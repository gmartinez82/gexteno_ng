...
class PDFComprobanteCompra extends TCPDF {
    ...
    public function getCondicionIva() { return $this->condicion_iva; }
    public function getCUIT() { return $this->cuit; }
    public function getIIBB() { return $this->iibb; }
    ...
    public function setProveedor($v) { $this->proveedor = $v; }
    public function setDomicilio($v) { $this->domicilio = $v; }
    public function setLocalidad($v) { $this->localidad = $v; }
    public function setProvincia($v) { $this->provincia = $v; }
    public function setCondicionIva($v) { $this->condicion_iva = $v; }
    public function setCUIT($v) { $this->cuit = $v; }
    public function setIIBB($v) { $this->iibb = $v; }
    ...
    function Header() {
        ...
        $this->HeaderComprobanteDatosProveedor($proveedor, $domicilio, $localidad, $provincia, $condicion_iva, $cuit, $iibb);               
    }
     ...
     * -------------------------------------------------------------------------
     */
    function HeaderComprobanteDatosProveedor($proveedor, $domicilio, $localidad, $provincia, $condicion_iva, $cuit, $iibb) {
        ...
        $this->Cell(1, 3, $proveedor, 0, 1, 'L', 1);

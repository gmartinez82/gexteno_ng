...
class BPdiPedidoAgrupacionItem
{ 
	
	const SES_PAGINACION = 'adm_pdipedidoagrupacionitem_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdipedidoagrupacionitem_paginas_registros';
	const SES_CRITERIOS = 'adm_pdipedidoagrupacionitem_criterios';
	
	const GEN_CLASE = 'PdiPedidoAgrupacionItem';
	const GEN_TABLA = 'pdi_pedido_agrupacion_item';
	...
	/* Constantes de Atributos de BPdiPedidoAgrupacionItem */ 
	const GEN_ATTR_ID = 'pdi_pedido_agrupacion_item.id';
	const GEN_ATTR_DESCRIPCION = 'pdi_pedido_agrupacion_item.descripcion';
	const GEN_ATTR_CODIGO = 'pdi_pedido_agrupacion_item.codigo';
	const GEN_ATTR_PDI_PEDIDO_AGRUPACION_ID = 'pdi_pedido_agrupacion_item.pdi_pedido_agrupacion_id';
	const GEN_ATTR_INS_INSUMO_ID = 'pdi_pedido_agrupacion_item.ins_insumo_id';
	const GEN_ATTR_CANTIDAD = 'pdi_pedido_agrupacion_item.cantidad';
	const GEN_ATTR_OBSERVACION = 'pdi_pedido_agrupacion_item.observacion';
	const GEN_ATTR_ORDEN = 'pdi_pedido_agrupacion_item.orden';
	const GEN_ATTR_ESTADO = 'pdi_pedido_agrupacion_item.estado';
	const GEN_ATTR_CREADO = 'pdi_pedido_agrupacion_item.creado';
	const GEN_ATTR_CREADO_POR = 'pdi_pedido_agrupacion_item.creado_por';
	const GEN_ATTR_MODIFICADO = 'pdi_pedido_agrupacion_item.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pdi_pedido_agrupacion_item.modificado_por';

	/* Constantes de Atributos Min de BPdiPedidoAgrupacionItem */ 
	...
	/* Atributos de BPdiPedidoAgrupacionItem */ 
	private $id;
	private $descripcion;
	private $codigo;
	...
	/* Getters de BPdiPedidoAgrupacionItem */ 
	...
	/* Setters de BPdiPedidoAgrupacionItem */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdiPedidoAgrupacionItem::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdiPedidoAgrupacionItem */ 	
	...
	/* Cambia el estado de BPdiPedidoAgrupacionItem */ 	
	...
	/* Save de BPdiPedidoAgrupacionItem */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pdi_pedido_agrupacion_item_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
                    ...
                    ) RETURNING currval('pdi_pedido_agrupacion_item_seq')";
                ...
                $sql = "
				 ...
				 ".PdiPedidoAgrupacionItem::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdiPedidoAgrupacionItem */ 	
	...
	public function duplicarPdiPedidoAgrupacionItem(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdiPedidoAgrupacionItems($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdiPedidoAgrupacionItem::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdipedidoagrupacionitem = new PdiPedidoAgrupacionItem();
                    $pdipedidoagrupacionitem->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdipedidoagrupacionitem->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdipedidoagrupacionitem->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdipedidoagrupacionitem->setPdiPedidoAgrupacionId($fila[self::GEN_ATTR_MIN_PDI_PEDIDO_AGRUPACION_ID]);
			$pdipedidoagrupacionitem->setInsInsumoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_ID]);
			$pdipedidoagrupacionitem->setCantidad($fila[self::GEN_ATTR_MIN_CANTIDAD]);
			$pdipedidoagrupacionitem->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdipedidoagrupacionitem->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdipedidoagrupacionitem->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdipedidoagrupacionitem->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdipedidoagrupacionitem->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdipedidoagrupacionitem->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdipedidoagrupacionitem->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdiPedidoAgrupacionItemsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdiPedidoAgrupacionItems para listado de Backend */ 	
	static function getPdiPedidoAgrupacionItemsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdiPedidoAgrupacionItemsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems($paginador, $criterio);
	...
	/* Método getPdiPedidoAgrupacionItems filtrado para select */ 	
	static function getPdiPedidoAgrupacionItemsCmbF($paginador = null, $criterio = null){
            $col = PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems($paginador, $criterio);
	...
	/* Método getPdiPedidoAgrupacionItems filtrado por una coleccion de objetos foraneos de PdiPedidoAgrupacion */ 	
	static function getPdiPedidoAgrupacionItemsXPdiPedidoAgrupacions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoAgrupacionItem::GEN_ATTR_PDI_PEDIDO_AGRUPACION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoAgrupacionItem::GEN_TABLA);
            $c->addOrden(PdiPedidoAgrupacionItem::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems($p, $c);
            foreach($os as $o){
	...
	/* Método getPdiPedidoAgrupacionItems filtrado por una coleccion de objetos foraneos de InsInsumo */ 	
	static function getPdiPedidoAgrupacionItemsXInsInsumos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoAgrupacionItem::GEN_ATTR_INS_INSUMO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoAgrupacionItem::GEN_TABLA);
            $c->addOrden(PdiPedidoAgrupacionItem::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pdi_pedido_agrupacion_item_adm.php';
            $url_gestion = 'pdi_pedido_agrupacion_item_gestion.php';
	...
	public function getPdiPedidos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdiPedido::GEN_ATTR_PDI_PEDIDO_AGRUPACION_ITEM_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdiPedidosCmb(){
            $c = new Criterio();
            $c->add(PdiPedido::GEN_ATTR_PDI_PEDIDO_AGRUPACION_ITEM_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdiPedido::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pdi_pedido_agrupacion_item'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pdi_pedido_agrupacion_item';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdiPedidoAgrupacionItems($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdiPedidoAgrupacionItems(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pdi_pedido_agrupacion_item_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdiPedidoAgrupacionItem::GEN_TABLA);
                $c->addOrden(PdiPedidoAgrupacionItem::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pdi_pedido_agrupacion_items = PdiPedidoAgrupacionItem::getPdiPedidoAgrupacionItems(null, $c);

                $arr = array();
                foreach($pdi_pedido_agrupacion_items as $pdi_pedido_agrupacion_item){
                    $descripcion = $pdi_pedido_agrupacion_item->getDescripcion();

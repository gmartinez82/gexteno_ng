...
class BCliClienteTipoGestion
{ 
	
	const SES_PAGINACION = 'adm_cliclientetipogestion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclientetipogestion_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclientetipogestion_criterios';
	
	const GEN_CLASE = 'CliClienteTipoGestion';
	const GEN_TABLA = 'cli_cliente_tipo_gestion';
	...
	/* Constantes de Atributos de BCliClienteTipoGestion */ 
	const GEN_ATTR_ID = 'cli_cliente_tipo_gestion.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_tipo_gestion.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_tipo_gestion.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_tipo_gestion.descripcion_publica';
	const GEN_ATTR_COLOR = 'cli_cliente_tipo_gestion.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_tipo_gestion.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_tipo_gestion.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_tipo_gestion.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_tipo_gestion.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_tipo_gestion.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_tipo_gestion.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_tipo_gestion.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_tipo_gestion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_tipo_gestion.modificado_por';

	/* Constantes de Atributos Min de BCliClienteTipoGestion */ 
	...
	/* Atributos de BCliClienteTipoGestion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BCliClienteTipoGestion */ 
	...
	/* Setters de BCliClienteTipoGestion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClienteTipoGestion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BCliClienteTipoGestion */ 	
	...
	/* Cambia el estado de BCliClienteTipoGestion */ 	
	...
	/* Save de BCliClienteTipoGestion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_tipo_gestion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_tipo_gestion_seq')";
                ...
                $sql = "
				 ...
				 ".CliClienteTipoGestion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClienteTipoGestion */ 	
	...
	public function duplicarCliClienteTipoGestion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteTipoGestions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteTipoGestion::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclientetipogestions = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclientetipogestion = new CliClienteTipoGestion();
                    $cliclientetipogestion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclientetipogestion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclientetipogestion->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclientetipogestion->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclientetipogestion->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclientetipogestion->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclientetipogestion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclientetipogestion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclientetipogestion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclientetipogestion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclientetipogestion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclientetipogestion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclientetipogestion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclientetipogestion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclientetipogestions[] = $cliclientetipogestion;
		}
		
		return $cliclientetipogestions;
	}	
	

	/* Método getCliClienteTipoGestions Habilitados */ 	
	static function getCliClienteTipoGestionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteTipoGestion::getCliClienteTipoGestions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteTipoGestions para listado de Backend */ 	
	static function getCliClienteTipoGestionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteTipoGestion::getCliClienteTipoGestions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteTipoGestionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteTipoGestion::getCliClienteTipoGestions($paginador, $criterio);
	...
	/* Método getCliClienteTipoGestions filtrado para select */ 	
	static function getCliClienteTipoGestionsCmbF($paginador = null, $criterio = null){
            $col = CliClienteTipoGestion::getCliClienteTipoGestions($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_tipo_gestion_adm.php';
            $url_gestion = 'cli_cliente_tipo_gestion_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_GESTION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_GESTION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_tipo_gestion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_tipo_gestion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteTipoGestions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteTipoGestions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_tipo_gestion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(CliClienteTipoGestion::GEN_TABLA);
                $c->addOrden(CliClienteTipoGestion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_tipo_gestions = CliClienteTipoGestion::getCliClienteTipoGestions(null, $c);

                $arr = array();
                foreach($cli_cliente_tipo_gestions as $cli_cliente_tipo_gestion){
                    $descripcion = $cli_cliente_tipo_gestion->getDescripcion();

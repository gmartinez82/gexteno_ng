...
class BPdeRecepcionDestinatario
{ 
	
	const SES_PAGINACION = 'adm_pderecepciondestinatario_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecepciondestinatario_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecepciondestinatario_criterios';
	
	const GEN_CLASE = 'PdeRecepcionDestinatario';
	const GEN_TABLA = 'pde_recepcion_destinatario';
	...
	/* Constantes de Atributos de BPdeRecepcionDestinatario */ 
	const GEN_ATTR_ID = 'pde_recepcion_destinatario.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recepcion_destinatario.descripcion';
	const GEN_ATTR_PDE_RECEPCION_ID = 'pde_recepcion_destinatario.pde_recepcion_id';
	const GEN_ATTR_US_USUARIO_ID = 'pde_recepcion_destinatario.us_usuario_id';
	const GEN_ATTR_OBSERVADO = 'pde_recepcion_destinatario.observado';
	const GEN_ATTR_LEIDO = 'pde_recepcion_destinatario.leido';
	const GEN_ATTR_DESTACADO = 'pde_recepcion_destinatario.destacado';
	const GEN_ATTR_AVISO_EMAIL = 'pde_recepcion_destinatario.aviso_email';
	const GEN_ATTR_AVISO_SMS = 'pde_recepcion_destinatario.aviso_sms';
	const GEN_ATTR_CODIGO = 'pde_recepcion_destinatario.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_recepcion_destinatario.observacion';
	const GEN_ATTR_ORDEN = 'pde_recepcion_destinatario.orden';
	const GEN_ATTR_ESTADO = 'pde_recepcion_destinatario.estado';
	const GEN_ATTR_CREADO = 'pde_recepcion_destinatario.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recepcion_destinatario.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recepcion_destinatario.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recepcion_destinatario.modificado_por';

	/* Constantes de Atributos Min de BPdeRecepcionDestinatario */ 
	...
	/* Atributos de BPdeRecepcionDestinatario */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeRecepcionDestinatario */ 
	...
	/* Setters de BPdeRecepcionDestinatario */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PdeRecepcionDestinatario();
            $o->setId($fila[PdeRecepcionDestinatario::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeRecepcionDestinatario */ 	
	...
	/* Cambia el estado de BPdeRecepcionDestinatario */ 	
	...
	/* Save de BPdeRecepcionDestinatario */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recepcion_destinatario_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_recepcion_destinatario_seq')";
                ...
                $sql = "
				 ...
				 ".PdeRecepcionDestinatario::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeRecepcionDestinatario */ 	
	...
	public function duplicarPdeRecepcionDestinatario(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeRecepcionDestinatarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeRecepcionDestinatario::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecepciondestinatario = new PdeRecepcionDestinatario();
                    $pderecepciondestinatario->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecepciondestinatario->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecepciondestinatario->setPdeRecepcionId($fila[self::GEN_ATTR_MIN_PDE_RECEPCION_ID]);
			$pderecepciondestinatario->setUsUsuarioId($fila[self::GEN_ATTR_MIN_US_USUARIO_ID]);
			$pderecepciondestinatario->setObservado($fila[self::GEN_ATTR_MIN_OBSERVADO]);
			$pderecepciondestinatario->setLeido($fila[self::GEN_ATTR_MIN_LEIDO]);
			$pderecepciondestinatario->setDestacado($fila[self::GEN_ATTR_MIN_DESTACADO]);
			$pderecepciondestinatario->setAvisoEmail($fila[self::GEN_ATTR_MIN_AVISO_EMAIL]);
			$pderecepciondestinatario->setAvisoSms($fila[self::GEN_ATTR_MIN_AVISO_SMS]);
			$pderecepciondestinatario->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecepciondestinatario->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecepciondestinatario->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecepciondestinatario->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecepciondestinatario->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecepciondestinatario->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecepciondestinatario->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecepciondestinatario->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeRecepcionDestinatariosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeRecepcionDestinatario::getPdeRecepcionDestinatarios($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeRecepcionDestinatarios para listado de Backend */ 	
	static function getPdeRecepcionDestinatariosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeRecepcionDestinatario::getPdeRecepcionDestinatarios($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeRecepcionDestinatariosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeRecepcionDestinatario::getPdeRecepcionDestinatarios($paginador, $criterio);
	...
	/* Método getPdeRecepcionDestinatarios filtrado para select */ 	
	static function getPdeRecepcionDestinatariosCmbF($paginador = null, $criterio = null){
            $col = PdeRecepcionDestinatario::getPdeRecepcionDestinatarios($paginador, $criterio);
	...
	/* Método getPdeRecepcionDestinatarios filtrado por una coleccion de objetos foraneos de PdeRecepcion */ 	
	static function getPdeRecepcionDestinatariosXPdeRecepcions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeRecepcionDestinatario::GEN_ATTR_PDE_RECEPCION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeRecepcionDestinatario::GEN_TABLA);
            $c->addOrden(PdeRecepcionDestinatario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeRecepcionDestinatario::getPdeRecepcionDestinatarios($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeRecepcionDestinatarios filtrado por una coleccion de objetos foraneos de UsUsuario */ 	
	static function getPdeRecepcionDestinatariosXUsUsuarios($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeRecepcionDestinatario::GEN_ATTR_US_USUARIO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeRecepcionDestinatario::GEN_TABLA);
            $c->addOrden(PdeRecepcionDestinatario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recepcion_destinatario_adm.php';
            $url_gestion = 'pde_recepcion_destinatario_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recepcion_destinatario'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recepcion_destinatario';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeRecepcionDestinatarios($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeRecepcionDestinatarios(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recepcion_destinatario_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeRecepcionDestinatario::GEN_TABLA);
                $c->addOrden(PdeRecepcionDestinatario::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recepcion_destinatarios = PdeRecepcionDestinatario::getPdeRecepcionDestinatarios(null, $c);

                $arr = array();
                foreach($pde_recepcion_destinatarios as $pde_recepcion_destinatario){
                    $descripcion = $pde_recepcion_destinatario->getDescripcion();

...
class BPdeRecepcionAgrupacion
{ 
	
	const SES_PAGINACION = 'adm_pderecepcionagrupacion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecepcionagrupacion_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecepcionagrupacion_criterios';
	
	const GEN_CLASE = 'PdeRecepcionAgrupacion';
	const GEN_TABLA = 'pde_recepcion_agrupacion';
	...
	/* Constantes de Atributos de BPdeRecepcionAgrupacion */ 
	const GEN_ATTR_ID = 'pde_recepcion_agrupacion.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recepcion_agrupacion.descripcion';
	const GEN_ATTR_CODIGO = 'pde_recepcion_agrupacion.codigo';
	const GEN_ATTR_NRO_COMPROBANTE = 'pde_recepcion_agrupacion.nro_comprobante';
	const GEN_ATTR_PDE_TIPO_RECEPCION_ID = 'pde_recepcion_agrupacion.pde_tipo_recepcion_id';
	const GEN_ATTR_PDE_CENTRO_RECEPCION_ID = 'pde_recepcion_agrupacion.pde_centro_recepcion_id';
	const GEN_ATTR_PRV_PROVEEDOR_ID = 'pde_recepcion_agrupacion.prv_proveedor_id';
	const GEN_ATTR_FECHA_ENTREGA = 'pde_recepcion_agrupacion.fecha_entrega';
	const GEN_ATTR_OBSERVACION = 'pde_recepcion_agrupacion.observacion';
	const GEN_ATTR_ORDEN = 'pde_recepcion_agrupacion.orden';
	const GEN_ATTR_ESTADO = 'pde_recepcion_agrupacion.estado';
	const GEN_ATTR_CREADO = 'pde_recepcion_agrupacion.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recepcion_agrupacion.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recepcion_agrupacion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recepcion_agrupacion.modificado_por';

	/* Constantes de Atributos Min de BPdeRecepcionAgrupacion */ 
	...
	/* Atributos de BPdeRecepcionAgrupacion */ 
	private $id;
	private $descripcion;
	private $codigo;
	...
	/* Getters de BPdeRecepcionAgrupacion */ 
	...
	/* Setters de BPdeRecepcionAgrupacion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeRecepcionAgrupacion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeRecepcionAgrupacion */ 	
	...
	/* Cambia el estado de BPdeRecepcionAgrupacion */ 	
	...
	/* Save de BPdeRecepcionAgrupacion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recepcion_agrupacion_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
                    ...
                    ) RETURNING currval('pde_recepcion_agrupacion_seq')";
                ...
                $sql = "
				 ...
				 ".PdeRecepcionAgrupacion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeRecepcionAgrupacion */ 	
	...
	public function duplicarPdeRecepcionAgrupacion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeRecepcionAgrupacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeRecepcionAgrupacion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecepcionagrupacion = new PdeRecepcionAgrupacion();
                    $pderecepcionagrupacion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecepcionagrupacion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecepcionagrupacion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecepcionagrupacion->setNroComprobante($fila[self::GEN_ATTR_MIN_NRO_COMPROBANTE]);
			$pderecepcionagrupacion->setPdeTipoRecepcionId($fila[self::GEN_ATTR_MIN_PDE_TIPO_RECEPCION_ID]);
			$pderecepcionagrupacion->setPdeCentroRecepcionId($fila[self::GEN_ATTR_MIN_PDE_CENTRO_RECEPCION_ID]);
			$pderecepcionagrupacion->setPrvProveedorId($fila[self::GEN_ATTR_MIN_PRV_PROVEEDOR_ID]);
			$pderecepcionagrupacion->setFechaEntrega($fila[self::GEN_ATTR_MIN_FECHA_ENTREGA]);
			$pderecepcionagrupacion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecepcionagrupacion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecepcionagrupacion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecepcionagrupacion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecepcionagrupacion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecepcionagrupacion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecepcionagrupacion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeRecepcionAgrupacionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeRecepcionAgrupacions para listado de Backend */ 	
	static function getPdeRecepcionAgrupacionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeRecepcionAgrupacionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions($paginador, $criterio);
	...
	/* Método getPdeRecepcionAgrupacions filtrado para select */ 	
	static function getPdeRecepcionAgrupacionsCmbF($paginador = null, $criterio = null){
            $col = PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions($paginador, $criterio);
	...
	/* Método getPdeRecepcionAgrupacions filtrado por una coleccion de objetos foraneos de PdeTipoRecepcion */ 	
	static function getPdeRecepcionAgrupacionsXPdeTipoRecepcions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeRecepcionAgrupacion::GEN_ATTR_PDE_TIPO_RECEPCION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeRecepcionAgrupacion::GEN_TABLA);
            $c->addOrden(PdeRecepcionAgrupacion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeRecepcionAgrupacions filtrado por una coleccion de objetos foraneos de PdeCentroRecepcion */ 	
	static function getPdeRecepcionAgrupacionsXPdeCentroRecepcions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeRecepcionAgrupacion::GEN_ATTR_PDE_CENTRO_RECEPCION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeRecepcionAgrupacion::GEN_TABLA);
            $c->addOrden(PdeRecepcionAgrupacion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeRecepcionAgrupacions filtrado por una coleccion de objetos foraneos de PrvProveedor */ 	
	static function getPdeRecepcionAgrupacionsXPrvProveedors($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeRecepcionAgrupacion::GEN_ATTR_PRV_PROVEEDOR_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeRecepcionAgrupacion::GEN_TABLA);
            $c->addOrden(PdeRecepcionAgrupacion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recepcion_agrupacion_adm.php';
            $url_gestion = 'pde_recepcion_agrupacion_gestion.php';
	...
	public function getPdeRecepcions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecepcion::GEN_ATTR_PDE_RECEPCION_AGRUPACION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecepcionsCmb(){
            $c = new Criterio();
            $c->add(PdeRecepcion::GEN_ATTR_PDE_RECEPCION_AGRUPACION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecepcion::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recepcion_agrupacion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recepcion_agrupacion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeRecepcionAgrupacions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeRecepcionAgrupacions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recepcion_agrupacion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeRecepcionAgrupacion::GEN_TABLA);
                $c->addOrden(PdeRecepcionAgrupacion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recepcion_agrupacions = PdeRecepcionAgrupacion::getPdeRecepcionAgrupacions(null, $c);

                $arr = array();
                foreach($pde_recepcion_agrupacions as $pde_recepcion_agrupacion){
                    $descripcion = $pde_recepcion_agrupacion->getDescripcion();

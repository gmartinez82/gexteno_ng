...
class BVtaNotaCreditoVtaTributo
{ 
	
	const SES_PAGINACION = 'adm_vtanotacreditovtatributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtanotacreditovtatributo_paginas_registros';
	const SES_CRITERIOS = 'adm_vtanotacreditovtatributo_criterios';
	
	const GEN_CLASE = 'VtaNotaCreditoVtaTributo';
	const GEN_TABLA = 'vta_nota_credito_vta_tributo';
	...
	/* Constantes de Atributos de BVtaNotaCreditoVtaTributo */ 
	const GEN_ATTR_ID = 'vta_nota_credito_vta_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'vta_nota_credito_vta_tributo.descripcion';
	const GEN_ATTR_VTA_NOTA_CREDITO_ID = 'vta_nota_credito_vta_tributo.vta_nota_credito_id';
	const GEN_ATTR_VTA_TRIBUTO_ID = 'vta_nota_credito_vta_tributo.vta_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'vta_nota_credito_vta_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'vta_nota_credito_vta_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'vta_nota_credito_vta_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'vta_nota_credito_vta_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'vta_nota_credito_vta_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_nota_credito_vta_tributo.observacion';
	const GEN_ATTR_ORDEN = 'vta_nota_credito_vta_tributo.orden';
	const GEN_ATTR_ESTADO = 'vta_nota_credito_vta_tributo.estado';
	const GEN_ATTR_CREADO = 'vta_nota_credito_vta_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'vta_nota_credito_vta_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_nota_credito_vta_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_nota_credito_vta_tributo.modificado_por';

	/* Constantes de Atributos Min de BVtaNotaCreditoVtaTributo */ 
	...
	/* Atributos de BVtaNotaCreditoVtaTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaNotaCreditoVtaTributo */ 
	...
	/* Setters de BVtaNotaCreditoVtaTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaNotaCreditoVtaTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaNotaCreditoVtaTributo */ 	
	...
	/* Cambia el estado de BVtaNotaCreditoVtaTributo */ 	
	...
	/* Save de BVtaNotaCreditoVtaTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_nota_credito_vta_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_nota_credito_vta_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".VtaNotaCreditoVtaTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaNotaCreditoVtaTributo */ 	
	...
	public function duplicarVtaNotaCreditoVtaTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaNotaCreditoVtaTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaNotaCreditoVtaTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtanotacreditovtatributo = new VtaNotaCreditoVtaTributo();
                    $vtanotacreditovtatributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtanotacreditovtatributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtanotacreditovtatributo->setVtaNotaCreditoId($fila[self::GEN_ATTR_MIN_VTA_NOTA_CREDITO_ID]);
			$vtanotacreditovtatributo->setVtaTributoId($fila[self::GEN_ATTR_MIN_VTA_TRIBUTO_ID]);
			$vtanotacreditovtatributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$vtanotacreditovtatributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$vtanotacreditovtatributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$vtanotacreditovtatributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$vtanotacreditovtatributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtanotacreditovtatributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtanotacreditovtatributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtanotacreditovtatributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtanotacreditovtatributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtanotacreditovtatributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtanotacreditovtatributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtanotacreditovtatributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaNotaCreditoVtaTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaNotaCreditoVtaTributos para listado de Backend */ 	
	static function getVtaNotaCreditoVtaTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaNotaCreditoVtaTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos($paginador, $criterio);
	...
	/* Método getVtaNotaCreditoVtaTributos filtrado para select */ 	
	static function getVtaNotaCreditoVtaTributosCmbF($paginador = null, $criterio = null){
            $col = VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos($paginador, $criterio);
	...
	/* Método getVtaNotaCreditoVtaTributos filtrado por una coleccion de objetos foraneos de VtaNotaCredito */ 	
	static function getVtaNotaCreditoVtaTributosXVtaNotaCreditos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaNotaCreditoVtaTributo::GEN_ATTR_VTA_NOTA_CREDITO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaNotaCreditoVtaTributo::GEN_TABLA);
            $c->addOrden(VtaNotaCreditoVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaNotaCreditoVtaTributos filtrado por una coleccion de objetos foraneos de VtaTributo */ 	
	static function getVtaNotaCreditoVtaTributosXVtaTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaNotaCreditoVtaTributo::GEN_ATTR_VTA_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaNotaCreditoVtaTributo::GEN_TABLA);
            $c->addOrden(VtaNotaCreditoVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_nota_credito_vta_tributo_adm.php';
            $url_gestion = 'vta_nota_credito_vta_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_nota_credito_vta_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_nota_credito_vta_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaNotaCreditoVtaTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaNotaCreditoVtaTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_nota_credito_vta_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaNotaCreditoVtaTributo::GEN_TABLA);
                $c->addOrden(VtaNotaCreditoVtaTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_nota_credito_vta_tributos = VtaNotaCreditoVtaTributo::getVtaNotaCreditoVtaTributos(null, $c);

                $arr = array();
                foreach($vta_nota_credito_vta_tributos as $vta_nota_credito_vta_tributo){
                    $descripcion = $vta_nota_credito_vta_tributo->getDescripcion();

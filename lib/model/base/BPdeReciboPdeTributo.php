...
class BPdeReciboPdeTributo
{ 
	
	const SES_PAGINACION = 'adm_pderecibopdetributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecibopdetributo_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecibopdetributo_criterios';
	
	const GEN_CLASE = 'PdeReciboPdeTributo';
	const GEN_TABLA = 'pde_recibo_pde_tributo';
	...
	/* Constantes de Atributos de BPdeReciboPdeTributo */ 
	const GEN_ATTR_ID = 'pde_recibo_pde_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recibo_pde_tributo.descripcion';
	const GEN_ATTR_PDE_RECIBO_ID = 'pde_recibo_pde_tributo.pde_recibo_id';
	const GEN_ATTR_PDE_TRIBUTO_ID = 'pde_recibo_pde_tributo.pde_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'pde_recibo_pde_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'pde_recibo_pde_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'pde_recibo_pde_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'pde_recibo_pde_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'pde_recibo_pde_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_recibo_pde_tributo.observacion';
	const GEN_ATTR_ORDEN = 'pde_recibo_pde_tributo.orden';
	const GEN_ATTR_ESTADO = 'pde_recibo_pde_tributo.estado';
	const GEN_ATTR_CREADO = 'pde_recibo_pde_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recibo_pde_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recibo_pde_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recibo_pde_tributo.modificado_por';

	/* Constantes de Atributos Min de BPdeReciboPdeTributo */ 
	...
	/* Atributos de BPdeReciboPdeTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeReciboPdeTributo */ 
	...
	/* Setters de BPdeReciboPdeTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeReciboPdeTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeReciboPdeTributo */ 	
	...
	/* Cambia el estado de BPdeReciboPdeTributo */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recibo_pde_tributo_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getPdeReciboId()."
                    ...
                    ) RETURNING currval('pde_recibo_pde_tributo_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeReciboPdeTributo */ 	
	...
	public function duplicarPdeReciboPdeTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeReciboPdeTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeReciboPdeTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecibopdetributo = new PdeReciboPdeTributo();
                    $pderecibopdetributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecibopdetributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecibopdetributo->setPdeReciboId($fila[self::GEN_ATTR_MIN_PDE_RECIBO_ID]);
			$pderecibopdetributo->setPdeTributoId($fila[self::GEN_ATTR_MIN_PDE_TRIBUTO_ID]);
			$pderecibopdetributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$pderecibopdetributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$pderecibopdetributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$pderecibopdetributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$pderecibopdetributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecibopdetributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecibopdetributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecibopdetributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecibopdetributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecibopdetributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecibopdetributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecibopdetributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeReciboPdeTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeReciboPdeTributo::getPdeReciboPdeTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeReciboPdeTributos para listado de Backend */ 	
	static function getPdeReciboPdeTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeReciboPdeTributo::getPdeReciboPdeTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeReciboPdeTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeReciboPdeTributo::getPdeReciboPdeTributos($paginador, $criterio);
	...
	/* Método getPdeReciboPdeTributos filtrado para select */ 	
	static function getPdeReciboPdeTributosCmbF($paginador = null, $criterio = null){
            $col = PdeReciboPdeTributo::getPdeReciboPdeTributos($paginador, $criterio);
	...
	/* Método getPdeReciboPdeTributos filtrado por una coleccion de objetos foraneos de PdeRecibo */ 	
	static function getPdeReciboPdeTributosXPdeRecibos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeReciboPdeTributo::GEN_ATTR_PDE_RECIBO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeReciboPdeTributo::GEN_TABLA);
            $c->addOrden(PdeReciboPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeReciboPdeTributo::getPdeReciboPdeTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeReciboPdeTributos filtrado por una coleccion de objetos foraneos de PdeTributo */ 	
	static function getPdeReciboPdeTributosXPdeTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeReciboPdeTributo::GEN_ATTR_PDE_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeReciboPdeTributo::GEN_TABLA);
            $c->addOrden(PdeReciboPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recibo_pde_tributo_adm.php';
            $url_gestion = 'pde_recibo_pde_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recibo_pde_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recibo_pde_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeReciboPdeTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeReciboPdeTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recibo_pde_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeReciboPdeTributo::GEN_TABLA);
                $c->addOrden(PdeReciboPdeTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recibo_pde_tributos = PdeReciboPdeTributo::getPdeReciboPdeTributos(null, $c);

                $arr = array();
                foreach($pde_recibo_pde_tributos as $pde_recibo_pde_tributo){
                    $descripcion = $pde_recibo_pde_tributo->getDescripcion();

...
class BPdeFacturaTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_pdefacturatipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdefacturatipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pdefacturatipoestado_criterios';
	
	const GEN_CLASE = 'PdeFacturaTipoEstado';
	const GEN_TABLA = 'pde_factura_tipo_estado';
	...
	/* Constantes de Atributos de BPdeFacturaTipoEstado */ 
	const GEN_ATTR_ID = 'pde_factura_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'pde_factura_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'pde_factura_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'pde_factura_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'pde_factura_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'pde_factura_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'pde_factura_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'pde_factura_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'pde_factura_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'pde_factura_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'pde_factura_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'pde_factura_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'pde_factura_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'pde_factura_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pde_factura_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_factura_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_factura_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BPdeFacturaTipoEstado */ 
	...
	/* Atributos de BPdeFacturaTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BPdeFacturaTipoEstado */ 
	...
	/* Setters de BPdeFacturaTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeFacturaTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeFacturaTipoEstado */ 	
	...
	/* Cambia el estado de BPdeFacturaTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_factura_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('pde_factura_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PdeFacturaTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeFacturaTipoEstado */ 	
	...
	public function duplicarPdeFacturaTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeFacturaTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeFacturaTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdefacturatipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdefacturatipoestado = new PdeFacturaTipoEstado();
                    $pdefacturatipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdefacturatipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdefacturatipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdefacturatipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$pdefacturatipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$pdefacturatipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$pdefacturatipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$pdefacturatipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$pdefacturatipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$pdefacturatipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$pdefacturatipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdefacturatipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdefacturatipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdefacturatipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdefacturatipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdefacturatipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdefacturatipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdefacturatipoestados[] = $pdefacturatipoestado;
		}
		
		return $pdefacturatipoestados;
	}	
	

	/* Método getPdeFacturaTipoEstados Habilitados */ 	
	static function getPdeFacturaTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeFacturaTipoEstado::getPdeFacturaTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeFacturaTipoEstados para listado de Backend */ 	
	static function getPdeFacturaTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeFacturaTipoEstado::getPdeFacturaTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeFacturaTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeFacturaTipoEstado::getPdeFacturaTipoEstados($paginador, $criterio);
	...
	/* Método getPdeFacturaTipoEstados filtrado para select */ 	
	static function getPdeFacturaTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = PdeFacturaTipoEstado::getPdeFacturaTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_factura_tipo_estado_adm.php';
            $url_gestion = 'pde_factura_tipo_estado_gestion.php';
	...
	public function getPdeFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeFactura::GEN_ATTR_PDE_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeFacturasCmb(){
            $c = new Criterio();
            $c->add(PdeFactura::GEN_ATTR_PDE_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeFactura::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeFacturaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeFacturaEstado::GEN_ATTR_PDE_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeFacturaEstadosCmb(){
            $c = new Criterio();
            $c->add(PdeFacturaEstado::GEN_ATTR_PDE_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeFacturaEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PdeFacturas (Coleccion) relacionados a traves de PdeFacturaEstado */ 	
	public function getPdeFacturasXPdeFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(PdeFactura::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(PdeFacturaEstado::GEN_ATTR_PDE_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeFactura::GEN_TABLA);
            $c->addRealJoin(PdeFacturaEstado::GEN_TABLA, PdeFacturaEstado::GEN_ATTR_PDE_FACTURA_ID, PdeFactura::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PdeFacturas relacionados a traves de PdeFacturaEstado */ 	
	public function getCantidadPdeFacturasXPdeFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PdeFactura (Objeto) relacionado a traves de PdeFacturaEstado */ 	
	public function getPdeFacturaXPdeFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPdeFacturasXPdeFacturaEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_factura_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_factura_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeFacturaTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeFacturaTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_factura_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeFacturaTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_factura_tipo_estados = PdeFacturaTipoEstado::getPdeFacturaTipoEstados(null, $c);

                $arr = array();
                foreach($pde_factura_tipo_estados as $pde_factura_tipo_estado){
                    $descripcion = $pde_factura_tipo_estado->getDescripcion();

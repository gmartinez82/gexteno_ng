...
class BPdeTipoRecibo
{ 
	
	const SES_PAGINACION = 'adm_pdetiporecibo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdetiporecibo_paginas_registros';
	const SES_CRITERIOS = 'adm_pdetiporecibo_criterios';
	
	const GEN_CLASE = 'PdeTipoRecibo';
	const GEN_TABLA = 'pde_tipo_recibo';
	...
	/* Constantes de Atributos de BPdeTipoRecibo */ 
	const GEN_ATTR_ID = 'pde_tipo_recibo.id';
	const GEN_ATTR_DESCRIPCION = 'pde_tipo_recibo.descripcion';
	const GEN_ATTR_CODIGO_MIN = 'pde_tipo_recibo.codigo_min';
	const GEN_ATTR_CODIGO = 'pde_tipo_recibo.codigo';
	const GEN_ATTR_INFORMA = 'pde_tipo_recibo.informa';
	const GEN_ATTR_OBSERVACION = 'pde_tipo_recibo.observacion';
	const GEN_ATTR_ORDEN = 'pde_tipo_recibo.orden';
	const GEN_ATTR_ESTADO = 'pde_tipo_recibo.estado';
	const GEN_ATTR_CREADO = 'pde_tipo_recibo.creado';
	const GEN_ATTR_CREADO_POR = 'pde_tipo_recibo.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_tipo_recibo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_tipo_recibo.modificado_por';

	/* Constantes de Atributos Min de BPdeTipoRecibo */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new PdeTipoRecibo();
            $o->setId($fila[PdeTipoRecibo::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BPdeTipoRecibo */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_tipo_recibo_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeTipoRecibo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeTipoRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeTipoRecibo::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdetiporecibos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdetiporecibo = new PdeTipoRecibo();
                    $pdetiporecibo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdetiporecibo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdetiporecibo->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$pdetiporecibo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdetiporecibo->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$pdetiporecibo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdetiporecibo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdetiporecibo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdetiporecibo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdetiporecibo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdetiporecibo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdetiporecibo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdetiporecibos[] = $pdetiporecibo;
		}
		
		return $pdetiporecibos;
	}	
	

	/* Método getPdeTipoRecibos Habilitados */ 	
	static function getPdeTipoRecibosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeTipoRecibo::getPdeTipoRecibos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeTipoRecibos para listado de Backend */ 	
	static function getPdeTipoRecibosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeTipoRecibo::getPdeTipoRecibos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeTipoRecibosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeTipoRecibo::getPdeTipoRecibos($paginador, $criterio);
	...
	/* Método getPdeTipoRecibos filtrado para select */ 	
	static function getPdeTipoRecibosCmbF($paginador = null, $criterio = null){
            $col = PdeTipoRecibo::getPdeTipoRecibos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_tipo_recibo_adm.php';
            $url_gestion = 'pde_tipo_recibo_gestion.php';
	...
	public function getGralCondicionIvaPdeTipoRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralCondicionIvaPdeTipoRecibo::GEN_ATTR_PDE_TIPO_RECIBO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralCondicionIvaPdeTipoRecibosCmb(){
            $c = new Criterio();
            $c->add(GralCondicionIvaPdeTipoRecibo::GEN_ATTR_PDE_TIPO_RECIBO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralCondicionIvaPdeTipoRecibo::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralCondicionIvas (Coleccion) relacionados a traves de GralCondicionIvaPdeTipoRecibo */ 	
	public function getGralCondicionIvasXGralCondicionIvaPdeTipoRecibo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralCondicionIvaPdeTipoRecibo::GEN_TABLA, GralCondicionIvaPdeTipoRecibo::GEN_ATTR_GRAL_CONDICION_IVA_ID, GralCondicionIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralCondicionIvas relacionados a traves de GralCondicionIvaPdeTipoRecibo */ 	
	public function getCantidadGralCondicionIvasXGralCondicionIvaPdeTipoRecibo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralCondicionIva (Objeto) relacionado a traves de GralCondicionIvaPdeTipoRecibo */ 	
	public function getGralCondicionIvaXGralCondicionIvaPdeTipoRecibo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralCondicionIvasXGralCondicionIvaPdeTipoRecibo($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPdeRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecibo::GEN_ATTR_PDE_TIPO_RECIBO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecibosCmb(){
            $c = new Criterio();
            $c->add(PdeRecibo::GEN_ATTR_PDE_TIPO_RECIBO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecibo::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralCondicionIvas asignados a PdeTipoRecibo */ 	
	...
	/* Método setea nuevos GralCondicionIvas asignados al PdeTipoRecibo */ 	
	public function setGralCondicionIvaPdeTipoRecibos($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setPdeTipoReciboId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralCondicionIva en el alta de PdeTipoRecibo */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_tipo_recibo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_tipo_recibo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeTipoRecibos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeTipoRecibos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_tipo_recibo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeTipoRecibo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_tipo_recibos = PdeTipoRecibo::getPdeTipoRecibos(null, $c);

                $arr = array();
                foreach($pde_tipo_recibos as $pde_tipo_recibo){
                    $descripcion = $pde_tipo_recibo->getDescripcion();

...
{ 
	...
	const SES_PAGINACION = 'adm_genapitoken_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_genapitoken_paginas_registros';
	const SES_CRITERIOS = 'adm_genapitoken_criterios';
	
	const GEN_CLASE = 'GenApiToken';
	const GEN_TABLA = 'gen_api_token';
	...
	/* Constantes de Atributos de BGenApiToken */ 
	const GEN_ATTR_ID = 'gen_api_token.id';
	const GEN_ATTR_DESCRIPCION = 'gen_api_token.descripcion';
	const GEN_ATTR_GEN_API_CONSUMER_ID = 'gen_api_token.gen_api_consumer_id';
	const GEN_ATTR_GEN_API_PROYECTO_ID = 'gen_api_token.gen_api_proyecto_id';
	const GEN_ATTR_VENCIMIENTO = 'gen_api_token.vencimiento';
	const GEN_ATTR_ACTIVO = 'gen_api_token.activo';
	const GEN_ATTR_CODIGO = 'gen_api_token.codigo';
	const GEN_ATTR_OBSERVACION = 'gen_api_token.observacion';
	const GEN_ATTR_ORDEN = 'gen_api_token.orden';
	const GEN_ATTR_ESTADO = 'gen_api_token.estado';
	const GEN_ATTR_CREADO = 'gen_api_token.creado';
	const GEN_ATTR_CREADO_POR = 'gen_api_token.creado_por';
	const GEN_ATTR_MODIFICADO = 'gen_api_token.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'gen_api_token.modificado_por';

	/* Constantes de Atributos Min de BGenApiToken */ 
	const GEN_ATTR_MIN_ID = 'id';
	const GEN_ATTR_MIN_DESCRIPCION = 'descripcion';
	const GEN_ATTR_MIN_GEN_API_CONSUMER_ID = 'gen_api_consumer_id';
	...
	/* Atributos de BGenApiToken */ 
	private $id;
	private $descripcion;
	private $gen_api_consumer_id;
	...
	/* Getters de BGenApiToken */ 
	public function getId(){ if(isset($this->id)){ return $this->id; }else{ return ''; } }
	public function getDescripcion(){ if(isset($this->descripcion)){ return $this->descripcion; }else{ return ''; } }
	public function getGenApiConsumerId(){ if(isset($this->gen_api_consumer_id)){ return $this->gen_api_consumer_id; }else{ return 'null'; } }
	...
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 SELECT 
				...
				, ".self::GEN_ATTR_GEN_API_CONSUMER_ID."
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setGenApiConsumerId($fila[self::GEN_ATTR_MIN_GEN_API_CONSUMER_ID]);
	...
	public function setGenApiConsumerId($v){ $this->gen_api_consumer_id = $v; }
	...
	public static function hidratarObjeto($fila){            
            $o = new GenApiToken();
            $o->setId($fila[GenApiToken::GEN_ATTR_MIN_ID], false);
            
			$o->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$o->setGenApiConsumerId($fila[self::GEN_ATTR_MIN_GEN_API_CONSUMER_ID]);
	...
	/* Cambia el estado de BGenApiToken */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						, ".self::GEN_ATTR_MIN_GEN_API_CONSUMER_ID."
                ...
                nextval('gen_api_token_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getGenApiConsumerId()."
                    ...
                    ) RETURNING currval('gen_api_token_seq')";
                ...
                $sql = "
				 ...
				 ".GenApiToken::GEN_TABLA."
				 SET 
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
						, ".self::GEN_ATTR_MIN_GEN_API_CONSUMER_ID." = ".$this->getGenApiConsumerId()."
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarGenApiToken(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getGenApiTokens($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = GenApiToken::setAplicarFiltrosDeAlcance($criterio);
		...
		$genapitokens = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $genapitoken = new GenApiToken();
                    $genapitoken->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $genapitoken->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$genapitoken->setGenApiConsumerId($fila[self::GEN_ATTR_MIN_GEN_API_CONSUMER_ID]);
			$genapitoken->setGenApiProyectoId($fila[self::GEN_ATTR_MIN_GEN_API_PROYECTO_ID]);
			$genapitoken->setVencimiento($fila[self::GEN_ATTR_MIN_VENCIMIENTO]);
			$genapitoken->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$genapitoken->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$genapitoken->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$genapitoken->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$genapitoken->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$genapitoken->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$genapitoken->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$genapitoken->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$genapitoken->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getGenApiTokensHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return GenApiToken::getGenApiTokens($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getGenApiTokens para listado de Backend */ 	
	static function getGenApiTokensDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return GenApiToken::getGenApiTokens($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getGenApiTokensCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = GenApiToken::getGenApiTokens($paginador, $criterio);
	...
	/* Método getGenApiTokens filtrado para select */ 	
	static function getGenApiTokensCmbF($paginador = null, $criterio = null){
            $col = GenApiToken::getGenApiTokens($paginador, $criterio);
	...
	/* Método getGenApiTokens filtrado por una coleccion de objetos foraneos de GenApiConsumer */ 	
	static function getGenApiTokensXGenApiConsumers($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(GenApiToken::GEN_ATTR_GEN_API_CONSUMER_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(GenApiToken::GEN_TABLA);
            $c->addOrden(GenApiToken::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = GenApiToken::getGenApiTokens($p, $c);
            foreach($os as $o){
                $os_con_indice[$o->getGenApiConsumerId()] = $o;
            }
            return $os_con_indice;
	}	
	

	/* Método getGenApiTokens filtrado por una coleccion de objetos foraneos de GenApiProyecto */ 	
	static function getGenApiTokensXGenApiProyectos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(GenApiToken::GEN_ATTR_GEN_API_PROYECTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(GenApiToken::GEN_TABLA);
            $c->addOrden(GenApiToken::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'gen_api_token_adm.php';
            $url_gestion = 'gen_api_token_gestion.php';
	...
	public function getAppMovInstalacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(AppMovInstalacion::GEN_ATTR_GEN_API_TOKEN_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getAppMovInstalacionsCmb(){
            $c = new Criterio();
            $c->add(AppMovInstalacion::GEN_ATTR_GEN_API_TOKEN_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(AppMovInstalacion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getAppMovActividads($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(AppMovActividad::GEN_ATTR_GEN_API_TOKEN_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getAppMovActividadsCmb(){
            $c = new Criterio();
            $c->add(AppMovActividad::GEN_ATTR_GEN_API_TOKEN_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(AppMovActividad::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna el GenApiConsumer (Clave Foranea) */ 	
    public function getGenApiConsumer(){
        $o = new GenApiConsumer();
        $o->setId($this->getGenApiConsumerId());
        return $o;			
    }

	/* Metodo que retorna el GenApiConsumer (Clave Foranea) en Array */ 	
    public function getGenApiConsumerEnArray(&$arr_os){
        if($this->getGenApiConsumerId() != 'null'){
            if(isset($arr_os[$this->getGenApiConsumerId()])){
                $o = $arr_os[$this->getGenApiConsumerId()];
            }else{
                $o = GenApiConsumer::getOxId($this->getGenApiConsumerId());
                if($o){
                    $arr_os[$this->getGenApiConsumerId()] = $o;
                }
            }
        }else{
            $o = new GenApiConsumer();
    ...
    public function getDescripcionVinculante($contexto_solicitante = ''){
        ...
        if($contexto_solicitante != GenApiConsumer::GEN_CLASE){
            if($this->getGenApiConsumer()->getDescripcion() != ''){
                $descripcion.= Lang::_lang(GenApiConsumer::GEN_CLASE, true).':';
                $descripcion.= '<strong>'.$this->getGenApiConsumer()->getDescripcion().'</strong>';
                $descripcion.= ' - ';
            }
        }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM gen_api_token'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'gen_api_token';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getGenApiTokens($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getGenApiTokens(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'gen_api_consumer_id' */ 	
	static function getOxGenApiConsumerId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_GEN_API_CONSUMER_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'gen_api_consumer_id' */ 	
	static function getOsxGenApiConsumerId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_GEN_API_CONSUMER_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'gen_api_token_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(GenApiToken::GEN_TABLA);
                $c->addOrden(GenApiToken::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($gen_api_tokens as $gen_api_token){
                    $descripcion = $gen_api_token->getDescripcion();

...
class BPdiPedidoAgrupacionEstado
{ 
	
	const SES_PAGINACION = 'adm_pdipedidoagrupacionestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdipedidoagrupacionestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pdipedidoagrupacionestado_criterios';
	
	const GEN_CLASE = 'PdiPedidoAgrupacionEstado';
	const GEN_TABLA = 'pdi_pedido_agrupacion_estado';
	...
	/* Constantes de Atributos de BPdiPedidoAgrupacionEstado */ 
	const GEN_ATTR_ID = 'pdi_pedido_agrupacion_estado.id';
	const GEN_ATTR_PDI_PEDIDO_AGRUPACION_ID = 'pdi_pedido_agrupacion_estado.pdi_pedido_agrupacion_id';
	const GEN_ATTR_PDI_PEDIDO_AGRUPACION_TIPO_ESTADO_ID = 'pdi_pedido_agrupacion_estado.pdi_pedido_agrupacion_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'pdi_pedido_agrupacion_estado.inicial';
	const GEN_ATTR_ACTUAL = 'pdi_pedido_agrupacion_estado.actual';
	const GEN_ATTR_OBSERVACION = 'pdi_pedido_agrupacion_estado.observacion';
	const GEN_ATTR_CREADO = 'pdi_pedido_agrupacion_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pdi_pedido_agrupacion_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pdi_pedido_agrupacion_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pdi_pedido_agrupacion_estado.modificado_por';

	/* Constantes de Atributos Min de BPdiPedidoAgrupacionEstado */ 
	...
	/* Atributos de BPdiPedidoAgrupacionEstado */ 
	private $id;
	...
	/* Getters de BPdiPedidoAgrupacionEstado */ 
	...
	/* Setters de BPdiPedidoAgrupacionEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PdiPedidoAgrupacionEstado();
            $o->setId($fila[PdiPedidoAgrupacionEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdiPedidoAgrupacionEstado */ 	
	...
	/* Cambia el estado de BPdiPedidoAgrupacionEstado */ 	
	...
	/* Save de BPdiPedidoAgrupacionEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_PDI_PEDIDO_AGRUPACION_ID."
                ...
                nextval('pdi_pedido_agrupacion_estado_seq'), 
                ".$this->getPdiPedidoAgrupacionId()."
                    ...
                    ) RETURNING currval('pdi_pedido_agrupacion_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PdiPedidoAgrupacionEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_PDI_PEDIDO_AGRUPACION_ID." = ".$this->getPdiPedidoAgrupacionId()."
	...
	/* Delete de BPdiPedidoAgrupacionEstado */ 	
	...
	public function duplicarPdiPedidoAgrupacionEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdiPedidoAgrupacionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdiPedidoAgrupacionEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdipedidoagrupacionestado = new PdiPedidoAgrupacionEstado();
                    $pdipedidoagrupacionestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdipedidoagrupacionestado->setPdiPedidoAgrupacionId($fila[self::GEN_ATTR_MIN_PDI_PEDIDO_AGRUPACION_ID]);
			$pdipedidoagrupacionestado->setPdiPedidoAgrupacionTipoEstadoId($fila[self::GEN_ATTR_MIN_PDI_PEDIDO_AGRUPACION_TIPO_ESTADO_ID]);
			$pdipedidoagrupacionestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$pdipedidoagrupacionestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$pdipedidoagrupacionestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdipedidoagrupacionestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdipedidoagrupacionestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdipedidoagrupacionestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdipedidoagrupacionestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdiPedidoAgrupacionEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdiPedidoAgrupacionEstado::getPdiPedidoAgrupacionEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdiPedidoAgrupacionEstados para listado de Backend */ 	
	static function getPdiPedidoAgrupacionEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdiPedidoAgrupacionEstado::getPdiPedidoAgrupacionEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdiPedidoAgrupacionEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdiPedidoAgrupacionEstado::getPdiPedidoAgrupacionEstados($paginador, $criterio);
	...
	/* Método getPdiPedidoAgrupacionEstados filtrado para select */ 	
	static function getPdiPedidoAgrupacionEstadosCmbF($paginador = null, $criterio = null){
            $col = PdiPedidoAgrupacionEstado::getPdiPedidoAgrupacionEstados($paginador, $criterio);
	...
	/* Método getPdiPedidoAgrupacionEstados filtrado por una coleccion de objetos foraneos de PdiPedidoAgrupacion */ 	
	static function getPdiPedidoAgrupacionEstadosXPdiPedidoAgrupacions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoAgrupacionEstado::GEN_ATTR_PDI_PEDIDO_AGRUPACION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoAgrupacionEstado::GEN_TABLA);
            $c->addOrden(PdiPedidoAgrupacionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdiPedidoAgrupacionEstado::getPdiPedidoAgrupacionEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getPdiPedidoAgrupacionEstados filtrado por una coleccion de objetos foraneos de PdiPedidoAgrupacionTipoEstado */ 	
	static function getPdiPedidoAgrupacionEstadosXPdiPedidoAgrupacionTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoAgrupacionEstado::GEN_ATTR_PDI_PEDIDO_AGRUPACION_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoAgrupacionEstado::GEN_TABLA);
            $c->addOrden(PdiPedidoAgrupacionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pdi_pedido_agrupacion_estado_adm.php';
            $url_gestion = 'pdi_pedido_agrupacion_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pdi_pedido_agrupacion_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pdi_pedido_agrupacion_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdiPedidoAgrupacionEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdiPedidoAgrupacionEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pdi_pedido_agrupacion_estado_adm');
            }else{

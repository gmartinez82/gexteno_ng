...
class BVtaOrdenVentaEstado
{ 
	
	const SES_PAGINACION = 'adm_vtaordenventaestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaordenventaestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaordenventaestado_criterios';
	
	const GEN_CLASE = 'VtaOrdenVentaEstado';
	const GEN_TABLA = 'vta_orden_venta_estado';
	...
	/* Constantes de Atributos de BVtaOrdenVentaEstado */ 
	const GEN_ATTR_ID = 'vta_orden_venta_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_orden_venta_estado.descripcion';
	const GEN_ATTR_VTA_ORDEN_VENTA_ID = 'vta_orden_venta_estado.vta_orden_venta_id';
	const GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID = 'vta_orden_venta_estado.vta_orden_venta_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'vta_orden_venta_estado.inicial';
	const GEN_ATTR_ACTUAL = 'vta_orden_venta_estado.actual';
	const GEN_ATTR_CODIGO = 'vta_orden_venta_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_orden_venta_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_orden_venta_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_orden_venta_estado.estado';
	const GEN_ATTR_CREADO = 'vta_orden_venta_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_orden_venta_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_orden_venta_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_orden_venta_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaOrdenVentaEstado */ 
	...
	/* Atributos de BVtaOrdenVentaEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaOrdenVentaEstado */ 
	...
	/* Setters de BVtaOrdenVentaEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaOrdenVentaEstado();
            $o->setId($fila[VtaOrdenVentaEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaOrdenVentaEstado */ 	
	...
	/* Cambia el estado de BVtaOrdenVentaEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_orden_venta_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_orden_venta_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaOrdenVentaEstado */ 	
	...
	public function duplicarVtaOrdenVentaEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaOrdenVentaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaOrdenVentaEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaordenventaestado = new VtaOrdenVentaEstado();
                    $vtaordenventaestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaordenventaestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaordenventaestado->setVtaOrdenVentaId($fila[self::GEN_ATTR_MIN_VTA_ORDEN_VENTA_ID]);
			$vtaordenventaestado->setVtaOrdenVentaTipoEstadoId($fila[self::GEN_ATTR_MIN_VTA_ORDEN_VENTA_TIPO_ESTADO_ID]);
			$vtaordenventaestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$vtaordenventaestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$vtaordenventaestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaordenventaestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaordenventaestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaordenventaestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaordenventaestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaordenventaestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaordenventaestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaordenventaestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaOrdenVentaEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaOrdenVentaEstado::getVtaOrdenVentaEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaOrdenVentaEstados para listado de Backend */ 	
	static function getVtaOrdenVentaEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaOrdenVentaEstado::getVtaOrdenVentaEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaOrdenVentaEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaOrdenVentaEstado::getVtaOrdenVentaEstados($paginador, $criterio);
	...
	/* Método getVtaOrdenVentaEstados filtrado para select */ 	
	static function getVtaOrdenVentaEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaOrdenVentaEstado::getVtaOrdenVentaEstados($paginador, $criterio);
	...
	/* Método getVtaOrdenVentaEstados filtrado por una coleccion de objetos foraneos de VtaOrdenVenta */ 	
	static function getVtaOrdenVentaEstadosXVtaOrdenVentas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaOrdenVentaEstado::GEN_TABLA);
            $c->addOrden(VtaOrdenVentaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaOrdenVentaEstado::getVtaOrdenVentaEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaOrdenVentaEstados filtrado por una coleccion de objetos foraneos de VtaOrdenVentaTipoEstado */ 	
	static function getVtaOrdenVentaEstadosXVtaOrdenVentaTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaOrdenVentaEstado::GEN_TABLA);
            $c->addOrden(VtaOrdenVentaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_orden_venta_estado_adm.php';
            $url_gestion = 'vta_orden_venta_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_orden_venta_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_orden_venta_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaOrdenVentaEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaOrdenVentaEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_orden_venta_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaOrdenVentaEstado::GEN_TABLA);
                $c->addOrden(VtaOrdenVentaEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($vta_orden_venta_estados as $vta_orden_venta_estado){
                    $descripcion = $vta_orden_venta_estado->getDescripcion();

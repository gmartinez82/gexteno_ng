...
{ 
	...
	const SES_PAGINACION = 'adm_graldia_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_graldia_paginas_registros';
	const SES_CRITERIOS = 'adm_graldia_criterios';
	
	const GEN_CLASE = 'GralDia';
	const GEN_TABLA = 'gral_dia';
	...
	/* Constantes de Atributos de BGralDia */ 
	const GEN_ATTR_ID = 'gral_dia.id';
	const GEN_ATTR_DESCRIPCION = 'gral_dia.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'gral_dia.descripcion_corta';
	const GEN_ATTR_CODIGO = 'gral_dia.codigo';
	const GEN_ATTR_CODIGO_NUMERO = 'gral_dia.codigo_numero';
	const GEN_ATTR_OBSERVACION = 'gral_dia.observacion';
	const GEN_ATTR_ORDEN = 'gral_dia.orden';
	const GEN_ATTR_ESTADO = 'gral_dia.estado';
	const GEN_ATTR_CREADO = 'gral_dia.creado';
	const GEN_ATTR_CREADO_POR = 'gral_dia.creado_por';
	const GEN_ATTR_MODIFICADO = 'gral_dia.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'gral_dia.modificado_por';

	/* Constantes de Atributos Min de BGralDia */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new GralDia();
            $o->setId($fila[GralDia::GEN_ATTR_MIN_ID], false);
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('gral_dia_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarGralDia(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getGralDias($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = GralDia::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $graldia = new GralDia();
                    $graldia->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $graldia->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$graldia->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$graldia->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$graldia->setCodigoNumero($fila[self::GEN_ATTR_MIN_CODIGO_NUMERO]);
			$graldia->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$graldia->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$graldia->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$graldia->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$graldia->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$graldia->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$graldia->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	/* Método getGralDias Habilitados */ 	
	static function getGralDiasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return GralDia::getGralDias($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getGralDias para listado de Backend */ 	
	static function getGralDiasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return GralDia::getGralDias($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getGralDiasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = GralDia::getGralDias($paginador, $criterio);
	...
	/* Método getGralDias filtrado para select */ 	
	static function getGralDiasCmbF($paginador = null, $criterio = null){
            $col = GralDia::getGralDias($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'gral_dia_adm.php';
            $url_gestion = 'gral_dia_gestion.php';
	...
	public function getGralRutaGralDias($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralRutaGralDia::GEN_ATTR_GRAL_DIA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralRutaGralDiasCmb(){
            $c = new Criterio();
            $c->add(GralRutaGralDia::GEN_ATTR_GRAL_DIA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralRutaGralDia::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralRutas (Coleccion) relacionados a traves de GralRutaGralDia */ 	
	public function getGralRutasXGralRutaGralDia($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralRutaGralDia::GEN_TABLA, GralRutaGralDia::GEN_ATTR_GRAL_RUTA_ID, GralRuta::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralRutas relacionados a traves de GralRutaGralDia */ 	
	public function getCantidadGralRutasXGralRutaGralDia($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralRuta (Objeto) relacionado a traves de GralRutaGralDia */ 	
	public function getGralRutaXGralRutaGralDia($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralRutasXGralRutaGralDia($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPerMovPlanificacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PerMovPlanificacion::GEN_ATTR_GRAL_DIA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPerMovPlanificacionsCmb(){
            $c = new Criterio();
            $c->add(PerMovPlanificacion::GEN_ATTR_GRAL_DIA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PerMovPlanificacion::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralRutas asignados a GralDia */ 	
	...
	/* Método setea nuevos GralRutas asignados al GralDia */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralRuta en el alta de GralDia */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM gral_dia'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'gral_dia';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getGralDias($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getGralDias(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'gral_dia_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(GralDia::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $gral_dias = GralDia::getGralDias(null, $c);

                $arr = array();
                foreach($gral_dias as $gral_dia){
                    $descripcion = $gral_dia->getDescripcion();

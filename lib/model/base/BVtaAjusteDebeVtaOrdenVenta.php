...
class BVtaAjusteDebeVtaOrdenVenta
{ 
	
	const SES_PAGINACION = 'adm_vtaajustedebevtaordenventa_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustedebevtaordenventa_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustedebevtaordenventa_criterios';
	
	const GEN_CLASE = 'VtaAjusteDebeVtaOrdenVenta';
	const GEN_TABLA = 'vta_ajuste_debe_vta_orden_venta';
	...
	/* Constantes de Atributos de BVtaAjusteDebeVtaOrdenVenta */ 
	const GEN_ATTR_ID = 'vta_ajuste_debe_vta_orden_venta.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_debe_vta_orden_venta.descripcion';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ID = 'vta_ajuste_debe_vta_orden_venta.vta_ajuste_debe_id';
	const GEN_ATTR_VTA_ORDEN_VENTA_ID = 'vta_ajuste_debe_vta_orden_venta.vta_orden_venta_id';
	const GEN_ATTR_INS_INSUMO_ID = 'vta_ajuste_debe_vta_orden_venta.ins_insumo_id';
	const GEN_ATTR_INS_UNIDAD_MEDIDA_ID = 'vta_ajuste_debe_vta_orden_venta.ins_unidad_medida_id';
	const GEN_ATTR_GRAL_TIPO_IVA_ID = 'vta_ajuste_debe_vta_orden_venta.gral_tipo_iva_id';
	const GEN_ATTR_IMPORTE_UNITARIO = 'vta_ajuste_debe_vta_orden_venta.importe_unitario';
	const GEN_ATTR_CANTIDAD = 'vta_ajuste_debe_vta_orden_venta.cantidad';
	const GEN_ATTR_INS_INSUMO_COSTO_ID = 'vta_ajuste_debe_vta_orden_venta.ins_insumo_costo_id';
	const GEN_ATTR_IMPORTE_COSTO = 'vta_ajuste_debe_vta_orden_venta.importe_costo';
	const GEN_ATTR_CODIGO = 'vta_ajuste_debe_vta_orden_venta.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_debe_vta_orden_venta.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_debe_vta_orden_venta.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_debe_vta_orden_venta.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_debe_vta_orden_venta.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_debe_vta_orden_venta.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_debe_vta_orden_venta.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_debe_vta_orden_venta.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteDebeVtaOrdenVenta */ 
	...
	/* Atributos de BVtaAjusteDebeVtaOrdenVenta */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteDebeVtaOrdenVenta */ 
	...
	/* Setters de BVtaAjusteDebeVtaOrdenVenta */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteDebeVtaOrdenVenta */ 	
	...
	/* Cambia el estado de BVtaAjusteDebeVtaOrdenVenta */ 	
	...
	/* Save de BVtaAjusteDebeVtaOrdenVenta */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_debe_vta_orden_venta_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_debe_vta_orden_venta_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteDebeVtaOrdenVenta::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteDebeVtaOrdenVenta */ 	
	...
	public function duplicarVtaAjusteDebeVtaOrdenVenta(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteDebeVtaOrdenVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteDebeVtaOrdenVenta::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustedebevtaordenventa = new VtaAjusteDebeVtaOrdenVenta();
                    $vtaajustedebevtaordenventa->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustedebevtaordenventa->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustedebevtaordenventa->setVtaAjusteDebeId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ID]);
			$vtaajustedebevtaordenventa->setVtaOrdenVentaId($fila[self::GEN_ATTR_MIN_VTA_ORDEN_VENTA_ID]);
			$vtaajustedebevtaordenventa->setInsInsumoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_ID]);
			$vtaajustedebevtaordenventa->setInsUnidadMedidaId($fila[self::GEN_ATTR_MIN_INS_UNIDAD_MEDIDA_ID]);
			$vtaajustedebevtaordenventa->setGralTipoIvaId($fila[self::GEN_ATTR_MIN_GRAL_TIPO_IVA_ID]);
			$vtaajustedebevtaordenventa->setImporteUnitario($fila[self::GEN_ATTR_MIN_IMPORTE_UNITARIO]);
			$vtaajustedebevtaordenventa->setCantidad($fila[self::GEN_ATTR_MIN_CANTIDAD]);
			$vtaajustedebevtaordenventa->setInsInsumoCostoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_COSTO_ID]);
			$vtaajustedebevtaordenventa->setImporteCosto($fila[self::GEN_ATTR_MIN_IMPORTE_COSTO]);
			$vtaajustedebevtaordenventa->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustedebevtaordenventa->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustedebevtaordenventa->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustedebevtaordenventa->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustedebevtaordenventa->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustedebevtaordenventa->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustedebevtaordenventa->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustedebevtaordenventa->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteDebeVtaOrdenVentasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteDebeVtaOrdenVenta::getVtaAjusteDebeVtaOrdenVentas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteDebeVtaOrdenVentas para listado de Backend */ 	
	static function getVtaAjusteDebeVtaOrdenVentasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteDebeVtaOrdenVenta::getVtaAjusteDebeVtaOrdenVentas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteDebeVtaOrdenVentasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteDebeVtaOrdenVenta::getVtaAjusteDebeVtaOrdenVentas($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado para select */ 	
	static function getVtaAjusteDebeVtaOrdenVentasCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteDebeVtaOrdenVenta::getVtaAjusteDebeVtaOrdenVentas($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de VtaAjusteDebe */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXVtaAjusteDebes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_VTA_AJUSTE_DEBE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteDebeVtaOrdenVenta::getVtaAjusteDebeVtaOrdenVentas($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de VtaOrdenVenta */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXVtaOrdenVentas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_VTA_ORDEN_VENTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de InsInsumo */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXInsInsumos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_INS_INSUMO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de InsUnidadMedida */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXInsUnidadMedidas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_INS_UNIDAD_MEDIDA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de GralTipoIva */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXGralTipoIvas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_GRAL_TIPO_IVA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaAjusteDebeVtaOrdenVentas filtrado por una coleccion de objetos foraneos de InsInsumoCosto */ 	
	static function getVtaAjusteDebeVtaOrdenVentasXInsInsumoCostos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_INS_INSUMO_COSTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_debe_vta_orden_venta_adm.php';
            $url_gestion = 'vta_ajuste_debe_vta_orden_venta_gestion.php';
	...
	public function getVtaAjusteHaberVtaAjusteDebeVtaOrdenVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteHaberVtaAjusteDebeVtaOrdenVenta::GEN_ATTR_VTA_AJUSTE_DEBE_VTA_ORDEN_VENTA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteHaberVtaAjusteDebeVtaOrdenVentasCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteHaberVtaAjusteDebeVtaOrdenVenta::GEN_ATTR_VTA_AJUSTE_DEBE_VTA_ORDEN_VENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteHaberVtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_debe_vta_orden_venta'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_debe_vta_orden_venta';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteDebeVtaOrdenVentas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteDebeVtaOrdenVentas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_debe_vta_orden_venta_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteDebeVtaOrdenVenta::GEN_TABLA);
                $c->addOrden(VtaAjusteDebeVtaOrdenVenta::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($vta_ajuste_debe_vta_orden_ventas as $vta_ajuste_debe_vta_orden_venta){
                    $descripcion = $vta_ajuste_debe_vta_orden_venta->getDescripcion();

...
class BVtaAjusteHaberVtaTributo
{ 
	
	const SES_PAGINACION = 'adm_vtaajustehabervtatributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustehabervtatributo_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustehabervtatributo_criterios';
	
	const GEN_CLASE = 'VtaAjusteHaberVtaTributo';
	const GEN_TABLA = 'vta_ajuste_haber_vta_tributo';
	...
	/* Constantes de Atributos de BVtaAjusteHaberVtaTributo */ 
	const GEN_ATTR_ID = 'vta_ajuste_haber_vta_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_haber_vta_tributo.descripcion';
	const GEN_ATTR_VTA_AJUSTE_HABER_ID = 'vta_ajuste_haber_vta_tributo.vta_ajuste_haber_id';
	const GEN_ATTR_VTA_TRIBUTO_ID = 'vta_ajuste_haber_vta_tributo.vta_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'vta_ajuste_haber_vta_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'vta_ajuste_haber_vta_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'vta_ajuste_haber_vta_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'vta_ajuste_haber_vta_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'vta_ajuste_haber_vta_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_haber_vta_tributo.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_haber_vta_tributo.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_haber_vta_tributo.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_haber_vta_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_haber_vta_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_haber_vta_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_haber_vta_tributo.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteHaberVtaTributo */ 
	...
	/* Atributos de BVtaAjusteHaberVtaTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteHaberVtaTributo */ 
	...
	/* Setters de BVtaAjusteHaberVtaTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaAjusteHaberVtaTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteHaberVtaTributo */ 	
	...
	/* Cambia el estado de BVtaAjusteHaberVtaTributo */ 	
	...
	/* Save de BVtaAjusteHaberVtaTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_haber_vta_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_haber_vta_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteHaberVtaTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteHaberVtaTributo */ 	
	...
	public function duplicarVtaAjusteHaberVtaTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteHaberVtaTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteHaberVtaTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustehabervtatributo = new VtaAjusteHaberVtaTributo();
                    $vtaajustehabervtatributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustehabervtatributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustehabervtatributo->setVtaAjusteHaberId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_HABER_ID]);
			$vtaajustehabervtatributo->setVtaTributoId($fila[self::GEN_ATTR_MIN_VTA_TRIBUTO_ID]);
			$vtaajustehabervtatributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$vtaajustehabervtatributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$vtaajustehabervtatributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$vtaajustehabervtatributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$vtaajustehabervtatributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustehabervtatributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustehabervtatributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustehabervtatributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustehabervtatributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustehabervtatributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustehabervtatributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustehabervtatributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteHaberVtaTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteHaberVtaTributos para listado de Backend */ 	
	static function getVtaAjusteHaberVtaTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteHaberVtaTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberVtaTributos filtrado para select */ 	
	static function getVtaAjusteHaberVtaTributosCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberVtaTributos filtrado por una coleccion de objetos foraneos de VtaAjusteHaber */ 	
	static function getVtaAjusteHaberVtaTributosXVtaAjusteHabers($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteHaberVtaTributo::GEN_ATTR_VTA_AJUSTE_HABER_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteHaberVtaTributo::GEN_TABLA);
            $c->addOrden(VtaAjusteHaberVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaAjusteHaberVtaTributos filtrado por una coleccion de objetos foraneos de VtaTributo */ 	
	static function getVtaAjusteHaberVtaTributosXVtaTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteHaberVtaTributo::GEN_ATTR_VTA_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteHaberVtaTributo::GEN_TABLA);
            $c->addOrden(VtaAjusteHaberVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_haber_vta_tributo_adm.php';
            $url_gestion = 'vta_ajuste_haber_vta_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_haber_vta_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_haber_vta_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteHaberVtaTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteHaberVtaTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_haber_vta_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteHaberVtaTributo::GEN_TABLA);
                $c->addOrden(VtaAjusteHaberVtaTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_haber_vta_tributos = VtaAjusteHaberVtaTributo::getVtaAjusteHaberVtaTributos(null, $c);

                $arr = array();
                foreach($vta_ajuste_haber_vta_tributos as $vta_ajuste_haber_vta_tributo){
                    $descripcion = $vta_ajuste_haber_vta_tributo->getDescripcion();

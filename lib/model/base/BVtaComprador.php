...
{ 
	...
	const SES_PAGINACION = 'adm_vtacomprador_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtacomprador_paginas_registros';
	const SES_CRITERIOS = 'adm_vtacomprador_criterios';
	
	const GEN_CLASE = 'VtaComprador';
	const GEN_TABLA = 'vta_comprador';
	...
	/* Constantes de Atributos de BVtaComprador */ 
	const GEN_ATTR_ID = 'vta_comprador.id';
	const GEN_ATTR_DESCRIPCION = 'vta_comprador.descripcion';
	const GEN_ATTR_APELLIDO = 'vta_comprador.apellido';
	const GEN_ATTR_NOMBRE = 'vta_comprador.nombre';
	const GEN_ATTR_VTA_TIPO_COMPRADOR_ID = 'vta_comprador.vta_tipo_comprador_id';
	const GEN_ATTR_GEO_LOCALIDAD_ID = 'vta_comprador.geo_localidad_id';
	const GEN_ATTR_EMAIL = 'vta_comprador.email';
	const GEN_ATTR_TELEFONO = 'vta_comprador.telefono';
	const GEN_ATTR_CELULAR = 'vta_comprador.celular';
	const GEN_ATTR_DOMICILIO = 'vta_comprador.domicilio';
	const GEN_ATTR_PORCENTAJE_COMISION = 'vta_comprador.porcentaje_comision';
	const GEN_ATTR_CODIGO = 'vta_comprador.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_comprador.observacion';
	const GEN_ATTR_ORDEN = 'vta_comprador.orden';
	const GEN_ATTR_ESTADO = 'vta_comprador.estado';
	const GEN_ATTR_CREADO = 'vta_comprador.creado';
	const GEN_ATTR_CREADO_POR = 'vta_comprador.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_comprador.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_comprador.modificado_por';

	/* Constantes de Atributos Min de BVtaComprador */ 
	const GEN_ATTR_MIN_ID = 'id';
	const GEN_ATTR_MIN_DESCRIPCION = 'descripcion';
	const GEN_ATTR_MIN_APELLIDO = 'apellido';
	const GEN_ATTR_MIN_NOMBRE = 'nombre';
	const GEN_ATTR_MIN_VTA_TIPO_COMPRADOR_ID = 'vta_tipo_comprador_id';
	...
	/* Atributos de BVtaComprador */ 
	private $id;
	private $descripcion;
	private $apellido;
	private $nombre;
	private $vta_tipo_comprador_id;
	...
	public function getVtaTipoCompradorId(){ if(isset($this->vta_tipo_comprador_id)){ return $this->vta_tipo_comprador_id; }else{ return 'null'; } }
	...
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 SELECT 
				...
				, ".self::GEN_ATTR_VTA_TIPO_COMPRADOR_ID."
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setVtaTipoCompradorId($fila[self::GEN_ATTR_MIN_VTA_TIPO_COMPRADOR_ID]);
	...
	public function setVtaTipoCompradorId($v){ $this->vta_tipo_comprador_id = $v; }
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaComprador();
            $o->setId($fila[VtaComprador::GEN_ATTR_MIN_ID], false);
            
			$o->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$o->setApellido($fila[self::GEN_ATTR_MIN_APELLIDO]);
			$o->setNombre($fila[self::GEN_ATTR_MIN_NOMBRE]);
			$o->setVtaTipoCompradorId($fila[self::GEN_ATTR_MIN_VTA_TIPO_COMPRADOR_ID]);
	...
	/* Cambia el estado de BVtaComprador */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						...
						, ".self::GEN_ATTR_MIN_VTA_TIPO_COMPRADOR_ID."
                ...
                nextval('vta_comprador_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getApellido()."'
						, '".$this->getNombre()."'
						, ".$this->getVtaTipoCompradorId()."
                    ...
                    ) RETURNING currval('vta_comprador_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaComprador(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaCompradors($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaComprador::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtacompradors = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtacomprador = new VtaComprador();
                    $vtacomprador->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtacomprador->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtacomprador->setApellido($fila[self::GEN_ATTR_MIN_APELLIDO]);
			$vtacomprador->setNombre($fila[self::GEN_ATTR_MIN_NOMBRE]);
			$vtacomprador->setVtaTipoCompradorId($fila[self::GEN_ATTR_MIN_VTA_TIPO_COMPRADOR_ID]);
			$vtacomprador->setGeoLocalidadId($fila[self::GEN_ATTR_MIN_GEO_LOCALIDAD_ID]);
			$vtacomprador->setEmail($fila[self::GEN_ATTR_MIN_EMAIL]);
			$vtacomprador->setTelefono($fila[self::GEN_ATTR_MIN_TELEFONO]);
			$vtacomprador->setCelular($fila[self::GEN_ATTR_MIN_CELULAR]);
			$vtacomprador->setDomicilio($fila[self::GEN_ATTR_MIN_DOMICILIO]);
			$vtacomprador->setPorcentajeComision($fila[self::GEN_ATTR_MIN_PORCENTAJE_COMISION]);
			$vtacomprador->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtacomprador->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtacomprador->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtacomprador->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtacomprador->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtacomprador->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtacomprador->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtacomprador->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaCompradorsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaComprador::getVtaCompradors($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaCompradors para listado de Backend */ 	
	static function getVtaCompradorsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaComprador::getVtaCompradors($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaCompradorsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaComprador::getVtaCompradors($paginador, $criterio);
	...
	/* Método getVtaCompradors filtrado para select */ 	
	static function getVtaCompradorsCmbF($paginador = null, $criterio = null){
            $col = VtaComprador::getVtaCompradors($paginador, $criterio);
	...
	/* Método getVtaCompradors filtrado por una coleccion de objetos foraneos de VtaTipoComprador */ 	
	static function getVtaCompradorsXVtaTipoCompradors($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComprador::GEN_ATTR_VTA_TIPO_COMPRADOR_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComprador::GEN_TABLA);
            $c->addOrden(VtaComprador::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaComprador::getVtaCompradors($p, $c);
            foreach($os as $o){
                $os_con_indice[$o->getVtaTipoCompradorId()] = $o;
            }
            return $os_con_indice;
	}	
	

	/* Método getVtaCompradors filtrado por una coleccion de objetos foraneos de GeoLocalidad */ 	
	static function getVtaCompradorsXGeoLocalidads($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComprador::GEN_ATTR_GEO_LOCALIDAD_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComprador::GEN_TABLA);
            $c->addOrden(VtaComprador::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_comprador_adm.php';
            $url_gestion = 'vta_comprador_gestion.php';
	...
	public function getCliCentroPedidos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCentroPedido::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliCentroPedidosCmb(){
            $c = new Criterio();
            $c->add(CliCentroPedido::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCentroPedido::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCliClienteVtaCompradors($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteVtaComprador::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteVtaCompradorsCmb(){
            $c = new Criterio();
            $c->add(CliClienteVtaComprador::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteVtaComprador::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteVtaComprador */ 	
	public function getCliClientesXCliClienteVtaComprador($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(CliClienteVtaComprador::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->addRealJoin(CliClienteVtaComprador::GEN_TABLA, CliClienteVtaComprador::GEN_ATTR_CLI_CLIENTE_ID, CliCliente::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteVtaComprador */ 	
	public function getCantidadCliClientesXCliClienteVtaComprador($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            $c->addSelect(CliCliente::GEN_ATTR_ID);
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteVtaComprador */ 	
	public function getCliClienteXCliClienteVtaComprador($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteVtaComprador($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaPresupuestos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaPresupuesto::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaPresupuestosCmb(){
            $c = new Criterio();
            $c->add(VtaPresupuesto::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaPresupuesto::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaFactura::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaFacturasCmb(){
            $c = new Criterio();
            $c->add(VtaFactura::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFactura::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaComisions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComision::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionsCmb(){
            $c = new Criterio();
            $c->add(VtaComision::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComision::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaComisionVtaFacturaConfiguracions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComisionVtaFacturaConfiguracion::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionVtaFacturaConfiguracionsCmb(){
            $c = new Criterio();
            $c->add(VtaComisionVtaFacturaConfiguracion::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComisionVtaFacturaConfiguracion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaComisionVtaAjusteDebeConfiguracions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComisionVtaAjusteDebeConfiguracion::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionVtaAjusteDebeConfiguracionsCmb(){
            $c = new Criterio();
            $c->add(VtaComisionVtaAjusteDebeConfiguracion::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComisionVtaAjusteDebeConfiguracion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaAjusteDebes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteDebe::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteDebesCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteDebe::GEN_ATTR_VTA_COMPRADOR_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteDebe::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los CliClientes asignados a VtaComprador */ 	
	...
	/* Método setea nuevos CliClientes asignados al VtaComprador */ 	
	public function setCliClienteVtaCompradors($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaCompradorId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion CliCliente en el alta de VtaComprador */ 	
	public function getAltaMostrarBloqueRelacionCliClienteVtaComprador(){
            return true;
	}
	

	/* Metodo que retorna el VtaTipoComprador (Clave Foranea) */ 	
    public function getVtaTipoComprador(){
        $o = new VtaTipoComprador();
        $o->setId($this->getVtaTipoCompradorId());
        return $o;			
    }

	/* Metodo que retorna el VtaTipoComprador (Clave Foranea) en Array */ 	
    public function getVtaTipoCompradorEnArray(&$arr_os){
        if($this->getVtaTipoCompradorId() != 'null'){
            if(isset($arr_os[$this->getVtaTipoCompradorId()])){
                $o = $arr_os[$this->getVtaTipoCompradorId()];
            }else{
                $o = VtaTipoComprador::getOxId($this->getVtaTipoCompradorId());
                if($o){
                    $arr_os[$this->getVtaTipoCompradorId()] = $o;
                }
            }
        }else{
            $o = new VtaTipoComprador();
    ...
    public function getDescripcionVinculante($contexto_solicitante = ''){
        ...
        if($contexto_solicitante != VtaTipoComprador::GEN_CLASE){
            if($this->getVtaTipoComprador()->getDescripcion() != ''){
                $descripcion.= Lang::_lang(VtaTipoComprador::GEN_CLASE, true).':';
                $descripcion.= '<strong>'.$this->getVtaTipoComprador()->getDescripcion().'</strong>';
                $descripcion.= ' - ';
            }
        }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_comprador'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_comprador';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaCompradors($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaCompradors(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'vta_tipo_comprador_id' */ 	
	static function getOxVtaTipoCompradorId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_VTA_TIPO_COMPRADOR_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'vta_tipo_comprador_id' */ 	
	static function getOsxVtaTipoCompradorId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_VTA_TIPO_COMPRADOR_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_comprador_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaComprador::GEN_TABLA);
                $c->addOrden(VtaComprador::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

...
class BPdeOrdenPagoPdeTributo
{ 
	
	const SES_PAGINACION = 'adm_pdeordenpagopdetributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdeordenpagopdetributo_paginas_registros';
	const SES_CRITERIOS = 'adm_pdeordenpagopdetributo_criterios';
	
	const GEN_CLASE = 'PdeOrdenPagoPdeTributo';
	const GEN_TABLA = 'pde_orden_pago_pde_tributo';
	...
	/* Constantes de Atributos de BPdeOrdenPagoPdeTributo */ 
	const GEN_ATTR_ID = 'pde_orden_pago_pde_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'pde_orden_pago_pde_tributo.descripcion';
	const GEN_ATTR_PDE_ORDEN_PAGO_ID = 'pde_orden_pago_pde_tributo.pde_orden_pago_id';
	const GEN_ATTR_PDE_TRIBUTO_ID = 'pde_orden_pago_pde_tributo.pde_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'pde_orden_pago_pde_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'pde_orden_pago_pde_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'pde_orden_pago_pde_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'pde_orden_pago_pde_tributo.alicuota_decimal';
	const GEN_ATTR_FECHA_EMISION = 'pde_orden_pago_pde_tributo.fecha_emision';
	const GEN_ATTR_ANIO = 'pde_orden_pago_pde_tributo.anio';
	const GEN_ATTR_NRO_COMPROBANTE = 'pde_orden_pago_pde_tributo.nro_comprobante';
	const GEN_ATTR_CODIGO = 'pde_orden_pago_pde_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_orden_pago_pde_tributo.observacion';
	const GEN_ATTR_ORDEN = 'pde_orden_pago_pde_tributo.orden';
	const GEN_ATTR_ESTADO = 'pde_orden_pago_pde_tributo.estado';
	const GEN_ATTR_CREADO = 'pde_orden_pago_pde_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'pde_orden_pago_pde_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_orden_pago_pde_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_orden_pago_pde_tributo.modificado_por';

	/* Constantes de Atributos Min de BPdeOrdenPagoPdeTributo */ 
	...
	/* Atributos de BPdeOrdenPagoPdeTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeOrdenPagoPdeTributo */ 
	...
	public function getNroComprobante(){ if(isset($this->nro_comprobante)){ return $this->nro_comprobante; }else{ return 0; } }
	...
	/* Setters de BPdeOrdenPagoPdeTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeOrdenPagoPdeTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeOrdenPagoPdeTributo */ 	
	...
	/* Cambia el estado de BPdeOrdenPagoPdeTributo */ 	
	...
	/* Save de BPdeOrdenPagoPdeTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_orden_pago_pde_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_orden_pago_pde_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".PdeOrdenPagoPdeTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeOrdenPagoPdeTributo */ 	
	...
	public function duplicarPdeOrdenPagoPdeTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeOrdenPagoPdeTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeOrdenPagoPdeTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdeordenpagopdetributo = new PdeOrdenPagoPdeTributo();
                    $pdeordenpagopdetributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdeordenpagopdetributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdeordenpagopdetributo->setPdeOrdenPagoId($fila[self::GEN_ATTR_MIN_PDE_ORDEN_PAGO_ID]);
			$pdeordenpagopdetributo->setPdeTributoId($fila[self::GEN_ATTR_MIN_PDE_TRIBUTO_ID]);
			$pdeordenpagopdetributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$pdeordenpagopdetributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$pdeordenpagopdetributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$pdeordenpagopdetributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$pdeordenpagopdetributo->setFechaEmision($fila[self::GEN_ATTR_MIN_FECHA_EMISION]);
			$pdeordenpagopdetributo->setAnio($fila[self::GEN_ATTR_MIN_ANIO]);
			$pdeordenpagopdetributo->setNroComprobante($fila[self::GEN_ATTR_MIN_NRO_COMPROBANTE]);
			$pdeordenpagopdetributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdeordenpagopdetributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdeordenpagopdetributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdeordenpagopdetributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdeordenpagopdetributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdeordenpagopdetributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdeordenpagopdetributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdeordenpagopdetributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeOrdenPagoPdeTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeOrdenPagoPdeTributos para listado de Backend */ 	
	static function getPdeOrdenPagoPdeTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeOrdenPagoPdeTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos($paginador, $criterio);
	...
	/* Método getPdeOrdenPagoPdeTributos filtrado para select */ 	
	static function getPdeOrdenPagoPdeTributosCmbF($paginador = null, $criterio = null){
            $col = PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos($paginador, $criterio);
	...
	/* Método getPdeOrdenPagoPdeTributos filtrado por una coleccion de objetos foraneos de PdeOrdenPago */ 	
	static function getPdeOrdenPagoPdeTributosXPdeOrdenPagos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeOrdenPagoPdeTributo::GEN_ATTR_PDE_ORDEN_PAGO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeOrdenPagoPdeTributo::GEN_TABLA);
            $c->addOrden(PdeOrdenPagoPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeOrdenPagoPdeTributos filtrado por una coleccion de objetos foraneos de PdeTributo */ 	
	static function getPdeOrdenPagoPdeTributosXPdeTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeOrdenPagoPdeTributo::GEN_ATTR_PDE_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeOrdenPagoPdeTributo::GEN_TABLA);
            $c->addOrden(PdeOrdenPagoPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_orden_pago_pde_tributo_adm.php';
            $url_gestion = 'pde_orden_pago_pde_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_orden_pago_pde_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_orden_pago_pde_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeOrdenPagoPdeTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeOrdenPagoPdeTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_orden_pago_pde_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeOrdenPagoPdeTributo::GEN_TABLA);
                $c->addOrden(PdeOrdenPagoPdeTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_orden_pago_pde_tributos = PdeOrdenPagoPdeTributo::getPdeOrdenPagoPdeTributos(null, $c);

                $arr = array();
                foreach($pde_orden_pago_pde_tributos as $pde_orden_pago_pde_tributo){
                    $descripcion = $pde_orden_pago_pde_tributo->getDescripcion();

...
class BCliClienteTipoEstadoVenta
{ 
	
	const SES_PAGINACION = 'adm_cliclientetipoestadoventa_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclientetipoestadoventa_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclientetipoestadoventa_criterios';
	
	const GEN_CLASE = 'CliClienteTipoEstadoVenta';
	const GEN_TABLA = 'cli_cliente_tipo_estado_venta';
	...
	/* Constantes de Atributos de BCliClienteTipoEstadoVenta */ 
	const GEN_ATTR_ID = 'cli_cliente_tipo_estado_venta.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_tipo_estado_venta.descripcion';
	const GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID = 'cli_cliente_tipo_estado_venta.cli_cliente_tipo_estado_lead_id';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_tipo_estado_venta.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_tipo_estado_venta.descripcion_publica';
	const GEN_ATTR_LEYENDA = 'cli_cliente_tipo_estado_venta.leyenda';
	const GEN_ATTR_ACTIVO = 'cli_cliente_tipo_estado_venta.activo';
	const GEN_ATTR_TERMINAL = 'cli_cliente_tipo_estado_venta.terminal';
	const GEN_ATTR_ANULADO = 'cli_cliente_tipo_estado_venta.anulado';
	const GEN_ATTR_GESTIONABLE = 'cli_cliente_tipo_estado_venta.gestionable';
	const GEN_ATTR_BLOQUEADO = 'cli_cliente_tipo_estado_venta.bloqueado';
	const GEN_ATTR_ANOMALIA = 'cli_cliente_tipo_estado_venta.anomalia';
	const GEN_ATTR_COLOR = 'cli_cliente_tipo_estado_venta.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_tipo_estado_venta.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_tipo_estado_venta.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_tipo_estado_venta.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_tipo_estado_venta.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_tipo_estado_venta.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_tipo_estado_venta.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_tipo_estado_venta.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_tipo_estado_venta.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_tipo_estado_venta.modificado_por';

	/* Constantes de Atributos Min de BCliClienteTipoEstadoVenta */ 
	const GEN_ATTR_MIN_ID = 'id';
	const GEN_ATTR_MIN_DESCRIPCION = 'descripcion';
	const GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID = 'cli_cliente_tipo_estado_lead_id';
	...
	/* Atributos de BCliClienteTipoEstadoVenta */ 
	private $id;
	private $descripcion;
	private $cli_cliente_tipo_estado_lead_id;
	...
	/* Getters de BCliClienteTipoEstadoVenta */ 
	public function getId(){ if(isset($this->id)){ return $this->id; }else{ return ''; } }
	public function getDescripcion(){ if(isset($this->descripcion)){ return $this->descripcion; }else{ return ''; } }
	public function getCliClienteTipoEstadoLeadId(){ if(isset($this->cli_cliente_tipo_estado_lead_id)){ return $this->cli_cliente_tipo_estado_lead_id; }else{ return 'null'; } }
	...
	/* Setters de BCliClienteTipoEstadoVenta */ 	
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 SELECT 
				...
				, ".self::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID."
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setCliClienteTipoEstadoLeadId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID]);
	...
	public function setCliClienteTipoEstadoLeadId($v){ $this->cli_cliente_tipo_estado_lead_id = $v; }
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClienteTipoEstadoVenta::GEN_ATTR_MIN_ID], false);
            
			$o->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$o->setCliClienteTipoEstadoLeadId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID]);
	...
	/* Control de BCliClienteTipoEstadoVenta */ 	
	...
	/* Cambia el estado de BCliClienteTipoEstadoVenta */ 	
	...
	/* Save de BCliClienteTipoEstadoVenta */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						, ".self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID."
                ...
                nextval('cli_cliente_tipo_estado_venta_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getCliClienteTipoEstadoLeadId()."
                    ...
                    ) RETURNING currval('cli_cliente_tipo_estado_venta_seq')";
                ...
                $sql = "
				 ...
				 ".CliClienteTipoEstadoVenta::GEN_TABLA."
				 SET 
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
						, ".self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID." = ".$this->getCliClienteTipoEstadoLeadId()."
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClienteTipoEstadoVenta */ 	
	...
	public function duplicarCliClienteTipoEstadoVenta(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteTipoEstadoVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteTipoEstadoVenta::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclientetipoestadoventas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclientetipoestadoventa = new CliClienteTipoEstadoVenta();
                    $cliclientetipoestadoventa->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclientetipoestadoventa->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclientetipoestadoventa->setCliClienteTipoEstadoLeadId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID]);
			$cliclientetipoestadoventa->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclientetipoestadoventa->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclientetipoestadoventa->setLeyenda($fila[self::GEN_ATTR_MIN_LEYENDA]);
			$cliclientetipoestadoventa->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$cliclientetipoestadoventa->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$cliclientetipoestadoventa->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$cliclientetipoestadoventa->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$cliclientetipoestadoventa->setBloqueado($fila[self::GEN_ATTR_MIN_BLOQUEADO]);
			$cliclientetipoestadoventa->setAnomalia($fila[self::GEN_ATTR_MIN_ANOMALIA]);
			$cliclientetipoestadoventa->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclientetipoestadoventa->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclientetipoestadoventa->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclientetipoestadoventa->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclientetipoestadoventa->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclientetipoestadoventa->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclientetipoestadoventa->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclientetipoestadoventa->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclientetipoestadoventa->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclientetipoestadoventa->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclientetipoestadoventas[] = $cliclientetipoestadoventa;
		}
		
		return $cliclientetipoestadoventas;
	}	
	

	/* Método getCliClienteTipoEstadoVentas Habilitados */ 	
	static function getCliClienteTipoEstadoVentasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteTipoEstadoVentas para listado de Backend */ 	
	static function getCliClienteTipoEstadoVentasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteTipoEstadoVentasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas($paginador, $criterio);
	...
	/* Método getCliClienteTipoEstadoVentas filtrado para select */ 	
	static function getCliClienteTipoEstadoVentasCmbF($paginador = null, $criterio = null){
            $col = CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas($paginador, $criterio);
	...
	/* Método getCliClienteTipoEstadoVentas filtrado por una coleccion de objetos foraneos de CliClienteTipoEstadoLead */ 	
	static function getCliClienteTipoEstadoVentasXCliClienteTipoEstadoLeads($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(CliClienteTipoEstadoVenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(CliClienteTipoEstadoVenta::GEN_TABLA);
            $c->addOrden(CliClienteTipoEstadoVenta::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas($p, $c);
            foreach($os as $o){
                $os_con_indice[$o->getCliClienteTipoEstadoLeadId()] = $o;
            }
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_tipo_estado_venta_adm.php';
            $url_gestion = 'cli_cliente_tipo_estado_venta_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_VENTA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_VENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCliClienteEstadoVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteEstadoVenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_VENTA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteEstadoVentasCmb(){
            $c = new Criterio();
            $c->add(CliClienteEstadoVenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_VENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteEstadoVenta::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteEstadoVenta */ 	
	public function getCliClientesXCliClienteEstadoVenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteEstadoVenta */ 	
	public function getCantidadCliClientesXCliClienteEstadoVenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteEstadoVenta */ 	
	public function getCliClienteXCliClienteEstadoVenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteEstadoVenta($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna el CliClienteTipoEstadoLead (Clave Foranea) */ 	
    public function getCliClienteTipoEstadoLead(){
        $o = new CliClienteTipoEstadoLead();
        $o->setId($this->getCliClienteTipoEstadoLeadId());
        return $o;			
    }

	/* Metodo que retorna el CliClienteTipoEstadoLead (Clave Foranea) en Array */ 	
    public function getCliClienteTipoEstadoLeadEnArray(&$arr_os){
        if($this->getCliClienteTipoEstadoLeadId() != 'null'){
            if(isset($arr_os[$this->getCliClienteTipoEstadoLeadId()])){
                $o = $arr_os[$this->getCliClienteTipoEstadoLeadId()];
            }else{
                $o = CliClienteTipoEstadoLead::getOxId($this->getCliClienteTipoEstadoLeadId());
                if($o){
                    $arr_os[$this->getCliClienteTipoEstadoLeadId()] = $o;
                }
            }
        }else{
            $o = new CliClienteTipoEstadoLead();
    ...
    public function getDescripcionVinculante($contexto_solicitante = ''){
        ...
        if($contexto_solicitante != CliClienteTipoEstadoLead::GEN_CLASE){
            if($this->getCliClienteTipoEstadoLead()->getDescripcion() != ''){
                $descripcion.= Lang::_lang(CliClienteTipoEstadoLead::GEN_CLASE, true).':';
                $descripcion.= '<strong>'.$this->getCliClienteTipoEstadoLead()->getDescripcion().'</strong>';
                $descripcion.= ' - ';
            }
        }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_tipo_estado_venta'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_tipo_estado_venta';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoVentas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoVentas(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'cli_cliente_tipo_estado_lead_id' */ 	
	static function getOxCliClienteTipoEstadoLeadId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'cli_cliente_tipo_estado_lead_id' */ 	
	static function getOsxCliClienteTipoEstadoLeadId($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_LEAD_ID, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_tipo_estado_venta_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(CliClienteTipoEstadoVenta::GEN_TABLA);
                $c->addOrden(CliClienteTipoEstadoVenta::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_tipo_estado_ventas = CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentas(null, $c);

                $arr = array();
                foreach($cli_cliente_tipo_estado_ventas as $cli_cliente_tipo_estado_venta){
                    $descripcion = $cli_cliente_tipo_estado_venta->getDescripcion();

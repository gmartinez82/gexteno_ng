...
class BVtaOrdenVentaTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_vtaordenventatipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaordenventatipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaordenventatipoestado_criterios';
	
	const GEN_CLASE = 'VtaOrdenVentaTipoEstado';
	const GEN_TABLA = 'vta_orden_venta_tipo_estado';
	...
	/* Constantes de Atributos de BVtaOrdenVentaTipoEstado */ 
	const GEN_ATTR_ID = 'vta_orden_venta_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_orden_venta_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'vta_orden_venta_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'vta_orden_venta_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'vta_orden_venta_tipo_estado.terminal';
	const GEN_ATTR_OBSERVACION = 'vta_orden_venta_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_orden_venta_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_orden_venta_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'vta_orden_venta_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_orden_venta_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_orden_venta_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_orden_venta_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaOrdenVentaTipoEstado */ 
	...
	/* Atributos de BVtaOrdenVentaTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BVtaOrdenVentaTipoEstado */ 
	...
	/* Setters de BVtaOrdenVentaTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaOrdenVentaTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaOrdenVentaTipoEstado */ 	
	...
	/* Cambia el estado de BVtaOrdenVentaTipoEstado */ 	
	...
	/* Save de BVtaOrdenVentaTipoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_orden_venta_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('vta_orden_venta_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".VtaOrdenVentaTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaOrdenVentaTipoEstado */ 	
	...
	public function duplicarVtaOrdenVentaTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaOrdenVentaTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaOrdenVentaTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtaordenventatipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaordenventatipoestado = new VtaOrdenVentaTipoEstado();
                    $vtaordenventatipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaordenventatipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaordenventatipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaordenventatipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$vtaordenventatipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$vtaordenventatipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaordenventatipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaordenventatipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaordenventatipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaordenventatipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaordenventatipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaordenventatipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtaordenventatipoestados[] = $vtaordenventatipoestado;
		}
		
		return $vtaordenventatipoestados;
	}	
	

	/* Método getVtaOrdenVentaTipoEstados Habilitados */ 	
	static function getVtaOrdenVentaTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaOrdenVentaTipoEstado::getVtaOrdenVentaTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaOrdenVentaTipoEstados para listado de Backend */ 	
	static function getVtaOrdenVentaTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaOrdenVentaTipoEstado::getVtaOrdenVentaTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaOrdenVentaTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaOrdenVentaTipoEstado::getVtaOrdenVentaTipoEstados($paginador, $criterio);
	...
	/* Método getVtaOrdenVentaTipoEstados filtrado para select */ 	
	static function getVtaOrdenVentaTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaOrdenVentaTipoEstado::getVtaOrdenVentaTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_orden_venta_tipo_estado_adm.php';
            $url_gestion = 'vta_orden_venta_tipo_estado_gestion.php';
	...
	public function getVtaOrdenVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaOrdenVenta::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaOrdenVentasCmb(){
            $c = new Criterio();
            $c->add(VtaOrdenVenta::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaOrdenVenta::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaOrdenVentaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaOrdenVentaEstadosCmb(){
            $c = new Criterio();
            $c->add(VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaOrdenVentaEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaOrdenVentas (Coleccion) relacionados a traves de VtaOrdenVentaEstado */ 	
	public function getVtaOrdenVentasXVtaOrdenVentaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(VtaOrdenVenta::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaOrdenVenta::GEN_TABLA);
            $c->addRealJoin(VtaOrdenVentaEstado::GEN_TABLA, VtaOrdenVentaEstado::GEN_ATTR_VTA_ORDEN_VENTA_ID, VtaOrdenVenta::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaOrdenVentas relacionados a traves de VtaOrdenVentaEstado */ 	
	public function getCantidadVtaOrdenVentasXVtaOrdenVentaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaOrdenVenta (Objeto) relacionado a traves de VtaOrdenVentaEstado */ 	
	public function getVtaOrdenVentaXVtaOrdenVentaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaOrdenVentasXVtaOrdenVentaEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_orden_venta_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_orden_venta_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaOrdenVentaTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaOrdenVentaTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_orden_venta_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaOrdenVentaTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_orden_venta_tipo_estados = VtaOrdenVentaTipoEstado::getVtaOrdenVentaTipoEstados(null, $c);

                $arr = array();
                foreach($vta_orden_venta_tipo_estados as $vta_orden_venta_tipo_estado){
                    $descripcion = $vta_orden_venta_tipo_estado->getDescripcion();

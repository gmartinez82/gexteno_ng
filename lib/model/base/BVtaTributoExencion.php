...
class BVtaTributoExencion
{ 
	
	const SES_PAGINACION = 'adm_vtatributoexencion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtatributoexencion_paginas_registros';
	const SES_CRITERIOS = 'adm_vtatributoexencion_criterios';
	
	const GEN_CLASE = 'VtaTributoExencion';
	const GEN_TABLA = 'vta_tributo_exencion';
	...
	/* Constantes de Atributos de BVtaTributoExencion */ 
	const GEN_ATTR_ID = 'vta_tributo_exencion.id';
	const GEN_ATTR_DESCRIPCION = 'vta_tributo_exencion.descripcion';
	const GEN_ATTR_VTA_TRIBUTO_ID = 'vta_tributo_exencion.vta_tributo_id';
	const GEN_ATTR_CLI_CLIENTE_ID = 'vta_tributo_exencion.cli_cliente_id';
	const GEN_ATTR_FECHA_INICIO = 'vta_tributo_exencion.fecha_inicio';
	const GEN_ATTR_FECHA_FIN = 'vta_tributo_exencion.fecha_fin';
	const GEN_ATTR_CODIGO = 'vta_tributo_exencion.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_tributo_exencion.observacion';
	const GEN_ATTR_ORDEN = 'vta_tributo_exencion.orden';
	const GEN_ATTR_ESTADO = 'vta_tributo_exencion.estado';
	const GEN_ATTR_CREADO = 'vta_tributo_exencion.creado';
	const GEN_ATTR_CREADO_POR = 'vta_tributo_exencion.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_tributo_exencion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_tributo_exencion.modificado_por';

	/* Constantes de Atributos Min de BVtaTributoExencion */ 
	...
	/* Atributos de BVtaTributoExencion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaTributoExencion */ 
	...
	/* Setters de BVtaTributoExencion */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaTributoExencion();
            $o->setId($fila[VtaTributoExencion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaTributoExencion */ 	
	...
	/* Cambia el estado de BVtaTributoExencion */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_tributo_exencion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_tributo_exencion_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaTributoExencion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaTributoExencions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaTributoExencion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtatributoexencion = new VtaTributoExencion();
                    $vtatributoexencion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtatributoexencion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtatributoexencion->setVtaTributoId($fila[self::GEN_ATTR_MIN_VTA_TRIBUTO_ID]);
			$vtatributoexencion->setCliClienteId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_ID]);
			$vtatributoexencion->setFechaInicio($fila[self::GEN_ATTR_MIN_FECHA_INICIO]);
			$vtatributoexencion->setFechaFin($fila[self::GEN_ATTR_MIN_FECHA_FIN]);
			$vtatributoexencion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtatributoexencion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtatributoexencion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtatributoexencion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtatributoexencion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtatributoexencion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtatributoexencion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtatributoexencion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaTributoExencionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaTributoExencion::getVtaTributoExencions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaTributoExencions para listado de Backend */ 	
	static function getVtaTributoExencionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaTributoExencion::getVtaTributoExencions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaTributoExencionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaTributoExencion::getVtaTributoExencions($paginador, $criterio);
	...
	/* Método getVtaTributoExencions filtrado para select */ 	
	static function getVtaTributoExencionsCmbF($paginador = null, $criterio = null){
            $col = VtaTributoExencion::getVtaTributoExencions($paginador, $criterio);
	...
	/* Método getVtaTributoExencions filtrado por una coleccion de objetos foraneos de VtaTributo */ 	
	static function getVtaTributoExencionsXVtaTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaTributoExencion::GEN_ATTR_VTA_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaTributoExencion::GEN_TABLA);
            $c->addOrden(VtaTributoExencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaTributoExencion::getVtaTributoExencions($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaTributoExencions filtrado por una coleccion de objetos foraneos de CliCliente */ 	
	static function getVtaTributoExencionsXCliClientes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaTributoExencion::GEN_ATTR_CLI_CLIENTE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaTributoExencion::GEN_TABLA);
            $c->addOrden(VtaTributoExencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_tributo_exencion_adm.php';
            $url_gestion = 'vta_tributo_exencion_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_tributo_exencion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_tributo_exencion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaTributoExencions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaTributoExencions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_tributo_exencion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaTributoExencion::GEN_TABLA);
                $c->addOrden(VtaTributoExencion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_tributo_exencions = VtaTributoExencion::getVtaTributoExencions(null, $c);

                $arr = array();
                foreach($vta_tributo_exencions as $vta_tributo_exencion){
                    $descripcion = $vta_tributo_exencion->getDescripcion();

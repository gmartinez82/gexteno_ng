...
class BCliClienteTipoEstadoSatisfaccion
{ 
	
	const SES_PAGINACION = 'adm_cliclientetipoestadosatisfaccion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclientetipoestadosatisfaccion_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclientetipoestadosatisfaccion_criterios';
	
	const GEN_CLASE = 'CliClienteTipoEstadoSatisfaccion';
	const GEN_TABLA = 'cli_cliente_tipo_estado_satisfaccion';
	...
	/* Constantes de Atributos de BCliClienteTipoEstadoSatisfaccion */ 
	const GEN_ATTR_ID = 'cli_cliente_tipo_estado_satisfaccion.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_tipo_estado_satisfaccion.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_tipo_estado_satisfaccion.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_tipo_estado_satisfaccion.descripcion_publica';
	const GEN_ATTR_LEYENDA = 'cli_cliente_tipo_estado_satisfaccion.leyenda';
	const GEN_ATTR_ACTIVO = 'cli_cliente_tipo_estado_satisfaccion.activo';
	const GEN_ATTR_TERMINAL = 'cli_cliente_tipo_estado_satisfaccion.terminal';
	const GEN_ATTR_ANULADO = 'cli_cliente_tipo_estado_satisfaccion.anulado';
	const GEN_ATTR_GESTIONABLE = 'cli_cliente_tipo_estado_satisfaccion.gestionable';
	const GEN_ATTR_BLOQUEADO = 'cli_cliente_tipo_estado_satisfaccion.bloqueado';
	const GEN_ATTR_ANOMALIA = 'cli_cliente_tipo_estado_satisfaccion.anomalia';
	const GEN_ATTR_COLOR = 'cli_cliente_tipo_estado_satisfaccion.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_tipo_estado_satisfaccion.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_tipo_estado_satisfaccion.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_tipo_estado_satisfaccion.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_tipo_estado_satisfaccion.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_tipo_estado_satisfaccion.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_tipo_estado_satisfaccion.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_tipo_estado_satisfaccion.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_tipo_estado_satisfaccion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_tipo_estado_satisfaccion.modificado_por';

	/* Constantes de Atributos Min de BCliClienteTipoEstadoSatisfaccion */ 
	...
	/* Atributos de BCliClienteTipoEstadoSatisfaccion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BCliClienteTipoEstadoSatisfaccion */ 
	...
	/* Setters de BCliClienteTipoEstadoSatisfaccion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClienteTipoEstadoSatisfaccion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BCliClienteTipoEstadoSatisfaccion */ 	
	...
	/* Cambia el estado de BCliClienteTipoEstadoSatisfaccion */ 	
	...
	/* Save de BCliClienteTipoEstadoSatisfaccion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_tipo_estado_satisfaccion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_tipo_estado_satisfaccion_seq')";
                ...
                $sql = "
				 ...
				 ".CliClienteTipoEstadoSatisfaccion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClienteTipoEstadoSatisfaccion */ 	
	...
	public function duplicarCliClienteTipoEstadoSatisfaccion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteTipoEstadoSatisfaccions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteTipoEstadoSatisfaccion::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclientetipoestadosatisfaccions = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclientetipoestadosatisfaccion = new CliClienteTipoEstadoSatisfaccion();
                    $cliclientetipoestadosatisfaccion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclientetipoestadosatisfaccion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclientetipoestadosatisfaccion->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclientetipoestadosatisfaccion->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclientetipoestadosatisfaccion->setLeyenda($fila[self::GEN_ATTR_MIN_LEYENDA]);
			$cliclientetipoestadosatisfaccion->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$cliclientetipoestadosatisfaccion->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$cliclientetipoestadosatisfaccion->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$cliclientetipoestadosatisfaccion->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$cliclientetipoestadosatisfaccion->setBloqueado($fila[self::GEN_ATTR_MIN_BLOQUEADO]);
			$cliclientetipoestadosatisfaccion->setAnomalia($fila[self::GEN_ATTR_MIN_ANOMALIA]);
			$cliclientetipoestadosatisfaccion->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclientetipoestadosatisfaccion->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclientetipoestadosatisfaccion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclientetipoestadosatisfaccion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclientetipoestadosatisfaccion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclientetipoestadosatisfaccion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclientetipoestadosatisfaccion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclientetipoestadosatisfaccion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclientetipoestadosatisfaccion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclientetipoestadosatisfaccion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclientetipoestadosatisfaccions[] = $cliclientetipoestadosatisfaccion;
		}
		
		return $cliclientetipoestadosatisfaccions;
	}	
	

	/* Método getCliClienteTipoEstadoSatisfaccions Habilitados */ 	
	static function getCliClienteTipoEstadoSatisfaccionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteTipoEstadoSatisfaccion::getCliClienteTipoEstadoSatisfaccions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteTipoEstadoSatisfaccions para listado de Backend */ 	
	static function getCliClienteTipoEstadoSatisfaccionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteTipoEstadoSatisfaccion::getCliClienteTipoEstadoSatisfaccions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteTipoEstadoSatisfaccionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteTipoEstadoSatisfaccion::getCliClienteTipoEstadoSatisfaccions($paginador, $criterio);
	...
	/* Método getCliClienteTipoEstadoSatisfaccions filtrado para select */ 	
	static function getCliClienteTipoEstadoSatisfaccionsCmbF($paginador = null, $criterio = null){
            $col = CliClienteTipoEstadoSatisfaccion::getCliClienteTipoEstadoSatisfaccions($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_tipo_estado_satisfaccion_adm.php';
            $url_gestion = 'cli_cliente_tipo_estado_satisfaccion_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_SATISFACCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_SATISFACCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCliClienteEstadoSatisfaccions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteEstadoSatisfaccion::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_SATISFACCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteEstadoSatisfaccionsCmb(){
            $c = new Criterio();
            $c->add(CliClienteEstadoSatisfaccion::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_SATISFACCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteEstadoSatisfaccion::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteEstadoSatisfaccion */ 	
	public function getCliClientesXCliClienteEstadoSatisfaccion($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(CliClienteEstadoSatisfaccion::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_SATISFACCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->addRealJoin(CliClienteEstadoSatisfaccion::GEN_TABLA, CliClienteEstadoSatisfaccion::GEN_ATTR_CLI_CLIENTE_ID, CliCliente::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteEstadoSatisfaccion */ 	
	public function getCantidadCliClientesXCliClienteEstadoSatisfaccion($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteEstadoSatisfaccion */ 	
	public function getCliClienteXCliClienteEstadoSatisfaccion($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteEstadoSatisfaccion($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_tipo_estado_satisfaccion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_tipo_estado_satisfaccion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoSatisfaccions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoSatisfaccions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_tipo_estado_satisfaccion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(CliClienteTipoEstadoSatisfaccion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_tipo_estado_satisfaccions = CliClienteTipoEstadoSatisfaccion::getCliClienteTipoEstadoSatisfaccions(null, $c);

                $arr = array();
                foreach($cli_cliente_tipo_estado_satisfaccions as $cli_cliente_tipo_estado_satisfaccion){
                    $descripcion = $cli_cliente_tipo_estado_satisfaccion->getDescripcion();

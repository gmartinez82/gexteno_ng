...
class BPdeReciboTipoPago
{ 
	
	const SES_PAGINACION = 'adm_pderecibotipopago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecibotipopago_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecibotipopago_criterios';
	
	const GEN_CLASE = 'PdeReciboTipoPago';
	const GEN_TABLA = 'pde_recibo_tipo_pago';
	...
	/* Constantes de Atributos de BPdeReciboTipoPago */ 
	const GEN_ATTR_ID = 'pde_recibo_tipo_pago.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recibo_tipo_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'pde_recibo_tipo_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'pde_recibo_tipo_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'pde_recibo_tipo_pago.codigo_min';
	const GEN_ATTR_COLOR = 'pde_recibo_tipo_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'pde_recibo_tipo_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'pde_recibo_tipo_pago.observacion';
	const GEN_ATTR_ORDEN = 'pde_recibo_tipo_pago.orden';
	const GEN_ATTR_ESTADO = 'pde_recibo_tipo_pago.estado';
	const GEN_ATTR_CREADO = 'pde_recibo_tipo_pago.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recibo_tipo_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recibo_tipo_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recibo_tipo_pago.modificado_por';

	/* Constantes de Atributos Min de BPdeReciboTipoPago */ 
	...
	/* Atributos de BPdeReciboTipoPago */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeReciboTipoPago::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BPdeReciboTipoPago */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recibo_tipo_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_recibo_tipo_pago_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeReciboTipoPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeReciboTipoPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeReciboTipoPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$pderecibotipopagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecibotipopago = new PdeReciboTipoPago();
                    $pderecibotipopago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecibotipopago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecibotipopago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$pderecibotipopago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecibotipopago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$pderecibotipopago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$pderecibotipopago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$pderecibotipopago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecibotipopago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecibotipopago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecibotipopago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecibotipopago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecibotipopago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecibotipopago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pderecibotipopagos[] = $pderecibotipopago;
		}
		
		return $pderecibotipopagos;
	}	
	

	/* Método getPdeReciboTipoPagos Habilitados */ 	
	static function getPdeReciboTipoPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeReciboTipoPago::getPdeReciboTipoPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeReciboTipoPagos para listado de Backend */ 	
	static function getPdeReciboTipoPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeReciboTipoPago::getPdeReciboTipoPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeReciboTipoPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeReciboTipoPago::getPdeReciboTipoPagos($paginador, $criterio);
	...
	/* Método getPdeReciboTipoPagos filtrado para select */ 	
	static function getPdeReciboTipoPagosCmbF($paginador = null, $criterio = null){
            $col = PdeReciboTipoPago::getPdeReciboTipoPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recibo_tipo_pago_adm.php';
            $url_gestion = 'pde_recibo_tipo_pago_gestion.php';
	...
	public function getPdeRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecibosCmb(){
            $c = new Criterio();
            $c->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecibo::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recibo_tipo_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recibo_tipo_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeReciboTipoPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeReciboTipoPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recibo_tipo_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeReciboTipoPago::GEN_TABLA);
                $c->addOrden(PdeReciboTipoPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recibo_tipo_pagos = PdeReciboTipoPago::getPdeReciboTipoPagos(null, $c);

                $arr = array();
                foreach($pde_recibo_tipo_pagos as $pde_recibo_tipo_pago){
                    $descripcion = $pde_recibo_tipo_pago->getDescripcion();

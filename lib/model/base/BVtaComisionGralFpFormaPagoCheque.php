...
class BVtaComisionGralFpFormaPagoCheque
{ 
	
	const SES_PAGINACION = 'adm_vtacomisiongralfpformapagocheque_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtacomisiongralfpformapagocheque_paginas_registros';
	const SES_CRITERIOS = 'adm_vtacomisiongralfpformapagocheque_criterios';
	
	const GEN_CLASE = 'VtaComisionGralFpFormaPagoCheque';
	const GEN_TABLA = 'vta_comision_gral_fp_forma_pago_cheque';
	...
	/* Constantes de Atributos de BVtaComisionGralFpFormaPagoCheque */ 
	const GEN_ATTR_ID = 'vta_comision_gral_fp_forma_pago_cheque.id';
	const GEN_ATTR_DESCRIPCION = 'vta_comision_gral_fp_forma_pago_cheque.descripcion';
	const GEN_ATTR_VTA_COMISION_ID = 'vta_comision_gral_fp_forma_pago_cheque.vta_comision_id';
	const GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID = 'vta_comision_gral_fp_forma_pago_cheque.vta_comision_gral_fp_forma_pago_id';
	const GEN_ATTR_GRAL_BANCO_ID = 'vta_comision_gral_fp_forma_pago_cheque.gral_banco_id';
	const GEN_ATTR_NUMERO_CHEQUE = 'vta_comision_gral_fp_forma_pago_cheque.numero_cheque';
	const GEN_ATTR_FECHA_EMISION = 'vta_comision_gral_fp_forma_pago_cheque.fecha_emision';
	const GEN_ATTR_FECHA_COBRO = 'vta_comision_gral_fp_forma_pago_cheque.fecha_cobro';
	const GEN_ATTR_FIRMANTE = 'vta_comision_gral_fp_forma_pago_cheque.firmante';
	const GEN_ATTR_ENTREGADOR = 'vta_comision_gral_fp_forma_pago_cheque.entregador';
	const GEN_ATTR_CODIGO = 'vta_comision_gral_fp_forma_pago_cheque.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_comision_gral_fp_forma_pago_cheque.observacion';
	const GEN_ATTR_ORDEN = 'vta_comision_gral_fp_forma_pago_cheque.orden';
	const GEN_ATTR_ESTADO = 'vta_comision_gral_fp_forma_pago_cheque.estado';
	const GEN_ATTR_CREADO = 'vta_comision_gral_fp_forma_pago_cheque.creado';
	const GEN_ATTR_CREADO_POR = 'vta_comision_gral_fp_forma_pago_cheque.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_comision_gral_fp_forma_pago_cheque.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_comision_gral_fp_forma_pago_cheque.modificado_por';

	/* Constantes de Atributos Min de BVtaComisionGralFpFormaPagoCheque */ 
	...
	/* Atributos de BVtaComisionGralFpFormaPagoCheque */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaComisionGralFpFormaPagoCheque */ 
	...
	/* Setters de BVtaComisionGralFpFormaPagoCheque */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaComisionGralFpFormaPagoCheque();
            $o->setId($fila[VtaComisionGralFpFormaPagoCheque::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaComisionGralFpFormaPagoCheque */ 	
	...
	/* Cambia el estado de BVtaComisionGralFpFormaPagoCheque */ 	
	...
	/* Save de BVtaComisionGralFpFormaPagoCheque */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_comision_gral_fp_forma_pago_cheque_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_comision_gral_fp_forma_pago_cheque_seq')";
                ...
                $sql = "
				 ...
				 ".VtaComisionGralFpFormaPagoCheque::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaComisionGralFpFormaPagoCheque */ 	
	...
	public function duplicarVtaComisionGralFpFormaPagoCheque(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaComisionGralFpFormaPagoCheques($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaComisionGralFpFormaPagoCheque::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtacomisiongralfpformapagocheque = new VtaComisionGralFpFormaPagoCheque();
                    $vtacomisiongralfpformapagocheque->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtacomisiongralfpformapagocheque->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtacomisiongralfpformapagocheque->setVtaComisionId($fila[self::GEN_ATTR_MIN_VTA_COMISION_ID]);
			$vtacomisiongralfpformapagocheque->setVtaComisionGralFpFormaPagoId($fila[self::GEN_ATTR_MIN_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID]);
			$vtacomisiongralfpformapagocheque->setGralBancoId($fila[self::GEN_ATTR_MIN_GRAL_BANCO_ID]);
			$vtacomisiongralfpformapagocheque->setNumeroCheque($fila[self::GEN_ATTR_MIN_NUMERO_CHEQUE]);
			$vtacomisiongralfpformapagocheque->setFechaEmision($fila[self::GEN_ATTR_MIN_FECHA_EMISION]);
			$vtacomisiongralfpformapagocheque->setFechaCobro($fila[self::GEN_ATTR_MIN_FECHA_COBRO]);
			$vtacomisiongralfpformapagocheque->setFirmante($fila[self::GEN_ATTR_MIN_FIRMANTE]);
			$vtacomisiongralfpformapagocheque->setEntregador($fila[self::GEN_ATTR_MIN_ENTREGADOR]);
			$vtacomisiongralfpformapagocheque->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtacomisiongralfpformapagocheque->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtacomisiongralfpformapagocheque->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtacomisiongralfpformapagocheque->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtacomisiongralfpformapagocheque->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtacomisiongralfpformapagocheque->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtacomisiongralfpformapagocheque->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtacomisiongralfpformapagocheque->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaComisionGralFpFormaPagoChequesHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaComisionGralFpFormaPagoCheques para listado de Backend */ 	
	static function getVtaComisionGralFpFormaPagoChequesDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaComisionGralFpFormaPagoChequesCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques($paginador, $criterio);
	...
	/* Método getVtaComisionGralFpFormaPagoCheques filtrado para select */ 	
	static function getVtaComisionGralFpFormaPagoChequesCmbF($paginador = null, $criterio = null){
            $col = VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques($paginador, $criterio);
	...
	/* Método getVtaComisionGralFpFormaPagoCheques filtrado por una coleccion de objetos foraneos de VtaComision */ 	
	static function getVtaComisionGralFpFormaPagoChequesXVtaComisions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_VTA_COMISION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionGralFpFormaPagoCheque::GEN_TABLA);
            $c->addOrden(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaComisionGralFpFormaPagoCheques filtrado por una coleccion de objetos foraneos de VtaComisionGralFpFormaPago */ 	
	static function getVtaComisionGralFpFormaPagoChequesXVtaComisionGralFpFormaPagos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionGralFpFormaPagoCheque::GEN_TABLA);
            $c->addOrden(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaComisionGralFpFormaPagoCheques filtrado por una coleccion de objetos foraneos de GralBanco */ 	
	static function getVtaComisionGralFpFormaPagoChequesXGralBancos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_GRAL_BANCO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionGralFpFormaPagoCheque::GEN_TABLA);
            $c->addOrden(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_comision_gral_fp_forma_pago_cheque_adm.php';
            $url_gestion = 'vta_comision_gral_fp_forma_pago_cheque_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_comision_gral_fp_forma_pago_cheque'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_comision_gral_fp_forma_pago_cheque';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaComisionGralFpFormaPagoCheques($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaComisionGralFpFormaPagoCheques(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_comision_gral_fp_forma_pago_cheque_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaComisionGralFpFormaPagoCheque::GEN_TABLA);
                $c->addOrden(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_comision_gral_fp_forma_pago_cheques = VtaComisionGralFpFormaPagoCheque::getVtaComisionGralFpFormaPagoCheques(null, $c);

                $arr = array();
                foreach($vta_comision_gral_fp_forma_pago_cheques as $vta_comision_gral_fp_forma_pago_cheque){
                    $descripcion = $vta_comision_gral_fp_forma_pago_cheque->getDescripcion();

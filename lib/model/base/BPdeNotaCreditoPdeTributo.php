...
class BPdeNotaCreditoPdeTributo
{ 
	
	const SES_PAGINACION = 'adm_pdenotacreditopdetributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdenotacreditopdetributo_paginas_registros';
	const SES_CRITERIOS = 'adm_pdenotacreditopdetributo_criterios';
	
	const GEN_CLASE = 'PdeNotaCreditoPdeTributo';
	const GEN_TABLA = 'pde_nota_credito_pde_tributo';
	...
	/* Constantes de Atributos de BPdeNotaCreditoPdeTributo */ 
	const GEN_ATTR_ID = 'pde_nota_credito_pde_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'pde_nota_credito_pde_tributo.descripcion';
	const GEN_ATTR_PDE_NOTA_CREDITO_ID = 'pde_nota_credito_pde_tributo.pde_nota_credito_id';
	const GEN_ATTR_PDE_TRIBUTO_ID = 'pde_nota_credito_pde_tributo.pde_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'pde_nota_credito_pde_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'pde_nota_credito_pde_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'pde_nota_credito_pde_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'pde_nota_credito_pde_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'pde_nota_credito_pde_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_nota_credito_pde_tributo.observacion';
	const GEN_ATTR_ORDEN = 'pde_nota_credito_pde_tributo.orden';
	const GEN_ATTR_ESTADO = 'pde_nota_credito_pde_tributo.estado';
	const GEN_ATTR_CREADO = 'pde_nota_credito_pde_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'pde_nota_credito_pde_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_nota_credito_pde_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_nota_credito_pde_tributo.modificado_por';

	/* Constantes de Atributos Min de BPdeNotaCreditoPdeTributo */ 
	...
	/* Atributos de BPdeNotaCreditoPdeTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeNotaCreditoPdeTributo */ 
	...
	/* Setters de BPdeNotaCreditoPdeTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeNotaCreditoPdeTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeNotaCreditoPdeTributo */ 	
	...
	/* Cambia el estado de BPdeNotaCreditoPdeTributo */ 	
	...
	/* Save de BPdeNotaCreditoPdeTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_nota_credito_pde_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_nota_credito_pde_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".PdeNotaCreditoPdeTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeNotaCreditoPdeTributo */ 	
	...
	public function duplicarPdeNotaCreditoPdeTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeNotaCreditoPdeTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeNotaCreditoPdeTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdenotacreditopdetributo = new PdeNotaCreditoPdeTributo();
                    $pdenotacreditopdetributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdenotacreditopdetributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdenotacreditopdetributo->setPdeNotaCreditoId($fila[self::GEN_ATTR_MIN_PDE_NOTA_CREDITO_ID]);
			$pdenotacreditopdetributo->setPdeTributoId($fila[self::GEN_ATTR_MIN_PDE_TRIBUTO_ID]);
			$pdenotacreditopdetributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$pdenotacreditopdetributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$pdenotacreditopdetributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$pdenotacreditopdetributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$pdenotacreditopdetributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdenotacreditopdetributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdenotacreditopdetributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdenotacreditopdetributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdenotacreditopdetributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdenotacreditopdetributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdenotacreditopdetributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdenotacreditopdetributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeNotaCreditoPdeTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeNotaCreditoPdeTributos para listado de Backend */ 	
	static function getPdeNotaCreditoPdeTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeNotaCreditoPdeTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos($paginador, $criterio);
	...
	/* Método getPdeNotaCreditoPdeTributos filtrado para select */ 	
	static function getPdeNotaCreditoPdeTributosCmbF($paginador = null, $criterio = null){
            $col = PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos($paginador, $criterio);
	...
	/* Método getPdeNotaCreditoPdeTributos filtrado por una coleccion de objetos foraneos de PdeNotaCredito */ 	
	static function getPdeNotaCreditoPdeTributosXPdeNotaCreditos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeNotaCreditoPdeTributo::GEN_ATTR_PDE_NOTA_CREDITO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeNotaCreditoPdeTributo::GEN_TABLA);
            $c->addOrden(PdeNotaCreditoPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeNotaCreditoPdeTributos filtrado por una coleccion de objetos foraneos de PdeTributo */ 	
	static function getPdeNotaCreditoPdeTributosXPdeTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeNotaCreditoPdeTributo::GEN_ATTR_PDE_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeNotaCreditoPdeTributo::GEN_TABLA);
            $c->addOrden(PdeNotaCreditoPdeTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_nota_credito_pde_tributo_adm.php';
            $url_gestion = 'pde_nota_credito_pde_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_nota_credito_pde_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_nota_credito_pde_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeNotaCreditoPdeTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeNotaCreditoPdeTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_nota_credito_pde_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeNotaCreditoPdeTributo::GEN_TABLA);
                $c->addOrden(PdeNotaCreditoPdeTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_nota_credito_pde_tributos = PdeNotaCreditoPdeTributo::getPdeNotaCreditoPdeTributos(null, $c);

                $arr = array();
                foreach($pde_nota_credito_pde_tributos as $pde_nota_credito_pde_tributo){
                    $descripcion = $pde_nota_credito_pde_tributo->getDescripcion();

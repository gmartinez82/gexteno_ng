...
class BVtaAjusteDebeItemCheque
{ 
	
	const SES_PAGINACION = 'adm_vtaajustedebeitemcheque_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustedebeitemcheque_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustedebeitemcheque_criterios';
	
	const GEN_CLASE = 'VtaAjusteDebeItemCheque';
	const GEN_TABLA = 'vta_ajuste_debe_item_cheque';
	...
	/* Constantes de Atributos de BVtaAjusteDebeItemCheque */ 
	const GEN_ATTR_ID = 'vta_ajuste_debe_item_cheque.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_debe_item_cheque.descripcion';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ID = 'vta_ajuste_debe_item_cheque.vta_ajuste_debe_id';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ITEM_ID = 'vta_ajuste_debe_item_cheque.vta_ajuste_debe_item_id';
	const GEN_ATTR_GRAL_BANCO_ID = 'vta_ajuste_debe_item_cheque.gral_banco_id';
	const GEN_ATTR_NUMERO_CHEQUE = 'vta_ajuste_debe_item_cheque.numero_cheque';
	const GEN_ATTR_FECHA_EMISION = 'vta_ajuste_debe_item_cheque.fecha_emision';
	const GEN_ATTR_FECHA_COBRO = 'vta_ajuste_debe_item_cheque.fecha_cobro';
	const GEN_ATTR_FIRMANTE = 'vta_ajuste_debe_item_cheque.firmante';
	const GEN_ATTR_ENTREGADOR = 'vta_ajuste_debe_item_cheque.entregador';
	const GEN_ATTR_CODIGO = 'vta_ajuste_debe_item_cheque.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_debe_item_cheque.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_debe_item_cheque.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_debe_item_cheque.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_debe_item_cheque.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_debe_item_cheque.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_debe_item_cheque.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_debe_item_cheque.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteDebeItemCheque */ 
	...
	/* Atributos de BVtaAjusteDebeItemCheque */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteDebeItemCheque */ 
	...
	/* Setters de BVtaAjusteDebeItemCheque */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaAjusteDebeItemCheque();
            $o->setId($fila[VtaAjusteDebeItemCheque::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteDebeItemCheque */ 	
	...
	/* Cambia el estado de BVtaAjusteDebeItemCheque */ 	
	...
	/* Save de BVtaAjusteDebeItemCheque */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_debe_item_cheque_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_debe_item_cheque_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteDebeItemCheque::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteDebeItemCheque */ 	
	...
	public function duplicarVtaAjusteDebeItemCheque(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteDebeItemCheques($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteDebeItemCheque::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustedebeitemcheque = new VtaAjusteDebeItemCheque();
                    $vtaajustedebeitemcheque->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustedebeitemcheque->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustedebeitemcheque->setVtaAjusteDebeId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ID]);
			$vtaajustedebeitemcheque->setVtaAjusteDebeItemId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ITEM_ID]);
			$vtaajustedebeitemcheque->setGralBancoId($fila[self::GEN_ATTR_MIN_GRAL_BANCO_ID]);
			$vtaajustedebeitemcheque->setNumeroCheque($fila[self::GEN_ATTR_MIN_NUMERO_CHEQUE]);
			$vtaajustedebeitemcheque->setFechaEmision($fila[self::GEN_ATTR_MIN_FECHA_EMISION]);
			$vtaajustedebeitemcheque->setFechaCobro($fila[self::GEN_ATTR_MIN_FECHA_COBRO]);
			$vtaajustedebeitemcheque->setFirmante($fila[self::GEN_ATTR_MIN_FIRMANTE]);
			$vtaajustedebeitemcheque->setEntregador($fila[self::GEN_ATTR_MIN_ENTREGADOR]);
			$vtaajustedebeitemcheque->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustedebeitemcheque->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustedebeitemcheque->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustedebeitemcheque->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustedebeitemcheque->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustedebeitemcheque->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustedebeitemcheque->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustedebeitemcheque->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteDebeItemChequesHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteDebeItemCheques para listado de Backend */ 	
	static function getVtaAjusteDebeItemChequesDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteDebeItemChequesCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeItemCheques filtrado para select */ 	
	static function getVtaAjusteDebeItemChequesCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeItemCheques filtrado por una coleccion de objetos foraneos de VtaAjusteDebe */ 	
	static function getVtaAjusteDebeItemChequesXVtaAjusteDebes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeItemCheque::GEN_ATTR_VTA_AJUSTE_DEBE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeItemCheque::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeItemCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaAjusteDebeItemCheques filtrado por una coleccion de objetos foraneos de VtaAjusteDebeItem */ 	
	static function getVtaAjusteDebeItemChequesXVtaAjusteDebeItems($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeItemCheque::GEN_ATTR_VTA_AJUSTE_DEBE_ITEM_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeItemCheque::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeItemCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getVtaAjusteDebeItemCheques filtrado por una coleccion de objetos foraneos de GralBanco */ 	
	static function getVtaAjusteDebeItemChequesXGralBancos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeItemCheque::GEN_ATTR_GRAL_BANCO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeItemCheque::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeItemCheque::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_debe_item_cheque_adm.php';
            $url_gestion = 'vta_ajuste_debe_item_cheque_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_debe_item_cheque'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_debe_item_cheque';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteDebeItemCheques($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteDebeItemCheques(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_debe_item_cheque_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteDebeItemCheque::GEN_TABLA);
                $c->addOrden(VtaAjusteDebeItemCheque::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_debe_item_cheques = VtaAjusteDebeItemCheque::getVtaAjusteDebeItemCheques(null, $c);

                $arr = array();
                foreach($vta_ajuste_debe_item_cheques as $vta_ajuste_debe_item_cheque){
                    $descripcion = $vta_ajuste_debe_item_cheque->getDescripcion();

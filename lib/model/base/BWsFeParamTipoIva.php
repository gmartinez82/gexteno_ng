...
class BWsFeParamTipoIva
{ 
	
	const SES_PAGINACION = 'adm_wsfeparamtipoiva_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_wsfeparamtipoiva_paginas_registros';
	const SES_CRITERIOS = 'adm_wsfeparamtipoiva_criterios';
	
	const GEN_CLASE = 'WsFeParamTipoIva';
	const GEN_TABLA = 'ws_fe_param_tipo_iva';
	...
	/* Constantes de Atributos de BWsFeParamTipoIva */ 
	const GEN_ATTR_ID = 'ws_fe_param_tipo_iva.id';
	const GEN_ATTR_DESCRIPCION = 'ws_fe_param_tipo_iva.descripcion';
	const GEN_ATTR_CODIGO = 'ws_fe_param_tipo_iva.codigo';
	const GEN_ATTR_CODIGO_AFIP = 'ws_fe_param_tipo_iva.codigo_afip';
	const GEN_ATTR_FECHA_DESDE = 'ws_fe_param_tipo_iva.fecha_desde';
	const GEN_ATTR_FECHA_HASTA = 'ws_fe_param_tipo_iva.fecha_hasta';
	const GEN_ATTR_OBSERVACION = 'ws_fe_param_tipo_iva.observacion';
	const GEN_ATTR_ORDEN = 'ws_fe_param_tipo_iva.orden';
	const GEN_ATTR_ESTADO = 'ws_fe_param_tipo_iva.estado';
	const GEN_ATTR_CREADO = 'ws_fe_param_tipo_iva.creado';
	const GEN_ATTR_CREADO_POR = 'ws_fe_param_tipo_iva.creado_por';
	const GEN_ATTR_MODIFICADO = 'ws_fe_param_tipo_iva.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ws_fe_param_tipo_iva.modificado_por';

	/* Constantes de Atributos Min de BWsFeParamTipoIva */ 
	...
	/* Atributos de BWsFeParamTipoIva */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $codigo_afip;
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[WsFeParamTipoIva::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BWsFeParamTipoIva */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('ws_fe_param_tipo_iva_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, '".$this->getCodigoAfip()."'
						, '".$this->getFechaDesde()."'
                    ...
                    ) RETURNING currval('ws_fe_param_tipo_iva_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarWsFeParamTipoIva(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getWsFeParamTipoIvas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = WsFeParamTipoIva::setAplicarFiltrosDeAlcance($criterio);
		...
		$wsfeparamtipoivas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $wsfeparamtipoiva = new WsFeParamTipoIva();
                    $wsfeparamtipoiva->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $wsfeparamtipoiva->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$wsfeparamtipoiva->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$wsfeparamtipoiva->setCodigoAfip($fila[self::GEN_ATTR_MIN_CODIGO_AFIP]);
			$wsfeparamtipoiva->setFechaDesde($fila[self::GEN_ATTR_MIN_FECHA_DESDE]);
			$wsfeparamtipoiva->setFechaHasta($fila[self::GEN_ATTR_MIN_FECHA_HASTA]);
			$wsfeparamtipoiva->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$wsfeparamtipoiva->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$wsfeparamtipoiva->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$wsfeparamtipoiva->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$wsfeparamtipoiva->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$wsfeparamtipoiva->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$wsfeparamtipoiva->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $wsfeparamtipoivas[] = $wsfeparamtipoiva;
		}
		
		return $wsfeparamtipoivas;
	}	
	

	/* Método getWsFeParamTipoIvas Habilitados */ 	
	static function getWsFeParamTipoIvasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return WsFeParamTipoIva::getWsFeParamTipoIvas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getWsFeParamTipoIvas para listado de Backend */ 	
	static function getWsFeParamTipoIvasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return WsFeParamTipoIva::getWsFeParamTipoIvas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getWsFeParamTipoIvasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = WsFeParamTipoIva::getWsFeParamTipoIvas($paginador, $criterio);
	...
	/* Método getWsFeParamTipoIvas filtrado para select */ 	
	static function getWsFeParamTipoIvasCmbF($paginador = null, $criterio = null){
            $col = WsFeParamTipoIva::getWsFeParamTipoIvas($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ws_fe_param_tipo_iva_adm.php';
            $url_gestion = 'ws_fe_param_tipo_iva_gestion.php';
	...
	public function getGralTipoIvaWsFeParamTipoIvas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralTipoIvaWsFeParamTipoIva::GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralTipoIvaWsFeParamTipoIvasCmb(){
            $c = new Criterio();
            $c->add(GralTipoIvaWsFeParamTipoIva::GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralTipoIvaWsFeParamTipoIva::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralTipoIvas (Coleccion) relacionados a traves de GralTipoIvaWsFeParamTipoIva */ 	
	public function getGralTipoIvasXGralTipoIvaWsFeParamTipoIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralTipoIvaWsFeParamTipoIva::GEN_TABLA, GralTipoIvaWsFeParamTipoIva::GEN_ATTR_GRAL_TIPO_IVA_ID, GralTipoIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralTipoIvas relacionados a traves de GralTipoIvaWsFeParamTipoIva */ 	
	public function getCantidadGralTipoIvasXGralTipoIvaWsFeParamTipoIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralTipoIva (Objeto) relacionado a traves de GralTipoIvaWsFeParamTipoIva */ 	
	public function getGralTipoIvaXGralTipoIvaWsFeParamTipoIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralTipoIvasXGralTipoIvaWsFeParamTipoIva($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getWsFeOpeSolicitudIvas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(WsFeOpeSolicitudIva::GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getWsFeOpeSolicitudIvasCmb(){
            $c = new Criterio();
            $c->add(WsFeOpeSolicitudIva::GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(WsFeOpeSolicitudIva::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeOpeSolicituds (Coleccion) relacionados a traves de WsFeOpeSolicitudIva */ 	
	public function getWsFeOpeSolicitudsXWsFeOpeSolicitudIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(WsFeOpeSolicitudIva::GEN_TABLA, WsFeOpeSolicitudIva::GEN_ATTR_WS_FE_OPE_SOLICITUD_ID, WsFeOpeSolicitud::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeOpeSolicituds relacionados a traves de WsFeOpeSolicitudIva */ 	
	public function getCantidadWsFeOpeSolicitudsXWsFeOpeSolicitudIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeOpeSolicitud (Objeto) relacionado a traves de WsFeOpeSolicitudIva */ 	
	public function getWsFeOpeSolicitudXWsFeOpeSolicitudIva($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeOpeSolicitudsXWsFeOpeSolicitudIva($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna una coleccion de IDs de los GralTipoIvas asignados a WsFeParamTipoIva */ 	
	...
	/* Método setea nuevos GralTipoIvas asignados al WsFeParamTipoIva */ 	
	public function setGralTipoIvaWsFeParamTipoIvas($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setWsFeParamTipoIvaId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralTipoIva en el alta de WsFeParamTipoIva */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ws_fe_param_tipo_iva'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ws_fe_param_tipo_iva';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getWsFeParamTipoIvas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getWsFeParamTipoIvas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ws_fe_param_tipo_iva_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(WsFeParamTipoIva::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $ws_fe_param_tipo_ivas = WsFeParamTipoIva::getWsFeParamTipoIvas(null, $c);

                $arr = array();
                foreach($ws_fe_param_tipo_ivas as $ws_fe_param_tipo_iva){
                    $descripcion = $ws_fe_param_tipo_iva->getDescripcion();

...
class BPdeReciboTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_pderecibotipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecibotipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecibotipoestado_criterios';
	
	const GEN_CLASE = 'PdeReciboTipoEstado';
	const GEN_TABLA = 'pde_recibo_tipo_estado';
	...
	/* Constantes de Atributos de BPdeReciboTipoEstado */ 
	const GEN_ATTR_ID = 'pde_recibo_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recibo_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'pde_recibo_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'pde_recibo_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'pde_recibo_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'pde_recibo_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'pde_recibo_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'pde_recibo_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'pde_recibo_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'pde_recibo_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'pde_recibo_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'pde_recibo_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'pde_recibo_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'pde_recibo_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recibo_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recibo_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recibo_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BPdeReciboTipoEstado */ 
	...
	/* Atributos de BPdeReciboTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BPdeReciboTipoEstado */ 
	...
	/* Setters de BPdeReciboTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeReciboTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeReciboTipoEstado */ 	
	...
	/* Cambia el estado de BPdeReciboTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recibo_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('pde_recibo_tipo_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeReciboTipoEstado */ 	
	...
	public function duplicarPdeReciboTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeReciboTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeReciboTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$pderecibotipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecibotipoestado = new PdeReciboTipoEstado();
                    $pderecibotipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecibotipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecibotipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecibotipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$pderecibotipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$pderecibotipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$pderecibotipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$pderecibotipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$pderecibotipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$pderecibotipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$pderecibotipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecibotipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecibotipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecibotipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecibotipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecibotipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecibotipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pderecibotipoestados[] = $pderecibotipoestado;
		}
		
		return $pderecibotipoestados;
	}	
	

	/* Método getPdeReciboTipoEstados Habilitados */ 	
	static function getPdeReciboTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeReciboTipoEstado::getPdeReciboTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeReciboTipoEstados para listado de Backend */ 	
	static function getPdeReciboTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeReciboTipoEstado::getPdeReciboTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeReciboTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeReciboTipoEstado::getPdeReciboTipoEstados($paginador, $criterio);
	...
	/* Método getPdeReciboTipoEstados filtrado para select */ 	
	static function getPdeReciboTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = PdeReciboTipoEstado::getPdeReciboTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recibo_tipo_estado_adm.php';
            $url_gestion = 'pde_recibo_tipo_estado_gestion.php';
	...
	public function getPdeRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecibosCmb(){
            $c = new Criterio();
            $c->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecibo::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeReciboEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeReciboEstado::GEN_ATTR_PDE_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeReciboEstadosCmb(){
            $c = new Criterio();
            $c->add(PdeReciboEstado::GEN_ATTR_PDE_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeReciboEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PdeRecibos (Coleccion) relacionados a traves de PdeReciboEstado */ 	
	public function getPdeRecibosXPdeReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(PdeRecibo::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(PdeReciboEstado::GEN_ATTR_PDE_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecibo::GEN_TABLA);
            $c->addRealJoin(PdeReciboEstado::GEN_TABLA, PdeReciboEstado::GEN_ATTR_PDE_RECIBO_ID, PdeRecibo::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PdeRecibos relacionados a traves de PdeReciboEstado */ 	
	public function getCantidadPdeRecibosXPdeReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PdeRecibo (Objeto) relacionado a traves de PdeReciboEstado */ 	
	public function getPdeReciboXPdeReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPdeRecibosXPdeReciboEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recibo_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recibo_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeReciboTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeReciboTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recibo_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeReciboTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recibo_tipo_estados = PdeReciboTipoEstado::getPdeReciboTipoEstados(null, $c);

                $arr = array();
                foreach($pde_recibo_tipo_estados as $pde_recibo_tipo_estado){
                    $descripcion = $pde_recibo_tipo_estado->getDescripcion();

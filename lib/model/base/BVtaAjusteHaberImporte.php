...
class BVtaAjusteHaberImporte
{ 
	
	const SES_PAGINACION = 'adm_vtaajustehaberimporte_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustehaberimporte_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustehaberimporte_criterios';
	
	const GEN_CLASE = 'VtaAjusteHaberImporte';
	const GEN_TABLA = 'vta_ajuste_haber_importe';
	...
	/* Constantes de Atributos de BVtaAjusteHaberImporte */ 
	const GEN_ATTR_ID = 'vta_ajuste_haber_importe.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_haber_importe.descripcion';
	const GEN_ATTR_VTA_AJUSTE_HABER_ID = 'vta_ajuste_haber_importe.vta_ajuste_haber_id';
	const GEN_ATTR_IMPORTE_SUBTOTAL = 'vta_ajuste_haber_importe.importe_subtotal';
	const GEN_ATTR_IMPORTE_IVA = 'vta_ajuste_haber_importe.importe_iva';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'vta_ajuste_haber_importe.importe_tributo';
	const GEN_ATTR_IMPORTE_TOTAL = 'vta_ajuste_haber_importe.importe_total';
	const GEN_ATTR_IMPORTE_SALDADO = 'vta_ajuste_haber_importe.importe_saldado';
	const GEN_ATTR_IMPORTE_SALDO = 'vta_ajuste_haber_importe.importe_saldo';
	const GEN_ATTR_CODIGO = 'vta_ajuste_haber_importe.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_haber_importe.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_haber_importe.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_haber_importe.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_haber_importe.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_haber_importe.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_haber_importe.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_haber_importe.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteHaberImporte */ 
	...
	/* Atributos de BVtaAjusteHaberImporte */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteHaberImporte */ 
	...
	/* Setters de BVtaAjusteHaberImporte */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaAjusteHaberImporte();
            $o->setId($fila[VtaAjusteHaberImporte::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteHaberImporte */ 	
	...
	/* Cambia el estado de BVtaAjusteHaberImporte */ 	
	...
	/* Save de BVtaAjusteHaberImporte */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_haber_importe_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_haber_importe_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteHaberImporte::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteHaberImporte */ 	
	...
	public function duplicarVtaAjusteHaberImporte(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteHaberImportes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteHaberImporte::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustehaberimporte = new VtaAjusteHaberImporte();
                    $vtaajustehaberimporte->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustehaberimporte->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustehaberimporte->setVtaAjusteHaberId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_HABER_ID]);
			$vtaajustehaberimporte->setImporteSubtotal($fila[self::GEN_ATTR_MIN_IMPORTE_SUBTOTAL]);
			$vtaajustehaberimporte->setImporteIva($fila[self::GEN_ATTR_MIN_IMPORTE_IVA]);
			$vtaajustehaberimporte->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$vtaajustehaberimporte->setImporteTotal($fila[self::GEN_ATTR_MIN_IMPORTE_TOTAL]);
			$vtaajustehaberimporte->setImporteSaldado($fila[self::GEN_ATTR_MIN_IMPORTE_SALDADO]);
			$vtaajustehaberimporte->setImporteSaldo($fila[self::GEN_ATTR_MIN_IMPORTE_SALDO]);
			$vtaajustehaberimporte->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustehaberimporte->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustehaberimporte->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustehaberimporte->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustehaberimporte->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustehaberimporte->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustehaberimporte->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustehaberimporte->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteHaberImportesHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteHaberImporte::getVtaAjusteHaberImportes($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteHaberImportes para listado de Backend */ 	
	static function getVtaAjusteHaberImportesDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteHaberImporte::getVtaAjusteHaberImportes($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteHaberImportesCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteHaberImporte::getVtaAjusteHaberImportes($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberImportes filtrado para select */ 	
	static function getVtaAjusteHaberImportesCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteHaberImporte::getVtaAjusteHaberImportes($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberImportes filtrado por una coleccion de objetos foraneos de VtaAjusteHaber */ 	
	static function getVtaAjusteHaberImportesXVtaAjusteHabers($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteHaberImporte::GEN_ATTR_VTA_AJUSTE_HABER_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteHaberImporte::GEN_TABLA);
            $c->addOrden(VtaAjusteHaberImporte::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteHaberImporte::getVtaAjusteHaberImportes($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_haber_importe_adm.php';
            $url_gestion = 'vta_ajuste_haber_importe_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_haber_importe'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_haber_importe';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteHaberImportes($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteHaberImportes(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_haber_importe_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteHaberImporte::GEN_TABLA);
                $c->addOrden(VtaAjusteHaberImporte::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_haber_importes = VtaAjusteHaberImporte::getVtaAjusteHaberImportes(null, $c);

                $arr = array();
                foreach($vta_ajuste_haber_importes as $vta_ajuste_haber_importe){
                    $descripcion = $vta_ajuste_haber_importe->getDescripcion();

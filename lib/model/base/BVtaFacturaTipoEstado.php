...
class BVtaFacturaTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_vtafacturatipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtafacturatipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtafacturatipoestado_criterios';
	
	const GEN_CLASE = 'VtaFacturaTipoEstado';
	const GEN_TABLA = 'vta_factura_tipo_estado';
	...
	/* Constantes de Atributos de BVtaFacturaTipoEstado */ 
	const GEN_ATTR_ID = 'vta_factura_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_factura_tipo_estado.descripcion';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'vta_factura_tipo_estado.descripcion_publica';
	const GEN_ATTR_CODIGO = 'vta_factura_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'vta_factura_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'vta_factura_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'vta_factura_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'vta_factura_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'vta_factura_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'vta_factura_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'vta_factura_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'vta_factura_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_factura_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_factura_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'vta_factura_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_factura_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_factura_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_factura_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaFacturaTipoEstado */ 
	...
	/* Atributos de BVtaFacturaTipoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaFacturaTipoEstado */ 
	...
	/* Setters de BVtaFacturaTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaFacturaTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaFacturaTipoEstado */ 	
	...
	/* Cambia el estado de BVtaFacturaTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_factura_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_factura_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".VtaFacturaTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaFacturaTipoEstado */ 	
	...
	public function duplicarVtaFacturaTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaFacturaTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaFacturaTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtafacturatipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtafacturatipoestado = new VtaFacturaTipoEstado();
                    $vtafacturatipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtafacturatipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtafacturatipoestado->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$vtafacturatipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtafacturatipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$vtafacturatipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$vtafacturatipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$vtafacturatipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$vtafacturatipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$vtafacturatipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$vtafacturatipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$vtafacturatipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtafacturatipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtafacturatipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtafacturatipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtafacturatipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtafacturatipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtafacturatipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtafacturatipoestados[] = $vtafacturatipoestado;
		}
		
		return $vtafacturatipoestados;
	}	
	

	/* Método getVtaFacturaTipoEstados Habilitados */ 	
	static function getVtaFacturaTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaFacturaTipoEstado::getVtaFacturaTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaFacturaTipoEstados para listado de Backend */ 	
	static function getVtaFacturaTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaFacturaTipoEstado::getVtaFacturaTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaFacturaTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaFacturaTipoEstado::getVtaFacturaTipoEstados($paginador, $criterio);
	...
	/* Método getVtaFacturaTipoEstados filtrado para select */ 	
	static function getVtaFacturaTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaFacturaTipoEstado::getVtaFacturaTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_factura_tipo_estado_adm.php';
            $url_gestion = 'vta_factura_tipo_estado_gestion.php';
	...
	public function getVtaFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaFactura::GEN_ATTR_VTA_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaFacturasCmb(){
            $c = new Criterio();
            $c->add(VtaFactura::GEN_ATTR_VTA_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFactura::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaFacturaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaFacturaEstado::GEN_ATTR_VTA_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaFacturaEstadosCmb(){
            $c = new Criterio();
            $c->add(VtaFacturaEstado::GEN_ATTR_VTA_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFacturaEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaFacturas (Coleccion) relacionados a traves de VtaFacturaEstado */ 	
	public function getVtaFacturasXVtaFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(VtaFactura::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(VtaFacturaEstado::GEN_ATTR_VTA_FACTURA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFactura::GEN_TABLA);
            $c->addRealJoin(VtaFacturaEstado::GEN_TABLA, VtaFacturaEstado::GEN_ATTR_VTA_FACTURA_ID, VtaFactura::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaFacturas relacionados a traves de VtaFacturaEstado */ 	
	public function getCantidadVtaFacturasXVtaFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaFactura (Objeto) relacionado a traves de VtaFacturaEstado */ 	
	public function getVtaFacturaXVtaFacturaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaFacturasXVtaFacturaEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_factura_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_factura_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaFacturaTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaFacturaTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_factura_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaFacturaTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_factura_tipo_estados = VtaFacturaTipoEstado::getVtaFacturaTipoEstados(null, $c);

                $arr = array();
                foreach($vta_factura_tipo_estados as $vta_factura_tipo_estado){
                    $descripcion = $vta_factura_tipo_estado->getDescripcion();

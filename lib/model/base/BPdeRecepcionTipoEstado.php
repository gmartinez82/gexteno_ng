...
class BPdeRecepcionTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_pderecepciontipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecepciontipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecepciontipoestado_criterios';
	
	const GEN_CLASE = 'PdeRecepcionTipoEstado';
	const GEN_TABLA = 'pde_recepcion_tipo_estado';
	...
	/* Constantes de Atributos de BPdeRecepcionTipoEstado */ 
	const GEN_ATTR_ID = 'pde_recepcion_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recepcion_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'pde_recepcion_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'pde_recepcion_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'pde_recepcion_tipo_estado.terminal';
	const GEN_ATTR_AFECTA_STOCK = 'pde_recepcion_tipo_estado.afecta_stock';
	const GEN_ATTR_OBSERVACION = 'pde_recepcion_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'pde_recepcion_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'pde_recepcion_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'pde_recepcion_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recepcion_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recepcion_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recepcion_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BPdeRecepcionTipoEstado */ 
	const GEN_ATTR_MIN_ID = 'id';
	const GEN_ATTR_MIN_DESCRIPCION = 'descripcion';
	const GEN_ATTR_MIN_CODIGO = 'codigo';
	const GEN_ATTR_MIN_ACTIVO = 'activo';
	const GEN_ATTR_MIN_TERMINAL = 'terminal';
	const GEN_ATTR_MIN_AFECTA_STOCK = 'afecta_stock';
	...
	/* Atributos de BPdeRecepcionTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BPdeRecepcionTipoEstado */ 
	...
	public function getAfectaStock(){ if(isset($this->afecta_stock)){ return $this->afecta_stock; }else{ return 0; } }
	...
	/* Setters de BPdeRecepcionTipoEstado */ 	
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setAfectaStock($fila[self::GEN_ATTR_MIN_AFECTA_STOCK]);
	...
	public function setAfectaStock($v){ $this->afecta_stock = $v; }
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeRecepcionTipoEstado::GEN_ATTR_MIN_ID], false);
            
			$o->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$o->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$o->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$o->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$o->setAfectaStock($fila[self::GEN_ATTR_MIN_AFECTA_STOCK]);
	...
	/* Control de BPdeRecepcionTipoEstado */ 	
	...
	/* Cambia el estado de BPdeRecepcionTipoEstado */ 	
	...
	/* Save de BPdeRecepcionTipoEstado */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						...
						, ".self::GEN_ATTR_MIN_AFECTA_STOCK."
                ...
                nextval('pde_recepcion_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('pde_recepcion_tipo_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeRecepcionTipoEstado */ 	
	...
	public function duplicarPdeRecepcionTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeRecepcionTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeRecepcionTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$pderecepciontipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecepciontipoestado = new PdeRecepcionTipoEstado();
                    $pderecepciontipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecepciontipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecepciontipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecepciontipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$pderecepciontipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$pderecepciontipoestado->setAfectaStock($fila[self::GEN_ATTR_MIN_AFECTA_STOCK]);
			$pderecepciontipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecepciontipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecepciontipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecepciontipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecepciontipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecepciontipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecepciontipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pderecepciontipoestados[] = $pderecepciontipoestado;
		}
		
		return $pderecepciontipoestados;
	}	
	

	/* Método getPdeRecepcionTipoEstados Habilitados */ 	
	static function getPdeRecepcionTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeRecepcionTipoEstado::getPdeRecepcionTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeRecepcionTipoEstados para listado de Backend */ 	
	static function getPdeRecepcionTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeRecepcionTipoEstado::getPdeRecepcionTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeRecepcionTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeRecepcionTipoEstado::getPdeRecepcionTipoEstados($paginador, $criterio);
	...
	/* Método getPdeRecepcionTipoEstados filtrado para select */ 	
	static function getPdeRecepcionTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = PdeRecepcionTipoEstado::getPdeRecepcionTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recepcion_tipo_estado_adm.php';
            $url_gestion = 'pde_recepcion_tipo_estado_gestion.php';
	...
	public function getPdeRecepcions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecepcion::GEN_ATTR_PDE_RECEPCION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecepcionsCmb(){
            $c = new Criterio();
            $c->add(PdeRecepcion::GEN_ATTR_PDE_RECEPCION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecepcion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeRecepcionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecepcionEstado::GEN_ATTR_PDE_RECEPCION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecepcionEstadosCmb(){
            $c = new Criterio();
            $c->add(PdeRecepcionEstado::GEN_ATTR_PDE_RECEPCION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecepcionEstado::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recepcion_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recepcion_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeRecepcionTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeRecepcionTipoEstados(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'afecta_stock' */ 	
	static function getOxAfectaStock($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_AFECTA_STOCK, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'afecta_stock' */ 	
	static function getOsxAfectaStock($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_AFECTA_STOCK, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recepcion_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeRecepcionTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recepcion_tipo_estados = PdeRecepcionTipoEstado::getPdeRecepcionTipoEstados(null, $c);

                $arr = array();
                foreach($pde_recepcion_tipo_estados as $pde_recepcion_tipo_estado){
                    $descripcion = $pde_recepcion_tipo_estado->getDescripcion();

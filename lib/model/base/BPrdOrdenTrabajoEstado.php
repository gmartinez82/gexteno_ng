...
class BPrdOrdenTrabajoEstado
{ 
	
	const SES_PAGINACION = 'adm_prdordentrabajoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_prdordentrabajoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_prdordentrabajoestado_criterios';
	
	const GEN_CLASE = 'PrdOrdenTrabajoEstado';
	const GEN_TABLA = 'prd_orden_trabajo_estado';
	...
	/* Constantes de Atributos de BPrdOrdenTrabajoEstado */ 
	const GEN_ATTR_ID = 'prd_orden_trabajo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'prd_orden_trabajo_estado.descripcion';
	const GEN_ATTR_PRD_ORDEN_TRABAJO_ID = 'prd_orden_trabajo_estado.prd_orden_trabajo_id';
	const GEN_ATTR_PRD_ORDEN_TRABAJO_TIPO_ESTADO_ID = 'prd_orden_trabajo_estado.prd_orden_trabajo_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'prd_orden_trabajo_estado.inicial';
	const GEN_ATTR_ACTUAL = 'prd_orden_trabajo_estado.actual';
	const GEN_ATTR_CODIGO = 'prd_orden_trabajo_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'prd_orden_trabajo_estado.observacion';
	const GEN_ATTR_ORDEN = 'prd_orden_trabajo_estado.orden';
	const GEN_ATTR_ESTADO = 'prd_orden_trabajo_estado.estado';
	const GEN_ATTR_CREADO = 'prd_orden_trabajo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'prd_orden_trabajo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'prd_orden_trabajo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'prd_orden_trabajo_estado.modificado_por';

	/* Constantes de Atributos Min de BPrdOrdenTrabajoEstado */ 
	...
	/* Atributos de BPrdOrdenTrabajoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPrdOrdenTrabajoEstado */ 
	...
	/* Setters de BPrdOrdenTrabajoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PrdOrdenTrabajoEstado();
            $o->setId($fila[PrdOrdenTrabajoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPrdOrdenTrabajoEstado */ 	
	...
	/* Cambia el estado de BPrdOrdenTrabajoEstado */ 	
	...
	/* Save de BPrdOrdenTrabajoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('prd_orden_trabajo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('prd_orden_trabajo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PrdOrdenTrabajoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPrdOrdenTrabajoEstado */ 	
	...
	public function duplicarPrdOrdenTrabajoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPrdOrdenTrabajoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PrdOrdenTrabajoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $prdordentrabajoestado = new PrdOrdenTrabajoEstado();
                    $prdordentrabajoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $prdordentrabajoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$prdordentrabajoestado->setPrdOrdenTrabajoId($fila[self::GEN_ATTR_MIN_PRD_ORDEN_TRABAJO_ID]);
			$prdordentrabajoestado->setPrdOrdenTrabajoTipoEstadoId($fila[self::GEN_ATTR_MIN_PRD_ORDEN_TRABAJO_TIPO_ESTADO_ID]);
			$prdordentrabajoestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$prdordentrabajoestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$prdordentrabajoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$prdordentrabajoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$prdordentrabajoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$prdordentrabajoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$prdordentrabajoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$prdordentrabajoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$prdordentrabajoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$prdordentrabajoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPrdOrdenTrabajoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PrdOrdenTrabajoEstado::getPrdOrdenTrabajoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPrdOrdenTrabajoEstados para listado de Backend */ 	
	static function getPrdOrdenTrabajoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PrdOrdenTrabajoEstado::getPrdOrdenTrabajoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPrdOrdenTrabajoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PrdOrdenTrabajoEstado::getPrdOrdenTrabajoEstados($paginador, $criterio);
	...
	/* Método getPrdOrdenTrabajoEstados filtrado para select */ 	
	static function getPrdOrdenTrabajoEstadosCmbF($paginador = null, $criterio = null){
            $col = PrdOrdenTrabajoEstado::getPrdOrdenTrabajoEstados($paginador, $criterio);
	...
	/* Método getPrdOrdenTrabajoEstados filtrado por una coleccion de objetos foraneos de PrdOrdenTrabajo */ 	
	static function getPrdOrdenTrabajoEstadosXPrdOrdenTrabajos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrdOrdenTrabajoEstado::GEN_ATTR_PRD_ORDEN_TRABAJO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrdOrdenTrabajoEstado::GEN_TABLA);
            $c->addOrden(PrdOrdenTrabajoEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PrdOrdenTrabajoEstado::getPrdOrdenTrabajoEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getPrdOrdenTrabajoEstados filtrado por una coleccion de objetos foraneos de PrdOrdenTrabajoTipoEstado */ 	
	static function getPrdOrdenTrabajoEstadosXPrdOrdenTrabajoTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrdOrdenTrabajoEstado::GEN_ATTR_PRD_ORDEN_TRABAJO_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrdOrdenTrabajoEstado::GEN_TABLA);
            $c->addOrden(PrdOrdenTrabajoEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'prd_orden_trabajo_estado_adm.php';
            $url_gestion = 'prd_orden_trabajo_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM prd_orden_trabajo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'prd_orden_trabajo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPrdOrdenTrabajoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPrdOrdenTrabajoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'prd_orden_trabajo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PrdOrdenTrabajoEstado::GEN_TABLA);
                $c->addOrden(PrdOrdenTrabajoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($prd_orden_trabajo_estados as $prd_orden_trabajo_estado){
                    $descripcion = $prd_orden_trabajo_estado->getDescripcion();

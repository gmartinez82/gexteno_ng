...
class BVtaReciboTipoPago
{ 
	
	const SES_PAGINACION = 'adm_vtarecibotipopago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtarecibotipopago_paginas_registros';
	const SES_CRITERIOS = 'adm_vtarecibotipopago_criterios';
	
	const GEN_CLASE = 'VtaReciboTipoPago';
	const GEN_TABLA = 'vta_recibo_tipo_pago';
	...
	/* Constantes de Atributos de BVtaReciboTipoPago */ 
	const GEN_ATTR_ID = 'vta_recibo_tipo_pago.id';
	const GEN_ATTR_DESCRIPCION = 'vta_recibo_tipo_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'vta_recibo_tipo_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'vta_recibo_tipo_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_recibo_tipo_pago.codigo_min';
	const GEN_ATTR_COLOR = 'vta_recibo_tipo_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'vta_recibo_tipo_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'vta_recibo_tipo_pago.observacion';
	const GEN_ATTR_ORDEN = 'vta_recibo_tipo_pago.orden';
	const GEN_ATTR_ESTADO = 'vta_recibo_tipo_pago.estado';
	const GEN_ATTR_CREADO = 'vta_recibo_tipo_pago.creado';
	const GEN_ATTR_CREADO_POR = 'vta_recibo_tipo_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_recibo_tipo_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_recibo_tipo_pago.modificado_por';

	/* Constantes de Atributos Min de BVtaReciboTipoPago */ 
	...
	/* Atributos de BVtaReciboTipoPago */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaReciboTipoPago::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaReciboTipoPago */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_recibo_tipo_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_recibo_tipo_pago_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaReciboTipoPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaReciboTipoPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaReciboTipoPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtarecibotipopagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtarecibotipopago = new VtaReciboTipoPago();
                    $vtarecibotipopago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtarecibotipopago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtarecibotipopago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$vtarecibotipopago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtarecibotipopago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtarecibotipopago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$vtarecibotipopago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$vtarecibotipopago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtarecibotipopago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtarecibotipopago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtarecibotipopago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtarecibotipopago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtarecibotipopago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtarecibotipopago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtarecibotipopagos[] = $vtarecibotipopago;
		}
		
		return $vtarecibotipopagos;
	}	
	

	/* Método getVtaReciboTipoPagos Habilitados */ 	
	static function getVtaReciboTipoPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaReciboTipoPago::getVtaReciboTipoPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaReciboTipoPagos para listado de Backend */ 	
	static function getVtaReciboTipoPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaReciboTipoPago::getVtaReciboTipoPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaReciboTipoPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaReciboTipoPago::getVtaReciboTipoPagos($paginador, $criterio);
	...
	/* Método getVtaReciboTipoPagos filtrado para select */ 	
	static function getVtaReciboTipoPagosCmbF($paginador = null, $criterio = null){
            $col = VtaReciboTipoPago::getVtaReciboTipoPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_recibo_tipo_pago_adm.php';
            $url_gestion = 'vta_recibo_tipo_pago_gestion.php';
	...
	public function getVtaRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaRecibosCmb(){
            $c = new Criterio();
            $c->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRecibo::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_recibo_tipo_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_recibo_tipo_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaReciboTipoPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaReciboTipoPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_recibo_tipo_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaReciboTipoPago::GEN_TABLA);
                $c->addOrden(VtaReciboTipoPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_recibo_tipo_pagos = VtaReciboTipoPago::getVtaReciboTipoPagos(null, $c);

                $arr = array();
                foreach($vta_recibo_tipo_pagos as $vta_recibo_tipo_pago){
                    $descripcion = $vta_recibo_tipo_pago->getDescripcion();

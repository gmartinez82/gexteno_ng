...
class BFndCajaTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_fndcajatipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_fndcajatipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_fndcajatipoestado_criterios';
	
	const GEN_CLASE = 'FndCajaTipoEstado';
	const GEN_TABLA = 'fnd_caja_tipo_estado';
	...
	/* Constantes de Atributos de BFndCajaTipoEstado */ 
	const GEN_ATTR_ID = 'fnd_caja_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'fnd_caja_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'fnd_caja_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'fnd_caja_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'fnd_caja_tipo_estado.terminal';
	const GEN_ATTR_ANULADO = 'fnd_caja_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'fnd_caja_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'fnd_caja_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'fnd_caja_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'fnd_caja_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'fnd_caja_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'fnd_caja_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'fnd_caja_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BFndCajaTipoEstado */ 
	...
	/* Atributos de BFndCajaTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[FndCajaTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BFndCajaTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('fnd_caja_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('fnd_caja_tipo_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarFndCajaTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getFndCajaTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = FndCajaTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$fndcajatipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $fndcajatipoestado = new FndCajaTipoEstado();
                    $fndcajatipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $fndcajatipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$fndcajatipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$fndcajatipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$fndcajatipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$fndcajatipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$fndcajatipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$fndcajatipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$fndcajatipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$fndcajatipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$fndcajatipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$fndcajatipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$fndcajatipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $fndcajatipoestados[] = $fndcajatipoestado;
		}
		
		return $fndcajatipoestados;
	}	
	

	/* Método getFndCajaTipoEstados Habilitados */ 	
	static function getFndCajaTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return FndCajaTipoEstado::getFndCajaTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getFndCajaTipoEstados para listado de Backend */ 	
	static function getFndCajaTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return FndCajaTipoEstado::getFndCajaTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getFndCajaTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = FndCajaTipoEstado::getFndCajaTipoEstados($paginador, $criterio);
	...
	/* Método getFndCajaTipoEstados filtrado para select */ 	
	static function getFndCajaTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = FndCajaTipoEstado::getFndCajaTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'fnd_caja_tipo_estado_adm.php';
            $url_gestion = 'fnd_caja_tipo_estado_gestion.php';
	...
	public function getFndCajas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(FndCaja::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getFndCajasCmb(){
            $c = new Criterio();
            $c->add(FndCaja::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(FndCaja::GEN_TABLA);
            $c->setCriterios();
	...
	public function getFndCajaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(FndCajaEstado::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getFndCajaEstadosCmb(){
            $c = new Criterio();
            $c->add(FndCajaEstado::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(FndCajaEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener FndCajas (Coleccion) relacionados a traves de FndCajaEstado */ 	
	public function getFndCajasXFndCajaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(FndCaja::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(FndCajaEstado::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(FndCaja::GEN_TABLA);
            $c->addRealJoin(FndCajaEstado::GEN_TABLA, FndCajaEstado::GEN_ATTR_FND_CAJA_ID, FndCaja::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de FndCajas relacionados a traves de FndCajaEstado */ 	
	public function getCantidadFndCajasXFndCajaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener FndCaja (Objeto) relacionado a traves de FndCajaEstado */ 	
	public function getFndCajaXFndCajaEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getFndCajasXFndCajaEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM fnd_caja_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'fnd_caja_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getFndCajaTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getFndCajaTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'fnd_caja_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(FndCajaTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $fnd_caja_tipo_estados = FndCajaTipoEstado::getFndCajaTipoEstados(null, $c);

                $arr = array();
                foreach($fnd_caja_tipo_estados as $fnd_caja_tipo_estado){
                    $descripcion = $fnd_caja_tipo_estado->getDescripcion();

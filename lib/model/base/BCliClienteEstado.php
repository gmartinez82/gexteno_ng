...
class BCliClienteEstado
{ 
	
	const SES_PAGINACION = 'adm_cliclienteestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclienteestado_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclienteestado_criterios';
	
	const GEN_CLASE = 'CliClienteEstado';
	const GEN_TABLA = 'cli_cliente_estado';
	...
	/* Constantes de Atributos de BCliClienteEstado */ 
	const GEN_ATTR_ID = 'cli_cliente_estado.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_estado.descripcion';
	const GEN_ATTR_CLI_CLIENTE_ID = 'cli_cliente_estado.cli_cliente_id';
	const GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID = 'cli_cliente_estado.cli_cliente_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'cli_cliente_estado.inicial';
	const GEN_ATTR_ACTUAL = 'cli_cliente_estado.actual';
	const GEN_ATTR_CODIGO = 'cli_cliente_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_estado.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_estado.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_estado.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_estado.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_estado.modificado_por';

	/* Constantes de Atributos Min de BCliClienteEstado */ 
	...
	/* Atributos de BCliClienteEstado */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            $o = new CliClienteEstado();
            $o->setId($fila[CliClienteEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BCliClienteEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarCliClienteEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclienteestado = new CliClienteEstado();
                    $cliclienteestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclienteestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclienteestado->setCliClienteId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_ID]);
			$cliclienteestado->setCliClienteTipoEstadoId($fila[self::GEN_ATTR_MIN_CLI_CLIENTE_TIPO_ESTADO_ID]);
			$cliclienteestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$cliclienteestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$cliclienteestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclienteestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclienteestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclienteestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclienteestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclienteestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclienteestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclienteestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getCliClienteEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteEstado::getCliClienteEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteEstados para listado de Backend */ 	
	static function getCliClienteEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteEstado::getCliClienteEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteEstado::getCliClienteEstados($paginador, $criterio);
	...
	/* Método getCliClienteEstados filtrado para select */ 	
	static function getCliClienteEstadosCmbF($paginador = null, $criterio = null){
            $col = CliClienteEstado::getCliClienteEstados($paginador, $criterio);
	...
	/* Método getCliClienteEstados filtrado por una coleccion de objetos foraneos de CliCliente */ 	
	static function getCliClienteEstadosXCliClientes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(CliClienteEstado::GEN_ATTR_CLI_CLIENTE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(CliClienteEstado::GEN_TABLA);
            $c->addOrden(CliClienteEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = CliClienteEstado::getCliClienteEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getCliClienteEstados filtrado por una coleccion de objetos foraneos de CliClienteTipoEstado */ 	
	static function getCliClienteEstadosXCliClienteTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(CliClienteEstado::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(CliClienteEstado::GEN_TABLA);
            $c->addOrden(CliClienteEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_estado_adm.php';
            $url_gestion = 'cli_cliente_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(CliClienteEstado::GEN_TABLA);
                $c->addOrden(CliClienteEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($cli_cliente_estados as $cli_cliente_estado){
                    $descripcion = $cli_cliente_estado->getDescripcion();

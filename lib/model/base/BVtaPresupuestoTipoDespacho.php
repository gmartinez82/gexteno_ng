...
class BVtaPresupuestoTipoDespacho
{ 
	
	const SES_PAGINACION = 'adm_vtapresupuestotipodespacho_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtapresupuestotipodespacho_paginas_registros';
	const SES_CRITERIOS = 'adm_vtapresupuestotipodespacho_criterios';
	
	const GEN_CLASE = 'VtaPresupuestoTipoDespacho';
	const GEN_TABLA = 'vta_presupuesto_tipo_despacho';
	...
	/* Constantes de Atributos de BVtaPresupuestoTipoDespacho */ 
	const GEN_ATTR_ID = 'vta_presupuesto_tipo_despacho.id';
	const GEN_ATTR_DESCRIPCION = 'vta_presupuesto_tipo_despacho.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'vta_presupuesto_tipo_despacho.descripcion_corta';
	const GEN_ATTR_CODIGO = 'vta_presupuesto_tipo_despacho.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_presupuesto_tipo_despacho.codigo_min';
	const GEN_ATTR_COLOR = 'vta_presupuesto_tipo_despacho.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'vta_presupuesto_tipo_despacho.color_secundario';
	const GEN_ATTR_OBSERVACION = 'vta_presupuesto_tipo_despacho.observacion';
	const GEN_ATTR_ORDEN = 'vta_presupuesto_tipo_despacho.orden';
	const GEN_ATTR_ESTADO = 'vta_presupuesto_tipo_despacho.estado';
	const GEN_ATTR_CREADO = 'vta_presupuesto_tipo_despacho.creado';
	const GEN_ATTR_CREADO_POR = 'vta_presupuesto_tipo_despacho.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_presupuesto_tipo_despacho.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_presupuesto_tipo_despacho.modificado_por';

	/* Constantes de Atributos Min de BVtaPresupuestoTipoDespacho */ 
	...
	/* Atributos de BVtaPresupuestoTipoDespacho */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaPresupuestoTipoDespacho */ 
	...
	/* Setters de BVtaPresupuestoTipoDespacho */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaPresupuestoTipoDespacho::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaPresupuestoTipoDespacho */ 	
	...
	/* Cambia el estado de BVtaPresupuestoTipoDespacho */ 	
	...
	/* Save de BVtaPresupuestoTipoDespacho */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_presupuesto_tipo_despacho_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_presupuesto_tipo_despacho_seq')";
                ...
                $sql = "
				 ...
				 ".VtaPresupuestoTipoDespacho::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaPresupuestoTipoDespacho */ 	
	...
	public function duplicarVtaPresupuestoTipoDespacho(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaPresupuestoTipoDespachos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaPresupuestoTipoDespacho::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtapresupuestotipodespachos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtapresupuestotipodespacho = new VtaPresupuestoTipoDespacho();
                    $vtapresupuestotipodespacho->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtapresupuestotipodespacho->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtapresupuestotipodespacho->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$vtapresupuestotipodespacho->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtapresupuestotipodespacho->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtapresupuestotipodespacho->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$vtapresupuestotipodespacho->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$vtapresupuestotipodespacho->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtapresupuestotipodespacho->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtapresupuestotipodespacho->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtapresupuestotipodespacho->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtapresupuestotipodespacho->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtapresupuestotipodespacho->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtapresupuestotipodespacho->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtapresupuestotipodespachos[] = $vtapresupuestotipodespacho;
		}
		
		return $vtapresupuestotipodespachos;
	}	
	

	/* Método getVtaPresupuestoTipoDespachos Habilitados */ 	
	static function getVtaPresupuestoTipoDespachosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaPresupuestoTipoDespacho::getVtaPresupuestoTipoDespachos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaPresupuestoTipoDespachos para listado de Backend */ 	
	static function getVtaPresupuestoTipoDespachosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaPresupuestoTipoDespacho::getVtaPresupuestoTipoDespachos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaPresupuestoTipoDespachosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaPresupuestoTipoDespacho::getVtaPresupuestoTipoDespachos($paginador, $criterio);
	...
	/* Método getVtaPresupuestoTipoDespachos filtrado para select */ 	
	static function getVtaPresupuestoTipoDespachosCmbF($paginador = null, $criterio = null){
            $col = VtaPresupuestoTipoDespacho::getVtaPresupuestoTipoDespachos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_presupuesto_tipo_despacho_adm.php';
            $url_gestion = 'vta_presupuesto_tipo_despacho_gestion.php';
	...
	public function getVtaPresupuestos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaPresupuesto::GEN_ATTR_VTA_PRESUPUESTO_TIPO_DESPACHO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaPresupuestosCmb(){
            $c = new Criterio();
            $c->add(VtaPresupuesto::GEN_ATTR_VTA_PRESUPUESTO_TIPO_DESPACHO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaPresupuesto::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_presupuesto_tipo_despacho'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_presupuesto_tipo_despacho';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaPresupuestoTipoDespachos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaPresupuestoTipoDespachos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_presupuesto_tipo_despacho_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaPresupuestoTipoDespacho::GEN_TABLA);
                $c->addOrden(VtaPresupuestoTipoDespacho::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_presupuesto_tipo_despachos = VtaPresupuestoTipoDespacho::getVtaPresupuestoTipoDespachos(null, $c);

                $arr = array();
                foreach($vta_presupuesto_tipo_despachos as $vta_presupuesto_tipo_despacho){
                    $descripcion = $vta_presupuesto_tipo_despacho->getDescripcion();

...
class BVtaComisionTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_vtacomisiontipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtacomisiontipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtacomisiontipoestado_criterios';
	
	const GEN_CLASE = 'VtaComisionTipoEstado';
	const GEN_TABLA = 'vta_comision_tipo_estado';
	...
	/* Constantes de Atributos de BVtaComisionTipoEstado */ 
	const GEN_ATTR_ID = 'vta_comision_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_comision_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'vta_comision_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'vta_comision_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'vta_comision_tipo_estado.terminal';
	const GEN_ATTR_ANULADO = 'vta_comision_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'vta_comision_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_comision_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_comision_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'vta_comision_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_comision_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_comision_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_comision_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaComisionTipoEstado */ 
	...
	/* Atributos de BVtaComisionTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BVtaComisionTipoEstado */ 
	...
	/* Setters de BVtaComisionTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaComisionTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaComisionTipoEstado */ 	
	...
	/* Cambia el estado de BVtaComisionTipoEstado */ 	
	...
	/* Save de BVtaComisionTipoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_comision_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('vta_comision_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".VtaComisionTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaComisionTipoEstado */ 	
	...
	public function duplicarVtaComisionTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaComisionTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaComisionTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtacomisiontipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtacomisiontipoestado = new VtaComisionTipoEstado();
                    $vtacomisiontipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtacomisiontipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtacomisiontipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtacomisiontipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$vtacomisiontipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$vtacomisiontipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$vtacomisiontipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtacomisiontipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtacomisiontipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtacomisiontipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtacomisiontipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtacomisiontipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtacomisiontipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtacomisiontipoestados[] = $vtacomisiontipoestado;
		}
		
		return $vtacomisiontipoestados;
	}	
	

	/* Método getVtaComisionTipoEstados Habilitados */ 	
	static function getVtaComisionTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaComisionTipoEstado::getVtaComisionTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaComisionTipoEstados para listado de Backend */ 	
	static function getVtaComisionTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaComisionTipoEstado::getVtaComisionTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaComisionTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaComisionTipoEstado::getVtaComisionTipoEstados($paginador, $criterio);
	...
	/* Método getVtaComisionTipoEstados filtrado para select */ 	
	static function getVtaComisionTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaComisionTipoEstado::getVtaComisionTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_comision_tipo_estado_adm.php';
            $url_gestion = 'vta_comision_tipo_estado_gestion.php';
	...
	public function getVtaComisions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComision::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionsCmb(){
            $c = new Criterio();
            $c->add(VtaComision::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComision::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaComisionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComisionEstado::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionEstadosCmb(){
            $c = new Criterio();
            $c->add(VtaComisionEstado::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComisionEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaComisions (Coleccion) relacionados a traves de VtaComisionEstado */ 	
	public function getVtaComisionsXVtaComisionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(VtaComision::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(VtaComisionEstado::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComision::GEN_TABLA);
            $c->addRealJoin(VtaComisionEstado::GEN_TABLA, VtaComisionEstado::GEN_ATTR_VTA_COMISION_ID, VtaComision::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaComisions relacionados a traves de VtaComisionEstado */ 	
	public function getCantidadVtaComisionsXVtaComisionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaComision (Objeto) relacionado a traves de VtaComisionEstado */ 	
	public function getVtaComisionXVtaComisionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaComisionsXVtaComisionEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_comision_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_comision_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaComisionTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaComisionTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_comision_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaComisionTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_comision_tipo_estados = VtaComisionTipoEstado::getVtaComisionTipoEstados(null, $c);

                $arr = array();
                foreach($vta_comision_tipo_estados as $vta_comision_tipo_estado){
                    $descripcion = $vta_comision_tipo_estado->getDescripcion();

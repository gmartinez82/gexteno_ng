...
class BVtaReciboTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_vtarecibotipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtarecibotipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtarecibotipoestado_criterios';
	
	const GEN_CLASE = 'VtaReciboTipoEstado';
	const GEN_TABLA = 'vta_recibo_tipo_estado';
	...
	/* Constantes de Atributos de BVtaReciboTipoEstado */ 
	const GEN_ATTR_ID = 'vta_recibo_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_recibo_tipo_estado.descripcion';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'vta_recibo_tipo_estado.descripcion_publica';
	const GEN_ATTR_CODIGO = 'vta_recibo_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'vta_recibo_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'vta_recibo_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'vta_recibo_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'vta_recibo_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'vta_recibo_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'vta_recibo_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'vta_recibo_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'vta_recibo_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_recibo_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_recibo_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'vta_recibo_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_recibo_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_recibo_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_recibo_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaReciboTipoEstado */ 
	...
	/* Atributos de BVtaReciboTipoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaReciboTipoEstado */ 
	...
	/* Setters de BVtaReciboTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaReciboTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaReciboTipoEstado */ 	
	...
	/* Cambia el estado de BVtaReciboTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_recibo_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_recibo_tipo_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaReciboTipoEstado */ 	
	...
	public function duplicarVtaReciboTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaReciboTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaReciboTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtarecibotipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtarecibotipoestado = new VtaReciboTipoEstado();
                    $vtarecibotipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtarecibotipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtarecibotipoestado->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$vtarecibotipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtarecibotipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$vtarecibotipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$vtarecibotipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$vtarecibotipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$vtarecibotipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$vtarecibotipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$vtarecibotipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$vtarecibotipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtarecibotipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtarecibotipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtarecibotipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtarecibotipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtarecibotipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtarecibotipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtarecibotipoestados[] = $vtarecibotipoestado;
		}
		
		return $vtarecibotipoestados;
	}	
	

	/* Método getVtaReciboTipoEstados Habilitados */ 	
	static function getVtaReciboTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaReciboTipoEstado::getVtaReciboTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaReciboTipoEstados para listado de Backend */ 	
	static function getVtaReciboTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaReciboTipoEstado::getVtaReciboTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaReciboTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaReciboTipoEstado::getVtaReciboTipoEstados($paginador, $criterio);
	...
	/* Método getVtaReciboTipoEstados filtrado para select */ 	
	static function getVtaReciboTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaReciboTipoEstado::getVtaReciboTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_recibo_tipo_estado_adm.php';
            $url_gestion = 'vta_recibo_tipo_estado_gestion.php';
	...
	public function getVtaRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaRecibosCmb(){
            $c = new Criterio();
            $c->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRecibo::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaReciboEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaReciboEstado::GEN_ATTR_VTA_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaReciboEstadosCmb(){
            $c = new Criterio();
            $c->add(VtaReciboEstado::GEN_ATTR_VTA_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaReciboEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaRecibos (Coleccion) relacionados a traves de VtaReciboEstado */ 	
	public function getVtaRecibosXVtaReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(VtaRecibo::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(VtaReciboEstado::GEN_ATTR_VTA_RECIBO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRecibo::GEN_TABLA);
            $c->addRealJoin(VtaReciboEstado::GEN_TABLA, VtaReciboEstado::GEN_ATTR_VTA_RECIBO_ID, VtaRecibo::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaRecibos relacionados a traves de VtaReciboEstado */ 	
	public function getCantidadVtaRecibosXVtaReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaRecibo (Objeto) relacionado a traves de VtaReciboEstado */ 	
	public function getVtaReciboXVtaReciboEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaRecibosXVtaReciboEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_recibo_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_recibo_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaReciboTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaReciboTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_recibo_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaReciboTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_recibo_tipo_estados = VtaReciboTipoEstado::getVtaReciboTipoEstados(null, $c);

                $arr = array();
                foreach($vta_recibo_tipo_estados as $vta_recibo_tipo_estado){
                    $descripcion = $vta_recibo_tipo_estado->getDescripcion();

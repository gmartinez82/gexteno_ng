...
class BVtaTipoFactura
{ 
	
	const SES_PAGINACION = 'adm_vtatipofactura_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtatipofactura_paginas_registros';
	const SES_CRITERIOS = 'adm_vtatipofactura_criterios';
	
	const GEN_CLASE = 'VtaTipoFactura';
	const GEN_TABLA = 'vta_tipo_factura';
	...
	/* Constantes de Atributos de BVtaTipoFactura */ 
	const GEN_ATTR_ID = 'vta_tipo_factura.id';
	const GEN_ATTR_DESCRIPCION = 'vta_tipo_factura.descripcion';
	const GEN_ATTR_CODIGO = 'vta_tipo_factura.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_tipo_factura.codigo_min';
	const GEN_ATTR_INFORMA = 'vta_tipo_factura.informa';
	const GEN_ATTR_OBSERVACION = 'vta_tipo_factura.observacion';
	const GEN_ATTR_ORDEN = 'vta_tipo_factura.orden';
	const GEN_ATTR_ESTADO = 'vta_tipo_factura.estado';
	const GEN_ATTR_CREADO = 'vta_tipo_factura.creado';
	const GEN_ATTR_CREADO_POR = 'vta_tipo_factura.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_tipo_factura.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_tipo_factura.modificado_por';

	/* Constantes de Atributos Min de BVtaTipoFactura */ 
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaTipoFactura::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaTipoFactura */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_tipo_factura_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaTipoFactura(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaTipoFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaTipoFactura::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtatipofacturas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtatipofactura = new VtaTipoFactura();
                    $vtatipofactura->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtatipofactura->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtatipofactura->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtatipofactura->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtatipofactura->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$vtatipofactura->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtatipofactura->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtatipofactura->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtatipofactura->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtatipofactura->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtatipofactura->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtatipofactura->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtatipofacturas[] = $vtatipofactura;
		}
		
		return $vtatipofacturas;
	}	
	

	/* Método getVtaTipoFacturas Habilitados */ 	
	static function getVtaTipoFacturasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaTipoFactura::getVtaTipoFacturas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaTipoFacturas para listado de Backend */ 	
	static function getVtaTipoFacturasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaTipoFactura::getVtaTipoFacturas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaTipoFacturasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaTipoFactura::getVtaTipoFacturas($paginador, $criterio);
	...
	/* Método getVtaTipoFacturas filtrado para select */ 	
	static function getVtaTipoFacturasCmbF($paginador = null, $criterio = null){
            $col = VtaTipoFactura::getVtaTipoFacturas($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_tipo_factura_adm.php';
            $url_gestion = 'vta_tipo_factura_gestion.php';
	...
	public function getGralCondicionIvaVtaTipoFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralCondicionIvaVtaTipoFactura::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralCondicionIvaVtaTipoFacturasCmb(){
            $c = new Criterio();
            $c->add(GralCondicionIvaVtaTipoFactura::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralCondicionIvaVtaTipoFactura::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralCondicionIvas (Coleccion) relacionados a traves de GralCondicionIvaVtaTipoFactura */ 	
	public function getGralCondicionIvasXGralCondicionIvaVtaTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralCondicionIvaVtaTipoFactura::GEN_TABLA, GralCondicionIvaVtaTipoFactura::GEN_ATTR_GRAL_CONDICION_IVA_ID, GralCondicionIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralCondicionIvas relacionados a traves de GralCondicionIvaVtaTipoFactura */ 	
	public function getCantidadGralCondicionIvasXGralCondicionIvaVtaTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralCondicionIva (Objeto) relacionado a traves de GralCondicionIvaVtaTipoFactura */ 	
	public function getGralCondicionIvaXGralCondicionIvaVtaTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralCondicionIvasXGralCondicionIvaVtaTipoFactura($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaTipoFacturaWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaTipoFacturaWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(VtaTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaTipoFacturaWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de VtaTipoFacturaWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXVtaTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(VtaTipoFacturaWsFeParamTipoComprobante::GEN_TABLA, VtaTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de VtaTipoFacturaWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXVtaTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de VtaTipoFacturaWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXVtaTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXVtaTipoFacturaWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaFactura::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaFacturasCmb(){
            $c = new Criterio();
            $c->add(VtaFactura::GEN_ATTR_VTA_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFactura::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralCondicionIvas asignados a VtaTipoFactura */ 	
	...
	/* Método setea nuevos GralCondicionIvas asignados al VtaTipoFactura */ 	
	public function setGralCondicionIvaVtaTipoFacturas($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaTipoFacturaId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralCondicionIva en el alta de VtaTipoFactura */ 	
	public function getAltaMostrarBloqueRelacionGralCondicionIvaVtaTipoFactura(){
            return true;
	}
	

	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a VtaTipoFactura */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al VtaTipoFactura */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de VtaTipoFactura */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_tipo_factura'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_tipo_factura';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaTipoFacturas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaTipoFacturas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_tipo_factura_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaTipoFactura::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_tipo_facturas = VtaTipoFactura::getVtaTipoFacturas(null, $c);

                $arr = array();
                foreach($vta_tipo_facturas as $vta_tipo_factura){
                    $descripcion = $vta_tipo_factura->getDescripcion();

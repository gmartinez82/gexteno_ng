...
class BWsFeParamTipoConcepto
{ 
	
	const SES_PAGINACION = 'adm_wsfeparamtipoconcepto_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_wsfeparamtipoconcepto_paginas_registros';
	const SES_CRITERIOS = 'adm_wsfeparamtipoconcepto_criterios';
	
	const GEN_CLASE = 'WsFeParamTipoConcepto';
	const GEN_TABLA = 'ws_fe_param_tipo_concepto';
	...
	/* Constantes de Atributos de BWsFeParamTipoConcepto */ 
	const GEN_ATTR_ID = 'ws_fe_param_tipo_concepto.id';
	const GEN_ATTR_DESCRIPCION = 'ws_fe_param_tipo_concepto.descripcion';
	const GEN_ATTR_CODIGO = 'ws_fe_param_tipo_concepto.codigo';
	const GEN_ATTR_CODIGO_AFIP = 'ws_fe_param_tipo_concepto.codigo_afip';
	const GEN_ATTR_FECHA_DESDE = 'ws_fe_param_tipo_concepto.fecha_desde';
	const GEN_ATTR_FECHA_HASTA = 'ws_fe_param_tipo_concepto.fecha_hasta';
	const GEN_ATTR_OBSERVACION = 'ws_fe_param_tipo_concepto.observacion';
	const GEN_ATTR_ORDEN = 'ws_fe_param_tipo_concepto.orden';
	const GEN_ATTR_ESTADO = 'ws_fe_param_tipo_concepto.estado';
	const GEN_ATTR_CREADO = 'ws_fe_param_tipo_concepto.creado';
	const GEN_ATTR_CREADO_POR = 'ws_fe_param_tipo_concepto.creado_por';
	const GEN_ATTR_MODIFICADO = 'ws_fe_param_tipo_concepto.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ws_fe_param_tipo_concepto.modificado_por';

	/* Constantes de Atributos Min de BWsFeParamTipoConcepto */ 
	...
	/* Atributos de BWsFeParamTipoConcepto */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $codigo_afip;
	...
	/* Getters de BWsFeParamTipoConcepto */ 
	...
	/* Setters de BWsFeParamTipoConcepto */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[WsFeParamTipoConcepto::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BWsFeParamTipoConcepto */ 	
	...
	/* Cambia el estado de BWsFeParamTipoConcepto */ 	
	...
	/* Save de BWsFeParamTipoConcepto */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('ws_fe_param_tipo_concepto_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, '".$this->getCodigoAfip()."'
						, '".$this->getFechaDesde()."'
                    ...
                    ) RETURNING currval('ws_fe_param_tipo_concepto_seq')";
                ...
                $sql = "
				 ...
				 ".WsFeParamTipoConcepto::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BWsFeParamTipoConcepto */ 	
	...
	public function duplicarWsFeParamTipoConcepto(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getWsFeParamTipoConceptos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = WsFeParamTipoConcepto::setAplicarFiltrosDeAlcance($criterio);
		...
		$wsfeparamtipoconceptos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $wsfeparamtipoconcepto = new WsFeParamTipoConcepto();
                    $wsfeparamtipoconcepto->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $wsfeparamtipoconcepto->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$wsfeparamtipoconcepto->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$wsfeparamtipoconcepto->setCodigoAfip($fila[self::GEN_ATTR_MIN_CODIGO_AFIP]);
			$wsfeparamtipoconcepto->setFechaDesde($fila[self::GEN_ATTR_MIN_FECHA_DESDE]);
			$wsfeparamtipoconcepto->setFechaHasta($fila[self::GEN_ATTR_MIN_FECHA_HASTA]);
			$wsfeparamtipoconcepto->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$wsfeparamtipoconcepto->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$wsfeparamtipoconcepto->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$wsfeparamtipoconcepto->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$wsfeparamtipoconcepto->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$wsfeparamtipoconcepto->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$wsfeparamtipoconcepto->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $wsfeparamtipoconceptos[] = $wsfeparamtipoconcepto;
		}
		
		return $wsfeparamtipoconceptos;
	}	
	

	/* Método getWsFeParamTipoConceptos Habilitados */ 	
	static function getWsFeParamTipoConceptosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return WsFeParamTipoConcepto::getWsFeParamTipoConceptos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getWsFeParamTipoConceptos para listado de Backend */ 	
	static function getWsFeParamTipoConceptosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return WsFeParamTipoConcepto::getWsFeParamTipoConceptos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getWsFeParamTipoConceptosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = WsFeParamTipoConcepto::getWsFeParamTipoConceptos($paginador, $criterio);
	...
	/* Método getWsFeParamTipoConceptos filtrado para select */ 	
	static function getWsFeParamTipoConceptosCmbF($paginador = null, $criterio = null){
            $col = WsFeParamTipoConcepto::getWsFeParamTipoConceptos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ws_fe_param_tipo_concepto_adm.php';
            $url_gestion = 'ws_fe_param_tipo_concepto_gestion.php';
	...
	public function getWsFeOpeSolicituds($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(WsFeOpeSolicitud::GEN_ATTR_WS_FE_PARAM_TIPO_CONCEPTO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getWsFeOpeSolicitudsCmb(){
            $c = new Criterio();
            $c->add(WsFeOpeSolicitud::GEN_ATTR_WS_FE_PARAM_TIPO_CONCEPTO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(WsFeOpeSolicitud::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ws_fe_param_tipo_concepto'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ws_fe_param_tipo_concepto';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getWsFeParamTipoConceptos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getWsFeParamTipoConceptos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ws_fe_param_tipo_concepto_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(WsFeParamTipoConcepto::GEN_TABLA);
                $c->addOrden(WsFeParamTipoConcepto::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $ws_fe_param_tipo_conceptos = WsFeParamTipoConcepto::getWsFeParamTipoConceptos(null, $c);

                $arr = array();
                foreach($ws_fe_param_tipo_conceptos as $ws_fe_param_tipo_concepto){
                    $descripcion = $ws_fe_param_tipo_concepto->getDescripcion();

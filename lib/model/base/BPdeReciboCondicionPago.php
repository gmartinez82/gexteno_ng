...
class BPdeReciboCondicionPago
{ 
	
	const SES_PAGINACION = 'adm_pderecibocondicionpago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pderecibocondicionpago_paginas_registros';
	const SES_CRITERIOS = 'adm_pderecibocondicionpago_criterios';
	
	const GEN_CLASE = 'PdeReciboCondicionPago';
	const GEN_TABLA = 'pde_recibo_condicion_pago';
	...
	/* Constantes de Atributos de BPdeReciboCondicionPago */ 
	const GEN_ATTR_ID = 'pde_recibo_condicion_pago.id';
	const GEN_ATTR_DESCRIPCION = 'pde_recibo_condicion_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'pde_recibo_condicion_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'pde_recibo_condicion_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'pde_recibo_condicion_pago.codigo_min';
	const GEN_ATTR_COLOR = 'pde_recibo_condicion_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'pde_recibo_condicion_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'pde_recibo_condicion_pago.observacion';
	const GEN_ATTR_ORDEN = 'pde_recibo_condicion_pago.orden';
	const GEN_ATTR_ESTADO = 'pde_recibo_condicion_pago.estado';
	const GEN_ATTR_CREADO = 'pde_recibo_condicion_pago.creado';
	const GEN_ATTR_CREADO_POR = 'pde_recibo_condicion_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_recibo_condicion_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_recibo_condicion_pago.modificado_por';

	/* Constantes de Atributos Min de BPdeReciboCondicionPago */ 
	...
	/* Atributos de BPdeReciboCondicionPago */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeReciboCondicionPago */ 
	...
	/* Setters de BPdeReciboCondicionPago */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeReciboCondicionPago::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeReciboCondicionPago */ 	
	...
	/* Cambia el estado de BPdeReciboCondicionPago */ 	
	...
	/* Save de BPdeReciboCondicionPago */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_recibo_condicion_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_recibo_condicion_pago_seq')";
                ...
                $sql = "
				 ...
				 ".PdeReciboCondicionPago::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeReciboCondicionPago */ 	
	...
	public function duplicarPdeReciboCondicionPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeReciboCondicionPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeReciboCondicionPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$pderecibocondicionpagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pderecibocondicionpago = new PdeReciboCondicionPago();
                    $pderecibocondicionpago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pderecibocondicionpago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pderecibocondicionpago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$pderecibocondicionpago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pderecibocondicionpago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$pderecibocondicionpago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$pderecibocondicionpago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$pderecibocondicionpago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pderecibocondicionpago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pderecibocondicionpago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pderecibocondicionpago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pderecibocondicionpago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pderecibocondicionpago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pderecibocondicionpago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pderecibocondicionpagos[] = $pderecibocondicionpago;
		}
		
		return $pderecibocondicionpagos;
	}	
	

	/* Método getPdeReciboCondicionPagos Habilitados */ 	
	static function getPdeReciboCondicionPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeReciboCondicionPago::getPdeReciboCondicionPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeReciboCondicionPagos para listado de Backend */ 	
	static function getPdeReciboCondicionPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeReciboCondicionPago::getPdeReciboCondicionPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeReciboCondicionPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeReciboCondicionPago::getPdeReciboCondicionPagos($paginador, $criterio);
	...
	/* Método getPdeReciboCondicionPagos filtrado para select */ 	
	static function getPdeReciboCondicionPagosCmbF($paginador = null, $criterio = null){
            $col = PdeReciboCondicionPago::getPdeReciboCondicionPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_recibo_condicion_pago_adm.php';
            $url_gestion = 'pde_recibo_condicion_pago_gestion.php';
	...
	public function getPdeRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeRecibosCmb(){
            $c = new Criterio();
            $c->add(PdeRecibo::GEN_ATTR_PDE_RECIBO_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeRecibo::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_recibo_condicion_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_recibo_condicion_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeReciboCondicionPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeReciboCondicionPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_recibo_condicion_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeReciboCondicionPago::GEN_TABLA);
                $c->addOrden(PdeReciboCondicionPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_recibo_condicion_pagos = PdeReciboCondicionPago::getPdeReciboCondicionPagos(null, $c);

                $arr = array();
                foreach($pde_recibo_condicion_pagos as $pde_recibo_condicion_pago){
                    $descripcion = $pde_recibo_condicion_pago->getDescripcion();

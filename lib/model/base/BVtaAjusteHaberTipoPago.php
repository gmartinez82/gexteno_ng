...
class BVtaAjusteHaberTipoPago
{ 
	
	const SES_PAGINACION = 'adm_vtaajustehabertipopago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustehabertipopago_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustehabertipopago_criterios';
	
	const GEN_CLASE = 'VtaAjusteHaberTipoPago';
	const GEN_TABLA = 'vta_ajuste_haber_tipo_pago';
	...
	/* Constantes de Atributos de BVtaAjusteHaberTipoPago */ 
	const GEN_ATTR_ID = 'vta_ajuste_haber_tipo_pago.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_haber_tipo_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'vta_ajuste_haber_tipo_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'vta_ajuste_haber_tipo_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_ajuste_haber_tipo_pago.codigo_min';
	const GEN_ATTR_COLOR = 'vta_ajuste_haber_tipo_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'vta_ajuste_haber_tipo_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_haber_tipo_pago.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_haber_tipo_pago.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_haber_tipo_pago.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_haber_tipo_pago.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_haber_tipo_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_haber_tipo_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_haber_tipo_pago.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteHaberTipoPago */ 
	...
	/* Atributos de BVtaAjusteHaberTipoPago */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteHaberTipoPago */ 
	...
	/* Setters de BVtaAjusteHaberTipoPago */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaAjusteHaberTipoPago::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteHaberTipoPago */ 	
	...
	/* Cambia el estado de BVtaAjusteHaberTipoPago */ 	
	...
	/* Save de BVtaAjusteHaberTipoPago */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_haber_tipo_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_haber_tipo_pago_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteHaberTipoPago::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteHaberTipoPago */ 	
	...
	public function duplicarVtaAjusteHaberTipoPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteHaberTipoPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteHaberTipoPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtaajustehabertipopagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustehabertipopago = new VtaAjusteHaberTipoPago();
                    $vtaajustehabertipopago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustehabertipopago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustehabertipopago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$vtaajustehabertipopago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustehabertipopago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtaajustehabertipopago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$vtaajustehabertipopago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$vtaajustehabertipopago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustehabertipopago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustehabertipopago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustehabertipopago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustehabertipopago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustehabertipopago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustehabertipopago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtaajustehabertipopagos[] = $vtaajustehabertipopago;
		}
		
		return $vtaajustehabertipopagos;
	}	
	

	/* Método getVtaAjusteHaberTipoPagos Habilitados */ 	
	static function getVtaAjusteHaberTipoPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteHaberTipoPago::getVtaAjusteHaberTipoPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteHaberTipoPagos para listado de Backend */ 	
	static function getVtaAjusteHaberTipoPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteHaberTipoPago::getVtaAjusteHaberTipoPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteHaberTipoPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteHaberTipoPago::getVtaAjusteHaberTipoPagos($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberTipoPagos filtrado para select */ 	
	static function getVtaAjusteHaberTipoPagosCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteHaberTipoPago::getVtaAjusteHaberTipoPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_haber_tipo_pago_adm.php';
            $url_gestion = 'vta_ajuste_haber_tipo_pago_gestion.php';
	...
	public function getVtaAjusteHabers($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteHaber::GEN_ATTR_VTA_AJUSTE_HABER_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteHabersCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteHaber::GEN_ATTR_VTA_AJUSTE_HABER_TIPO_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteHaber::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_haber_tipo_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_haber_tipo_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteHaberTipoPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteHaberTipoPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_haber_tipo_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteHaberTipoPago::GEN_TABLA);
                $c->addOrden(VtaAjusteHaberTipoPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_haber_tipo_pagos = VtaAjusteHaberTipoPago::getVtaAjusteHaberTipoPagos(null, $c);

                $arr = array();
                foreach($vta_ajuste_haber_tipo_pagos as $vta_ajuste_haber_tipo_pago){
                    $descripcion = $vta_ajuste_haber_tipo_pago->getDescripcion();

...
class BVtaAjusteHaberCondicionPago
{ 
	
	const SES_PAGINACION = 'adm_vtaajustehabercondicionpago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustehabercondicionpago_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustehabercondicionpago_criterios';
	
	const GEN_CLASE = 'VtaAjusteHaberCondicionPago';
	const GEN_TABLA = 'vta_ajuste_haber_condicion_pago';
	...
	/* Constantes de Atributos de BVtaAjusteHaberCondicionPago */ 
	const GEN_ATTR_ID = 'vta_ajuste_haber_condicion_pago.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_haber_condicion_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'vta_ajuste_haber_condicion_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'vta_ajuste_haber_condicion_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_ajuste_haber_condicion_pago.codigo_min';
	const GEN_ATTR_COLOR = 'vta_ajuste_haber_condicion_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'vta_ajuste_haber_condicion_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_haber_condicion_pago.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_haber_condicion_pago.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_haber_condicion_pago.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_haber_condicion_pago.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_haber_condicion_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_haber_condicion_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_haber_condicion_pago.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteHaberCondicionPago */ 
	...
	/* Atributos de BVtaAjusteHaberCondicionPago */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteHaberCondicionPago */ 
	...
	/* Setters de BVtaAjusteHaberCondicionPago */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaAjusteHaberCondicionPago::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteHaberCondicionPago */ 	
	...
	/* Cambia el estado de BVtaAjusteHaberCondicionPago */ 	
	...
	/* Save de BVtaAjusteHaberCondicionPago */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_haber_condicion_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_haber_condicion_pago_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteHaberCondicionPago::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteHaberCondicionPago */ 	
	...
	public function duplicarVtaAjusteHaberCondicionPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteHaberCondicionPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteHaberCondicionPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtaajustehabercondicionpagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustehabercondicionpago = new VtaAjusteHaberCondicionPago();
                    $vtaajustehabercondicionpago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustehabercondicionpago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustehabercondicionpago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$vtaajustehabercondicionpago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustehabercondicionpago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtaajustehabercondicionpago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$vtaajustehabercondicionpago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$vtaajustehabercondicionpago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustehabercondicionpago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustehabercondicionpago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustehabercondicionpago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustehabercondicionpago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustehabercondicionpago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustehabercondicionpago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtaajustehabercondicionpagos[] = $vtaajustehabercondicionpago;
		}
		
		return $vtaajustehabercondicionpagos;
	}	
	

	/* Método getVtaAjusteHaberCondicionPagos Habilitados */ 	
	static function getVtaAjusteHaberCondicionPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteHaberCondicionPago::getVtaAjusteHaberCondicionPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteHaberCondicionPagos para listado de Backend */ 	
	static function getVtaAjusteHaberCondicionPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteHaberCondicionPago::getVtaAjusteHaberCondicionPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteHaberCondicionPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteHaberCondicionPago::getVtaAjusteHaberCondicionPagos($paginador, $criterio);
	...
	/* Método getVtaAjusteHaberCondicionPagos filtrado para select */ 	
	static function getVtaAjusteHaberCondicionPagosCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteHaberCondicionPago::getVtaAjusteHaberCondicionPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_haber_condicion_pago_adm.php';
            $url_gestion = 'vta_ajuste_haber_condicion_pago_gestion.php';
	...
	public function getVtaAjusteHabers($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteHaber::GEN_ATTR_VTA_AJUSTE_HABER_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteHabersCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteHaber::GEN_ATTR_VTA_AJUSTE_HABER_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteHaber::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_haber_condicion_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_haber_condicion_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteHaberCondicionPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteHaberCondicionPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_haber_condicion_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteHaberCondicionPago::GEN_TABLA);
                $c->addOrden(VtaAjusteHaberCondicionPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_haber_condicion_pagos = VtaAjusteHaberCondicionPago::getVtaAjusteHaberCondicionPagos(null, $c);

                $arr = array();
                foreach($vta_ajuste_haber_condicion_pagos as $vta_ajuste_haber_condicion_pago){
                    $descripcion = $vta_ajuste_haber_condicion_pago->getDescripcion();

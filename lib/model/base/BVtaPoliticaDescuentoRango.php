...
class BVtaPoliticaDescuentoRango
{ 
	
	const SES_PAGINACION = 'adm_vtapoliticadescuentorango_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtapoliticadescuentorango_paginas_registros';
	const SES_CRITERIOS = 'adm_vtapoliticadescuentorango_criterios';
	
	const GEN_CLASE = 'VtaPoliticaDescuentoRango';
	const GEN_TABLA = 'vta_politica_descuento_rango';
	...
	/* Constantes de Atributos de BVtaPoliticaDescuentoRango */ 
	const GEN_ATTR_ID = 'vta_politica_descuento_rango.id';
	const GEN_ATTR_DESCRIPCION = 'vta_politica_descuento_rango.descripcion';
	const GEN_ATTR_VTA_POLITICA_DESCUENTO_ID = 'vta_politica_descuento_rango.vta_politica_descuento_id';
	const GEN_ATTR_INS_TIPO_LISTA_PRECIO_ID = 'vta_politica_descuento_rango.ins_tipo_lista_precio_id';
	const GEN_ATTR_CANTIDAD_DESDE = 'vta_politica_descuento_rango.cantidad_desde';
	const GEN_ATTR_CANTIDAD_HASTA = 'vta_politica_descuento_rango.cantidad_hasta';
	const GEN_ATTR_PORCENTAJE_DESCUENTO = 'vta_politica_descuento_rango.porcentaje_descuento';
	const GEN_ATTR_PORCENTAJE_NEGOCIACION = 'vta_politica_descuento_rango.porcentaje_negociacion';
	const GEN_ATTR_CODIGO = 'vta_politica_descuento_rango.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_politica_descuento_rango.observacion';
	const GEN_ATTR_ORDEN = 'vta_politica_descuento_rango.orden';
	const GEN_ATTR_ESTADO = 'vta_politica_descuento_rango.estado';
	const GEN_ATTR_CREADO = 'vta_politica_descuento_rango.creado';
	const GEN_ATTR_CREADO_POR = 'vta_politica_descuento_rango.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_politica_descuento_rango.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_politica_descuento_rango.modificado_por';

	/* Constantes de Atributos Min de BVtaPoliticaDescuentoRango */ 
	...
	const GEN_ATTR_MIN_CANTIDAD_DESDE = 'cantidad_desde';
	const GEN_ATTR_MIN_CANTIDAD_HASTA = 'cantidad_hasta';
	const GEN_ATTR_MIN_PORCENTAJE_DESCUENTO = 'porcentaje_descuento';
	const GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION = 'porcentaje_negociacion';
	...
	/* Atributos de BVtaPoliticaDescuentoRango */ 
	private $id;
	private $descripcion;
	private $vta_politica_descuento_id;
	private $ins_tipo_lista_precio_id;
	private $cantidad_desde;
	private $cantidad_hasta;
	...
	/* Getters de BVtaPoliticaDescuentoRango */ 
	...
	public function getCantidadDesde(){ if(isset($this->cantidad_desde)){ return $this->cantidad_desde; }else{ return 0; } }
	public function getCantidadHasta(){ if(isset($this->cantidad_hasta)){ return $this->cantidad_hasta; }else{ return 0; } }
	public function getPorcentajeDescuento(){ if(isset($this->porcentaje_descuento)){ return $this->porcentaje_descuento; }else{ return 0; } }
	public function getPorcentajeNegociacion(){ if(isset($this->porcentaje_negociacion)){ return $this->porcentaje_negociacion; }else{ return 0; } }
	...
	/* Setters de BVtaPoliticaDescuentoRango */ 	
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 SELECT 
				...
				, ".self::GEN_ATTR_CANTIDAD_DESDE."
				, ".self::GEN_ATTR_CANTIDAD_HASTA."
				, ".self::GEN_ATTR_PORCENTAJE_DESCUENTO."
				, ".self::GEN_ATTR_PORCENTAJE_NEGOCIACION."
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setCantidadDesde($fila[self::GEN_ATTR_MIN_CANTIDAD_DESDE]);
				$this->setCantidadHasta($fila[self::GEN_ATTR_MIN_CANTIDAD_HASTA]);
				$this->setPorcentajeDescuento($fila[self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO]);
				$this->setPorcentajeNegociacion($fila[self::GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION]);
	...
	public function setCantidadDesde($v){ $this->cantidad_desde = $v; }
	public function setCantidadHasta($v){ $this->cantidad_hasta = $v; }
	public function setPorcentajeDescuento($v){ $this->porcentaje_descuento = $v; }
	public function setPorcentajeNegociacion($v){ $this->porcentaje_negociacion = $v; }
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaPoliticaDescuentoRango::GEN_ATTR_MIN_ID], false);
			...
			$o->setCantidadDesde($fila[self::GEN_ATTR_MIN_CANTIDAD_DESDE]);
			$o->setCantidadHasta($fila[self::GEN_ATTR_MIN_CANTIDAD_HASTA]);
			$o->setPorcentajeDescuento($fila[self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO]);
			$o->setPorcentajeNegociacion($fila[self::GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION]);
	...
	/* Control de BVtaPoliticaDescuentoRango */ 	
	...
	/* Cambia el estado de BVtaPoliticaDescuentoRango */ 	
	...
	/* Save de BVtaPoliticaDescuentoRango */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						...
						, ".self::GEN_ATTR_MIN_CANTIDAD_DESDE."
						, ".self::GEN_ATTR_MIN_CANTIDAD_HASTA."
						, ".self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO."
						, ".self::GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION."
                ...
                nextval('vta_politica_descuento_rango_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getVtaPoliticaDescuentoId()."
						, ".$this->getInsTipoListaPrecioId()."
						, '".$this->getCantidadDesde()."'
						, '".$this->getCantidadHasta()."'
						, '".$this->getPorcentajeDescuento()."'
						, '".$this->getPorcentajeNegociacion()."'
						, '".$this->getCodigo()."'
						, '".$this->getObservacion()."'
						, ".$this->getOrden()."
						, ".$this->getEstado()."
                    ...
                    ) RETURNING currval('vta_politica_descuento_rango_seq')";
                ...
                $sql = "
				 ...
				 ".VtaPoliticaDescuentoRango::GEN_TABLA."
				 SET 
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
						...
						, ".self::GEN_ATTR_MIN_CANTIDAD_DESDE." = '".$this->getCantidadDesde()."'
						, ".self::GEN_ATTR_MIN_CANTIDAD_HASTA." = '".$this->getCantidadHasta()."'
						, ".self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO." = '".$this->getPorcentajeDescuento()."'
						, ".self::GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION." = '".$this->getPorcentajeNegociacion()."'
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaPoliticaDescuentoRango */ 	
	...
	public function duplicarVtaPoliticaDescuentoRango(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaPoliticaDescuentoRangos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaPoliticaDescuentoRango::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtapoliticadescuentorango = new VtaPoliticaDescuentoRango();
                    $vtapoliticadescuentorango->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtapoliticadescuentorango->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtapoliticadescuentorango->setVtaPoliticaDescuentoId($fila[self::GEN_ATTR_MIN_VTA_POLITICA_DESCUENTO_ID]);
			$vtapoliticadescuentorango->setInsTipoListaPrecioId($fila[self::GEN_ATTR_MIN_INS_TIPO_LISTA_PRECIO_ID]);
			$vtapoliticadescuentorango->setCantidadDesde($fila[self::GEN_ATTR_MIN_CANTIDAD_DESDE]);
			$vtapoliticadescuentorango->setCantidadHasta($fila[self::GEN_ATTR_MIN_CANTIDAD_HASTA]);
			$vtapoliticadescuentorango->setPorcentajeDescuento($fila[self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO]);
			$vtapoliticadescuentorango->setPorcentajeNegociacion($fila[self::GEN_ATTR_MIN_PORCENTAJE_NEGOCIACION]);
			$vtapoliticadescuentorango->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtapoliticadescuentorango->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtapoliticadescuentorango->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtapoliticadescuentorango->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtapoliticadescuentorango->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtapoliticadescuentorango->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtapoliticadescuentorango->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtapoliticadescuentorango->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaPoliticaDescuentoRangosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaPoliticaDescuentoRango::getVtaPoliticaDescuentoRangos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaPoliticaDescuentoRangos para listado de Backend */ 	
	static function getVtaPoliticaDescuentoRangosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaPoliticaDescuentoRango::getVtaPoliticaDescuentoRangos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaPoliticaDescuentoRangosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaPoliticaDescuentoRango::getVtaPoliticaDescuentoRangos($paginador, $criterio);
	...
	/* Método getVtaPoliticaDescuentoRangos filtrado para select */ 	
	static function getVtaPoliticaDescuentoRangosCmbF($paginador = null, $criterio = null){
            $col = VtaPoliticaDescuentoRango::getVtaPoliticaDescuentoRangos($paginador, $criterio);
	...
	/* Método getVtaPoliticaDescuentoRangos filtrado por una coleccion de objetos foraneos de VtaPoliticaDescuento */ 	
	static function getVtaPoliticaDescuentoRangosXVtaPoliticaDescuentos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaPoliticaDescuentoRango::GEN_ATTR_VTA_POLITICA_DESCUENTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaPoliticaDescuentoRango::GEN_TABLA);
            $c->addOrden(VtaPoliticaDescuentoRango::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaPoliticaDescuentoRango::getVtaPoliticaDescuentoRangos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaPoliticaDescuentoRangos filtrado por una coleccion de objetos foraneos de InsTipoListaPrecio */ 	
	static function getVtaPoliticaDescuentoRangosXInsTipoListaPrecios($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaPoliticaDescuentoRango::GEN_ATTR_INS_TIPO_LISTA_PRECIO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaPoliticaDescuentoRango::GEN_TABLA);
            $c->addOrden(VtaPoliticaDescuentoRango::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_politica_descuento_rango_adm.php';
            $url_gestion = 'vta_politica_descuento_rango_gestion.php';
	...
	public function getVtaPresupuestoInsInsumos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaPresupuestoInsInsumo::GEN_ATTR_VTA_POLITICA_DESCUENTO_RANGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaPresupuestoInsInsumosCmb(){
            $c = new Criterio();
            $c->add(VtaPresupuestoInsInsumo::GEN_ATTR_VTA_POLITICA_DESCUENTO_RANGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaPresupuestoInsInsumo::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaOrdenVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaOrdenVenta::GEN_ATTR_VTA_POLITICA_DESCUENTO_RANGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaOrdenVentasCmb(){
            $c = new Criterio();
            $c->add(VtaOrdenVenta::GEN_ATTR_VTA_POLITICA_DESCUENTO_RANGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaOrdenVenta::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_politica_descuento_rango'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_politica_descuento_rango';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaPoliticaDescuentoRangos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaPoliticaDescuentoRangos(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'cantidad_desde' */ 	
	static function getOxCantidadDesde($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CANTIDAD_DESDE, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'cantidad_desde' */ 	
	static function getOsxCantidadDesde($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CANTIDAD_DESDE, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna un objeto de acuerdo al 'cantidad_hasta' */ 	
	static function getOxCantidadHasta($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CANTIDAD_HASTA, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'cantidad_hasta' */ 	
	static function getOsxCantidadHasta($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_CANTIDAD_HASTA, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna un objeto de acuerdo al 'porcentaje_negociacion' */ 	
	static function getOxPorcentajeNegociacion($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_PORCENTAJE_NEGOCIACION, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'porcentaje_negociacion' */ 	
	static function getOsxPorcentajeNegociacion($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_PORCENTAJE_NEGOCIACION, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_politica_descuento_rango_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaPoliticaDescuentoRango::GEN_TABLA);
                $c->addOrden(VtaPoliticaDescuentoRango::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($vta_politica_descuento_rangos as $vta_politica_descuento_rango){
                    $descripcion = $vta_politica_descuento_rango->getDescripcion();

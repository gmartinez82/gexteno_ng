...
class BPdeFacturaPdeOc
{ 
	
	const SES_PAGINACION = 'adm_pdefacturapdeoc_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdefacturapdeoc_paginas_registros';
	const SES_CRITERIOS = 'adm_pdefacturapdeoc_criterios';
	
	const GEN_CLASE = 'PdeFacturaPdeOc';
	const GEN_TABLA = 'pde_factura_pde_oc';
	...
	/* Constantes de Atributos de BPdeFacturaPdeOc */ 
	const GEN_ATTR_ID = 'pde_factura_pde_oc.id';
	const GEN_ATTR_DESCRIPCION = 'pde_factura_pde_oc.descripcion';
	const GEN_ATTR_PDE_FACTURA_ID = 'pde_factura_pde_oc.pde_factura_id';
	const GEN_ATTR_PDE_OC_ID = 'pde_factura_pde_oc.pde_oc_id';
	const GEN_ATTR_INS_INSUMO_ID = 'pde_factura_pde_oc.ins_insumo_id';
	const GEN_ATTR_INS_UNIDAD_MEDIDA_ID = 'pde_factura_pde_oc.ins_unidad_medida_id';
	const GEN_ATTR_GRAL_TIPO_IVA_ID = 'pde_factura_pde_oc.gral_tipo_iva_id';
	const GEN_ATTR_IMPORTE_UNITARIO = 'pde_factura_pde_oc.importe_unitario';
	const GEN_ATTR_CANTIDAD = 'pde_factura_pde_oc.cantidad';
	const GEN_ATTR_INS_INSUMO_COSTO_ID = 'pde_factura_pde_oc.ins_insumo_costo_id';
	const GEN_ATTR_IMPORTE_COSTO = 'pde_factura_pde_oc.importe_costo';
	const GEN_ATTR_PORCENTAJE_DESCUENTO = 'pde_factura_pde_oc.porcentaje_descuento';
	const GEN_ATTR_CODIGO = 'pde_factura_pde_oc.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_factura_pde_oc.observacion';
	const GEN_ATTR_ORDEN = 'pde_factura_pde_oc.orden';
	const GEN_ATTR_ESTADO = 'pde_factura_pde_oc.estado';
	const GEN_ATTR_CREADO = 'pde_factura_pde_oc.creado';
	const GEN_ATTR_CREADO_POR = 'pde_factura_pde_oc.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_factura_pde_oc.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_factura_pde_oc.modificado_por';

	/* Constantes de Atributos Min de BPdeFacturaPdeOc */ 
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeFacturaPdeOc::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BPdeFacturaPdeOc */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_factura_pde_oc_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_factura_pde_oc_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeFacturaPdeOc(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeFacturaPdeOcs($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeFacturaPdeOc::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdefacturapdeoc = new PdeFacturaPdeOc();
                    $pdefacturapdeoc->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdefacturapdeoc->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdefacturapdeoc->setPdeFacturaId($fila[self::GEN_ATTR_MIN_PDE_FACTURA_ID]);
			$pdefacturapdeoc->setPdeOcId($fila[self::GEN_ATTR_MIN_PDE_OC_ID]);
			$pdefacturapdeoc->setInsInsumoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_ID]);
			$pdefacturapdeoc->setInsUnidadMedidaId($fila[self::GEN_ATTR_MIN_INS_UNIDAD_MEDIDA_ID]);
			$pdefacturapdeoc->setGralTipoIvaId($fila[self::GEN_ATTR_MIN_GRAL_TIPO_IVA_ID]);
			$pdefacturapdeoc->setImporteUnitario($fila[self::GEN_ATTR_MIN_IMPORTE_UNITARIO]);
			$pdefacturapdeoc->setCantidad($fila[self::GEN_ATTR_MIN_CANTIDAD]);
			$pdefacturapdeoc->setInsInsumoCostoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_COSTO_ID]);
			$pdefacturapdeoc->setImporteCosto($fila[self::GEN_ATTR_MIN_IMPORTE_COSTO]);
			$pdefacturapdeoc->setPorcentajeDescuento($fila[self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO]);
			$pdefacturapdeoc->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdefacturapdeoc->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdefacturapdeoc->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdefacturapdeoc->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdefacturapdeoc->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdefacturapdeoc->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdefacturapdeoc->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdefacturapdeoc->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeFacturaPdeOcsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeFacturaPdeOc::getPdeFacturaPdeOcs($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeFacturaPdeOcs para listado de Backend */ 	
	static function getPdeFacturaPdeOcsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeFacturaPdeOc::getPdeFacturaPdeOcs($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeFacturaPdeOcsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeFacturaPdeOc::getPdeFacturaPdeOcs($paginador, $criterio);
	...
	/* Método getPdeFacturaPdeOcs filtrado para select */ 	
	static function getPdeFacturaPdeOcsCmbF($paginador = null, $criterio = null){
            $col = PdeFacturaPdeOc::getPdeFacturaPdeOcs($paginador, $criterio);
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de PdeFactura */ 	
	static function getPdeFacturaPdeOcsXPdeFacturas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_PDE_FACTURA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeFacturaPdeOc::getPdeFacturaPdeOcs($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de PdeOc */ 	
	static function getPdeFacturaPdeOcsXPdeOcs($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_PDE_OC_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de InsInsumo */ 	
	static function getPdeFacturaPdeOcsXInsInsumos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_INS_INSUMO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de InsUnidadMedida */ 	
	static function getPdeFacturaPdeOcsXInsUnidadMedidas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_INS_UNIDAD_MEDIDA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de GralTipoIva */ 	
	static function getPdeFacturaPdeOcsXGralTipoIvas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_GRAL_TIPO_IVA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeOcs filtrado por una coleccion de objetos foraneos de InsInsumoCosto */ 	
	static function getPdeFacturaPdeOcsXInsInsumoCostos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeOc::GEN_ATTR_INS_INSUMO_COSTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_factura_pde_oc_adm.php';
            $url_gestion = 'pde_factura_pde_oc_gestion.php';
	...
	public function getPdeNotaCreditoPdeFacturaPdeOcs($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaCreditoPdeFacturaPdeOc::GEN_ATTR_PDE_FACTURA_PDE_OC_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaCreditoPdeFacturaPdeOcsCmb(){
            $c = new Criterio();
            $c->add(PdeNotaCreditoPdeFacturaPdeOc::GEN_ATTR_PDE_FACTURA_PDE_OC_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaCreditoPdeFacturaPdeOc::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_factura_pde_oc'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_factura_pde_oc';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeFacturaPdeOcs($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeFacturaPdeOcs(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_factura_pde_oc_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeFacturaPdeOc::GEN_TABLA);
                $c->addOrden(PdeFacturaPdeOc::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_factura_pde_ocs = PdeFacturaPdeOc::getPdeFacturaPdeOcs(null, $c);

                $arr = array();
                foreach($pde_factura_pde_ocs as $pde_factura_pde_oc){
                    $descripcion = $pde_factura_pde_oc->getDescripcion();

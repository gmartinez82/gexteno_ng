...
class BPdiPedidoDestinatario
{ 
	
	const SES_PAGINACION = 'adm_pdipedidodestinatario_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdipedidodestinatario_paginas_registros';
	const SES_CRITERIOS = 'adm_pdipedidodestinatario_criterios';
	
	const GEN_CLASE = 'PdiPedidoDestinatario';
	const GEN_TABLA = 'pdi_pedido_destinatario';
	...
	/* Constantes de Atributos de BPdiPedidoDestinatario */ 
	const GEN_ATTR_ID = 'pdi_pedido_destinatario.id';
	const GEN_ATTR_DESCRIPCION = 'pdi_pedido_destinatario.descripcion';
	const GEN_ATTR_PDI_PEDIDO_ID = 'pdi_pedido_destinatario.pdi_pedido_id';
	const GEN_ATTR_US_USUARIO_ID = 'pdi_pedido_destinatario.us_usuario_id';
	const GEN_ATTR_OBSERVADO = 'pdi_pedido_destinatario.observado';
	const GEN_ATTR_LEIDO = 'pdi_pedido_destinatario.leido';
	const GEN_ATTR_DESTACADO = 'pdi_pedido_destinatario.destacado';
	const GEN_ATTR_AVISO_EMAIL = 'pdi_pedido_destinatario.aviso_email';
	const GEN_ATTR_AVISO_SMS = 'pdi_pedido_destinatario.aviso_sms';
	const GEN_ATTR_CODIGO = 'pdi_pedido_destinatario.codigo';
	const GEN_ATTR_OBSERVACION = 'pdi_pedido_destinatario.observacion';
	const GEN_ATTR_ORDEN = 'pdi_pedido_destinatario.orden';
	const GEN_ATTR_ESTADO = 'pdi_pedido_destinatario.estado';
	const GEN_ATTR_CREADO = 'pdi_pedido_destinatario.creado';
	const GEN_ATTR_CREADO_POR = 'pdi_pedido_destinatario.creado_por';
	const GEN_ATTR_MODIFICADO = 'pdi_pedido_destinatario.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pdi_pedido_destinatario.modificado_por';

	/* Constantes de Atributos Min de BPdiPedidoDestinatario */ 
	...
	/* Atributos de BPdiPedidoDestinatario */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdiPedidoDestinatario */ 
	...
	/* Setters de BPdiPedidoDestinatario */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PdiPedidoDestinatario();
            $o->setId($fila[PdiPedidoDestinatario::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdiPedidoDestinatario */ 	
	...
	/* Cambia el estado de BPdiPedidoDestinatario */ 	
	...
	/* Save de BPdiPedidoDestinatario */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pdi_pedido_destinatario_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getPdiPedidoId()."
						, ".$this->getUsUsuarioId()."
						, ".$this->getObservado()."
                    ...
                    ) RETURNING currval('pdi_pedido_destinatario_seq')";
                ...
                $sql = "
				 ...
				 ".PdiPedidoDestinatario::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdiPedidoDestinatario */ 	
	...
	public function duplicarPdiPedidoDestinatario(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdiPedidoDestinatarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdiPedidoDestinatario::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdipedidodestinatario = new PdiPedidoDestinatario();
                    $pdipedidodestinatario->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdipedidodestinatario->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdipedidodestinatario->setPdiPedidoId($fila[self::GEN_ATTR_MIN_PDI_PEDIDO_ID]);
			$pdipedidodestinatario->setUsUsuarioId($fila[self::GEN_ATTR_MIN_US_USUARIO_ID]);
			$pdipedidodestinatario->setObservado($fila[self::GEN_ATTR_MIN_OBSERVADO]);
			$pdipedidodestinatario->setLeido($fila[self::GEN_ATTR_MIN_LEIDO]);
			$pdipedidodestinatario->setDestacado($fila[self::GEN_ATTR_MIN_DESTACADO]);
			$pdipedidodestinatario->setAvisoEmail($fila[self::GEN_ATTR_MIN_AVISO_EMAIL]);
			$pdipedidodestinatario->setAvisoSms($fila[self::GEN_ATTR_MIN_AVISO_SMS]);
			$pdipedidodestinatario->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdipedidodestinatario->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdipedidodestinatario->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdipedidodestinatario->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdipedidodestinatario->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdipedidodestinatario->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdipedidodestinatario->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdipedidodestinatario->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdiPedidoDestinatariosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdiPedidoDestinatario::getPdiPedidoDestinatarios($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdiPedidoDestinatarios para listado de Backend */ 	
	static function getPdiPedidoDestinatariosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdiPedidoDestinatario::getPdiPedidoDestinatarios($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdiPedidoDestinatariosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdiPedidoDestinatario::getPdiPedidoDestinatarios($paginador, $criterio);
	...
	/* Método getPdiPedidoDestinatarios filtrado para select */ 	
	static function getPdiPedidoDestinatariosCmbF($paginador = null, $criterio = null){
            $col = PdiPedidoDestinatario::getPdiPedidoDestinatarios($paginador, $criterio);
	...
	/* Método getPdiPedidoDestinatarios filtrado por una coleccion de objetos foraneos de PdiPedido */ 	
	static function getPdiPedidoDestinatariosXPdiPedidos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoDestinatario::GEN_ATTR_PDI_PEDIDO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoDestinatario::GEN_TABLA);
            $c->addOrden(PdiPedidoDestinatario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdiPedidoDestinatario::getPdiPedidoDestinatarios($p, $c);
            foreach($os as $o){
	...
	/* Método getPdiPedidoDestinatarios filtrado por una coleccion de objetos foraneos de UsUsuario */ 	
	static function getPdiPedidoDestinatariosXUsUsuarios($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdiPedidoDestinatario::GEN_ATTR_US_USUARIO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdiPedidoDestinatario::GEN_TABLA);
            $c->addOrden(PdiPedidoDestinatario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pdi_pedido_destinatario_adm.php';
            $url_gestion = 'pdi_pedido_destinatario_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pdi_pedido_destinatario'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pdi_pedido_destinatario';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdiPedidoDestinatarios($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdiPedidoDestinatarios(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pdi_pedido_destinatario_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdiPedidoDestinatario::GEN_TABLA);
                $c->addOrden(PdiPedidoDestinatario::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pdi_pedido_destinatarios = PdiPedidoDestinatario::getPdiPedidoDestinatarios(null, $c);

                $arr = array();
                foreach($pdi_pedido_destinatarios as $pdi_pedido_destinatario){
                    $descripcion = $pdi_pedido_destinatario->getDescripcion();

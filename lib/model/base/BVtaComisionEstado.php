...
class BVtaComisionEstado
{ 
	
	const SES_PAGINACION = 'adm_vtacomisionestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtacomisionestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtacomisionestado_criterios';
	
	const GEN_CLASE = 'VtaComisionEstado';
	const GEN_TABLA = 'vta_comision_estado';
	...
	/* Constantes de Atributos de BVtaComisionEstado */ 
	const GEN_ATTR_ID = 'vta_comision_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_comision_estado.descripcion';
	const GEN_ATTR_VTA_COMISION_ID = 'vta_comision_estado.vta_comision_id';
	const GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID = 'vta_comision_estado.vta_comision_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'vta_comision_estado.inicial';
	const GEN_ATTR_ACTUAL = 'vta_comision_estado.actual';
	const GEN_ATTR_CODIGO = 'vta_comision_estado.codigo';
	const GEN_ATTR_NOTA_INTERNA = 'vta_comision_estado.nota_interna';
	const GEN_ATTR_NOTA_PUBLICA = 'vta_comision_estado.nota_publica';
	const GEN_ATTR_OBSERVACION = 'vta_comision_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_comision_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_comision_estado.estado';
	const GEN_ATTR_CREADO = 'vta_comision_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_comision_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_comision_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_comision_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaComisionEstado */ 
	...
	/* Atributos de BVtaComisionEstado */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaComisionEstado();
            $o->setId($fila[VtaComisionEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaComisionEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_comision_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_comision_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaComisionEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaComisionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaComisionEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtacomisionestado = new VtaComisionEstado();
                    $vtacomisionestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtacomisionestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtacomisionestado->setVtaComisionId($fila[self::GEN_ATTR_MIN_VTA_COMISION_ID]);
			$vtacomisionestado->setVtaComisionTipoEstadoId($fila[self::GEN_ATTR_MIN_VTA_COMISION_TIPO_ESTADO_ID]);
			$vtacomisionestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$vtacomisionestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$vtacomisionestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtacomisionestado->setNotaInterna($fila[self::GEN_ATTR_MIN_NOTA_INTERNA]);
			$vtacomisionestado->setNotaPublica($fila[self::GEN_ATTR_MIN_NOTA_PUBLICA]);
			$vtacomisionestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtacomisionestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtacomisionestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtacomisionestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtacomisionestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtacomisionestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtacomisionestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaComisionEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaComisionEstado::getVtaComisionEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaComisionEstados para listado de Backend */ 	
	static function getVtaComisionEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaComisionEstado::getVtaComisionEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaComisionEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaComisionEstado::getVtaComisionEstados($paginador, $criterio);
	...
	/* Método getVtaComisionEstados filtrado para select */ 	
	static function getVtaComisionEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaComisionEstado::getVtaComisionEstados($paginador, $criterio);
	...
	/* Método getVtaComisionEstados filtrado por una coleccion de objetos foraneos de VtaComision */ 	
	static function getVtaComisionEstadosXVtaComisions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionEstado::GEN_ATTR_VTA_COMISION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionEstado::GEN_TABLA);
            $c->addOrden(VtaComisionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaComisionEstado::getVtaComisionEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaComisionEstados filtrado por una coleccion de objetos foraneos de VtaComisionTipoEstado */ 	
	static function getVtaComisionEstadosXVtaComisionTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionEstado::GEN_ATTR_VTA_COMISION_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionEstado::GEN_TABLA);
            $c->addOrden(VtaComisionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_comision_estado_adm.php';
            $url_gestion = 'vta_comision_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_comision_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_comision_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaComisionEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaComisionEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_comision_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaComisionEstado::GEN_TABLA);
                $c->addOrden(VtaComisionEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($vta_comision_estados as $vta_comision_estado){
                    $descripcion = $vta_comision_estado->getDescripcion();

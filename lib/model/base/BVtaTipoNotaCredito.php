...
class BVtaTipoNotaCredito
{ 
	
	const SES_PAGINACION = 'adm_vtatiponotacredito_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtatiponotacredito_paginas_registros';
	const SES_CRITERIOS = 'adm_vtatiponotacredito_criterios';
	
	const GEN_CLASE = 'VtaTipoNotaCredito';
	const GEN_TABLA = 'vta_tipo_nota_credito';
	...
	/* Constantes de Atributos de BVtaTipoNotaCredito */ 
	const GEN_ATTR_ID = 'vta_tipo_nota_credito.id';
	const GEN_ATTR_DESCRIPCION = 'vta_tipo_nota_credito.descripcion';
	const GEN_ATTR_CODIGO_MIN = 'vta_tipo_nota_credito.codigo_min';
	const GEN_ATTR_CODIGO = 'vta_tipo_nota_credito.codigo';
	const GEN_ATTR_INFORMA = 'vta_tipo_nota_credito.informa';
	const GEN_ATTR_OBSERVACION = 'vta_tipo_nota_credito.observacion';
	const GEN_ATTR_ORDEN = 'vta_tipo_nota_credito.orden';
	const GEN_ATTR_ESTADO = 'vta_tipo_nota_credito.estado';
	const GEN_ATTR_CREADO = 'vta_tipo_nota_credito.creado';
	const GEN_ATTR_CREADO_POR = 'vta_tipo_nota_credito.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_tipo_nota_credito.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_tipo_nota_credito.modificado_por';

	/* Constantes de Atributos Min de BVtaTipoNotaCredito */ 
	...
	/* Atributos de BVtaTipoNotaCredito */ 
	private $id;
	private $descripcion;
	private $codigo_min;
	private $codigo;
	...
	/* Getters de BVtaTipoNotaCredito */ 
	...
	/* Setters de BVtaTipoNotaCredito */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaTipoNotaCredito::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaTipoNotaCredito */ 	
	...
	/* Cambia el estado de BVtaTipoNotaCredito */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_tipo_nota_credito_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigoMin()."'
						, '".$this->getCodigo()."'
						, ".$this->getInforma()."
                    ...
                    ) RETURNING currval('vta_tipo_nota_credito_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaTipoNotaCredito(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaTipoNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaTipoNotaCredito::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtatiponotacreditos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtatiponotacredito = new VtaTipoNotaCredito();
                    $vtatiponotacredito->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtatiponotacredito->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtatiponotacredito->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtatiponotacredito->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtatiponotacredito->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$vtatiponotacredito->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtatiponotacredito->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtatiponotacredito->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtatiponotacredito->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtatiponotacredito->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtatiponotacredito->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtatiponotacredito->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtatiponotacreditos[] = $vtatiponotacredito;
		}
		
		return $vtatiponotacreditos;
	}	
	

	/* Método getVtaTipoNotaCreditos Habilitados */ 	
	static function getVtaTipoNotaCreditosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaTipoNotaCredito::getVtaTipoNotaCreditos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaTipoNotaCreditos para listado de Backend */ 	
	static function getVtaTipoNotaCreditosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaTipoNotaCredito::getVtaTipoNotaCreditos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaTipoNotaCreditosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaTipoNotaCredito::getVtaTipoNotaCreditos($paginador, $criterio);
	...
	/* Método getVtaTipoNotaCreditos filtrado para select */ 	
	static function getVtaTipoNotaCreditosCmbF($paginador = null, $criterio = null){
            $col = VtaTipoNotaCredito::getVtaTipoNotaCreditos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_tipo_nota_credito_adm.php';
            $url_gestion = 'vta_tipo_nota_credito_gestion.php';
	...
	public function getGralCondicionIvaVtaTipoNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralCondicionIvaVtaTipoNotaCredito::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralCondicionIvaVtaTipoNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(GralCondicionIvaVtaTipoNotaCredito::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralCondicionIvaVtaTipoNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralCondicionIvas (Coleccion) relacionados a traves de GralCondicionIvaVtaTipoNotaCredito */ 	
	public function getGralCondicionIvasXGralCondicionIvaVtaTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralCondicionIvaVtaTipoNotaCredito::GEN_TABLA, GralCondicionIvaVtaTipoNotaCredito::GEN_ATTR_GRAL_CONDICION_IVA_ID, GralCondicionIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralCondicionIvas relacionados a traves de GralCondicionIvaVtaTipoNotaCredito */ 	
	public function getCantidadGralCondicionIvasXGralCondicionIvaVtaTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralCondicionIva (Objeto) relacionado a traves de GralCondicionIvaVtaTipoNotaCredito */ 	
	public function getGralCondicionIvaXGralCondicionIvaVtaTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralCondicionIvasXGralCondicionIvaVtaTipoNotaCredito($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaTipoNotaCreditoWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaTipoNotaCreditoWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(VtaTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaTipoNotaCreditoWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de VtaTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXVtaTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(VtaTipoNotaCreditoWsFeParamTipoComprobante::GEN_TABLA, VtaTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de VtaTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXVtaTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de VtaTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXVtaTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXVtaTipoNotaCreditoWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaNotaCredito::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(VtaNotaCredito::GEN_ATTR_VTA_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralCondicionIvas asignados a VtaTipoNotaCredito */ 	
	...
	/* Método setea nuevos GralCondicionIvas asignados al VtaTipoNotaCredito */ 	
	public function setGralCondicionIvaVtaTipoNotaCreditos($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaTipoNotaCreditoId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralCondicionIva en el alta de VtaTipoNotaCredito */ 	
	public function getAltaMostrarBloqueRelacionGralCondicionIvaVtaTipoNotaCredito(){
            return true;
	}
	

	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a VtaTipoNotaCredito */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al VtaTipoNotaCredito */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de VtaTipoNotaCredito */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_tipo_nota_credito'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_tipo_nota_credito';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaTipoNotaCreditos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaTipoNotaCreditos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_tipo_nota_credito_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaTipoNotaCredito::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_tipo_nota_creditos = VtaTipoNotaCredito::getVtaTipoNotaCreditos(null, $c);

                $arr = array();
                foreach($vta_tipo_nota_creditos as $vta_tipo_nota_credito){
                    $descripcion = $vta_tipo_nota_credito->getDescripcion();

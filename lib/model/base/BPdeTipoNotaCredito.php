...
class BPdeTipoNotaCredito
{ 
	
	const SES_PAGINACION = 'adm_pdetiponotacredito_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdetiponotacredito_paginas_registros';
	const SES_CRITERIOS = 'adm_pdetiponotacredito_criterios';
	
	const GEN_CLASE = 'PdeTipoNotaCredito';
	const GEN_TABLA = 'pde_tipo_nota_credito';
	...
	/* Constantes de Atributos de BPdeTipoNotaCredito */ 
	const GEN_ATTR_ID = 'pde_tipo_nota_credito.id';
	const GEN_ATTR_DESCRIPCION = 'pde_tipo_nota_credito.descripcion';
	const GEN_ATTR_CODIGO_MIN = 'pde_tipo_nota_credito.codigo_min';
	const GEN_ATTR_CODIGO = 'pde_tipo_nota_credito.codigo';
	const GEN_ATTR_INFORMA = 'pde_tipo_nota_credito.informa';
	const GEN_ATTR_OBSERVACION = 'pde_tipo_nota_credito.observacion';
	const GEN_ATTR_ORDEN = 'pde_tipo_nota_credito.orden';
	const GEN_ATTR_ESTADO = 'pde_tipo_nota_credito.estado';
	const GEN_ATTR_CREADO = 'pde_tipo_nota_credito.creado';
	const GEN_ATTR_CREADO_POR = 'pde_tipo_nota_credito.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_tipo_nota_credito.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_tipo_nota_credito.modificado_por';

	/* Constantes de Atributos Min de BPdeTipoNotaCredito */ 
	...
	/* Atributos de BPdeTipoNotaCredito */ 
	private $id;
	private $descripcion;
	private $codigo_min;
	private $codigo;
	...
	/* Getters de BPdeTipoNotaCredito */ 
	...
	/* Setters de BPdeTipoNotaCredito */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeTipoNotaCredito::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeTipoNotaCredito */ 	
	...
	/* Cambia el estado de BPdeTipoNotaCredito */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_tipo_nota_credito_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigoMin()."'
						, '".$this->getCodigo()."'
						, ".$this->getInforma()."
                    ...
                    ) RETURNING currval('pde_tipo_nota_credito_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeTipoNotaCredito(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeTipoNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeTipoNotaCredito::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdetiponotacreditos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdetiponotacredito = new PdeTipoNotaCredito();
                    $pdetiponotacredito->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdetiponotacredito->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdetiponotacredito->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$pdetiponotacredito->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdetiponotacredito->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$pdetiponotacredito->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdetiponotacredito->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdetiponotacredito->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdetiponotacredito->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdetiponotacredito->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdetiponotacredito->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdetiponotacredito->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdetiponotacreditos[] = $pdetiponotacredito;
		}
		
		return $pdetiponotacreditos;
	}	
	

	/* Método getPdeTipoNotaCreditos Habilitados */ 	
	static function getPdeTipoNotaCreditosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeTipoNotaCredito::getPdeTipoNotaCreditos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeTipoNotaCreditos para listado de Backend */ 	
	static function getPdeTipoNotaCreditosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeTipoNotaCredito::getPdeTipoNotaCreditos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeTipoNotaCreditosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeTipoNotaCredito::getPdeTipoNotaCreditos($paginador, $criterio);
	...
	/* Método getPdeTipoNotaCreditos filtrado para select */ 	
	static function getPdeTipoNotaCreditosCmbF($paginador = null, $criterio = null){
            $col = PdeTipoNotaCredito::getPdeTipoNotaCreditos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_tipo_nota_credito_adm.php';
            $url_gestion = 'pde_tipo_nota_credito_gestion.php';
	...
	public function getGralCondicionIvaPdeTipoNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralCondicionIvaPdeTipoNotaCredito::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralCondicionIvaPdeTipoNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(GralCondicionIvaPdeTipoNotaCredito::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralCondicionIvaPdeTipoNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralCondicionIvas (Coleccion) relacionados a traves de GralCondicionIvaPdeTipoNotaCredito */ 	
	public function getGralCondicionIvasXGralCondicionIvaPdeTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralCondicionIvaPdeTipoNotaCredito::GEN_TABLA, GralCondicionIvaPdeTipoNotaCredito::GEN_ATTR_GRAL_CONDICION_IVA_ID, GralCondicionIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralCondicionIvas relacionados a traves de GralCondicionIvaPdeTipoNotaCredito */ 	
	public function getCantidadGralCondicionIvasXGralCondicionIvaPdeTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralCondicionIva (Objeto) relacionado a traves de GralCondicionIvaPdeTipoNotaCredito */ 	
	public function getGralCondicionIvaXGralCondicionIvaPdeTipoNotaCredito($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralCondicionIvasXGralCondicionIvaPdeTipoNotaCredito($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPdeTipoNotaCreditoWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeTipoNotaCreditoWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(PdeTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeTipoNotaCreditoWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de PdeTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXPdeTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PdeTipoNotaCreditoWsFeParamTipoComprobante::GEN_TABLA, PdeTipoNotaCreditoWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de PdeTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXPdeTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de PdeTipoNotaCreditoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXPdeTipoNotaCreditoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXPdeTipoNotaCreditoWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPdeNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaCredito::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(PdeNotaCredito::GEN_ATTR_PDE_TIPO_NOTA_CREDITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralCondicionIvas asignados a PdeTipoNotaCredito */ 	
	...
	/* Método setea nuevos GralCondicionIvas asignados al PdeTipoNotaCredito */ 	
	public function setGralCondicionIvaPdeTipoNotaCreditos($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setPdeTipoNotaCreditoId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralCondicionIva en el alta de PdeTipoNotaCredito */ 	
	public function getAltaMostrarBloqueRelacionGralCondicionIvaPdeTipoNotaCredito(){
            return true;
	}
	

	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a PdeTipoNotaCredito */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al PdeTipoNotaCredito */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de PdeTipoNotaCredito */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_tipo_nota_credito'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_tipo_nota_credito';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeTipoNotaCreditos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeTipoNotaCreditos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_tipo_nota_credito_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeTipoNotaCredito::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_tipo_nota_creditos = PdeTipoNotaCredito::getPdeTipoNotaCreditos(null, $c);

                $arr = array();
                foreach($pde_tipo_nota_creditos as $pde_tipo_nota_credito){
                    $descripcion = $pde_tipo_nota_credito->getDescripcion();

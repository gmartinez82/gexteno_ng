...
class BVtaReciboCondicionPago
{ 
	
	const SES_PAGINACION = 'adm_vtarecibocondicionpago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtarecibocondicionpago_paginas_registros';
	const SES_CRITERIOS = 'adm_vtarecibocondicionpago_criterios';
	
	const GEN_CLASE = 'VtaReciboCondicionPago';
	const GEN_TABLA = 'vta_recibo_condicion_pago';
	...
	/* Constantes de Atributos de BVtaReciboCondicionPago */ 
	const GEN_ATTR_ID = 'vta_recibo_condicion_pago.id';
	const GEN_ATTR_DESCRIPCION = 'vta_recibo_condicion_pago.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'vta_recibo_condicion_pago.descripcion_corta';
	const GEN_ATTR_CODIGO = 'vta_recibo_condicion_pago.codigo';
	const GEN_ATTR_CODIGO_MIN = 'vta_recibo_condicion_pago.codigo_min';
	const GEN_ATTR_COLOR = 'vta_recibo_condicion_pago.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'vta_recibo_condicion_pago.color_secundario';
	const GEN_ATTR_OBSERVACION = 'vta_recibo_condicion_pago.observacion';
	const GEN_ATTR_ORDEN = 'vta_recibo_condicion_pago.orden';
	const GEN_ATTR_ESTADO = 'vta_recibo_condicion_pago.estado';
	const GEN_ATTR_CREADO = 'vta_recibo_condicion_pago.creado';
	const GEN_ATTR_CREADO_POR = 'vta_recibo_condicion_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_recibo_condicion_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_recibo_condicion_pago.modificado_por';

	/* Constantes de Atributos Min de BVtaReciboCondicionPago */ 
	...
	/* Atributos de BVtaReciboCondicionPago */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaReciboCondicionPago */ 
	...
	/* Setters de BVtaReciboCondicionPago */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaReciboCondicionPago::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaReciboCondicionPago */ 	
	...
	/* Cambia el estado de BVtaReciboCondicionPago */ 	
	...
	/* Save de BVtaReciboCondicionPago */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_recibo_condicion_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_recibo_condicion_pago_seq')";
                ...
                $sql = "
				 ...
				 ".VtaReciboCondicionPago::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaReciboCondicionPago */ 	
	...
	public function duplicarVtaReciboCondicionPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaReciboCondicionPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaReciboCondicionPago::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtarecibocondicionpagos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtarecibocondicionpago = new VtaReciboCondicionPago();
                    $vtarecibocondicionpago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtarecibocondicionpago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtarecibocondicionpago->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$vtarecibocondicionpago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtarecibocondicionpago->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtarecibocondicionpago->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$vtarecibocondicionpago->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$vtarecibocondicionpago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtarecibocondicionpago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtarecibocondicionpago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtarecibocondicionpago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtarecibocondicionpago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtarecibocondicionpago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtarecibocondicionpago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtarecibocondicionpagos[] = $vtarecibocondicionpago;
		}
		
		return $vtarecibocondicionpagos;
	}	
	

	/* Método getVtaReciboCondicionPagos Habilitados */ 	
	static function getVtaReciboCondicionPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaReciboCondicionPago::getVtaReciboCondicionPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaReciboCondicionPagos para listado de Backend */ 	
	static function getVtaReciboCondicionPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaReciboCondicionPago::getVtaReciboCondicionPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaReciboCondicionPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaReciboCondicionPago::getVtaReciboCondicionPagos($paginador, $criterio);
	...
	/* Método getVtaReciboCondicionPagos filtrado para select */ 	
	static function getVtaReciboCondicionPagosCmbF($paginador = null, $criterio = null){
            $col = VtaReciboCondicionPago::getVtaReciboCondicionPagos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_recibo_condicion_pago_adm.php';
            $url_gestion = 'vta_recibo_condicion_pago_gestion.php';
	...
	public function getVtaRecibos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaRecibosCmb(){
            $c = new Criterio();
            $c->add(VtaRecibo::GEN_ATTR_VTA_RECIBO_CONDICION_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRecibo::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_recibo_condicion_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_recibo_condicion_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaReciboCondicionPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaReciboCondicionPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_recibo_condicion_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaReciboCondicionPago::GEN_TABLA);
                $c->addOrden(VtaReciboCondicionPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_recibo_condicion_pagos = VtaReciboCondicionPago::getVtaReciboCondicionPagos(null, $c);

                $arr = array();
                foreach($vta_recibo_condicion_pagos as $vta_recibo_condicion_pago){
                    $descripcion = $vta_recibo_condicion_pago->getDescripcion();

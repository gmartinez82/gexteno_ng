...
class BVtaComisionGralFpFormaPago
{ 
	
	const SES_PAGINACION = 'adm_vtacomisiongralfpformapago_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtacomisiongralfpformapago_paginas_registros';
	const SES_CRITERIOS = 'adm_vtacomisiongralfpformapago_criterios';
	
	const GEN_CLASE = 'VtaComisionGralFpFormaPago';
	const GEN_TABLA = 'vta_comision_gral_fp_forma_pago';
	...
	/* Constantes de Atributos de BVtaComisionGralFpFormaPago */ 
	const GEN_ATTR_ID = 'vta_comision_gral_fp_forma_pago.id';
	const GEN_ATTR_DESCRIPCION = 'vta_comision_gral_fp_forma_pago.descripcion';
	const GEN_ATTR_VTA_COMISION_ID = 'vta_comision_gral_fp_forma_pago.vta_comision_id';
	const GEN_ATTR_GRAL_FP_FORMA_PAGO_ID = 'vta_comision_gral_fp_forma_pago.gral_fp_forma_pago_id';
	const GEN_ATTR_IMPORTE_AFECTADO = 'vta_comision_gral_fp_forma_pago.importe_afectado';
	const GEN_ATTR_CODIGO = 'vta_comision_gral_fp_forma_pago.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_comision_gral_fp_forma_pago.observacion';
	const GEN_ATTR_ORDEN = 'vta_comision_gral_fp_forma_pago.orden';
	const GEN_ATTR_ESTADO = 'vta_comision_gral_fp_forma_pago.estado';
	const GEN_ATTR_CREADO = 'vta_comision_gral_fp_forma_pago.creado';
	const GEN_ATTR_CREADO_POR = 'vta_comision_gral_fp_forma_pago.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_comision_gral_fp_forma_pago.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_comision_gral_fp_forma_pago.modificado_por';

	/* Constantes de Atributos Min de BVtaComisionGralFpFormaPago */ 
	...
	/* Atributos de BVtaComisionGralFpFormaPago */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaComisionGralFpFormaPago */ 
	...
	/* Setters de BVtaComisionGralFpFormaPago */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaComisionGralFpFormaPago::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaComisionGralFpFormaPago */ 	
	...
	/* Cambia el estado de BVtaComisionGralFpFormaPago */ 	
	...
	/* Save de BVtaComisionGralFpFormaPago */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_comision_gral_fp_forma_pago_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_comision_gral_fp_forma_pago_seq')";
                ...
                $sql = "
				 ...
				 ".VtaComisionGralFpFormaPago::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaComisionGralFpFormaPago */ 	
	...
	public function duplicarVtaComisionGralFpFormaPago(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaComisionGralFpFormaPagos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaComisionGralFpFormaPago::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtacomisiongralfpformapago = new VtaComisionGralFpFormaPago();
                    $vtacomisiongralfpformapago->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtacomisiongralfpformapago->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtacomisiongralfpformapago->setVtaComisionId($fila[self::GEN_ATTR_MIN_VTA_COMISION_ID]);
			$vtacomisiongralfpformapago->setGralFpFormaPagoId($fila[self::GEN_ATTR_MIN_GRAL_FP_FORMA_PAGO_ID]);
			$vtacomisiongralfpformapago->setImporteAfectado($fila[self::GEN_ATTR_MIN_IMPORTE_AFECTADO]);
			$vtacomisiongralfpformapago->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtacomisiongralfpformapago->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtacomisiongralfpformapago->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtacomisiongralfpformapago->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtacomisiongralfpformapago->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtacomisiongralfpformapago->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtacomisiongralfpformapago->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtacomisiongralfpformapago->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaComisionGralFpFormaPagosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaComisionGralFpFormaPagos para listado de Backend */ 	
	static function getVtaComisionGralFpFormaPagosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaComisionGralFpFormaPagosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos($paginador, $criterio);
	...
	/* Método getVtaComisionGralFpFormaPagos filtrado para select */ 	
	static function getVtaComisionGralFpFormaPagosCmbF($paginador = null, $criterio = null){
            $col = VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos($paginador, $criterio);
	...
	/* Método getVtaComisionGralFpFormaPagos filtrado por una coleccion de objetos foraneos de VtaComision */ 	
	static function getVtaComisionGralFpFormaPagosXVtaComisions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionGralFpFormaPago::GEN_ATTR_VTA_COMISION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionGralFpFormaPago::GEN_TABLA);
            $c->addOrden(VtaComisionGralFpFormaPago::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaComisionGralFpFormaPagos filtrado por una coleccion de objetos foraneos de GralFpFormaPago */ 	
	static function getVtaComisionGralFpFormaPagosXGralFpFormaPagos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaComisionGralFpFormaPago::GEN_ATTR_GRAL_FP_FORMA_PAGO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaComisionGralFpFormaPago::GEN_TABLA);
            $c->addOrden(VtaComisionGralFpFormaPago::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_comision_gral_fp_forma_pago_adm.php';
            $url_gestion = 'vta_comision_gral_fp_forma_pago_gestion.php';
	...
	public function getVtaComisionGralFpFormaPagoCheques($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaComisionGralFpFormaPagoChequesCmb(){
            $c = new Criterio();
            $c->add(VtaComisionGralFpFormaPagoCheque::GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaComisionGralFpFormaPagoCheque::GEN_TABLA);
            $c->setCriterios();
	...
	public function getFndChqCheques($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(FndChqCheque::GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getFndChqChequesCmb(){
            $c = new Criterio();
            $c->add(FndChqCheque::GEN_ATTR_VTA_COMISION_GRAL_FP_FORMA_PAGO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(FndChqCheque::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_comision_gral_fp_forma_pago'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_comision_gral_fp_forma_pago';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaComisionGralFpFormaPagos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaComisionGralFpFormaPagos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_comision_gral_fp_forma_pago_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaComisionGralFpFormaPago::GEN_TABLA);
                $c->addOrden(VtaComisionGralFpFormaPago::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_comision_gral_fp_forma_pagos = VtaComisionGralFpFormaPago::getVtaComisionGralFpFormaPagos(null, $c);

                $arr = array();
                foreach($vta_comision_gral_fp_forma_pagos as $vta_comision_gral_fp_forma_pago){
                    $descripcion = $vta_comision_gral_fp_forma_pago->getDescripcion();

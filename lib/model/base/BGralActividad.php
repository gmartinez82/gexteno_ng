...
class BGralActividad
{ 
	
	const SES_PAGINACION = 'adm_gralactividad_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_gralactividad_paginas_registros';
	const SES_CRITERIOS = 'adm_gralactividad_criterios';
	
	const GEN_CLASE = 'GralActividad';
	const GEN_TABLA = 'gral_actividad';
	...
	/* Constantes de Atributos de BGralActividad */ 
	const GEN_ATTR_ID = 'gral_actividad.id';
	const GEN_ATTR_DESCRIPCION = 'gral_actividad.descripcion';
	const GEN_ATTR_CODIGO = 'gral_actividad.codigo';
	const GEN_ATTR_OBSERVACION = 'gral_actividad.observacion';
	const GEN_ATTR_ORDEN = 'gral_actividad.orden';
	const GEN_ATTR_ESTADO = 'gral_actividad.estado';
	const GEN_ATTR_CREADO = 'gral_actividad.creado';
	const GEN_ATTR_CREADO_POR = 'gral_actividad.creado_por';
	const GEN_ATTR_MODIFICADO = 'gral_actividad.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'gral_actividad.modificado_por';

	/* Constantes de Atributos Min de BGralActividad */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new GralActividad();
            $o->setId($fila[GralActividad::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BGralActividad */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('gral_actividad_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function deleteAll(){
            ...
            // se elimina la coleccion de GralEscenarios relacionados
            $c = new Criterio('COLECCION_DELETE_ALL');
            $c->addTabla(GralEscenario::GEN_TABLA);
            $c->setCriterios();		
            foreach($this->getGralEscenarios(null, $c) as $o){
                    $o->deleteAll();
            }
	...
	public function duplicarGralActividad(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getGralActividads($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = GralActividad::setAplicarFiltrosDeAlcance($criterio);
		...
		$gralactividads = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $gralactividad = new GralActividad();
                    $gralactividad->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $gralactividad->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$gralactividad->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$gralactividad->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$gralactividad->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$gralactividad->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$gralactividad->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$gralactividad->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$gralactividad->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$gralactividad->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $gralactividads[] = $gralactividad;
		}
		
		return $gralactividads;
	}	
	

	/* Método getGralActividads Habilitados */ 	
	static function getGralActividadsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return GralActividad::getGralActividads($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getGralActividads para listado de Backend */ 	
	static function getGralActividadsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return GralActividad::getGralActividads($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getGralActividadsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = GralActividad::getGralActividads($paginador, $criterio);
	...
	/* Método getGralActividads filtrado para select */ 	
	static function getGralActividadsCmbF($paginador = null, $criterio = null){
            $col = GralActividad::getGralActividads($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'gral_actividad_adm.php';
            $url_gestion = 'gral_actividad_gestion.php';
	...
	/* Metodo getGralEscenarios */ 	
	public function getGralEscenarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            // inicializacion de variables
            if(is_null($paginador)){
                $paginador = new Paginador(GralEscenario::getCantidadTotalDeRegistros(), 1);
            }
            if(is_null($criterio)){
                ...
                //$criterio->addOrden(GralEscenario::GEN_ATTR_ORDEN, 'asc');                            
                $criterio->addOrden('1', 'asc');			
                $criterio->setCriterios();
            }
                
            $criterio->add(GralEscenario::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
                    $criterio->add(GralEscenario::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
                }else{
                    $criterio->add(GralEscenario::GEN_ATTR_ESTADO, 0, Criterio::IGUAL);			
                }
            }
            ...
            $cons = new Consulta();
            $sql = "SELECT ".$criterio->getDistinct()." ".GralEscenario::GEN_TABLA.".* FROM ".$criterio->getTablas().$criterio->getWhere().$criterio->getOrden();
            ...
            while($fila = pg_fetch_array($cons->getResultado())){
                $gralescenario = GralEscenario::hidratarObjeto($fila);			
	...
	/* Método getGralEscenariosBloque para MasInfo */ 	
	public function getGralEscenariosParaBloqueMasInfo($paginador = null, $criterio = null, $estado = null){
            // inicializacion de variables
            if(is_null($paginador)){
                $paginador = new Paginador(50, 1);
            }

            $os = $this->getGralEscenarios($paginador, $criterio, $estado);
            return $os;
		
	}

	/* Método getGralEscenarios Habilitados */ 	
	public function getGralEscenariosHabilitados($paginador = null, $criterio = null, $estado = null){

            $os = $this->getGralEscenarios($paginador, $criterio, true);
            return $os;
		
	}

	/* Método getGralEscenario */ 	
	public function getGralEscenario($criterio = null){
            $paginador = new Paginador(1, 1);
            $os = $this->getGralEscenarios($paginador, $criterio);
            foreach($os as $o){
                return $o;
            }
            return false;
	...
	/* Delete de GralEscenario relacionadas */ 	
	public function deleteGralEscenarios(){
            $obs = $this->getGralEscenarios();
            foreach($obs as $o){
                $o->delete();
            }
            return true;
	...
	/* Metodos getGralEscenariosCmb() GralEscenario relacionadas */ 	
	public function getGralEscenariosCmb(){
            $c = new Criterio();
            $c->add(GralEscenario::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralEscenario::GEN_TABLA);
            $c->setCriterios();

            $os = GralEscenario::getGralEscenariosCmbF(null, $c);
            return $os;
	}
	...
	public function getCliClienteGralActividads($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteGralActividad::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteGralActividadsCmb(){
            $c = new Criterio();
            $c->add(CliClienteGralActividad::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteGralActividad::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteGralActividad */ 	
	public function getCliClientesXCliClienteGralActividad($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(CliClienteGralActividad::GEN_TABLA, CliClienteGralActividad::GEN_ATTR_CLI_CLIENTE_ID, CliCliente::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteGralActividad */ 	
	public function getCantidadCliClientesXCliClienteGralActividad($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteGralActividad */ 	
	public function getCliClienteXCliClienteGralActividad($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteGralActividad($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaPresupuestos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaPresupuesto::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaPresupuestosCmb(){
            $c = new Criterio();
            $c->add(VtaPresupuesto::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaPresupuesto::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaNotaCredito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(VtaNotaCredito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaNotaDebitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaNotaDebito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaNotaDebitosCmb(){
            $c = new Criterio();
            $c->add(VtaNotaDebito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaDebito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaFactura::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaFacturasCmb(){
            $c = new Criterio();
            $c->add(VtaFactura::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaFactura::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeFactura::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeFacturasCmb(){
            $c = new Criterio();
            $c->add(PdeFactura::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeFactura::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeNotaCreditos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaCredito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaCreditosCmb(){
            $c = new Criterio();
            $c->add(PdeNotaCredito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaCredito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeNotaDebitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaDebito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaDebitosCmb(){
            $c = new Criterio();
            $c->add(PdeNotaDebito::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaDebito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCntbDiarioAsientos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CntbDiarioAsiento::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCntbDiarioAsientosCmb(){
            $c = new Criterio();
            $c->add(CntbDiarioAsiento::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CntbDiarioAsiento::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaAjusteDebes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteDebe::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteDebesCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteDebe::GEN_ATTR_GRAL_ACTIVIDAD_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteDebe::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los CliClientes asignados a GralActividad */ 	
	...
	/* Método setea nuevos CliClientes asignados al GralActividad */ 	
	public function setCliClienteGralActividads($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setGralActividadId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion CliCliente en el alta de GralActividad */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM gral_actividad'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'gral_actividad';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getGralActividads($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getGralActividads(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'gral_actividad_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(GralActividad::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $gral_actividads = GralActividad::getGralActividads(null, $c);

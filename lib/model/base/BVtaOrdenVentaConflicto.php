...
class BVtaOrdenVentaConflicto
{ 
	
	const SES_PAGINACION = 'adm_vtaordenventaconflicto_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaordenventaconflicto_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaordenventaconflicto_criterios';
	
	const GEN_CLASE = 'VtaOrdenVentaConflicto';
	const GEN_TABLA = 'vta_orden_venta_conflicto';
	...
	/* Constantes de Atributos de BVtaOrdenVentaConflicto */ 
	const GEN_ATTR_ID = 'vta_orden_venta_conflicto.id';
	const GEN_ATTR_DESCRIPCION = 'vta_orden_venta_conflicto.descripcion';
	const GEN_ATTR_VTA_ORDEN_VENTA_ID = 'vta_orden_venta_conflicto.vta_orden_venta_id';
	const GEN_ATTR_IMPORTE_INICIAL = 'vta_orden_venta_conflicto.importe_inicial';
	const GEN_ATTR_IMPORTE_ACTUALIZADO = 'vta_orden_venta_conflicto.importe_actualizado';
	const GEN_ATTR_IMPORTE_DIFERENCIA = 'vta_orden_venta_conflicto.importe_diferencia';
	const GEN_ATTR_IMPORTE_RESUELTO = 'vta_orden_venta_conflicto.importe_resuelto';
	const GEN_ATTR_FECHA_CONFLICTO = 'vta_orden_venta_conflicto.fecha_conflicto';
	const GEN_ATTR_FECHA_RESOLUCION = 'vta_orden_venta_conflicto.fecha_resolucion';
	const GEN_ATTR_US_USUARIO_RESOLUCION = 'vta_orden_venta_conflicto.us_usuario_resolucion';
	const GEN_ATTR_RESUELTO = 'vta_orden_venta_conflicto.resuelto';
	const GEN_ATTR_CODIGO = 'vta_orden_venta_conflicto.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_orden_venta_conflicto.observacion';
	const GEN_ATTR_ORDEN = 'vta_orden_venta_conflicto.orden';
	const GEN_ATTR_ESTADO = 'vta_orden_venta_conflicto.estado';
	const GEN_ATTR_CREADO = 'vta_orden_venta_conflicto.creado';
	const GEN_ATTR_CREADO_POR = 'vta_orden_venta_conflicto.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_orden_venta_conflicto.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_orden_venta_conflicto.modificado_por';

	/* Constantes de Atributos Min de BVtaOrdenVentaConflicto */ 
	...
	/* Atributos de BVtaOrdenVentaConflicto */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaOrdenVentaConflicto */ 
	...
	/* Setters de BVtaOrdenVentaConflicto */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaOrdenVentaConflicto();
            $o->setId($fila[VtaOrdenVentaConflicto::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaOrdenVentaConflicto */ 	
	...
	/* Cambia el estado de BVtaOrdenVentaConflicto */ 	
	...
	/* Save de BVtaOrdenVentaConflicto */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_orden_venta_conflicto_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_orden_venta_conflicto_seq')";
                ...
                $sql = "
				 ...
				 ".VtaOrdenVentaConflicto::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaOrdenVentaConflicto */ 	
	...
	public function duplicarVtaOrdenVentaConflicto(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaOrdenVentaConflictos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaOrdenVentaConflicto::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaordenventaconflicto = new VtaOrdenVentaConflicto();
                    $vtaordenventaconflicto->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaordenventaconflicto->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaordenventaconflicto->setVtaOrdenVentaId($fila[self::GEN_ATTR_MIN_VTA_ORDEN_VENTA_ID]);
			$vtaordenventaconflicto->setImporteInicial($fila[self::GEN_ATTR_MIN_IMPORTE_INICIAL]);
			$vtaordenventaconflicto->setImporteActualizado($fila[self::GEN_ATTR_MIN_IMPORTE_ACTUALIZADO]);
			$vtaordenventaconflicto->setImporteDiferencia($fila[self::GEN_ATTR_MIN_IMPORTE_DIFERENCIA]);
			$vtaordenventaconflicto->setImporteResuelto($fila[self::GEN_ATTR_MIN_IMPORTE_RESUELTO]);
			$vtaordenventaconflicto->setFechaConflicto($fila[self::GEN_ATTR_MIN_FECHA_CONFLICTO]);
			$vtaordenventaconflicto->setFechaResolucion($fila[self::GEN_ATTR_MIN_FECHA_RESOLUCION]);
			$vtaordenventaconflicto->setUsUsuarioResolucion($fila[self::GEN_ATTR_MIN_US_USUARIO_RESOLUCION]);
			$vtaordenventaconflicto->setResuelto($fila[self::GEN_ATTR_MIN_RESUELTO]);
			$vtaordenventaconflicto->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaordenventaconflicto->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaordenventaconflicto->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaordenventaconflicto->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaordenventaconflicto->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaordenventaconflicto->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaordenventaconflicto->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaordenventaconflicto->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaOrdenVentaConflictosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaOrdenVentaConflictos para listado de Backend */ 	
	static function getVtaOrdenVentaConflictosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaOrdenVentaConflictosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos($paginador, $criterio);
	...
	/* Método getVtaOrdenVentaConflictos filtrado para select */ 	
	static function getVtaOrdenVentaConflictosCmbF($paginador = null, $criterio = null){
            $col = VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos($paginador, $criterio);
	...
	/* Método getVtaOrdenVentaConflictos filtrado por una coleccion de objetos foraneos de VtaOrdenVenta */ 	
	static function getVtaOrdenVentaConflictosXVtaOrdenVentas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaOrdenVentaConflicto::GEN_ATTR_VTA_ORDEN_VENTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaOrdenVentaConflicto::GEN_TABLA);
            $c->addOrden(VtaOrdenVentaConflicto::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_orden_venta_conflicto_adm.php';
            $url_gestion = 'vta_orden_venta_conflicto_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_orden_venta_conflicto'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_orden_venta_conflicto';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaOrdenVentaConflictos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaOrdenVentaConflictos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_orden_venta_conflicto_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaOrdenVentaConflicto::GEN_TABLA);
                $c->addOrden(VtaOrdenVentaConflicto::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_orden_venta_conflictos = VtaOrdenVentaConflicto::getVtaOrdenVentaConflictos(null, $c);

                $arr = array();
                foreach($vta_orden_venta_conflictos as $vta_orden_venta_conflicto){
                    $descripcion = $vta_orden_venta_conflicto->getDescripcion();

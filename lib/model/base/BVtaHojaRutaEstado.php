...
class BVtaHojaRutaEstado
{ 
	
	const SES_PAGINACION = 'adm_vtahojarutaestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtahojarutaestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtahojarutaestado_criterios';
	
	const GEN_CLASE = 'VtaHojaRutaEstado';
	const GEN_TABLA = 'vta_hoja_ruta_estado';
	...
	/* Constantes de Atributos de BVtaHojaRutaEstado */ 
	const GEN_ATTR_ID = 'vta_hoja_ruta_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_hoja_ruta_estado.descripcion';
	const GEN_ATTR_VTA_HOJA_RUTA_ID = 'vta_hoja_ruta_estado.vta_hoja_ruta_id';
	const GEN_ATTR_VTA_HOJA_RUTA_TIPO_ESTADO_ID = 'vta_hoja_ruta_estado.vta_hoja_ruta_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'vta_hoja_ruta_estado.inicial';
	const GEN_ATTR_ACTUAL = 'vta_hoja_ruta_estado.actual';
	const GEN_ATTR_CODIGO = 'vta_hoja_ruta_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_hoja_ruta_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_hoja_ruta_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_hoja_ruta_estado.estado';
	const GEN_ATTR_CREADO = 'vta_hoja_ruta_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_hoja_ruta_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_hoja_ruta_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_hoja_ruta_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaHojaRutaEstado */ 
	...
	/* Atributos de BVtaHojaRutaEstado */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaHojaRutaEstado();
            $o->setId($fila[VtaHojaRutaEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaHojaRutaEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_hoja_ruta_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_hoja_ruta_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaHojaRutaEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaHojaRutaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaHojaRutaEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtahojarutaestado = new VtaHojaRutaEstado();
                    $vtahojarutaestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtahojarutaestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtahojarutaestado->setVtaHojaRutaId($fila[self::GEN_ATTR_MIN_VTA_HOJA_RUTA_ID]);
			$vtahojarutaestado->setVtaHojaRutaTipoEstadoId($fila[self::GEN_ATTR_MIN_VTA_HOJA_RUTA_TIPO_ESTADO_ID]);
			$vtahojarutaestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$vtahojarutaestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$vtahojarutaestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtahojarutaestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtahojarutaestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtahojarutaestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtahojarutaestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtahojarutaestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtahojarutaestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtahojarutaestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaHojaRutaEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaHojaRutaEstado::getVtaHojaRutaEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaHojaRutaEstados para listado de Backend */ 	
	static function getVtaHojaRutaEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaHojaRutaEstado::getVtaHojaRutaEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaHojaRutaEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaHojaRutaEstado::getVtaHojaRutaEstados($paginador, $criterio);
	...
	/* Método getVtaHojaRutaEstados filtrado para select */ 	
	static function getVtaHojaRutaEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaHojaRutaEstado::getVtaHojaRutaEstados($paginador, $criterio);
	...
	/* Método getVtaHojaRutaEstados filtrado por una coleccion de objetos foraneos de VtaHojaRuta */ 	
	static function getVtaHojaRutaEstadosXVtaHojaRutas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaHojaRutaEstado::GEN_ATTR_VTA_HOJA_RUTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaHojaRutaEstado::GEN_TABLA);
            $c->addOrden(VtaHojaRutaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaHojaRutaEstado::getVtaHojaRutaEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaHojaRutaEstados filtrado por una coleccion de objetos foraneos de VtaHojaRutaTipoEstado */ 	
	static function getVtaHojaRutaEstadosXVtaHojaRutaTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaHojaRutaEstado::GEN_ATTR_VTA_HOJA_RUTA_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaHojaRutaEstado::GEN_TABLA);
            $c->addOrden(VtaHojaRutaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_hoja_ruta_estado_adm.php';
            $url_gestion = 'vta_hoja_ruta_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_hoja_ruta_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_hoja_ruta_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaHojaRutaEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaHojaRutaEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_hoja_ruta_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaHojaRutaEstado::GEN_TABLA);
                $c->addOrden(VtaHojaRutaEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($vta_hoja_ruta_estados as $vta_hoja_ruta_estado){
                    $descripcion = $vta_hoja_ruta_estado->getDescripcion();

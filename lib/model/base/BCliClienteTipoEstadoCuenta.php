...
class BCliClienteTipoEstadoCuenta
{ 
	
	const SES_PAGINACION = 'adm_cliclientetipoestadocuenta_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclientetipoestadocuenta_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclientetipoestadocuenta_criterios';
	
	const GEN_CLASE = 'CliClienteTipoEstadoCuenta';
	const GEN_TABLA = 'cli_cliente_tipo_estado_cuenta';
	...
	/* Constantes de Atributos de BCliClienteTipoEstadoCuenta */ 
	const GEN_ATTR_ID = 'cli_cliente_tipo_estado_cuenta.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_tipo_estado_cuenta.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_tipo_estado_cuenta.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_tipo_estado_cuenta.descripcion_publica';
	const GEN_ATTR_LEYENDA = 'cli_cliente_tipo_estado_cuenta.leyenda';
	const GEN_ATTR_ACTIVO = 'cli_cliente_tipo_estado_cuenta.activo';
	const GEN_ATTR_TERMINAL = 'cli_cliente_tipo_estado_cuenta.terminal';
	const GEN_ATTR_ANULADO = 'cli_cliente_tipo_estado_cuenta.anulado';
	const GEN_ATTR_GESTIONABLE = 'cli_cliente_tipo_estado_cuenta.gestionable';
	const GEN_ATTR_BLOQUEADO = 'cli_cliente_tipo_estado_cuenta.bloqueado';
	const GEN_ATTR_ANOMALIA = 'cli_cliente_tipo_estado_cuenta.anomalia';
	const GEN_ATTR_COLOR = 'cli_cliente_tipo_estado_cuenta.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_tipo_estado_cuenta.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_tipo_estado_cuenta.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_tipo_estado_cuenta.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_tipo_estado_cuenta.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_tipo_estado_cuenta.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_tipo_estado_cuenta.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_tipo_estado_cuenta.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_tipo_estado_cuenta.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_tipo_estado_cuenta.modificado_por';

	/* Constantes de Atributos Min de BCliClienteTipoEstadoCuenta */ 
	...
	/* Atributos de BCliClienteTipoEstadoCuenta */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BCliClienteTipoEstadoCuenta */ 
	...
	/* Setters de BCliClienteTipoEstadoCuenta */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClienteTipoEstadoCuenta::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BCliClienteTipoEstadoCuenta */ 	
	...
	/* Cambia el estado de BCliClienteTipoEstadoCuenta */ 	
	...
	/* Save de BCliClienteTipoEstadoCuenta */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_tipo_estado_cuenta_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_tipo_estado_cuenta_seq')";
                ...
                $sql = "
				 ...
				 ".CliClienteTipoEstadoCuenta::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClienteTipoEstadoCuenta */ 	
	...
	public function duplicarCliClienteTipoEstadoCuenta(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteTipoEstadoCuentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteTipoEstadoCuenta::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclientetipoestadocuentas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclientetipoestadocuenta = new CliClienteTipoEstadoCuenta();
                    $cliclientetipoestadocuenta->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclientetipoestadocuenta->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclientetipoestadocuenta->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclientetipoestadocuenta->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclientetipoestadocuenta->setLeyenda($fila[self::GEN_ATTR_MIN_LEYENDA]);
			$cliclientetipoestadocuenta->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$cliclientetipoestadocuenta->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$cliclientetipoestadocuenta->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$cliclientetipoestadocuenta->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$cliclientetipoestadocuenta->setBloqueado($fila[self::GEN_ATTR_MIN_BLOQUEADO]);
			$cliclientetipoestadocuenta->setAnomalia($fila[self::GEN_ATTR_MIN_ANOMALIA]);
			$cliclientetipoestadocuenta->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclientetipoestadocuenta->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclientetipoestadocuenta->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclientetipoestadocuenta->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclientetipoestadocuenta->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclientetipoestadocuenta->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclientetipoestadocuenta->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclientetipoestadocuenta->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclientetipoestadocuenta->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclientetipoestadocuenta->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclientetipoestadocuentas[] = $cliclientetipoestadocuenta;
		}
		
		return $cliclientetipoestadocuentas;
	}	
	

	/* Método getCliClienteTipoEstadoCuentas Habilitados */ 	
	static function getCliClienteTipoEstadoCuentasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteTipoEstadoCuenta::getCliClienteTipoEstadoCuentas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteTipoEstadoCuentas para listado de Backend */ 	
	static function getCliClienteTipoEstadoCuentasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteTipoEstadoCuenta::getCliClienteTipoEstadoCuentas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteTipoEstadoCuentasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteTipoEstadoCuenta::getCliClienteTipoEstadoCuentas($paginador, $criterio);
	...
	/* Método getCliClienteTipoEstadoCuentas filtrado para select */ 	
	static function getCliClienteTipoEstadoCuentasCmbF($paginador = null, $criterio = null){
            $col = CliClienteTipoEstadoCuenta::getCliClienteTipoEstadoCuentas($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_tipo_estado_cuenta_adm.php';
            $url_gestion = 'cli_cliente_tipo_estado_cuenta_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_CUENTA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_CUENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCliClienteEstadoCuentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteEstadoCuenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_CUENTA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteEstadoCuentasCmb(){
            $c = new Criterio();
            $c->add(CliClienteEstadoCuenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_CUENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteEstadoCuenta::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteEstadoCuenta */ 	
	public function getCliClientesXCliClienteEstadoCuenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(CliClienteEstadoCuenta::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_CUENTA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->addRealJoin(CliClienteEstadoCuenta::GEN_TABLA, CliClienteEstadoCuenta::GEN_ATTR_CLI_CLIENTE_ID, CliCliente::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteEstadoCuenta */ 	
	public function getCantidadCliClientesXCliClienteEstadoCuenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteEstadoCuenta */ 	
	public function getCliClienteXCliClienteEstadoCuenta($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteEstadoCuenta($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_tipo_estado_cuenta'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_tipo_estado_cuenta';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoCuentas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteTipoEstadoCuentas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_tipo_estado_cuenta_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(CliClienteTipoEstadoCuenta::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_tipo_estado_cuentas = CliClienteTipoEstadoCuenta::getCliClienteTipoEstadoCuentas(null, $c);

                $arr = array();
                foreach($cli_cliente_tipo_estado_cuentas as $cli_cliente_tipo_estado_cuenta){
                    $descripcion = $cli_cliente_tipo_estado_cuenta->getDescripcion();

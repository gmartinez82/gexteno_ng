...
class BCliClienteTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_cliclientetipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclientetipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclientetipoestado_criterios';
	
	const GEN_CLASE = 'CliClienteTipoEstado';
	const GEN_TABLA = 'cli_cliente_tipo_estado';
	...
	/* Constantes de Atributos de BCliClienteTipoEstado */ 
	const GEN_ATTR_ID = 'cli_cliente_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_tipo_estado.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_tipo_estado.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_tipo_estado.descripcion_publica';
	const GEN_ATTR_LEYENDA = 'cli_cliente_tipo_estado.leyenda';
	const GEN_ATTR_ACTIVO = 'cli_cliente_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'cli_cliente_tipo_estado.terminal';
	const GEN_ATTR_ANULADO = 'cli_cliente_tipo_estado.anulado';
	const GEN_ATTR_GESTIONABLE = 'cli_cliente_tipo_estado.gestionable';
	const GEN_ATTR_BLOQUEADO = 'cli_cliente_tipo_estado.bloqueado';
	const GEN_ATTR_ANOMALIA = 'cli_cliente_tipo_estado.anomalia';
	const GEN_ATTR_COLOR = 'cli_cliente_tipo_estado.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_tipo_estado.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_tipo_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BCliClienteTipoEstado */ 
	...
	/* Atributos de BCliClienteTipoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BCliClienteTipoEstado */ 
	...
	/* Setters de BCliClienteTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClienteTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BCliClienteTipoEstado */ 	
	...
	/* Cambia el estado de BCliClienteTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".CliClienteTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClienteTipoEstado */ 	
	...
	public function duplicarCliClienteTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClienteTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClienteTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclientetipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclientetipoestado = new CliClienteTipoEstado();
                    $cliclientetipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclientetipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclientetipoestado->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclientetipoestado->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclientetipoestado->setLeyenda($fila[self::GEN_ATTR_MIN_LEYENDA]);
			$cliclientetipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$cliclientetipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$cliclientetipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$cliclientetipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$cliclientetipoestado->setBloqueado($fila[self::GEN_ATTR_MIN_BLOQUEADO]);
			$cliclientetipoestado->setAnomalia($fila[self::GEN_ATTR_MIN_ANOMALIA]);
			$cliclientetipoestado->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclientetipoestado->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclientetipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclientetipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclientetipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclientetipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclientetipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclientetipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclientetipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclientetipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclientetipoestados[] = $cliclientetipoestado;
		}
		
		return $cliclientetipoestados;
	}	
	

	/* Método getCliClienteTipoEstados Habilitados */ 	
	static function getCliClienteTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClienteTipoEstado::getCliClienteTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClienteTipoEstados para listado de Backend */ 	
	static function getCliClienteTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClienteTipoEstado::getCliClienteTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClienteTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClienteTipoEstado::getCliClienteTipoEstados($paginador, $criterio);
	...
	/* Método getCliClienteTipoEstados filtrado para select */ 	
	static function getCliClienteTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = CliClienteTipoEstado::getCliClienteTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_tipo_estado_adm.php';
            $url_gestion = 'cli_cliente_tipo_estado_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
	...
	public function getCliClienteEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliClienteEstado::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClienteEstadosCmb(){
            $c = new Criterio();
            $c->add(CliClienteEstado::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliClienteEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener CliClientes (Coleccion) relacionados a traves de CliClienteEstado */ 	
	public function getCliClientesXCliClienteEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(CliCliente::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(CliClienteEstado::GEN_ATTR_CLI_CLIENTE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->addRealJoin(CliClienteEstado::GEN_TABLA, CliClienteEstado::GEN_ATTR_CLI_CLIENTE_ID, CliCliente::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de CliClientes relacionados a traves de CliClienteEstado */ 	
	public function getCantidadCliClientesXCliClienteEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener CliCliente (Objeto) relacionado a traves de CliClienteEstado */ 	
	public function getCliClienteXCliClienteEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getCliClientesXCliClienteEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClienteTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClienteTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(CliClienteTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_tipo_estados = CliClienteTipoEstado::getCliClienteTipoEstados(null, $c);

                $arr = array();
                foreach($cli_cliente_tipo_estados as $cli_cliente_tipo_estado){
                    $descripcion = $cli_cliente_tipo_estado->getDescripcion();

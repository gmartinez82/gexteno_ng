...
class BPdeOcDestinatario
{ 
	
	const SES_PAGINACION = 'adm_pdeocdestinatario_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdeocdestinatario_paginas_registros';
	const SES_CRITERIOS = 'adm_pdeocdestinatario_criterios';
	
	const GEN_CLASE = 'PdeOcDestinatario';
	const GEN_TABLA = 'pde_oc_destinatario';
	...
	/* Constantes de Atributos de BPdeOcDestinatario */ 
	const GEN_ATTR_ID = 'pde_oc_destinatario.id';
	const GEN_ATTR_DESCRIPCION = 'pde_oc_destinatario.descripcion';
	const GEN_ATTR_PDE_OC_ID = 'pde_oc_destinatario.pde_oc_id';
	const GEN_ATTR_US_USUARIO_ID = 'pde_oc_destinatario.us_usuario_id';
	const GEN_ATTR_OBSERVADO = 'pde_oc_destinatario.observado';
	const GEN_ATTR_LEIDO = 'pde_oc_destinatario.leido';
	const GEN_ATTR_DESTACADO = 'pde_oc_destinatario.destacado';
	const GEN_ATTR_AVISO_EMAIL = 'pde_oc_destinatario.aviso_email';
	const GEN_ATTR_AVISO_SMS = 'pde_oc_destinatario.aviso_sms';
	const GEN_ATTR_CODIGO = 'pde_oc_destinatario.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_oc_destinatario.observacion';
	const GEN_ATTR_ORDEN = 'pde_oc_destinatario.orden';
	const GEN_ATTR_ESTADO = 'pde_oc_destinatario.estado';
	const GEN_ATTR_CREADO = 'pde_oc_destinatario.creado';
	const GEN_ATTR_CREADO_POR = 'pde_oc_destinatario.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_oc_destinatario.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_oc_destinatario.modificado_por';

	/* Constantes de Atributos Min de BPdeOcDestinatario */ 
	...
	/* Atributos de BPdeOcDestinatario */ 
	private $id;
	private $descripcion;
	private $pde_oc_id;
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeOcDestinatario::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BPdeOcDestinatario */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_oc_destinatario_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getPdeOcId()."
						, ".$this->getUsUsuarioId()."
						, ".$this->getObservado()."
                    ...
                    ) RETURNING currval('pde_oc_destinatario_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeOcDestinatario(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeOcDestinatarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeOcDestinatario::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdeocdestinatario = new PdeOcDestinatario();
                    $pdeocdestinatario->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdeocdestinatario->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdeocdestinatario->setPdeOcId($fila[self::GEN_ATTR_MIN_PDE_OC_ID]);
			$pdeocdestinatario->setUsUsuarioId($fila[self::GEN_ATTR_MIN_US_USUARIO_ID]);
			$pdeocdestinatario->setObservado($fila[self::GEN_ATTR_MIN_OBSERVADO]);
			$pdeocdestinatario->setLeido($fila[self::GEN_ATTR_MIN_LEIDO]);
			$pdeocdestinatario->setDestacado($fila[self::GEN_ATTR_MIN_DESTACADO]);
			$pdeocdestinatario->setAvisoEmail($fila[self::GEN_ATTR_MIN_AVISO_EMAIL]);
			$pdeocdestinatario->setAvisoSms($fila[self::GEN_ATTR_MIN_AVISO_SMS]);
			$pdeocdestinatario->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdeocdestinatario->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdeocdestinatario->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdeocdestinatario->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdeocdestinatario->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdeocdestinatario->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdeocdestinatario->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdeocdestinatario->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeOcDestinatariosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeOcDestinatario::getPdeOcDestinatarios($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeOcDestinatarios para listado de Backend */ 	
	static function getPdeOcDestinatariosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeOcDestinatario::getPdeOcDestinatarios($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeOcDestinatariosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeOcDestinatario::getPdeOcDestinatarios($paginador, $criterio);
	...
	/* Método getPdeOcDestinatarios filtrado para select */ 	
	static function getPdeOcDestinatariosCmbF($paginador = null, $criterio = null){
            $col = PdeOcDestinatario::getPdeOcDestinatarios($paginador, $criterio);
	...
	/* Método getPdeOcDestinatarios filtrado por una coleccion de objetos foraneos de PdeOc */ 	
	static function getPdeOcDestinatariosXPdeOcs($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeOcDestinatario::GEN_ATTR_PDE_OC_ID, $arr_ids, Criterio::IN_ARRAY);
            ...
            $os = PdeOcDestinatario::getPdeOcDestinatarios($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeOcDestinatarios filtrado por una coleccion de objetos foraneos de UsUsuario */ 	
	static function getPdeOcDestinatariosXUsUsuarios($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeOcDestinatario::GEN_ATTR_US_USUARIO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeOcDestinatario::GEN_TABLA);
            $c->addOrden(PdeOcDestinatario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_oc_destinatario_adm.php';
            $url_gestion = 'pde_oc_destinatario_gestion.php';
	...
	public function getPdeOcEnvioEmails($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeOcEnvioEmail::GEN_ATTR_PDE_OC_DESTINATARIO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeOcEnvioEmailsCmb(){
            $c = new Criterio();
            $c->add(PdeOcEnvioEmail::GEN_ATTR_PDE_OC_DESTINATARIO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOcEnvioEmail::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PdeOcs (Coleccion) relacionados a traves de PdeOcEnvioEmail */ 	
	public function getPdeOcsXPdeOcEnvioEmail($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PdeOcEnvioEmail::GEN_TABLA, PdeOcEnvioEmail::GEN_ATTR_PDE_OC_ID, PdeOc::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PdeOcs relacionados a traves de PdeOcEnvioEmail */ 	
	public function getCantidadPdeOcsXPdeOcEnvioEmail($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PdeOc (Objeto) relacionado a traves de PdeOcEnvioEmail */ 	
	public function getPdeOcXPdeOcEnvioEmail($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPdeOcsXPdeOcEnvioEmail($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_oc_destinatario'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_oc_destinatario';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeOcDestinatarios($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeOcDestinatarios(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_oc_destinatario_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeOcDestinatario::GEN_TABLA);
                $c->addOrden(PdeOcDestinatario::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_oc_destinatarios = PdeOcDestinatario::getPdeOcDestinatarios(null, $c);

                $arr = array();
                foreach($pde_oc_destinatarios as $pde_oc_destinatario){
                    $descripcion = $pde_oc_destinatario->getDescripcion();

...
class BEkuDeOpeTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_ekudeopetipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_ekudeopetipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_ekudeopetipoestado_criterios';
	
	const GEN_CLASE = 'EkuDeOpeTipoEstado';
	const GEN_TABLA = 'eku_de_ope_tipo_estado';
	...
	/* Constantes de Atributos de BEkuDeOpeTipoEstado */ 
	const GEN_ATTR_ID = 'eku_de_ope_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'eku_de_ope_tipo_estado.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'eku_de_ope_tipo_estado.descripcion_corta';
	const GEN_ATTR_APROBADO = 'eku_de_ope_tipo_estado.aprobado';
	const GEN_ATTR_ACTIVO = 'eku_de_ope_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'eku_de_ope_tipo_estado.terminal';
	const GEN_ATTR_ANULADO = 'eku_de_ope_tipo_estado.anulado';
	const GEN_ATTR_GESTIONABLE = 'eku_de_ope_tipo_estado.gestionable';
	const GEN_ATTR_COLOR = 'eku_de_ope_tipo_estado.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'eku_de_ope_tipo_estado.color_secundario';
	const GEN_ATTR_CODIGO = 'eku_de_ope_tipo_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'eku_de_ope_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'eku_de_ope_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'eku_de_ope_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'eku_de_ope_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'eku_de_ope_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'eku_de_ope_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'eku_de_ope_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BEkuDeOpeTipoEstado */ 
	...
	/* Atributos de BEkuDeOpeTipoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BEkuDeOpeTipoEstado */ 
	...
	/* Setters de BEkuDeOpeTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[EkuDeOpeTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BEkuDeOpeTipoEstado */ 	
	...
	/* Cambia el estado de BEkuDeOpeTipoEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('eku_de_ope_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('eku_de_ope_tipo_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function deleteAll(){
            ...
            // se elimina la coleccion de EkuDes relacionados
            $c = new Criterio('COLECCION_DELETE_ALL');
            $c->addTabla(EkuDe::GEN_TABLA);
            $c->setCriterios();		
            foreach($this->getEkuDes(null, $c) as $o){
                    $o->deleteAll();
            }
	...
	public function duplicarEkuDeOpeTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getEkuDeOpeTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = EkuDeOpeTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$ekudeopetipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $ekudeopetipoestado = new EkuDeOpeTipoEstado();
                    $ekudeopetipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $ekudeopetipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$ekudeopetipoestado->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$ekudeopetipoestado->setAprobado($fila[self::GEN_ATTR_MIN_APROBADO]);
			$ekudeopetipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$ekudeopetipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$ekudeopetipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$ekudeopetipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$ekudeopetipoestado->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$ekudeopetipoestado->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$ekudeopetipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$ekudeopetipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$ekudeopetipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$ekudeopetipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$ekudeopetipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$ekudeopetipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$ekudeopetipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$ekudeopetipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $ekudeopetipoestados[] = $ekudeopetipoestado;
		}
		
		return $ekudeopetipoestados;
	}	
	

	/* Método getEkuDeOpeTipoEstados Habilitados */ 	
	static function getEkuDeOpeTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getEkuDeOpeTipoEstados para listado de Backend */ 	
	static function getEkuDeOpeTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getEkuDeOpeTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados($paginador, $criterio);
	...
	/* Método getEkuDeOpeTipoEstados filtrado para select */ 	
	static function getEkuDeOpeTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'eku_de_ope_tipo_estado_adm.php';
            $url_gestion = 'eku_de_ope_tipo_estado_gestion.php';
	...
	/* Metodo getEkuDes */ 	
	public function getEkuDes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            // inicializacion de variables
            if(is_null($paginador)){
                $paginador = new Paginador(EkuDe::getCantidadTotalDeRegistros(), 1);
            }
            if(is_null($criterio)){
                //$criterio = new Criterio(EkuDe::SES_CRITERIOS);
                $criterio = new Criterio();
                $criterio->addTabla(EkuDe::GEN_TABLA);
                ...
                //$criterio->addOrden(EkuDe::GEN_ATTR_ORDEN, 'asc');                            
                $criterio->addOrden('1', 'asc');			
                $criterio->setCriterios();
            }
                
            $criterio->add(EkuDe::GEN_ATTR_EKU_DE_OPE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
                    $criterio->add(EkuDe::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
                }else{
                    $criterio->add(EkuDe::GEN_ATTR_ESTADO, 0, Criterio::IGUAL);			
                }
            }
            ...
            $cons = new Consulta();
            $sql = "SELECT ".$criterio->getDistinct()." ".EkuDe::GEN_TABLA.".* FROM ".$criterio->getTablas().$criterio->getWhere().$criterio->getOrden();
            ...
            $ekudes = array();
            while($fila = pg_fetch_array($cons->getResultado())){
                $ekude = EkuDe::hidratarObjeto($fila);			
                $ekudes[] = $ekude;
            }
	...
	/* Método getEkuDesBloque para MasInfo */ 	
	public function getEkuDesParaBloqueMasInfo($paginador = null, $criterio = null, $estado = null){
            // inicializacion de variables
            if(is_null($paginador)){
                $paginador = new Paginador(50, 1);
            }

            $os = $this->getEkuDes($paginador, $criterio, $estado);
            return $os;
		
	}

	/* Método getEkuDes Habilitados */ 	
	public function getEkuDesHabilitados($paginador = null, $criterio = null, $estado = null){

            $os = $this->getEkuDes($paginador, $criterio, true);
            return $os;
		
	}

	/* Método getEkuDe */ 	
	public function getEkuDe($criterio = null){
            $paginador = new Paginador(1, 1);
            $os = $this->getEkuDes($paginador, $criterio);
            foreach($os as $o){
                return $o;
            }
            return false;
	...
	/* Delete de EkuDe relacionadas */ 	
	public function deleteEkuDes(){
            $obs = $this->getEkuDes();
            foreach($obs as $o){
                $o->delete();
            }
	...
	/* Metodos getEkuDesCmb() EkuDe relacionadas */ 	
	public function getEkuDesCmb(){
            $c = new Criterio();
            $c->add(EkuDe::GEN_ATTR_EKU_DE_OPE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(EkuDe::GEN_TABLA);
            $c->setCriterios();

            $os = EkuDe::getEkuDesCmbF(null, $c);
            return $os;
	}
	...
	public function getEkuDeOpeEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(EkuDeOpeEstado::GEN_ATTR_EKU_DE_OPE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getEkuDeOpeEstadosCmb(){
            $c = new Criterio();
            $c->add(EkuDeOpeEstado::GEN_ATTR_EKU_DE_OPE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(EkuDeOpeEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener EkuDes (Coleccion) relacionados a traves de EkuDeOpeEstado */ 	
	public function getEkuDesXEkuDeOpeEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->add(EkuDeOpeEstado::GEN_ATTR_EKU_DE_OPE_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(EkuDe::GEN_TABLA);
            $c->addRealJoin(EkuDeOpeEstado::GEN_TABLA, EkuDeOpeEstado::GEN_ATTR_EKU_DE_ID, EkuDe::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de EkuDes relacionados a traves de EkuDeOpeEstado */ 	
	public function getCantidadEkuDesXEkuDeOpeEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener EkuDe (Objeto) relacionado a traves de EkuDeOpeEstado */ 	
	public function getEkuDeXEkuDeOpeEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getEkuDesXEkuDeOpeEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM eku_de_ope_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'eku_de_ope_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getEkuDeOpeTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getEkuDeOpeTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'eku_de_ope_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(EkuDeOpeTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $eku_de_ope_tipo_estados = EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados(null, $c);

                $arr = array();
                foreach($eku_de_ope_tipo_estados as $eku_de_ope_tipo_estado){
                    $descripcion = $eku_de_ope_tipo_estado->getDescripcion();

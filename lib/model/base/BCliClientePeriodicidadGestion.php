...
class BCliClientePeriodicidadGestion
{ 
	
	const SES_PAGINACION = 'adm_cliclienteperiodicidadgestion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_cliclienteperiodicidadgestion_paginas_registros';
	const SES_CRITERIOS = 'adm_cliclienteperiodicidadgestion_criterios';
	
	const GEN_CLASE = 'CliClientePeriodicidadGestion';
	const GEN_TABLA = 'cli_cliente_periodicidad_gestion';
	...
	/* Constantes de Atributos de BCliClientePeriodicidadGestion */ 
	const GEN_ATTR_ID = 'cli_cliente_periodicidad_gestion.id';
	const GEN_ATTR_DESCRIPCION = 'cli_cliente_periodicidad_gestion.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'cli_cliente_periodicidad_gestion.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'cli_cliente_periodicidad_gestion.descripcion_publica';
	const GEN_ATTR_COLOR = 'cli_cliente_periodicidad_gestion.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'cli_cliente_periodicidad_gestion.color_secundario';
	const GEN_ATTR_CODIGO = 'cli_cliente_periodicidad_gestion.codigo';
	const GEN_ATTR_OBSERVACION = 'cli_cliente_periodicidad_gestion.observacion';
	const GEN_ATTR_ORDEN = 'cli_cliente_periodicidad_gestion.orden';
	const GEN_ATTR_ESTADO = 'cli_cliente_periodicidad_gestion.estado';
	const GEN_ATTR_CREADO = 'cli_cliente_periodicidad_gestion.creado';
	const GEN_ATTR_CREADO_POR = 'cli_cliente_periodicidad_gestion.creado_por';
	const GEN_ATTR_MODIFICADO = 'cli_cliente_periodicidad_gestion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'cli_cliente_periodicidad_gestion.modificado_por';

	/* Constantes de Atributos Min de BCliClientePeriodicidadGestion */ 
	...
	/* Atributos de BCliClientePeriodicidadGestion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BCliClientePeriodicidadGestion */ 
	...
	/* Setters de BCliClientePeriodicidadGestion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[CliClientePeriodicidadGestion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BCliClientePeriodicidadGestion */ 	
	...
	/* Cambia el estado de BCliClientePeriodicidadGestion */ 	
	...
	/* Save de BCliClientePeriodicidadGestion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('cli_cliente_periodicidad_gestion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('cli_cliente_periodicidad_gestion_seq')";
                ...
                $sql = "
				 ...
				 ".CliClientePeriodicidadGestion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BCliClientePeriodicidadGestion */ 	
	...
	public function duplicarCliClientePeriodicidadGestion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getCliClientePeriodicidadGestions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = CliClientePeriodicidadGestion::setAplicarFiltrosDeAlcance($criterio);
		...
		$cliclienteperiodicidadgestions = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $cliclienteperiodicidadgestion = new CliClientePeriodicidadGestion();
                    $cliclienteperiodicidadgestion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $cliclienteperiodicidadgestion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$cliclienteperiodicidadgestion->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$cliclienteperiodicidadgestion->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$cliclienteperiodicidadgestion->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$cliclienteperiodicidadgestion->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$cliclienteperiodicidadgestion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$cliclienteperiodicidadgestion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$cliclienteperiodicidadgestion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$cliclienteperiodicidadgestion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$cliclienteperiodicidadgestion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$cliclienteperiodicidadgestion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$cliclienteperiodicidadgestion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$cliclienteperiodicidadgestion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $cliclienteperiodicidadgestions[] = $cliclienteperiodicidadgestion;
		}
		
		return $cliclienteperiodicidadgestions;
	}	
	

	/* Método getCliClientePeriodicidadGestions Habilitados */ 	
	static function getCliClientePeriodicidadGestionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return CliClientePeriodicidadGestion::getCliClientePeriodicidadGestions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getCliClientePeriodicidadGestions para listado de Backend */ 	
	static function getCliClientePeriodicidadGestionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return CliClientePeriodicidadGestion::getCliClientePeriodicidadGestions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getCliClientePeriodicidadGestionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = CliClientePeriodicidadGestion::getCliClientePeriodicidadGestions($paginador, $criterio);
	...
	/* Método getCliClientePeriodicidadGestions filtrado para select */ 	
	static function getCliClientePeriodicidadGestionsCmbF($paginador = null, $criterio = null){
            $col = CliClientePeriodicidadGestion::getCliClientePeriodicidadGestions($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'cli_cliente_periodicidad_gestion_adm.php';
            $url_gestion = 'cli_cliente_periodicidad_gestion_gestion.php';
	...
	public function getCliClientes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(CliCliente::GEN_ATTR_CLI_CLIENTE_PERIODICIDAD_GESTION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getCliClientesCmb(){
            $c = new Criterio();
            $c->add(CliCliente::GEN_ATTR_CLI_CLIENTE_PERIODICIDAD_GESTION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(CliCliente::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM cli_cliente_periodicidad_gestion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'cli_cliente_periodicidad_gestion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getCliClientePeriodicidadGestions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getCliClientePeriodicidadGestions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'cli_cliente_periodicidad_gestion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(CliClientePeriodicidadGestion::GEN_TABLA);
                $c->addOrden(CliClientePeriodicidadGestion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $cli_cliente_periodicidad_gestions = CliClientePeriodicidadGestion::getCliClientePeriodicidadGestions(null, $c);

                $arr = array();
                foreach($cli_cliente_periodicidad_gestions as $cli_cliente_periodicidad_gestion){
                    $descripcion = $cli_cliente_periodicidad_gestion->getDescripcion();

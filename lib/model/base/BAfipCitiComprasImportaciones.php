...
class BAfipCitiComprasImportaciones
{ 
	
	const SES_PAGINACION = 'adm_afipciticomprasimportaciones_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_afipciticomprasimportaciones_paginas_registros';
	const SES_CRITERIOS = 'adm_afipciticomprasimportaciones_criterios';
	
	const GEN_CLASE = 'AfipCitiComprasImportaciones';
	const GEN_TABLA = 'afip_citi_compras_importaciones';
	...
	/* Constantes de Atributos de BAfipCitiComprasImportaciones */ 
	const GEN_ATTR_ID = 'afip_citi_compras_importaciones.id';
	const GEN_ATTR_DESCRIPCION = 'afip_citi_compras_importaciones.descripcion';
	const GEN_ATTR_CODIGO = 'afip_citi_compras_importaciones.codigo';
	const GEN_ATTR_AFIP_CITI_PRC_ID = 'afip_citi_compras_importaciones.afip_citi_prc_id';
	const GEN_ATTR_AFIP_CITI_CABECERA_ID = 'afip_citi_compras_importaciones.afip_citi_cabecera_id';
	const GEN_ATTR_AFIP_CITI_DESPACHO_IMPORTACION = 'afip_citi_compras_importaciones.afip_citi_despacho_importacion';
	const GEN_ATTR_AFIP_CITI_IMPORTE_NETO_GRAVADO = 'afip_citi_compras_importaciones.afip_citi_importe_neto_gravado';
	const GEN_ATTR_AFIP_CITI_ALICUOTA_IVA = 'afip_citi_compras_importaciones.afip_citi_alicuota_iva';
	const GEN_ATTR_AFIP_CITI_IMPORTE_IMPUESTO_LIQUIDADO = 'afip_citi_compras_importaciones.afip_citi_importe_impuesto_liquidado';
	const GEN_ATTR_PDE_FACTURA_ID = 'afip_citi_compras_importaciones.pde_factura_id';
	const GEN_ATTR_PDE_NOTA_CREDITO_ID = 'afip_citi_compras_importaciones.pde_nota_credito_id';
	const GEN_ATTR_PDE_NOTA_DEBITO_ID = 'afip_citi_compras_importaciones.pde_nota_debito_id';
	const GEN_ATTR_OBSERVACION = 'afip_citi_compras_importaciones.observacion';
	const GEN_ATTR_ORDEN = 'afip_citi_compras_importaciones.orden';
	const GEN_ATTR_ESTADO = 'afip_citi_compras_importaciones.estado';
	const GEN_ATTR_CREADO = 'afip_citi_compras_importaciones.creado';
	const GEN_ATTR_CREADO_POR = 'afip_citi_compras_importaciones.creado_por';
	const GEN_ATTR_MODIFICADO = 'afip_citi_compras_importaciones.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'afip_citi_compras_importaciones.modificado_por';

	/* Constantes de Atributos Min de BAfipCitiComprasImportaciones */ 
	...
	/* Atributos de BAfipCitiComprasImportaciones */ 
	private $id;
	private $descripcion;
	private $codigo;
	...
	/* Getters de BAfipCitiComprasImportaciones */ 
	...
	/* Setters de BAfipCitiComprasImportaciones */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new AfipCitiComprasImportaciones();
            $o->setId($fila[AfipCitiComprasImportaciones::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BAfipCitiComprasImportaciones */ 	
	...
	/* Cambia el estado de BAfipCitiComprasImportaciones */ 	
	...
	/* Save de BAfipCitiComprasImportaciones */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('afip_citi_compras_importaciones_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
                    ...
                    ) RETURNING currval('afip_citi_compras_importaciones_seq')";
                ...
                $sql = "
				 ...
				 ".AfipCitiComprasImportaciones::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BAfipCitiComprasImportaciones */ 	
	...
	public function duplicarAfipCitiComprasImportaciones(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getAfipCitiComprasImportacioness($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = AfipCitiComprasImportaciones::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $afipciticomprasimportaciones = new AfipCitiComprasImportaciones();
                    $afipciticomprasimportaciones->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $afipciticomprasimportaciones->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$afipciticomprasimportaciones->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$afipciticomprasimportaciones->setAfipCitiPrcId($fila[self::GEN_ATTR_MIN_AFIP_CITI_PRC_ID]);
			$afipciticomprasimportaciones->setAfipCitiCabeceraId($fila[self::GEN_ATTR_MIN_AFIP_CITI_CABECERA_ID]);
			$afipciticomprasimportaciones->setAfipCitiDespachoImportacion($fila[self::GEN_ATTR_MIN_AFIP_CITI_DESPACHO_IMPORTACION]);
			$afipciticomprasimportaciones->setAfipCitiImporteNetoGravado($fila[self::GEN_ATTR_MIN_AFIP_CITI_IMPORTE_NETO_GRAVADO]);
			$afipciticomprasimportaciones->setAfipCitiAlicuotaIva($fila[self::GEN_ATTR_MIN_AFIP_CITI_ALICUOTA_IVA]);
			$afipciticomprasimportaciones->setAfipCitiImporteImpuestoLiquidado($fila[self::GEN_ATTR_MIN_AFIP_CITI_IMPORTE_IMPUESTO_LIQUIDADO]);
			$afipciticomprasimportaciones->setPdeFacturaId($fila[self::GEN_ATTR_MIN_PDE_FACTURA_ID]);
			$afipciticomprasimportaciones->setPdeNotaCreditoId($fila[self::GEN_ATTR_MIN_PDE_NOTA_CREDITO_ID]);
			$afipciticomprasimportaciones->setPdeNotaDebitoId($fila[self::GEN_ATTR_MIN_PDE_NOTA_DEBITO_ID]);
			$afipciticomprasimportaciones->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$afipciticomprasimportaciones->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$afipciticomprasimportaciones->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$afipciticomprasimportaciones->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$afipciticomprasimportaciones->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$afipciticomprasimportaciones->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$afipciticomprasimportaciones->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getAfipCitiComprasImportacionessHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getAfipCitiComprasImportacioness para listado de Backend */ 	
	static function getAfipCitiComprasImportacionessDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getAfipCitiComprasImportacionessCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness($paginador, $criterio);
	...
	/* Método getAfipCitiComprasImportacioness filtrado para select */ 	
	static function getAfipCitiComprasImportacionessCmbF($paginador = null, $criterio = null){
            $col = AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness($paginador, $criterio);
	...
	/* Método getAfipCitiComprasImportacioness filtrado por una coleccion de objetos foraneos de AfipCitiPrc */ 	
	static function getAfipCitiComprasImportacionessXAfipCitiPrcs($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AfipCitiComprasImportaciones::GEN_ATTR_AFIP_CITI_PRC_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
            $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness($p, $c);
            foreach($os as $o){
	...
	/* Método getAfipCitiComprasImportacioness filtrado por una coleccion de objetos foraneos de AfipCitiCabecera */ 	
	static function getAfipCitiComprasImportacionessXAfipCitiCabeceras($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AfipCitiComprasImportaciones::GEN_ATTR_AFIP_CITI_CABECERA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
            $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getAfipCitiComprasImportacioness filtrado por una coleccion de objetos foraneos de PdeFactura */ 	
	static function getAfipCitiComprasImportacionessXPdeFacturas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AfipCitiComprasImportaciones::GEN_ATTR_PDE_FACTURA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
            $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getAfipCitiComprasImportacioness filtrado por una coleccion de objetos foraneos de PdeNotaCredito */ 	
	static function getAfipCitiComprasImportacionessXPdeNotaCreditos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AfipCitiComprasImportaciones::GEN_ATTR_PDE_NOTA_CREDITO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
            $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getAfipCitiComprasImportacioness filtrado por una coleccion de objetos foraneos de PdeNotaDebito */ 	
	static function getAfipCitiComprasImportacionessXPdeNotaDebitos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AfipCitiComprasImportaciones::GEN_ATTR_PDE_NOTA_DEBITO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
            $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'afip_citi_compras_importaciones_adm.php';
            $url_gestion = 'afip_citi_compras_importaciones_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM afip_citi_compras_importaciones'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'afip_citi_compras_importaciones';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getAfipCitiComprasImportacioness($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getAfipCitiComprasImportacioness(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'afip_citi_compras_importaciones_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(AfipCitiComprasImportaciones::GEN_TABLA);
                $c->addOrden(AfipCitiComprasImportaciones::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $afip_citi_compras_importacioness = AfipCitiComprasImportaciones::getAfipCitiComprasImportacioness(null, $c);

                $arr = array();
                foreach($afip_citi_compras_importacioness as $afip_citi_compras_importaciones){
                    $descripcion = $afip_citi_compras_importaciones->getDescripcion();

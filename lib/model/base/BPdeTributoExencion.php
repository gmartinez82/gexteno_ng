...
class BPdeTributoExencion
{ 
	
	const SES_PAGINACION = 'adm_pdetributoexencion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdetributoexencion_paginas_registros';
	const SES_CRITERIOS = 'adm_pdetributoexencion_criterios';
	
	const GEN_CLASE = 'PdeTributoExencion';
	const GEN_TABLA = 'pde_tributo_exencion';
	...
	/* Constantes de Atributos de BPdeTributoExencion */ 
	const GEN_ATTR_ID = 'pde_tributo_exencion.id';
	const GEN_ATTR_DESCRIPCION = 'pde_tributo_exencion.descripcion';
	const GEN_ATTR_PDE_TRIBUTO_ID = 'pde_tributo_exencion.pde_tributo_id';
	const GEN_ATTR_PRV_PROVEEDOR_ID = 'pde_tributo_exencion.prv_proveedor_id';
	const GEN_ATTR_FECHA_INICIO = 'pde_tributo_exencion.fecha_inicio';
	const GEN_ATTR_FECHA_FIN = 'pde_tributo_exencion.fecha_fin';
	const GEN_ATTR_CODIGO = 'pde_tributo_exencion.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_tributo_exencion.observacion';
	const GEN_ATTR_ORDEN = 'pde_tributo_exencion.orden';
	const GEN_ATTR_ESTADO = 'pde_tributo_exencion.estado';
	const GEN_ATTR_CREADO = 'pde_tributo_exencion.creado';
	const GEN_ATTR_CREADO_POR = 'pde_tributo_exencion.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_tributo_exencion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_tributo_exencion.modificado_por';

	/* Constantes de Atributos Min de BPdeTributoExencion */ 
	...
	/* Atributos de BPdeTributoExencion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeTributoExencion */ 
	...
	/* Setters de BPdeTributoExencion */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PdeTributoExencion();
            $o->setId($fila[PdeTributoExencion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeTributoExencion */ 	
	...
	/* Cambia el estado de BPdeTributoExencion */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_tributo_exencion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_tributo_exencion_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeTributoExencion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeTributoExencions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeTributoExencion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdetributoexencion = new PdeTributoExencion();
                    $pdetributoexencion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdetributoexencion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdetributoexencion->setPdeTributoId($fila[self::GEN_ATTR_MIN_PDE_TRIBUTO_ID]);
			$pdetributoexencion->setPrvProveedorId($fila[self::GEN_ATTR_MIN_PRV_PROVEEDOR_ID]);
			$pdetributoexencion->setFechaInicio($fila[self::GEN_ATTR_MIN_FECHA_INICIO]);
			$pdetributoexencion->setFechaFin($fila[self::GEN_ATTR_MIN_FECHA_FIN]);
			$pdetributoexencion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdetributoexencion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdetributoexencion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdetributoexencion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdetributoexencion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdetributoexencion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdetributoexencion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdetributoexencion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeTributoExencionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeTributoExencion::getPdeTributoExencions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeTributoExencions para listado de Backend */ 	
	static function getPdeTributoExencionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeTributoExencion::getPdeTributoExencions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeTributoExencionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeTributoExencion::getPdeTributoExencions($paginador, $criterio);
	...
	/* Método getPdeTributoExencions filtrado para select */ 	
	static function getPdeTributoExencionsCmbF($paginador = null, $criterio = null){
            $col = PdeTributoExencion::getPdeTributoExencions($paginador, $criterio);
	...
	/* Método getPdeTributoExencions filtrado por una coleccion de objetos foraneos de PdeTributo */ 	
	static function getPdeTributoExencionsXPdeTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeTributoExencion::GEN_ATTR_PDE_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeTributoExencion::GEN_TABLA);
            $c->addOrden(PdeTributoExencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeTributoExencion::getPdeTributoExencions($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeTributoExencions filtrado por una coleccion de objetos foraneos de PrvProveedor */ 	
	static function getPdeTributoExencionsXPrvProveedors($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeTributoExencion::GEN_ATTR_PRV_PROVEEDOR_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeTributoExencion::GEN_TABLA);
            $c->addOrden(PdeTributoExencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_tributo_exencion_adm.php';
            $url_gestion = 'pde_tributo_exencion_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_tributo_exencion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_tributo_exencion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeTributoExencions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeTributoExencions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_tributo_exencion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeTributoExencion::GEN_TABLA);
                $c->addOrden(PdeTributoExencion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_tributo_exencions = PdeTributoExencion::getPdeTributoExencions(null, $c);

                $arr = array();
                foreach($pde_tributo_exencions as $pde_tributo_exencion){
                    $descripcion = $pde_tributo_exencion->getDescripcion();

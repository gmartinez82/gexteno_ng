...
class BVtaAjusteDebeItemRetencion
{ 
	
	const SES_PAGINACION = 'adm_vtaajustedebeitemretencion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustedebeitemretencion_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustedebeitemretencion_criterios';
	
	const GEN_CLASE = 'VtaAjusteDebeItemRetencion';
	const GEN_TABLA = 'vta_ajuste_debe_item_retencion';
	...
	/* Constantes de Atributos de BVtaAjusteDebeItemRetencion */ 
	const GEN_ATTR_ID = 'vta_ajuste_debe_item_retencion.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_debe_item_retencion.descripcion';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ID = 'vta_ajuste_debe_item_retencion.vta_ajuste_debe_id';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ITEM_ID = 'vta_ajuste_debe_item_retencion.vta_ajuste_debe_item_id';
	const GEN_ATTR_NUMERO_COMPROBANTE = 'vta_ajuste_debe_item_retencion.numero_comprobante';
	const GEN_ATTR_FECHA_EMISION = 'vta_ajuste_debe_item_retencion.fecha_emision';
	const GEN_ATTR_IMPORTE_BASE_IMPONIBLE = 'vta_ajuste_debe_item_retencion.importe_base_imponible';
	const GEN_ATTR_IMPORTE_RETENCION = 'vta_ajuste_debe_item_retencion.importe_retencion';
	const GEN_ATTR_CODIGO = 'vta_ajuste_debe_item_retencion.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_debe_item_retencion.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_debe_item_retencion.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_debe_item_retencion.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_debe_item_retencion.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_debe_item_retencion.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_debe_item_retencion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_debe_item_retencion.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteDebeItemRetencion */ 
	...
	/* Atributos de BVtaAjusteDebeItemRetencion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteDebeItemRetencion */ 
	...
	/* Setters de BVtaAjusteDebeItemRetencion */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaAjusteDebeItemRetencion();
            $o->setId($fila[VtaAjusteDebeItemRetencion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteDebeItemRetencion */ 	
	...
	/* Cambia el estado de BVtaAjusteDebeItemRetencion */ 	
	...
	/* Save de BVtaAjusteDebeItemRetencion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_debe_item_retencion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_debe_item_retencion_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteDebeItemRetencion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteDebeItemRetencion */ 	
	...
	public function duplicarVtaAjusteDebeItemRetencion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteDebeItemRetencions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteDebeItemRetencion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustedebeitemretencion = new VtaAjusteDebeItemRetencion();
                    $vtaajustedebeitemretencion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustedebeitemretencion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustedebeitemretencion->setVtaAjusteDebeId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ID]);
			$vtaajustedebeitemretencion->setVtaAjusteDebeItemId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ITEM_ID]);
			$vtaajustedebeitemretencion->setNumeroComprobante($fila[self::GEN_ATTR_MIN_NUMERO_COMPROBANTE]);
			$vtaajustedebeitemretencion->setFechaEmision($fila[self::GEN_ATTR_MIN_FECHA_EMISION]);
			$vtaajustedebeitemretencion->setImporteBaseImponible($fila[self::GEN_ATTR_MIN_IMPORTE_BASE_IMPONIBLE]);
			$vtaajustedebeitemretencion->setImporteRetencion($fila[self::GEN_ATTR_MIN_IMPORTE_RETENCION]);
			$vtaajustedebeitemretencion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustedebeitemretencion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustedebeitemretencion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustedebeitemretencion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustedebeitemretencion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustedebeitemretencion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustedebeitemretencion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustedebeitemretencion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteDebeItemRetencionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteDebeItemRetencions para listado de Backend */ 	
	static function getVtaAjusteDebeItemRetencionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteDebeItemRetencionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeItemRetencions filtrado para select */ 	
	static function getVtaAjusteDebeItemRetencionsCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeItemRetencions filtrado por una coleccion de objetos foraneos de VtaAjusteDebe */ 	
	static function getVtaAjusteDebeItemRetencionsXVtaAjusteDebes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeItemRetencion::GEN_ATTR_VTA_AJUSTE_DEBE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeItemRetencion::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeItemRetencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaAjusteDebeItemRetencions filtrado por una coleccion de objetos foraneos de VtaAjusteDebeItem */ 	
	static function getVtaAjusteDebeItemRetencionsXVtaAjusteDebeItems($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeItemRetencion::GEN_ATTR_VTA_AJUSTE_DEBE_ITEM_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeItemRetencion::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeItemRetencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_debe_item_retencion_adm.php';
            $url_gestion = 'vta_ajuste_debe_item_retencion_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_debe_item_retencion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_debe_item_retencion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteDebeItemRetencions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteDebeItemRetencions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_debe_item_retencion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteDebeItemRetencion::GEN_TABLA);
                $c->addOrden(VtaAjusteDebeItemRetencion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_debe_item_retencions = VtaAjusteDebeItemRetencion::getVtaAjusteDebeItemRetencions(null, $c);

                $arr = array();
                foreach($vta_ajuste_debe_item_retencions as $vta_ajuste_debe_item_retencion){
                    $descripcion = $vta_ajuste_debe_item_retencion->getDescripcion();

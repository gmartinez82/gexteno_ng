...
class BWsFeOpeSolicitudIva
{ 
	
	const SES_PAGINACION = 'adm_wsfeopesolicitudiva_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_wsfeopesolicitudiva_paginas_registros';
	const SES_CRITERIOS = 'adm_wsfeopesolicitudiva_criterios';
	
	const GEN_CLASE = 'WsFeOpeSolicitudIva';
	const GEN_TABLA = 'ws_fe_ope_solicitud_iva';
	...
	/* Constantes de Atributos de BWsFeOpeSolicitudIva */ 
	const GEN_ATTR_ID = 'ws_fe_ope_solicitud_iva.id';
	const GEN_ATTR_DESCRIPCION = 'ws_fe_ope_solicitud_iva.descripcion';
	const GEN_ATTR_WS_FE_OPE_SOLICITUD_ID = 'ws_fe_ope_solicitud_iva.ws_fe_ope_solicitud_id';
	const GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID = 'ws_fe_ope_solicitud_iva.ws_fe_param_tipo_iva_id';
	const GEN_ATTR_WS_FE_AFIP_CODIGO = 'ws_fe_ope_solicitud_iva.ws_fe_afip_codigo';
	const GEN_ATTR_WS_FE_AFIP_BASE_IMPONIBLE = 'ws_fe_ope_solicitud_iva.ws_fe_afip_base_imponible';
	const GEN_ATTR_WS_FE_AFIP_IMPORTE = 'ws_fe_ope_solicitud_iva.ws_fe_afip_importe';
	const GEN_ATTR_CODIGO = 'ws_fe_ope_solicitud_iva.codigo';
	const GEN_ATTR_OBSERVACION = 'ws_fe_ope_solicitud_iva.observacion';
	const GEN_ATTR_CREADO = 'ws_fe_ope_solicitud_iva.creado';
	const GEN_ATTR_CREADO_POR = 'ws_fe_ope_solicitud_iva.creado_por';
	const GEN_ATTR_MODIFICADO = 'ws_fe_ope_solicitud_iva.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ws_fe_ope_solicitud_iva.modificado_por';

	/* Constantes de Atributos Min de BWsFeOpeSolicitudIva */ 
	...
	/* Atributos de BWsFeOpeSolicitudIva */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BWsFeOpeSolicitudIva */ 
	...
	/* Setters de BWsFeOpeSolicitudIva */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new WsFeOpeSolicitudIva();
            $o->setId($fila[WsFeOpeSolicitudIva::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BWsFeOpeSolicitudIva */ 	
	...
	/* Cambia el estado de BWsFeOpeSolicitudIva */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('ws_fe_ope_solicitud_iva_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('ws_fe_ope_solicitud_iva_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BWsFeOpeSolicitudIva */ 	
	...
	public function duplicarWsFeOpeSolicitudIva(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getWsFeOpeSolicitudIvas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = WsFeOpeSolicitudIva::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $wsfeopesolicitudiva = new WsFeOpeSolicitudIva();
                    $wsfeopesolicitudiva->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $wsfeopesolicitudiva->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$wsfeopesolicitudiva->setWsFeOpeSolicitudId($fila[self::GEN_ATTR_MIN_WS_FE_OPE_SOLICITUD_ID]);
			$wsfeopesolicitudiva->setWsFeParamTipoIvaId($fila[self::GEN_ATTR_MIN_WS_FE_PARAM_TIPO_IVA_ID]);
			$wsfeopesolicitudiva->setWsFeAfipCodigo($fila[self::GEN_ATTR_MIN_WS_FE_AFIP_CODIGO]);
			$wsfeopesolicitudiva->setWsFeAfipBaseImponible($fila[self::GEN_ATTR_MIN_WS_FE_AFIP_BASE_IMPONIBLE]);
			$wsfeopesolicitudiva->setWsFeAfipImporte($fila[self::GEN_ATTR_MIN_WS_FE_AFIP_IMPORTE]);
			$wsfeopesolicitudiva->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$wsfeopesolicitudiva->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$wsfeopesolicitudiva->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$wsfeopesolicitudiva->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$wsfeopesolicitudiva->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$wsfeopesolicitudiva->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getWsFeOpeSolicitudIvasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getWsFeOpeSolicitudIvas para listado de Backend */ 	
	static function getWsFeOpeSolicitudIvasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getWsFeOpeSolicitudIvasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas($paginador, $criterio);
	...
	/* Método getWsFeOpeSolicitudIvas filtrado para select */ 	
	static function getWsFeOpeSolicitudIvasCmbF($paginador = null, $criterio = null){
            $col = WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas($paginador, $criterio);
	...
	/* Método getWsFeOpeSolicitudIvas filtrado por una coleccion de objetos foraneos de WsFeOpeSolicitud */ 	
	static function getWsFeOpeSolicitudIvasXWsFeOpeSolicituds($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(WsFeOpeSolicitudIva::GEN_ATTR_WS_FE_OPE_SOLICITUD_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(WsFeOpeSolicitudIva::GEN_TABLA);
            $c->addOrden(WsFeOpeSolicitudIva::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas($p, $c);
            foreach($os as $o){
	...
	/* Método getWsFeOpeSolicitudIvas filtrado por una coleccion de objetos foraneos de WsFeParamTipoIva */ 	
	static function getWsFeOpeSolicitudIvasXWsFeParamTipoIvas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(WsFeOpeSolicitudIva::GEN_ATTR_WS_FE_PARAM_TIPO_IVA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(WsFeOpeSolicitudIva::GEN_TABLA);
            $c->addOrden(WsFeOpeSolicitudIva::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ws_fe_ope_solicitud_iva_adm.php';
            $url_gestion = 'ws_fe_ope_solicitud_iva_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ws_fe_ope_solicitud_iva'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ws_fe_ope_solicitud_iva';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getWsFeOpeSolicitudIvas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getWsFeOpeSolicitudIvas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ws_fe_ope_solicitud_iva_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(WsFeOpeSolicitudIva::GEN_TABLA);
                $c->addOrden(WsFeOpeSolicitudIva::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $ws_fe_ope_solicitud_ivas = WsFeOpeSolicitudIva::getWsFeOpeSolicitudIvas(null, $c);

                $arr = array();
                foreach($ws_fe_ope_solicitud_ivas as $ws_fe_ope_solicitud_iva){
                    $descripcion = $ws_fe_ope_solicitud_iva->getDescripcion();

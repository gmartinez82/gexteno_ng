...
class BFndCajaEstado
{ 
	
	const SES_PAGINACION = 'adm_fndcajaestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_fndcajaestado_paginas_registros';
	const SES_CRITERIOS = 'adm_fndcajaestado_criterios';
	
	const GEN_CLASE = 'FndCajaEstado';
	const GEN_TABLA = 'fnd_caja_estado';
	...
	/* Constantes de Atributos de BFndCajaEstado */ 
	const GEN_ATTR_ID = 'fnd_caja_estado.id';
	const GEN_ATTR_DESCRIPCION = 'fnd_caja_estado.descripcion';
	const GEN_ATTR_FND_CAJA_ID = 'fnd_caja_estado.fnd_caja_id';
	const GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID = 'fnd_caja_estado.fnd_caja_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'fnd_caja_estado.inicial';
	const GEN_ATTR_ACTUAL = 'fnd_caja_estado.actual';
	const GEN_ATTR_CODIGO = 'fnd_caja_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'fnd_caja_estado.observacion';
	const GEN_ATTR_ORDEN = 'fnd_caja_estado.orden';
	const GEN_ATTR_ESTADO = 'fnd_caja_estado.estado';
	const GEN_ATTR_CREADO = 'fnd_caja_estado.creado';
	const GEN_ATTR_CREADO_POR = 'fnd_caja_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'fnd_caja_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'fnd_caja_estado.modificado_por';

	/* Constantes de Atributos Min de BFndCajaEstado */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new FndCajaEstado();
            $o->setId($fila[FndCajaEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BFndCajaEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('fnd_caja_estado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarFndCajaEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getFndCajaEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = FndCajaEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $fndcajaestado = new FndCajaEstado();
                    $fndcajaestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $fndcajaestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$fndcajaestado->setFndCajaId($fila[self::GEN_ATTR_MIN_FND_CAJA_ID]);
			$fndcajaestado->setFndCajaTipoEstadoId($fila[self::GEN_ATTR_MIN_FND_CAJA_TIPO_ESTADO_ID]);
			$fndcajaestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$fndcajaestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$fndcajaestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$fndcajaestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$fndcajaestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$fndcajaestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$fndcajaestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$fndcajaestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$fndcajaestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$fndcajaestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getFndCajaEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return FndCajaEstado::getFndCajaEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getFndCajaEstados para listado de Backend */ 	
	static function getFndCajaEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return FndCajaEstado::getFndCajaEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getFndCajaEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = FndCajaEstado::getFndCajaEstados($paginador, $criterio);
	...
	/* Método getFndCajaEstados filtrado para select */ 	
	static function getFndCajaEstadosCmbF($paginador = null, $criterio = null){
            $col = FndCajaEstado::getFndCajaEstados($paginador, $criterio);
	...
	/* Método getFndCajaEstados filtrado por una coleccion de objetos foraneos de FndCaja */ 	
	static function getFndCajaEstadosXFndCajas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(FndCajaEstado::GEN_ATTR_FND_CAJA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(FndCajaEstado::GEN_TABLA);
            $c->addOrden(FndCajaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = FndCajaEstado::getFndCajaEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getFndCajaEstados filtrado por una coleccion de objetos foraneos de FndCajaTipoEstado */ 	
	static function getFndCajaEstadosXFndCajaTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(FndCajaEstado::GEN_ATTR_FND_CAJA_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(FndCajaEstado::GEN_TABLA);
            $c->addOrden(FndCajaEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'fnd_caja_estado_adm.php';
            $url_gestion = 'fnd_caja_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM fnd_caja_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'fnd_caja_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getFndCajaEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getFndCajaEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'fnd_caja_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(FndCajaEstado::GEN_TABLA);
                $c->addOrden(FndCajaEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($fnd_caja_estados as $fnd_caja_estado){
                    $descripcion = $fnd_caja_estado->getDescripcion();

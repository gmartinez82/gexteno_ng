...
{ 
	...
	const SES_PAGINACION = 'adm_osestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_osestado_paginas_registros';
	const SES_CRITERIOS = 'adm_osestado_criterios';
	
	const GEN_CLASE = 'OsEstado';
	const GEN_TABLA = 'os_estado';
	...
	/* Constantes de Atributos de BOsEstado */ 
	const GEN_ATTR_ID = 'os_estado.id';
	const GEN_ATTR_OS_ORDEN_SERVICIO_ID = 'os_estado.os_orden_servicio_id';
	const GEN_ATTR_OS_TIPO_ESTADO_ID = 'os_estado.os_tipo_estado_id';
	const GEN_ATTR_ACTUAL = 'os_estado.actual';
	const GEN_ATTR_FECHA = 'os_estado.fecha';
	const GEN_ATTR_DESCRIPCION = 'os_estado.descripcion';
	const GEN_ATTR_CODIGO = 'os_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'os_estado.observacion';
	const GEN_ATTR_ORDEN = 'os_estado.orden';
	const GEN_ATTR_ESTADO = 'os_estado.estado';
	const GEN_ATTR_CREADO = 'os_estado.creado';
	const GEN_ATTR_CREADO_POR = 'os_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'os_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'os_estado.modificado_por';

	/* Constantes de Atributos Min de BOsEstado */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new OsEstado();
            $o->setId($fila[OsEstado::GEN_ATTR_MIN_ID], false);
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                ".$this->getOsOrdenServicioId()."
                    ...
                    ) RETURNING currval('os_estado_seq')";
...
".self::GEN_ATTR_MIN_OS_ORDEN_SERVICIO_ID." = ".$this->getOsOrdenServicioId()."
	...
	public function duplicarOsEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getOsEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = OsEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$osestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $osestado = new OsEstado();
                    $osestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $osestado->setOsOrdenServicioId($fila[self::GEN_ATTR_MIN_OS_ORDEN_SERVICIO_ID]);
			$osestado->setOsTipoEstadoId($fila[self::GEN_ATTR_MIN_OS_TIPO_ESTADO_ID]);
			$osestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$osestado->setFecha($fila[self::GEN_ATTR_MIN_FECHA]);
			$osestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$osestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$osestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$osestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$osestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$osestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$osestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$osestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$osestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getOsEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return OsEstado::getOsEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getOsEstados para listado de Backend */ 	
	static function getOsEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return OsEstado::getOsEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getOsEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = OsEstado::getOsEstados($paginador, $criterio);
	...
	/* Método getOsEstados filtrado para select */ 	
	static function getOsEstadosCmbF($paginador = null, $criterio = null){
            $col = OsEstado::getOsEstados($paginador, $criterio);
	...
	/* Método getOsEstados filtrado por una coleccion de objetos foraneos de OsOrdenServicio */ 	
	static function getOsEstadosXOsOrdenServicios($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(OsEstado::GEN_ATTR_OS_ORDEN_SERVICIO_ID, $arr_ids, Criterio::IN_ARRAY);
	...
	/* Método getOsEstados filtrado por una coleccion de objetos foraneos de OsTipoEstado */ 	
	static function getOsEstadosXOsTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(OsEstado::GEN_ATTR_OS_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(OsEstado::GEN_TABLA);
            $c->addOrden(OsEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'os_estado_adm.php';
            $url_gestion = 'os_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM os_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'os_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getOsEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getOsEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'os_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(OsEstado::GEN_TABLA);
                $c->addOrden(OsEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($os_estados as $os_estado){
                    $descripcion = $os_estado->getDescripcion();

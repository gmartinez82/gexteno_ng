...
class BVtaPuntoVentaActual
{ 
	
	const SES_PAGINACION = 'adm_vtapuntoventaactual_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtapuntoventaactual_paginas_registros';
	const SES_CRITERIOS = 'adm_vtapuntoventaactual_criterios';
	
	const GEN_CLASE = 'VtaPuntoVentaActual';
	const GEN_TABLA = 'vta_punto_venta_actual';
	...
	/* Constantes de Atributos de BVtaPuntoVentaActual */ 
	const GEN_ATTR_ID = 'vta_punto_venta_actual.id';
	const GEN_ATTR_DESCRIPCION = 'vta_punto_venta_actual.descripcion';
	const GEN_ATTR_VTA_PUNTO_VENTA_ID = 'vta_punto_venta_actual.vta_punto_venta_id';
	const GEN_ATTR_VTA_TIPO_PUNTO_VENTA_ID = 'vta_punto_venta_actual.vta_tipo_punto_venta_id';
	const GEN_ATTR_SERIE = 'vta_punto_venta_actual.serie';
	const GEN_ATTR_NUMERO_ACTUAL = 'vta_punto_venta_actual.numero_actual';
	const GEN_ATTR_OBSERVACION = 'vta_punto_venta_actual.observacion';
	const GEN_ATTR_ORDEN = 'vta_punto_venta_actual.orden';
	const GEN_ATTR_ESTADO = 'vta_punto_venta_actual.estado';
	const GEN_ATTR_CREADO = 'vta_punto_venta_actual.creado';
	const GEN_ATTR_CREADO_POR = 'vta_punto_venta_actual.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_punto_venta_actual.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_punto_venta_actual.modificado_por';

	/* Constantes de Atributos Min de BVtaPuntoVentaActual */ 
	...
	/* Atributos de BVtaPuntoVentaActual */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaPuntoVentaActual */ 
	...
	/* Setters de BVtaPuntoVentaActual */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaPuntoVentaActual();
            $o->setId($fila[VtaPuntoVentaActual::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaPuntoVentaActual */ 	
	...
	/* Cambia el estado de BVtaPuntoVentaActual */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_punto_venta_actual_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_punto_venta_actual_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaPuntoVentaActual */ 	
	...
	public function duplicarVtaPuntoVentaActual(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaPuntoVentaActuals($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaPuntoVentaActual::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtapuntoventaactual = new VtaPuntoVentaActual();
                    $vtapuntoventaactual->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtapuntoventaactual->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtapuntoventaactual->setVtaPuntoVentaId($fila[self::GEN_ATTR_MIN_VTA_PUNTO_VENTA_ID]);
			$vtapuntoventaactual->setVtaTipoPuntoVentaId($fila[self::GEN_ATTR_MIN_VTA_TIPO_PUNTO_VENTA_ID]);
			$vtapuntoventaactual->setSerie($fila[self::GEN_ATTR_MIN_SERIE]);
			$vtapuntoventaactual->setNumeroActual($fila[self::GEN_ATTR_MIN_NUMERO_ACTUAL]);
			$vtapuntoventaactual->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtapuntoventaactual->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtapuntoventaactual->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtapuntoventaactual->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtapuntoventaactual->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtapuntoventaactual->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtapuntoventaactual->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaPuntoVentaActualsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaPuntoVentaActual::getVtaPuntoVentaActuals($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaPuntoVentaActuals para listado de Backend */ 	
	static function getVtaPuntoVentaActualsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaPuntoVentaActual::getVtaPuntoVentaActuals($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaPuntoVentaActualsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaPuntoVentaActual::getVtaPuntoVentaActuals($paginador, $criterio);
	...
	/* Método getVtaPuntoVentaActuals filtrado para select */ 	
	static function getVtaPuntoVentaActualsCmbF($paginador = null, $criterio = null){
            $col = VtaPuntoVentaActual::getVtaPuntoVentaActuals($paginador, $criterio);
	...
	/* Método getVtaPuntoVentaActuals filtrado por una coleccion de objetos foraneos de VtaPuntoVenta */ 	
	static function getVtaPuntoVentaActualsXVtaPuntoVentas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaPuntoVentaActual::GEN_ATTR_VTA_PUNTO_VENTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaPuntoVentaActual::GEN_TABLA);
            $c->addOrden(VtaPuntoVentaActual::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaPuntoVentaActual::getVtaPuntoVentaActuals($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaPuntoVentaActuals filtrado por una coleccion de objetos foraneos de VtaTipoPuntoVenta */ 	
	static function getVtaPuntoVentaActualsXVtaTipoPuntoVentas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaPuntoVentaActual::GEN_ATTR_VTA_TIPO_PUNTO_VENTA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaPuntoVentaActual::GEN_TABLA);
            $c->addOrden(VtaPuntoVentaActual::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_punto_venta_actual_adm.php';
            $url_gestion = 'vta_punto_venta_actual_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_punto_venta_actual'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_punto_venta_actual';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaPuntoVentaActuals($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaPuntoVentaActuals(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_punto_venta_actual_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaPuntoVentaActual::GEN_TABLA);
                $c->addOrden(VtaPuntoVentaActual::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_punto_venta_actuals = VtaPuntoVentaActual::getVtaPuntoVentaActuals(null, $c);

                $arr = array();
                foreach($vta_punto_venta_actuals as $vta_punto_venta_actual){
                    $descripcion = $vta_punto_venta_actual->getDescripcion();

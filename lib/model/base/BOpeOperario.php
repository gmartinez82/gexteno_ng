...
{ 
	...
	const SES_PAGINACION = 'adm_opeoperario_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_opeoperario_paginas_registros';
	const SES_CRITERIOS = 'adm_opeoperario_criterios';
	
	const GEN_CLASE = 'OpeOperario';
	const GEN_TABLA = 'ope_operario';
	...
	/* Constantes de Atributos de BOpeOperario */ 
	const GEN_ATTR_ID = 'ope_operario.id';
	const GEN_ATTR_DESCRIPCION = 'ope_operario.descripcion';
	const GEN_ATTR_PER_PERSONA_ID = 'ope_operario.per_persona_id';
	const GEN_ATTR_CODIGO = 'ope_operario.codigo';
	const GEN_ATTR_OBSERVACION = 'ope_operario.observacion';
	const GEN_ATTR_ORDEN = 'ope_operario.orden';
	const GEN_ATTR_ESTADO = 'ope_operario.estado';
	const GEN_ATTR_CREADO = 'ope_operario.creado';
	const GEN_ATTR_CREADO_POR = 'ope_operario.creado_por';
	const GEN_ATTR_MODIFICADO = 'ope_operario.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ope_operario.modificado_por';

	/* Constantes de Atributos Min de BOpeOperario */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new OpeOperario();
            $o->setId($fila[OpeOperario::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BOpeOperario */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('ope_operario_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarOpeOperario(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getOpeOperarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = OpeOperario::setAplicarFiltrosDeAlcance($criterio);
		...
		$opeoperarios = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $opeoperario = new OpeOperario();
                    $opeoperario->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $opeoperario->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$opeoperario->setPerPersonaId($fila[self::GEN_ATTR_MIN_PER_PERSONA_ID]);
			$opeoperario->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$opeoperario->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$opeoperario->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$opeoperario->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$opeoperario->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$opeoperario->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$opeoperario->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$opeoperario->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getOpeOperariosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return OpeOperario::getOpeOperarios($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getOpeOperarios para listado de Backend */ 	
	static function getOpeOperariosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return OpeOperario::getOpeOperarios($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getOpeOperariosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = OpeOperario::getOpeOperarios($paginador, $criterio);
	...
	/* Método getOpeOperarios filtrado para select */ 	
	static function getOpeOperariosCmbF($paginador = null, $criterio = null){
            $col = OpeOperario::getOpeOperarios($paginador, $criterio);
	...
	/* Método getOpeOperarios filtrado por una coleccion de objetos foraneos de PerPersona */ 	
	static function getOpeOperariosXPerPersonas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(OpeOperario::GEN_ATTR_PER_PERSONA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(OpeOperario::GEN_TABLA);
            $c->addOrden(OpeOperario::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = OpeOperario::getOpeOperarios($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ope_operario_adm.php';
            $url_gestion = 'ope_operario_gestion.php';
	...
	public function getPrdOrdenTrabajoOperacionOpeOperarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrdOrdenTrabajoOperacionOpeOperario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrdOrdenTrabajoOperacionOpeOperariosCmb(){
            $c = new Criterio();
            $c->add(PrdOrdenTrabajoOperacionOpeOperario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdOrdenTrabajoOperacionOpeOperario::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PrdOrdenTrabajoOperacions (Coleccion) relacionados a traves de PrdOrdenTrabajoOperacionOpeOperario */ 	
	public function getPrdOrdenTrabajoOperacionsXPrdOrdenTrabajoOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PrdOrdenTrabajoOperacionOpeOperario::GEN_TABLA, PrdOrdenTrabajoOperacionOpeOperario::GEN_ATTR_PRD_ORDEN_TRABAJO_OPERACION_ID, PrdOrdenTrabajoOperacion::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PrdOrdenTrabajoOperacions relacionados a traves de PrdOrdenTrabajoOperacionOpeOperario */ 	
	public function getCantidadPrdOrdenTrabajoOperacionsXPrdOrdenTrabajoOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PrdOrdenTrabajoOperacion (Objeto) relacionado a traves de PrdOrdenTrabajoOperacionOpeOperario */ 	
	public function getPrdOrdenTrabajoOperacionXPrdOrdenTrabajoOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPrdOrdenTrabajoOperacionsXPrdOrdenTrabajoOperacionOpeOperario($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPrdParamOperacionOpeOperarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrdParamOperacionOpeOperario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrdParamOperacionOpeOperariosCmb(){
            $c = new Criterio();
            $c->add(PrdParamOperacionOpeOperario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdParamOperacionOpeOperario::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PrdParamOperacions (Coleccion) relacionados a traves de PrdParamOperacionOpeOperario */ 	
	public function getPrdParamOperacionsXPrdParamOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PrdParamOperacionOpeOperario::GEN_TABLA, PrdParamOperacionOpeOperario::GEN_ATTR_PRD_PARAM_OPERACION_ID, PrdParamOperacion::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PrdParamOperacions relacionados a traves de PrdParamOperacionOpeOperario */ 	
	public function getCantidadPrdParamOperacionsXPrdParamOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PrdParamOperacion (Objeto) relacionado a traves de PrdParamOperacionOpeOperario */ 	
	public function getPrdParamOperacionXPrdParamOperacionOpeOperario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPrdParamOperacionsXPrdParamOperacionOpeOperario($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getOpeOperarioUsUsuarios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(OpeOperarioUsUsuario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getOpeOperarioUsUsuariosCmb(){
            $c = new Criterio();
            $c->add(OpeOperarioUsUsuario::GEN_ATTR_OPE_OPERARIO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(OpeOperarioUsUsuario::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener UsUsuarios (Coleccion) relacionados a traves de OpeOperarioUsUsuario */ 	
	public function getUsUsuariosXOpeOperarioUsUsuario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(OpeOperarioUsUsuario::GEN_TABLA, OpeOperarioUsUsuario::GEN_ATTR_US_USUARIO_ID, UsUsuario::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de UsUsuarios relacionados a traves de OpeOperarioUsUsuario */ 	
	public function getCantidadUsUsuariosXOpeOperarioUsUsuario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener UsUsuario (Objeto) relacionado a traves de OpeOperarioUsUsuario */ 	
	public function getUsUsuarioXOpeOperarioUsUsuario($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getUsUsuariosXOpeOperarioUsUsuario($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna una coleccion de IDs de los PrdParamOperacions asignados a OpeOperario */ 	
	...
	/* Método setea nuevos PrdParamOperacions asignados al OpeOperario */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion PrdParamOperacion en el alta de OpeOperario */ 	
	public function getAltaMostrarBloqueRelacionPrdParamOperacionOpeOperario(){
            return true;
	}
	

	/* Metodo que retorna una coleccion de IDs de los UsUsuarios asignados a OpeOperario */ 	
	...
	/* Método setea nuevos UsUsuarios asignados al OpeOperario */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion UsUsuario en el alta de OpeOperario */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ope_operario'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ope_operario';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getOpeOperarios($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getOpeOperarios(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ope_operario_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(OpeOperario::GEN_TABLA);
                $c->addOrden(OpeOperario::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $ope_operarios = OpeOperario::getOpeOperarios(null, $c);

                $arr = array();
                foreach($ope_operarios as $ope_operario){
                    $descripcion = $ope_operario->getDescripcion();

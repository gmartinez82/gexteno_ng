...
class BPrdLineaProduccion
{ 
	
	const SES_PAGINACION = 'adm_prdlineaproduccion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_prdlineaproduccion_paginas_registros';
	const SES_CRITERIOS = 'adm_prdlineaproduccion_criterios';
	
	const GEN_CLASE = 'PrdLineaProduccion';
	const GEN_TABLA = 'prd_linea_produccion';
	...
	/* Constantes de Atributos de BPrdLineaProduccion */ 
	const GEN_ATTR_ID = 'prd_linea_produccion.id';
	const GEN_ATTR_DESCRIPCION = 'prd_linea_produccion.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'prd_linea_produccion.descripcion_corta';
	const GEN_ATTR_PRD_PROCESO_PRODUCTIVO_ID = 'prd_linea_produccion.prd_proceso_productivo_id';
	const GEN_ATTR_NUMERO = 'prd_linea_produccion.numero';
	const GEN_ATTR_CODIGO = 'prd_linea_produccion.codigo';
	const GEN_ATTR_OBSERVACION = 'prd_linea_produccion.observacion';
	const GEN_ATTR_ORDEN = 'prd_linea_produccion.orden';
	const GEN_ATTR_ESTADO = 'prd_linea_produccion.estado';
	const GEN_ATTR_CREADO = 'prd_linea_produccion.creado';
	const GEN_ATTR_CREADO_POR = 'prd_linea_produccion.creado_por';
	const GEN_ATTR_MODIFICADO = 'prd_linea_produccion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'prd_linea_produccion.modificado_por';

	/* Constantes de Atributos Min de BPrdLineaProduccion */ 
	...
	/* Atributos de BPrdLineaProduccion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPrdLineaProduccion */ 
	...
	/* Setters de BPrdLineaProduccion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PrdLineaProduccion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPrdLineaProduccion */ 	
	...
	/* Cambia el estado de BPrdLineaProduccion */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('prd_linea_produccion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('prd_linea_produccion_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPrdLineaProduccion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPrdLineaProduccions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PrdLineaProduccion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $prdlineaproduccion = new PrdLineaProduccion();
                    $prdlineaproduccion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $prdlineaproduccion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$prdlineaproduccion->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$prdlineaproduccion->setPrdProcesoProductivoId($fila[self::GEN_ATTR_MIN_PRD_PROCESO_PRODUCTIVO_ID]);
			$prdlineaproduccion->setNumero($fila[self::GEN_ATTR_MIN_NUMERO]);
			$prdlineaproduccion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$prdlineaproduccion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$prdlineaproduccion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$prdlineaproduccion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$prdlineaproduccion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$prdlineaproduccion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$prdlineaproduccion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$prdlineaproduccion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPrdLineaProduccionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PrdLineaProduccion::getPrdLineaProduccions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPrdLineaProduccions para listado de Backend */ 	
	static function getPrdLineaProduccionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PrdLineaProduccion::getPrdLineaProduccions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPrdLineaProduccionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PrdLineaProduccion::getPrdLineaProduccions($paginador, $criterio);
	...
	/* Método getPrdLineaProduccions filtrado para select */ 	
	static function getPrdLineaProduccionsCmbF($paginador = null, $criterio = null){
            $col = PrdLineaProduccion::getPrdLineaProduccions($paginador, $criterio);
	...
	/* Método getPrdLineaProduccions filtrado por una coleccion de objetos foraneos de PrdProcesoProductivo */ 	
	static function getPrdLineaProduccionsXPrdProcesoProductivos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrdLineaProduccion::GEN_ATTR_PRD_PROCESO_PRODUCTIVO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrdLineaProduccion::GEN_TABLA);
            $c->addOrden(PrdLineaProduccion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PrdLineaProduccion::getPrdLineaProduccions($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'prd_linea_produccion_adm.php';
            $url_gestion = 'prd_linea_produccion_gestion.php';
	...
	public function getPrdOrdenTrabajoCiclos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrdOrdenTrabajoCiclo::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrdOrdenTrabajoCiclosCmb(){
            $c = new Criterio();
            $c->add(PrdOrdenTrabajoCiclo::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdOrdenTrabajoCiclo::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PrdOrdenTrabajos (Coleccion) relacionados a traves de PrdOrdenTrabajoCiclo */ 	
	public function getPrdOrdenTrabajosXPrdOrdenTrabajoCiclo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PrdOrdenTrabajoCiclo::GEN_TABLA, PrdOrdenTrabajoCiclo::GEN_ATTR_PRD_ORDEN_TRABAJO_ID, PrdOrdenTrabajo::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PrdOrdenTrabajos relacionados a traves de PrdOrdenTrabajoCiclo */ 	
	public function getCantidadPrdOrdenTrabajosXPrdOrdenTrabajoCiclo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PrdOrdenTrabajo (Objeto) relacionado a traves de PrdOrdenTrabajoCiclo */ 	
	public function getPrdOrdenTrabajoXPrdOrdenTrabajoCiclo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPrdOrdenTrabajosXPrdOrdenTrabajoCiclo($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPrdParamOperacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrdParamOperacion::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrdParamOperacionsCmb(){
            $c = new Criterio();
            $c->add(PrdParamOperacion::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdParamOperacion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPrdLineaProduccionPrdParamOperacionPrdEquipos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrdLineaProduccionPrdParamOperacionPrdEquiposCmb(){
            $c = new Criterio();
            $c->add(PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PrdParamOperacions (Coleccion) relacionados a traves de PrdLineaProduccionPrdParamOperacionPrdEquipo */ 	
	public function getPrdParamOperacionsXPrdLineaProduccionPrdParamOperacionPrdEquipo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(PrdParamOperacion::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_ATTR_PRD_LINEA_PRODUCCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrdParamOperacion::GEN_TABLA);
            $c->addRealJoin(PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_TABLA, PrdLineaProduccionPrdParamOperacionPrdEquipo::GEN_ATTR_PRD_PARAM_OPERACION_ID, PrdParamOperacion::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PrdParamOperacions relacionados a traves de PrdLineaProduccionPrdParamOperacionPrdEquipo */ 	
	public function getCantidadPrdParamOperacionsXPrdLineaProduccionPrdParamOperacionPrdEquipo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PrdParamOperacion (Objeto) relacionado a traves de PrdLineaProduccionPrdParamOperacionPrdEquipo */ 	
	public function getPrdParamOperacionXPrdLineaProduccionPrdParamOperacionPrdEquipo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPrdParamOperacionsXPrdLineaProduccionPrdParamOperacionPrdEquipo($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM prd_linea_produccion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'prd_linea_produccion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPrdLineaProduccions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPrdLineaProduccions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'prd_linea_produccion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PrdLineaProduccion::GEN_TABLA);
                $c->addOrden(PrdLineaProduccion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $prd_linea_produccions = PrdLineaProduccion::getPrdLineaProduccions(null, $c);

                $arr = array();
                foreach($prd_linea_produccions as $prd_linea_produccion){
                    $descripcion = $prd_linea_produccion->getDescripcion();

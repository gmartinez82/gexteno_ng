...
class BVtaNotaDebitoTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_vtanotadebitotipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtanotadebitotipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtanotadebitotipoestado_criterios';
	
	const GEN_CLASE = 'VtaNotaDebitoTipoEstado';
	const GEN_TABLA = 'vta_nota_debito_tipo_estado';
	...
	/* Constantes de Atributos de BVtaNotaDebitoTipoEstado */ 
	const GEN_ATTR_ID = 'vta_nota_debito_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_nota_debito_tipo_estado.descripcion';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'vta_nota_debito_tipo_estado.descripcion_publica';
	const GEN_ATTR_CODIGO = 'vta_nota_debito_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'vta_nota_debito_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'vta_nota_debito_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'vta_nota_debito_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'vta_nota_debito_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'vta_nota_debito_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'vta_nota_debito_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'vta_nota_debito_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'vta_nota_debito_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'vta_nota_debito_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'vta_nota_debito_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'vta_nota_debito_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_nota_debito_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_nota_debito_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_nota_debito_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BVtaNotaDebitoTipoEstado */ 
	...
	/* Atributos de BVtaNotaDebitoTipoEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaNotaDebitoTipoEstado */ 
	...
	/* Setters de BVtaNotaDebitoTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaNotaDebitoTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaNotaDebitoTipoEstado */ 	
	...
	/* Cambia el estado de BVtaNotaDebitoTipoEstado */ 	
	...
	/* Save de BVtaNotaDebitoTipoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_nota_debito_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_nota_debito_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".VtaNotaDebitoTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaNotaDebitoTipoEstado */ 	
	...
	public function duplicarVtaNotaDebitoTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaNotaDebitoTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaNotaDebitoTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtanotadebitotipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtanotadebitotipoestado = new VtaNotaDebitoTipoEstado();
                    $vtanotadebitotipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtanotadebitotipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtanotadebitotipoestado->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$vtanotadebitotipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtanotadebitotipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$vtanotadebitotipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$vtanotadebitotipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$vtanotadebitotipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$vtanotadebitotipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$vtanotadebitotipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$vtanotadebitotipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$vtanotadebitotipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtanotadebitotipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtanotadebitotipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtanotadebitotipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtanotadebitotipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtanotadebitotipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtanotadebitotipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtanotadebitotipoestados[] = $vtanotadebitotipoestado;
		}
		
		return $vtanotadebitotipoestados;
	}	
	

	/* Método getVtaNotaDebitoTipoEstados Habilitados */ 	
	static function getVtaNotaDebitoTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaNotaDebitoTipoEstados para listado de Backend */ 	
	static function getVtaNotaDebitoTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaNotaDebitoTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstados($paginador, $criterio);
	...
	/* Método getVtaNotaDebitoTipoEstados filtrado para select */ 	
	static function getVtaNotaDebitoTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_nota_debito_tipo_estado_adm.php';
            $url_gestion = 'vta_nota_debito_tipo_estado_gestion.php';
	...
	public function getVtaNotaDebitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaNotaDebito::GEN_ATTR_VTA_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaNotaDebitosCmb(){
            $c = new Criterio();
            $c->add(VtaNotaDebito::GEN_ATTR_VTA_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaDebito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaNotaDebitoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaNotaDebitoEstado::GEN_ATTR_VTA_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaNotaDebitoEstadosCmb(){
            $c = new Criterio();
            $c->add(VtaNotaDebitoEstado::GEN_ATTR_VTA_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaDebitoEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaNotaDebitos (Coleccion) relacionados a traves de VtaNotaDebitoEstado */ 	
	public function getVtaNotaDebitosXVtaNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(VtaNotaDebito::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(VtaNotaDebitoEstado::GEN_ATTR_VTA_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaNotaDebito::GEN_TABLA);
            $c->addRealJoin(VtaNotaDebitoEstado::GEN_TABLA, VtaNotaDebitoEstado::GEN_ATTR_VTA_NOTA_DEBITO_ID, VtaNotaDebito::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaNotaDebitos relacionados a traves de VtaNotaDebitoEstado */ 	
	public function getCantidadVtaNotaDebitosXVtaNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaNotaDebito (Objeto) relacionado a traves de VtaNotaDebitoEstado */ 	
	public function getVtaNotaDebitoXVtaNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaNotaDebitosXVtaNotaDebitoEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_nota_debito_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_nota_debito_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaNotaDebitoTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaNotaDebitoTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_nota_debito_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaNotaDebitoTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_nota_debito_tipo_estados = VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstados(null, $c);

                $arr = array();
                foreach($vta_nota_debito_tipo_estados as $vta_nota_debito_tipo_estado){
                    $descripcion = $vta_nota_debito_tipo_estado->getDescripcion();

...
class BInsInsumoBulto
{ 
	
	const SES_PAGINACION = 'adm_insinsumobulto_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_insinsumobulto_paginas_registros';
	const SES_CRITERIOS = 'adm_insinsumobulto_criterios';
	
	const GEN_CLASE = 'InsInsumoBulto';
	const GEN_TABLA = 'ins_insumo_bulto';
	...
	/* Constantes de Atributos de BInsInsumoBulto */ 
	const GEN_ATTR_ID = 'ins_insumo_bulto.id';
	const GEN_ATTR_DESCRIPCION = 'ins_insumo_bulto.descripcion';
	const GEN_ATTR_INS_INSUMO_ID = 'ins_insumo_bulto.ins_insumo_id';
	const GEN_ATTR_CANTIDAD = 'ins_insumo_bulto.cantidad';
	const GEN_ATTR_INS_UNIDAD_MEDIDA_ID = 'ins_insumo_bulto.ins_unidad_medida_id';
	const GEN_ATTR_CODIGO = 'ins_insumo_bulto.codigo';
	const GEN_ATTR_OBSERVACION = 'ins_insumo_bulto.observacion';
	const GEN_ATTR_ORDEN = 'ins_insumo_bulto.orden';
	const GEN_ATTR_ESTADO = 'ins_insumo_bulto.estado';
	const GEN_ATTR_CREADO = 'ins_insumo_bulto.creado';
	const GEN_ATTR_CREADO_POR = 'ins_insumo_bulto.creado_por';
	const GEN_ATTR_MODIFICADO = 'ins_insumo_bulto.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ins_insumo_bulto.modificado_por';

	/* Constantes de Atributos Min de BInsInsumoBulto */ 
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[InsInsumoBulto::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BInsInsumoBulto */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('ins_insumo_bulto_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarInsInsumoBulto(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getInsInsumoBultos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = InsInsumoBulto::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $insinsumobulto = new InsInsumoBulto();
                    $insinsumobulto->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $insinsumobulto->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$insinsumobulto->setInsInsumoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_ID]);
			$insinsumobulto->setCantidad($fila[self::GEN_ATTR_MIN_CANTIDAD]);
			$insinsumobulto->setInsUnidadMedidaId($fila[self::GEN_ATTR_MIN_INS_UNIDAD_MEDIDA_ID]);
			$insinsumobulto->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$insinsumobulto->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$insinsumobulto->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$insinsumobulto->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$insinsumobulto->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$insinsumobulto->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$insinsumobulto->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$insinsumobulto->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getInsInsumoBultosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return InsInsumoBulto::getInsInsumoBultos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getInsInsumoBultos para listado de Backend */ 	
	static function getInsInsumoBultosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return InsInsumoBulto::getInsInsumoBultos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getInsInsumoBultosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = InsInsumoBulto::getInsInsumoBultos($paginador, $criterio);
	...
	/* Método getInsInsumoBultos filtrado para select */ 	
	static function getInsInsumoBultosCmbF($paginador = null, $criterio = null){
            $col = InsInsumoBulto::getInsInsumoBultos($paginador, $criterio);
	...
	/* Método getInsInsumoBultos filtrado por una coleccion de objetos foraneos de InsInsumo */ 	
	static function getInsInsumoBultosXInsInsumos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(InsInsumoBulto::GEN_ATTR_INS_INSUMO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(InsInsumoBulto::GEN_TABLA);
            $c->addOrden(InsInsumoBulto::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = InsInsumoBulto::getInsInsumoBultos($p, $c);
            foreach($os as $o){
	...
	/* Método getInsInsumoBultos filtrado por una coleccion de objetos foraneos de InsUnidadMedida */ 	
	static function getInsInsumoBultosXInsUnidadMedidas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(InsInsumoBulto::GEN_ATTR_INS_UNIDAD_MEDIDA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(InsInsumoBulto::GEN_TABLA);
            $c->addOrden(InsInsumoBulto::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ins_insumo_bulto_adm.php';
            $url_gestion = 'ins_insumo_bulto_gestion.php';
	...
	public function getInsInsumoBultoInsTipoListaPrecios($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(InsInsumoBultoInsTipoListaPrecio::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getInsInsumoBultoInsTipoListaPreciosCmb(){
            $c = new Criterio();
            $c->add(InsInsumoBultoInsTipoListaPrecio::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(InsInsumoBultoInsTipoListaPrecio::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener InsTipoListaPrecios (Coleccion) relacionados a traves de InsInsumoBultoInsTipoListaPrecio */ 	
	public function getInsTipoListaPreciosXInsInsumoBultoInsTipoListaPrecio($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(InsInsumoBultoInsTipoListaPrecio::GEN_TABLA, InsInsumoBultoInsTipoListaPrecio::GEN_ATTR_INS_TIPO_LISTA_PRECIO_ID, InsTipoListaPrecio::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de InsTipoListaPrecios relacionados a traves de InsInsumoBultoInsTipoListaPrecio */ 	
	public function getCantidadInsTipoListaPreciosXInsInsumoBultoInsTipoListaPrecio($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener InsTipoListaPrecio (Objeto) relacionado a traves de InsInsumoBultoInsTipoListaPrecio */ 	
	public function getInsTipoListaPrecioXInsInsumoBultoInsTipoListaPrecio($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getInsTipoListaPreciosXInsInsumoBultoInsTipoListaPrecio($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaPresupuestoInsInsumos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaPresupuestoInsInsumo::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaPresupuestoInsInsumosCmb(){
            $c = new Criterio();
            $c->add(VtaPresupuestoInsInsumo::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaPresupuestoInsInsumo::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaOrdenVentas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaOrdenVenta::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaOrdenVentasCmb(){
            $c = new Criterio();
            $c->add(VtaOrdenVenta::GEN_ATTR_INS_INSUMO_BULTO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaOrdenVenta::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los InsTipoListaPrecios asignados a InsInsumoBulto */ 	
	...
	/* Método setea nuevos InsTipoListaPrecios asignados al InsInsumoBulto */ 	
	public function setInsInsumoBultoInsTipoListaPrecios($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setInsInsumoBultoId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion InsTipoListaPrecio en el alta de InsInsumoBulto */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ins_insumo_bulto'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ins_insumo_bulto';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getInsInsumoBultos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getInsInsumoBultos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ins_insumo_bulto_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(InsInsumoBulto::GEN_TABLA);
                $c->addOrden(InsInsumoBulto::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($ins_insumo_bultos as $ins_insumo_bulto){
                    $descripcion = $ins_insumo_bulto->getDescripcion();

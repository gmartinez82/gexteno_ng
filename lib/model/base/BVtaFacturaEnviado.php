...
class BVtaFacturaEnviado
{ 
	
	const SES_PAGINACION = 'adm_vtafacturaenviado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtafacturaenviado_paginas_registros';
	const SES_CRITERIOS = 'adm_vtafacturaenviado_criterios';
	
	const GEN_CLASE = 'VtaFacturaEnviado';
	const GEN_TABLA = 'vta_factura_enviado';
	...
	/* Constantes de Atributos de BVtaFacturaEnviado */ 
	const GEN_ATTR_ID = 'vta_factura_enviado.id';
	const GEN_ATTR_DESCRIPCION = 'vta_factura_enviado.descripcion';
	const GEN_ATTR_VTA_FACTURA_ID = 'vta_factura_enviado.vta_factura_id';
	const GEN_ATTR_ASUNTO = 'vta_factura_enviado.asunto';
	const GEN_ATTR_DESTINATARIO = 'vta_factura_enviado.destinatario';
	const GEN_ATTR_CUERPO = 'vta_factura_enviado.cuerpo';
	const GEN_ATTR_ADJUNTO = 'vta_factura_enviado.adjunto';
	const GEN_ATTR_CODIGO_ENVIO = 'vta_factura_enviado.codigo_envio';
	const GEN_ATTR_CODIGO = 'vta_factura_enviado.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_factura_enviado.observacion';
	const GEN_ATTR_ORDEN = 'vta_factura_enviado.orden';
	const GEN_ATTR_ESTADO = 'vta_factura_enviado.estado';
	const GEN_ATTR_CREADO = 'vta_factura_enviado.creado';
	const GEN_ATTR_CREADO_POR = 'vta_factura_enviado.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_factura_enviado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_factura_enviado.modificado_por';

	/* Constantes de Atributos Min de BVtaFacturaEnviado */ 
	...
	/* Atributos de BVtaFacturaEnviado */ 
	private $id;
	private $descripcion;
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaFacturaEnviado();
            $o->setId($fila[VtaFacturaEnviado::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaFacturaEnviado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_factura_enviado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_factura_enviado_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaFacturaEnviado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaFacturaEnviados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaFacturaEnviado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtafacturaenviado = new VtaFacturaEnviado();
                    $vtafacturaenviado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtafacturaenviado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtafacturaenviado->setVtaFacturaId($fila[self::GEN_ATTR_MIN_VTA_FACTURA_ID]);
			$vtafacturaenviado->setAsunto($fila[self::GEN_ATTR_MIN_ASUNTO]);
			$vtafacturaenviado->setDestinatario($fila[self::GEN_ATTR_MIN_DESTINATARIO]);
			$vtafacturaenviado->setCuerpo($fila[self::GEN_ATTR_MIN_CUERPO]);
			$vtafacturaenviado->setAdjunto($fila[self::GEN_ATTR_MIN_ADJUNTO]);
			$vtafacturaenviado->setCodigoEnvio($fila[self::GEN_ATTR_MIN_CODIGO_ENVIO]);
			$vtafacturaenviado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtafacturaenviado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtafacturaenviado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtafacturaenviado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtafacturaenviado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtafacturaenviado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtafacturaenviado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtafacturaenviado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaFacturaEnviadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaFacturaEnviado::getVtaFacturaEnviados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaFacturaEnviados para listado de Backend */ 	
	static function getVtaFacturaEnviadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaFacturaEnviado::getVtaFacturaEnviados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaFacturaEnviadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaFacturaEnviado::getVtaFacturaEnviados($paginador, $criterio);
	...
	/* Método getVtaFacturaEnviados filtrado para select */ 	
	static function getVtaFacturaEnviadosCmbF($paginador = null, $criterio = null){
            $col = VtaFacturaEnviado::getVtaFacturaEnviados($paginador, $criterio);
	...
	/* Método getVtaFacturaEnviados filtrado por una coleccion de objetos foraneos de VtaFactura */ 	
	static function getVtaFacturaEnviadosXVtaFacturas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaFacturaEnviado::GEN_ATTR_VTA_FACTURA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaFacturaEnviado::GEN_TABLA);
            $c->addOrden(VtaFacturaEnviado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaFacturaEnviado::getVtaFacturaEnviados($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_factura_enviado_adm.php';
            $url_gestion = 'vta_factura_enviado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_factura_enviado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_factura_enviado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaFacturaEnviados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaFacturaEnviados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_factura_enviado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaFacturaEnviado::GEN_TABLA);
                $c->addOrden(VtaFacturaEnviado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_factura_enviados = VtaFacturaEnviado::getVtaFacturaEnviados(null, $c);

                $arr = array();
                foreach($vta_factura_enviados as $vta_factura_enviado){
                    $descripcion = $vta_factura_enviado->getDescripcion();

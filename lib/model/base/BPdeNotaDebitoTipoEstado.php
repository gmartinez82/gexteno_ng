...
class BPdeNotaDebitoTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_pdenotadebitotipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdenotadebitotipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pdenotadebitotipoestado_criterios';
	
	const GEN_CLASE = 'PdeNotaDebitoTipoEstado';
	const GEN_TABLA = 'pde_nota_debito_tipo_estado';
	...
	/* Constantes de Atributos de BPdeNotaDebitoTipoEstado */ 
	const GEN_ATTR_ID = 'pde_nota_debito_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'pde_nota_debito_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'pde_nota_debito_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'pde_nota_debito_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'pde_nota_debito_tipo_estado.terminal';
	const GEN_ATTR_IMPUTABLE = 'pde_nota_debito_tipo_estado.imputable';
	const GEN_ATTR_GESTIONABLE = 'pde_nota_debito_tipo_estado.gestionable';
	const GEN_ATTR_APROBADO_AFIP = 'pde_nota_debito_tipo_estado.aprobado_afip';
	const GEN_ATTR_CONTABILIZABLE = 'pde_nota_debito_tipo_estado.contabilizable';
	const GEN_ATTR_ANULADO = 'pde_nota_debito_tipo_estado.anulado';
	const GEN_ATTR_OBSERVACION = 'pde_nota_debito_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'pde_nota_debito_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'pde_nota_debito_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'pde_nota_debito_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pde_nota_debito_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_nota_debito_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_nota_debito_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BPdeNotaDebitoTipoEstado */ 
	...
	/* Atributos de BPdeNotaDebitoTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BPdeNotaDebitoTipoEstado */ 
	...
	/* Setters de BPdeNotaDebitoTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeNotaDebitoTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeNotaDebitoTipoEstado */ 	
	...
	/* Cambia el estado de BPdeNotaDebitoTipoEstado */ 	
	...
	/* Save de BPdeNotaDebitoTipoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_nota_debito_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('pde_nota_debito_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PdeNotaDebitoTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeNotaDebitoTipoEstado */ 	
	...
	public function duplicarPdeNotaDebitoTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeNotaDebitoTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeNotaDebitoTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdenotadebitotipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdenotadebitotipoestado = new PdeNotaDebitoTipoEstado();
                    $pdenotadebitotipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdenotadebitotipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdenotadebitotipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdenotadebitotipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$pdenotadebitotipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$pdenotadebitotipoestado->setImputable($fila[self::GEN_ATTR_MIN_IMPUTABLE]);
			$pdenotadebitotipoestado->setGestionable($fila[self::GEN_ATTR_MIN_GESTIONABLE]);
			$pdenotadebitotipoestado->setAprobadoAfip($fila[self::GEN_ATTR_MIN_APROBADO_AFIP]);
			$pdenotadebitotipoestado->setContabilizable($fila[self::GEN_ATTR_MIN_CONTABILIZABLE]);
			$pdenotadebitotipoestado->setAnulado($fila[self::GEN_ATTR_MIN_ANULADO]);
			$pdenotadebitotipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdenotadebitotipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdenotadebitotipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdenotadebitotipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdenotadebitotipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdenotadebitotipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdenotadebitotipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdenotadebitotipoestados[] = $pdenotadebitotipoestado;
		}
		
		return $pdenotadebitotipoestados;
	}	
	

	/* Método getPdeNotaDebitoTipoEstados Habilitados */ 	
	static function getPdeNotaDebitoTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeNotaDebitoTipoEstado::getPdeNotaDebitoTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeNotaDebitoTipoEstados para listado de Backend */ 	
	static function getPdeNotaDebitoTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeNotaDebitoTipoEstado::getPdeNotaDebitoTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeNotaDebitoTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeNotaDebitoTipoEstado::getPdeNotaDebitoTipoEstados($paginador, $criterio);
	...
	/* Método getPdeNotaDebitoTipoEstados filtrado para select */ 	
	static function getPdeNotaDebitoTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = PdeNotaDebitoTipoEstado::getPdeNotaDebitoTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_nota_debito_tipo_estado_adm.php';
            $url_gestion = 'pde_nota_debito_tipo_estado_gestion.php';
	...
	public function getPdeNotaDebitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaDebito::GEN_ATTR_PDE_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaDebitosCmb(){
            $c = new Criterio();
            $c->add(PdeNotaDebito::GEN_ATTR_PDE_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaDebito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeNotaDebitoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaDebitoEstado::GEN_ATTR_PDE_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaDebitoEstadosCmb(){
            $c = new Criterio();
            $c->add(PdeNotaDebitoEstado::GEN_ATTR_PDE_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaDebitoEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PdeNotaDebitos (Coleccion) relacionados a traves de PdeNotaDebitoEstado */ 	
	public function getPdeNotaDebitosXPdeNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(PdeNotaDebito::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(PdeNotaDebitoEstado::GEN_ATTR_PDE_NOTA_DEBITO_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaDebito::GEN_TABLA);
            $c->addRealJoin(PdeNotaDebitoEstado::GEN_TABLA, PdeNotaDebitoEstado::GEN_ATTR_PDE_NOTA_DEBITO_ID, PdeNotaDebito::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PdeNotaDebitos relacionados a traves de PdeNotaDebitoEstado */ 	
	public function getCantidadPdeNotaDebitosXPdeNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PdeNotaDebito (Objeto) relacionado a traves de PdeNotaDebitoEstado */ 	
	public function getPdeNotaDebitoXPdeNotaDebitoEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPdeNotaDebitosXPdeNotaDebitoEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_nota_debito_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_nota_debito_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeNotaDebitoTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeNotaDebitoTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_nota_debito_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeNotaDebitoTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_nota_debito_tipo_estados = PdeNotaDebitoTipoEstado::getPdeNotaDebitoTipoEstados(null, $c);

                $arr = array();
                foreach($pde_nota_debito_tipo_estados as $pde_nota_debito_tipo_estado){
                    $descripcion = $pde_nota_debito_tipo_estado->getDescripcion();

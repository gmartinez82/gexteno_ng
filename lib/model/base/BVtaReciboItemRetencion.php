...
class BVtaReciboItemRetencion
{ 
	
	const SES_PAGINACION = 'adm_vtareciboitemretencion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtareciboitemretencion_paginas_registros';
	const SES_CRITERIOS = 'adm_vtareciboitemretencion_criterios';
	
	const GEN_CLASE = 'VtaReciboItemRetencion';
	const GEN_TABLA = 'vta_recibo_item_retencion';
	...
	/* Constantes de Atributos de BVtaReciboItemRetencion */ 
	const GEN_ATTR_ID = 'vta_recibo_item_retencion.id';
	const GEN_ATTR_DESCRIPCION = 'vta_recibo_item_retencion.descripcion';
	const GEN_ATTR_VTA_RECIBO_ID = 'vta_recibo_item_retencion.vta_recibo_id';
	const GEN_ATTR_VTA_RECIBO_ITEM_ID = 'vta_recibo_item_retencion.vta_recibo_item_id';
	const GEN_ATTR_NUMERO_COMPROBANTE = 'vta_recibo_item_retencion.numero_comprobante';
	const GEN_ATTR_FECHA_EMISION = 'vta_recibo_item_retencion.fecha_emision';
	const GEN_ATTR_IMPORTE_BASE_IMPONIBLE = 'vta_recibo_item_retencion.importe_base_imponible';
	const GEN_ATTR_IMPORTE_RETENCION = 'vta_recibo_item_retencion.importe_retencion';
	const GEN_ATTR_CODIGO = 'vta_recibo_item_retencion.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_recibo_item_retencion.observacion';
	const GEN_ATTR_ORDEN = 'vta_recibo_item_retencion.orden';
	const GEN_ATTR_ESTADO = 'vta_recibo_item_retencion.estado';
	const GEN_ATTR_CREADO = 'vta_recibo_item_retencion.creado';
	const GEN_ATTR_CREADO_POR = 'vta_recibo_item_retencion.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_recibo_item_retencion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_recibo_item_retencion.modificado_por';

	/* Constantes de Atributos Min de BVtaReciboItemRetencion */ 
	...
	/* Atributos de BVtaReciboItemRetencion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaReciboItemRetencion */ 
	...
	/* Setters de BVtaReciboItemRetencion */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaReciboItemRetencion();
            $o->setId($fila[VtaReciboItemRetencion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaReciboItemRetencion */ 	
	...
	/* Cambia el estado de BVtaReciboItemRetencion */ 	
	...
	/* Save de BVtaReciboItemRetencion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_recibo_item_retencion_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getVtaReciboId()."
                    ...
                    ) RETURNING currval('vta_recibo_item_retencion_seq')";
                ...
                $sql = "
				 ...
				 ".VtaReciboItemRetencion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaReciboItemRetencion */ 	
	...
	public function duplicarVtaReciboItemRetencion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaReciboItemRetencions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaReciboItemRetencion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtareciboitemretencion = new VtaReciboItemRetencion();
                    $vtareciboitemretencion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtareciboitemretencion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtareciboitemretencion->setVtaReciboId($fila[self::GEN_ATTR_MIN_VTA_RECIBO_ID]);
			$vtareciboitemretencion->setVtaReciboItemId($fila[self::GEN_ATTR_MIN_VTA_RECIBO_ITEM_ID]);
			$vtareciboitemretencion->setNumeroComprobante($fila[self::GEN_ATTR_MIN_NUMERO_COMPROBANTE]);
			$vtareciboitemretencion->setFechaEmision($fila[self::GEN_ATTR_MIN_FECHA_EMISION]);
			$vtareciboitemretencion->setImporteBaseImponible($fila[self::GEN_ATTR_MIN_IMPORTE_BASE_IMPONIBLE]);
			$vtareciboitemretencion->setImporteRetencion($fila[self::GEN_ATTR_MIN_IMPORTE_RETENCION]);
			$vtareciboitemretencion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtareciboitemretencion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtareciboitemretencion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtareciboitemretencion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtareciboitemretencion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtareciboitemretencion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtareciboitemretencion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtareciboitemretencion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaReciboItemRetencionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaReciboItemRetencion::getVtaReciboItemRetencions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaReciboItemRetencions para listado de Backend */ 	
	static function getVtaReciboItemRetencionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaReciboItemRetencion::getVtaReciboItemRetencions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaReciboItemRetencionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaReciboItemRetencion::getVtaReciboItemRetencions($paginador, $criterio);
	...
	/* Método getVtaReciboItemRetencions filtrado para select */ 	
	static function getVtaReciboItemRetencionsCmbF($paginador = null, $criterio = null){
            $col = VtaReciboItemRetencion::getVtaReciboItemRetencions($paginador, $criterio);
	...
	/* Método getVtaReciboItemRetencions filtrado por una coleccion de objetos foraneos de VtaRecibo */ 	
	static function getVtaReciboItemRetencionsXVtaRecibos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaReciboItemRetencion::GEN_ATTR_VTA_RECIBO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaReciboItemRetencion::GEN_TABLA);
            $c->addOrden(VtaReciboItemRetencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaReciboItemRetencion::getVtaReciboItemRetencions($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaReciboItemRetencions filtrado por una coleccion de objetos foraneos de VtaReciboItem */ 	
	static function getVtaReciboItemRetencionsXVtaReciboItems($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaReciboItemRetencion::GEN_ATTR_VTA_RECIBO_ITEM_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaReciboItemRetencion::GEN_TABLA);
            $c->addOrden(VtaReciboItemRetencion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_recibo_item_retencion_adm.php';
            $url_gestion = 'vta_recibo_item_retencion_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_recibo_item_retencion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_recibo_item_retencion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaReciboItemRetencions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaReciboItemRetencions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_recibo_item_retencion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaReciboItemRetencion::GEN_TABLA);
                $c->addOrden(VtaReciboItemRetencion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_recibo_item_retencions = VtaReciboItemRetencion::getVtaReciboItemRetencions(null, $c);

                $arr = array();
                foreach($vta_recibo_item_retencions as $vta_recibo_item_retencion){
                    $descripcion = $vta_recibo_item_retencion->getDescripcion();

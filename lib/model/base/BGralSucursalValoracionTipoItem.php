...
class BGralSucursalValoracionTipoItem
{ 
	
	const SES_PAGINACION = 'adm_gralsucursalvaloraciontipoitem_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_gralsucursalvaloraciontipoitem_paginas_registros';
	const SES_CRITERIOS = 'adm_gralsucursalvaloraciontipoitem_criterios';
	
	const GEN_CLASE = 'GralSucursalValoracionTipoItem';
	const GEN_TABLA = 'gral_sucursal_valoracion_tipo_item';
	...
	/* Constantes de Atributos de BGralSucursalValoracionTipoItem */ 
	const GEN_ATTR_ID = 'gral_sucursal_valoracion_tipo_item.id';
	const GEN_ATTR_DESCRIPCION = 'gral_sucursal_valoracion_tipo_item.descripcion';
	const GEN_ATTR_DESCRIPCION_CORTA = 'gral_sucursal_valoracion_tipo_item.descripcion_corta';
	const GEN_ATTR_DESCRIPCION_PUBLICA = 'gral_sucursal_valoracion_tipo_item.descripcion_publica';
	const GEN_ATTR_COLOR = 'gral_sucursal_valoracion_tipo_item.color';
	const GEN_ATTR_COLOR_SECUNDARIO = 'gral_sucursal_valoracion_tipo_item.color_secundario';
	const GEN_ATTR_CODIGO = 'gral_sucursal_valoracion_tipo_item.codigo';
	const GEN_ATTR_OBSERVACION = 'gral_sucursal_valoracion_tipo_item.observacion';
	const GEN_ATTR_ORDEN = 'gral_sucursal_valoracion_tipo_item.orden';
	const GEN_ATTR_ESTADO = 'gral_sucursal_valoracion_tipo_item.estado';
	const GEN_ATTR_CREADO = 'gral_sucursal_valoracion_tipo_item.creado';
	const GEN_ATTR_CREADO_POR = 'gral_sucursal_valoracion_tipo_item.creado_por';
	const GEN_ATTR_MODIFICADO = 'gral_sucursal_valoracion_tipo_item.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'gral_sucursal_valoracion_tipo_item.modificado_por';

	/* Constantes de Atributos Min de BGralSucursalValoracionTipoItem */ 
	...
	/* Atributos de BGralSucursalValoracionTipoItem */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BGralSucursalValoracionTipoItem */ 
	...
	/* Setters de BGralSucursalValoracionTipoItem */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[GralSucursalValoracionTipoItem::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BGralSucursalValoracionTipoItem */ 	
	...
	/* Cambia el estado de BGralSucursalValoracionTipoItem */ 	
	...
	/* Save de BGralSucursalValoracionTipoItem */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('gral_sucursal_valoracion_tipo_item_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('gral_sucursal_valoracion_tipo_item_seq')";
                ...
                $sql = "
				 ...
				 ".GralSucursalValoracionTipoItem::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BGralSucursalValoracionTipoItem */ 	
	...
	public function duplicarGralSucursalValoracionTipoItem(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getGralSucursalValoracionTipoItems($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = GralSucursalValoracionTipoItem::setAplicarFiltrosDeAlcance($criterio);
		...
		$gralsucursalvaloraciontipoitems = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $gralsucursalvaloraciontipoitem = new GralSucursalValoracionTipoItem();
                    $gralsucursalvaloraciontipoitem->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $gralsucursalvaloraciontipoitem->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$gralsucursalvaloraciontipoitem->setDescripcionCorta($fila[self::GEN_ATTR_MIN_DESCRIPCION_CORTA]);
			$gralsucursalvaloraciontipoitem->setDescripcionPublica($fila[self::GEN_ATTR_MIN_DESCRIPCION_PUBLICA]);
			$gralsucursalvaloraciontipoitem->setColor($fila[self::GEN_ATTR_MIN_COLOR]);
			$gralsucursalvaloraciontipoitem->setColorSecundario($fila[self::GEN_ATTR_MIN_COLOR_SECUNDARIO]);
			$gralsucursalvaloraciontipoitem->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$gralsucursalvaloraciontipoitem->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$gralsucursalvaloraciontipoitem->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$gralsucursalvaloraciontipoitem->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$gralsucursalvaloraciontipoitem->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$gralsucursalvaloraciontipoitem->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$gralsucursalvaloraciontipoitem->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$gralsucursalvaloraciontipoitem->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $gralsucursalvaloraciontipoitems[] = $gralsucursalvaloraciontipoitem;
		}
		
		return $gralsucursalvaloraciontipoitems;
	}	
	

	/* Método getGralSucursalValoracionTipoItems Habilitados */ 	
	static function getGralSucursalValoracionTipoItemsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getGralSucursalValoracionTipoItems para listado de Backend */ 	
	static function getGralSucursalValoracionTipoItemsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getGralSucursalValoracionTipoItemsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems($paginador, $criterio);
	...
	/* Método getGralSucursalValoracionTipoItems filtrado para select */ 	
	static function getGralSucursalValoracionTipoItemsCmbF($paginador = null, $criterio = null){
            $col = GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'gral_sucursal_valoracion_tipo_item_adm.php';
            $url_gestion = 'gral_sucursal_valoracion_tipo_item_gestion.php';
	...
	public function getGralSucursalValoracions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralSucursalValoracion::GEN_ATTR_GRAL_SUCURSAL_VALORACION_TIPO_ITEM_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralSucursalValoracionsCmb(){
            $c = new Criterio();
            $c->add(GralSucursalValoracion::GEN_ATTR_GRAL_SUCURSAL_VALORACION_TIPO_ITEM_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralSucursalValoracion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getGralSucursalValoracionTipoItemGralSucursals($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralSucursalValoracionTipoItemGralSucursal::GEN_ATTR_GRAL_SUCURSAL_VALORACION_TIPO_ITEM_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralSucursalValoracionTipoItemGralSucursalsCmb(){
            $c = new Criterio();
            $c->add(GralSucursalValoracionTipoItemGralSucursal::GEN_ATTR_GRAL_SUCURSAL_VALORACION_TIPO_ITEM_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralSucursalValoracionTipoItemGralSucursal::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralSucursals (Coleccion) relacionados a traves de GralSucursalValoracionTipoItemGralSucursal */ 	
	public function getGralSucursalsXGralSucursalValoracionTipoItemGralSucursal($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralSucursalValoracionTipoItemGralSucursal::GEN_TABLA, GralSucursalValoracionTipoItemGralSucursal::GEN_ATTR_GRAL_SUCURSAL_ID, GralSucursal::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralSucursals relacionados a traves de GralSucursalValoracionTipoItemGralSucursal */ 	
	public function getCantidadGralSucursalsXGralSucursalValoracionTipoItemGralSucursal($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralSucursal (Objeto) relacionado a traves de GralSucursalValoracionTipoItemGralSucursal */ 	
	public function getGralSucursalXGralSucursalValoracionTipoItemGralSucursal($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralSucursalsXGralSucursalValoracionTipoItemGralSucursal($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna una coleccion de IDs de los GralSucursals asignados a GralSucursalValoracionTipoItem */ 	
	...
	/* Método setea nuevos GralSucursals asignados al GralSucursalValoracionTipoItem */ 	
	public function setGralSucursalValoracionTipoItemGralSucursals($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setGralSucursalValoracionTipoItemId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralSucursal en el alta de GralSucursalValoracionTipoItem */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM gral_sucursal_valoracion_tipo_item'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'gral_sucursal_valoracion_tipo_item';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getGralSucursalValoracionTipoItems($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getGralSucursalValoracionTipoItems(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'gral_sucursal_valoracion_tipo_item_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(GralSucursalValoracionTipoItem::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $gral_sucursal_valoracion_tipo_items = GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems(null, $c);

                $arr = array();
                foreach($gral_sucursal_valoracion_tipo_items as $gral_sucursal_valoracion_tipo_item){
                    $descripcion = $gral_sucursal_valoracion_tipo_item->getDescripcion();

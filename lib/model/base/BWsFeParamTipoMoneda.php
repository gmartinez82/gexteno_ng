...
class BWsFeParamTipoMoneda
{ 
	
	const SES_PAGINACION = 'adm_wsfeparamtipomoneda_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_wsfeparamtipomoneda_paginas_registros';
	const SES_CRITERIOS = 'adm_wsfeparamtipomoneda_criterios';
	
	const GEN_CLASE = 'WsFeParamTipoMoneda';
	const GEN_TABLA = 'ws_fe_param_tipo_moneda';
	...
	/* Constantes de Atributos de BWsFeParamTipoMoneda */ 
	const GEN_ATTR_ID = 'ws_fe_param_tipo_moneda.id';
	const GEN_ATTR_DESCRIPCION = 'ws_fe_param_tipo_moneda.descripcion';
	const GEN_ATTR_CODIGO = 'ws_fe_param_tipo_moneda.codigo';
	const GEN_ATTR_CODIGO_AFIP = 'ws_fe_param_tipo_moneda.codigo_afip';
	const GEN_ATTR_FECHA_DESDE = 'ws_fe_param_tipo_moneda.fecha_desde';
	const GEN_ATTR_FECHA_HASTA = 'ws_fe_param_tipo_moneda.fecha_hasta';
	const GEN_ATTR_OBSERVACION = 'ws_fe_param_tipo_moneda.observacion';
	const GEN_ATTR_ORDEN = 'ws_fe_param_tipo_moneda.orden';
	const GEN_ATTR_ESTADO = 'ws_fe_param_tipo_moneda.estado';
	const GEN_ATTR_CREADO = 'ws_fe_param_tipo_moneda.creado';
	const GEN_ATTR_CREADO_POR = 'ws_fe_param_tipo_moneda.creado_por';
	const GEN_ATTR_MODIFICADO = 'ws_fe_param_tipo_moneda.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ws_fe_param_tipo_moneda.modificado_por';

	/* Constantes de Atributos Min de BWsFeParamTipoMoneda */ 
	...
	/* Atributos de BWsFeParamTipoMoneda */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $codigo_afip;
	...
	/* Getters de BWsFeParamTipoMoneda */ 
	...
	/* Setters de BWsFeParamTipoMoneda */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[WsFeParamTipoMoneda::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BWsFeParamTipoMoneda */ 	
	...
	/* Cambia el estado de BWsFeParamTipoMoneda */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('ws_fe_param_tipo_moneda_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, '".$this->getCodigoAfip()."'
						, '".$this->getFechaDesde()."'
                    ...
                    ) RETURNING currval('ws_fe_param_tipo_moneda_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BWsFeParamTipoMoneda */ 	
	...
	public function duplicarWsFeParamTipoMoneda(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getWsFeParamTipoMonedas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = WsFeParamTipoMoneda::setAplicarFiltrosDeAlcance($criterio);
		...
		$wsfeparamtipomonedas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $wsfeparamtipomoneda = new WsFeParamTipoMoneda();
                    $wsfeparamtipomoneda->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $wsfeparamtipomoneda->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$wsfeparamtipomoneda->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$wsfeparamtipomoneda->setCodigoAfip($fila[self::GEN_ATTR_MIN_CODIGO_AFIP]);
			$wsfeparamtipomoneda->setFechaDesde($fila[self::GEN_ATTR_MIN_FECHA_DESDE]);
			$wsfeparamtipomoneda->setFechaHasta($fila[self::GEN_ATTR_MIN_FECHA_HASTA]);
			$wsfeparamtipomoneda->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$wsfeparamtipomoneda->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$wsfeparamtipomoneda->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$wsfeparamtipomoneda->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$wsfeparamtipomoneda->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$wsfeparamtipomoneda->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$wsfeparamtipomoneda->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $wsfeparamtipomonedas[] = $wsfeparamtipomoneda;
		}
		
		return $wsfeparamtipomonedas;
	}	
	

	/* Método getWsFeParamTipoMonedas Habilitados */ 	
	static function getWsFeParamTipoMonedasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return WsFeParamTipoMoneda::getWsFeParamTipoMonedas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getWsFeParamTipoMonedas para listado de Backend */ 	
	static function getWsFeParamTipoMonedasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return WsFeParamTipoMoneda::getWsFeParamTipoMonedas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getWsFeParamTipoMonedasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = WsFeParamTipoMoneda::getWsFeParamTipoMonedas($paginador, $criterio);
	...
	/* Método getWsFeParamTipoMonedas filtrado para select */ 	
	static function getWsFeParamTipoMonedasCmbF($paginador = null, $criterio = null){
            $col = WsFeParamTipoMoneda::getWsFeParamTipoMonedas($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ws_fe_param_tipo_moneda_adm.php';
            $url_gestion = 'ws_fe_param_tipo_moneda_gestion.php';
	...
	public function getWsFeOpeSolicituds($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(WsFeOpeSolicitud::GEN_ATTR_WS_FE_PARAM_TIPO_MONEDA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getWsFeOpeSolicitudsCmb(){
            $c = new Criterio();
            $c->add(WsFeOpeSolicitud::GEN_ATTR_WS_FE_PARAM_TIPO_MONEDA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(WsFeOpeSolicitud::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ws_fe_param_tipo_moneda'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ws_fe_param_tipo_moneda';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getWsFeParamTipoMonedas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getWsFeParamTipoMonedas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ws_fe_param_tipo_moneda_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(WsFeParamTipoMoneda::GEN_TABLA);
                $c->addOrden(WsFeParamTipoMoneda::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $ws_fe_param_tipo_monedas = WsFeParamTipoMoneda::getWsFeParamTipoMonedas(null, $c);

                $arr = array();
                foreach($ws_fe_param_tipo_monedas as $ws_fe_param_tipo_moneda){
                    $descripcion = $ws_fe_param_tipo_moneda->getDescripcion();

...
class BVtaTipoRemitoAjuste
{ 
	
	const SES_PAGINACION = 'adm_vtatiporemitoajuste_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtatiporemitoajuste_paginas_registros';
	const SES_CRITERIOS = 'adm_vtatiporemitoajuste_criterios';
	
	const GEN_CLASE = 'VtaTipoRemitoAjuste';
	const GEN_TABLA = 'vta_tipo_remito_ajuste';
	...
	/* Constantes de Atributos de BVtaTipoRemitoAjuste */ 
	const GEN_ATTR_ID = 'vta_tipo_remito_ajuste.id';
	const GEN_ATTR_DESCRIPCION = 'vta_tipo_remito_ajuste.descripcion';
	const GEN_ATTR_CODIGO_MIN = 'vta_tipo_remito_ajuste.codigo_min';
	const GEN_ATTR_CODIGO = 'vta_tipo_remito_ajuste.codigo';
	const GEN_ATTR_INFORMA = 'vta_tipo_remito_ajuste.informa';
	const GEN_ATTR_OBSERVACION = 'vta_tipo_remito_ajuste.observacion';
	const GEN_ATTR_ORDEN = 'vta_tipo_remito_ajuste.orden';
	const GEN_ATTR_ESTADO = 'vta_tipo_remito_ajuste.estado';
	const GEN_ATTR_CREADO = 'vta_tipo_remito_ajuste.creado';
	const GEN_ATTR_CREADO_POR = 'vta_tipo_remito_ajuste.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_tipo_remito_ajuste.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_tipo_remito_ajuste.modificado_por';

	/* Constantes de Atributos Min de BVtaTipoRemitoAjuste */ 
	...
	/* Atributos de BVtaTipoRemitoAjuste */ 
	private $id;
	private $descripcion;
	private $codigo_min;
	private $codigo;
	...
	/* Getters de BVtaTipoRemitoAjuste */ 
	...
	/* Setters de BVtaTipoRemitoAjuste */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaTipoRemitoAjuste::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaTipoRemitoAjuste */ 	
	...
	/* Cambia el estado de BVtaTipoRemitoAjuste */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_tipo_remito_ajuste_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigoMin()."'
						, '".$this->getCodigo()."'
						, ".$this->getInforma()."
                    ...
                    ) RETURNING currval('vta_tipo_remito_ajuste_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaTipoRemitoAjuste */ 	
	...
	public function duplicarVtaTipoRemitoAjuste(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaTipoRemitoAjustes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaTipoRemitoAjuste::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtatiporemitoajustes = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtatiporemitoajuste = new VtaTipoRemitoAjuste();
                    $vtatiporemitoajuste->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtatiporemitoajuste->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtatiporemitoajuste->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtatiporemitoajuste->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtatiporemitoajuste->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$vtatiporemitoajuste->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtatiporemitoajuste->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtatiporemitoajuste->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtatiporemitoajuste->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtatiporemitoajuste->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtatiporemitoajuste->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtatiporemitoajuste->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtatiporemitoajustes[] = $vtatiporemitoajuste;
		}
		
		return $vtatiporemitoajustes;
	}	
	

	/* Método getVtaTipoRemitoAjustes Habilitados */ 	
	static function getVtaTipoRemitoAjustesHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaTipoRemitoAjuste::getVtaTipoRemitoAjustes($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaTipoRemitoAjustes para listado de Backend */ 	
	static function getVtaTipoRemitoAjustesDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaTipoRemitoAjuste::getVtaTipoRemitoAjustes($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaTipoRemitoAjustesCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaTipoRemitoAjuste::getVtaTipoRemitoAjustes($paginador, $criterio);
	...
	/* Método getVtaTipoRemitoAjustes filtrado para select */ 	
	static function getVtaTipoRemitoAjustesCmbF($paginador = null, $criterio = null){
            $col = VtaTipoRemitoAjuste::getVtaTipoRemitoAjustes($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_tipo_remito_ajuste_adm.php';
            $url_gestion = 'vta_tipo_remito_ajuste_gestion.php';
	...
	public function getVtaTipoRemitoAjusteWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaTipoRemitoAjusteWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_REMITO_AJUSTE_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaTipoRemitoAjusteWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(VtaTipoRemitoAjusteWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_REMITO_AJUSTE_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaTipoRemitoAjusteWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de VtaTipoRemitoAjusteWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXVtaTipoRemitoAjusteWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(VtaTipoRemitoAjusteWsFeParamTipoComprobante::GEN_TABLA, VtaTipoRemitoAjusteWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de VtaTipoRemitoAjusteWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXVtaTipoRemitoAjusteWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de VtaTipoRemitoAjusteWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXVtaTipoRemitoAjusteWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXVtaTipoRemitoAjusteWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getVtaRemitoAjustes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaRemitoAjuste::GEN_ATTR_VTA_TIPO_REMITO_AJUSTE_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaRemitoAjustesCmb(){
            $c = new Criterio();
            $c->add(VtaRemitoAjuste::GEN_ATTR_VTA_TIPO_REMITO_AJUSTE_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRemitoAjuste::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a VtaTipoRemitoAjuste */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al VtaTipoRemitoAjuste */ 	
	public function setVtaTipoRemitoAjusteWsFeParamTipoComprobantes($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaTipoRemitoAjusteId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de VtaTipoRemitoAjuste */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_tipo_remito_ajuste'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_tipo_remito_ajuste';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaTipoRemitoAjustes($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaTipoRemitoAjustes(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_tipo_remito_ajuste_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaTipoRemitoAjuste::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_tipo_remito_ajustes = VtaTipoRemitoAjuste::getVtaTipoRemitoAjustes(null, $c);

                $arr = array();
                foreach($vta_tipo_remito_ajustes as $vta_tipo_remito_ajuste){
                    $descripcion = $vta_tipo_remito_ajuste->getDescripcion();

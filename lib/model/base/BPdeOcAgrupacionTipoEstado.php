...
class BPdeOcAgrupacionTipoEstado
{ 
	
	const SES_PAGINACION = 'adm_pdeocagrupaciontipoestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdeocagrupaciontipoestado_paginas_registros';
	const SES_CRITERIOS = 'adm_pdeocagrupaciontipoestado_criterios';
	
	const GEN_CLASE = 'PdeOcAgrupacionTipoEstado';
	const GEN_TABLA = 'pde_oc_agrupacion_tipo_estado';
	...
	/* Constantes de Atributos de BPdeOcAgrupacionTipoEstado */ 
	const GEN_ATTR_ID = 'pde_oc_agrupacion_tipo_estado.id';
	const GEN_ATTR_DESCRIPCION = 'pde_oc_agrupacion_tipo_estado.descripcion';
	const GEN_ATTR_CODIGO = 'pde_oc_agrupacion_tipo_estado.codigo';
	const GEN_ATTR_ACTIVO = 'pde_oc_agrupacion_tipo_estado.activo';
	const GEN_ATTR_TERMINAL = 'pde_oc_agrupacion_tipo_estado.terminal';
	const GEN_ATTR_OBSERVACION = 'pde_oc_agrupacion_tipo_estado.observacion';
	const GEN_ATTR_ORDEN = 'pde_oc_agrupacion_tipo_estado.orden';
	const GEN_ATTR_ESTADO = 'pde_oc_agrupacion_tipo_estado.estado';
	const GEN_ATTR_CREADO = 'pde_oc_agrupacion_tipo_estado.creado';
	const GEN_ATTR_CREADO_POR = 'pde_oc_agrupacion_tipo_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_oc_agrupacion_tipo_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_oc_agrupacion_tipo_estado.modificado_por';

	/* Constantes de Atributos Min de BPdeOcAgrupacionTipoEstado */ 
	...
	/* Atributos de BPdeOcAgrupacionTipoEstado */ 
	private $id;
	private $descripcion;
	private $codigo;
	private $activo;
	...
	/* Getters de BPdeOcAgrupacionTipoEstado */ 
	...
	/* Setters de BPdeOcAgrupacionTipoEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeOcAgrupacionTipoEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeOcAgrupacionTipoEstado */ 	
	...
	/* Cambia el estado de BPdeOcAgrupacionTipoEstado */ 	
	...
	/* Save de BPdeOcAgrupacionTipoEstado */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_oc_agrupacion_tipo_estado_seq'), 
                '".$this->getDescripcion()."'
						, '".$this->getCodigo()."'
						, ".$this->getActivo()."
						, ".$this->getTerminal()."
                    ...
                    ) RETURNING currval('pde_oc_agrupacion_tipo_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PdeOcAgrupacionTipoEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeOcAgrupacionTipoEstado */ 	
	...
	public function duplicarPdeOcAgrupacionTipoEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeOcAgrupacionTipoEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeOcAgrupacionTipoEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdeocagrupaciontipoestados = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdeocagrupaciontipoestado = new PdeOcAgrupacionTipoEstado();
                    $pdeocagrupaciontipoestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdeocagrupaciontipoestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdeocagrupaciontipoestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdeocagrupaciontipoestado->setActivo($fila[self::GEN_ATTR_MIN_ACTIVO]);
			$pdeocagrupaciontipoestado->setTerminal($fila[self::GEN_ATTR_MIN_TERMINAL]);
			$pdeocagrupaciontipoestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdeocagrupaciontipoestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdeocagrupaciontipoestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdeocagrupaciontipoestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdeocagrupaciontipoestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdeocagrupaciontipoestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdeocagrupaciontipoestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdeocagrupaciontipoestados[] = $pdeocagrupaciontipoestado;
		}
		
		return $pdeocagrupaciontipoestados;
	}	
	

	/* Método getPdeOcAgrupacionTipoEstados Habilitados */ 	
	static function getPdeOcAgrupacionTipoEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeOcAgrupacionTipoEstado::getPdeOcAgrupacionTipoEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeOcAgrupacionTipoEstados para listado de Backend */ 	
	static function getPdeOcAgrupacionTipoEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeOcAgrupacionTipoEstado::getPdeOcAgrupacionTipoEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeOcAgrupacionTipoEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeOcAgrupacionTipoEstado::getPdeOcAgrupacionTipoEstados($paginador, $criterio);
	...
	/* Método getPdeOcAgrupacionTipoEstados filtrado para select */ 	
	static function getPdeOcAgrupacionTipoEstadosCmbF($paginador = null, $criterio = null){
            $col = PdeOcAgrupacionTipoEstado::getPdeOcAgrupacionTipoEstados($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_oc_agrupacion_tipo_estado_adm.php';
            $url_gestion = 'pde_oc_agrupacion_tipo_estado_gestion.php';
	...
	public function getPdeOcAgrupacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeOcAgrupacion::GEN_ATTR_PDE_OC_AGRUPACION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeOcAgrupacionsCmb(){
            $c = new Criterio();
            $c->add(PdeOcAgrupacion::GEN_ATTR_PDE_OC_AGRUPACION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOcAgrupacion::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeOcAgrupacionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeOcAgrupacionEstado::GEN_ATTR_PDE_OC_AGRUPACION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeOcAgrupacionEstadosCmb(){
            $c = new Criterio();
            $c->add(PdeOcAgrupacionEstado::GEN_ATTR_PDE_OC_AGRUPACION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOcAgrupacionEstado::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener PdeOcAgrupacions (Coleccion) relacionados a traves de PdeOcAgrupacionEstado */ 	
	public function getPdeOcAgrupacionsXPdeOcAgrupacionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
                $c->add(PdeOcAgrupacion::GEN_ATTR_ESTADO, 1, Criterio::IGUAL);
            ...
            $c->add(PdeOcAgrupacionEstado::GEN_ATTR_PDE_OC_AGRUPACION_TIPO_ESTADO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOcAgrupacion::GEN_TABLA);
            $c->addRealJoin(PdeOcAgrupacionEstado::GEN_TABLA, PdeOcAgrupacionEstado::GEN_ATTR_PDE_OC_AGRUPACION_ID, PdeOcAgrupacion::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de PdeOcAgrupacions relacionados a traves de PdeOcAgrupacionEstado */ 	
	public function getCantidadPdeOcAgrupacionsXPdeOcAgrupacionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener PdeOcAgrupacion (Objeto) relacionado a traves de PdeOcAgrupacionEstado */ 	
	public function getPdeOcAgrupacionXPdeOcAgrupacionEstado($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getPdeOcAgrupacionsXPdeOcAgrupacionEstado($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_oc_agrupacion_tipo_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_oc_agrupacion_tipo_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeOcAgrupacionTipoEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeOcAgrupacionTipoEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_oc_agrupacion_tipo_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeOcAgrupacionTipoEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_oc_agrupacion_tipo_estados = PdeOcAgrupacionTipoEstado::getPdeOcAgrupacionTipoEstados(null, $c);

                $arr = array();
                foreach($pde_oc_agrupacion_tipo_estados as $pde_oc_agrupacion_tipo_estado){
                    $descripcion = $pde_oc_agrupacion_tipo_estado->getDescripcion();

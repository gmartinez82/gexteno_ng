...
class BVtaTipoRemito
{ 
	
	const SES_PAGINACION = 'adm_vtatiporemito_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtatiporemito_paginas_registros';
	const SES_CRITERIOS = 'adm_vtatiporemito_criterios';
	
	const GEN_CLASE = 'VtaTipoRemito';
	const GEN_TABLA = 'vta_tipo_remito';
	...
	/* Constantes de Atributos de BVtaTipoRemito */ 
	const GEN_ATTR_ID = 'vta_tipo_remito.id';
	const GEN_ATTR_DESCRIPCION = 'vta_tipo_remito.descripcion';
	const GEN_ATTR_CODIGO_MIN = 'vta_tipo_remito.codigo_min';
	const GEN_ATTR_CODIGO = 'vta_tipo_remito.codigo';
	const GEN_ATTR_INFORMA = 'vta_tipo_remito.informa';
	const GEN_ATTR_OBSERVACION = 'vta_tipo_remito.observacion';
	const GEN_ATTR_ORDEN = 'vta_tipo_remito.orden';
	const GEN_ATTR_ESTADO = 'vta_tipo_remito.estado';
	const GEN_ATTR_CREADO = 'vta_tipo_remito.creado';
	const GEN_ATTR_CREADO_POR = 'vta_tipo_remito.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_tipo_remito.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_tipo_remito.modificado_por';

	/* Constantes de Atributos Min de BVtaTipoRemito */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new VtaTipoRemito();
            $o->setId($fila[VtaTipoRemito::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BVtaTipoRemito */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_tipo_remito_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarVtaTipoRemito(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaTipoRemitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaTipoRemito::setAplicarFiltrosDeAlcance($criterio);
		...
		$vtatiporemitos = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtatiporemito = new VtaTipoRemito();
                    $vtatiporemito->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtatiporemito->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtatiporemito->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$vtatiporemito->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtatiporemito->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$vtatiporemito->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtatiporemito->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtatiporemito->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtatiporemito->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtatiporemito->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtatiporemito->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtatiporemito->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $vtatiporemitos[] = $vtatiporemito;
		}
		
		return $vtatiporemitos;
	}	
	

	/* Método getVtaTipoRemitos Habilitados */ 	
	static function getVtaTipoRemitosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaTipoRemito::getVtaTipoRemitos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaTipoRemitos para listado de Backend */ 	
	static function getVtaTipoRemitosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaTipoRemito::getVtaTipoRemitos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaTipoRemitosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaTipoRemito::getVtaTipoRemitos($paginador, $criterio);
	...
	/* Método getVtaTipoRemitos filtrado para select */ 	
	static function getVtaTipoRemitosCmbF($paginador = null, $criterio = null){
            $col = VtaTipoRemito::getVtaTipoRemitos($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_tipo_remito_adm.php';
            $url_gestion = 'vta_tipo_remito_gestion.php';
	...
	public function getVtaRemitos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaRemito::GEN_ATTR_VTA_TIPO_REMITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaRemitosCmb(){
            $c = new Criterio();
            $c->add(VtaRemito::GEN_ATTR_VTA_TIPO_REMITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaRemito::GEN_TABLA);
            $c->setCriterios();
	...
	public function getVtaTipoRemitoWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaTipoRemitoWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_REMITO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaTipoRemitoWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(VtaTipoRemitoWsFeParamTipoComprobante::GEN_ATTR_VTA_TIPO_REMITO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaTipoRemitoWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de VtaTipoRemitoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXVtaTipoRemitoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(VtaTipoRemitoWsFeParamTipoComprobante::GEN_TABLA, VtaTipoRemitoWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de VtaTipoRemitoWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXVtaTipoRemitoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de VtaTipoRemitoWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXVtaTipoRemitoWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXVtaTipoRemitoWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a VtaTipoRemito */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al VtaTipoRemito */ 	
	public function setVtaTipoRemitoWsFeParamTipoComprobantes($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaTipoRemitoId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de VtaTipoRemito */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_tipo_remito'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_tipo_remito';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaTipoRemitos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaTipoRemitos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_tipo_remito_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(VtaTipoRemito::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_tipo_remitos = VtaTipoRemito::getVtaTipoRemitos(null, $c);

                $arr = array();
                foreach($vta_tipo_remitos as $vta_tipo_remito){
                    $descripcion = $vta_tipo_remito->getDescripcion();

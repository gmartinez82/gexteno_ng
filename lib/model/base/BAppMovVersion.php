...
class BAppMovVersion
{ 
	
	const SES_PAGINACION = 'adm_appmovversion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_appmovversion_paginas_registros';
	const SES_CRITERIOS = 'adm_appmovversion_criterios';
	
	const GEN_CLASE = 'AppMovVersion';
	const GEN_TABLA = 'app_mov_version';
	...
	/* Constantes de Atributos de BAppMovVersion */ 
	const GEN_ATTR_ID = 'app_mov_version.id';
	const GEN_ATTR_DESCRIPCION = 'app_mov_version.descripcion';
	const GEN_ATTR_APP_MOV_MODULO_ID = 'app_mov_version.app_mov_modulo_id';
	const GEN_ATTR_CODIGO = 'app_mov_version.codigo';
	const GEN_ATTR_VERSION = 'app_mov_version.version';
	const GEN_ATTR_VERSION_MINIMA = 'app_mov_version.version_minima';
	const GEN_ATTR_FECHA = 'app_mov_version.fecha';
	const GEN_ATTR_ACTUAL = 'app_mov_version.actual';
	const GEN_ATTR_OBSERVACION = 'app_mov_version.observacion';
	const GEN_ATTR_ORDEN = 'app_mov_version.orden';
	const GEN_ATTR_ESTADO = 'app_mov_version.estado';
	const GEN_ATTR_CREADO = 'app_mov_version.creado';
	const GEN_ATTR_CREADO_POR = 'app_mov_version.creado_por';
	const GEN_ATTR_MODIFICADO = 'app_mov_version.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'app_mov_version.modificado_por';

	/* Constantes de Atributos Min de BAppMovVersion */ 
	const GEN_ATTR_MIN_ID = 'id';
	const GEN_ATTR_MIN_DESCRIPCION = 'descripcion';
	const GEN_ATTR_MIN_APP_MOV_MODULO_ID = 'app_mov_modulo_id';
	const GEN_ATTR_MIN_CODIGO = 'codigo';
	const GEN_ATTR_MIN_VERSION = 'version';
	const GEN_ATTR_MIN_VERSION_MINIMA = 'version_minima';
	...
	public function getVersionMinima(){ if(isset($this->version_minima)){ return $this->version_minima; }else{ return ''; } }
	...
	public function setId($v, $db = true){
            ...
            if($db){
			 ...
			 WHERE ". self::GEN_ATTR_ID." = ".$this->getId();
				...
				$this->setVersionMinima($fila[self::GEN_ATTR_MIN_VERSION_MINIMA]);
	...
	public function setVersionMinima($v){ $this->version_minima = $v; }
	...
	public static function hidratarObjeto($fila){            
            $o = new AppMovVersion();
            $o->setId($fila[AppMovVersion::GEN_ATTR_MIN_ID], false);
			...
			$o->setVersionMinima($fila[self::GEN_ATTR_MIN_VERSION_MINIMA]);
	...
	/* Cambia el estado de BAppMovVersion */ 	
            ...
            if(!isset($this->id)){
                ...
                $sql = "
				 INSERT INTO ".self::GEN_TABLA." (".self::GEN_ATTR_MIN_ID.", ".self::GEN_ATTR_MIN_DESCRIPCION."
						...
						, ".self::GEN_ATTR_MIN_VERSION_MINIMA."
                ...
                nextval('app_mov_version_seq'), 
                '".$this->getDescripcion()."'
						, ".$this->getAppMovModuloId()."
						, '".$this->getCodigo()."'
						, '".$this->getVersion()."'
						, '".$this->getVersionMinima()."'
						, '".$this->getFecha()."'
						, ".$this->getActual()."
						, '".$this->getObservacion()."'
						, ".$this->getOrden()."
                    ...
                    ) RETURNING currval('app_mov_version_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarAppMovVersion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getAppMovVersions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = AppMovVersion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $appmovversion = new AppMovVersion();
                    $appmovversion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $appmovversion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$appmovversion->setAppMovModuloId($fila[self::GEN_ATTR_MIN_APP_MOV_MODULO_ID]);
			$appmovversion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$appmovversion->setVersion($fila[self::GEN_ATTR_MIN_VERSION]);
			$appmovversion->setVersionMinima($fila[self::GEN_ATTR_MIN_VERSION_MINIMA]);
			$appmovversion->setFecha($fila[self::GEN_ATTR_MIN_FECHA]);
			$appmovversion->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$appmovversion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$appmovversion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$appmovversion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$appmovversion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$appmovversion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$appmovversion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$appmovversion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getAppMovVersionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return AppMovVersion::getAppMovVersions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getAppMovVersions para listado de Backend */ 	
	static function getAppMovVersionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return AppMovVersion::getAppMovVersions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getAppMovVersionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = AppMovVersion::getAppMovVersions($paginador, $criterio);
	...
	/* Método getAppMovVersions filtrado para select */ 	
	static function getAppMovVersionsCmbF($paginador = null, $criterio = null){
            $col = AppMovVersion::getAppMovVersions($paginador, $criterio);
	...
	/* Método getAppMovVersions filtrado por una coleccion de objetos foraneos de AppMovModulo */ 	
	static function getAppMovVersionsXAppMovModulos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(AppMovVersion::GEN_ATTR_APP_MOV_MODULO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(AppMovVersion::GEN_TABLA);
            $c->addOrden(AppMovVersion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'app_mov_version_adm.php';
            $url_gestion = 'app_mov_version_gestion.php';
	...
	public function getAppMovInstalacions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(AppMovInstalacion::GEN_ATTR_APP_MOV_VERSION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getAppMovInstalacionsCmb(){
            $c = new Criterio();
            $c->add(AppMovInstalacion::GEN_ATTR_APP_MOV_VERSION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(AppMovInstalacion::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM app_mov_version'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'app_mov_version';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getAppMovVersions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getAppMovVersions(null, $criterio);
            return $obs;
	}
	...
	/* retorna un objeto de acuerdo al 'version_minima' */ 	
	static function getOxVersionMinima($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_VERSION_MINIMA, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	/* retorna una coleccion de objetos de acuerdo al 'version_minima' */ 	
	static function getOsxVersionMinima($valor){
            $criterio = new Criterio();
            $criterio->add(self::GEN_ATTR_VERSION_MINIMA, $valor, Criterio::IGUAL);
            $criterio->addTabla(self::GEN_TABLA);
            $criterio->setCriterios();
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'app_mov_version_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(AppMovVersion::GEN_TABLA);
                $c->addOrden(AppMovVersion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $app_mov_versions = AppMovVersion::getAppMovVersions(null, $c);

                $arr = array();
                foreach($app_mov_versions as $app_mov_version){
                    $descripcion = $app_mov_version->getDescripcion();

...
class BVtaAjusteDebeVtaTributo
{ 
	
	const SES_PAGINACION = 'adm_vtaajustedebevtatributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtaajustedebevtatributo_paginas_registros';
	const SES_CRITERIOS = 'adm_vtaajustedebevtatributo_criterios';
	
	const GEN_CLASE = 'VtaAjusteDebeVtaTributo';
	const GEN_TABLA = 'vta_ajuste_debe_vta_tributo';
	...
	/* Constantes de Atributos de BVtaAjusteDebeVtaTributo */ 
	const GEN_ATTR_ID = 'vta_ajuste_debe_vta_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'vta_ajuste_debe_vta_tributo.descripcion';
	const GEN_ATTR_VTA_AJUSTE_DEBE_ID = 'vta_ajuste_debe_vta_tributo.vta_ajuste_debe_id';
	const GEN_ATTR_VTA_TRIBUTO_ID = 'vta_ajuste_debe_vta_tributo.vta_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'vta_ajuste_debe_vta_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'vta_ajuste_debe_vta_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'vta_ajuste_debe_vta_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'vta_ajuste_debe_vta_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'vta_ajuste_debe_vta_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_ajuste_debe_vta_tributo.observacion';
	const GEN_ATTR_ORDEN = 'vta_ajuste_debe_vta_tributo.orden';
	const GEN_ATTR_ESTADO = 'vta_ajuste_debe_vta_tributo.estado';
	const GEN_ATTR_CREADO = 'vta_ajuste_debe_vta_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'vta_ajuste_debe_vta_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_ajuste_debe_vta_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_ajuste_debe_vta_tributo.modificado_por';

	/* Constantes de Atributos Min de BVtaAjusteDebeVtaTributo */ 
	...
	/* Atributos de BVtaAjusteDebeVtaTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaAjusteDebeVtaTributo */ 
	...
	/* Setters de BVtaAjusteDebeVtaTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaAjusteDebeVtaTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaAjusteDebeVtaTributo */ 	
	...
	/* Cambia el estado de BVtaAjusteDebeVtaTributo */ 	
	...
	/* Save de BVtaAjusteDebeVtaTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_ajuste_debe_vta_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_ajuste_debe_vta_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".VtaAjusteDebeVtaTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaAjusteDebeVtaTributo */ 	
	...
	public function duplicarVtaAjusteDebeVtaTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaAjusteDebeVtaTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaAjusteDebeVtaTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtaajustedebevtatributo = new VtaAjusteDebeVtaTributo();
                    $vtaajustedebevtatributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtaajustedebevtatributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtaajustedebevtatributo->setVtaAjusteDebeId($fila[self::GEN_ATTR_MIN_VTA_AJUSTE_DEBE_ID]);
			$vtaajustedebevtatributo->setVtaTributoId($fila[self::GEN_ATTR_MIN_VTA_TRIBUTO_ID]);
			$vtaajustedebevtatributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$vtaajustedebevtatributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$vtaajustedebevtatributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$vtaajustedebevtatributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$vtaajustedebevtatributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtaajustedebevtatributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtaajustedebevtatributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtaajustedebevtatributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtaajustedebevtatributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtaajustedebevtatributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtaajustedebevtatributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtaajustedebevtatributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaAjusteDebeVtaTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaAjusteDebeVtaTributos para listado de Backend */ 	
	static function getVtaAjusteDebeVtaTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaAjusteDebeVtaTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeVtaTributos filtrado para select */ 	
	static function getVtaAjusteDebeVtaTributosCmbF($paginador = null, $criterio = null){
            $col = VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos($paginador, $criterio);
	...
	/* Método getVtaAjusteDebeVtaTributos filtrado por una coleccion de objetos foraneos de VtaAjusteDebe */ 	
	static function getVtaAjusteDebeVtaTributosXVtaAjusteDebes($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaTributo::GEN_ATTR_VTA_AJUSTE_DEBE_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaTributo::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaAjusteDebeVtaTributos filtrado por una coleccion de objetos foraneos de VtaTributo */ 	
	static function getVtaAjusteDebeVtaTributosXVtaTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaAjusteDebeVtaTributo::GEN_ATTR_VTA_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaAjusteDebeVtaTributo::GEN_TABLA);
            $c->addOrden(VtaAjusteDebeVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_ajuste_debe_vta_tributo_adm.php';
            $url_gestion = 'vta_ajuste_debe_vta_tributo_gestion.php';
	...
	public function getVtaAjusteHaberVtaAjusteDebeVtaTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(VtaAjusteHaberVtaAjusteDebeVtaTributo::GEN_ATTR_VTA_AJUSTE_DEBE_VTA_TRIBUTO_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getVtaAjusteHaberVtaAjusteDebeVtaTributosCmb(){
            $c = new Criterio();
            $c->add(VtaAjusteHaberVtaAjusteDebeVtaTributo::GEN_ATTR_VTA_AJUSTE_DEBE_VTA_TRIBUTO_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(VtaAjusteHaberVtaAjusteDebeVtaTributo::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener VtaAjusteHabers (Coleccion) relacionados a traves de VtaAjusteHaberVtaAjusteDebeVtaTributo */ 	
	public function getVtaAjusteHabersXVtaAjusteHaberVtaAjusteDebeVtaTributo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(VtaAjusteHaberVtaAjusteDebeVtaTributo::GEN_TABLA, VtaAjusteHaberVtaAjusteDebeVtaTributo::GEN_ATTR_VTA_AJUSTE_HABER_ID, VtaAjusteHaber::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de VtaAjusteHabers relacionados a traves de VtaAjusteHaberVtaAjusteDebeVtaTributo */ 	
	public function getCantidadVtaAjusteHabersXVtaAjusteHaberVtaAjusteDebeVtaTributo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener VtaAjusteHaber (Objeto) relacionado a traves de VtaAjusteHaberVtaAjusteDebeVtaTributo */ 	
	public function getVtaAjusteHaberXVtaAjusteHaberVtaAjusteDebeVtaTributo($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getVtaAjusteHabersXVtaAjusteHaberVtaAjusteDebeVtaTributo($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	/* Metodo que retorna una coleccion de IDs de los VtaAjusteHabers asignados a VtaAjusteDebeVtaTributo */ 	
	...
	/* Método setea nuevos VtaAjusteHabers asignados al VtaAjusteDebeVtaTributo */ 	
	public function setVtaAjusteHaberVtaAjusteDebeVtaTributos($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setVtaAjusteDebeVtaTributoId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion VtaAjusteHaber en el alta de VtaAjusteDebeVtaTributo */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_ajuste_debe_vta_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_ajuste_debe_vta_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaAjusteDebeVtaTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaAjusteDebeVtaTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_ajuste_debe_vta_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaAjusteDebeVtaTributo::GEN_TABLA);
                $c->addOrden(VtaAjusteDebeVtaTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_ajuste_debe_vta_tributos = VtaAjusteDebeVtaTributo::getVtaAjusteDebeVtaTributos(null, $c);

                $arr = array();
                foreach($vta_ajuste_debe_vta_tributos as $vta_ajuste_debe_vta_tributo){
                    $descripcion = $vta_ajuste_debe_vta_tributo->getDescripcion();

...
class BPrvImportacionEstado
{ 
	
	const SES_PAGINACION = 'adm_prvimportacionestado_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_prvimportacionestado_paginas_registros';
	const SES_CRITERIOS = 'adm_prvimportacionestado_criterios';
	
	const GEN_CLASE = 'PrvImportacionEstado';
	const GEN_TABLA = 'prv_importacion_estado';
	...
	/* Constantes de Atributos de BPrvImportacionEstado */ 
	const GEN_ATTR_ID = 'prv_importacion_estado.id';
	const GEN_ATTR_DESCRIPCION = 'prv_importacion_estado.descripcion';
	const GEN_ATTR_PRV_IMPORTACION_ID = 'prv_importacion_estado.prv_importacion_id';
	const GEN_ATTR_PRV_IMPORTACION_TIPO_ESTADO_ID = 'prv_importacion_estado.prv_importacion_tipo_estado_id';
	const GEN_ATTR_INICIAL = 'prv_importacion_estado.inicial';
	const GEN_ATTR_ACTUAL = 'prv_importacion_estado.actual';
	const GEN_ATTR_CODIGO = 'prv_importacion_estado.codigo';
	const GEN_ATTR_OBSERVACION = 'prv_importacion_estado.observacion';
	const GEN_ATTR_ESTADO = 'prv_importacion_estado.estado';
	const GEN_ATTR_ORDEN = 'prv_importacion_estado.orden';
	const GEN_ATTR_CREADO = 'prv_importacion_estado.creado';
	const GEN_ATTR_CREADO_POR = 'prv_importacion_estado.creado_por';
	const GEN_ATTR_MODIFICADO = 'prv_importacion_estado.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'prv_importacion_estado.modificado_por';

	/* Constantes de Atributos Min de BPrvImportacionEstado */ 
	...
	/* Atributos de BPrvImportacionEstado */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPrvImportacionEstado */ 
	...
	/* Setters de BPrvImportacionEstado */ 	
	...
	public static function hidratarObjeto($fila){            
            $o = new PrvImportacionEstado();
            $o->setId($fila[PrvImportacionEstado::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPrvImportacionEstado */ 	
	...
	/* Cambia el estado de BPrvImportacionEstado */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('prv_importacion_estado_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('prv_importacion_estado_seq')";
                ...
                $sql = "
				 ...
				 ".PrvImportacionEstado::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPrvImportacionEstado */ 	
	...
	public function duplicarPrvImportacionEstado(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPrvImportacionEstados($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PrvImportacionEstado::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $prvimportacionestado = new PrvImportacionEstado();
                    $prvimportacionestado->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $prvimportacionestado->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$prvimportacionestado->setPrvImportacionId($fila[self::GEN_ATTR_MIN_PRV_IMPORTACION_ID]);
			$prvimportacionestado->setPrvImportacionTipoEstadoId($fila[self::GEN_ATTR_MIN_PRV_IMPORTACION_TIPO_ESTADO_ID]);
			$prvimportacionestado->setInicial($fila[self::GEN_ATTR_MIN_INICIAL]);
			$prvimportacionestado->setActual($fila[self::GEN_ATTR_MIN_ACTUAL]);
			$prvimportacionestado->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$prvimportacionestado->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$prvimportacionestado->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$prvimportacionestado->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$prvimportacionestado->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$prvimportacionestado->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$prvimportacionestado->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$prvimportacionestado->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPrvImportacionEstadosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PrvImportacionEstado::getPrvImportacionEstados($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPrvImportacionEstados para listado de Backend */ 	
	static function getPrvImportacionEstadosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PrvImportacionEstado::getPrvImportacionEstados($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPrvImportacionEstadosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PrvImportacionEstado::getPrvImportacionEstados($paginador, $criterio);
	...
	/* Método getPrvImportacionEstados filtrado para select */ 	
	static function getPrvImportacionEstadosCmbF($paginador = null, $criterio = null){
            $col = PrvImportacionEstado::getPrvImportacionEstados($paginador, $criterio);
	...
	/* Método getPrvImportacionEstados filtrado por una coleccion de objetos foraneos de PrvImportacion */ 	
	static function getPrvImportacionEstadosXPrvImportacions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrvImportacionEstado::GEN_ATTR_PRV_IMPORTACION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrvImportacionEstado::GEN_TABLA);
            $c->addOrden(PrvImportacionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PrvImportacionEstado::getPrvImportacionEstados($p, $c);
            foreach($os as $o){
	...
	/* Método getPrvImportacionEstados filtrado por una coleccion de objetos foraneos de PrvImportacionTipoEstado */ 	
	static function getPrvImportacionEstadosXPrvImportacionTipoEstados($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrvImportacionEstado::GEN_ATTR_PRV_IMPORTACION_TIPO_ESTADO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrvImportacionEstado::GEN_TABLA);
            $c->addOrden(PrvImportacionEstado::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'prv_importacion_estado_adm.php';
            $url_gestion = 'prv_importacion_estado_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM prv_importacion_estado'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'prv_importacion_estado';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPrvImportacionEstados($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPrvImportacionEstados(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'prv_importacion_estado_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PrvImportacionEstado::GEN_TABLA);
                $c->addOrden(PrvImportacionEstado::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($prv_importacion_estados as $prv_importacion_estado){
                    $descripcion = $prv_importacion_estado->getDescripcion();

...
{ 
	...
	const SES_PAGINACION = 'adm_insmatriz_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_insmatriz_paginas_registros';
	const SES_CRITERIOS = 'adm_insmatriz_criterios';
	
	const GEN_CLASE = 'InsMatriz';
	const GEN_TABLA = 'ins_matriz';
	...
	/* Constantes de Atributos de BInsMatriz */ 
	const GEN_ATTR_ID = 'ins_matriz.id';
	const GEN_ATTR_INS_MARCA_ID = 'ins_matriz.ins_marca_id';
	const GEN_ATTR_CODIGO_PIEZA = 'ins_matriz.codigo_pieza';
	const GEN_ATTR_CODIGO = 'ins_matriz.codigo';
	const GEN_ATTR_DESCRIPCION = 'ins_matriz.descripcion';
	const GEN_ATTR_OBSERVACION = 'ins_matriz.observacion';
	const GEN_ATTR_ORDEN = 'ins_matriz.orden';
	const GEN_ATTR_ESTADO = 'ins_matriz.estado';
	const GEN_ATTR_CREADO = 'ins_matriz.creado';
	const GEN_ATTR_CREADO_POR = 'ins_matriz.creado_por';
	const GEN_ATTR_MODIFICADO = 'ins_matriz.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'ins_matriz.modificado_por';

	/* Constantes de Atributos Min de BInsMatriz */ 
	...
	public static function hidratarObjeto($fila){            
            $o = new InsMatriz();
            $o->setId($fila[InsMatriz::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BInsMatriz */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                ".$this->getInsMarcaId()."
                    ...
                    ) RETURNING currval('ins_matriz_seq')";
...
".self::GEN_ATTR_MIN_INS_MARCA_ID." = ".$this->getInsMarcaId()."
	...
	public function duplicarInsMatriz(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getInsMatrizs($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = InsMatriz::setAplicarFiltrosDeAlcance($criterio);
		...
		$insmatrizs = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $insmatriz = new InsMatriz();
                    $insmatriz->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $insmatriz->setInsMarcaId($fila[self::GEN_ATTR_MIN_INS_MARCA_ID]);
			$insmatriz->setCodigoPieza($fila[self::GEN_ATTR_MIN_CODIGO_PIEZA]);
			$insmatriz->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$insmatriz->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$insmatriz->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$insmatriz->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$insmatriz->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$insmatriz->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$insmatriz->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$insmatriz->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$insmatriz->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getInsMatrizsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return InsMatriz::getInsMatrizs($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getInsMatrizs para listado de Backend */ 	
	static function getInsMatrizsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return InsMatriz::getInsMatrizs($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getInsMatrizsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = InsMatriz::getInsMatrizs($paginador, $criterio);
	...
	/* Método getInsMatrizs filtrado para select */ 	
	static function getInsMatrizsCmbF($paginador = null, $criterio = null){
            $col = InsMatriz::getInsMatrizs($paginador, $criterio);
	...
	/* Método getInsMatrizs filtrado por una coleccion de objetos foraneos de InsMarca */ 	
	static function getInsMatrizsXInsMarcas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(InsMatriz::GEN_ATTR_INS_MARCA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(InsMatriz::GEN_TABLA);
            $c->addOrden(InsMatriz::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = InsMatriz::getInsMatrizs($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'ins_matriz_adm.php';
            $url_gestion = 'ins_matriz_gestion.php';
	...
	public function getInsInsumos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(InsInsumo::GEN_ATTR_INS_MATRIZ_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getInsInsumosCmb(){
            $c = new Criterio();
            $c->add(InsInsumo::GEN_ATTR_INS_MATRIZ_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(InsInsumo::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPrvInsumos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PrvInsumo::GEN_ATTR_INS_MATRIZ_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPrvInsumosCmb(){
            $c = new Criterio();
            $c->add(PrvInsumo::GEN_ATTR_INS_MATRIZ_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PrvInsumo::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM ins_matriz'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'ins_matriz';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getInsMatrizs($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getInsMatrizs(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'ins_matriz_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(InsMatriz::GEN_TABLA);
                $c->addOrden(InsMatriz::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();
                ...
                foreach($ins_matrizs as $ins_matriz){
                    $descripcion = $ins_matriz->getDescripcion();

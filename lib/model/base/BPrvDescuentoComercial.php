...
class BPrvDescuentoComercial
{ 
	
	const SES_PAGINACION = 'adm_prvdescuentocomercial_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_prvdescuentocomercial_paginas_registros';
	const SES_CRITERIOS = 'adm_prvdescuentocomercial_criterios';
	
	const GEN_CLASE = 'PrvDescuentoComercial';
	const GEN_TABLA = 'prv_descuento_comercial';
	...
	/* Constantes de Atributos de BPrvDescuentoComercial */ 
	const GEN_ATTR_ID = 'prv_descuento_comercial.id';
	const GEN_ATTR_DESCRIPCION = 'prv_descuento_comercial.descripcion';
	const GEN_ATTR_PRV_PROVEEDOR_ID = 'prv_descuento_comercial.prv_proveedor_id';
	const GEN_ATTR_CODIGO = 'prv_descuento_comercial.codigo';
	const GEN_ATTR_PORCENTAJE_DESCUENTO = 'prv_descuento_comercial.porcentaje_descuento';
	const GEN_ATTR_OBSERVACION = 'prv_descuento_comercial.observacion';
	const GEN_ATTR_ORDEN = 'prv_descuento_comercial.orden';
	const GEN_ATTR_ESTADO = 'prv_descuento_comercial.estado';
	const GEN_ATTR_CREADO = 'prv_descuento_comercial.creado';
	const GEN_ATTR_CREADO_POR = 'prv_descuento_comercial.creado_por';
	const GEN_ATTR_MODIFICADO = 'prv_descuento_comercial.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'prv_descuento_comercial.modificado_por';

	/* Constantes de Atributos Min de BPrvDescuentoComercial */ 
	...
	/* Atributos de BPrvDescuentoComercial */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPrvDescuentoComercial */ 
	...
	/* Setters de BPrvDescuentoComercial */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PrvDescuentoComercial::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPrvDescuentoComercial */ 	
	...
	/* Cambia el estado de BPrvDescuentoComercial */ 	
	...
	/* Save de BPrvDescuentoComercial */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('prv_descuento_comercial_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('prv_descuento_comercial_seq')";
                ...
                $sql = "
				 ...
				 ".PrvDescuentoComercial::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPrvDescuentoComercial */ 	
	...
	public function duplicarPrvDescuentoComercial(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPrvDescuentoComercials($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PrvDescuentoComercial::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $prvdescuentocomercial = new PrvDescuentoComercial();
                    $prvdescuentocomercial->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $prvdescuentocomercial->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$prvdescuentocomercial->setPrvProveedorId($fila[self::GEN_ATTR_MIN_PRV_PROVEEDOR_ID]);
			$prvdescuentocomercial->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$prvdescuentocomercial->setPorcentajeDescuento($fila[self::GEN_ATTR_MIN_PORCENTAJE_DESCUENTO]);
			$prvdescuentocomercial->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$prvdescuentocomercial->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$prvdescuentocomercial->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$prvdescuentocomercial->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$prvdescuentocomercial->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$prvdescuentocomercial->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$prvdescuentocomercial->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPrvDescuentoComercialsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PrvDescuentoComercial::getPrvDescuentoComercials($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPrvDescuentoComercials para listado de Backend */ 	
	static function getPrvDescuentoComercialsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PrvDescuentoComercial::getPrvDescuentoComercials($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPrvDescuentoComercialsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PrvDescuentoComercial::getPrvDescuentoComercials($paginador, $criterio);
	...
	/* Método getPrvDescuentoComercials filtrado para select */ 	
	static function getPrvDescuentoComercialsCmbF($paginador = null, $criterio = null){
            $col = PrvDescuentoComercial::getPrvDescuentoComercials($paginador, $criterio);
	...
	/* Método getPrvDescuentoComercials filtrado por una coleccion de objetos foraneos de PrvProveedor */ 	
	static function getPrvDescuentoComercialsXPrvProveedors($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PrvDescuentoComercial::GEN_ATTR_PRV_PROVEEDOR_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PrvDescuentoComercial::GEN_TABLA);
            $c->addOrden(PrvDescuentoComercial::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PrvDescuentoComercial::getPrvDescuentoComercials($p, $c);
            foreach($os as $o){
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'prv_descuento_comercial_adm.php';
            $url_gestion = 'prv_descuento_comercial_gestion.php';
	...
	public function getPdeOcAgrupacionItems($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeOcAgrupacionItem::GEN_ATTR_PRV_DESCUENTO_COMERCIAL_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeOcAgrupacionItemsCmb(){
            $c = new Criterio();
            $c->add(PdeOcAgrupacionItem::GEN_ATTR_PRV_DESCUENTO_COMERCIAL_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOcAgrupacionItem::GEN_TABLA);
            $c->setCriterios();
	...
	public function getPdeOcs($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeOc::GEN_ATTR_PRV_DESCUENTO_COMERCIAL_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeOcsCmb(){
            $c = new Criterio();
            $c->add(PdeOc::GEN_ATTR_PRV_DESCUENTO_COMERCIAL_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeOc::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM prv_descuento_comercial'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'prv_descuento_comercial';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPrvDescuentoComercials($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPrvDescuentoComercials(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'prv_descuento_comercial_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PrvDescuentoComercial::GEN_TABLA);
                $c->addOrden(PrvDescuentoComercial::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $prv_descuento_comercials = PrvDescuentoComercial::getPrvDescuentoComercials(null, $c);

                $arr = array();
                foreach($prv_descuento_comercials as $prv_descuento_comercial){
                    $descripcion = $prv_descuento_comercial->getDescripcion();

...
class BPdeFacturaPdeRecepcion
{ 
	
	const SES_PAGINACION = 'adm_pdefacturapderecepcion_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdefacturapderecepcion_paginas_registros';
	const SES_CRITERIOS = 'adm_pdefacturapderecepcion_criterios';
	
	const GEN_CLASE = 'PdeFacturaPdeRecepcion';
	const GEN_TABLA = 'pde_factura_pde_recepcion';
	...
	/* Constantes de Atributos de BPdeFacturaPdeRecepcion */ 
	const GEN_ATTR_ID = 'pde_factura_pde_recepcion.id';
	const GEN_ATTR_DESCRIPCION = 'pde_factura_pde_recepcion.descripcion';
	const GEN_ATTR_PDE_FACTURA_ID = 'pde_factura_pde_recepcion.pde_factura_id';
	const GEN_ATTR_PDE_RECEPCION_ID = 'pde_factura_pde_recepcion.pde_recepcion_id';
	const GEN_ATTR_INS_INSUMO_ID = 'pde_factura_pde_recepcion.ins_insumo_id';
	const GEN_ATTR_INS_UNIDAD_MEDIDA_ID = 'pde_factura_pde_recepcion.ins_unidad_medida_id';
	const GEN_ATTR_GRAL_TIPO_IVA_ID = 'pde_factura_pde_recepcion.gral_tipo_iva_id';
	const GEN_ATTR_IMPORTE_UNITARIO = 'pde_factura_pde_recepcion.importe_unitario';
	const GEN_ATTR_CANTIDAD = 'pde_factura_pde_recepcion.cantidad';
	const GEN_ATTR_INS_INSUMO_COSTO_ID = 'pde_factura_pde_recepcion.ins_insumo_costo_id';
	const GEN_ATTR_IMPORTE_COSTO = 'pde_factura_pde_recepcion.importe_costo';
	const GEN_ATTR_CODIGO = 'pde_factura_pde_recepcion.codigo';
	const GEN_ATTR_OBSERVACION = 'pde_factura_pde_recepcion.observacion';
	const GEN_ATTR_ORDEN = 'pde_factura_pde_recepcion.orden';
	const GEN_ATTR_ESTADO = 'pde_factura_pde_recepcion.estado';
	const GEN_ATTR_CREADO = 'pde_factura_pde_recepcion.creado';
	const GEN_ATTR_CREADO_POR = 'pde_factura_pde_recepcion.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_factura_pde_recepcion.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_factura_pde_recepcion.modificado_por';

	/* Constantes de Atributos Min de BPdeFacturaPdeRecepcion */ 
	...
	/* Atributos de BPdeFacturaPdeRecepcion */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BPdeFacturaPdeRecepcion */ 
	...
	/* Setters de BPdeFacturaPdeRecepcion */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeFacturaPdeRecepcion::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BPdeFacturaPdeRecepcion */ 	
	...
	/* Cambia el estado de BPdeFacturaPdeRecepcion */ 	
	...
	/* Save de BPdeFacturaPdeRecepcion */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('pde_factura_pde_recepcion_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_factura_pde_recepcion_seq')";
                ...
                $sql = "
				 ...
				 ".PdeFacturaPdeRecepcion::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BPdeFacturaPdeRecepcion */ 	
	...
	public function duplicarPdeFacturaPdeRecepcion(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeFacturaPdeRecepcions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeFacturaPdeRecepcion::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdefacturapderecepcion = new PdeFacturaPdeRecepcion();
                    $pdefacturapderecepcion->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdefacturapderecepcion->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdefacturapderecepcion->setPdeFacturaId($fila[self::GEN_ATTR_MIN_PDE_FACTURA_ID]);
			$pdefacturapderecepcion->setPdeRecepcionId($fila[self::GEN_ATTR_MIN_PDE_RECEPCION_ID]);
			$pdefacturapderecepcion->setInsInsumoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_ID]);
			$pdefacturapderecepcion->setInsUnidadMedidaId($fila[self::GEN_ATTR_MIN_INS_UNIDAD_MEDIDA_ID]);
			$pdefacturapderecepcion->setGralTipoIvaId($fila[self::GEN_ATTR_MIN_GRAL_TIPO_IVA_ID]);
			$pdefacturapderecepcion->setImporteUnitario($fila[self::GEN_ATTR_MIN_IMPORTE_UNITARIO]);
			$pdefacturapderecepcion->setCantidad($fila[self::GEN_ATTR_MIN_CANTIDAD]);
			$pdefacturapderecepcion->setInsInsumoCostoId($fila[self::GEN_ATTR_MIN_INS_INSUMO_COSTO_ID]);
			$pdefacturapderecepcion->setImporteCosto($fila[self::GEN_ATTR_MIN_IMPORTE_COSTO]);
			$pdefacturapderecepcion->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdefacturapderecepcion->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdefacturapderecepcion->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdefacturapderecepcion->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdefacturapderecepcion->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdefacturapderecepcion->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdefacturapderecepcion->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdefacturapderecepcion->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getPdeFacturaPdeRecepcionsHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeFacturaPdeRecepcions para listado de Backend */ 	
	static function getPdeFacturaPdeRecepcionsDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeFacturaPdeRecepcionsCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions($paginador, $criterio);
	...
	/* Método getPdeFacturaPdeRecepcions filtrado para select */ 	
	static function getPdeFacturaPdeRecepcionsCmbF($paginador = null, $criterio = null){
            $col = PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions($paginador, $criterio);
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de PdeFactura */ 	
	static function getPdeFacturaPdeRecepcionsXPdeFacturas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_PDE_FACTURA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions($p, $c);
            foreach($os as $o){
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de PdeRecepcion */ 	
	static function getPdeFacturaPdeRecepcionsXPdeRecepcions($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_PDE_RECEPCION_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de InsInsumo */ 	
	static function getPdeFacturaPdeRecepcionsXInsInsumos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_INS_INSUMO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de InsUnidadMedida */ 	
	static function getPdeFacturaPdeRecepcionsXInsUnidadMedidas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_INS_UNIDAD_MEDIDA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de GralTipoIva */ 	
	static function getPdeFacturaPdeRecepcionsXGralTipoIvas($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_GRAL_TIPO_IVA_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	/* Método getPdeFacturaPdeRecepcions filtrado por una coleccion de objetos foraneos de InsInsumoCosto */ 	
	static function getPdeFacturaPdeRecepcionsXInsInsumoCostos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(PdeFacturaPdeRecepcion::GEN_ATTR_INS_INSUMO_COSTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
            $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_factura_pde_recepcion_adm.php';
            $url_gestion = 'pde_factura_pde_recepcion_gestion.php';
	...
	public function getPdeNotaCreditoPdeFacturaPdeRecepcions($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeNotaCreditoPdeFacturaPdeRecepcion::GEN_ATTR_PDE_FACTURA_PDE_RECEPCION_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeNotaCreditoPdeFacturaPdeRecepcionsCmb(){
            $c = new Criterio();
            $c->add(PdeNotaCreditoPdeFacturaPdeRecepcion::GEN_ATTR_PDE_FACTURA_PDE_RECEPCION_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeNotaCreditoPdeFacturaPdeRecepcion::GEN_TABLA);
            $c->setCriterios();
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_factura_pde_recepcion'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_factura_pde_recepcion';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeFacturaPdeRecepcions($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeFacturaPdeRecepcions(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_factura_pde_recepcion_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(PdeFacturaPdeRecepcion::GEN_TABLA);
                $c->addOrden(PdeFacturaPdeRecepcion::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_factura_pde_recepcions = PdeFacturaPdeRecepcion::getPdeFacturaPdeRecepcions(null, $c);

                $arr = array();
                foreach($pde_factura_pde_recepcions as $pde_factura_pde_recepcion){
                    $descripcion = $pde_factura_pde_recepcion->getDescripcion();

...
class BVtaNotaDebitoVtaTributo
{ 
	
	const SES_PAGINACION = 'adm_vtanotadebitovtatributo_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_vtanotadebitovtatributo_paginas_registros';
	const SES_CRITERIOS = 'adm_vtanotadebitovtatributo_criterios';
	
	const GEN_CLASE = 'VtaNotaDebitoVtaTributo';
	const GEN_TABLA = 'vta_nota_debito_vta_tributo';
	...
	/* Constantes de Atributos de BVtaNotaDebitoVtaTributo */ 
	const GEN_ATTR_ID = 'vta_nota_debito_vta_tributo.id';
	const GEN_ATTR_DESCRIPCION = 'vta_nota_debito_vta_tributo.descripcion';
	const GEN_ATTR_VTA_NOTA_DEBITO_ID = 'vta_nota_debito_vta_tributo.vta_nota_debito_id';
	const GEN_ATTR_VTA_TRIBUTO_ID = 'vta_nota_debito_vta_tributo.vta_tributo_id';
	const GEN_ATTR_IMPORTE_IMPONIBLE = 'vta_nota_debito_vta_tributo.importe_imponible';
	const GEN_ATTR_IMPORTE_TRIBUTO = 'vta_nota_debito_vta_tributo.importe_tributo';
	const GEN_ATTR_ALICUOTA_PORCENTUAL = 'vta_nota_debito_vta_tributo.alicuota_porcentual';
	const GEN_ATTR_ALICUOTA_DECIMAL = 'vta_nota_debito_vta_tributo.alicuota_decimal';
	const GEN_ATTR_CODIGO = 'vta_nota_debito_vta_tributo.codigo';
	const GEN_ATTR_OBSERVACION = 'vta_nota_debito_vta_tributo.observacion';
	const GEN_ATTR_ORDEN = 'vta_nota_debito_vta_tributo.orden';
	const GEN_ATTR_ESTADO = 'vta_nota_debito_vta_tributo.estado';
	const GEN_ATTR_CREADO = 'vta_nota_debito_vta_tributo.creado';
	const GEN_ATTR_CREADO_POR = 'vta_nota_debito_vta_tributo.creado_por';
	const GEN_ATTR_MODIFICADO = 'vta_nota_debito_vta_tributo.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'vta_nota_debito_vta_tributo.modificado_por';

	/* Constantes de Atributos Min de BVtaNotaDebitoVtaTributo */ 
	...
	/* Atributos de BVtaNotaDebitoVtaTributo */ 
	private $id;
	private $descripcion;
	...
	/* Getters de BVtaNotaDebitoVtaTributo */ 
	...
	/* Setters de BVtaNotaDebitoVtaTributo */ 	
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[VtaNotaDebitoVtaTributo::GEN_ATTR_MIN_ID], false);
	...
	/* Control de BVtaNotaDebitoVtaTributo */ 	
	...
	/* Cambia el estado de BVtaNotaDebitoVtaTributo */ 	
	...
	/* Save de BVtaNotaDebitoVtaTributo */ 	
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                nextval('vta_nota_debito_vta_tributo_seq'), 
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('vta_nota_debito_vta_tributo_seq')";
                ...
                $sql = "
				 ...
				 ".VtaNotaDebitoVtaTributo::GEN_TABLA."
				 SET 
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	/* Delete de BVtaNotaDebitoVtaTributo */ 	
	...
	public function duplicarVtaNotaDebitoVtaTributo(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getVtaNotaDebitoVtaTributos($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = VtaNotaDebitoVtaTributo::setAplicarFiltrosDeAlcance($criterio);
		...
		while($fila = pg_fetch_array($cons->getResultado())){
                    $vtanotadebitovtatributo = new VtaNotaDebitoVtaTributo();
                    $vtanotadebitovtatributo->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $vtanotadebitovtatributo->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$vtanotadebitovtatributo->setVtaNotaDebitoId($fila[self::GEN_ATTR_MIN_VTA_NOTA_DEBITO_ID]);
			$vtanotadebitovtatributo->setVtaTributoId($fila[self::GEN_ATTR_MIN_VTA_TRIBUTO_ID]);
			$vtanotadebitovtatributo->setImporteImponible($fila[self::GEN_ATTR_MIN_IMPORTE_IMPONIBLE]);
			$vtanotadebitovtatributo->setImporteTributo($fila[self::GEN_ATTR_MIN_IMPORTE_TRIBUTO]);
			$vtanotadebitovtatributo->setAlicuotaPorcentual($fila[self::GEN_ATTR_MIN_ALICUOTA_PORCENTUAL]);
			$vtanotadebitovtatributo->setAlicuotaDecimal($fila[self::GEN_ATTR_MIN_ALICUOTA_DECIMAL]);
			$vtanotadebitovtatributo->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$vtanotadebitovtatributo->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$vtanotadebitovtatributo->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$vtanotadebitovtatributo->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$vtanotadebitovtatributo->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$vtanotadebitovtatributo->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$vtanotadebitovtatributo->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$vtanotadebitovtatributo->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
	...
	static function getVtaNotaDebitoVtaTributosHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getVtaNotaDebitoVtaTributos para listado de Backend */ 	
	static function getVtaNotaDebitoVtaTributosDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getVtaNotaDebitoVtaTributosCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos($paginador, $criterio);
	...
	/* Método getVtaNotaDebitoVtaTributos filtrado para select */ 	
	static function getVtaNotaDebitoVtaTributosCmbF($paginador = null, $criterio = null){
            $col = VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos($paginador, $criterio);
	...
	/* Método getVtaNotaDebitoVtaTributos filtrado por una coleccion de objetos foraneos de VtaNotaDebito */ 	
	static function getVtaNotaDebitoVtaTributosXVtaNotaDebitos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaNotaDebitoVtaTributo::GEN_ATTR_VTA_NOTA_DEBITO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaNotaDebitoVtaTributo::GEN_TABLA);
            $c->addOrden(VtaNotaDebitoVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();

            $p = null;

            $os = VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos($p, $c);
            foreach($os as $o){
	...
	/* Método getVtaNotaDebitoVtaTributos filtrado por una coleccion de objetos foraneos de VtaTributo */ 	
	static function getVtaNotaDebitoVtaTributosXVtaTributos($os_foraneas){
            $os_con_indice = array();
            $arr_ids = array();
            ...
            $c= new Criterio();
            $c->add(VtaNotaDebitoVtaTributo::GEN_ATTR_VTA_TRIBUTO_ID, $arr_ids, Criterio::IN_ARRAY);
            $c->addTabla(VtaNotaDebitoVtaTributo::GEN_TABLA);
            $c->addOrden(VtaNotaDebitoVtaTributo::GEN_ATTR_ID, Criterio::_ASC);
            $c->setCriterios();
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'vta_nota_debito_vta_tributo_adm.php';
            $url_gestion = 'vta_nota_debito_vta_tributo_gestion.php';
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM vta_nota_debito_vta_tributo'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'vta_nota_debito_vta_tributo';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getVtaNotaDebitoVtaTributos($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getVtaNotaDebitoVtaTributos(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'vta_nota_debito_vta_tributo_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                $c = new Criterio();
                $c->addTabla(VtaNotaDebitoVtaTributo::GEN_TABLA);
                $c->addOrden(VtaNotaDebitoVtaTributo::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $vta_nota_debito_vta_tributos = VtaNotaDebitoVtaTributo::getVtaNotaDebitoVtaTributos(null, $c);

                $arr = array();
                foreach($vta_nota_debito_vta_tributos as $vta_nota_debito_vta_tributo){
                    $descripcion = $vta_nota_debito_vta_tributo->getDescripcion();

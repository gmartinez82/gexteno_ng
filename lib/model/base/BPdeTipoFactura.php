...
class BPdeTipoFactura
{ 
	
	const SES_PAGINACION = 'adm_pdetipofactura_paginas';
	const SES_PAGINACION_REGISTROS = 'adm_pdetipofactura_paginas_registros';
	const SES_CRITERIOS = 'adm_pdetipofactura_criterios';
	
	const GEN_CLASE = 'PdeTipoFactura';
	const GEN_TABLA = 'pde_tipo_factura';
	...
	/* Constantes de Atributos de BPdeTipoFactura */ 
	const GEN_ATTR_ID = 'pde_tipo_factura.id';
	const GEN_ATTR_DESCRIPCION = 'pde_tipo_factura.descripcion';
	const GEN_ATTR_CODIGO = 'pde_tipo_factura.codigo';
	const GEN_ATTR_CODIGO_MIN = 'pde_tipo_factura.codigo_min';
	const GEN_ATTR_INFORMA = 'pde_tipo_factura.informa';
	const GEN_ATTR_OBSERVACION = 'pde_tipo_factura.observacion';
	const GEN_ATTR_ORDEN = 'pde_tipo_factura.orden';
	const GEN_ATTR_ESTADO = 'pde_tipo_factura.estado';
	const GEN_ATTR_CREADO = 'pde_tipo_factura.creado';
	const GEN_ATTR_CREADO_POR = 'pde_tipo_factura.creado_por';
	const GEN_ATTR_MODIFICADO = 'pde_tipo_factura.modificado';
	const GEN_ATTR_MODIFICADO_POR = 'pde_tipo_factura.modificado_por';

	/* Constantes de Atributos Min de BPdeTipoFactura */ 
	...
	public static function hidratarObjeto($fila){            
            ...
            $o->setId($fila[PdeTipoFactura::GEN_ATTR_MIN_ID], false);
	...
	/* Cambia el estado de BPdeTipoFactura */ 	
	...
	public function save($array_datos_auditoria = false){
            ...
            if(!isset($this->id)){
                ...
                '".$this->getDescripcion()."'
                    ...
                    ) RETURNING currval('pde_tipo_factura_seq')";
...
".self::GEN_ATTR_MIN_DESCRIPCION." = '".$this->getDescripcion()."'
	...
	public function duplicarPdeTipoFactura(){
            // duplicar el elemento
            
	}

	/* Metodo que retorna la coleccion principal de la clase */ 	
	static function getPdeTipoFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
		...
		if(is_null($criterio)){
                    ...
                    $criterio = PdeTipoFactura::setAplicarFiltrosDeAlcance($criterio);
		...
		$pdetipofacturas = array();
		while($fila = pg_fetch_array($cons->getResultado())){
                    $pdetipofactura = new PdeTipoFactura();
                    $pdetipofactura->setId($fila[self::GEN_ATTR_MIN_ID], false);


                    $pdetipofactura->setDescripcion($fila[self::GEN_ATTR_MIN_DESCRIPCION]);
			$pdetipofactura->setCodigo($fila[self::GEN_ATTR_MIN_CODIGO]);
			$pdetipofactura->setCodigoMin($fila[self::GEN_ATTR_MIN_CODIGO_MIN]);
			$pdetipofactura->setInforma($fila[self::GEN_ATTR_MIN_INFORMA]);
			$pdetipofactura->setObservacion($fila[self::GEN_ATTR_MIN_OBSERVACION]);
			$pdetipofactura->setOrden($fila[self::GEN_ATTR_MIN_ORDEN]);
			$pdetipofactura->setEstado($fila[self::GEN_ATTR_MIN_ESTADO]);
			$pdetipofactura->setCreado($fila[self::GEN_ATTR_MIN_CREADO]);
			$pdetipofactura->setCreadoPor($fila[self::GEN_ATTR_MIN_CREADO_POR]);
			$pdetipofactura->setModificado($fila[self::GEN_ATTR_MIN_MODIFICADO]);
			$pdetipofactura->setModificadoPor($fila[self::GEN_ATTR_MIN_MODIFICADO_POR]);
				

                    $pdetipofacturas[] = $pdetipofactura;
		}
		
		return $pdetipofacturas;
	}	
	

	/* Método getPdeTipoFacturas Habilitados */ 	
	static function getPdeTipoFacturasHabilitados($paginador = null, $criterio = null, $arr_ordens = false){
            return PdeTipoFactura::getPdeTipoFacturas($paginador, $criterio, true, $arr_ordens);
	}

	/* Método getPdeTipoFacturas para listado de Backend */ 	
	static function getPdeTipoFacturasDesdeBackend($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            return PdeTipoFactura::getPdeTipoFacturas($paginador, $criterio, $estado, $arr_ordens);
	}

	/* Método coleccion principal de la clase para select */ 	
	static function getPdeTipoFacturasCmb($estado = true){
            $paginador = new Paginador(self::getCantidadTotalDeRegistros(), 1);
            ...
            $col = PdeTipoFactura::getPdeTipoFacturas($paginador, $criterio);
	...
	/* Método getPdeTipoFacturas filtrado para select */ 	
	static function getPdeTipoFacturasCmbF($paginador = null, $criterio = null){
            $col = PdeTipoFactura::getPdeTipoFacturas($paginador, $criterio);
	...
	static function getInfoBtnVolver($indice = false){
            $url = 'pde_tipo_factura_adm.php';
            $url_gestion = 'pde_tipo_factura_gestion.php';
	...
	public function getGralCondicionIvaPdeTipoFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(GralCondicionIvaPdeTipoFactura::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getGralCondicionIvaPdeTipoFacturasCmb(){
            $c = new Criterio();
            $c->add(GralCondicionIvaPdeTipoFactura::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(GralCondicionIvaPdeTipoFactura::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener GralCondicionIvas (Coleccion) relacionados a traves de GralCondicionIvaPdeTipoFactura */ 	
	public function getGralCondicionIvasXGralCondicionIvaPdeTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(GralCondicionIvaPdeTipoFactura::GEN_TABLA, GralCondicionIvaPdeTipoFactura::GEN_ATTR_GRAL_CONDICION_IVA_ID, GralCondicionIva::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de GralCondicionIvas relacionados a traves de GralCondicionIvaPdeTipoFactura */ 	
	public function getCantidadGralCondicionIvasXGralCondicionIvaPdeTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener GralCondicionIva (Objeto) relacionado a traves de GralCondicionIvaPdeTipoFactura */ 	
	public function getGralCondicionIvaXGralCondicionIvaPdeTipoFactura($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getGralCondicionIvasXGralCondicionIvaPdeTipoFactura($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPdeTipoFacturaWsFeParamTipoComprobantes($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeTipoFacturaWsFeParamTipoComprobantesCmb(){
            $c = new Criterio();
            $c->add(PdeTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeTipoFacturaWsFeParamTipoComprobante::GEN_TABLA);
            $c->setCriterios();
	...
	/* Getter para obtener WsFeParamTipoComprobantes (Coleccion) relacionados a traves de PdeTipoFacturaWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobantesXPdeTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
            if($estado){
            ...
            $c->addRealJoin(PdeTipoFacturaWsFeParamTipoComprobante::GEN_TABLA, PdeTipoFacturaWsFeParamTipoComprobante::GEN_ATTR_WS_FE_PARAM_TIPO_COMPROBANTE_ID, WsFeParamTipoComprobante::GEN_ATTR_ID);
            $c->addOrden(2);
            $c->setCriterios();
	...
	/* Getter para obtener la cantidad de WsFeParamTipoComprobantes relacionados a traves de PdeTipoFacturaWsFeParamTipoComprobante */ 	
	public function getCantidadWsFeParamTipoComprobantesXPdeTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $c = new Criterio();
	...
	/* Getter para obtener WsFeParamTipoComprobante (Objeto) relacionado a traves de PdeTipoFacturaWsFeParamTipoComprobante */ 	
	public function getWsFeParamTipoComprobanteXPdeTipoFacturaWsFeParamTipoComprobante($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            $os = $this->getWsFeParamTipoComprobantesXPdeTipoFacturaWsFeParamTipoComprobante($paginador, $criterio, $estado, $arr_ordens);
            foreach($os as $o){
                return $o;
            }
	...
	public function getPdeFacturas($paginador = null, $criterio = null, $estado = null, $arr_ordens = false){
            ...
            $criterio->add(PdeFactura::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            if(!is_null($estado)){
                if($estado){
	...
	public function getPdeFacturasCmb(){
            $c = new Criterio();
            $c->add(PdeFactura::GEN_ATTR_PDE_TIPO_FACTURA_ID, $this->getId(), Criterio::IGUAL);
            $c->addTabla(PdeFactura::GEN_TABLA);
            $c->setCriterios();
	...
	/* Metodo que retorna una coleccion de IDs de los GralCondicionIvas asignados a PdeTipoFactura */ 	
	...
	/* Método setea nuevos GralCondicionIvas asignados al PdeTipoFactura */ 	
	public function setGralCondicionIvaPdeTipoFacturas($ids){
            ...
            if($ids){
                foreach($ids as $id => $v){
                    ...
                    $o->setPdeTipoFacturaId($this->getId());
                    $o->save();
                }
            }
            return true;
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion GralCondicionIva en el alta de PdeTipoFactura */ 	
	public function getAltaMostrarBloqueRelacionGralCondicionIvaPdeTipoFactura(){
            return true;
	}
	

	/* Metodo que retorna una coleccion de IDs de los WsFeParamTipoComprobantes asignados a PdeTipoFactura */ 	
	...
	/* Método setea nuevos WsFeParamTipoComprobantes asignados al PdeTipoFactura */ 	
	...
	/* Método que indica si debe mostrarse o no el bloque de relacion WsFeParamTipoComprobante en el alta de PdeTipoFactura */ 	
    ...
    static function getCantidadTotalDeRegistros(){
            ...
            //$cons->setSQL('SELECT count(id) cantidad FROM pde_tipo_factura'); // modificado por reltuples
            $cons->setSQL("SELECT reltuples AS cantidad FROM pg_class WHERE relname = 'pde_tipo_factura';");
	...
	static function getOxId($valor){
            ...
            $obs = self::getPdeTipoFacturas($paginador, $criterio);
            foreach($obs as $o){
                    return $o;
            }
            return false;
	...
	static function getOsxId($valor){
            ...
            $obs = self::getPdeTipoFacturas(null, $criterio);
            return $obs;
	}
	...
	*/
	...
	static function getFiltrosArrGral($archivo = ''){
            if(trim($archivo) == ''){
                $arr = array('clase' => self::GEN_CLASE, 'tabla' => self::GEN_TABLA, 'archivo' => 'pde_tipo_factura_adm');
            }else{
	...
	public function getModificadoDiferenciaDiasDescripcion(){
            ...
            static function getArrDescripcionsUnificado(){
                ...
                $c->addOrden(PdeTipoFactura::GEN_ATTR_DESCRIPCION, Criterio::_ASC);
                $c->setCriterios();

                $pde_tipo_facturas = PdeTipoFactura::getPdeTipoFacturas(null, $c);

                $arr = array();
                foreach($pde_tipo_facturas as $pde_tipo_factura){
                    $descripcion = $pde_tipo_factura->getDescripcion();

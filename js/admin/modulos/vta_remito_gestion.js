...
function setVtaOrdenVentaBtnGenerarRemito() {
    ...
    $.ajax({
        ...
        data: form.serialize() + '&cli_cliente_id=' + cli_cliente_id + '&cli_centro_recepcion_id=' + cli_centro_recepcion_id + '&en_domicilio=' + en_domicilio + '&txa_nota_interna=' + txa_nota_interna,
        dataType: "json",
        beforeSend: function (objeto) {

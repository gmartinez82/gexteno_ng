...
$vta_comisionista_id = Gral::getVars(2, 'id');
$vta_comisionista = VtaComisionista::getOxId($vta_comisionista_id);
?>
<div class="masinfo-datos">

	<div class="par ">
		<div class="label"><?php Lang::_lang('Observaciones') ?></div>
		<div class="dato"><?php Gral::_echo(nl2br($vta_comisionista->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_COMISIONISTA_AUDITOR')){ ?>
	<div class="par inline">
		<div class="label"><?php Lang::_lang('Creado') ?></div>
		<div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_comisionista->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_comisionista->getCreadoPorDescripcion()) ?></strong></i></div>
	</div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_COMISIONISTA_AUDITOR')){ ?>
	<div class="par inline">
		...
		<div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_comisionista->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_comisionista->getModificadoPorDescripcion()) ?></strong></i></div>
	</div>		
<?php } ?>
...
<div class="tabs">
	<ul>
		<?php if(UsCredencial::getEsAcreditado('VTA_COMISIONISTA_MASINFO_VTA_PRESUPUESTO')){ ?>
	...
	<div id="tab_vta_presupuesto" class="bloque-relacion vta_presupuesto">
            ...
            <h4><?php Lang::_lang('VtaPresupuesto') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('VtaComisionista') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($vta_comisionista->getVtaPresupuestosParaBloqueMasInfo() as $vta_presupuesto){ ?>
                    <div class="uno">
...
<div class="acciones">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('VTA_COMISIONISTA_MASINFO_VTA_PRESUPUESTO_BOTONERA')){ ?>
                    <div class="botonera">
            ...
            <?php if($vta_presupuesto){ ?>
                ...
                <?php Lang::_lang('Ver VtaPresupuestos de ') ?> <strong><?php echo($vta_comisionista->getDescripcion()) ?></strong>
                </a>				
                            </div>
            <?php } ?>
                            <div class="boton">

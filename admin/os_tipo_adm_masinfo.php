...
<div class="masinfo-datos">
	...
	<div class="par ">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($os_tipo->getPlantilla())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($os_tipo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'OS_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($os_tipo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($os_tipo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'OS_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($os_tipo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($os_tipo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('OS_TIPO_MASINFO_OS_ORDEN_SERVICIO')){ ?>
	...
	<div id="tab_os_orden_servicio" class="bloque-relacion os_orden_servicio">
            ...
            <h4><?php Lang::_lang('OsOrdenServicio') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('OsTipo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($os_tipo->getOsOrdenServiciosParaBloqueMasInfo() as $os_orden_servicio){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('OS_TIPO_MASINFO_OS_ORDEN_SERVICIO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($os_orden_servicio){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver OsOrdenServicios de ') ?> <strong><?php echo($os_tipo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
if(Gral::esPost()){
    ...
    $gral_centro_costo_gral_sucursal = GralCentroCostoGralSucursal::getOxId($hdn_id);
    if(!$gral_centro_costo_gral_sucursal){
        $gral_centro_costo_gral_sucursal = new GralCentroCostoGralSucursal();
    }else{
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        if($gral_centro_costo_gral_sucursal){
            if(GralCentroCostoGralSucursal::GEN_CONTROL_ALCANCE){
                if($gral_centro_costo_gral_sucursal->getHash() != $hdn_hash){

                    header('Location: us_noautorizado.php?tipo=HASH&clase=GralCentroCostoGralSucursal&id='.$gral_centro_costo_gral_sucursal->getId().'&cod='.$hdn_hash);
                    exit;
                }
            }            
        }            
	...
	$gral_centro_costo_gral_sucursal->setGralCentroCostoId(Gral::getVars(1, "cmb_gral_centro_costo_id", null));
	$gral_centro_costo_gral_sucursal->setGralSucursalId(Gral::getVars(1, "cmb_gral_sucursal_id", null));
	$gral_centro_costo_gral_sucursal->setObservacion(Gral::getVars(1, "txa_observacion"));
    }
    if(UsCredencial::getEsAcreditado('GRAL_CENTRO_COSTO_GRAL_SUCURSAL_ALTA_AVANZADA')){ 
    }
	...
	switch($accion){
            case 'guardar':
                ...
                if(!$error->getExisteError()){
                    ...
                    header('Location: ?cs=1&id='.$gral_centro_costo_gral_sucursal->getId().'&hash='.$gral_centro_costo_gral_sucursal->getHash());
                    exit;
                }
            break;
            case 'guardarnvo':
	...
	if(trim($hdn_id) != 0){ 
            $gral_centro_costo_gral_sucursal->setId($hdn_id);
            ...
            if($gral_centro_costo_gral_sucursal){
                if(GralCentroCostoGralSucursal::GEN_CONTROL_ALCANCE){
                    if($gral_centro_costo_gral_sucursal->getHash() != $hash){

                        header('Location: us_noautorizado.php?tipo=HASH&clase=GralCentroCostoGralSucursal&id='.$gral_centro_costo_gral_sucursal->getId().'&cod='.$hash);
                        exit;
                    }
                }
            }            
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(GralCentroCostoGralSucursal::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(GralCentroCostoGralSucursal::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('GRAL_CENTRO_COSTO_GRAL_SUCURSAL_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_gral_centro_costo_gral_sucursal'>
            ...
            <tr>
                <td id="label_cmb_gral_centro_costo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_centro_costo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_centro_costo_gral_sucursal_alta&atributo=gral_centro_costo_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_centro_costo_id" clase_id="gral_centro_costo" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_centro_costo_id" <?php echo ($gral_centro_costo_gral_sucursal->getGralCentroCostoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_centro_costo_id', Gral::getCmbFiltro(GralCentroCosto::getGralCentroCostosCmb(true), '...'), $gral_centro_costo_gral_sucursal->getGralCentroCostoId(), 'textbox  '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_gral_sucursal_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_sucursal_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_centro_costo_gral_sucursal_alta&atributo=gral_sucursal_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_sucursal_id" clase_id="gral_sucursal" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_sucursal_id" <?php echo ($gral_centro_costo_gral_sucursal->getGralSucursalId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_sucursal_id', Gral::getCmbFiltro(GralSucursal::getGralSucursalsCmb(true), '...'), $gral_centro_costo_gral_sucursal->getGralSucursalId(), 'textbox  '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_centro_costo_gral_sucursal_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($gral_centro_costo_gral_sucursal->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'>
            <input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($gral_centro_costo_gral_sucursal->getId()) ?>'/>
            <input name='hdn_hash' type='hidden' id='hdn_hash' size='5' value='<?php Gral::_echoTxt($gral_centro_costo_gral_sucursal->getHash()) ?>'/>
    ...
    <?php if(trim($gral_centro_costo_gral_sucursal->getId()) != ''){ ?>

...
$pagina_actual = PerPersonaArchivo::getSesPag();
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="per_persona_archivo">
              <?php include 'ajax/modulos/per_persona_archivo/per_persona_archivo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="per_persona_archivo">
              <?php //include 'ajax/modulos/per_persona_archivo/per_persona_archivo_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('per_persona_archivo', <?php echo $pagina_actual ?>);
</script>

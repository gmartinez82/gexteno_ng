...
$db_nombre_pagina = 'pde_nota_debito_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="pde_nota_debito">
              <?php include 'ajax/modulos/pde_nota_debito/pde_nota_debito_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="pde_nota_debito">
              <?php //include 'ajax/modulos/pde_nota_debito/pde_nota_debito_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('pde_nota_debito', <?php echo $pagina_actual ?>);
</script>

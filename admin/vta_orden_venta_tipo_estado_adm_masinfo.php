...
$vta_orden_venta_tipo_estado_id = Gral::getVars(2, 'id');
$vta_orden_venta_tipo_estado = VtaOrdenVentaTipoEstado::getOxId($vta_orden_venta_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($vta_orden_venta_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_ORDEN_VENTA_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_orden_venta_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_orden_venta_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_ORDEN_VENTA_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_orden_venta_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_orden_venta_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('VTA_ORDEN_VENTA_TIPO_ESTADO_MASINFO_VTA_ORDEN_VENTA')){ ?>
            <li><a href="#tab_vta_orden_venta"><?php Lang::_lang('VtaOrdenVenta') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('VTA_ORDEN_VENTA_TIPO_ESTADO_MASINFO_VTA_ORDEN_VENTA_ESTADO')){ ?>
	...
	<div id="tab_vta_orden_venta" class="bloque-relacion vta_orden_venta">
            ...
            <h4><?php Lang::_lang('VtaOrdenVenta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('VtaOrdenVentaTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($vta_orden_venta_tipo_estado->getVtaOrdenVentasParaBloqueMasInfo() as $vta_orden_venta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('VTA_ORDEN_VENTA_TIPO_ESTADO_MASINFO_VTA_ORDEN_VENTA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_orden_venta){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaOrdenVentas de ') ?> <strong><?php echo($vta_orden_venta_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_orden_venta_estado" class="bloque-relacion vta_orden_venta_estado">
            ...
            <h4><?php Lang::_lang('VtaOrdenVentaEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('VtaOrdenVentaTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($vta_orden_venta_tipo_estado->getVtaOrdenVentaEstadosParaBloqueMasInfo() as $vta_orden_venta_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('VTA_ORDEN_VENTA_TIPO_ESTADO_MASINFO_VTA_ORDEN_VENTA_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($vta_orden_venta_estado){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo VtaOrdenVentaEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta_estado->getFiltrosArrXCampo('VtaOrdenVentaTipoEstado', 'vta_orden_venta_tipo_estado_id') ?>" >
                                <?php Lang::_lang('Ver VtaOrdenVentaEstados de ') ?> <strong><?php echo($vta_orden_venta_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$widget_key            = 'fnd_caja_x_tipo_estado_bar';
$widget_codigo         = 'WIDGET_HOME_FND_CAJA_X_TIPO_ESTADO_BAR';
...
$arr_widget                 = GenWidget::getWidgetFndCajaBar($desde, $hasta, $widget_cmb_gral_caja_id, $widget_cmb_fnd_cajero_id, $cmb_visualizacion);
...
<div class="subtitulo">
    <strong>Cajas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>

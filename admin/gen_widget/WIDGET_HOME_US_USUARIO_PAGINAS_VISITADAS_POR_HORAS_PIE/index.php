...
$widget_key = 'us_usuario_paginas_visitadas_por_horas_pie';
$widget_codigo = 'WIDGET_HOME_US_USUARIO_PAGINAS_VISITADAS_POR_HORAS_PIE';
...
$arr_widget = GenWidget::getWidgetUsUsuarioPaginasVisitadasPorHorasPie($txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $cmb_usuario_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa las <strong>horas mas visitadas</strong> (en porcentaje) entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> diferenciado por horas.
</div>

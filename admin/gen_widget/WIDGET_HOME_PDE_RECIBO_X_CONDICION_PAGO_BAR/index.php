...
$widget_key            = 'pde_recibo_x_condicion_pago_bar';
$widget_codigo         = 'WIDGET_HOME_PDE_RECIBO_X_CONDICION_PAGO_BAR';
...
$arr_widget                 = GenWidget::getWidgetPdeReciboXCondicionPagoBar($desde, $hasta, $widget_cmb_prv_proveedor_id, $widget_cmb_pde_recibo_tipo_pago_id, $widget_cmb_pde_recibo_tipo_estado_id, $cmb_visualizacion);

...
$widget_key            = 'vta_orden_venta_x_geo_provincia_bar';
$widget_codigo         = 'WIDGET_HOME_VTA_ORDEN_VENTA_X_GEO_PROVINCIA_BAR';
...
$arr_widget                 = GenWidget::getWidgetVtaOrdenVentaXGeoProvinciaBar($desde, $hasta, $widget_cmb_vta_vendedor_id, $widget_cmb_gral_sucursal_id, $widget_cmb_gral_actividad_id, $widget_cmb_gral_escenario_id, $widget_cmb_ins_categoria_id, $widget_cmb_cli_cliente_id, $cmb_visualizacion, $txt_cantidad);

<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_pde_factura_concepto_id', Gral::getCmbFiltro(PdeFacturaConcepto::getPdeFacturaConceptosCmb(true), '...'), $widget_cmb_pde_factura_concepto_id, 'textbox widget_cmb_pde_factura_concepto_id'. $error_input_css); ?>
        </div>
    </div>

...
$widget_key            = 'pde_factura_item_x_gral_centro_costo_bar';
$widget_codigo         = 'WIDGET_HOME_PDE_FACTURA_ITEM_X_GRAL_CENTRO_COSTO_BAR';
...
if ($filtrar)
{
    ...
    $widget_cmb_pde_factura_concepto_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_pde_factura_concepto_id', 0);
...
$arr_widget                 = GenWidget::getWidgetPdeFacturaItemXGralCentroCostoBar($desde, $hasta, $widget_cmb_pde_factura_concepto_id, $cmb_visualizacion, $txt_cantidad);
...
<div class="subtitulo">
    <strong>Facturas de Compra entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>
            ...
            tooltips:
            {
                ...
                callbacks: {
                    title: function (tooltipItem, data) { 
                        return 'Clientes de ' + data.labels[tooltipItem[0].index]; 
                    },
                    label: function(tooltipItems, data) {
                        return gen_widget_formatter.format(tooltipItems.yLabel);
                    },

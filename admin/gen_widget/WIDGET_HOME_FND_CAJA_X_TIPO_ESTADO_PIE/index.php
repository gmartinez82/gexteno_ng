...
$widget_key            = 'fnd_caja_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_FND_CAJA_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetFndCajaPie($desde, $hasta, $widget_cmb_gral_caja_id, $widget_cmb_fnd_cajero_id, $cmb_visualizacion);
...
<div class="subtitulo">
    <strong>Cajas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

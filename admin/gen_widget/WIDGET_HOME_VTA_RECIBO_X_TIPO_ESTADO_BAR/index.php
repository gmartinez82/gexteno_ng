...
$widget_key            = 'vta_recibo_x_tipo_estado_bar';
$widget_codigo         = 'WIDGET_HOME_VTA_RECIBO_X_TIPO_ESTADO_BAR';
...
if ($filtrar)
{
    ...
    $widget_cmb_vta_recibo_condicion_pago_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_vta_recibo_condicion_pago_id', 0);
...
$arr_widget                 = GenWidget::getWidgetVtaReciboBar($desde, $hasta, $widget_cmb_fnd_cajero_id, $widget_cmb_gral_sucursal_id, $widget_cmb_cli_cliente_id, $widget_cmb_vta_recibo_tipo_pago_id, $widget_cmb_vta_recibo_condicion_pago_id, $cmb_visualizacion);

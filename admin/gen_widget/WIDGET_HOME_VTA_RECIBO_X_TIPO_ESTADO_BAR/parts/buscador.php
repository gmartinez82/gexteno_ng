<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_vta_recibo_tipo_pago_id', Gral::getCmbFiltro(VtaReciboTipoPago::getVtaReciboTipoPagosCmb(true), '...'), $widget_cmb_vta_recibo_tipo_pago_id, 'textbox widget_cmb_vta_recibo_tipo_pago_id '. $error_input_css); ?>
        </div>
    </div>
    
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Condicion Pago'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_vta_recibo_condicion_pago_id', Gral::getCmbFiltro(VtaReciboCondicionPago::getVtaReciboCondicionPagosCmb(true), '...'), $widget_cmb_vta_recibo_condicion_pago_id, 'textbox widget_cmb_vta_recibo_condicion_pago_id '. $error_input_css); ?>
        </div>
    </div>

...
$widget_key            = 'pde_oc_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_PDE_OC_X_TIPO_ESTADO_PIE';
...
if ($filtrar)
{
    ...
    $cmb_visualizacion_oc = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_visualizacion_oc', 0);
...
else
{
    ...
    $cmb_visualizacion_oc = GralSiNo::GRAL_SINO_OC_TIPO_ESTADO;
}

$arr_widget                = GenWidget::getWidgetPdeOcPie($desde, $hasta, $widget_cmb_ins_categoria_id, $widget_cmb_prv_proveedor_id, $cmb_visualizacion, $cmb_visualizacion_oc);
...
<div class="subtitulo">
    <strong>OC entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_visualizacion_oc', Gral::getCmbFiltro(GralSiNo::getTipoVisualizacionOrdenesCompraCmb(), '...'), $cmb_visualizacion_oc, 'textbox widget_cmb_visualizacion_oc '. $error_input_css); ?>
        </div>
    </div>

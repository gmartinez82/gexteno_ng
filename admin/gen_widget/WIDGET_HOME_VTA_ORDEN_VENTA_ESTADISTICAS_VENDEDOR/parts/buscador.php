...
<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Tipo Estado Venta'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_cli_cliente_tipo_estado_venta_id', Gral::getCmbFiltro(CliClienteTipoEstadoVenta::getCliClienteTipoEstadoVentasCmb(true), '...'), $cmb_cli_cliente_tipo_estado_venta_id, 'textbox widget_cmb_cli_cliente_tipo_gestion_id '. $error_input_css); ?>
        </div>
    </div>
    
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Periodicidad'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_cli_cliente_periodicidad_gestion_id', Gral::getCmbFiltro(CliClientePeriodicidadGestion::getCliClientePeriodicidadGestionsCmb(true), '...'), $cmb_cli_cliente_periodicidad_gestion_id, 'textbox widget_cmb_cli_cliente_periodicidad_gestion_id '. $error_input_css); ?>
        </div>
    </div>

...
$widget_key            = 'pdi_pedido_x_tipo_estado_bar';
$widget_codigo         = 'WIDGET_HOME_PDI_PEDIDO_X_TIPO_ESTADO_BAR';
...
$arr_widget                 = GenWidget::getWidgetPdiPedidoBar($desde, $hasta, $widget_cmb_pan_panol_origen, $widget_cmb_pan_panol_destino, $widget_cmb_activo);
...
<div class="subtitulo">
    <strong>Pedidos entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>

...
$widget_key            = 'vta_orden_venta_x_tipo_estado_bar';
$widget_codigo         = 'WIDGET_HOME_VTA_ORDEN_VENTA_X_TIPO_ESTADO_BAR';
...
$arr_widget                 = GenWidget::getWidgetVtaOrdenVentaBar($desde, $hasta, $widget_cmb_vta_vendedor_id, $widget_cmb_gral_sucursal_id, $widget_cmb_gral_actividad_id, $widget_cmb_gral_escenario_id, $widget_cmb_ins_categoria_id, $widget_cmb_vta_preventista_id, $widget_cmb_cli_cliente_id, $cmb_visualizacion, $cmb_visualizacion_ov);
...
<div class="subtitulo">
    <strong>Ordenes de Ventas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>

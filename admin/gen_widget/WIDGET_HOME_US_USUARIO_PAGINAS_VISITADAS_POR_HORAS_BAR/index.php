...
$widget_key = 'us_usuario_paginas_visitadas_por_horas_bar';
$widget_codigo = 'WIDGET_HOME_US_USUARIO_PAGINAS_VISITADAS_POR_HORAS_BAR';
...
$arr_widget = GenWidget::getWidgetUsUsuarioPaginasVisitadasPorHorasBar($txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $cmb_usuario_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa las <strong>horas mas visitadas</strong> entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> discriminado por horas.
</div>

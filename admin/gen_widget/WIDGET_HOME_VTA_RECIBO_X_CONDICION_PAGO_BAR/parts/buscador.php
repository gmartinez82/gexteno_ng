<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_vta_recibo_tipo_estado_id', Gral::getCmbFiltro(VtaReciboTipoEstado::getVtaReciboTipoEstadosCmb(true), '...'), $widget_cmb_vta_recibo_tipo_estado_id, 'textbox widget_cmb_vta_recibo_tipo_estado_id '. $error_input_css); ?>
        </div>
    </div>

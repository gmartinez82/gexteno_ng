...
$widget_key            = 'vta_recibo_x_condicion_pago_bar';
$widget_codigo         = 'WIDGET_HOME_VTA_RECIBO_X_CONDICION_PAGO_BAR';
...
if ($filtrar)
{
    ...
    $widget_cmb_vta_recibo_tipo_pago_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_vta_recibo_tipo_pago_id', 0);
    $widget_cmb_vta_recibo_tipo_estado_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_vta_recibo_tipo_estado_id', 0);
...
else
{
    ...
    $widget_cmb_fnd_cajero_id = 0;
    $cmb_visualizacion = GralSiNo::GRAL_SINO_CI_IMPORTE;
}

$arr_widget                 = GenWidget::getWidgetVtaReciboXCondicionPagoBar($desde, $hasta, $widget_cmb_fnd_cajero_id, $widget_cmb_gral_sucursal_id, $widget_cmb_cli_cliente_id, $widget_cmb_vta_recibo_tipo_pago_id, $widget_cmb_vta_recibo_tipo_estado_id, $cmb_visualizacion);
...
<div class="subtitulo">
    <strong>Recibos entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>

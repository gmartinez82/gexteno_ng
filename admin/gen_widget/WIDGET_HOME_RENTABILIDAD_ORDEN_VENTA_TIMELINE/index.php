...
$widget_key = 'rentabilidad_orden_venta_timeline';
$widget_codigo = 'WIDGET_HOME_RENTABILIDAD_ORDEN_VENTA_TIMELINE';
...
if ($filtrar) {
    ...
    $cmb_ins_tipo_lista_precio_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_ins_tipo_lista_precio_id', 0);
...
$arr_widget = GenWidget::getWidgetRentabilidadOrdenVentaTimeline($periodicidad, $desde, $hasta, $widget_cmb_ins_etiqueta_id, $widget_cmb_ins_categoria_id, $cmb_ins_tipo_insumo_id, $cmb_ins_tipo_lista_precio_id, $widget_cmb_gral_sucursal_id, $widget_cmb_gral_actividad_id, $widget_cmb_ins_marca_id);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Calculado en base a ordenes de ventas emitidas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br />
</div>

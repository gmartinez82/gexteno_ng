...
$widget_key = 'us_navegacion_por_usuario_horario_no_laboral_bar';
$widget_codigo = 'WIDGET_HOME_US_NAVEGACION_POR_USUARIO_HORARIO_NO_LABORAL_BAR';
...
$arr_widget = GenWidget::getWidgetUsNavegacionPorUsuarioHorarioNoLaboralBar($txt_desde, $txt_hasta, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa la <strong>cantidad total de pantallas</strong> en <strong>horario NO laboral</strong>, es decir, entre las <?php echo UsUsuario::HORA_SALIDA_SEMANAL ?> y <?php echo UsUsuario::HORA_ENTRADA_SEMANAL ?> Hs. del <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> discriminado por usuario.
</div>

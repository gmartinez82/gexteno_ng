...
$widget_key = 'us_navegacion_por_usuario_bar';
$widget_codigo = 'WIDGET_HOME_US_NAVEGACION_POR_USUARIO_BAR';
...
$arr_widget = GenWidget::getWidgetUsNavegacionPorUsuarioBar($txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $cmb_pagina, $cmb_grupo_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa la <strong>cantidad total de pantallas</strong> entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> discriminado por usuario.
</div>

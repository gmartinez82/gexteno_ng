...
$widget_key            = 'us_navegacion_por_usuario_timeline';
$widget_codigo         = 'WIDGET_HOME_US_NAVEGACION_POR_USUARIO_TIMELINE';
$widget_key_camelizado = Gral::setDbCamelizar($widget_key, '_');

$filtrar = Gral::getVars(Gral::VARS_GET, 'filtrar', 0, Gral::TIPO_INTEGER);
if ($filtrar)
{
    // ---------------------------------------------------------------------
...
$arr_widget                 = GenWidget::getWidgetUsNavegacionPorUsuarioTimeline($periodicidad, $txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $cmb_pagina, $cmb_grupo_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa la <strong>cantidad total de pantallas</strong> entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> distinguido por usuario.
</div>
...
<div class="datos">
    ...
    <!------------  GRAFICO  -------------->
    <canvas id="canvas_<?php echo $widget_key ?>"></canvas>

...
$widget_key            = 'ins_etiqueta_x_cantidad_bar';
$widget_codigo         = 'WIDGET_HOME_INS_ETIQUETA_X_CANTIDAD_BAR';
...
$arr_widget                 = GenWidget::getWidgetInsEtiquetaCantidadBar($desde, $hasta, $txt_cantidad, $cmb_ins_tipo_insumo_id, $txt_importe_desde, $txt_importe_hasta, $widget_cmb_cli_cliente_id, $widget_cmb_gral_sucursal_id, $widget_cmb_ins_categoria_id, $widget_cmb_gral_actividad_id, $widget_cmb_ins_marca_id, $cmb_visualizacion);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    <strong>Etiquetas Vendidas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>

...
$widget_key = 'us_navegacion_por_ip_bar';
$widget_codigo = 'WIDGET_HOME_US_NAVEGACION_POR_IP_BAR';
...
if ($filtrar) {
    ...
    $cmb_usuario_id = Gral::getVars(Gral::VARS_GET, 'widget_' . $widget_key . '_cmb_usuario_id', 0);
    ...
    $widget_txt_texto = '';
    $txt_cantidad = 10;
    $cmb_ordenamiento = GralSiNo::GRAL_SINO_ORDENAMIENTO_RANKING;
}

$arr_widget = GenWidget::getWidgetUsNavegacionPorIpBar($txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $widget_txt_texto, $cmb_usuario_id, $txt_cantidad, $cmb_ordenamiento);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa los <strong>IPs mas usadas</strong> entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong>.
</div>

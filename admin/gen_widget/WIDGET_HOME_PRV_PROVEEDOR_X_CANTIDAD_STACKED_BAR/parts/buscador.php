<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_visualizacion', GralSiNo::getTipoVisualizacionCantidadPorcentajeCmb(), $cmb_visualizacion, 'textbox widget_cmb_visualizacion '. $error_input_css); ?>
        </div>
    </div> 
    
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Ordenar por'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_orden', InsStockResumenTipoEstado::getInsStockResumenTipoEstadosCmb(true), $widget_cmb_orden, 'textbox widget_cmb_orden'. $error_input_css); ?>
        </div>
    </div>

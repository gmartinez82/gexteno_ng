...
$widget_key = 'us_navegacion_paginas_visitadas_pie';
$widget_codigo = 'WIDGET_HOME_US_NAVEGACION_PAGINAS_VISITADAS_PIE';
...
$arr_widget = GenWidget::getWidgetUsNavegacionPaginasVisitadasPie($txt_desde, $txt_hasta, $txt_hora_desde, $txt_hora_hasta, $cmb_usuario_id, $cmb_grupo_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa las <strong>pantallas mas visitadas</strong> (en porcentaje) entre el <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> diferenciado por usuario.
</div>

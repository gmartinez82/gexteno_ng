...
$widget_key            = 'vta_recibo_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_VTA_RECIBO_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetVtaReciboPie($desde, $hasta, $widget_cmb_fnd_cajero_id, $widget_cmb_gral_sucursal_id, $widget_cmb_cli_cliente_id, $widget_cmb_vta_recibo_tipo_pago_id, $widget_cmb_vta_recibo_condicion_pago_id, $cmb_visualizacion);

<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Centro Costo'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_gral_centro_costo_id', Gral::getCmbFiltro(GralCentroCosto::getGralCentroCostosCmb(true), '...'), $widget_cmb_gral_centro_costo_id, 'textbox widget_cmb_gral_centro_costo_id'. $error_input_css); ?>
        </div>
    </div>

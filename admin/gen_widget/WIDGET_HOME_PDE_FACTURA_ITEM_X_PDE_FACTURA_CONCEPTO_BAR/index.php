...
$widget_key            = 'pde_factura_item_x_pde_factura_concepto_bar';
$widget_codigo         = 'WIDGET_HOME_PDE_FACTURA_ITEM_X_PDE_FACTURA_CONCEPTO_BAR';
...
if ($filtrar)
{
    ...
    $widget_cmb_gral_centro_costo_id = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_gral_centro_costo_id', 0);
...
$arr_widget                 = GenWidget::getWidgetPdeFacturaItemXPdeFacturaConceptoBar($desde, $hasta, $widget_cmb_gral_centro_costo_id, $cmb_visualizacion, $txt_cantidad);

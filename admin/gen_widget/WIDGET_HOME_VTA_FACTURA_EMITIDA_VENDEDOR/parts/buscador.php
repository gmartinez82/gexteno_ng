...
<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_cli_cliente_id', CliCliente::getCliClientesCmb(true), $widget_cmb_cli_cliente_id, 'textbox widget_cmb_cli_cliente_id selective-input-filtro '. $error_input_css); ?>
        </div>
    </div>
    
    <div class="col par">
        <div class="label">
            <?php Lang::_lang('Otros') ?>
        </div>
        <div class="dato">
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_otros', Gral::getCmbFiltro(GralSiNo::getGralSiNosCmb(true), '...'), $widget_cmb_otros, 'textbox widget_cmb_otros' . $error_input_css); ?>
        </div>
    </div>

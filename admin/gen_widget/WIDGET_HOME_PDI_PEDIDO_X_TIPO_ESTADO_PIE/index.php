...
$widget_key            = 'pdi_pedido_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_PDI_PEDIDO_X_TIPO_ESTADO_PIE';
...
if ($filtrar)
{
    ...
    $widget_cmb_pan_panol_origen   = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_pan_panol_origen', 0);
    $widget_cmb_pan_panol_destino   = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_pan_panol_destino', 0);
    $widget_cmb_activo    = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_activo', -1);
...
$arr_widget                = GenWidget::getWidgetPdiPedidoPie($desde, $hasta, $widget_cmb_pan_panol_origen, $widget_cmb_pan_panol_destino, $widget_cmb_activo);
...
<div class="subtitulo">
    <strong>Pedidos entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

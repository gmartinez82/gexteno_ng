...
$widget_key            = 'vta_remito_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_VTA_REMITO_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetVtaRemitoPie($desde, $hasta, $widget_cmb_pan_panol_id, $widget_cmb_cli_cliente_id);
...
<div class="subtitulo">
    <strong>Remitos entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

...
$widget_key            = 'pde_orden_pago_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_PDE_ORDEN_PAGO_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetPdeOrdenPagoPie($desde, $hasta, $widget_cmb_prv_proveedor_id, $cmb_visualizacion);
...
<div class="subtitulo">
    <strong>OP entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

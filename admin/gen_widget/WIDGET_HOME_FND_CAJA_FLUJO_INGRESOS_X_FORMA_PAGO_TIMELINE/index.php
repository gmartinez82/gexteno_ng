...
$widget_key = 'fnd_caja_flujo_ingresos_x_forma_pago_timeline';
$widget_codigo = 'WIDGET_HOME_FND_CAJA_FLUJO_INGRESOS_X_FORMA_PAGO_TIMELINE';
...
$arr_widget = GenWidget::getWidgetFndCajaFlujoIngresosXFormaPagoTimeline($periodicidad, $desde, $hasta, $widget_cmb_gral_caja_id, $widget_cmb_fnd_cajero_id);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Calculado en base al flujo de ingreso en caja entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br />
</div>

...
if ($filtrar)
{
    ...
    $cmb_ordenes = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_ordenes', '');
...
else
{
    ...
    $cmb_ordenes = GralSiNo::GRAL_SINO_OV_CANTIDAD_VENDIDA;
}

$arr_widget                 = GenWidget::getWidgetInsInsumoCantidadBar($desde, $hasta, $txt_cantidad, $widget_cmb_ins_etiqueta_id, $cmb_ins_tipo_insumo_id, $txt_importe_desde, $txt_importe_hasta, $widget_cmb_cli_cliente_id, $widget_cmb_gral_sucursal_id, $widget_cmb_ins_categoria_id, $widget_cmb_gral_actividad_id, $widget_cmb_ins_marca_id, $cmb_visualizacion, $cmb_ordenes);
//Gral::prr($arr_widget);

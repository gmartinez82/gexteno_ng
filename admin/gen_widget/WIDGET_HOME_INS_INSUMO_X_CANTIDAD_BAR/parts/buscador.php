<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Ordenes'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_ordenes', GralSiNo::getTipoVisualizacionOrdenesVentaCantidadCmb(), $cmb_ordenes, 'textbox widget_cmb_ordenes '. $error_input_css); ?>
        </div>
    </div> 

...
$widget_key = 'vta_orden_venta_remitida_no_facturada';
$widget_codigo = 'WIDGET_HOME_VTA_ORDEN_VENTA_REMITIDA_NO_FACTURADA';
...
// Consulta
// -----------------------------------------------------------------------------
$vta_orden_ventas = VtaOrdenVenta::getVtaOrdenVentasRemitidasNoFacturadas($txt_desde, $txt_hasta, $widget_cmb_pan_panol_id, $widget_cmb_vta_presupuesto_tipo_venta_id);
...
<div class="subtitulo">
    Ordenes de Venta <strong>ACTIVAS</strong> generadas entre el <?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?> que han sido <strong>REMITIDAS</strong> pero <strong>NO TOTALMENTE FACTURADAS</strong>.
</div>

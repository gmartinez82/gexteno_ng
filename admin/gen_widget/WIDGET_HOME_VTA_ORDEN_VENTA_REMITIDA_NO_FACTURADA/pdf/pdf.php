...
$pdf->SetTitle(DbConfig::CONFIG_CONF_PROYECTO_MIN.'-OV-Remitidas-No-Facturadas.pdf');

$pdf->setTitulo('OV Remitidas No Facturadas');
...
$pdf->Output(DbConfig::CONFIG_CONF_PROYECTO_MIN.'-OV-Remitidas-No-Facturadas.pdf', 'I');

...
$widget_key            = 'pde_oc_x_tipo_estado_bar';
$widget_codigo         = 'WIDGET_HOME_PDE_OC_X_TIPO_ESTADO_BAR';
...
$arr_widget                 = GenWidget::getWidgetPdeOcBar($desde, $hasta, $widget_cmb_ins_categoria_id, $widget_cmb_prv_proveedor_id, $cmb_visualizacion, $cmb_visualizacion_oc);
...
<div class="subtitulo">
    <strong>OC entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.</strong>
</div>

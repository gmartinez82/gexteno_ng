...
$widget_key            = 'pde_factura_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_PDE_FACTURA_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetPdeFacturaPie($desde, $hasta, $widget_cmb_gral_actividad_id, $widget_cmb_gral_escenario_id, $widget_cmb_prv_proveedor_id, $cmb_visualizacion);

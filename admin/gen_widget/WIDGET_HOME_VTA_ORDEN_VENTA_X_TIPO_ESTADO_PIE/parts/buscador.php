<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_' . $widget_key . '_cmb_visualizacion_ov', Gral::getCmbFiltro(GralSiNo::getTipoVisualizacionOrdenesVentaCmb(), '...'), $cmb_visualizacion_ov, 'textbox widget_cmb_visualizacion_ov ' . $error_input_css); ?>
        </div>
    </div>

...
$widget_key            = 'vta_orden_venta_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_VTA_ORDEN_VENTA_X_TIPO_ESTADO_PIE';
...
if ($filtrar)
{
    ...
    $cmb_visualizacion_ov = Gral::getVars(Gral::VARS_GET, 'widget_'.$widget_key.'_cmb_visualizacion_ov', 0);
...
else
{
    ...
    $cmb_visualizacion_ov = GralSiNo::GRAL_SINO_OV_TIPO_ESTADO;
}

$arr_widget                = GenWidget::getWidgetVtaOrdenVentaPie($desde, $hasta, $widget_cmb_vta_vendedor_id, $widget_cmb_gral_sucursal_id, $widget_cmb_gral_actividad_id, $widget_cmb_gral_escenario_id, $widget_cmb_ins_categoria_id, $widget_cmb_vta_preventista_id, $widget_cmb_cli_cliente_id, $cmb_visualizacion, $cmb_visualizacion_ov);
...
<div class="subtitulo">
    <strong>Ordenes de Ventas entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

<form id='widget_<?php echo $widget_key ?>_form' name='widget_<?php echo $widget_key ?>_form'>
    ...
    <div class='col par'>
        ...
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_gral_sucursal_id', Gral::getCmbFiltro(GralSucursal::getGralSucursalsCmb(true), '...'), $widget_cmb_gral_sucursal_id, 'textbox widget_gral_sucursal_id '. $error_input_css); ?>
        </div>
    </div>
    
    <div class='col par'>
        <div class='label'>
            <?php Lang::_lang('Tipo Venta'); ?>
        </div>
        <div class='dato'>
            <?php Html::html_dib_select(1, 'widget_'.$widget_key.'_cmb_vta_presupuesto_tipo_venta_id', Gral::getCmbFiltro(VtaPresupuestoTipoVenta::getVtaPresupuestoTipoVentasCmb(true), '...'), $widget_cmb_vta_presupuesto_tipo_venta_id, 'textbox widget_cmb_vta_presupuesto_tipo_venta_id '. $error_input_css); ?>
        </div>
    </div>
    ...
    <div class='col botonera'>
        ...
        <button type='button' id='widget_<?php echo $widget_key ?>_btn_generar_pdf' name='widget_<?php echo $widget_key ?>_btn_generar_pdf' class='boton'>Generar PDF</button>
    </div>
</form>
...
$widget_key            = 'presupuesto_timeline';
$widget_codigo         = 'WIDGET_HOME_PRESUPUESTOS_TIMELINE';
...
if ($filtrar) {
    ...
    // ---------------------------------------------------------------------
    $desde = Gral::getVars(2, 'widget_'.$widget_key.'_txt_desde', '');
    $hasta = Gral::getVars(2, 'widget_'.$widget_key.'_txt_hasta', '');
    $widget_cmb_vta_vendedor_id = Gral::getVars(2, 'widget_'.$widget_key.'_cmb_vta_vendedor_id', 0);
...
if ($widget_cmb_vta_vendedor_id != 0) {
    $sql .= "
            AND vta_vendedor.id = ".$widget_cmb_vta_vendedor_id;
}

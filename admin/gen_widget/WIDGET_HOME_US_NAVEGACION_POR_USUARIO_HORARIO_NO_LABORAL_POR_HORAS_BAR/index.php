...
$widget_key = 'us_navegacion_por_usuario_horario_no_laboral_por_horas_bar';
$widget_codigo = 'WIDGET_HOME_US_NAVEGACION_POR_USUARIO_HORARIO_NO_LABORAL_POR_HORAS_BAR';
...
$arr_widget = GenWidget::getWidgetUsNavegacionPorUsuarioHorarioNoLaboralPorHorasBar($txt_desde, $txt_hasta, $cmb_usuario_id, $txt_cantidad);
//Gral::prr($arr_widget);
...
<div class="subtitulo">
    Representa las <strong>horas mas visitadas</strong> en <strong>horario NO laboral</strong>, es decir, entre las <?php echo UsUsuario::HORA_SALIDA_SEMANAL ?> y <?php echo UsUsuario::HORA_ENTRADA_SEMANAL ?> Hs. del <strong><?php echo Gral::getFechaToWEB($txt_desde) ?> y <?php echo Gral::getFechaToWEB($txt_hasta) ?></strong> discriminado por horas.
</div>

...
$widget_key            = 'vta_presuesto_x_tipo_estado_pie';
$widget_codigo         = 'WIDGET_HOME_VTA_PRESUPUESTO_X_TIPO_ESTADO_PIE';
...
$arr_widget                = GenWidget::getWidgetVtaPresupuestoPie($desde, $hasta, $widget_cmb_vta_vendedor_id, $widget_cmb_gral_sucursal_id, $widget_cmb_gral_actividad_id, $widget_cmb_gral_escenario_id, $widget_cmb_vta_preventista_id, $widget_cmb_cli_cliente_id, $cmb_visualizacion);
...
<div class="subtitulo">
    <strong>Presupuestos entre el <?php echo Gral::getFechaToWEB($desde) ?> y <?php echo Gral::getFechaToWEB($hasta) ?>.<br /></strong>
</div>

...
$c = new Criterio();
$c->addTabla('pde_nota_credito_archivo');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$archivos = $pde_nota_credito->getPdeNotaCreditoArchivos(null, $c);
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PdeNotaCreditoArchivos') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="archivos" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <?php include "ajax/modulos/pde_nota_credito_archivo/pde_nota_credito_archivo_masivo.php" ?>
                ...
                <div class="bloque-archivos">
                    ...
                    <div id="div_grupo_archivo_<?php Gral::_echo($archivo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($archivo->getId()) ?>" >
                        <?php
                        include "ajax/modulos/pde_nota_credito_archivo/pde_nota_credito_archivo_uno.php";
                        ?>
                    </div>
                    <?php } ?>
                </div>

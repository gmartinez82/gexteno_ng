...
if(Gral::esPost()){
    ...
    $cli_subcategoria_ins_tipo_lista_precio = CliSubcategoriaInsTipoListaPrecio::getOxId($hdn_id);
    if(!$cli_subcategoria_ins_tipo_lista_precio){
        $cli_subcategoria_ins_tipo_lista_precio = new CliSubcategoriaInsTipoListaPrecio();
    }else{
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        if($cli_subcategoria_ins_tipo_lista_precio){
            if($cli_subcategoria_ins_tipo_lista_precio->getHash() != $hdn_hash){
                
                header('Location: us_noautorizado.php?tipo=HASH&clase=CliSubcategoriaInsTipoListaPrecio&id='.$cli_subcategoria_ins_tipo_lista_precio->getId().'&cod='.$hdn_hash);
                exit;
            }
        }            
    }
    
	$cli_subcategoria_ins_tipo_lista_precio->setCliSubcategoriaId(Gral::getVars(1, "cmb_cli_subcategoria_id", null));
	$cli_subcategoria_ins_tipo_lista_precio->setInsTipoListaPrecioId(Gral::getVars(1, "cmb_ins_tipo_lista_precio_id", null));
	$cli_subcategoria_ins_tipo_lista_precio->setPredeterminado(Gral::getVars(1, "cmb_predeterminado", 0));
	$cli_subcategoria_ins_tipo_lista_precio->setObservacion(Gral::getVars(1, "txa_observacion"));
	...
	switch($accion){
            case 'guardar':
                ...
                if(!$error->getExisteError()){
                    ...
                    header('Location: ?cs=1&id='.$cli_subcategoria_ins_tipo_lista_precio->getId().'&hash='.$cli_subcategoria_ins_tipo_lista_precio->getHash());
                    exit;
                }
            break;
            case 'guardarnvo':
	...
	if(trim($hdn_id) != 0){ 
            $cli_subcategoria_ins_tipo_lista_precio->setId($hdn_id);
            ...
            if($cli_subcategoria_ins_tipo_lista_precio){
                if($cli_subcategoria_ins_tipo_lista_precio->getHash() != $hash){

                    header('Location: us_noautorizado.php?tipo=HASH&clase=CliSubcategoriaInsTipoListaPrecio&id='.$cli_subcategoria_ins_tipo_lista_precio->getId().'&cod='.$hash);
                    exit;
                }
            }            
...
<div id='cuerpo' >
	...
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('CliSubcategoriaInsTipoListaPrecios') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(CliSubcategoriaInsTipoListaPrecio::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(CliSubcategoriaInsTipoListaPrecio::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('CLI_SUBCATEGORIA_INS_TIPO_LISTA_PRECIO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_cli_subcategoria_ins_tipo_lista_precio'>
            ...
            <tr>
                <td id="label_cmb_cli_subcategoria_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_cli_subcategoria_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=cli_subcategoria_ins_tipo_lista_precio_alta&atributo=cli_subcategoria_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_cli_subcategoria_id" clase_id="cli_subcategoria" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_cli_subcategoria_id" <?php echo ($cli_subcategoria_ins_tipo_lista_precio->getCliSubcategoriaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_cli_subcategoria_id', Gral::getCmbFiltro(CliSubcategoria::getCliSubcategoriasCmb(true), '...'), $cli_subcategoria_ins_tipo_lista_precio->getCliSubcategoriaId(), 'textbox  '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_ins_tipo_lista_precio_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_ins_tipo_lista_precio_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=cli_subcategoria_ins_tipo_lista_precio_alta&atributo=ins_tipo_lista_precio_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_ins_tipo_lista_precio_id', Gral::getCmbFiltro(InsTipoListaPrecio::getInsTipoListaPreciosCmb(true), '...'), $cli_subcategoria_ins_tipo_lista_precio->getInsTipoListaPrecioId(), 'textbox  '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_predeterminado" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_predeterminado' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=cli_subcategoria_ins_tipo_lista_precio_alta&atributo=predeterminado' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_predeterminado', GralSiNo::getGralSiNosCmb(), $cli_subcategoria_ins_tipo_lista_precio->getPredeterminado(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=cli_subcategoria_ins_tipo_lista_precio_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($cli_subcategoria_ins_tipo_lista_precio->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'>
            <input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($cli_subcategoria_ins_tipo_lista_precio->getId()) ?>'/>
            <input name='hdn_hash' type='hidden' id='hdn_hash' size='5' value='<?php Gral::_echoTxt($cli_subcategoria_ins_tipo_lista_precio->getHash()) ?>'/>
    ...
    <?php if(trim($cli_subcategoria_ins_tipo_lista_precio->getId()) != ''){ ?>

...
$db_nombre_pagina = 'vta_recibo_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="vta_recibo">
              <?php include 'ajax/modulos/vta_recibo/vta_recibo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="vta_recibo">
              <?php //include 'ajax/modulos/vta_recibo/vta_recibo_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('vta_recibo', <?php echo $pagina_actual ?>);
</script>

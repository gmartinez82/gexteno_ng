...
$pagina_actual = OsOrdenServicioImagen::getSesPag();
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="os_orden_servicio_imagen">
              <?php include 'ajax/modulos/os_orden_servicio_imagen/os_orden_servicio_imagen_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="os_orden_servicio_imagen">
              <?php //include 'ajax/modulos/os_orden_servicio_imagen/os_orden_servicio_imagen_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('os_orden_servicio_imagen', <?php echo $pagina_actual ?>);
</script>

...
$c = new Criterio();
$c->addTabla('veh_marca_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $veh_marca->getVehMarcaImagens(null, $c);

$clase = "VehMarca";
$tabla = "veh_marca";
$padre = $veh_marca->getId();
          ...
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="titulo">
                    ...
                    <div class="dato"><?php Gral::_echo($veh_marca->getDescripcion()) ?></div>
                </div>
                <div class="botonera">
                    <div class="boton volver"><a href="<?php Gral::_echo(VehMarca::getInfoBtnVolver('url')) ?>"><?php Lang::_lang(VehMarca::getInfoBtnVolver('label')) ?></a></div>
                    <div class="boton editar"><a href="veh_marca_alta.php?id=<?php Gral::_echo($veh_marca->getId()) ?>"><?php Lang::_lang('Editar') ?> <strong><?php Gral::_echo($veh_marca->getDescripcion()) ?></strong></a></div>
                </div>

                
                <?php include "ajax/modulos/veh_marca_imagen/veh_marca_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/veh_marca_imagen/veh_marca_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

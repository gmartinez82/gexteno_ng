...
$prd_orden_trabajo_tipo_estado_id = Gral::getVars(2, 'id');
$prd_orden_trabajo_tipo_estado = PrdOrdenTrabajoTipoEstado::getOxId($prd_orden_trabajo_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prd_orden_trabajo_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_ORDEN_TRABAJO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_orden_trabajo_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_orden_trabajo_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_ORDEN_TRABAJO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_orden_trabajo_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_orden_trabajo_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRD_ORDEN_TRABAJO_TIPO_ESTADO_MASINFO_PRD_ORDEN_TRABAJO')){ ?>
            <li><a href="#tab_prd_orden_trabajo"><?php Lang::_lang('PrdOrdenTrabajos') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PRD_ORDEN_TRABAJO_TIPO_ESTADO_MASINFO_PRD_ORDEN_TRABAJO_ESTADO')){ ?>
	...
	<div id="tab_prd_orden_trabajo" class="bloque-relacion prd_orden_trabajo">
            ...
            <h4><?php Lang::_lang('PrdOrdenTrabajo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrdOrdenTrabajoTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prd_orden_trabajo_tipo_estado->getPrdOrdenTrabajosParaBloqueMasInfo() as $prd_orden_trabajo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRD_ORDEN_TRABAJO_TIPO_ESTADO_MASINFO_PRD_ORDEN_TRABAJO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($prd_orden_trabajo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PrdOrdenTrabajos de ') ?> <strong><?php echo($prd_orden_trabajo_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_prd_orden_trabajo_estado" class="bloque-relacion prd_orden_trabajo_estado">
            ...
            <h4><?php Lang::_lang('PrdOrdenTrabajoEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrdOrdenTrabajoTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prd_orden_trabajo_tipo_estado->getPrdOrdenTrabajoEstadosParaBloqueMasInfo() as $prd_orden_trabajo_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRD_ORDEN_TRABAJO_TIPO_ESTADO_MASINFO_PRD_ORDEN_TRABAJO_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($prd_orden_trabajo_estado){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PrdOrdenTrabajoEstado::getFiltrosArrGral() ?>&arr=<?php echo $prd_orden_trabajo_estado->getFiltrosArrXCampo('PrdOrdenTrabajoTipoEstado', 'prd_orden_trabajo_tipo_estado_id') ?>" >
                                <?php Lang::_lang('Ver PrdOrdenTrabajoEstados de ') ?> <strong><?php echo($prd_orden_trabajo_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

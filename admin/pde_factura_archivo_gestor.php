...
$db_nombre_pagina = 'pde_factura_archivo_adm';
...
$c = new Criterio();
$c->addTabla('pde_factura_archivo');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$archivos = $pde_factura->getPdeFacturaArchivos(null, $c);

$clase = "PdeFactura";
$tabla = "pde_factura";
$padre = $pde_factura->getId();
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PdeFacturaArchivos') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="archivos" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="botonera">
                    <div class="boton volver"><a href="<?php Gral::_echo(PdeFactura::getInfoBtnVolver('url')) ?>"><?php Lang::_lang(PdeFactura::getInfoBtnVolver('label')) ?></a></div>
                    <div class="boton editar"><a href="pde_factura_alta.php?id=<?php Gral::_echo($pde_factura->getId()) ?>"><?php Lang::_lang('Editar') ?> <strong><?php Gral::_echo($pde_factura->getDescripcion()) ?></strong></a></div>
                </div>

                <?php include "ajax/modulos/pde_factura_archivo/pde_factura_archivo_masivo.php" ?>
                ...
                <div class="bloque-archivos">
                    ...
                    <div id="div_grupo_archivo_<?php Gral::_echo($archivo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($archivo->getId()) ?>" >
                        <?php
                        include "ajax/modulos/pde_factura_archivo/pde_factura_archivo_uno.php";
                        ?>
                    </div>
                    <?php } ?>
                </div>

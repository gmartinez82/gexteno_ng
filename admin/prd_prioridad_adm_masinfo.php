...
$prd_prioridad_id = Gral::getVars(2, 'id');
$prd_prioridad = PrdPrioridad::getOxId($prd_prioridad_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prd_prioridad->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_PRIORIDAD_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_prioridad->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_prioridad->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_PRIORIDAD_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_prioridad->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_prioridad->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRD_PRIORIDAD_MASINFO_PRD_ORDEN_TRABAJO')){ ?>
	...
	<div id="tab_prd_orden_trabajo" class="bloque-relacion prd_orden_trabajo">
            ...
            <h4><?php Lang::_lang('PrdOrdenTrabajo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrdPrioridad') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prd_prioridad->getPrdOrdenTrabajosParaBloqueMasInfo() as $prd_orden_trabajo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRD_PRIORIDAD_MASINFO_PRD_ORDEN_TRABAJO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($prd_orden_trabajo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PrdOrdenTrabajos de ') ?> <strong><?php echo($prd_prioridad->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

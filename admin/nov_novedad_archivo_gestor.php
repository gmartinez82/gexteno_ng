...
$c = new Criterio();
$c->addTabla('nov_novedad_archivo');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$archivos = $nov_novedad->getNovNovedadArchivos(null, $c);
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('NovNovedadArchivos') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="archivos" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <?php include "ajax/modulos/nov_novedad_archivo/nov_novedad_archivo_masivo.php" ?>
                ...
                <div class="bloque-archivos">
                    ...
                    <div id="div_grupo_archivo_<?php Gral::_echo($archivo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($archivo->getId()) ?>" >
                        <?php
                        include "ajax/modulos/nov_novedad_archivo/nov_novedad_archivo_uno.php";
                        ?>
                    </div>
                    <?php } ?>
                </div>

...
if (Gral::esPost()) {
    ...
    //include "rep_pdi_ajustes_xlsx.php";
    include "rep_pdi_ajustes_php_excel.php";
} else {
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('Ajustes de Stock') ?> </div>
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    ...
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Ajustes de Stock') ?></div>

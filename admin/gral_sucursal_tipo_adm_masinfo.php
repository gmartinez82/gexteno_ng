...
$gral_sucursal_tipo_id = Gral::getVars(2, 'id');
$gral_sucursal_tipo = GralSucursalTipo::getOxId($gral_sucursal_tipo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_sucursal_tipo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GRAL_SUCURSAL_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gral_sucursal_tipo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gral_sucursal_tipo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GRAL_SUCURSAL_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gral_sucursal_tipo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gral_sucursal_tipo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('GRAL_SUCURSAL_TIPO_MASINFO_GRAL_SUCURSAL')){ ?>
	...
	<div id="tab_gral_sucursal" class="bloque-relacion gral_sucursal">
            ...
            <h4><?php Lang::_lang('GralSucursal') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralSucursalTipo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_sucursal_tipo->getGralSucursalsParaBloqueMasInfo() as $gral_sucursal){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_SUCURSAL_TIPO_MASINFO_GRAL_SUCURSAL_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($gral_sucursal){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver GralSucursals de ') ?> <strong><?php echo($gral_sucursal_tipo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

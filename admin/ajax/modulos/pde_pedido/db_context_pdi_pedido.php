...
$pdi_pedido = $pde_pedido->getPdiPedido();
...
<div class="datos" id="<?php Gral::_echo($pdi_pedido->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdePedido::getFiltrosArrGral() ?>&arr=<?php echo $pde_pedido->getFiltrosArrXCampo('PdiPedido', 'pdi_pedido_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdePedidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pdi_pedido->getDescripcion()) ?></strong>
        </a>
    </div>

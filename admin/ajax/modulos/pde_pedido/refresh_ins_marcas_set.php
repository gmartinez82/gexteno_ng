...
$o_ids = eval('return $o_padre->getPdePedidoInsMarcasId();');


// elementos seleccionados
$c = new Criterio();
$c->add('pde_pedido_ins_marca.pde_pedido_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_marca');
$c->addRealJoin('pde_pedido_ins_marca', 'pde_pedido_ins_marca.ins_marca_id', 'ins_marca.id', 'LEFT JOIN');
$c->addOrden('2');
$c->setCriterios();

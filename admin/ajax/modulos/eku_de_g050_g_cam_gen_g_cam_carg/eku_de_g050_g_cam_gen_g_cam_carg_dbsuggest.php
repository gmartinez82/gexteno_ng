...
if($buscar != '...'){
    ...
    $c->add('eku_de_g050_g_cam_gen_g_cam_carg.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_g050_g_cam_gen_g_cam_carg.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_g050_g_cam_gen_g_cam_carg.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_g050_g_cam_gen_g_cam_carg.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_g050_g_cam_gen_g_cam_carg');
$c->addOrden('eku_de_g050_g_cam_gen_g_cam_carg.orden', 'asc');
$c->setCriterios();

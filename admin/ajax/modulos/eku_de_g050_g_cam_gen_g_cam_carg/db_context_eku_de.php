...
$eku_de_g050_g_cam_gen_g_cam_carg_id = Gral::getVars(2, 'eku_de_g050_g_cam_gen_g_cam_carg_id');
$eku_de_g050_g_cam_gen_g_cam_carg = EkuDeG050GCamGenGCamCarg::getOxId($eku_de_g050_g_cam_gen_g_cam_carg_id);
$eku_de = $eku_de_g050_g_cam_gen_g_cam_carg->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeG050GCamGenGCamCarg::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_g050_g_cam_gen_g_cam_carg->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeG050GCamGenGCamCargs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

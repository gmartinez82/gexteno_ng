...
if($buscar != '...'){
    ...
    $c->add('pln_jornada.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('pln_jornada.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_jornada.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_jornada.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

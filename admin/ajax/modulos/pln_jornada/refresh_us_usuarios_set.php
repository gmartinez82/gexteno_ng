...
$c->add('pln_jornada_us_usuario.pln_jornada_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('pln_jornada_us_usuario', 'pln_jornada_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

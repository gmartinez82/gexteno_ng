...
$ws_fe_param_tipo_tributo = $vta_tributo_ws_fe_param_tipo_tributo->getWsFeParamTipoTributo();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_param_tipo_tributo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTributoWsFeParamTipoTributo::getFiltrosArrGral() ?>&arr=<?php echo $vta_tributo_ws_fe_param_tipo_tributo->getFiltrosArrXCampo('WsFeParamTipoTributo', 'ws_fe_param_tipo_tributo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTributoWsFeParamTipoTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_param_tipo_tributo->getDescripcion()) ?></strong>
        </a>
    </div>

...
<tr class="tr-item" key = "<?php echo $key ?>">
    ...
    <td>
        <div class="pde_nota_debito_concepto">
            <?php
            $pde_nota_debito_concepto_id = $cmb_pde_nota_debito_concepto_ids[$key];
            Html::html_dib_select(1, "cmb_pde_nota_debito_concepto_id[" . $key . "]", Gral::getCmbFiltro(PdeNotaDebitoConcepto::getPdeNotaDebitoConceptosCmb(), '...'), $pde_nota_debito_concepto_id, 'textbox pde_nota_debito_concepto_id' . $error_input_css);
            ?>
        </div>

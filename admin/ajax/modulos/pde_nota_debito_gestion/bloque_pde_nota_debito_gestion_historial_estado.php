<table border="0" class="tabla-modal">
    ...
    <?php
    $pde_nota_debito_estados = $pde_nota_debito->getPdeNotaDebitoEstados();
    $cont = 0;
    foreach ($pde_nota_debito_estados as $pde_nota_debito_estado) {
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($pde_nota_debito_estado->getCreado())); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="tipo-estado">
                    <img src="imgs/pde_nota_debito_tipo_estado/<?php Gral::_echo($pde_nota_debito_estado->getPdeNotaDebitoTipoEstado()->getCodigo()) ?>.png" alt="tipo-estado" width="15" />
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por">
                    <?php Gral::_echo($pde_nota_debito_estado->getCreadoPorDescripcion()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="actual">
                    <img src="imgs/btn_estado_<?php echo $pde_nota_debito_estado->getActual(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>
        </tr>
    <?php } ?>

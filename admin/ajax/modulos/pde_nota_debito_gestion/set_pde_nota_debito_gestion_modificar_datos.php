...
$pde_tipo_nota_debito_id = Gral::getVars(Gral::VARS_POST, "cmb_pde_tipo_nota_debito_id", 0);
...
if ($pde_tipo_nota_debito_id == 0) {
    $arr["cmb_pde_tipo_nota_debito_id"] = Lang::_lang("Debe seleccionar un Tipo de ND", true);
    $arr["error"] = true;
}
...
if (!$arr["error"]) {
    ...
    $pde_nota_debito->setModificarDatosComprobante($pde_tipo_nota_debito_id, $prv_proveedor_id, $txt_fecha, $cmb_gral_mes_id, $cmb_anio, $txt_nro_timbrado, $txt_nro_punto_venta, $txt_nro_comprobante, $txt_fecha_vencimiento, $txa_observacion, $txt_comprobante_tributos);
}

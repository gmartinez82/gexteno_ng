...
$o_ids = eval('return $o_padre->getPdeNotaDebitoWsFeOpeSolicitudsId();');


// elementos seleccionados
$c = new Criterio();
$c->add('pde_nota_debito_ws_fe_ope_solicitud.pde_nota_debito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ws_fe_ope_solicitud');
$c->addRealJoin('pde_nota_debito_ws_fe_ope_solicitud', 'pde_nota_debito_ws_fe_ope_solicitud.ws_fe_ope_solicitud_id', 'ws_fe_ope_solicitud.id', 'LEFT JOIN');

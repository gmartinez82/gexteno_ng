...
<div class="datos generar-ws-fe-afip">
    ...
    <form id='form_generar_ws_fe_afip' name='form_generar_ws_fe_afip' method='POST' action='' >
        ...
        <?php include "bloque_pde_nota_debito_listado_items_x_prv_proveedor_modal.php"; ?>
        ...
        <div class="col col1">
            ...
            <div class="par">
                ...
                <div class="dato">
                    <?php
                    //Gral::_echo(PdeNotaDebito::getDeterminacionTipoNotaDebito($prv_proveedor_id)->getDescripcion())
                    $cmb_pde_tipo_nota_debito_id = PdeNotaDebito::getDeterminacionTipoNotaDebito($prv_proveedor_id)->getId();
                    Html::html_dib_select(1, 'cmb_pde_tipo_nota_debito_id', Gral::getCmbFiltro(PdeTipoNotaDebito::getPdeTipoNotaDebitosCmb(), '...'), $cmb_pde_tipo_nota_debito_id, 'textbox ' . $error_input_css);
                    ?>
        ...
        <div class="col col2">
            <?php include "bloque_pde_nota_debito_listado_items_tabla_totales.php"; ?>            
        </div>

        <div class="label-error" id="generar_nota_debito_online_afip_error"></div>
        <div class="botonera">
            <button class="boton" prv_proveedor_id="<?php echo $prv_proveedor_id ?>" id='btn_generar_nota_debito_online' name='btn_generar_nota_debito_online' type='button' class='btn_generar_nota_debito_online'><?php Lang::_lang('Registrar ND de Proveedores') ?></button>
        </div>

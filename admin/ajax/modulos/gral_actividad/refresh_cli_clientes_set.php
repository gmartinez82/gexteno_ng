...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('cli_cliente_gral_actividad.gral_actividad_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_gral_actividad', 'cli_cliente_gral_actividad.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

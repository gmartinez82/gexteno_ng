<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/vta_nota_debito/set_vta_nota_debito_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='vta_nota_debito_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('VtaNotaDebito') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='vta_nota_debito'><img src="imgs/btn_lupa.png" width="25"></label>

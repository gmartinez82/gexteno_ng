...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_nota_debito_vta_tributo.vta_nota_debito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_tributo');
$c->addRealJoin('vta_nota_debito_vta_tributo', 'vta_nota_debito_vta_tributo.vta_tributo_id', 'vta_tributo.id', 'LEFT JOIN');

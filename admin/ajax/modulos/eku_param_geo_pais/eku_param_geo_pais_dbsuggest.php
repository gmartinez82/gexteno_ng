...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_pais.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_geo_pais.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_pais.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_pais.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamGeoPais::getEkuParamGeoPaiss($p, $c);

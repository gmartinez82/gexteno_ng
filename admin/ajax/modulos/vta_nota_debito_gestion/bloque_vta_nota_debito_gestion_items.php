<table border="0" class="tabla-modal">
    <tr>
        ...
        <td class="adm_tbl_encabezado" width="280" align='center'><?php Lang::_lang("Descripcion"); ?></td>
    ...
    if (!count($vta_nota_debito_items) > 0) {
        $vta_nota_debito_items = $vta_nota_debito->getVtaNotaDebitoVtaFacturaVtaOrdenVentas();
    }
    ...
    foreach ($vta_nota_debito_items as $vta_nota_debito_item) {
        ...
        <tr>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                <div class="cantidad">
                    <?php $cantidad = $vta_nota_debito_item->getCantidad(); ?>
            ...
            <td align='right' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                <div class="importe-unitario">
                    <?php $importe_unitario = $vta_nota_debito_item->getImporteUnitario(); ?>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                <div class="aplica_percepcion_iibb">
                    <?php $gral_si_no_aplica_percepcion_iibb = GralSiNo::getOxId($vta_nota_debito_item->getPercepcionIibbAplica()); ?>

<table border="0" class="tabla-modal">
    ...
    <?php
    $vta_nota_debito_estados = $vta_nota_debito->getVtaNotaDebitoEstados();
    $cont = 0;
    foreach ($vta_nota_debito_estados as $vta_nota_debito_estado) {
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_nota_debito_estado->getCreado())); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="tipo-estado">
                    <img src="imgs/vta_nota_debito_tipo_estado/<?php Gral::_echo($vta_nota_debito_estado->getVtaNotaDebitoTipoEstado()->getCodigo()) ?>.png" alt="tipo-estado" width="15" />
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por">
                    <?php Gral::_echo($vta_nota_debito_estado->getCreadoPorDescripcion()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="actual">
                    <img src="imgs/btn_estado_<?php echo $vta_nota_debito_estado->getActual(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>
        </tr>
    <?php } ?>

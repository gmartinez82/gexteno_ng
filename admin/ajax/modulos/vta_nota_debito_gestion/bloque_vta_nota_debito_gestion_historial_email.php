<table border="0" class="tabla-modal-ficha-emails">
    ...
    <?php
    $vta_nota_debito_enviados = $vta_nota_debito->getVtaNotaDebitoEnviados();
    $cont = 0;
    foreach ($vta_nota_debito_enviados as $vta_nota_debito_enviado) {
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_nota_debito_enviado->getCreado())); ?>
                </div>
            </td>	
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="estado">
                    <img src="imgs/btn_estado_<?php echo $vta_nota_debito_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por-descripcion">
                    <?php Gral::_echo($vta_nota_debito_enviado->getCreadoPorDescripcion()); ?>
                </div>
            </td>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                <ul class="adm_botones_acciones_modal_ficha">
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_NOTA_CREDITO_GESTION_ACCION_COMPROBANTE')) { ?>
                        <li class='adm_botones_accion vta-nota-debito-comprobante' vta_nota_debito_enviado_id='<?php echo $vta_nota_debito_enviado->getId() ?>'>
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_NOTA_CREDITO_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                        <li class='adm_botones_accion vta-nota-debito-ver-cuerpo-correo' vta_nota_debito_enviado_id='<?php echo $vta_nota_debito_enviado->getId() ?>'>

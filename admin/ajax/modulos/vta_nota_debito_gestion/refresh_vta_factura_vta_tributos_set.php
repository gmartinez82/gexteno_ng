...
$o_ids = eval('return $o_padre->getVtaNotaDebitoVtaFacturaVtaTributosId();');


// elementos seleccionados
$c = new Criterio();
$c->add('vta_nota_debito_vta_factura_vta_tributo.vta_nota_debito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_factura_vta_tributo');
$c->addRealJoin('vta_nota_debito_vta_factura_vta_tributo', 'vta_nota_debito_vta_factura_vta_tributo.vta_factura_vta_tributo_id', 'vta_factura_vta_tributo.id', 'LEFT JOIN');

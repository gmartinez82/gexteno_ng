...
$vta_nota_debito_vta_tributos = $vta_nota_debito->getVtaNotaDebitoVtaTributos();

$cntb_diario_asiento = $vta_nota_debito->getCntbDiarioAsiento();
?>
<div class="tabs ficha-nota_debito" vta_nota_debito_id="<?php echo $vta_nota_debito->getId(); ?>">
    ...
    <ul>
        ...
        <?php if ((int) $vta_nota_debito->getCliClienteId() != 0): ?>
            <li>
                <a href="#tab_cliente">
    ...
    <?php if ((int) $vta_nota_debito->getCliClienteId() != 0): ?>
        <div id="tab_cliente" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_cliente.php"; ?>  
        </div>
    <?php endif; ?>
    ...
    <?php if ((int) $vta_nota_debito->getId() != 0): ?>
        <div id="tab_estados" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_estados.php"; ?>  
        </div>
    <?php endif; ?>
    ...
    <?php if ((int) $vta_nota_debito->getId() != 0): ?>
        <div id="tab_emails" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_email.php"; ?>  
        </div>
    <?php endif; ?>
    ...
    <?php if ((int) $vta_nota_debito->getId() != 0): ?>
        <div id="tab_items" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_items.php"; ?>  
        </div>
    <?php endif; ?>
    ...
    <?php if (count($vta_nota_debito_vta_tributos) > 0) { ?>
        ...
        <div id="tab_tributo" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_tributos.php"; ?>  
        </div>
    <?php } ?>
    ...
    <?php if ((int) $vta_nota_debito->getId() != 0): ?>
        <div id="tab_solicitud_afip" class="datos">
            <?php include "modal_vta_nota_debito_gestion_ficha_tab_solicitud_afip.php"; ?>  
        </div>
    <?php endif; ?>

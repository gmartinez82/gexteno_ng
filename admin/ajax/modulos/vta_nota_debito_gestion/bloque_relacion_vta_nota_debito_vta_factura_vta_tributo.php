	...
	<div class='relacion vta_factura_vta_tributo' clase='vta_factura_vta_tributo' padre='vta_nota_debito' padre_clase='VtaNotaDebito' relacion='VtaNotaDebitoVtaFacturaVtaTributo'>

	<div class='titulo'>
            <?php Lang::_lang('VtaFacturaVtaTributos') ?>
            <?php 
            $cantidad_vta_factura_vta_tributos = count($vta_nota_debito->getVtaFacturaVtaTributosXVtaNotaDebitoVtaFacturaVtaTributo());
	...
	<div class='buscador'>
            ...
            <div class="trigger wopenModal boton" archivo="ajax/modulos/vta_factura_vta_tributo/vta_factura_vta_tributo_alta.php" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="buscarSetResultados(1, '', 'vta_factura_vta_tributo', 'vta_nota_debito', <?php Gral::_echo($vta_nota_debito->getId()) ?>, 'VtaNotaDebito', 'vta_nota_debito_vta_factura_vta_tributo')" title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('VtaFacturaVtaTributo') ?>'>

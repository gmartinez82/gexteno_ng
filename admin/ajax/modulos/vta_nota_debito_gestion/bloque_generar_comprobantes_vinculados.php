<?php
$vta_nota_creditos = VtaNotaCredito::getVtaNotaCreditosImputables($dbsug_cli_cliente_id, $gral_empresa_id = null);
$vta_facturas = VtaFactura::getVtaFacturasImputablesANotaDebito($dbsug_cli_cliente_id, $gral_empresa_id = null);
...
<div class="crear-comprobantes-vinculados">
    <div class="crear-comprobantes-vinculados-inner">       
        ...
        if (count($vta_comprobantes) > 0) {
            ...
            <?php } ?>
        <?php } else { ?>
            El cliente no tiene comprobantes origen para continuar con la creacion de la Nota de Debito.
        <?php } ?>
    </div>
</div>

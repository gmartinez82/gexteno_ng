...
if($buscar != '...'){
    ...
    $c->add('prd_param_operacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_param_operacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_param_operacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_param_operacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

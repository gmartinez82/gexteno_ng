...
$prd_equipo = $prd_param_operacion->getPrdEquipo();
...
<div class="datos" id="<?php Gral::_echo($prd_equipo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrdParamOperacion::getFiltrosArrGral() ?>&arr=<?php echo $prd_param_operacion->getFiltrosArrXCampo('PrdEquipo', 'prd_equipo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrdParamOperacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prd_equipo->getDescripcion()) ?></strong>
        </a>
    </div>

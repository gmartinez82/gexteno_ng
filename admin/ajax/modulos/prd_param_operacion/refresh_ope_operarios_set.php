...
$c->add('prd_param_operacion_ope_operario.prd_param_operacion_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ope_operario');
$c->addRealJoin('prd_param_operacion_ope_operario', 'prd_param_operacion_ope_operario.ope_operario_id', 'ope_operario.id', 'LEFT JOIN');

...
if ($per_movimiento) {
    if ($per_movimiento->getPerMovTipoMovimiento()->getCodigo() == PerMovTipoMovimiento::TIPO_SALIDA) {
        $error = true;
    }
    ...
    if ($per_mov_tipo_movimiento) {
        ...
        //$txt_fecha_hora = Gral::getFechaHoraToWEB(Gral::getFechaHoraActual());
...
<div class="div-modal-alta-movimiento-salida">
    <form id="form_alta_movimiento_salida" name="form_alta_movimiento_salida">
        ...
        <div class="datos per-mov-movimiento-salida" >

            <?php if ($error): ?>
                <div class="par">
                    <div class="label"></div>
                    <div class="label-error">
                        El ultimo movimiento registrado debe ser de tipo ENTRADA para poder dar de alta un nuevo movimiento de tipo SALIDA
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if (!$error): ?>
                <div class="par">
                    <div class="label"><?php Lang::_lang("Mov Entrada") ?></div>
                    <div class="dato">
                        <?php Gral::_echo($per_movimiento->getId()); ?>
                    </div>
                </div>    
                <div class="par">

...
if($buscar != '...'){
    ...
    $c->add('eku_de_vta_nota_debito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_vta_nota_debito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_nota_debito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_nota_debito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_vta_nota_debito');
$c->addOrden('eku_de_vta_nota_debito.orden', 'asc');
$c->setCriterios();

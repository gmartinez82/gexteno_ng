...
$ins_insumo_costo = $vta_orden_venta->getInsInsumoCosto();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo_costo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaOrdenVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta->getFiltrosArrXCampo('InsInsumoCosto', 'ins_insumo_costo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaOrdenVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo_costo->getDescripcion()) ?></strong>
        </a>
    </div>

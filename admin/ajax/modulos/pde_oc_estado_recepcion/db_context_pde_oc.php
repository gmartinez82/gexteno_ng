...
$pde_oc = $pde_oc_estado_recepcion->getPdeOc();
...
<div class="datos" id="<?php Gral::_echo($pde_oc->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcEstadoRecepcion::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_estado_recepcion->getFiltrosArrXCampo('PdeOc', 'pde_oc_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcEstadoRecepcions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc->getDescripcion()) ?></strong>
        </a>
    </div>

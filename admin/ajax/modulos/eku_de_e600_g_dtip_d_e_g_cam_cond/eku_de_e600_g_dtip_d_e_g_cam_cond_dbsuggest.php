...
if($buscar != '...'){
    ...
    $c->add('eku_de_e600_g_dtip_d_e_g_cam_cond.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e600_g_dtip_d_e_g_cam_cond.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e600_g_dtip_d_e_g_cam_cond.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e600_g_dtip_d_e_g_cam_cond.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e600_g_dtip_d_e_g_cam_cond');
$c->addOrden('eku_de_e600_g_dtip_d_e_g_cam_cond.orden', 'asc');
$c->setCriterios();

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('gral_condicion_iva_pde_tipo_nota_debito.pde_tipo_nota_debito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_condicion_iva');
$c->addRealJoin('gral_condicion_iva_pde_tipo_nota_debito', 'gral_condicion_iva_pde_tipo_nota_debito.gral_condicion_iva_id', 'gral_condicion_iva.id', 'LEFT JOIN');

...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pde_tipo_nota_debito.id', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_id'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_id_comparador'));
	$criterio->add('pde_tipo_nota_debito.descripcion', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_descripcion'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_descripcion_comparador'));
	$criterio->add('pde_tipo_nota_debito.codigo_min', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_codigo_min'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_codigo_min_comparador'));
	$criterio->add('pde_tipo_nota_debito.codigo', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_codigo'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_codigo_comparador'));
	$criterio->add('pde_tipo_nota_debito.informa', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_informa'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_informa_comparador'));
	$criterio->add('pde_tipo_nota_debito.observacion', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_observacion'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_observacion_comparador'));
	$criterio->add('pde_tipo_nota_debito.estado', Gral::getVars(1, 'buscador_pde_tipo_nota_debito_estado'), Gral::getVars(1, 'buscador_pde_tipo_nota_debito_estado_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('gral_condicion_iva_pde_tipo_nota_debito', 'gral_condicion_iva_pde_tipo_nota_debito.pde_tipo_nota_debito_id', 'pde_tipo_nota_debito.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_tipo_nota_debito_ws_fe_param_tipo_comprobante', 'pde_tipo_nota_debito_ws_fe_param_tipo_comprobante.pde_tipo_nota_debito_id', 'pde_tipo_nota_debito.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_nota_debito', 'pde_nota_debito.pde_tipo_nota_debito_id', 'pde_tipo_nota_debito.id', 'LEFT JOIN');

...
$us_usuario = $pan_panol_us_usuario->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PanPanolUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $pan_panol_us_usuario->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PanPanolUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

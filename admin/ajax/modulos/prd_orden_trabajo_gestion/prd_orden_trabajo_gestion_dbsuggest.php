...
if($buscar != '...'){
    ...
    $c->add('prd_orden_trabajo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_orden_trabajo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_orden_trabajo');
$c->addOrden('prd_orden_trabajo.orden', 'asc');
$c->setCriterios();

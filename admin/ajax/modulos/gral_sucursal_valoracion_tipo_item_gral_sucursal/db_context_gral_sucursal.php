...
$gral_sucursal = $gral_sucursal_valoracion_tipo_item_gral_sucursal->getGralSucursal();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalValoracionTipoItemGralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_valoracion_tipo_item_gral_sucursal->getFiltrosArrXCampo('GralSucursal', 'gral_sucursal_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalValoracionTipoItemGralSucursals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal->getDescripcion()) ?></strong>
        </a>
    </div>

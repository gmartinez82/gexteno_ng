...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_valoracion_tipo_item_gral_sucursal.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_valoracion_tipo_item_gral_sucursal.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_tipo_item_gral_sucursal.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_tipo_item_gral_sucursal.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_valoracion_tipo_item_gral_sucursal');
$c->addOrden('gral_sucursal_valoracion_tipo_item_gral_sucursal.orden', 'asc');
$c->setCriterios();

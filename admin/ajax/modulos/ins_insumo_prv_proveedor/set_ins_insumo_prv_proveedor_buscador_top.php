...
$criterio->add('ins_insumo_prv_proveedor.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('ins_insumo_prv_proveedor.codigo', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_insumo_prv_proveedor.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

...
$ws_fe_ope_solicitud = $ws_fe_ope_solicitud_iva->getWsFeOpeSolicitud();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_ope_solicitud->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo WsFeOpeSolicitudIva::getFiltrosArrGral() ?>&arr=<?php echo $ws_fe_ope_solicitud_iva->getFiltrosArrXCampo('WsFeOpeSolicitud', 'ws_fe_ope_solicitud_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('WsFeOpeSolicitudIvas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_ope_solicitud->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('gral_banco.id', Gral::getVars(1, 'buscador_gral_banco_id'), Gral::getVars(1, 'buscador_gral_banco_id_comparador'));
	$criterio->add('gral_banco.descripcion', Gral::getVars(1, 'buscador_gral_banco_descripcion'), Gral::getVars(1, 'buscador_gral_banco_descripcion_comparador'));
	$criterio->add('gral_banco.descripcion_corta', Gral::getVars(1, 'buscador_gral_banco_descripcion_corta'), Gral::getVars(1, 'buscador_gral_banco_descripcion_corta_comparador'));
	$criterio->add('gral_banco.codigo_numerico', Gral::getVars(1, 'buscador_gral_banco_codigo_numerico'), Gral::getVars(1, 'buscador_gral_banco_codigo_numerico_comparador'));
	$criterio->add('gral_banco.codigo', Gral::getVars(1, 'buscador_gral_banco_codigo'), Gral::getVars(1, 'buscador_gral_banco_codigo_comparador'));
	$criterio->add('gral_banco.observacion', Gral::getVars(1, 'buscador_gral_banco_observacion'), Gral::getVars(1, 'buscador_gral_banco_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('vta_recibo_item_cheque', 'vta_recibo_item_cheque.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('vta_comision_gral_fp_forma_pago_cheque', 'vta_comision_gral_fp_forma_pago_cheque.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_recibo_item_cheque', 'pde_recibo_item_cheque.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_orden_pago_gral_fp_forma_pago_cheque', 'pde_orden_pago_gral_fp_forma_pago_cheque.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('fnd_chq_chequera', 'fnd_chq_chequera.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');
	$criterio->addRealJoin('fnd_chq_cheque', 'fnd_chq_cheque.gral_banco_id', 'gral_banco.id', 'LEFT JOIN');

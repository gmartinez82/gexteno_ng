...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('vta_orden_venta_tipo_estado.id', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_id'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_id_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.descripcion', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_descripcion'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_descripcion_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.codigo', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_codigo'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_codigo_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.activo', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_activo'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_activo_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.terminal', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_terminal'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_terminal_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.observacion', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_observacion'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_observacion_comparador'));
	$criterio->add('vta_orden_venta_tipo_estado.estado', Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_estado'), Gral::getVars(1, 'buscador_vta_orden_venta_tipo_estado_estado_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('vta_orden_venta', 'vta_orden_venta.vta_orden_venta_tipo_estado_id', 'vta_orden_venta_tipo_estado.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('vta_orden_venta_estado', 'vta_orden_venta_estado.vta_orden_venta_tipo_estado_id', 'vta_orden_venta_tipo_estado.id', 'LEFT JOIN');

...
<div class='ficha'>
	...
	<div class='par impar'>
		...
		<div class='dato'><?php Gral::_echo($fnd_chq_cheque->getFechaEmision()) ?></div>
	</div>
		
	<div class='par '>
		<div class='label'><?php Lang::_lang('Fecha Cobro') ?></div>
		<div class='dato'><?php Gral::_echo($fnd_chq_cheque->getFechaCobro()) ?></div>
	</div>
		
	<div class='par impar'>
		<div class='label'><?php Lang::_lang('Fecha Acreditacion') ?></div>
		<div class='dato'><?php Gral::_echo($fnd_chq_cheque->getFechaAcreditacion()) ?></div>
	</div>
		
	<div class='par '>
		<div class='label'><?php Lang::_lang('Fecha Vencimiento') ?></div>
		<div class='dato'><?php Gral::_echo($fnd_chq_cheque->getFechaVencimiento()) ?></div>
	</div>

...
$vta_vendedor_gral_escenario_id = Gral::getVars(2, 'vta_vendedor_gral_escenario_id');
$vta_vendedor_gral_escenario = VtaVendedorGralEscenario::getOxId($vta_vendedor_gral_escenario_id);
$gral_escenario = $vta_vendedor_gral_escenario->getGralEscenario();
...
<div class="datos" id="<?php Gral::_echo($gral_escenario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaVendedorGralEscenario::getFiltrosArrGral() ?>&arr=<?php echo $vta_vendedor_gral_escenario->getFiltrosArrXCampo('GralEscenario', 'gral_escenario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaVendedorGralEscenarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_escenario->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pde_centro_pedido_prv_proveedor_id = Gral::getVars(2, 'pde_centro_pedido_prv_proveedor_id');
$pde_centro_pedido_prv_proveedor = PdeCentroPedidoPrvProveedor::getOxId($pde_centro_pedido_prv_proveedor_id);
$pde_centro_pedido = $pde_centro_pedido_prv_proveedor->getPdeCentroPedido();
...
<div class="datos" id="<?php Gral::_echo($pde_centro_pedido->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeCentroPedidoPrvProveedor::getFiltrosArrGral() ?>&arr=<?php echo $pde_centro_pedido_prv_proveedor->getFiltrosArrXCampo('PdeCentroPedido', 'pde_centro_pedido_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeCentroPedidoPrvProveedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_centro_pedido->getDescripcion()) ?></strong>
        </a>
    </div>

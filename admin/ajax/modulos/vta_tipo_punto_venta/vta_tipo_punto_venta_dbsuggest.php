...
VtaTipoPuntoVenta::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_tipo_punto_venta.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_tipo_punto_venta.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_tipo_punto_venta.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_tipo_punto_venta.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('vta_tipo_punto_venta');
$c->addOrden('vta_tipo_punto_venta.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = VtaTipoPuntoVenta::getVtaTipoPuntoVentas($p, $c);

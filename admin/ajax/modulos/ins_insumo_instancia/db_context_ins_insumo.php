...
$ins_insumo_instancia_id = Gral::getVars(2, 'ins_insumo_instancia_id');
$ins_insumo_instancia = InsInsumoInstancia::getOxId($ins_insumo_instancia_id);
$ins_insumo = $ins_insumo_instancia->getInsInsumo();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsInsumoInstancia::getFiltrosArrGral() ?>&arr=<?php echo $ins_insumo_instancia->getFiltrosArrXCampo('InsInsumo', 'ins_insumo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsInsumoInstancias') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('gral_tipo_iva.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_tipo_iva.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_iva.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_iva.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralTipoIva::getGralTipoIvas($p, $c);

...
$criterio->add('gen_prca_ejecucion_detalle.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('gen_prca_ejecucion_detalle.descripcion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.fechahora_inicio', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.fechahora_fin', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.iniciado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.finalizado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.codigo', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.confirmado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('gen_prca_ejecucion_detalle.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
...
$criterio->addRealJoin('gen_prca_ejecucion', 'gen_prca_ejecucion.id', 'gen_prca_ejecucion_detalle.gen_prca_ejecucion_id', 'LEFT JOIN');

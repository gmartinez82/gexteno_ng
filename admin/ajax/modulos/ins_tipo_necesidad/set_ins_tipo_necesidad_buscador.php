...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('ins_tipo_necesidad.id', Gral::getVars(1, 'buscador_ins_tipo_necesidad_id'), Gral::getVars(1, 'buscador_ins_tipo_necesidad_id_comparador'));
	$criterio->add('ins_tipo_necesidad.descripcion', Gral::getVars(1, 'buscador_ins_tipo_necesidad_descripcion'), Gral::getVars(1, 'buscador_ins_tipo_necesidad_descripcion_comparador'));
	$criterio->add('ins_tipo_necesidad.codigo', Gral::getVars(1, 'buscador_ins_tipo_necesidad_codigo'), Gral::getVars(1, 'buscador_ins_tipo_necesidad_codigo_comparador'));
	$criterio->add('ins_tipo_necesidad.observacion', Gral::getVars(1, 'buscador_ins_tipo_necesidad_observacion'), Gral::getVars(1, 'buscador_ins_tipo_necesidad_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('ins_insumo', 'ins_insumo.ins_tipo_necesidad_id', 'ins_tipo_necesidad.id', 'LEFT JOIN');

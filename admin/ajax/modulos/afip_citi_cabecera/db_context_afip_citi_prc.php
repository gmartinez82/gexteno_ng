...
$afip_citi_cabecera_id = Gral::getVars(2, 'afip_citi_cabecera_id');
...
<div class="datos" id="<?php Gral::_echo($afip_citi_prc->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiCabecera::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_cabecera->getFiltrosArrXCampo('AfipCitiPrc', 'afip_citi_prc_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiCabeceras') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($afip_citi_prc->getDescripcion()) ?></strong>
        </a>
    </div>

...
$fnd_caja = $fnd_chq_estado->getFndCaja();
...
<div class="datos" id="<?php Gral::_echo($fnd_caja->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo FndChqEstado::getFiltrosArrGral() ?>&arr=<?php echo $fnd_chq_estado->getFiltrosArrXCampo('FndCaja', 'fnd_caja_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('FndChqEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($fnd_caja->getDescripcion()) ?></strong>
        </a>
    </div>

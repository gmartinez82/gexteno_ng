...
$identificador = $ins_tipo_imagen->getId();
...
<div id="container_<?php echo $identificador ?>" class="masivo-bloque">
    ...
    <a id="refresh_<?php echo $identificador ?>" class="masivo-botones" href="?id=<?php echo $ins_insumo->getId() ?>">Actualizar Pagina</a>
</div>
...
var uploader_<?php echo $identificador ?> = new plupload.Uploader({
    ...
    max_file_size : '10mb',
        ...
        url : 'ajax/imagenes/upload_masivo_agrupado.php?padre=<?php echo $ins_insumo->getId() ?>&clase=InsInsumo&agrupacion_clase=InsTipoImagen&agrupacion_tabla=ins_tipo_imagen&agrupacion_id=<?php echo $identificador ?>',

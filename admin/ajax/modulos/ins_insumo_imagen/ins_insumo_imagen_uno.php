...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/ins_insumo_imagen/ins_insumo_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/ins_insumo_imagen/ins_insumo_imagen_uno_masinfo.php"; 
}
?>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e810_g_cam_esp_g_grup_sup.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e810_g_cam_esp_g_grup_sup.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e810_g_cam_esp_g_grup_sup.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e810_g_cam_esp_g_grup_sup.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e810_g_cam_esp_g_grup_sup');
$c->addOrden('eku_de_e810_g_cam_esp_g_grup_sup.orden', 'asc');
$c->setCriterios();

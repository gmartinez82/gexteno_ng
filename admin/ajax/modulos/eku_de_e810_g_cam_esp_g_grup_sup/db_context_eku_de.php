...
$eku_de_e810_g_cam_esp_g_grup_sup_id = Gral::getVars(2, 'eku_de_e810_g_cam_esp_g_grup_sup_id');
$eku_de_e810_g_cam_esp_g_grup_sup = EkuDeE810GCamEspGGrupSup::getOxId($eku_de_e810_g_cam_esp_g_grup_sup_id);
$eku_de = $eku_de_e810_g_cam_esp_g_grup_sup->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE810GCamEspGGrupSup::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e810_g_cam_esp_g_grup_sup->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE810GCamEspGGrupSups') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

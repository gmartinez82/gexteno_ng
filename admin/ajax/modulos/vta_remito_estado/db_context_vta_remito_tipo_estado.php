...
$vta_remito_tipo_estado = $vta_remito_estado->getVtaRemitoTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($vta_remito_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaRemitoEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_remito_estado->getFiltrosArrXCampo('VtaRemitoTipoEstado', 'vta_remito_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaRemitoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_remito_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('os_resolucion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_resolucion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_resolucion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_resolucion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_resolucion');
$c->addOrden('os_resolucion.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = OsResolucion::getOsResolucions($p, $c);

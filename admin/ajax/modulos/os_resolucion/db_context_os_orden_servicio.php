...
$os_orden_servicio = $os_resolucion->getOsOrdenServicio();
...
<div class="datos" id="<?php Gral::_echo($os_orden_servicio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo OsResolucion::getFiltrosArrGral() ?>&arr=<?php echo $os_resolucion->getFiltrosArrXCampo('OsOrdenServicio', 'os_orden_servicio_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('OsResolucions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($os_orden_servicio->getDescripcion()) ?></strong>
        </a>
    </div>

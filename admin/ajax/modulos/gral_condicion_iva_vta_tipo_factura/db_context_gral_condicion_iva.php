...
$gral_condicion_iva = $gral_condicion_iva_vta_tipo_factura->getGralCondicionIva();
...
<div class="datos" id="<?php Gral::_echo($gral_condicion_iva->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCondicionIvaVtaTipoFactura::getFiltrosArrGral() ?>&arr=<?php echo $gral_condicion_iva_vta_tipo_factura->getFiltrosArrXCampo('GralCondicionIva', 'gral_condicion_iva_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCondicionIvaVtaTipoFacturas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_condicion_iva->getDescripcion()) ?></strong>
        </a>
    </div>

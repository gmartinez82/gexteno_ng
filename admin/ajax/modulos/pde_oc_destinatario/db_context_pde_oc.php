...
$pde_oc_destinatario_id = Gral::getVars(2, 'pde_oc_destinatario_id');
$pde_oc_destinatario = PdeOcDestinatario::getOxId($pde_oc_destinatario_id);
$pde_oc = $pde_oc_destinatario->getPdeOc();
...
<div class="datos" id="<?php Gral::_echo($pde_oc->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcDestinatario::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_destinatario->getFiltrosArrXCampo('PdeOc', 'pde_oc_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcDestinatarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc->getDescripcion()) ?></strong>
        </a>
    </div>

...
<?php if (count($ins_stock_transformacions) > 0) { ?>
    ...
    <table border='0' align='center' class='listado' id='listado_adm_ins_stock_transformacion_gestion'>
        ...
        foreach ($ins_stock_transformacions as $ins_stock_transformacion) {
            ...
            <tr id="tr_ins_stock_transformacion_gestion_uno_<?php Gral::_echo($ins_stock_transformacion->getId()) ?>" class="uno" identificador="<?php Gral::_echo($ins_stock_transformacion->getId()) ?>">
                <?php include "ins_stock_transformacion_gestion_uno.php" ?>
            </tr>

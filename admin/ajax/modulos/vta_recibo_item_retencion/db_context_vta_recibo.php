...
$vta_recibo_item_retencion_id = Gral::getVars(2, 'vta_recibo_item_retencion_id');
$vta_recibo_item_retencion = VtaReciboItemRetencion::getOxId($vta_recibo_item_retencion_id);
$vta_recibo = $vta_recibo_item_retencion->getVtaRecibo();
...
<div class="datos" id="<?php Gral::_echo($vta_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaReciboItemRetencion::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_item_retencion->getFiltrosArrXCampo('VtaRecibo', 'vta_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaReciboItemRetencions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

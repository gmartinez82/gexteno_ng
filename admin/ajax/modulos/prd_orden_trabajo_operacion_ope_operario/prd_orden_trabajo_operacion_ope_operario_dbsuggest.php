...
if($buscar != '...'){
    ...
    $c->add('prd_orden_trabajo_operacion_ope_operario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_orden_trabajo_operacion_ope_operario.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_operacion_ope_operario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_operacion_ope_operario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_orden_trabajo_operacion_ope_operario');
$c->addOrden('prd_orden_trabajo_operacion_ope_operario.orden', 'asc');
$c->setCriterios();

...
$prd_orden_trabajo_operacion_ope_operario_id = Gral::getVars(2, 'prd_orden_trabajo_operacion_ope_operario_id');
...
$prd_orden_trabajo_operacion = $prd_orden_trabajo_operacion_ope_operario->getPrdOrdenTrabajoOperacion();
...
<div class="datos" id="<?php Gral::_echo($prd_orden_trabajo_operacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrdOrdenTrabajoOperacionOpeOperario::getFiltrosArrGral() ?>&arr=<?php echo $prd_orden_trabajo_operacion_ope_operario->getFiltrosArrXCampo('PrdOrdenTrabajoOperacion', 'prd_orden_trabajo_operacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrdOrdenTrabajoOperacionOpeOperarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prd_orden_trabajo_operacion->getDescripcion()) ?></strong>
        </a>
    </div>

<table border="0" class="tabla-modal">
    <tr>
        ...
        <td class="adm_tbl_encabezado" width="100" align='center'><?php Lang::_lang("Importe Bruto"); ?></td>
        <td class="adm_tbl_encabezado" width="100" align='center'><?php Lang::_lang("Descuento"); ?></td>
        <td class="adm_tbl_encabezado" width="100" align='center'><?php Lang::_lang("Importe Neto"); ?></td>

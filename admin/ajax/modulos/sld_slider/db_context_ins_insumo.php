...
$sld_slider_id = Gral::getVars(2, 'sld_slider_id');
$sld_slider = SldSlider::getOxId($sld_slider_id);
$ins_insumo = $sld_slider->getInsInsumo();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo SldSlider::getFiltrosArrGral() ?>&arr=<?php echo $sld_slider->getFiltrosArrXCampo('InsInsumo', 'ins_insumo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('SldSliders') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo->getDescripcion()) ?></strong>
        </a>
    </div>

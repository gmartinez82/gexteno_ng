...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('VTA_VENDEDOR_VALORACION_TIPO_ITEM_VTA_VENDEDOR_ADM_ACCION_ELIMINAR')){
    ...
    if($vta_vendedor_valoracion_tipo_item_vta_vendedor){
        if($vta_vendedor_valoracion_tipo_item_vta_vendedor->getHash() == $hash){
            $vta_vendedor_valoracion_tipo_item_vta_vendedor->deleteAll();
        }
    }
}    
?>

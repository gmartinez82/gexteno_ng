...
$vta_vendedor_valoracion_tipo_item = $vta_vendedor_valoracion_tipo_item_vta_vendedor->getVtaVendedorValoracionTipoItem();
...
<div class="datos" id="<?php Gral::_echo($vta_vendedor_valoracion_tipo_item->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaVendedorValoracionTipoItemVtaVendedor::getFiltrosArrGral() ?>&arr=<?php echo $vta_vendedor_valoracion_tipo_item_vta_vendedor->getFiltrosArrXCampo('VtaVendedorValoracionTipoItem', 'vta_vendedor_valoracion_tipo_item_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaVendedorValoracionTipoItemVtaVendedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_vendedor_valoracion_tipo_item->getDescripcion()) ?></strong>
        </a>
    </div>

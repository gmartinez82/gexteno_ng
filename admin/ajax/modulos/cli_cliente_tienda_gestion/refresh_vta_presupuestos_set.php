...
$o_ids = eval('return $o_padre->getVtaPresupuestoCliClienteTiendasId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_presupuesto_cli_cliente_tienda.cli_cliente_tienda_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_presupuesto');
$c->addRealJoin('vta_presupuesto_cli_cliente_tienda', 'vta_presupuesto_cli_cliente_tienda.vta_presupuesto_id', 'vta_presupuesto.id', 'LEFT JOIN');

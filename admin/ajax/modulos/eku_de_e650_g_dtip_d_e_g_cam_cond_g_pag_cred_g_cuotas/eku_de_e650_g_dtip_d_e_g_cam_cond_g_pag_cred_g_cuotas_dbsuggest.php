...
if($buscar != '...'){
    ...
    $c->add('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas');
$c->addOrden('eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas.orden', 'asc');
$c->setCriterios();

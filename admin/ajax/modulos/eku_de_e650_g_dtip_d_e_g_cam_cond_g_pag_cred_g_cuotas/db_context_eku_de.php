...
$eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas_id = Gral::getVars(2, 'eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas_id');
...
$eku_de = $eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE650GDtipDEGCamCondGPagCredGCuotas::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e650_g_dtip_d_e_g_cam_cond_g_pag_cred_g_cuotas->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE650GDtipDEGCamCondGPagCredGCuotass') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

...
$per_persona_us_usuario_id = Gral::getVars(2, 'per_persona_us_usuario_id');
$per_persona_us_usuario = PerPersonaUsUsuario::getOxId($per_persona_us_usuario_id);
$per_persona = $per_persona_us_usuario->getPerPersona();
...
<div class="datos" id="<?php Gral::_echo($per_persona->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PerPersonaUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $per_persona_us_usuario->getFiltrosArrXCampo('PerPersona', 'per_persona_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PerPersonaUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($per_persona->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans');
$c->addOrden('eku_de_e980_g_dtip_d_e_g_transp_g_cam_trans.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE980GDtipDEGTranspGCamTrans::getEkuDeE980GDtipDEGTranspGCamTranss($p, $c);

...
<form id='form_datos_adm_modificar_estado' name='form_datos_adm_modificar_estado' method='post' >
    <div class='datos modificar-estado' identificador="<?php echo $vta_hoja_ruta->getId() ?>" modulo="vta_hoja_ruta" modulo_estado="vta_hoja_ruta_estado">
        ...
        <div class="par">
            ...
            <div class="dato">
                <?php Html::html_dib_select(1, 'cmb_vta_hoja_ruta_tipo_estado_id', Gral::getCmbFiltro($vta_hoja_ruta->getVtaHojaRutaTipoEstadosPotencialesCmb(), '...'), $cmb_fnd_chq_tipo_estado_id, 'textbox') ?>
                <div class="error label-error" id="cmb_vta_hoja_ruta_tipo_estado_id_error"><?php Gral::_echo($vta_hoja_ruta_tipo_estado_id_error) ?></div>
            </div>
        </div>

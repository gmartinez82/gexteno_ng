...
if($buscar != '...'){
    ...
    $c->add('geo_provincia.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('geo_provincia.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_provincia.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_provincia.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('geo_provincia');
$c->addOrden('geo_provincia.orden', 'asc');
$c->setCriterios();

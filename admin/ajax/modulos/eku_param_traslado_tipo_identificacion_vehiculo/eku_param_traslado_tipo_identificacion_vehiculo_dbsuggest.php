...
if($buscar != '...'){
    ...
    $c->add('eku_param_traslado_tipo_identificacion_vehiculo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_traslado_tipo_identificacion_vehiculo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_traslado_tipo_identificacion_vehiculo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_traslado_tipo_identificacion_vehiculo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_traslado_tipo_identificacion_vehiculo');
$c->addOrden('eku_param_traslado_tipo_identificacion_vehiculo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTrasladoTipoIdentificacionVehiculo::getEkuParamTrasladoTipoIdentificacionVehiculos($p, $c);

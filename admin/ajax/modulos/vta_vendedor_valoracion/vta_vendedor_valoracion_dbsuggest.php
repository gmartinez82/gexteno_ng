...
VtaVendedorValoracion::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_vendedor_valoracion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_vendedor_valoracion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('vta_vendedor_valoracion');
$c->addOrden('vta_vendedor_valoracion.orden', 'asc');
$c->setCriterios();

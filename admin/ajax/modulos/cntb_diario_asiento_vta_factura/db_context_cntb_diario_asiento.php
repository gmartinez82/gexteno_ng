...
$cntb_diario_asiento = $cntb_diario_asiento_vta_factura->getCntbDiarioAsiento();
...
<div class="datos" id="<?php Gral::_echo($cntb_diario_asiento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CntbDiarioAsientoVtaFactura::getFiltrosArrGral() ?>&arr=<?php echo $cntb_diario_asiento_vta_factura->getFiltrosArrXCampo('CntbDiarioAsiento', 'cntb_diario_asiento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CntbDiarioAsientoVtaFacturas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_diario_asiento->getDescripcion()) ?></strong>
        </a>
    </div>

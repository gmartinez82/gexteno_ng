...
$cli_domicilio_id = Gral::getVars(2, 'cli_domicilio_id');
$cli_domicilio = CliDomicilio::getOxId($cli_domicilio_id);
$cli_cliente = $cli_domicilio->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliDomicilio::getFiltrosArrGral() ?>&arr=<?php echo $cli_domicilio->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliDomicilios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

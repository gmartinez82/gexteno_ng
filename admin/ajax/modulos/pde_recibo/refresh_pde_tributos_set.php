...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_recibo_pde_tributo.pde_recibo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_tributo');
$c->addRealJoin('pde_recibo_pde_tributo', 'pde_recibo_pde_tributo.pde_tributo_id', 'pde_tributo.id', 'LEFT JOIN');

...
if($buscar != '...'){
    ...
    $c->add('eku_param_caracteristicas_carga.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_caracteristicas_carga.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_caracteristicas_carga.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_caracteristicas_carga.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_caracteristicas_carga');
$c->addOrden('eku_param_caracteristicas_carga.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamCaracteristicasCarga::getEkuParamCaracteristicasCargas($p, $c);

...
<div class="datos confirmacion">
    ...
    <?php } else { ?>
        ...
        <form id='form_vta_presupuesto_gestion_edicion_confirmacion' name='form_vta_presupuesto_gestion_edicion_confirmacion' method='post' action='' vta_presupuesto_id="<?php Gral::_echo($vta_presupuesto->getId()) ?>" origen="venta_inmediata_contado">
            <div class="bloque-venta-inmediata-info-adicional-facturacion">
                ...
                <div class="col c1">
                    ...
                    <div class="par">
                        ...
                        <div class="dato">
                            <?php
                            Html::html_dib_select(1, 'cmb_confirmacion_vta_tipo_remito_id', VtaTipoRemito::getVtaTipoRemitosCmb(true), $cmb_confirmacion_vta_tipo_remito_id, 'textbox ' . $error_input_css);
                            ?>
                            <div class="label-error" id="cmb_confirmacion_vta_tipo_remito_id_error"></div>
                        </div>
                    </div>
                    ...
                    <div class="par" style="display: none;">
                        ...
                        <div class="dato">
                            <?php Html::html_dib_select(1, 'cmb_porcentaje_iva', Gral::getNumerosCmb(100, 100, 10), $cmb_porcentaje_iva, 'textbox') ?> %
        ...
        <?php if(!$restriccion_venta_por_stock){ ?>
            ...
            <div class="botonera confirmacion">        
                <div class="label-error" id="error_general_modal_error"></div>

                <button type="button" class="boton" id="btn_presupuesto_generar_venta_inmediata_contado_confirmar" name="btn_presupuesto_generar_venta_inmediata_contado_confirmar">
                    <div class="titulo">Venta Inmediata Contado</div>
                    <div class="comentario">Genera OV + Remito + Factura + Recibo</div>                              
                </button>

                <div class="checkbox">
                    <input type="checkbox" id="chk_abrir_comprobante" name="chk_abrir_comprobante" value="1" />
                    <label for="chk_abrir_comprobante">Abrir Factura al Cerrar</label>
                </div>

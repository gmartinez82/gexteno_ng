...
$cmb_confirmacion_vta_tipo_remito_ajuste_id= Gral::getVars(Gral::VARS_POST, "cmb_confirmacion_vta_tipo_remito_ajuste_id", 0);
...
$vta_presupuesto_importe_total_con_iva = $vta_presupuesto->getImporteTotalPresupuestoConIva(false, 0, $cmb_porcentaje_iva);

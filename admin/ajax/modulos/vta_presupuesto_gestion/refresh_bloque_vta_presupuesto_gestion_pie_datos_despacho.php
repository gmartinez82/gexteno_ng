...
$tipo_despacho_id = Gral::getVars(Gral::VARS_GET, 'tipo_despacho_id', 0);

if($cli_cliente_id != '-1'){
    $cli_cliente = CliCliente::getOxId($cli_cliente_id);
}
$vta_presupuesto_tipo_despacho = VtaPresupuestoTipoDespacho::getOxId($tipo_despacho_id);
...
include 'bloque_vta_presupuesto_gestion_pie_datos_despacho.php';

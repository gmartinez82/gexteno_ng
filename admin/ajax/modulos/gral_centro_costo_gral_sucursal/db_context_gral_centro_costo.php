...
$gral_centro_costo_gral_sucursal_id = Gral::getVars(2, 'gral_centro_costo_gral_sucursal_id');
$gral_centro_costo_gral_sucursal = GralCentroCostoGralSucursal::getOxId($gral_centro_costo_gral_sucursal_id);
$gral_centro_costo = $gral_centro_costo_gral_sucursal->getGralCentroCosto();
...
<div class="datos" id="<?php Gral::_echo($gral_centro_costo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCentroCostoGralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $gral_centro_costo_gral_sucursal->getFiltrosArrXCampo('GralCentroCosto', 'gral_centro_costo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCentroCostoGralSucursals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_centro_costo->getDescripcion()) ?></strong>
        </a>
    </div>

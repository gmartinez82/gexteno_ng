...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_presencia_gral_escenario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_presencia_gral_escenario');
$c->addOrden('eku_param_tipo_presencia_gral_escenario.orden', 'asc');
$c->setCriterios();

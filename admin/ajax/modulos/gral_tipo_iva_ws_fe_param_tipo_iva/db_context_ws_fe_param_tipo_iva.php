...
$ws_fe_param_tipo_iva = $gral_tipo_iva_ws_fe_param_tipo_iva->getWsFeParamTipoIva();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_param_tipo_iva->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralTipoIvaWsFeParamTipoIva::getFiltrosArrGral() ?>&arr=<?php echo $gral_tipo_iva_ws_fe_param_tipo_iva->getFiltrosArrXCampo('WsFeParamTipoIva', 'ws_fe_param_tipo_iva_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralTipoIvaWsFeParamTipoIvas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_param_tipo_iva->getDescripcion()) ?></strong>
        </a>
    </div>

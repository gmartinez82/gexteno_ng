...
if($buscar != '...'){
    ...
    $c->add('eku_param_unidad_medida.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_unidad_medida.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_unidad_medida.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_unidad_medida.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamUnidadMedida::getEkuParamUnidadMedidas($p, $c);

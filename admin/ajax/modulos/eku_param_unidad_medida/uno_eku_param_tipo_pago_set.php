...
<div class='list <?php echo $css_sel ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('EKU_PARAM_UNIDAD_MEDIDA_ALTA_RELACION_EKU_PARAM_TIPO_PAGO_ACCIONES_SELECCION')){ ?>	

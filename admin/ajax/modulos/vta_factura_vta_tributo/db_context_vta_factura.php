...
$vta_factura = $vta_factura_vta_tributo->getVtaFactura();
...
<div class="datos" id="<?php Gral::_echo($vta_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaFacturaVtaTributo::getFiltrosArrGral() ?>&arr=<?php echo $vta_factura_vta_tributo->getFiltrosArrXCampo('VtaFactura', 'vta_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaFacturaVtaTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_factura->getDescripcion()) ?></strong>
        </a>
    </div>

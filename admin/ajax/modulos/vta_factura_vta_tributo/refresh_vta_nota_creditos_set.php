...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_nota_credito_vta_factura_vta_tributo.vta_factura_vta_tributo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_nota_credito');
$c->addRealJoin('vta_nota_credito_vta_factura_vta_tributo', 'vta_nota_credito_vta_factura_vta_tributo.vta_nota_credito_id', 'vta_nota_credito.id', 'LEFT JOIN');

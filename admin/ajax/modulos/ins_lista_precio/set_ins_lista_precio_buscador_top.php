...
$criterio->add('ins_lista_precio.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('ins_lista_precio.importe_calculado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_lista_precio.importe_manual', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_lista_precio.importe_venta', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_lista_precio.porcentaje_incremento', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_lista_precio.porcentaje_descuento', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_lista_precio.cantidad_minima_venta', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

...
<table border='0' align='center' class='listado' id='listado_adm_vta_remito'>
  ...
  <tr id="tr_vta_remito_uno_<?php Gral::_echo($vta_remito->getId()) ?>" class="uno" identificador="<?php Gral::_echo($vta_remito->getId()) ?>">
  	<?php include "vta_remito_uno.php" ?>
  </tr>
  
  
  <tr id='tr_eliminar_<?php Gral::_echo($vta_remito->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($vta_remito->getId()) ?>" >
	<td colspan='15' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($vta_remito->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />

<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/os_orden_servicio/set_os_orden_servicio_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='os_orden_servicio_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('OsOrdenServicio') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='os_orden_servicio'><img src="imgs/btn_lupa.png" width="25"></label>

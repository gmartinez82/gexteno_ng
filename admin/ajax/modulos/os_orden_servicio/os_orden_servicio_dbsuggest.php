...
if($buscar != '...'){
    ...
    $c->add('os_orden_servicio.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_orden_servicio.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_orden_servicio');
$c->addOrden('os_orden_servicio.orden', 'asc');
$c->setCriterios();

...
if($buscar != '...'){
    ...
    $c->add('ctrl_equipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ctrl_equipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ctrl_equipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ctrl_equipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = CtrlEquipo::getCtrlEquipos($p, $c);

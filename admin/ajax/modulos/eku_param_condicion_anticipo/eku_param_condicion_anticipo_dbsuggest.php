...
if($buscar != '...'){
    ...
    $c->add('eku_param_condicion_anticipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_condicion_anticipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_anticipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_anticipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_condicion_anticipo');
$c->addOrden('eku_param_condicion_anticipo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamCondicionAnticipo::getEkuParamCondicionAnticipos($p, $c);

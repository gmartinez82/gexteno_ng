...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_centro_pedido_pde_centro_recepcion.pde_centro_recepcion_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_centro_pedido');
$c->addRealJoin('pde_centro_pedido_pde_centro_recepcion', 'pde_centro_pedido_pde_centro_recepcion.pde_centro_pedido_id', 'pde_centro_pedido.id', 'LEFT JOIN');

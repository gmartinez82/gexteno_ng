...
if($buscar != '...'){
    ...
    $c->add('eku_de_d001_g_dat_gral_ope.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_d001_g_dat_gral_ope.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d001_g_dat_gral_ope.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d001_g_dat_gral_ope.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_d001_g_dat_gral_ope');
$c->addOrden('eku_de_d001_g_dat_gral_ope.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeD001GDatGralOpe::getEkuDeD001GDatGralOpes($p, $c);

...
if($buscar != '...'){
    ...
    $c->add('eku_de_f001_g_tot_sub.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_f001_g_tot_sub.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_f001_g_tot_sub.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_f001_g_tot_sub.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_f001_g_tot_sub');
$c->addOrden('eku_de_f001_g_tot_sub.orden', 'asc');
$c->setCriterios();

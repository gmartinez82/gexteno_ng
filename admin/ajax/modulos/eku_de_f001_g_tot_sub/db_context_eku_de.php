...
$eku_de_f001_g_tot_sub_id = Gral::getVars(2, 'eku_de_f001_g_tot_sub_id');
$eku_de_f001_g_tot_sub = EkuDeF001GTotSub::getOxId($eku_de_f001_g_tot_sub_id);
$eku_de = $eku_de_f001_g_tot_sub->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeF001GTotSub::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_f001_g_tot_sub->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeF001GTotSubs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

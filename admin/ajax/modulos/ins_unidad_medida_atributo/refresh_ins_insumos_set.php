...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('ins_insumo_ins_atributo.ins_unidad_medida_atributo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_insumo');
$c->addRealJoin('ins_insumo_ins_atributo', 'ins_insumo_ins_atributo.ins_insumo_id', 'ins_insumo.id', 'LEFT JOIN');

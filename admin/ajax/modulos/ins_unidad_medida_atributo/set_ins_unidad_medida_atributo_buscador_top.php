...
$criterio->add('ins_unidad_medida_atributo.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('ins_unidad_medida_atributo.descripcion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('ins_unidad_medida_atributo.descripcion_corta', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

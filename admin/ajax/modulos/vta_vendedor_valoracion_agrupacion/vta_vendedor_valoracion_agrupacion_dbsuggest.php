...
VtaVendedorValoracionAgrupacion::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_vendedor_valoracion_agrupacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_vendedor_valoracion_agrupacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion_agrupacion.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion_agrupacion.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion_agrupacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('vta_vendedor_valoracion_agrupacion');
$c->addOrden('vta_vendedor_valoracion_agrupacion.orden', 'asc');
$c->setCriterios();

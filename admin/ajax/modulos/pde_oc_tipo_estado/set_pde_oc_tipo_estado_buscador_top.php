...
$criterio->add('pde_oc_tipo_estado.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('pde_oc_tipo_estado.activo', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('pde_oc_tipo_estado.afecta_presupuesto', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

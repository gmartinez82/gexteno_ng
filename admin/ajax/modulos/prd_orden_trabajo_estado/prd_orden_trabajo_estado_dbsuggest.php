...
if($buscar != '...'){
    ...
    $c->add('prd_orden_trabajo_estado.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_orden_trabajo_estado.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_estado.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_estado.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_orden_trabajo_estado');
$c->addOrden('prd_orden_trabajo_estado.orden', 'asc');
$c->setCriterios();

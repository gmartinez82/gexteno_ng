...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('ml_attribute_ml_value.ml_value_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ml_attribute');
$c->addRealJoin('ml_attribute_ml_value', 'ml_attribute_ml_value.ml_attribute_id', 'ml_attribute.id', 'LEFT JOIN');

...
$criterio->add('gral_fp_medio_pago.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('gral_fp_medio_pago.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
...
$criterio->addRealJoin('gral_fp_forma_pago', 'gral_fp_forma_pago.id', 'gral_fp_medio_pago.gral_fp_forma_pago_id', 'LEFT JOIN');

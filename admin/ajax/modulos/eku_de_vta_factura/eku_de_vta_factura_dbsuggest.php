...
if($buscar != '...'){
    ...
    $c->add('eku_de_vta_factura.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_vta_factura.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_factura.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_factura.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_vta_factura');
$c->addOrden('eku_de_vta_factura.orden', 'asc');
$c->setCriterios();

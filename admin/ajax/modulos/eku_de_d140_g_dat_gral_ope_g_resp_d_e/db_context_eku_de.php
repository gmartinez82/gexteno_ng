...
$eku_de_d140_g_dat_gral_ope_g_resp_d_e_id = Gral::getVars(2, 'eku_de_d140_g_dat_gral_ope_g_resp_d_e_id');
$eku_de_d140_g_dat_gral_ope_g_resp_d_e = EkuDeD140GDatGralOpeGRespDE::getOxId($eku_de_d140_g_dat_gral_ope_g_resp_d_e_id);
$eku_de = $eku_de_d140_g_dat_gral_ope_g_resp_d_e->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeD140GDatGralOpeGRespDE::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_d140_g_dat_gral_ope_g_resp_d_e->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeD140GDatGralOpeGRespDEs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

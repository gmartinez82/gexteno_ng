...
if($buscar != '...'){
    ...
    $c->add('eku_param_condicion_credito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_condicion_credito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_credito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_credito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_condicion_credito');
$c->addOrden('eku_param_condicion_credito.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamCondicionCredito::getEkuParamCondicionCreditos($p, $c);

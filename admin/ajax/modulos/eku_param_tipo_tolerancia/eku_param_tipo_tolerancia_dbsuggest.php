...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_tolerancia.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_tolerancia.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_tolerancia.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_tolerancia.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_tolerancia');
$c->addOrden('eku_param_tipo_tolerancia.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoTolerancia::getEkuParamTipoTolerancias($p, $c);

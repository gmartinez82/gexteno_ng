...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_afectacion_tributaria_gral_tipo_iva.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_afectacion_tributaria_gral_tipo_iva');
$c->addOrden('eku_param_tipo_afectacion_tributaria_gral_tipo_iva.orden', 'asc');
$c->setCriterios();

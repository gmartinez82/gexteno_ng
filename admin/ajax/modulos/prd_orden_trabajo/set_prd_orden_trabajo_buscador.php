...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('prd_orden_trabajo.prd_orden_trabajo_tipo_estado_id', Gral::getVars(1, 'buscador_prd_orden_trabajo_prd_orden_trabajo_tipo_estado_id'), Gral::getVars(1, 'buscador_prd_orden_trabajo_prd_orden_trabajo_tipo_estado_id_comparador'));

...
<form id='form_datos_adm_modificar_estado' name='form_datos_adm_modificar_estado' method='post' >
    <div class='datos modificar-estado' identificador="<?php echo $prd_orden_trabajo->getId() ?>" modulo="prd_orden_trabajo" modulo_estado="prd_orden_trabajo_estado">
        ...
        <div class="par">
            ...
            <div class="dato">
                <?php Html::html_dib_select(1, 'cmb_prd_orden_trabajo_tipo_estado_id', Gral::getCmbFiltro($prd_orden_trabajo->getPrdOrdenTrabajoTipoEstadosPotencialesCmb(), '...'), $cmb_fnd_chq_tipo_estado_id, 'textbox') ?>
                <div class="error label-error" id="cmb_prd_orden_trabajo_tipo_estado_id_error"><?php Gral::_echo($prd_orden_trabajo_tipo_estado_id_error) ?></div>
            </div>
        </div>

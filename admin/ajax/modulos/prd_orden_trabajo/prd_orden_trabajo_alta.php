...
if(Gral::esPost()){
	...
	$prd_orden_trabajo->setPrdOrdenTrabajoTipoEstadoId(Gral::getVars(1, "prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id", null));
...
?>
<body>
<form id='formu' name='formu' method='post' action='ajax/modulos/prd_orden_trabajo/prd_orden_trabajo_alta.php' >
      <?php //include 'parciales/confirmacion.php';?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_prd_orden_trabajo_tipo_estado_id' ?>" >
				  
                                        <?php Lang::_lang('PrdOrdenTrabajoTipoEstado', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('prd_orden_trabajo_tipo_estado_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id', Gral::getCmbFiltro(PrdOrdenTrabajoTipoEstado::getPrdOrdenTrabajoTipoEstadosCmb(), '...'), $prd_orden_trabajo->getPrdOrdenTrabajoTipoEstadoId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('PRD_ORDEN_TRABAJO_ALTA_CMB_EDIT_PRD_ORDEN_TRABAJO_TIPO_ESTADO')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id" clase_id="prd_orden_trabajo_tipo_estado" prefijo='prd_orden_trabajo_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_prd_orden_trabajo_tipo_estado_id" <?php echo ($prd_orden_trabajo->getPrdOrdenTrabajoTipoEstadoId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id" clase_id="prd_orden_trabajo_tipo_estado" prefijo='prd_orden_trabajo_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_prd_orden_trabajo_cmb_prd_orden_trabajo_tipo_estado_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_prd_orden_trabajo_alta_prd_orden_trabajo_tipo_estado_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_prd_orden_trabajo_alta_prd_orden_trabajo_tipo_estado_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_prd_orden_trabajo_alta_prd_orden_trabajo_tipo_estado_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_prd_orden_trabajo_alta_prd_orden_trabajo_tipo_estado_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>

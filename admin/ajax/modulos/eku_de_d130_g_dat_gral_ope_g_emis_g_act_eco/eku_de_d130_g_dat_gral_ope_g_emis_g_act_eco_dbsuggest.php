...
if($buscar != '...'){
    ...
    $c->add('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco');
$c->addOrden('eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco.orden', 'asc');
$c->setCriterios();

...
$eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco_id = Gral::getVars(2, 'eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco_id');
...
$eku_de = $eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeD130GDatGralOpeGEmisGActEco::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_d130_g_dat_gral_ope_g_emis_g_act_eco->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeD130GDatGralOpeGEmisGActEcos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

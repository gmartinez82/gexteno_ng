...
if(!UsCredencial::getEsAcreditado('VTA_POLITICA_DESCUENTO_ALTA')){
    echo "No tiene asignada la credencial VTA_POLITICA_DESCUENTO_ALTA. ";
    return false;
}
...
?>
<body>
<form id='formu' name='formu' method='post' action='ajax/modulos/vta_politica_descuento/vta_politica_descuento_alta.php' >

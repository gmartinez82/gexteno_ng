...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_politica_descuento_ins_insumo.vta_politica_descuento_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_insumo');
$c->addRealJoin('vta_politica_descuento_ins_insumo', 'vta_politica_descuento_ins_insumo.ins_insumo_id', 'ins_insumo.id', 'LEFT JOIN');

...
if($buscar != '...'){
    ...
    $c->add('eku_param_actividad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_actividad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_actividad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_actividad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_actividad');
$c->addOrden('eku_param_actividad.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamActividad::getEkuParamActividads($p, $c);

...
$pdi_pedido_agrupacion_item_id = Gral::getVars(2, 'pdi_pedido_agrupacion_item_id');
$pdi_pedido_agrupacion_item = PdiPedidoAgrupacionItem::getOxId($pdi_pedido_agrupacion_item_id);
$pdi_pedido_agrupacion = $pdi_pedido_agrupacion_item->getPdiPedidoAgrupacion();
...
<div class="datos" id="<?php Gral::_echo($pdi_pedido_agrupacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdiPedidoAgrupacionItem::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido_agrupacion_item->getFiltrosArrXCampo('PdiPedidoAgrupacion', 'pdi_pedido_agrupacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdiPedidoAgrupacionItems') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pdi_pedido_agrupacion->getDescripcion()) ?></strong>
        </a>
    </div>

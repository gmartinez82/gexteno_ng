...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pde_tipo_factura.id', Gral::getVars(1, 'buscador_pde_tipo_factura_id'), Gral::getVars(1, 'buscador_pde_tipo_factura_id_comparador'));
	$criterio->add('pde_tipo_factura.descripcion', Gral::getVars(1, 'buscador_pde_tipo_factura_descripcion'), Gral::getVars(1, 'buscador_pde_tipo_factura_descripcion_comparador'));
	$criterio->add('pde_tipo_factura.codigo', Gral::getVars(1, 'buscador_pde_tipo_factura_codigo'), Gral::getVars(1, 'buscador_pde_tipo_factura_codigo_comparador'));
	$criterio->add('pde_tipo_factura.codigo_min', Gral::getVars(1, 'buscador_pde_tipo_factura_codigo_min'), Gral::getVars(1, 'buscador_pde_tipo_factura_codigo_min_comparador'));
	$criterio->add('pde_tipo_factura.informa', Gral::getVars(1, 'buscador_pde_tipo_factura_informa'), Gral::getVars(1, 'buscador_pde_tipo_factura_informa_comparador'));
	$criterio->add('pde_tipo_factura.observacion', Gral::getVars(1, 'buscador_pde_tipo_factura_observacion'), Gral::getVars(1, 'buscador_pde_tipo_factura_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('gral_condicion_iva_pde_tipo_factura', 'gral_condicion_iva_pde_tipo_factura.pde_tipo_factura_id', 'pde_tipo_factura.id', 'LEFT JOIN');
	$criterio->addRealJoin('gral_condicion_iva', 'gral_condicion_iva.id', 'gral_condicion_iva_pde_tipo_factura.gral_condicion_iva_id', 'LEFT JOIN');
	$criterio->addRealJoin('pde_tipo_factura_ws_fe_param_tipo_comprobante', 'pde_tipo_factura_ws_fe_param_tipo_comprobante.pde_tipo_factura_id', 'pde_tipo_factura.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_factura', 'pde_factura.pde_tipo_factura_id', 'pde_tipo_factura.id', 'LEFT JOIN');

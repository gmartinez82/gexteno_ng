...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('gral_condicion_iva_pde_tipo_factura.pde_tipo_factura_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_condicion_iva');
$c->addRealJoin('gral_condicion_iva_pde_tipo_factura', 'gral_condicion_iva_pde_tipo_factura.gral_condicion_iva_id', 'gral_condicion_iva.id', 'LEFT JOIN');

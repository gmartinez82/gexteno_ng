...
$vta_nota_credito_vta_tributo_id = Gral::getVars(2, 'vta_nota_credito_vta_tributo_id');
$vta_nota_credito_vta_tributo = VtaNotaCreditoVtaTributo::getOxId($vta_nota_credito_vta_tributo_id);
$vta_nota_credito = $vta_nota_credito_vta_tributo->getVtaNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaCreditoVtaTributo::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_credito_vta_tributo->getFiltrosArrXCampo('VtaNotaCredito', 'vta_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaCreditoVtaTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

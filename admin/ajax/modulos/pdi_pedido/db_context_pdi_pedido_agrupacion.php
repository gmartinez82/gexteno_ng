...
$pdi_pedido_agrupacion = $pdi_pedido->getPdiPedidoAgrupacion();
...
<div class="datos" id="<?php Gral::_echo($pdi_pedido_agrupacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdiPedido::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido->getFiltrosArrXCampo('PdiPedidoAgrupacion', 'pdi_pedido_agrupacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdiPedidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pdi_pedido_agrupacion->getDescripcion()) ?></strong>
        </a>
    </div>

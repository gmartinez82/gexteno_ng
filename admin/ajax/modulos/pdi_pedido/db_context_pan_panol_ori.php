...
$pan_panol_ori = $pdi_pedido->getPanPanolOri();
...
<div class="datos" id="<?php Gral::_echo($pan_panol_ori->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdiPedido::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido->getFiltrosArrXCampo('PanPanolOri', 'pan_panol_ori_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdiPedidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pan_panol_ori->getDescripcion()) ?></strong>
        </a>
    </div>

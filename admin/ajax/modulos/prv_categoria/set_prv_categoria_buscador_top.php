...
$criterio->add('prv_categoria.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('prv_categoria.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

...
$pde_recibo_imagen_id = Gral::getVars(2, 'pde_recibo_imagen_id');
$pde_recibo_imagen = PdeReciboImagen::getOxId($pde_recibo_imagen_id);
$pde_recibo = $pde_recibo_imagen->getPdeRecibo();
...
<div class="datos" id="<?php Gral::_echo($pde_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeReciboImagen::getFiltrosArrGral() ?>&arr=<?php echo $pde_recibo_imagen->getFiltrosArrXCampo('PdeRecibo', 'pde_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeReciboImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/pde_recibo_imagen/pde_recibo_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/pde_recibo_imagen/pde_recibo_imagen_uno_masinfo.php"; 
}
?>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e700_g_dtip_d_e_g_cam_item.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e700_g_dtip_d_e_g_cam_item.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e700_g_dtip_d_e_g_cam_item.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e700_g_dtip_d_e_g_cam_item.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e700_g_dtip_d_e_g_cam_item');
$c->addOrden('eku_de_e700_g_dtip_d_e_g_cam_item.orden', 'asc');
$c->setCriterios();

...
$vta_nota_debito_vta_nota_credito_id = Gral::getVars(2, 'vta_nota_debito_vta_nota_credito_id');
...
<div class="datos" id="<?php Gral::_echo($vta_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaDebitoVtaNotaCredito::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_debito_vta_nota_credito->getFiltrosArrXCampo('VtaNotaCredito', 'vta_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaDebitoVtaNotaCreditos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

...
$criterio->add('cntb_diario_asiento_vta_nota_credito.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('cntb_diario_asiento_vta_nota_credito.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

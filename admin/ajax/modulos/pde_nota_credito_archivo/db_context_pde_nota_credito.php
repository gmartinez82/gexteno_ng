...
$pde_nota_credito_archivo_id = Gral::getVars(2, 'pde_nota_credito_archivo_id');
$pde_nota_credito_archivo = PdeNotaCreditoArchivo::getOxId($pde_nota_credito_archivo_id);
$pde_nota_credito = $pde_nota_credito_archivo->getPdeNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaCreditoArchivo::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_credito_archivo->getFiltrosArrXCampo('PdeNotaCredito', 'pde_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaCreditoArchivos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

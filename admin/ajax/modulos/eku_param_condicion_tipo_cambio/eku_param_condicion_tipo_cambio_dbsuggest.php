...
if($buscar != '...'){
    ...
    $c->add('eku_param_condicion_tipo_cambio.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_condicion_tipo_cambio.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_tipo_cambio.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_condicion_tipo_cambio.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_condicion_tipo_cambio');
$c->addOrden('eku_param_condicion_tipo_cambio.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamCondicionTipoCambio::getEkuParamCondicionTipoCambios($p, $c);

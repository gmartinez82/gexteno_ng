...
$pde_oc_tipo_origen = $pde_oc->getPdeOcTipoOrigen();
...
<div class="datos" id="<?php Gral::_echo($pde_oc_tipo_origen->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOc::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc->getFiltrosArrXCampo('PdeOcTipoOrigen', 'pde_oc_tipo_origen_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc_tipo_origen->getDescripcion()) ?></strong>
        </a>
    </div>

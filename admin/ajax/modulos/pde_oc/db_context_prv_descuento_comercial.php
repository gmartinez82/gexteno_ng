...
$prv_descuento_comercial = $pde_oc->getPrvDescuentoComercial();
...
<div class="datos" id="<?php Gral::_echo($prv_descuento_comercial->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOc::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc->getFiltrosArrXCampo('PrvDescuentoComercial', 'prv_descuento_comercial_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_descuento_comercial->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pdi_pedido_agrupacion = $pdi_pedido_agrupacion_estado->getPdiPedidoAgrupacion();
...
<div class="datos" id="<?php Gral::_echo($pdi_pedido_agrupacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdiPedidoAgrupacionEstado::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido_agrupacion_estado->getFiltrosArrXCampo('PdiPedidoAgrupacion', 'pdi_pedido_agrupacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdiPedidoAgrupacionEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pdi_pedido_agrupacion->getDescripcion()) ?></strong>
        </a>
    </div>

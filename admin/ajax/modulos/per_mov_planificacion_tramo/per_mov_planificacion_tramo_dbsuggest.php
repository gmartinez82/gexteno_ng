...
if($buscar != '...'){
    ...
    $c->add('per_mov_planificacion_tramo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('per_mov_planificacion_tramo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_mov_planificacion_tramo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_mov_planificacion_tramo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('per_mov_planificacion_tramo');
$c->addOrden('per_mov_planificacion_tramo.orden', 'asc');
$c->setCriterios();

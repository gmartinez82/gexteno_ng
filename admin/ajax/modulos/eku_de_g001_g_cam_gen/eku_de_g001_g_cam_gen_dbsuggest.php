...
if($buscar != '...'){
    ...
    $c->add('eku_de_g001_g_cam_gen.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_g001_g_cam_gen.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_g001_g_cam_gen.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_g001_g_cam_gen.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_g001_g_cam_gen');
$c->addOrden('eku_de_g001_g_cam_gen.orden', 'asc');
$c->setCriterios();

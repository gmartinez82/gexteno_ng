...
$eku_de_g001_g_cam_gen_id = Gral::getVars(2, 'eku_de_g001_g_cam_gen_id');
$eku_de_g001_g_cam_gen = EkuDeG001GCamGen::getOxId($eku_de_g001_g_cam_gen_id);
$eku_de = $eku_de_g001_g_cam_gen->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeG001GCamGen::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_g001_g_cam_gen->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeG001GCamGens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

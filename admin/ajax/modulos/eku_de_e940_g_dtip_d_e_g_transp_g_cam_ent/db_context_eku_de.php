...
$eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent_id = Gral::getVars(2, 'eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent_id');
...
$eku_de = $eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE940GDtipDEGTranspGCamEnt::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE940GDtipDEGTranspGCamEnts') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent');
$c->addOrden('eku_de_e940_g_dtip_d_e_g_transp_g_cam_ent.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE940GDtipDEGTranspGCamEnt::getEkuDeE940GDtipDEGTranspGCamEnts($p, $c);

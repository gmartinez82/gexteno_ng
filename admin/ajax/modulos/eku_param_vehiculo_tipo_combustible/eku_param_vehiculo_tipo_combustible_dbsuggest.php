...
if($buscar != '...'){
    ...
    $c->add('eku_param_vehiculo_tipo_combustible.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_vehiculo_tipo_combustible.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_vehiculo_tipo_combustible.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_vehiculo_tipo_combustible.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_vehiculo_tipo_combustible');
$c->addOrden('eku_param_vehiculo_tipo_combustible.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamVehiculoTipoCombustible::getEkuParamVehiculoTipoCombustibles($p, $c);

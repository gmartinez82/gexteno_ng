...
$pde_recibo_archivo_id = Gral::getVars(2, 'pde_recibo_archivo_id');
$pde_recibo_archivo = PdeReciboArchivo::getOxId($pde_recibo_archivo_id);
$pde_recibo = $pde_recibo_archivo->getPdeRecibo();
...
<div class="datos" id="<?php Gral::_echo($pde_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeReciboArchivo::getFiltrosArrGral() ?>&arr=<?php echo $pde_recibo_archivo->getFiltrosArrXCampo('PdeRecibo', 'pde_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeReciboArchivos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

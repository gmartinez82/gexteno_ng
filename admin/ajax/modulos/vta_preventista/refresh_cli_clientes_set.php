...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('cli_cliente_vta_preventista.vta_preventista_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_vta_preventista', 'cli_cliente_vta_preventista.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

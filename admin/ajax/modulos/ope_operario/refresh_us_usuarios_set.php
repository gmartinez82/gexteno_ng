...
$c->add('ope_operario_us_usuario.ope_operario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('ope_operario_us_usuario', 'ope_operario_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

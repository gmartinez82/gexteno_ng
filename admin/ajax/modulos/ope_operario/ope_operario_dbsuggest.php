...
if($buscar != '...'){
    ...
    $c->add('ope_operario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ope_operario.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ope_operario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ope_operario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

...
$pde_recepcion_destinatario_id = Gral::getVars(2, 'pde_recepcion_destinatario_id');
$pde_recepcion_destinatario = PdeRecepcionDestinatario::getOxId($pde_recepcion_destinatario_id);
$pde_recepcion = $pde_recepcion_destinatario->getPdeRecepcion();
...
<div class="datos" id="<?php Gral::_echo($pde_recepcion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeRecepcionDestinatario::getFiltrosArrGral() ?>&arr=<?php echo $pde_recepcion_destinatario->getFiltrosArrXCampo('PdeRecepcion', 'pde_recepcion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeRecepcionDestinatarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_recepcion->getDescripcion()) ?></strong>
        </a>
    </div>

...
$c->add('eku_param_tipo_presencia_gral_escenario.eku_param_tipo_presencia_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_escenario');
$c->addRealJoin('eku_param_tipo_presencia_gral_escenario', 'eku_param_tipo_presencia_gral_escenario.gral_escenario_id', 'gral_escenario.id', 'LEFT JOIN');

...
$criterio->add('eku_param_tipo_presencia.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('eku_param_tipo_presencia.codigo_eku', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_tipo_presencia.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_tipo_presencia.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

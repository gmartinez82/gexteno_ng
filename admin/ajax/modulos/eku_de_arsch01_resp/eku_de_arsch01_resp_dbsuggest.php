...
EkuDeArsch01Resp::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('eku_de_arsch01_resp.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_arsch01_resp.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_arsch01_resp.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_arsch01_resp.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_arsch01_resp');
$c->addOrden('eku_de_arsch01_resp.orden', 'asc');
$c->setCriterios();

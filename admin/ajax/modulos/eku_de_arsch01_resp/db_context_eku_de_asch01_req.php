...
$eku_de_asch01_req = $eku_de_arsch01_resp->getEkuDeAsch01Req();
...
<div class="datos" id="<?php Gral::_echo($eku_de_asch01_req->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeArsch01Resp::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_arsch01_resp->getFiltrosArrXCampo('EkuDeAsch01Req', 'eku_de_asch01_req_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeArsch01Resps') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de_asch01_req->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_tributo_id = Gral::getVars(2, 'vta_tributo_id');
$vta_tributo = VtaTributo::getOxId($vta_tributo_id);
$cntb_cuenta = $vta_tributo->getCntbCuenta();
...
<div class="datos" id="<?php Gral::_echo($cntb_cuenta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTributo::getFiltrosArrGral() ?>&arr=<?php echo $vta_tributo->getFiltrosArrXCampo('CntbCuenta', 'cntb_cuenta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_cuenta->getDescripcion()) ?></strong>
        </a>
    </div>

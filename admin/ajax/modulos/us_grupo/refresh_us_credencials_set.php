...
$o_ids = eval('return $o_padre->getUsAgrupadorsId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('us_agrupador.us_grupo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_credencial');
$c->addRealJoin('us_agrupador', 'us_agrupador.us_credencial_id', 'us_credencial.id', 'LEFT JOIN');

...
$o_ids = eval('return $o_padre->getNovNovedadUsGruposId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('nov_novedad_us_grupo.us_grupo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('nov_novedad');
$c->addRealJoin('nov_novedad_us_grupo', 'nov_novedad_us_grupo.nov_novedad_id', 'nov_novedad.id', 'LEFT JOIN');

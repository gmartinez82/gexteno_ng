...
if($buscar != '...'){
    ...
    $c->add('cli_tipo_cliente.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('cli_tipo_cliente.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_tipo_cliente.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_tipo_cliente.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = CliTipoCliente::getCliTipoClientes($p, $c);

...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_DE_E720_G_DTIP_D_E_G_CAM_ITEM_G_VALOR_ITEM_ADM_ACCION_ELIMINAR')){
    ...
    if($eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item){
        if($eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->getHash() == $hash){
            $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->deleteAll();
        }
    }
}    
?>

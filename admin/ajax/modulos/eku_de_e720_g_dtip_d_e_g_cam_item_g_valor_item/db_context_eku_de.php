...
$eku_de = $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE720GDtipDEGCamItemGValorItem::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE720GDtipDEGCamItemGValorItems') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

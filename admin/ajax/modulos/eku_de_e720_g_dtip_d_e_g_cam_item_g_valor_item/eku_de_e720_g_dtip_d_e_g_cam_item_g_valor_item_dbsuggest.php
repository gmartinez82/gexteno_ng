...
if($buscar != '...'){
    ...
    $c->add('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item');
$c->addOrden('eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE720GDtipDEGCamItemGValorItem::getEkuDeE720GDtipDEGCamItemGValorItems($p, $c);

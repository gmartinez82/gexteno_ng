...
if(UsCredencial::getEsAcreditado('EKU_DE_E720_G_DTIP_D_E_G_CAM_ITEM_G_VALOR_ITEM_ALTA')){
    ...
    // -------------------------------------------------------------------------
    $valor = EkuDeE720GDtipDEGCamItemGValorItem::getSaneamientoParaRegistroSimple($campo, $valor, $type, $mascara);
    ...
    $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item = EkuDeE720GDtipDEGCamItemGValorItem::getOxId($identificador);
    if($eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item){
        if($eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->getHash() == $hash){
            ...
            // -----------------------------------------------------------------
            eval("\$eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->set".Gral::getCamelCase($campo).'($valor);');
            
            $db_error = $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->control();
            ...
            if(!$arr['error']){
                ...
                // -------------------------------------------------------------
                $eku_de_e720_g_dtip_d_e_g_cam_item_g_valor_item->saveDesdeListado($campo, $valor);
            }

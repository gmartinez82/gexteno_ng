...
if($buscar != '...'){
    ...
    $c->add('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras');
$c->addOrden('eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras.orden', 'asc');
$c->setCriterios();

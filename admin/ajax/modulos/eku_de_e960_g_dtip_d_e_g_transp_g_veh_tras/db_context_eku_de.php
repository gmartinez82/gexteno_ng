...
$eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras_id = Gral::getVars(2, 'eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras_id');
...
$eku_de = $eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE960GDtipDEGTranspGVehTras::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e960_g_dtip_d_e_g_transp_g_veh_tras->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE960GDtipDEGTranspGVehTrass') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

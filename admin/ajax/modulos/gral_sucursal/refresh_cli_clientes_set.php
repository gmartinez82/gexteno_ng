...
$c->add('gral_sucursal_cli_cliente.gral_sucursal_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('gral_sucursal_cli_cliente', 'gral_sucursal_cli_cliente.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

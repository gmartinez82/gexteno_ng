...
$c->add('gral_sucursal_vta_vendedor.gral_sucursal_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('gral_sucursal_vta_vendedor', 'gral_sucursal_vta_vendedor.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

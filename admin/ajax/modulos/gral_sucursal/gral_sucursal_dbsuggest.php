...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

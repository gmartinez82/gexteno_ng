...
$c->add('gral_sucursal_us_usuario.gral_sucursal_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('gral_sucursal_us_usuario', 'gral_sucursal_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

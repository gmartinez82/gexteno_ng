...
$o_ids = eval('return $o_padre->getGralSucursalVtaPuntoVentasId();');
...
$c->add('gral_sucursal_vta_punto_venta.gral_sucursal_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_punto_venta');
$c->addRealJoin('gral_sucursal_vta_punto_venta', 'gral_sucursal_vta_punto_venta.vta_punto_venta_id', 'vta_punto_venta.id', 'LEFT JOIN');

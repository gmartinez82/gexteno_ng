...
$gral_empresa = $gral_sucursal->getGralEmpresa();
...
<div class="datos" id="<?php Gral::_echo($gral_empresa->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_empresa->getDescripcion()) ?></strong>
        </a>
    </div>

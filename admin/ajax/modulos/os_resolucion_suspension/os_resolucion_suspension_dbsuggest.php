...
if($buscar != '...'){
    ...
    $c->add('os_resolucion_suspension.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_resolucion_suspension.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_resolucion_suspension.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_resolucion_suspension.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_resolucion_suspension');
$c->addOrden('os_resolucion_suspension.orden', 'asc');
$c->setCriterios();

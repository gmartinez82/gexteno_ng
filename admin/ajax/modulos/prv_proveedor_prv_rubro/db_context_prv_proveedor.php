...
$prv_proveedor = $prv_proveedor_prv_rubro->getPrvProveedor();
...
<div class="datos" id="<?php Gral::_echo($prv_proveedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvProveedorPrvRubro::getFiltrosArrGral() ?>&arr=<?php echo $prv_proveedor_prv_rubro->getFiltrosArrXCampo('PrvProveedor', 'prv_proveedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvProveedorPrvRubros') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_proveedor->getDescripcion()) ?></strong>
        </a>
    </div>

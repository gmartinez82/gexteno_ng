...
$ins_tipo_lista_precio = $vta_politica_descuento_ins_tipo_lista_precio->getInsTipoListaPrecio();
...
<div class="datos" id="<?php Gral::_echo($ins_tipo_lista_precio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPoliticaDescuentoInsTipoListaPrecio::getFiltrosArrGral() ?>&arr=<?php echo $vta_politica_descuento_ins_tipo_lista_precio->getFiltrosArrXCampo('InsTipoListaPrecio', 'ins_tipo_lista_precio_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPoliticaDescuentoInsTipoListaPrecios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_tipo_lista_precio->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_politica_descuento_ins_tipo_lista_precio_id = Gral::getVars(2, 'vta_politica_descuento_ins_tipo_lista_precio_id');
...
$vta_politica_descuento = $vta_politica_descuento_ins_tipo_lista_precio->getVtaPoliticaDescuento();
...
<div class="datos" id="<?php Gral::_echo($vta_politica_descuento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPoliticaDescuentoInsTipoListaPrecio::getFiltrosArrGral() ?>&arr=<?php echo $vta_politica_descuento_ins_tipo_lista_precio->getFiltrosArrXCampo('VtaPoliticaDescuento', 'vta_politica_descuento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPoliticaDescuentoInsTipoListaPrecios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_politica_descuento->getDescripcion()) ?></strong>
        </a>
    </div>

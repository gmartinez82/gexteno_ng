...
$pde_nota_debito = $afip_citi_compras_cbte->getPdeNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiComprasCbte::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_compras_cbte->getFiltrosArrXCampo('PdeNotaDebito', 'pde_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiComprasCbtes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

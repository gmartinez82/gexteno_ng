...
$afip_citi_prc = $afip_citi_compras_cbte->getAfipCitiPrc();
...
<div class="datos" id="<?php Gral::_echo($afip_citi_prc->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiComprasCbte::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_compras_cbte->getFiltrosArrXCampo('AfipCitiPrc', 'afip_citi_prc_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiComprasCbtes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($afip_citi_prc->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pde_orden_pago = $pde_orden_pago_estado->getPdeOrdenPago();
...
<div class="datos" id="<?php Gral::_echo($pde_orden_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOrdenPagoEstado::getFiltrosArrGral() ?>&arr=<?php echo $pde_orden_pago_estado->getFiltrosArrXCampo('PdeOrdenPago', 'pde_orden_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOrdenPagoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_orden_pago->getDescripcion()) ?></strong>
        </a>
    </div>

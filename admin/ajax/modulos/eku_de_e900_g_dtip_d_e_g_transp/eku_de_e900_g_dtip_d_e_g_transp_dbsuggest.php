...
if($buscar != '...'){
    ...
    $c->add('eku_de_e900_g_dtip_d_e_g_transp.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e900_g_dtip_d_e_g_transp.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e900_g_dtip_d_e_g_transp.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e900_g_dtip_d_e_g_transp.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e900_g_dtip_d_e_g_transp');
$c->addOrden('eku_de_e900_g_dtip_d_e_g_transp.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE900GDtipDEGTransp::getEkuDeE900GDtipDEGTransps($p, $c);

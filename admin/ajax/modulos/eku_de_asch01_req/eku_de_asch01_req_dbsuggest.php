...
EkuDeAsch01Req::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('eku_de_asch01_req.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_asch01_req.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_asch01_req.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_asch01_req.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_asch01_req');
$c->addOrden('eku_de_asch01_req.orden', 'asc');
$c->setCriterios();

...
$eku_de_asch01_req_id = Gral::getVars(2, 'eku_de_asch01_req_id');
$eku_de_asch01_req = EkuDeAsch01Req::getOxId($eku_de_asch01_req_id);
$eku_de = $eku_de_asch01_req->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeAsch01Req::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_asch01_req->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeAsch01Reqs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

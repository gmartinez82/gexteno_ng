...
if($buscar != '...'){
    ...
    $c->add('eku_param_vehiculo_tipo_venta.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_vehiculo_tipo_venta.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_vehiculo_tipo_venta.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_vehiculo_tipo_venta.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_vehiculo_tipo_venta');
$c->addOrden('eku_param_vehiculo_tipo_venta.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamVehiculoTipoVenta::getEkuParamVehiculoTipoVentas($p, $c);

...
$us_login_id = Gral::getVars(2, 'us_login_id');
$us_login = UsLogin::getOxId($us_login_id);
$us_usuario = $us_login->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo UsLogin::getFiltrosArrGral() ?>&arr=<?php echo $us_login->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('UsLogins') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

...
$ins_tipo_lista_precio = $vta_vendedor_ins_tipo_lista_precio->getInsTipoListaPrecio();
...
<div class="datos" id="<?php Gral::_echo($ins_tipo_lista_precio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaVendedorInsTipoListaPrecio::getFiltrosArrGral() ?>&arr=<?php echo $vta_vendedor_ins_tipo_lista_precio->getFiltrosArrXCampo('InsTipoListaPrecio', 'ins_tipo_lista_precio_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaVendedorInsTipoListaPrecios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_tipo_lista_precio->getDescripcion()) ?></strong>
        </a>
    </div>

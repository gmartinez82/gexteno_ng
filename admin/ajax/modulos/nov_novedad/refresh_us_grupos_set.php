...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('nov_novedad_us_grupo.nov_novedad_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_grupo');
$c->addRealJoin('nov_novedad_us_grupo', 'nov_novedad_us_grupo.us_grupo_id', 'us_grupo.id', 'LEFT JOIN');

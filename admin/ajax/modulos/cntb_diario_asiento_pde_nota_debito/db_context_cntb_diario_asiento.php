...
$cntb_diario_asiento = $cntb_diario_asiento_pde_nota_debito->getCntbDiarioAsiento();
...
<div class="datos" id="<?php Gral::_echo($cntb_diario_asiento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CntbDiarioAsientoPdeNotaDebito::getFiltrosArrGral() ?>&arr=<?php echo $cntb_diario_asiento_pde_nota_debito->getFiltrosArrXCampo('CntbDiarioAsiento', 'cntb_diario_asiento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CntbDiarioAsientoPdeNotaDebitos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_diario_asiento->getDescripcion()) ?></strong>
        </a>
    </div>

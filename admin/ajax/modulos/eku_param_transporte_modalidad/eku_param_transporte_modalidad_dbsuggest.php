...
if($buscar != '...'){
    ...
    $c->add('eku_param_transporte_modalidad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_transporte_modalidad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_modalidad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_modalidad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_transporte_modalidad');
$c->addOrden('eku_param_transporte_modalidad.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTransporteModalidad::getEkuParamTransporteModalidads($p, $c);

...
$gral_sucursal_vta_vendedor_id = Gral::getVars(2, 'gral_sucursal_vta_vendedor_id');
$gral_sucursal_vta_vendedor = GralSucursalVtaVendedor::getOxId($gral_sucursal_vta_vendedor_id);
$gral_sucursal = $gral_sucursal_vta_vendedor->getGralSucursal();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalVtaVendedor::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_vta_vendedor->getFiltrosArrXCampo('GralSucursal', 'gral_sucursal_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalVtaVendedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal->getDescripcion()) ?></strong>
        </a>
    </div>

...
$gral_centro_costo_us_usuario_id = Gral::getVars(2, 'gral_centro_costo_us_usuario_id');
$gral_centro_costo_us_usuario = GralCentroCostoUsUsuario::getOxId($gral_centro_costo_us_usuario_id);
$gral_centro_costo = $gral_centro_costo_us_usuario->getGralCentroCosto();
...
<div class="datos" id="<?php Gral::_echo($gral_centro_costo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCentroCostoUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $gral_centro_costo_us_usuario->getFiltrosArrXCampo('GralCentroCosto', 'gral_centro_costo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCentroCostoUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_centro_costo->getDescripcion()) ?></strong>
        </a>
    </div>

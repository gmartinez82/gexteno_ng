...
<table border='0' align='center' class='listado' id='listado_adm_pde_oc_agrupacion'>
  ...
  <tr>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=pde_oc_tipo_origen_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('PdeOcTipoOrigen') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='pde_oc_tipo_origen_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=pde_oc_agrupacion_tipo_estado_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('PdeOcAgrupacionTipoEstado') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='pde_oc_agrupacion_tipo_estado_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='150' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=fecha_entrega&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Fecha Entrega') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='fecha_entrega'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='150' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=vencimiento&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Vencimiento') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='vencimiento'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id="tr_pde_oc_agrupacion_uno_<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>" class="uno" identificador="<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>">
  	<?php include "pde_oc_agrupacion_uno.php" ?>
  </tr>
  
  
  <tr id='tr_eliminar_<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>" >
	<td colspan='13' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />
	  <div><input name='btn_elim_aceptar' type='button' id='btn_elim_aceptar' value='<?php Lang::_lang('Aceptar') ?>'  class='btn_mensaje_aceptar' />
		<input name='btn_elim_cancelar' type='button' id='btn_elim_cancelar' value='<?php Lang::_lang('Cancelar') ?>'  class='btn_mensaje_cancelar' onclick='eliminar_conf(<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>,0)'/>
	  </div>
	</div>		</td>
	<td align='center'></td>
  </tr>

<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/pde_oc_agrupacion/set_pde_oc_agrupacion_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='pde_oc_agrupacion_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('PdeOcAgrupacion') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='pde_oc_agrupacion'><img src="imgs/btn_lupa.png" width="25"></label>

...
$app_mov_dispositivo = $app_mov_actividad->getAppMovDispositivo();
...
<div class="datos" id="<?php Gral::_echo($app_mov_dispositivo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AppMovActividad::getFiltrosArrGral() ?>&arr=<?php echo $app_mov_actividad->getFiltrosArrXCampo('AppMovDispositivo', 'app_mov_dispositivo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AppMovActividads') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($app_mov_dispositivo->getDescripcion()) ?></strong>
        </a>
    </div>

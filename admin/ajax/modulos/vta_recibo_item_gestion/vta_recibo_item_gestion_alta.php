...
?>
<body>
<form id='formu' name='formu' method='post' action='ajax/modulos/vta_recibo_item_gestion/vta_recibo_item_alta.php' >
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_vta_recibo_item_cmb_gral_fp_forma_pago_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_gral_fp_forma_pago_id' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_gral_fp_forma_pago_id', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_gral_fp_forma_pago_id', false, false) ?>" />
                                        <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_vta_recibo_item_cmb_vta_recibo_concepto_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_vta_recibo_concepto_id' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_vta_recibo_concepto_id', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_vta_recibo_concepto_id', false, false) ?>" />
                                        <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_vta_recibo_item_cmb_conciliado" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_conciliado' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_conciliado', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_conciliado', false, false) ?>" />
                                        <?php } ?>

...
$ins_insumo_ins_marca_id = Gral::getVars(2, 'ins_insumo_ins_marca_id');
$ins_insumo_ins_marca = InsInsumoInsMarca::getOxId($ins_insumo_ins_marca_id);
$ins_insumo = $ins_insumo_ins_marca->getInsInsumo();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsInsumoInsMarca::getFiltrosArrGral() ?>&arr=<?php echo $ins_insumo_ins_marca->getFiltrosArrXCampo('InsInsumo', 'ins_insumo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsInsumoInsMarcas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo->getDescripcion()) ?></strong>
        </a>
    </div>

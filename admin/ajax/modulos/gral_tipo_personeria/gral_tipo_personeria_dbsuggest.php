...
if($buscar != '...'){
    ...
    $c->add('gral_tipo_personeria.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_tipo_personeria.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_personeria.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_personeria.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralTipoPersoneria::getGralTipoPersonerias($p, $c);

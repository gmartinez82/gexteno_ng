...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('vta_tipo_origen_factura.id', Gral::getVars(1, 'buscador_vta_tipo_origen_factura_id'), Gral::getVars(1, 'buscador_vta_tipo_origen_factura_id_comparador'));
	$criterio->add('vta_tipo_origen_factura.descripcion', Gral::getVars(1, 'buscador_vta_tipo_origen_factura_descripcion'), Gral::getVars(1, 'buscador_vta_tipo_origen_factura_descripcion_comparador'));
	$criterio->add('vta_tipo_origen_factura.codigo', Gral::getVars(1, 'buscador_vta_tipo_origen_factura_codigo'), Gral::getVars(1, 'buscador_vta_tipo_origen_factura_codigo_comparador'));
	$criterio->add('vta_tipo_origen_factura.observacion', Gral::getVars(1, 'buscador_vta_tipo_origen_factura_observacion'), Gral::getVars(1, 'buscador_vta_tipo_origen_factura_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('vta_factura', 'vta_factura.vta_tipo_origen_factura_id', 'vta_tipo_origen_factura.id', 'LEFT JOIN');

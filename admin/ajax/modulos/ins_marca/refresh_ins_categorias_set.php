...
$o_ids = eval('return $o_padre->getInsCategoriaInsMarcasId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('ins_categoria_ins_marca.ins_marca_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_categoria');
$c->addRealJoin('ins_categoria_ins_marca', 'ins_categoria_ins_marca.ins_categoria_id', 'ins_categoria.id', 'LEFT JOIN');

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('prv_proveedor_ins_marca.ins_marca_id', $padre_id, Criterio::IGUAL);
$c->addTabla('prv_proveedor');
$c->addRealJoin('prv_proveedor_ins_marca', 'prv_proveedor_ins_marca.prv_proveedor_id', 'prv_proveedor.id', 'LEFT JOIN');

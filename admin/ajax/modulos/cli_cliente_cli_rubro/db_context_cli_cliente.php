...
$cli_cliente = $cli_cliente_cli_rubro->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliClienteCliRubro::getFiltrosArrGral() ?>&arr=<?php echo $cli_cliente_cli_rubro->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliClienteCliRubros') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/per_persona/set_per_persona_buscador_top.php">
    ...
    <div class="col">
        ...
        <input id="txt_cantidad_paginas" name="txt_cantidad_paginas" type="text" class="textboxx" size="2" value="<?php echo PerPersona::getSesPagCantidad() ?>" title="<?php Lang::_lang('Actualmente se visualizan') ?> <?php echo PerPersona::getSesPagCantidad() ?> <?php Lang::_lang('PerPersona') ?> <?php Lang::_lang('por Pagina') ?>" />
    </div>
    ...
    <div class="col">
        ...
        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='per_persona'><img src="imgs/btn_lupa.png" width="25"></label>

...
if($buscar != '...'){
    ...
    $c->add('per_persona.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('per_persona.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

...
<table border='0' align='center' class='listado' id='listado_adm_per_persona'>
    <thead>
    <tr>
	...
	<td width='40' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=legajo&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('LEG') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='legajo'){ ?>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=codigo_credencial&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Cod Cred') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='codigo_credencial'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='60' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=per_tipo_estado_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Estado') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='per_tipo_estado_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='40' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=control_horario&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Ctrl Hor') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='control_horario'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  ?>
    ...
    <tr id="tr_per_persona_uno_<?php Gral::_echo($per_persona->getId()) ?>" class="uno tr_datos" identificador="<?php Gral::_echo($per_persona->getId()) ?>" hash="<?php Gral::_echo($per_persona->getHash()) ?>" >
  	<?php include "per_persona_uno.php" ?>
    </tr>
  
  
    <tr id='tr_eliminar_<?php Gral::_echo($per_persona->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($per_persona->getId()) ?>" hash="<?php Gral::_echo($per_persona->getHash()) ?>" >
	<td colspan='11' align='center' class='adm_tbl_lineas'>
            
            <div id='div_eliminar_<?php Gral::_echo($per_persona->getId()) ?>'  class='div_eliminar warning'>
                ...
                <div class="eliminar-mensaje">
                    <?php Lang::_lang('Esta a punto de eliminar') ?> "<strong><?php Gral::_echo($per_persona->getDescripcion()) ?></strong>".<br />

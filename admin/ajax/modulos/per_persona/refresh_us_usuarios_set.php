...
$c->add('per_persona_us_usuario.per_persona_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('per_persona_us_usuario', 'per_persona_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

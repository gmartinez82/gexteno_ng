...
if($buscar != '...'){
    ...
    $c->add('prd_linea_produccion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_linea_produccion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_linea_produccion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_linea_produccion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_linea_produccion');
$c->addOrden('prd_linea_produccion.orden', 'asc');
$c->setCriterios();

...
$criterio->add('vta_factura_concepto.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->addRealJoin('cntb_cuenta', 'cntb_cuenta.id', 'vta_factura_concepto.cntb_cuenta_id', 'LEFT JOIN');

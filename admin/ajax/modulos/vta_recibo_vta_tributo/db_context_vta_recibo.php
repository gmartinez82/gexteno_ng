...
$vta_recibo_vta_tributo_id = Gral::getVars(2, 'vta_recibo_vta_tributo_id');
$vta_recibo_vta_tributo = VtaReciboVtaTributo::getOxId($vta_recibo_vta_tributo_id);
$vta_recibo = $vta_recibo_vta_tributo->getVtaRecibo();
...
<div class="datos" id="<?php Gral::_echo($vta_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaReciboVtaTributo::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_vta_tributo->getFiltrosArrXCampo('VtaRecibo', 'vta_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaReciboVtaTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

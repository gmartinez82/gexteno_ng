...
$ws_fe_ope_solicitud = $vta_nota_credito_ws_fe_ope_solicitud->getWsFeOpeSolicitud();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_ope_solicitud->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaCreditoWsFeOpeSolicitud::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_credito_ws_fe_ope_solicitud->getFiltrosArrXCampo('WsFeOpeSolicitud', 'ws_fe_ope_solicitud_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaCreditoWsFeOpeSolicituds') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_ope_solicitud->getDescripcion()) ?></strong>
        </a>
    </div>

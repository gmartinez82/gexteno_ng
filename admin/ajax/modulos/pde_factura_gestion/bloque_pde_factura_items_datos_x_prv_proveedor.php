...
?>
<form id='form_generar_factura' name='form_generar_factura' method='POST' action='' prv_proveedor_id="<?php echo $dbsug_prv_proveedor_id ?>">
    <div class="label-error" id='error_general_error'></div>
    <table class="listado_pde_factura_items" id="listado_pde_factura_items">
        <tr>

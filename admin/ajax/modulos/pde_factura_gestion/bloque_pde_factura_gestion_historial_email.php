<table border="0" class="tabla-modal-ficha-emails">
    ...
    <?php
    $pde_factura_enviados = $pde_factura->getPdeFacturaEnviados();
    $cont = 0;
    foreach ($pde_factura_enviados as $pde_factura_enviado) {
        $cont++;
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($pde_factura_enviado->getCreado())); ?>
                </div>
            </td>	

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="asunto">
                    <?php Gral::_echo($pde_factura_enviado->getAsunto()); ?>
                </div>
                <div class="destinatario">
                    <?php Gral::_echo($pde_factura_enviado->getDestinatario()); ?>
                </div>
                <div class="observacion">
                    <?php Gral::_echo($pde_factura_enviado->getObservacion()); ?>
                </div>                 
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="estado">
                    <img src="imgs/btn_estado_<?php echo $pde_factura_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="codigo_envio">
                    <?php Gral::_echo($pde_factura_enviado->getCodigoEnvio()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por-descripcion">
                    <?php Gral::_echo($pde_factura_enviado->getCreadoPorDescripcion()); ?>
                </div>
            </td>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                <ul class="adm_botones_acciones_modal_ficha">
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_FACTURA_GESTION_ACCION_COMPROBANTE')) { ?>
                        <li class='adm_botones_accion pde-factura-comprobante' pde_factura_enviado_id='<?php echo $pde_factura_enviado->getId() ?>'>
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_PRESUPUESTO_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                        <li class='adm_botones_accion pde-factura-ver-cuerpo-correo' pde_factura_enviado_id='<?php echo $pde_factura_enviado->getId() ?>'>

...
<tr class="tr-item" key = "<?php echo $key ?>">
    ...
    <td>
        <div class="pde_factura_concepto">
            <?php
            $pde_factura_concepto_id = $cmb_pde_factura_concepto_ids[$key];
            Html::html_dib_select(1, "cmb_pde_factura_concepto_id[" . $key . "]", Gral::getCmbFiltro(PdeFacturaConcepto::getPdeFacturaConceptosCmb(), '...'), $pde_factura_concepto_id, 'textbox pde_factura_concepto_id' . $error_input_css);
            ?>
        </div>

...
$pde_tributo = $pde_tributo_exencion->getPdeTributo();
...
<div class="datos" id="<?php Gral::_echo($pde_tributo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeTributoExencion::getFiltrosArrGral() ?>&arr=<?php echo $pde_tributo_exencion->getFiltrosArrXCampo('PdeTributo', 'pde_tributo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeTributoExencions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_tributo->getDescripcion()) ?></strong>
        </a>
    </div>

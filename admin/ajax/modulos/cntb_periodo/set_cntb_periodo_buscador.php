...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('cntb_periodo.gral_empresa_id', Gral::getVars(1, 'buscador_cntb_periodo_gral_empresa_id'), Gral::getVars(1, 'buscador_cntb_periodo_gral_empresa_id_comparador'));

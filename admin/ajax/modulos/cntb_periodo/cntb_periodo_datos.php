...
<?php if(count($cntb_periodos) > 0){ ?>

<table border='0' align='center' class='listado' id='listado_adm_cntb_periodo'>
  ...
  <tr id="tr_cntb_periodo_uno_<?php Gral::_echo($cntb_periodo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($cntb_periodo->getId()) ?>">
  	<?php include "cntb_periodo_uno.php" ?>
  </tr>
  ...
  <tr id='tr_eliminar_<?php Gral::_echo($cntb_periodo->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($cntb_periodo->getId()) ?>" >
	<td colspan='9' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($cntb_periodo->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />

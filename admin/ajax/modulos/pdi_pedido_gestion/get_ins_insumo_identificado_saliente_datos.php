...
if($ins_insumo_identificado){
	...
	$tal_insumo_asignado = $ins_insumo_identificado->getTalInsumoAsignadoActual();
	...
	if(!$tal_insumo_asignado){
		$tal_insumo_asignado = new TalInsumoAsignado();
	}	
	...
	Gral::setSes('MECANO_PDI_SALIENTE_INS_IDENTIFICADO_ARRAY_TMP', $array_en_sesion);
}else{
...
$arr = array(
	...
	'km' => $tal_insumo_asignado->getKmActualInsumo(),
	'instancia_id' => $tal_insumo_asignado->getInsInsumoInstanciaId(),
);

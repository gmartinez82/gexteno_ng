...
$array_en_sesion = Gral::getSes('MECANO_PDI_ENTREGA_INS_IDENTIFICADO_ARRAY_TMP');
...
<?php }else{ ?>
       <div class="noresultado"><?php Lang::_lang('No se encontraron insumos en') ?> <?php Gral::_echo(($pan_panol) ? $pan_panol->getDescripcion() : '') ?></div>
<?php } ?>

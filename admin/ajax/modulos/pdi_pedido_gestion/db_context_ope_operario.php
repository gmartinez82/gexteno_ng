...
$ope_operario = $pdi_pedido->getOpeOperario();
...
<div class="datos" id="<?php Gral::_echo($ope_operario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdiPedido::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido->getFiltrosArrXCampo('OpeOperario', 'ope_operario_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdiPedidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ope_operario->getDescripcion()) ?></strong>
        </a>
    </div>

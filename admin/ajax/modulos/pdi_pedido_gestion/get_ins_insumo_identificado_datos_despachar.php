...
if($ins_insumo_identificado){
	...
	$array_en_sesion = Gral::getSes('MECANO_PDI_DESPACHAR_INS_IDENTIFICADO_ARRAY_TMP');
	$array_en_sesion[$cont] = $ins_insumo_identificado_id;
	Gral::setSes('MECANO_PDI_DESPACHAR_INS_IDENTIFICADO_ARRAY_TMP', $array_en_sesion);
}else{

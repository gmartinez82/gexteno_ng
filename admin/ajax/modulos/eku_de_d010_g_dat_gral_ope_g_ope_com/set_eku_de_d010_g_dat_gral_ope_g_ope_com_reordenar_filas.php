...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_DE_D010_G_DAT_GRAL_OPE_G_OPE_COM_ADM_ACCION_REORDENAR')){
    ...
    foreach ($arr_identificadores_ordenados as $identificador){
        ...
        if($eku_de_d010_g_dat_gral_ope_g_ope_com){
            $eku_de_d010_g_dat_gral_ope_g_ope_com->setOrden($orden_paginado);
            $eku_de_d010_g_dat_gral_ope_g_ope_com->saveDesdeProceso();
        }
    }

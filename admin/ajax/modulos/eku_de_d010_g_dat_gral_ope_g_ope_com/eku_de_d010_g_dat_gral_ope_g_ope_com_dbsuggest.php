...
if($buscar != '...'){
    ...
    $c->add('eku_de_d010_g_dat_gral_ope_g_ope_com.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_d010_g_dat_gral_ope_g_ope_com.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d010_g_dat_gral_ope_g_ope_com.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d010_g_dat_gral_ope_g_ope_com.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_d010_g_dat_gral_ope_g_ope_com');
$c->addOrden('eku_de_d010_g_dat_gral_ope_g_ope_com.orden', 'asc');
$c->setCriterios();

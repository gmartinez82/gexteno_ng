...
$c->add('cli_cliente_gral_fp_cuota.gral_fp_cuota_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_gral_fp_cuota', 'cli_cliente_gral_fp_cuota.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

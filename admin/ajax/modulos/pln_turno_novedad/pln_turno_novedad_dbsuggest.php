...
if($buscar != '...'){
    ...
    $c->add('pln_turno_novedad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('pln_turno_novedad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_turno_novedad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_turno_novedad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('pln_turno_novedad');
$c->addOrden('pln_turno_novedad.orden', 'asc');
$c->setCriterios();

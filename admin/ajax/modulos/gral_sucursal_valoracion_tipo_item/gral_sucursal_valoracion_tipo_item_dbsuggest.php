...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_valoracion_tipo_item.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_valoracion_tipo_item.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_tipo_item.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_tipo_item.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_valoracion_tipo_item');
$c->addOrden('gral_sucursal_valoracion_tipo_item.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralSucursalValoracionTipoItem::getGralSucursalValoracionTipoItems($p, $c);

...
$o_ids = eval('return $o_padre->getGralSucursalValoracionTipoItemGralSucursalsId();');
...
$c->add('gral_sucursal_valoracion_tipo_item_gral_sucursal.gral_sucursal_valoracion_tipo_item_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_punto_venta');
$c->addRealJoin('gral_sucursal_valoracion_tipo_item_gral_sucursal', 'gral_sucursal_valoracion_tipo_item_gral_sucursal.vta_punto_venta_id', 'vta_punto_venta.id', 'LEFT JOIN');

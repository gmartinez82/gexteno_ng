...
if($buscar != '...'){
    ...
    $c->add('gral_novedad_motivo_extendido.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_novedad_motivo_extendido.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad_motivo_extendido.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad_motivo_extendido.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_novedad_motivo_extendido');
$c->addOrden('gral_novedad_motivo_extendido.orden', 'asc');
$c->setCriterios();

...
$gral_sucursal_valoracion_tipo_item = $gral_sucursal_valoracion->getGralSucursalValoracionTipoItem();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal_valoracion_tipo_item->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalValoracion::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_valoracion->getFiltrosArrXCampo('GralSucursalValoracionTipoItem', 'gral_sucursal_valoracion_tipo_item_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalValoracions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal_valoracion_tipo_item->getDescripcion()) ?></strong>
        </a>
    </div>

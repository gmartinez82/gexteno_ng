...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_valoracion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_valoracion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_valoracion');
$c->addOrden('gral_sucursal_valoracion.orden', 'asc');
$c->setCriterios();

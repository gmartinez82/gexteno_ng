...
$c->add('cli_cliente_ins_tipo_lista_precio.ins_tipo_lista_precio_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_ins_tipo_lista_precio', 'cli_cliente_ins_tipo_lista_precio.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

...
$c->add('vta_vendedor_ins_tipo_lista_precio.ins_tipo_lista_precio_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('vta_vendedor_ins_tipo_lista_precio', 'vta_vendedor_ins_tipo_lista_precio.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

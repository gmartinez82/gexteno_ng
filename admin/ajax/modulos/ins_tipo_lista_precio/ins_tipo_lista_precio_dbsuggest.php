...
if($buscar != '...'){
    ...
    $c->add('ins_tipo_lista_precio.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ins_tipo_lista_precio.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_tipo_lista_precio.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_tipo_lista_precio.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = InsTipoListaPrecio::getInsTipoListaPrecios($p, $c);

...
$c->add('cli_subcategoria_ins_tipo_lista_precio.ins_tipo_lista_precio_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_subcategoria');
$c->addRealJoin('cli_subcategoria_ins_tipo_lista_precio', 'cli_subcategoria_ins_tipo_lista_precio.cli_subcategoria_id', 'cli_subcategoria.id', 'LEFT JOIN');

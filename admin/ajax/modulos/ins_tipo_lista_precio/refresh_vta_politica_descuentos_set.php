...
$c->add('vta_politica_descuento_ins_tipo_lista_precio.ins_tipo_lista_precio_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_politica_descuento');
$c->addRealJoin('vta_politica_descuento_ins_tipo_lista_precio', 'vta_politica_descuento_ins_tipo_lista_precio.vta_politica_descuento_id', 'vta_politica_descuento.id', 'LEFT JOIN');

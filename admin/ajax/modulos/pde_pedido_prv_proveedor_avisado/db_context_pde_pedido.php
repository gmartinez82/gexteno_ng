...
$pde_pedido = $pde_pedido_prv_proveedor_avisado->getPdePedido();
...
<div class="datos" id="<?php Gral::_echo($pde_pedido->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdePedidoPrvProveedorAvisado::getFiltrosArrGral() ?>&arr=<?php echo $pde_pedido_prv_proveedor_avisado->getFiltrosArrXCampo('PdePedido', 'pde_pedido_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdePedidoPrvProveedorAvisados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_pedido->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pde_pedido_prv_proveedor_avisado_id = Gral::getVars(2, 'pde_pedido_prv_proveedor_avisado_id');
$pde_pedido_prv_proveedor_avisado = PdePedidoPrvProveedorAvisado::getOxId($pde_pedido_prv_proveedor_avisado_id);
$prv_proveedor = $pde_pedido_prv_proveedor_avisado->getPrvProveedor();
...
<div class="datos" id="<?php Gral::_echo($prv_proveedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdePedidoPrvProveedorAvisado::getFiltrosArrGral() ?>&arr=<?php echo $pde_pedido_prv_proveedor_avisado->getFiltrosArrXCampo('PrvProveedor', 'prv_proveedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdePedidoPrvProveedorAvisados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_proveedor->getDescripcion()) ?></strong>
        </a>
    </div>

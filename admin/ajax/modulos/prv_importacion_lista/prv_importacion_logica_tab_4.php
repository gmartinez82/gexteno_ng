...
$sql = "SELECT * FROM tmp_prv_importacion_tab_3 "
        . "WHERE prv_importacion_id = ".$prv_importacion->getId()
        . " AND (modificado = '1' OR nuevo = '1')"
        ;
...
// se registra la cantidad de filas en tab 4
$prv_importacion->setCantidadTab4($cantidad_tab4);

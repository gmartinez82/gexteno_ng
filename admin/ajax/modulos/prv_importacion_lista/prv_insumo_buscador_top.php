<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/prv_insumo/set_prv_insumo_buscador_top.php">
<div class="col">
...
<div class="col">
    ...
    <a class="boton" href='prv_insumo_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('PrvInsumo') ?>'><img src="imgs/btn_add.gif" width="25"></a>
    <?php } ?>
    
    <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='prv_insumo'><img src="imgs/btn_lupa.png" width="25"></label>

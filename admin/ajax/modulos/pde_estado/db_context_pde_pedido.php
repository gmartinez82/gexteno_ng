...
$pde_pedido = $pde_estado->getPdePedido();
...
<div class="datos" id="<?php Gral::_echo($pde_pedido->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeEstado::getFiltrosArrGral() ?>&arr=<?php echo $pde_estado->getFiltrosArrXCampo('PdePedido', 'pde_pedido_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_pedido->getDescripcion()) ?></strong>
        </a>
    </div>

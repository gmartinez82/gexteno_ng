...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_nota_credito_pde_tributo.pde_nota_credito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_tributo');
$c->addRealJoin('pde_nota_credito_pde_tributo', 'pde_nota_credito_pde_tributo.pde_tributo_id', 'pde_tributo.id', 'LEFT JOIN');

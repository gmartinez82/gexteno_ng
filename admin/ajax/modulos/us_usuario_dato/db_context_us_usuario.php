...
$us_usuario_dato_id = Gral::getVars(2, 'us_usuario_dato_id');
$us_usuario_dato = UsUsuarioDato::getOxId($us_usuario_dato_id);
$us_usuario = $us_usuario_dato->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo UsUsuarioDato::getFiltrosArrGral() ?>&arr=<?php echo $us_usuario_dato->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('UsUsuarioDatos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

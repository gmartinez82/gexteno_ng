...
$vta_tipo_recibo = $vta_tipo_recibo_ws_fe_param_tipo_comprobante->getVtaTipoRecibo();
...
<div class="datos" id="<?php Gral::_echo($vta_tipo_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTipoReciboWsFeParamTipoComprobante::getFiltrosArrGral() ?>&arr=<?php echo $vta_tipo_recibo_ws_fe_param_tipo_comprobante->getFiltrosArrXCampo('VtaTipoRecibo', 'vta_tipo_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTipoReciboWsFeParamTipoComprobantes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_tipo_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

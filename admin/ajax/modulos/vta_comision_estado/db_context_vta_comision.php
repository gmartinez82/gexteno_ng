...
$vta_comision = $vta_comision_estado->getVtaComision();
...
<div class="datos" id="<?php Gral::_echo($vta_comision->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaComisionEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_comision_estado->getFiltrosArrXCampo('VtaComision', 'vta_comision_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaComisionEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_comision->getDescripcion()) ?></strong>
        </a>
    </div>

...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_PARAM_TIPO_CONTRIBUYENTE_ALTA_RELACION_GRAL_TIPO_PERSONERIA_ACCIONES_SELECCION')){
    ...
    if($checked == 'checked' or $checked == 'true'){
        ...
        $o->setEkuParamTipoContribuyenteId($o_padre->getId());

...
$buscador_top_prv_proveedor_prv_rubro_id = Gral::getVars(Gral::VARS_POST, 'buscador_top_prv_proveedor_prv_rubro_id', 0);
...
$criterio->addInicioSubconsulta();
    ...
    if ($buscador_top_prv_proveedor_prv_rubro_id != 0) {
        $criterio->add('prv_rubro.id', $buscador_top_prv_proveedor_prv_rubro_id, Criterio::IGUAL);
    }

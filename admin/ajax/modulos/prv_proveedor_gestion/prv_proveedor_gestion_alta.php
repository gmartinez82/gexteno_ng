...
?>
<body>
<form id='formu' name='formu' method='post' action='ajax/modulos/prv_proveedor_gestion/prv_proveedor_alta.php' >
      <?php //include 'parciales/confirmacion.php';?>
		...
		<?php } ?> 
				...
				<tr>
				  ...
				  <input name='prv_proveedor_txt_codigo_postal' type='text' class='textbox <?php echo $error_input_css ?> ' id='prv_proveedor_txt_codigo_postal' value='<?php Gral::_echoTxt($prv_proveedor->getCodigoPostal(), true) ?>' size='50' />            

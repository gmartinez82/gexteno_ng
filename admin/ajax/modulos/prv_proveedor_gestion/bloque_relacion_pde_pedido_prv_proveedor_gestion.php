	...
	<div class='buscador'>
            ...
            <div class="trigger wopenModal boton" archivo="ajax/modulos/pde_pedido/pde_pedido_alta.php" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="buscarSetResultados(1, '', 'pde_pedido', 'prv_proveedor', <?php Gral::_echo($prv_proveedor->getId()) ?>, 'PrvProveedor', 'PdePedidoPrvProveedor')" title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('pde_pedido') ?>'>

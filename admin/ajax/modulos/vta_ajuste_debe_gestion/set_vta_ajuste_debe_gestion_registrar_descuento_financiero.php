...
$vta_ajuste_debe_ids = Gral::getVars(Gral::VARS_POST, "chk_vta_ajuste_debe", null);
...
if (is_null($vta_ajuste_debe_ids)) {
...
if (!$arr["error"]) {
    ...
    VtaAjusteDebe::setRegistrarDescuentoFinanciero($vta_ajuste_debe_ids, $var_sesion_random, $txt_descuento_financiero, $cmb_generar_recibo, $cmb_gral_fp_forma_pago_id, $txa_nota_publica, $txa_observacion, $cmb_vta_recibo_concepto_ids, $txt_descripcions, $txt_referencias, $txt_importe_unitarios, $cmb_gral_fp_forma_pago_ids);
}

...
?>
<form id='form_generar_ajuste_debe' name='form_generar_ajuste_debe' method='POST' action='' cli_cliente_id="<?php echo $dbsug_cli_cliente_id ?>">
    <div class="label-error" id='error_general_error'></div>
    <table class="listado_vta_ajuste_debe_items" id="listado_vta_ajuste_debe_items">
        <tr>
            ...
            <th><label class="boton agregar_item_ajuste_debe" title="<?php Lang::_lang('Agregar Item a Ajuste Debe') ?>"><img src="imgs/btn_add.gif" width="25"></label></th>
        </tr>
    </table>
</form>

...
// -------------------------------------------------------------------------
// Excepcion para KYA
// Punto de Venta Emisor de Cuentas Corrientes GARUPA 00
// -------------------------------------------------------------------------    
...
if ($vta_punto_venta_facturador_ctacte) {
    ...
    // se presetea el punto de venta emisor de cuentas corrientes
    $vta_ajuste_debe->setVtaPuntoVentaId($vta_punto_venta_facturador_ctacte->getId());
}
...
$txt_fecha_emision     = Gral::getFechaToWeb(date('Y-m-d'));
?>
<div class="datos generar-ws-fe-afip" tipo="<?php echo $tipo ?>">
    ...
    if ($tipo == 'item') {
        include "bloque_vta_ajuste_debe_listado_items_x_cli_cliente_modal.php";
    }
    ?>
    ...
    <form id='form_generar_ws_fe_afip' name='form_generar_ws_fe_afip' method='POST' action='' >
        ...
        <div class="col col1">
            ...
            <div class="par">
                ...
                <div class="dato">
                    <input name='txt_fecha_emision' type='text' class='textbox date' id='txt_fecha_emision' value='<?php Gral::_echoTxt(Gral::getFechaToWeb($txt_fecha_emision)) ?>' size='10' placeholder="dd/mm/aaaa" />
                    ...
                    <div class="label-error" id="txt_fecha_emision_error"><?php Gral::_echo($txt_fecha_emision_error) ?></div>  
                </div>
            </div>
        ...
        <div class="col col2" id="bloque_vta_ajuste_debe_listado_items_tabla_totales">
            <?php
        ...
        <div class="botonera">
            <button class="boton" id='btn_generar_ajuste_debe_online' name='btn_generar_ajuste_debe_online' type='button' class='btn_generar_ajuste_debe_online'><?php Lang::_lang('Generar Ajuste Debe') ?></button>
            <div class="label-error-botonera" id="generar_ajuste_debe_online_afip_error"></div>
        </div>

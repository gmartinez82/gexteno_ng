<?php
//$vta_ajuste_debe_vta_orden_venta
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
    <div class="check_vta_ajuste_debe_vta_orden_venta chk_vta_presupuesto_<?php echo $vta_presupuesto->getId() ?>">
        <input type="checkbox" name="chk_vta_ajuste_debe_vta_orden_venta[<?php echo $vta_ajuste_debe_vta_orden_venta->getId() ?>]" id="chk_vta_ajuste_debe_vta_orden_venta_<?php echo $vta_ajuste_debe_vta_orden_venta->getId() ?>" class="chk_vta_ajuste_debe_vta_orden_venta" vta_presupuesto_id="<?php echo $vta_presupuesto->getId() ?>"  value="<?php echo $vta_ajuste_debe_vta_orden_venta->getId() ?>">
    </div>
</td>
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
    <div class="cantidad">
        <input step = "<?php echo $step ?>" min="<?php echo $cantidad_minima ?>" max="<?php Gral::_echo($vta_ajuste_debe_vta_orden_venta->getCantidadDisponibleNotaCredito()) ?>" type="text" id="txt_vta_ajuste_debe_vta_orden_venta_cantidad_<?php echo $vta_ajuste_debe_vta_orden_venta->getId() ?>" name="txt_vta_ajuste_debe_vta_orden_venta_cantidad[<?php echo $vta_ajuste_debe_vta_orden_venta->getId() ?>]" value="<?php Gral::_echo($vta_ajuste_debe_vta_orden_venta->getCantidadDisponibleNotaCredito()) ?>" size="2" class="textbox txt_vta_ajuste_debe_vta_orden_venta_cantidad" />
    </div>
    <div class="disponible">
        <?php Gral::_echo($vta_ajuste_debe_vta_orden_venta->getCantidadDisponibleNotaCredito()) ?> / <?php Gral::_echo($vta_ajuste_debe_vta_orden_venta->getCantidad()) ?>
    </div>
...
<td align='right' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
    <div class="importe-unitario neto">
        <?php $importe_unitario = $vta_ajuste_debe_vta_orden_venta->getImporteUnitario(); ?>
...
<td align='right' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
    <div class="importe-total neto">
        <?php $importe_total = $vta_ajuste_debe_vta_orden_venta->getImporteTotal(); ?>
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
    <div class="importe-iva">	
        <?php Gral::_echoImp($vta_ajuste_debe_vta_orden_venta->getImporteIva()) ?>
    </div>
    <div class="gral_tipo_iva_id">	
        <?php Gral::_echo($vta_ajuste_debe_vta_orden_venta->getGralTipoIva()->getDescripcion()) ?>
    </div>
</td>

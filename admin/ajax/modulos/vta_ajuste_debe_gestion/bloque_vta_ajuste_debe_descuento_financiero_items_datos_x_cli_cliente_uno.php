...
<tr class="tr-item" key = "<?php echo $key ?>">
    ...
    <td>
        <div class="vta_recibo_concepto">
            <?php
            $vta_recibo_concepto_id = $cmb_vta_recibo_concepto_ids[$key];
            Html::html_dib_select(1, "cmb_vta_recibo_concepto_id[" . $key . "]", Gral::getCmbFiltro(VtaReciboConcepto::getVtaReciboConceptosCmb(), '...'), $vta_recibo_concepto_id, 'textbox cmb_vta_recibo_concepto_id' . $error_input_css);
            ?>
        ...
        <div class="label-error" id="cmb_vta_recibo_concepto_id_<?php echo $key ?>_error"></div>
    </td>
    ...
    <td>
        <div class="importe_unitario">
            $ <input class="moneda textbox" type="text" size="10" id="txt_importe_unitario_<?php echo $key ?>" name="txt_importe_unitario[<?php echo $key ?>]" value="<?php Gral::_echo($txt_importe_unitarios[$key]) ?>" />
        </div>

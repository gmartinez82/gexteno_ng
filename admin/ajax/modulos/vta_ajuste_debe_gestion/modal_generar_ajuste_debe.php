...
?>
<div class="datos generar-ajuste-debe" tipo="<?php echo $tipo ?>" vta_presupuesto_id="<?php echo ($vta_presupuesto) ? $vta_presupuesto->getId() : 0 ?>" >
    ...
    <div class="div_datos_generar_ajuste_debes">

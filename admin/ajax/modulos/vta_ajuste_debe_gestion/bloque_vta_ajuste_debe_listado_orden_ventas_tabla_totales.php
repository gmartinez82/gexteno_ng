...
if (count($vta_orden_venta_ids) > 0) {
    ...
    /*
    $arr_vta_tributos_vigentes = $vta_ajuste_debe->getTributosAAplicar($subtotal_calculado = $importe_total_neto_gravado);
    ...
    */
    ...
    <table border='0' align='center' class='detalle_vta_comprobante_total' id='detalle_vta_comprobante_total'>
        ...
        <tr class="subtotal">
            <td align='left' colspan="2">
                <?php Lang::_lang('Porcentaje IVA') ?>:
            </td>
            <td align='left' colspan="2">
                <div class="dato">
                    <?php Html::html_dib_select(1, 'cmb_porcentaje_iva', Gral::getNumerosCmb(100, 100), $cmb_porcentaje_iva = 100, 'textbox') ?> %
                </div>            
            </td>
        </tr>

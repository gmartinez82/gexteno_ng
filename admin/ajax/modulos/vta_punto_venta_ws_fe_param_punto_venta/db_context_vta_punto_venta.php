...
$vta_punto_venta = $vta_punto_venta_ws_fe_param_punto_venta->getVtaPuntoVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_punto_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPuntoVentaWsFeParamPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_punto_venta_ws_fe_param_punto_venta->getFiltrosArrXCampo('VtaPuntoVenta', 'vta_punto_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPuntoVentaWsFeParamPuntoVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_punto_venta->getDescripcion()) ?></strong>
        </a>
    </div>

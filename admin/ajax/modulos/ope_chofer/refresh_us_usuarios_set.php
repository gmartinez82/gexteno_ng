...
$c->add('ope_chofer_us_usuario.ope_chofer_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('ope_chofer_us_usuario', 'ope_chofer_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

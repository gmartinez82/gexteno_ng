...
$o_ids = eval('return $o_padre->getPdeCentroPedidoPrvProveedorsId();');
...
$c->add('pde_centro_pedido_prv_proveedor.prv_proveedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_centro_pedido');
$c->addRealJoin('pde_centro_pedido_prv_proveedor', 'pde_centro_pedido_prv_proveedor.pde_centro_pedido_id', 'pde_centro_pedido.id', 'LEFT JOIN');

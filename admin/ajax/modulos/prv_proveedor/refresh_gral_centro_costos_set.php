...
$c->add('gral_centro_costo_prv_proveedor.prv_proveedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_centro_costo');
$c->addRealJoin('gral_centro_costo_prv_proveedor', 'gral_centro_costo_prv_proveedor.gral_centro_costo_id', 'gral_centro_costo.id', 'LEFT JOIN');

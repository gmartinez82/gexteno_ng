...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <a class='boton' href='prv_rubro_alta.php?id=<?php echo $prv_rubro_relacionado->getId() ?>&hash=<?php echo $prv_rubro_relacionado->getHash() ?>' title="<?php Lang::_lang('Ver/Editar') ?>: '<?php Gral::_echo($prv_rubro_relacionado->getDescripcion()) ?>' "><?php Lang::_lang('Ver') ?></a>
        <?php } ?>
    </label>

...
<div class='ficha'>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($prv_proveedor->getPrvTipo()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo(GralSiNo::getOxId($prv_proveedor->getIvaIncluido())->getDescripcion()) ?></div>
    </div>

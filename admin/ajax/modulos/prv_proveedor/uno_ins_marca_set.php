...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <a class='boton' href='ins_marca_alta.php?id=<?php echo $ins_marca_relacionado->getId() ?>&hash=<?php echo $ins_marca_relacionado->getHash() ?>' title="<?php Lang::_lang('Ver/Editar') ?>: '<?php Gral::_echo($ins_marca_relacionado->getDescripcion()) ?>' "><?php Lang::_lang('Ver') ?></a>
        <?php } ?>
    </label>

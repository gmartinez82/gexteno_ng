...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('prv_proveedor.prv_tipo_id', Gral::getVars(1, 'buscador_prv_proveedor_prv_tipo_id'), Gral::getVars(1, 'buscador_prv_proveedor_prv_tipo_id_comparador'));
	...
	$criterio->add('prv_proveedor.datos_migracion', Gral::getVars(1, 'buscador_prv_proveedor_datos_migracion'), Gral::getVars(1, 'buscador_prv_proveedor_datos_migracion_comparador'));
	...
	$criterio->addRealJoin('gral_centro_costo_prv_proveedor', 'gral_centro_costo_prv_proveedor.prv_proveedor_id', 'prv_proveedor.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('pde_tributo_exencion', 'pde_tributo_exencion.prv_proveedor_id', 'prv_proveedor.id', 'LEFT JOIN');

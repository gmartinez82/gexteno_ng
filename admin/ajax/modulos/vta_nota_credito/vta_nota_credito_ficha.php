...
<div class='ficha'>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getVtaTipoOrigenNotaCredito()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getVtaNotaCreditoTipoEstado()->getDescripcion()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('VtaPuntoVenta') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getVtaPuntoVenta()->getDescripcion()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('GralFpFormaPago') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getGralFpFormaPago()->getDescripcion()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('VtaPreventista') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getVtaPreventista()->getDescripcion()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('GralActividad') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getGralActividad()->getDescripcion()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('GralEscenario') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getGralEscenario()->getDescripcion()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('Numero de Pto Vta') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getNumeroPuntoVenta()) ?></div>
    </div>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getNumeroNotaCreditoCompleto()) ?></div>
    </div>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo(Gral::getFechaToWeb($vta_nota_credito->getFechaEmision())) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('Fecha de Vencimiento') ?></div>
        <div class='dato'><?php Gral::_echo(Gral::getFechaToWeb($vta_nota_credito->getFechaVencimiento())) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('GralTipoDocumento') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getGralTipoDocumento()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getPersonaEmail()) ?></div>
    </div>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getNotaPublica()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('Anio') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getAnio()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('GralMes') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getGralMes()->getDescripcion()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('CntbDiarioAsiento') ?></div>
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getCntbDiarioAsiento()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo($vta_nota_credito->getNotaInterna()) ?></div>
    </div>

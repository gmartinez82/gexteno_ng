...
$eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e_id = Gral::getVars(2, 'eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e_id');
$eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e = EkuDeE400GDtipDEGCamNCDE::getOxId($eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e_id);
$eku_de = $eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE400GDtipDEGCamNCDE::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE400GDtipDEGCamNCDEs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

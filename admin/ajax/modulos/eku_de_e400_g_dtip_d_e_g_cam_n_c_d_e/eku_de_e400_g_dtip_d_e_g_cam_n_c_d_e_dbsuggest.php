...
if($buscar != '...'){
    ...
    $c->add('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e');
$c->addOrden('eku_de_e400_g_dtip_d_e_g_cam_n_c_d_e.orden', 'asc');
$c->setCriterios();

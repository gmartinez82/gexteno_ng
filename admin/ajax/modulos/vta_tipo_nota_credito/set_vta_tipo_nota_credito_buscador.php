...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('vta_tipo_nota_credito.id', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_id'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_id_comparador'));
	$criterio->add('vta_tipo_nota_credito.descripcion', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_descripcion'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_descripcion_comparador'));
	$criterio->add('vta_tipo_nota_credito.codigo_min', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_codigo_min'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_codigo_min_comparador'));
	$criterio->add('vta_tipo_nota_credito.codigo', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_codigo'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_codigo_comparador'));
	$criterio->add('vta_tipo_nota_credito.informa', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_informa'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_informa_comparador'));
	$criterio->add('vta_tipo_nota_credito.observacion', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_observacion'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_observacion_comparador'));
	$criterio->add('vta_tipo_nota_credito.estado', Gral::getVars(1, 'buscador_vta_tipo_nota_credito_estado'), Gral::getVars(1, 'buscador_vta_tipo_nota_credito_estado_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('gral_condicion_iva_vta_tipo_nota_credito', 'gral_condicion_iva_vta_tipo_nota_credito.vta_tipo_nota_credito_id', 'vta_tipo_nota_credito.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('vta_tipo_nota_credito_ws_fe_param_tipo_comprobante', 'vta_tipo_nota_credito_ws_fe_param_tipo_comprobante.vta_tipo_nota_credito_id', 'vta_tipo_nota_credito.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('vta_nota_credito', 'vta_nota_credito.vta_tipo_nota_credito_id', 'vta_tipo_nota_credito.id', 'LEFT JOIN');

...
$vta_comision_enviado_id = Gral::getVars(2, 'vta_comision_enviado_id');
...
<div class="datos" id="<?php Gral::_echo($vta_comision->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaComisionEnviado::getFiltrosArrGral() ?>&arr=<?php echo $vta_comision_enviado->getFiltrosArrXCampo('VtaComision', 'vta_comision_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaComisionEnviados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_comision->getDescripcion()) ?></strong>
        </a>
    </div>

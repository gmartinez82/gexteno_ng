...
$criterio->add('ins_insumo_similar.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->addRealJoin('ins_insumo', 'ins_insumo.id', 'ins_insumo_similar.ins_insumo_id', 'LEFT JOIN');

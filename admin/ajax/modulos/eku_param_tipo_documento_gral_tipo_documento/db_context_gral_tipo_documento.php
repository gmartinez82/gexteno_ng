...
$gral_tipo_documento = $eku_param_tipo_documento_gral_tipo_documento->getGralTipoDocumento();
...
<div class="datos" id="<?php Gral::_echo($gral_tipo_documento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamTipoDocumentoGralTipoDocumento::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_tipo_documento_gral_tipo_documento->getFiltrosArrXCampo('GralTipoDocumento', 'gral_tipo_documento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamTipoDocumentoGralTipoDocumentos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_tipo_documento->getDescripcion()) ?></strong>
        </a>
    </div>

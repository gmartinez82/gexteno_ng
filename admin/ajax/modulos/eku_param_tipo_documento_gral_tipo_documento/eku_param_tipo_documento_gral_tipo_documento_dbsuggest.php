...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_documento_gral_tipo_documento.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_documento_gral_tipo_documento');
$c->addOrden('eku_param_tipo_documento_gral_tipo_documento.orden', 'asc');
$c->setCriterios();

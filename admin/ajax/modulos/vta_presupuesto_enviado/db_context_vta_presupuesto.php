...
$vta_presupuesto_enviado_id = Gral::getVars(2, 'vta_presupuesto_enviado_id');
...
<div class="datos" id="<?php Gral::_echo($vta_presupuesto->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPresupuestoEnviado::getFiltrosArrGral() ?>&arr=<?php echo $vta_presupuesto_enviado->getFiltrosArrXCampo('VtaPresupuesto', 'vta_presupuesto_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPresupuestoEnviados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_presupuesto->getDescripcion()) ?></strong>
        </a>
    </div>

...
VtaVendedorValoracionTipoItem::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_vendedor_valoracion_tipo_item.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_vendedor_valoracion_tipo_item.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion_tipo_item.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor_valoracion_tipo_item.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('vta_vendedor_valoracion_tipo_item');
$c->addOrden('vta_vendedor_valoracion_tipo_item.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = VtaVendedorValoracionTipoItem::getVtaVendedorValoracionTipoItems($p, $c);

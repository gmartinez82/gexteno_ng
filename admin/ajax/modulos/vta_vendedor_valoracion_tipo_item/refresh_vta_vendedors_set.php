...
$o_ids = eval('return $o_padre->getVtaVendedorValoracionTipoItemVtaVendedorsId();');
...
$c->add('vta_vendedor_valoracion_tipo_item_vta_vendedor.vta_vendedor_valoracion_tipo_item_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('vta_vendedor_valoracion_tipo_item_vta_vendedor', 'vta_vendedor_valoracion_tipo_item_vta_vendedor.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

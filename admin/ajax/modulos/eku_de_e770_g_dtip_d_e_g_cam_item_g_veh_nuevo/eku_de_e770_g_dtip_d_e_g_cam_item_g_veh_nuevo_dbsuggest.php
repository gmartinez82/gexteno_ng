...
if($buscar != '...'){
    ...
    $c->add('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo');
$c->addOrden('eku_de_e770_g_dtip_d_e_g_cam_item_g_veh_nuevo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE770GDtipDEGCamItemGVehNuevo::getEkuDeE770GDtipDEGCamItemGVehNuevos($p, $c);

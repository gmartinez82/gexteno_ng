...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_cli_cliente.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_cli_cliente.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_cli_cliente.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_cli_cliente.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_cli_cliente');
$c->addOrden('gral_sucursal_cli_cliente.orden', 'asc');
$c->setCriterios();

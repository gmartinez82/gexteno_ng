...
$cli_cliente = $cli_cliente_gral_fp_agrupacion->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliClienteGralFpAgrupacion::getFiltrosArrGral() ?>&arr=<?php echo $cli_cliente_gral_fp_agrupacion->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliClienteGralFpAgrupacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

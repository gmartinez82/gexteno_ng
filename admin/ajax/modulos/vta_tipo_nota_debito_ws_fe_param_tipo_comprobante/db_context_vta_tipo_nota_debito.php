...
$vta_tipo_nota_debito = $vta_tipo_nota_debito_ws_fe_param_tipo_comprobante->getVtaTipoNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($vta_tipo_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTipoNotaDebitoWsFeParamTipoComprobante::getFiltrosArrGral() ?>&arr=<?php echo $vta_tipo_nota_debito_ws_fe_param_tipo_comprobante->getFiltrosArrXCampo('VtaTipoNotaDebito', 'vta_tipo_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTipoNotaDebitoWsFeParamTipoComprobantes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_tipo_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

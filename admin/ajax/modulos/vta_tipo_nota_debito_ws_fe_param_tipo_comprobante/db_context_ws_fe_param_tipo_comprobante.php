...
$vta_tipo_nota_debito_ws_fe_param_tipo_comprobante_id = Gral::getVars(2, 'vta_tipo_nota_debito_ws_fe_param_tipo_comprobante_id');
...
$ws_fe_param_tipo_comprobante = $vta_tipo_nota_debito_ws_fe_param_tipo_comprobante->getWsFeParamTipoComprobante();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_param_tipo_comprobante->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTipoNotaDebitoWsFeParamTipoComprobante::getFiltrosArrGral() ?>&arr=<?php echo $vta_tipo_nota_debito_ws_fe_param_tipo_comprobante->getFiltrosArrXCampo('WsFeParamTipoComprobante', 'ws_fe_param_tipo_comprobante_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTipoNotaDebitoWsFeParamTipoComprobantes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_param_tipo_comprobante->getDescripcion()) ?></strong>
        </a>
    </div>

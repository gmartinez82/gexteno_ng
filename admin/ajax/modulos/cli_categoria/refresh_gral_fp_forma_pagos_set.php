...
$o_ids = eval('return $o_padre->getCliCategoriaGralFpFormaPagosId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('cli_categoria_gral_fp_forma_pago.cli_categoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_fp_forma_pago');
$c->addRealJoin('cli_categoria_gral_fp_forma_pago', 'cli_categoria_gral_fp_forma_pago.gral_fp_forma_pago_id', 'gral_fp_forma_pago.id', 'LEFT JOIN');

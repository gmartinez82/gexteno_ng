...
$o_ids = eval('return $o_padre->getCliCategoriaVtaDescuentoFinancierosId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('cli_categoria_vta_descuento_financiero.cli_categoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_descuento_financiero');
$c->addRealJoin('cli_categoria_vta_descuento_financiero', 'cli_categoria_vta_descuento_financiero.vta_descuento_financiero_id', 'vta_descuento_financiero.id', 'LEFT JOIN');

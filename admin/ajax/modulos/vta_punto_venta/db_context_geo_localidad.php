...
$geo_localidad = $vta_punto_venta->getGeoLocalidad();
...
<div class="datos" id="<?php Gral::_echo($geo_localidad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_punto_venta->getFiltrosArrXCampo('GeoLocalidad', 'geo_localidad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPuntoVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($geo_localidad->getDescripcion()) ?></strong>
        </a>
    </div>

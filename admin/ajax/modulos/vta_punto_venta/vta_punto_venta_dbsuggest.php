...
VtaPuntoVenta::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_punto_venta.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_punto_venta.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_punto_venta.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_punto_venta.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

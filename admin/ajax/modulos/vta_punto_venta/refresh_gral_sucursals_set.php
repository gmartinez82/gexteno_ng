...
$c->add('gral_sucursal_vta_punto_venta.vta_punto_venta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_sucursal');
$c->addRealJoin('gral_sucursal_vta_punto_venta', 'gral_sucursal_vta_punto_venta.gral_sucursal_id', 'gral_sucursal.id', 'LEFT JOIN');

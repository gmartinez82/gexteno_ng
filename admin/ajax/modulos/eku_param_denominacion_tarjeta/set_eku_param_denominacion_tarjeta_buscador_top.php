...
$criterio->add('eku_param_denominacion_tarjeta.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('eku_param_denominacion_tarjeta.codigo_eku', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_denominacion_tarjeta.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_denominacion_tarjeta.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

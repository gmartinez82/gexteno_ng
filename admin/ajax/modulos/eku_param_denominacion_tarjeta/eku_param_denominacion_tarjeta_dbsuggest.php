...
if($buscar != '...'){
    ...
    $c->add('eku_param_denominacion_tarjeta.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_denominacion_tarjeta.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_denominacion_tarjeta.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_denominacion_tarjeta.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_denominacion_tarjeta');
$c->addOrden('eku_param_denominacion_tarjeta.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamDenominacionTarjeta::getEkuParamDenominacionTarjetas($p, $c);

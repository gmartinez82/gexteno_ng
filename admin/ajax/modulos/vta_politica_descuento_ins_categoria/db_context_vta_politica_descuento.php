...
$vta_politica_descuento = $vta_politica_descuento_ins_categoria->getVtaPoliticaDescuento();
...
<div class="datos" id="<?php Gral::_echo($vta_politica_descuento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPoliticaDescuentoInsCategoria::getFiltrosArrGral() ?>&arr=<?php echo $vta_politica_descuento_ins_categoria->getFiltrosArrXCampo('VtaPoliticaDescuento', 'vta_politica_descuento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPoliticaDescuentoInsCategorias') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_politica_descuento->getDescripcion()) ?></strong>
        </a>
    </div>

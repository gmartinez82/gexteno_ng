...
$cli_subcategoria_gral_fp_forma_pago_id = Gral::getVars(2, 'cli_subcategoria_gral_fp_forma_pago_id');
$cli_subcategoria_gral_fp_forma_pago = CliSubcategoriaGralFpFormaPago::getOxId($cli_subcategoria_gral_fp_forma_pago_id);
$gral_fp_forma_pago = $cli_subcategoria_gral_fp_forma_pago->getGralFpFormaPago();
...
<div class="datos" id="<?php Gral::_echo($gral_fp_forma_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliSubcategoriaGralFpFormaPago::getFiltrosArrGral() ?>&arr=<?php echo $cli_subcategoria_gral_fp_forma_pago->getFiltrosArrXCampo('GralFpFormaPago', 'gral_fp_forma_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliSubcategoriaGralFpFormaPagos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_fp_forma_pago->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('os_orden_servicio_imagen.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_orden_servicio_imagen.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio_imagen.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio_imagen.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_orden_servicio_imagen');
$c->addOrden('os_orden_servicio_imagen.orden', 'asc');
$c->setCriterios();

...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/os_orden_servicio_imagen/os_orden_servicio_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/os_orden_servicio_imagen/os_orden_servicio_imagen_uno_masinfo.php"; 
}
?>

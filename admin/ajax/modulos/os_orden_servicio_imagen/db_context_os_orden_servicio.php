...
$os_orden_servicio_imagen_id = Gral::getVars(2, 'os_orden_servicio_imagen_id');
$os_orden_servicio_imagen = OsOrdenServicioImagen::getOxId($os_orden_servicio_imagen_id);
$os_orden_servicio = $os_orden_servicio_imagen->getOsOrdenServicio();
...
<div class="datos" id="<?php Gral::_echo($os_orden_servicio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo OsOrdenServicioImagen::getFiltrosArrGral() ?>&arr=<?php echo $os_orden_servicio_imagen->getFiltrosArrXCampo('OsOrdenServicio', 'os_orden_servicio_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('OsOrdenServicioImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($os_orden_servicio->getDescripcion()) ?></strong>
        </a>
    </div>

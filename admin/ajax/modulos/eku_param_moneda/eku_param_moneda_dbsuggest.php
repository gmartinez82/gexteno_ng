...
if($buscar != '...'){
    ...
    $c->add('eku_param_moneda.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_moneda.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_moneda.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_moneda.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_moneda');
$c->addOrden('eku_param_moneda.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamMoneda::getEkuParamMonedas($p, $c);

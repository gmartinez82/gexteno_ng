...
$vta_tipo_nota_credito = $vta_tipo_nota_credito_ws_fe_param_tipo_comprobante->getVtaTipoNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($vta_tipo_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTipoNotaCreditoWsFeParamTipoComprobante::getFiltrosArrGral() ?>&arr=<?php echo $vta_tipo_nota_credito_ws_fe_param_tipo_comprobante->getFiltrosArrXCampo('VtaTipoNotaCredito', 'vta_tipo_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTipoNotaCreditoWsFeParamTipoComprobantes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_tipo_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

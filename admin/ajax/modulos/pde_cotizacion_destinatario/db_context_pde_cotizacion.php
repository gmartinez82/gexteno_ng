...
$pde_cotizacion_destinatario_id = Gral::getVars(2, 'pde_cotizacion_destinatario_id');
$pde_cotizacion_destinatario = PdeCotizacionDestinatario::getOxId($pde_cotizacion_destinatario_id);
$pde_cotizacion = $pde_cotizacion_destinatario->getPdeCotizacion();
...
<div class="datos" id="<?php Gral::_echo($pde_cotizacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeCotizacionDestinatario::getFiltrosArrGral() ?>&arr=<?php echo $pde_cotizacion_destinatario->getFiltrosArrXCampo('PdeCotizacion', 'pde_cotizacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeCotizacionDestinatarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_cotizacion->getDescripcion()) ?></strong>
        </a>
    </div>

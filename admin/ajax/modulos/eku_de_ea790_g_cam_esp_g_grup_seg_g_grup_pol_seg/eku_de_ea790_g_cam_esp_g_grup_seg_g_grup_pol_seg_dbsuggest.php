...
if($buscar != '...'){
    ...
    $c->add('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg');
$c->addOrden('eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg.orden', 'asc');
$c->setCriterios();

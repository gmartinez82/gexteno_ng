...
$eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg_id = Gral::getVars(2, 'eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg_id');
...
$eku_de = $eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeEa790GCamEspGGrupSegGGrupPolSeg::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_ea790_g_cam_esp_g_grup_seg_g_grup_pol_seg->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeEa790GCamEspGGrupSegGGrupPolSegs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

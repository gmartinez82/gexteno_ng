...
$not_noticia_leida_id = Gral::getVars(2, 'not_noticia_leida_id');
$not_noticia_leida = NotNoticiaLeida::getOxId($not_noticia_leida_id);
$not_noticia = $not_noticia_leida->getNotNoticia();
...
<div class="datos" id="<?php Gral::_echo($not_noticia->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo NotNoticiaLeida::getFiltrosArrGral() ?>&arr=<?php echo $not_noticia_leida->getFiltrosArrXCampo('NotNoticia', 'not_noticia_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('NotNoticiaLeidas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($not_noticia->getDescripcion()) ?></strong>
        </a>
    </div>

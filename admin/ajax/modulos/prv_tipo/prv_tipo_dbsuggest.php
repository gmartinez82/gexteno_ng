...
if($buscar != '...'){
    ...
    $c->add('prv_tipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prv_tipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prv_tipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prv_tipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prv_tipo');
$c->addOrden('prv_tipo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = PrvTipo::getPrvTipos($p, $c);

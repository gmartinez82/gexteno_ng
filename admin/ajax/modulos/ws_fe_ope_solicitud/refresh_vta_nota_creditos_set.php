...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_nota_credito_ws_fe_ope_solicitud.ws_fe_ope_solicitud_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_nota_credito');
$c->addRealJoin('vta_nota_credito_ws_fe_ope_solicitud', 'vta_nota_credito_ws_fe_ope_solicitud.vta_nota_credito_id', 'vta_nota_credito.id', 'LEFT JOIN');

...
$ws_fe_param_punto_venta = $ws_fe_ope_solicitud->getWsFeParamPuntoVenta();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_param_punto_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo WsFeOpeSolicitud::getFiltrosArrGral() ?>&arr=<?php echo $ws_fe_ope_solicitud->getFiltrosArrXCampo('WsFeParamPuntoVenta', 'ws_fe_param_punto_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('WsFeOpeSolicituds') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_param_punto_venta->getDescripcion()) ?></strong>
        </a>
    </div>

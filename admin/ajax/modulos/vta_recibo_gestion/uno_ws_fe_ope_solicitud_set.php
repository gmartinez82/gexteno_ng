...
if(in_array($ws_fe_ope_solicitud->getId(), $o_ids)){
	...
	$vta_recibo_ws_fe_ope_solicitud = VtaReciboWsFeOpeSolicitud::getOxArray($arr_cri);
...
<div class='list <?php echo $css_sel ?>' title='<?php echo $ws_fe_ope_solicitud->getObservacion() ?>'>
    ...
    <input type='checkbox' id='chk_ws_fe_ope_solicitud_id_<?php echo $ws_fe_ope_solicitud->getId() ?>' name='chk_ws_fe_ope_solicitud[<?php echo $ws_fe_ope_solicitud->getId() ?>]' <?php echo $sel ?> value='1' identificador='<?php echo $ws_fe_ope_solicitud->getId() ?>' relacion_id='<?php echo $vta_recibo_ws_fe_ope_solicitud_id ?>' />
    <?php } ?>

...
if ($cli_cliente) {
    $vta_recibo->setCliClienteId($cli_cliente_id);
    ...
    if ($vta_punto_venta) {
        ...
        $vta_recibo->setVtaPuntoVentaId($vta_punto_venta->getId());
    }
}
...
<div class="datos generar-ws-fe-afip">
    ...
    <form id='form_generar_ws_fe_afip' name='form_generar_ws_fe_afip' method='POST' action='' >
        ...
        <?php include "bloque_vta_recibo_listado_items_x_cli_cliente_modal.php"; ?>
        ...
        <div class="col col1">
            ...
            <div class="par" style="display: none;">
                ...
                <div class="dato">
                    <?php
                    Html::html_dib_select(1, 'cmb_vta_preventista_id', Gral::getCmbFiltro(VtaPreventista::getVtaPreventistasCmb(true), '...'), $vta_preventista_id, 'textbox ' . $error_input_css);
                    ?>
            ...
            <div class="par">
                ...
                <div class="dato">
                    <?php
                    Html::html_dib_select(1, 'cmb_vta_recibo_condicion_pago_id', Gral::getCmbFiltro(VtaReciboCondicionPago::getVtaReciboCondicionPagosCmb(true), '...'), $cmb_vta_recibo_condicion_pago_id, 'textbox ' . $error_input_css);
                    ?>
            ...
            <div class="par">
                ...
                <div class="dato">
                    <?php
                    Html::html_dib_select(1, 'cmb_vta_recibo_tipo_pago_id', Gral::getCmbFiltro(VtaReciboTipoPago::getVtaReciboTipoPagosCmb(true), '...'), $cmb_vta_recibo_tipo_pago_id, 'textbox ' . $error_input_css);
                    ?>
            ...
            <div class="par">
                ...
                <div class="dato">
                    <?php
                    Html::html_dib_select(1, 'cmb_gral_empresa_id', Gral::getCmbFiltro(GralEmpresa::getGralEmpresasCmb(true), '...'), $gral_empresa_id, 'textbox ' . $error_input_css);
                    ?>
            ...
            <div class="par">
                ...
                <div class="dato">
                    <?php
                    if ($vta_punto_venta) {
                        Html::html_dib_select(1, 'cmb_vta_punto_venta_id', Gral::getCmbFiltro($gral_empresa->getVtaPuntoVentasCmb(true), '...'), $vta_punto_venta_id, 'textbox ' . $error_input_css);
                    } else {
            ...
            <div class="par">
                ...
                <div class="dato">
                    <input name='txt_fecha' type='text' class='textbox date' id='txt_fecha' value='<?php Gral::_echo(Gral::getFechaToWEB(date('Y-m-d'))) ?>' size='10' placeholder="dd/mm/aaaa" />
            ...
            <div class="par">
                ...
                <div class="dato">
                    <textarea name='txa_observacion' rows='1' cols='70' id='txa_observacion' class='textbox'></textarea>
        ...
        <div class="col col2">
            <?php include "bloque_vta_recibo_listado_items_tabla_totales.php"; ?>
        </div>

        <div class="label-error" id="generar_recibo_online_afip_error"></div>
        <div class="botonera">
            <button class="boton" id='btn_generar_recibo_online' name='btn_generar_recibo_online' type='button' class='btn_generar_recibo_online'><?php Lang::_lang('Generar Recibo') ?></button>
        </div>

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('gral_tipo_iva_ws_fe_param_tipo_iva.ws_fe_param_tipo_iva_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_tipo_iva');
$c->addRealJoin('gral_tipo_iva_ws_fe_param_tipo_iva', 'gral_tipo_iva_ws_fe_param_tipo_iva.gral_tipo_iva_id', 'gral_tipo_iva.id', 'LEFT JOIN');

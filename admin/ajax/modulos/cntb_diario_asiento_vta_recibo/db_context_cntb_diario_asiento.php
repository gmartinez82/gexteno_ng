...
$cntb_diario_asiento = $cntb_diario_asiento_vta_recibo->getCntbDiarioAsiento();
...
<div class="datos" id="<?php Gral::_echo($cntb_diario_asiento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CntbDiarioAsientoVtaRecibo::getFiltrosArrGral() ?>&arr=<?php echo $cntb_diario_asiento_vta_recibo->getFiltrosArrXCampo('CntbDiarioAsiento', 'cntb_diario_asiento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CntbDiarioAsientoVtaRecibos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_diario_asiento->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_presupuesto = $vta_presupuesto_veh_coche->getVtaPresupuesto();
...
<div class="datos" id="<?php Gral::_echo($vta_presupuesto->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPresupuestoVehCoche::getFiltrosArrGral() ?>&arr=<?php echo $vta_presupuesto_veh_coche->getFiltrosArrXCampo('VtaPresupuesto', 'vta_presupuesto_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPresupuestoVehCoches') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_presupuesto->getDescripcion()) ?></strong>
        </a>
    </div>

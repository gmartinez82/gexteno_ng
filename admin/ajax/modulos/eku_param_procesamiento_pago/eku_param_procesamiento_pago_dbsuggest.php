...
if($buscar != '...'){
    ...
    $c->add('eku_param_procesamiento_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_procesamiento_pago.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_procesamiento_pago.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_procesamiento_pago.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_procesamiento_pago');
$c->addOrden('eku_param_procesamiento_pago.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamProcesamientoPago::getEkuParamProcesamientoPagos($p, $c);

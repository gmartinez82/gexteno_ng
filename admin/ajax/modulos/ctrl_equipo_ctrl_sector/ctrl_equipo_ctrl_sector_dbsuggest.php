...
if($buscar != '...'){
    ...
    $c->add('ctrl_equipo_ctrl_sector.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('ctrl_equipo_ctrl_sector');
$c->addOrden('ctrl_equipo_ctrl_sector.orden', 'asc');
$c->setCriterios();

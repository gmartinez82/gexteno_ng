...
<form id='form_datos_adm_modificar_estado' name='form_datos_adm_modificar_estado' method='post' >
    <div class='datos modificar-estado' identificador="<?php echo $us_memo->getId() ?>" modulo="us_memo" modulo_estado="us_memo_estado">
        ...
        <div class="par">
            ...
            <div class="dato">
                <?php Html::html_dib_select(1, 'cmb_us_memo_tipo_estado_id', Gral::getCmbFiltro($us_memo->getUsMemoTipoEstadosPotencialesCmb(), '...'), $cmb_fnd_chq_tipo_estado_id, 'textbox') ?>
                <div class="error label-error" id="cmb_us_memo_tipo_estado_id_error"><?php Gral::_echo($us_memo_tipo_estado_id_error) ?></div>
            </div>
        </div>

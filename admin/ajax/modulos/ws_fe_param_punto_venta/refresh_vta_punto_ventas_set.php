...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_punto_venta_ws_fe_param_punto_venta.ws_fe_param_punto_venta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_punto_venta');
$c->addRealJoin('vta_punto_venta_ws_fe_param_punto_venta', 'vta_punto_venta_ws_fe_param_punto_venta.vta_punto_venta_id', 'vta_punto_venta.id', 'LEFT JOIN');

...
$ws_fe_param_punto_venta_id = Gral::getVars(2, 'ws_fe_param_punto_venta_id');
$ws_fe_param_punto_venta = WsFeParamPuntoVenta::getOxId($ws_fe_param_punto_venta_id);
$gral_empresa = $ws_fe_param_punto_venta->getGralEmpresa();
...
<div class="datos" id="<?php Gral::_echo($gral_empresa->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo WsFeParamPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $ws_fe_param_punto_venta->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('WsFeParamPuntoVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_empresa->getDescripcion()) ?></strong>
        </a>
    </div>

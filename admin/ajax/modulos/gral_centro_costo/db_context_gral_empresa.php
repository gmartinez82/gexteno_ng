...
$gral_centro_costo_id = Gral::getVars(2, 'gral_centro_costo_id');
$gral_centro_costo = GralCentroCosto::getOxId($gral_centro_costo_id);
$gral_empresa = $gral_centro_costo->getGralEmpresa();
...
<div class="datos" id="<?php Gral::_echo($gral_empresa->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCentroCosto::getFiltrosArrGral() ?>&arr=<?php echo $gral_centro_costo->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCentroCostos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_empresa->getDescripcion()) ?></strong>
        </a>
    </div>

...
$o_ids = eval('return $o_padre->getGralCentroCostoUsUsuariosId();');
...
$c->add('gral_centro_costo_us_usuario.gral_centro_costo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('gral_centro_costo_us_usuario', 'gral_centro_costo_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

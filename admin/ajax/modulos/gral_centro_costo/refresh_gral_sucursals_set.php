...
$c->add('gral_centro_costo_gral_sucursal.gral_centro_costo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_sucursal');
$c->addRealJoin('gral_centro_costo_gral_sucursal', 'gral_centro_costo_gral_sucursal.gral_sucursal_id', 'gral_sucursal.id', 'LEFT JOIN');

...
$o_ids = eval('return $o_padre->getGralCentroCostoVtaVendedorsId();');
...
$c->add('gral_centro_costo_vta_vendedor.gral_centro_costo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('gral_centro_costo_vta_vendedor', 'gral_centro_costo_vta_vendedor.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

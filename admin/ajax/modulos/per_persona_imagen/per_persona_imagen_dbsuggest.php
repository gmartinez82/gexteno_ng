...
if($buscar != '...'){
    ...
    $c->add('per_persona_imagen.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('per_persona_imagen.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona_imagen.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_persona_imagen.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('per_persona_imagen');
$c->addOrden('per_persona_imagen.orden', 'asc');
$c->setCriterios();

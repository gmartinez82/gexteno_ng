...
$pde_oc_agrupacion_enviado_id = Gral::getVars(2, 'pde_oc_agrupacion_enviado_id');
$pde_oc_agrupacion_enviado = PdeOcAgrupacionEnviado::getOxId($pde_oc_agrupacion_enviado_id);
$pde_oc_agrupacion = $pde_oc_agrupacion_enviado->getPdeOcAgrupacion();
...
<div class="datos" id="<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcAgrupacionEnviado::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_agrupacion_enviado->getFiltrosArrXCampo('PdeOcAgrupacion', 'pde_oc_agrupacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcAgrupacionEnviados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc_agrupacion->getDescripcion()) ?></strong>
        </a>
    </div>

...
<div class='ficha'>
	...
	<div class='par impar'>
		...
		<div class='dato'><?php Gral::_echo($pde_recepcion->getInsMarca()->getDescripcion()) ?></div>
	</div>
	...
	<div class='par '>
		...
		<div class='dato'><?php Gral::_echo($pde_recepcion->getFechaEntrega()) ?></div>
	</div>
	...
	<div class='par impar'>
		...
		<div class='dato'><?php Gral::_echo($pde_recepcion->getVencimiento()) ?></div>
	</div>

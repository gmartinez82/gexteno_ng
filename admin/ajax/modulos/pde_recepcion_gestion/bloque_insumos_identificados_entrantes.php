<table border="0" align="center">
  <tr>
    ...
    <th width="150" class="adm_tbl_encabezado"><?php Lang::_lang('Codigo') ?></th>
  ...
  <?php for($i = 1; $i <= $cantidad; $i++){ ?>
	<?php
    if(!Gral::esPost()){
        $cmb_ins_marca_id[$i] = $pde_recepcion->getInsMarcaId();
  ...
  <tr>
    ...
    <td align="center" class="adm_tbl_lineas">
        <input type="text" id="txt_insumo_identificado_<?php $i ?>" name="txt_insumo_identificado[<?php echo $i ?>]" size="15" value="<?php Gral::_echo($txt_insumo_identificado[$i]) ?>" class="textbox">

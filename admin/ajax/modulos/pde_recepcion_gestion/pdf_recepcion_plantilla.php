...
// Info de la Empresa
// -----------------------------------------------------------------------------
$tipo = "Recepcion de Compra";
$tipo_letra = "X";
$codigo = $pde_recepcion->getCodigo();
$fecha = Gral::getFechaToWEB($pde_recepcion->getCreado());
...
$pdf->SetTitle($pde_recepcion->getNombreArchivoAdjuntoRecepcion());
...
// -----------------------------------------------------------------------------
$param = array(
    'pde_recepcion_id' => $pde_recepcion->getId(),
);
$archivo = Gral::getPathAbs() . "admin/ajax/modulos/pde_recepcion_gestion/pdf_recepcion_plantilla_tabla.php";
...
$archivo = Gral::getPathAbs() . "admin/ajax/modulos/pde_recepcion_gestion/pdf_recepcion_plantilla_tabla_oc.php";
$html_tabla = Gral::get_include_contents($archivo, $param);
...
$archivo = Gral::getPathAbs() . "admin/ajax/modulos/pde_recepcion_gestion/pdf_recepcion_plantilla_tabla_cotizaciones.php";
$html_tabla = Gral::get_include_contents($archivo, $param);

...
$gral_centro_costo_prv_proveedor_id = Gral::getVars(2, 'gral_centro_costo_prv_proveedor_id');
$gral_centro_costo_prv_proveedor = GralCentroCostoPrvProveedor::getOxId($gral_centro_costo_prv_proveedor_id);
$gral_centro_costo = $gral_centro_costo_prv_proveedor->getGralCentroCosto();
...
<div class="datos" id="<?php Gral::_echo($gral_centro_costo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCentroCostoPrvProveedor::getFiltrosArrGral() ?>&arr=<?php echo $gral_centro_costo_prv_proveedor->getFiltrosArrXCampo('GralCentroCosto', 'gral_centro_costo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCentroCostoPrvProveedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_centro_costo->getDescripcion()) ?></strong>
        </a>
    </div>

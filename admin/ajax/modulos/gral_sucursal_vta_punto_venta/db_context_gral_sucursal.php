...
$gral_sucursal = $gral_sucursal_vta_punto_venta->getGralSucursal();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalVtaPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_vta_punto_venta->getFiltrosArrXCampo('GralSucursal', 'gral_sucursal_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalVtaPuntoVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal->getDescripcion()) ?></strong>
        </a>
    </div>

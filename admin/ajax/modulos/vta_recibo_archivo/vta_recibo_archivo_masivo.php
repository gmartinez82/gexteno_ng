<div id="container" class="masivo-bloque">
    ...
    <a id="refresh" class="masivo-botones" href="?id=<?php echo $vta_recibo->getId() ?>">Actualizar Pagina</a>
</div>
...
var uploader = new plupload.Uploader({
    ...
    container: 'container',
    max_file_size : '10mb',
    url : 'ajax/archivos/upload_masivo.php?padre=<?php echo $vta_recibo->getId() ?>&clase=VtaRecibo',

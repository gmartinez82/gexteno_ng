...
$eku_de_e010_g_dtip_d_e_g_cam_f_e_id = Gral::getVars(2, 'eku_de_e010_g_dtip_d_e_g_cam_f_e_id');
$eku_de_e010_g_dtip_d_e_g_cam_f_e = EkuDeE010GDtipDEGCamFE::getOxId($eku_de_e010_g_dtip_d_e_g_cam_f_e_id);
$eku_de = $eku_de_e010_g_dtip_d_e_g_cam_f_e->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE010GDtipDEGCamFE::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e010_g_dtip_d_e_g_cam_f_e->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE010GDtipDEGCamFEs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

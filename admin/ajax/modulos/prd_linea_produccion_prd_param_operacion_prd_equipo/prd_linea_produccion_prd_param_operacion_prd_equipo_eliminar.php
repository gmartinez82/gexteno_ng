...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('PRD_LINEA_PRODUCCION_PRD_PARAM_OPERACION_PRD_EQUIPO_ADM_ACCION_ELIMINAR')){
    ...
    if($prd_linea_produccion_prd_param_operacion_prd_equipo){
        if($prd_linea_produccion_prd_param_operacion_prd_equipo->getHash() == $hash){
            $prd_linea_produccion_prd_param_operacion_prd_equipo->deleteAll();
        }
    }
}    
?>

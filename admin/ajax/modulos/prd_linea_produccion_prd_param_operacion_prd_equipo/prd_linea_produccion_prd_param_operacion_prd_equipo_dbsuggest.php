...
if($buscar != '...'){
    ...
    $c->add('prd_linea_produccion_prd_param_operacion_prd_equipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_linea_produccion_prd_param_operacion_prd_equipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_linea_produccion_prd_param_operacion_prd_equipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_linea_produccion_prd_param_operacion_prd_equipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_linea_produccion_prd_param_operacion_prd_equipo');
$c->addOrden('prd_linea_produccion_prd_param_operacion_prd_equipo.orden', 'asc');
$c->setCriterios();

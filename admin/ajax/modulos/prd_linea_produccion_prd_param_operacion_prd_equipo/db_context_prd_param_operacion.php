...
$prd_param_operacion = $prd_linea_produccion_prd_param_operacion_prd_equipo->getPrdParamOperacion();
...
<div class="datos" id="<?php Gral::_echo($prd_param_operacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrdLineaProduccionPrdParamOperacionPrdEquipo::getFiltrosArrGral() ?>&arr=<?php echo $prd_linea_produccion_prd_param_operacion_prd_equipo->getFiltrosArrXCampo('PrdParamOperacion', 'prd_param_operacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrdLineaProduccionPrdParamOperacionPrdEquipos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prd_param_operacion->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('gral_dia.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_dia.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_dia.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_dia.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_dia');
$c->addOrden('gral_dia.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralDia::getGralDias($p, $c);

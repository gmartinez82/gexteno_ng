...
if($buscar != '...'){
    ...
    $c->add('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini');
$c->addOrden('eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini.orden', 'asc');
$c->setCriterios();

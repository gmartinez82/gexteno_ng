...
$eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini_id = Gral::getVars(2, 'eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini_id');
...
$eku_de = $eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE605GDtipDEGCamCondGPaConEIni::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e605_g_dtip_d_e_g_cam_cond_g_pa_con_e_ini->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE605GDtipDEGCamCondGPaConEInis') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

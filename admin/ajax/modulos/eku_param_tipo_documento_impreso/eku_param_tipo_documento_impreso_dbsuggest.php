...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_documento_impreso.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_documento_impreso.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_documento_impreso.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_documento_impreso.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_documento_impreso');
$c->addOrden('eku_param_tipo_documento_impreso.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoDocumentoImpreso::getEkuParamTipoDocumentoImpresos($p, $c);

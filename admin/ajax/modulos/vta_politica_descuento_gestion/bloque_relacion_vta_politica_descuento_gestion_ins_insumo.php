	...
	<div class='buscador'>
            ...
            <div class="trigger wopenModal boton" archivo="ajax/modulos/ins_insumo/ins_insumo_alta.php" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="buscarSetResultados(1, '', 'ins_insumo', 'vta_politica_descuento', <?php Gral::_echo($vta_politica_descuento->getId()) ?>, 'VtaPoliticaDescuento', 'vta_politica_descuento_ins_insumo')" title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('ins_insumo') ?>'>

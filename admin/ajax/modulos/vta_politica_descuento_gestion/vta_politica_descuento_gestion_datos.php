...
<?php if (count($vta_politica_descuentos) > 0) { ?>
    ...
    <table border='0' align='center' class='listado' id='listado_adm_vta_politica_descuento_gestion'>
        ...
        <tr>
            ...
            <td width='150' align='center' class='adm_tbl_encabezado'>
                <?php Lang::_lang('Listas de Precios') ?>                    
            </td>

            <td width='200' align='center' class='adm_tbl_encabezado'>
                <?php Lang::_lang('Categorias') ?>                    
            </td>

            <td width='200' align='center' class='adm_tbl_encabezado'>
                <?php Lang::_lang('Productos') ?>                    
            </td>
        ...
        foreach ($vta_politica_descuentos as $vta_politica_descuento) {
            ...
            <tr id="tr_vta_politica_descuento_gestion_uno_<?php Gral::_echo($vta_politica_descuento->getId()) ?>" class="uno" identificador="<?php Gral::_echo($vta_politica_descuento->getId()) ?>">
                <?php include "vta_politica_descuento_gestion_uno.php" ?>
            </tr>

...
$criterio->add('eku_param_geo_ciudad.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('eku_param_geo_ciudad.codigo_eku', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_geo_ciudad.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_geo_ciudad.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

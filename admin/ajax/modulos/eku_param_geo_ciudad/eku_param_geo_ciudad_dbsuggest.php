...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_ciudad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_geo_ciudad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_ciudad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_ciudad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamGeoCiudad::getEkuParamGeoCiudads($p, $c);

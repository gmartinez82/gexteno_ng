...
$c->add('cli_subcategoria_gral_fp_forma_pago.cli_subcategoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_fp_forma_pago');
$c->addRealJoin('cli_subcategoria_gral_fp_forma_pago', 'cli_subcategoria_gral_fp_forma_pago.gral_fp_forma_pago_id', 'gral_fp_forma_pago.id', 'LEFT JOIN');

...
$o_ids = eval('return $o_padre->getCliSubcategoriaInsTipoListaPreciosId();');
...
$c->add('cli_subcategoria_ins_tipo_lista_precio.cli_subcategoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_tipo_lista_precio');
$c->addRealJoin('cli_subcategoria_ins_tipo_lista_precio', 'cli_subcategoria_ins_tipo_lista_precio.ins_tipo_lista_precio_id', 'ins_tipo_lista_precio.id', 'LEFT JOIN');

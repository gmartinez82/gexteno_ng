...
$o_ids = eval('return $o_padre->getGralSucursalUsUsuariosId();');
...
$c->add('gral_sucursal_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_sucursal');
$c->addRealJoin('gral_sucursal_us_usuario', 'gral_sucursal_us_usuario.gral_sucursal_id', 'gral_sucursal.id', 'LEFT JOIN');

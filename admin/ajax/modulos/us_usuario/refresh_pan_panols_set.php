...
$c->add('pan_panol_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pan_panol');
$c->addRealJoin('pan_panol_us_usuario', 'pan_panol_us_usuario.pan_panol_id', 'pan_panol.id', 'LEFT JOIN');

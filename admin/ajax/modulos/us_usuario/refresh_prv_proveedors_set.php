...
$c->add('prv_proveedor_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('prv_proveedor');
$c->addRealJoin('prv_proveedor_us_usuario', 'prv_proveedor_us_usuario.prv_proveedor_id', 'prv_proveedor.id', 'LEFT JOIN');

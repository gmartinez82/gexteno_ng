...
$o_ids = eval('return $o_padre->getPdeCentroRecepcionUsUsuariosId();');
...
$c->add('pde_centro_recepcion_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_centro_recepcion');
$c->addRealJoin('pde_centro_recepcion_us_usuario', 'pde_centro_recepcion_us_usuario.pde_centro_recepcion_id', 'pde_centro_recepcion.id', 'LEFT JOIN');

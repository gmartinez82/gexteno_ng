...
$o_ids = eval('return $o_padre->getVtaVendedorUsUsuariosId();');
...
$c->add('vta_vendedor_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('vta_vendedor_us_usuario', 'vta_vendedor_us_usuario.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

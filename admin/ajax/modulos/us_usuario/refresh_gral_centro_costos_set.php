...
$c->add('gral_centro_costo_us_usuario.us_usuario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_centro_costo');
$c->addRealJoin('gral_centro_costo_us_usuario', 'gral_centro_costo_us_usuario.gral_centro_costo_id', 'gral_centro_costo.id', 'LEFT JOIN');

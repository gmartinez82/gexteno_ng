...
if($buscar != '...'){
    ...
    $c->add('us_usuario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('us_usuario.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('us_usuario.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('us_usuario.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('us_usuario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('us_usuario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

...
$pde_factura_imagen_id = Gral::getVars(2, 'pde_factura_imagen_id');
$pde_factura_imagen = PdeFacturaImagen::getOxId($pde_factura_imagen_id);
$pde_factura = $pde_factura_imagen->getPdeFactura();
...
<div class="datos" id="<?php Gral::_echo($pde_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaImagen::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_imagen->getFiltrosArrXCampo('PdeFactura', 'pde_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_factura->getDescripcion()) ?></strong>
        </a>
    </div>

...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/pde_factura_imagen/pde_factura_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/pde_factura_imagen/pde_factura_imagen_uno_masinfo.php"; 
}
?>

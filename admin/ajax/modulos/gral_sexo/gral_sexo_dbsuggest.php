...
if($buscar != '...'){
    ...
    $c->add('gral_sexo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sexo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sexo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sexo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sexo');
$c->addOrden('gral_sexo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralSexo::getGralSexos($p, $c);

...
$vta_factura_ws_fe_ope_solicitud_id = Gral::getVars(2, 'vta_factura_ws_fe_ope_solicitud_id');
$vta_factura_ws_fe_ope_solicitud = VtaFacturaWsFeOpeSolicitud::getOxId($vta_factura_ws_fe_ope_solicitud_id);
$ws_fe_ope_solicitud = $vta_factura_ws_fe_ope_solicitud->getWsFeOpeSolicitud();
...
<div class="datos" id="<?php Gral::_echo($ws_fe_ope_solicitud->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaFacturaWsFeOpeSolicitud::getFiltrosArrGral() ?>&arr=<?php echo $vta_factura_ws_fe_ope_solicitud->getFiltrosArrXCampo('WsFeOpeSolicitud', 'ws_fe_ope_solicitud_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaFacturaWsFeOpeSolicituds') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ws_fe_ope_solicitud->getDescripcion()) ?></strong>
        </a>
    </div>

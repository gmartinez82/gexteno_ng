...
//                $col_marca_id_rollback_val = ($prv_insumo_rollback->getInsMarcaId() != 'null') ? $prv_insumo_rollback->getInsMarcaId() : $web_ins_marca_id;
//            } else {
//                $col_marca_id_rollback_val = ($prv_insumo_rollback->getInsMarcaId() != 'null') ? $prv_insumo_rollback->getInsMarcaId() : $objWorksheet_rollback->getCellByColumnAndRow($col_marca_id, $row)->getValue();
//            }
//
...
//                $col_pieza_id_rollback_val = ($col_pieza_id_rollback_val->getInsMarcaPieza() != 'null') ? $col_pieza_id_rollback_val->getInsMarcaPieza() : $web_pieza_id;
//            } else {
//                $col_pieza_id_rollback_val = ($col_pieza_id_rollback_val->getInsMarcaPieza() != 'null') ? $col_pieza_id_rollback_val->getInsMarcaPieza() : $objWorksheet_rollback->getCellByColumnAndRow($col_pieza_id, $row)->getValue();
//            }
        }
    } else {

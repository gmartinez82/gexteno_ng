...
?>
<td class="adm_tbl_lineas t3_td_nro_fila <?php echo $class_alerta; ?>">
    <?php Gral::_echo($row - 1); ?>
</td>
<td class="adm_tbl_lineas t3_td_nuevo <?php echo $class_alerta; ?>">
    <div class="check_nuevo">
        ...
        if (!($col_ins_insumo_id_val > '0' || $col_ins_matriz_id_val > '0')) {
            ...
            <input type="checkbox" 
                   name="check_nuevo[]"  
                   value="<?php echo $row ?>" 
                   <?php echo $checked_nuevo ?>  
                   title="<?php echo ($col_nuevo_val == '1') ? 'Se creara un nuevo insumo' : 'Crear un nuevo insumo' ?>" 
                   />            
            <?php
        }
        ?>
...
<td class="adm_tbl_lineas t3_td_id <?php echo $class_alerta; ?>">
    
    <!-- Se creara un nuevo insumo y una nueva matriz -->
    ...
    <!-- Cuando esta vinculado a un ins insumo -->
    <?php } else if ($col_ins_insumo_id_val != '' && $col_permite_desvincular_val == '1') { ?>
    ...
    <!-- Cuando se encuentra vinculado a un insumo existente y si fue modificado -->
    ...
    <!-- Cuando se encuentra vinculado a un insumo existente y no fue modificado -->
...
<td class="adm_tbl_lineas t3_td_cod_proveedor <?php echo $class_alerta; ?>"> 
    <?php Gral::_echo($col_codigo_proveedor_val) ?> 
</td>


<td class="adm_tbl_lineas t3_td_insumo <?php echo $class_alerta; ?>" >

    <div class="<?php echo $class_descripcion_ins_insumo_duplicada; ?>" title="<?php echo ($class_descripcion_ins_insumo_duplicada != '') ? $title_descripcion_ins_insumo_duplicada : '' ?>">
        
        <?php $checked_seleccion = ($col_actualiza_descripcion_val) ? 'checked="checked"' : "" ?>
        <input class="check_descripcion" type="checkbox" name="check_seleccion[]" title="<?php echo ($col_actualiza_descripcion_val == '1') ? 'Se modificara la descripcion del insumo del proveedor' : 'Modificar descripcion de insumo de proveedor' ?>" value="<?php echo $row ?>" <?php echo $checked_seleccion ?> />    

        <span class="descripcion">
        <?php Gral::_echo($col_descripcion_val); ?>
        </span>
        
        <img class="descripcion_insumo" src="imgs/btn_modi.gif" width="15" alt="btn-editar" title="Modificar descripcion" />
    </div>   

    <?php if ($col_nuevo_val == 1 && $col_descripcion_matriz_val != '') { ?>
        <div class="insumo-matriz-descripcion <?php echo $class_descripcion_ins_matriz_duplicada; ?>" title="<?php echo ($class_descripcion_ins_insumo_duplicada != '') ? $title_descripcion_ins_insumo_duplicada : 'Descripcion de Matriz' ?>">
...
<td class="adm_tbl_lineas t3_td_cod_marca <?php echo $class_alerta . ' ' . $class_marca_id_cod_marca_duplicada; ?>" title="<?php echo ($class_marca_id_cod_marca_duplicada != '') ? $title_marca_id_cod_marca_duplicada : '' ?>">
    ...
    <br />
    <input class="codigo marca" name="codigo-marca[]" type="text" title="Codigo de Marca" value="<?php Gral::_echo($col_codigo_marca_val); ?>">
</td> 

<td class="adm_tbl_lineas t3_td_cod_pieza <?php echo $class_alerta . ' ' . $class_marca_id_cod_oem_duplicada; ?>" title="<?php echo ($class_marca_id_cod_oem_duplicada != '') ? $title_marca_id_cod_marca_duplicada : '' ?>">
    ...
    <br />
    <input class="codigo pieza" name="codigo-pieza[]" type="text" title="Codido OEM" value="<?php Gral::_echo($col_codigo_pieza_val); ?>">
</td>

<td class="adm_tbl_lineas t3_td_nuevo_importe <?php echo $class_alerta; ?>">
    <div class="nuevo_importe">
        <?php PrvInsumoExcel::_echoImp($col_importe_val) ?>
    </div>
</td>

<td class="adm_tbl_lineas t3_td_nuevo_importe_neto <?php echo $class_alerta; ?>">
    <div class="nuevo_importe_neto">
        <?php PrvInsumoExcel::_echoImp($col_importe_neto_val); ?>
    </div>
</td>

<td class="adm_tbl_lineas t3_td_ultimo_importe <?php echo $class_alerta; ?>">
    <div class="ultimo-importe">
        <?php PrvInsumoExcel::_echoImp($col_ultimo_importe_val); ?>
    </div>
    <div class="ultimo-fecha">
        <?php echo $col_fecha_importacion_val; ?>
    </div>
</td>

<td class="adm_tbl_lineas t3_td_nuevo_incremento <?php echo $class_alerta; ?>">
...
<td class="adm_tbl_lineas t3_td_insumo_importe <?php echo $class_alerta; ?>">
    <?php PrvInsumoExcel::_echoImp($col_costo_actual_val) ?>
</td>

<td class="adm_tbl_lineas t3_td_insumo_incremento <?php echo $class_alerta; ?>">
...
<td class="adm_tbl_lineas t3_td_insumo_accion <?php echo $class_alerta; ?>">
    <div class="check_actualizar">
        <?php if ($col_proveedor_referencial_val){ ?>
        <img class="referencial" src="imgs/btn_importe.png" width="12" alt="hab" title="Es proveedor referencial de costos" />                    
        <?php } ?>
        ...
        <input type="checkbox" 
               name="check_actualizar_costo[]"  
               value="<?php echo $row ?>" 
                <?php echo $checked ?> 
                <?php echo $disabled ?> 
               title="<?php echo ($col_actualizar_costo_val == '1') ? 'Se actualizara el costo de insumo' : 'Actualizar costo de insumo' ?>"
               />    
        <?php } ?>
    </div>
</td>

<td class="adm_tbl_lineas t3_td_cancelar <?php echo $class_alerta; ?>">
    <div class="cancelar_registro" cancelado='<?php echo ($col_cancelado_val == 1) ? 1 : 0 ?>' >

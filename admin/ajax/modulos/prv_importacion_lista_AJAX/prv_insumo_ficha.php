...
<div class='ficha'>
	...
	<div class='par impar'>
		...
		<div class='dato'><?php Gral::_echo($prv_insumo->getInsMarcaPi()->getDescripcion()) ?></div>
	</div>
		
	<div class='par '>
		<div class='label'><?php Lang::_lang('Codigo del Proveedor') ?></div>
	...
	<div class='par '>
		<div class='label'><?php Lang::_lang('Codigo de Pieza') ?></div>

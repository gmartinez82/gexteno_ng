<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/fnd_chq_cheque/set_fnd_chq_cheque_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='fnd_chq_cheque_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('FndChqCheque') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='fnd_chq_cheque'><img src="imgs/btn_lupa.png" width="25"></label>

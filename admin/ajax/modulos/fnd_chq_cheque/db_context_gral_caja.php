...
$gral_caja = $fnd_chq_cheque->getGralCaja();
...
<div class="datos" id="<?php Gral::_echo($gral_caja->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo FndChqCheque::getFiltrosArrGral() ?>&arr=<?php echo $fnd_chq_cheque->getFiltrosArrXCampo('GralCaja', 'gral_caja_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('FndChqCheques') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_caja->getDescripcion()) ?></strong>
        </a>
    </div>

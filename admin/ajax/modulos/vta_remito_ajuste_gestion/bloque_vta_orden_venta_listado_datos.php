...
if (count($vta_orden_ventas) > 0) {
    ?>
    <form id='form_generar_remito_ajuste' name='form_generar_remito_ajuste' method='POST' action=''>

        <table border='0' align='center' class='listado' id='listado_vta_remito_ajuste_generar_remito_ajuste' multiseleccion = "<?php echo $control_presupuesto ?>">
            <tr>
        ...
        <div class="botonera">
            <button class="boton" id='btn_generar_remito_ajuste' name='btn_generar_remito_ajuste' type='button' class='btn_generar_remito_ajuste'><?php Lang::_lang('Generar Remito Ajuste') ?></button>
        </div>

...
// ------------------------------------------------------------------
$cmb_vta_hoja_ruta_id = Gral::getVars(Gral::VARS_POST, "cmb_vta_hoja_ruta_id", 0, Gral::TIPO_INTEGER);
...
{
    $arr["cmb_vta_hoja_ruta_id"] = Lang::_lang("Debe seleccionar una hoja de ruta para el remito ajuste", true);
    $arr["error"] = true;
}else{
...
if (!$arr["error"])
{
    $vta_remito_ajuste->setHojaRuta($cmb_vta_hoja_ruta_id);
}

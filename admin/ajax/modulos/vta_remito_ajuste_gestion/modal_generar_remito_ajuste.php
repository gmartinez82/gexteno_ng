...
if($cli_cliente){
    $vta_orden_ventas = $cli_cliente->getVtaOrdenVentasActivaRemitos($vta_presupuesto);
}

// controla que no se seleccionen OV de distintos presupuestos
$control_presupuesto = 1;
?>
<div class="datos generar-remito-ajuste" vta_presupuesto_id="<?php echo ($vta_presupuesto) ? $vta_presupuesto->getId() : 0 ?>">
    ...
    <div class="div_datos_generar_remito_ajustes">

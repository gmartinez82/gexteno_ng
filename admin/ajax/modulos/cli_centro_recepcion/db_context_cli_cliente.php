...
$cli_centro_recepcion_id = Gral::getVars(2, 'cli_centro_recepcion_id');
$cli_centro_recepcion = CliCentroRecepcion::getOxId($cli_centro_recepcion_id);
$cli_cliente = $cli_centro_recepcion->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliCentroRecepcion::getFiltrosArrGral() ?>&arr=<?php echo $cli_centro_recepcion->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliCentroRecepcions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_nota_credito_tipo_estado = $vta_nota_credito_estado->getVtaNotaCreditoTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_credito_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaCreditoEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_credito_estado->getFiltrosArrXCampo('VtaNotaCreditoTipoEstado', 'vta_nota_credito_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaCreditoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_credito_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pan_panol = $ins_stock_transformacion_destino->getPanPanol();
...
<div class="datos" id="<?php Gral::_echo($pan_panol->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsStockTransformacionDestino::getFiltrosArrGral() ?>&arr=<?php echo $ins_stock_transformacion_destino->getFiltrosArrXCampo('PanPanol', 'pan_panol_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsStockTransformacionDestinos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pan_panol->getDescripcion()) ?></strong>
        </a>
    </div>

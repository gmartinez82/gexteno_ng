...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_tipo_nota_credito_ws_fe_param_tipo_comprobante.ws_fe_param_tipo_comprobante_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_tipo_nota_credito');
$c->addRealJoin('vta_tipo_nota_credito_ws_fe_param_tipo_comprobante', 'vta_tipo_nota_credito_ws_fe_param_tipo_comprobante.vta_tipo_nota_credito_id', 'vta_tipo_nota_credito.id', 'LEFT JOIN');

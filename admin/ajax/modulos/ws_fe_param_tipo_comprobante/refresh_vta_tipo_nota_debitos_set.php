...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_tipo_nota_debito_ws_fe_param_tipo_comprobante.ws_fe_param_tipo_comprobante_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_tipo_nota_debito');
$c->addRealJoin('vta_tipo_nota_debito_ws_fe_param_tipo_comprobante', 'vta_tipo_nota_debito_ws_fe_param_tipo_comprobante.vta_tipo_nota_debito_id', 'vta_tipo_nota_debito.id', 'LEFT JOIN');

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_tipo_nota_credito_ws_fe_param_tipo_comprobante.ws_fe_param_tipo_comprobante_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_tipo_nota_credito');
$c->addRealJoin('pde_tipo_nota_credito_ws_fe_param_tipo_comprobante', 'pde_tipo_nota_credito_ws_fe_param_tipo_comprobante.pde_tipo_nota_credito_id', 'pde_tipo_nota_credito.id', 'LEFT JOIN');

...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_distrito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_geo_distrito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_distrito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_distrito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_geo_distrito');
$c->addOrden('eku_param_geo_distrito.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamGeoDistrito::getEkuParamGeoDistritos($p, $c);

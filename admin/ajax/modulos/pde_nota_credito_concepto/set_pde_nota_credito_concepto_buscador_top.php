...
$criterio->add('pde_nota_credito_concepto.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->addRealJoin('cntb_cuenta', 'cntb_cuenta.id', 'pde_nota_credito_concepto.cntb_cuenta_id', 'LEFT JOIN');

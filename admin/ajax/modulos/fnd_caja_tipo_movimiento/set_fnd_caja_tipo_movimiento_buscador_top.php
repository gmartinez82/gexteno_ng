...
$criterio->add('fnd_caja_tipo_movimiento.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('fnd_caja_tipo_movimiento.descripcion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('fnd_caja_tipo_movimiento.automatico', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
...
$criterio->add('fnd_caja_tipo_movimiento.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

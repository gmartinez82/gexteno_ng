...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_DE_E730_G_DTIP_D_E_G_CAM_ITEM_G_CAM_I_V_A_ADM_ACCION_ELIMINAR')){
    ...
    if($eku_de_e730_g_dtip_d_e_g_cam_item_g_cam_i_v_a){
        if($eku_de_e730_g_dtip_d_e_g_cam_item_g_cam_i_v_a->getHash() == $hash){
            $eku_de_e730_g_dtip_d_e_g_cam_item_g_cam_i_v_a->deleteAll();
        }
    }
}    
?>

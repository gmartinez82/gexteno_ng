...
if($buscar != '...'){
    ...
    $c->add('gral_medio_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_medio_pago.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_medio_pago.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_medio_pago.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_medio_pago');
$c->addOrden('gral_medio_pago.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralMedioPago::getGralMedioPagos($p, $c);

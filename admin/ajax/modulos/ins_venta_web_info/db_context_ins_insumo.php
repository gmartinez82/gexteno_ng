...
$ins_venta_web_info_id = Gral::getVars(2, 'ins_venta_web_info_id');
$ins_venta_web_info = InsVentaWebInfo::getOxId($ins_venta_web_info_id);
$ins_insumo = $ins_venta_web_info->getInsInsumo();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsVentaWebInfo::getFiltrosArrGral() ?>&arr=<?php echo $ins_venta_web_info->getFiltrosArrXCampo('InsInsumo', 'ins_insumo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsVentaWebInfos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo->getDescripcion()) ?></strong>
        </a>
    </div>

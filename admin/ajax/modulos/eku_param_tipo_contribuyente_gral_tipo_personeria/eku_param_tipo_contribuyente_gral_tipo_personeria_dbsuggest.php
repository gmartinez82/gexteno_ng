...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_contribuyente_gral_tipo_personeria.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_contribuyente_gral_tipo_personeria');
$c->addOrden('eku_param_tipo_contribuyente_gral_tipo_personeria.orden', 'asc');
$c->setCriterios();

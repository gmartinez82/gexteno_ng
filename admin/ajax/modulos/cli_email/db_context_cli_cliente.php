...
$cli_email_id = Gral::getVars(2, 'cli_email_id');
$cli_email = CliEmail::getOxId($cli_email_id);
$cli_cliente = $cli_email->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CliEmail::getFiltrosArrGral() ?>&arr=<?php echo $cli_email->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CliEmails') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

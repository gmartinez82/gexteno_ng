...
?>
<form id='form_datos_anular_comision' name='form_datos_anular_comision' method='post' >
    <div class='datos anular-comision' vta_comision_id="<?php echo $vta_comision_id ?>">

...
if (!$arr["error"]) {
    ...
    //$vta_comision_estado = $vta_comision->setVtaComisionEstado(VtaComisionTipoEstado::TIPO_ANULADO, $txa_observacion);
    $vta_comision_estado = $vta_comision->setVtaComisionAnular($txa_observacion);
}

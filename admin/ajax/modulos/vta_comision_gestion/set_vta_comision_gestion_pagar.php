...
if (!$arr["error"]) {
    ...
    //$vta_comision_estado = $vta_comision->setVtaComisionEstado(VtaComisionTipoEstado::TIPO_PAGADO, $txa_observacion);
    $vta_comision_estado = $vta_comision->setVtaComisionPagar($txa_observacion);
}

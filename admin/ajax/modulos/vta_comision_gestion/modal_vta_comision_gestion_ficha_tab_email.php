...
<div class="titulo"><?php Lang::_lang('Historial de Emails de la Comision') ?></div>
        ...
        foreach ($vta_comision_enviados as $vta_comision_enviado) {
            ...
            <tr>
                <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                    <div class="fecha">
                        <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_comision_enviado->getCreado())); ?>
                    </div>
                </td>	
                ...
                <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                    <div class="estado">
                        <img src="imgs/btn_estado_<?php echo $vta_comision_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                    </div>
                </td>
                ...
                <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                    <div class="creado-por-descripcion">
                        <?php Gral::_echo($vta_comision_enviado->getCreadoPorDescripcion()); ?>
                    </div>
                </td>
                ...
                <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                    <ul class="adm_botones_acciones_modal_ficha">
                        ...
                        <?php if (UsCredencial::getEsAcreditado('VTA_FACTURA_GESTION_ACCION_COMPROBANTE')) { ?>
                            <li class='adm_botones_accion vta-comision-comprobante' vta_comision_enviado_id='<?php echo $vta_comision_enviado->getId() ?>'>
                        ...
                        <?php if (UsCredencial::getEsAcreditado('VTA_PRESUPUESTO_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                            <li class='adm_botones_accion vta-comision-ver-cuerpo-correo' vta_comision_enviado_id='<?php echo $vta_comision_enviado->getId() ?>'>

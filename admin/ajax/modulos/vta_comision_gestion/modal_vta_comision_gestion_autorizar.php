...
?>
<form id='form_datos_autorizar_comision' name='form_datos_autorizar_comision' method='post' >
    <div class='datos autorizar-comision' vta_comision_id="<?php echo $vta_comision_id ?>">

...
if($buscar != '...'){
    ...
    $c->add('pln_turno.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('pln_turno.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_turno.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_turno.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('pln_turno');
$c->addOrden('pln_turno.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = PlnTurno::getPlnTurnos($p, $c);

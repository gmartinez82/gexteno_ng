...
if($buscar != '...'){
    ...
    $c->add('gral_novedad_motivo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_novedad_motivo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad_motivo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad_motivo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_novedad_motivo');
$c->addOrden('gral_novedad_motivo.orden', 'asc');
$c->setCriterios();

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq');
$c->addOrden('eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq.orden', 'asc');
$c->setCriterios();

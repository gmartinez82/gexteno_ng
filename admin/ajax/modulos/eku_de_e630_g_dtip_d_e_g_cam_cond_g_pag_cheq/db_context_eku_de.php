...
$eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq_id = Gral::getVars(2, 'eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq_id');
...
$eku_de = $eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE630GDtipDEGCamCondGPagCheq::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE630GDtipDEGCamCondGPagCheqs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

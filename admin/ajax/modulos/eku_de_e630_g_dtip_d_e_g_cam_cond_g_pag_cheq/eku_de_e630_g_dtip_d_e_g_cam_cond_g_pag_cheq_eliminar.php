...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_DE_E630_G_DTIP_D_E_G_CAM_COND_G_PAG_CHEQ_ADM_ACCION_ELIMINAR')){
    ...
    if($eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq){
        if($eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq->getHash() == $hash){
            $eku_de_e630_g_dtip_d_e_g_cam_cond_g_pag_cheq->deleteAll();
        }
    }
}    
?>

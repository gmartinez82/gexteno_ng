...
$pde_nota_debito_pde_tributo_id = Gral::getVars(2, 'pde_nota_debito_pde_tributo_id');
$pde_nota_debito_pde_tributo = PdeNotaDebitoPdeTributo::getOxId($pde_nota_debito_pde_tributo_id);
$pde_nota_debito = $pde_nota_debito_pde_tributo->getPdeNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaDebitoPdeTributo::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito_pde_tributo->getFiltrosArrXCampo('PdeNotaDebito', 'pde_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaDebitoPdeTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

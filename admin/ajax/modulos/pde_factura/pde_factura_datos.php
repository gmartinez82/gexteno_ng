...
<?php include Gral::getPathAbs().'admin/parciales/buscadores/activos/pde_factura.php' ?>

<?php if(count($pde_facturas) > 0){ ?>

<table border='0' align='center' class='listado' id='listado_adm_pde_factura'>
  ...
  <tr>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=pde_tipo_origen_factura_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('PdeTipoOrigenFactura') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='pde_tipo_origen_factura_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id="tr_pde_factura_uno_<?php Gral::_echo($pde_factura->getId()) ?>" class="uno" identificador="<?php Gral::_echo($pde_factura->getId()) ?>">
  	<?php include "pde_factura_uno.php" ?>
  </tr>
  
  
  <tr id='tr_eliminar_<?php Gral::_echo($pde_factura->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($pde_factura->getId()) ?>" >
	<td colspan='26' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($pde_factura->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />
...
?>
  <tr id='tr_mi_<?php Gral::_echo($pde_factura->getId()) ?>' <?php Gral::_echo($mi_display) ?>>
	...
	<div class="masinfo">
		<?php 
		if(trim($id) == $pde_factura->getId()){ 
			include "pde_factura_adm_masinfo.php";
		}
		?>
	</div>

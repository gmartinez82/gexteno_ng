<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/pde_factura/set_pde_factura_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='pde_factura_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('PdeFactura') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='pde_factura'><img src="imgs/btn_lupa.png" width="25"></label>

	...
	<div class='relacion ws_fe_ope_solicitud' clase='ws_fe_ope_solicitud' padre='pde_recibo' padre_clase='PdeRecibo' relacion='PdeReciboWsFeOpeSolicitud'>

	<div class='titulo'>
            <?php Lang::_lang('WsFeOpeSolicituds') ?>
            <?php 
            $cantidad_ws_fe_ope_solicituds = count($pde_recibo->getWsFeOpeSolicitudsXPdeReciboWsFeOpeSolicitud());

...
$o_ids = eval('return $o_padre->getPdeReciboWsFeOpeSolicitudsId();');


// elementos seleccionados
$c = new Criterio();
$c->add('pde_recibo_ws_fe_ope_solicitud.pde_recibo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ws_fe_ope_solicitud');
$c->addRealJoin('pde_recibo_ws_fe_ope_solicitud', 'pde_recibo_ws_fe_ope_solicitud.ws_fe_ope_solicitud_id', 'ws_fe_ope_solicitud.id', 'LEFT JOIN');

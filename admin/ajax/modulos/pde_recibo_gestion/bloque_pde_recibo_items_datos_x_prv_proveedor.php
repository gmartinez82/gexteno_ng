...
?>
<form id='form_generar_recibo' name='form_generar_recibo' method='POST' action='' prv_proveedor_id="<?php echo $dbsug_prv_proveedor_id ?>">
    <div class="label-error" id='error_general_error'></div>
    <table class="listado_pde_recibo_items" id="listado_pde_recibo_items">
        <tr>
...
<div class="botonera">
    <button id='btn_set_ws_fe_recibo_afip' name='btn_set_ws_fe_recibo_afip' type='button' class='boton btn_set_ws_fe_recibo_afip' prv_proveedor_id="<?php echo $dbsug_prv_proveedor_id ?>"><?php Lang::_lang('Siguiente') ?></button>
</div>
...
<?php if (count($pde_recibos) > 0) { ?>
    ...
    <table border='0' align='center' class='listado' id='listado_adm_pde_recibo_gestion'>
        ...
        foreach ($pde_recibos as $pde_recibo) {
            ...
            <tr id="tr_pde_recibo_gestion_uno_<?php Gral::_echo($pde_recibo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($pde_recibo->getId()) ?>">
                <?php include "pde_recibo_gestion_uno.php" ?>
            </tr>


            <tr id='tr_eliminar_<?php Gral::_echo($pde_recibo->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($pde_recibo->getId()) ?>" >
                <td colspan='14' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($pde_recibo->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
                        <br />

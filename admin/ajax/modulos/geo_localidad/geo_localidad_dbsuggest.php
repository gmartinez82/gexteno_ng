...
if($buscar != '...'){
    ...
    $c->add('geo_localidad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('geo_localidad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_localidad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_localidad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

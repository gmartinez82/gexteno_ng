...
$c->add('gral_ruta_geo_localidad.geo_localidad_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_ruta');
$c->addRealJoin('gral_ruta_geo_localidad', 'gral_ruta_geo_localidad.gral_ruta_id', 'gral_ruta.id', 'LEFT JOIN');

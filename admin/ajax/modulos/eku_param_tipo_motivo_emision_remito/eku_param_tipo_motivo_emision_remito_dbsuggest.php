...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_motivo_emision_remito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_motivo_emision_remito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_motivo_emision_remito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_motivo_emision_remito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_motivo_emision_remito');
$c->addOrden('eku_param_tipo_motivo_emision_remito.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoMotivoEmisionRemito::getEkuParamTipoMotivoEmisionRemitos($p, $c);

...
if($buscar != '...'){
    ...
    $c->add('eku_param_transporte_responsable_flete.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_transporte_responsable_flete.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_responsable_flete.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_responsable_flete.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_transporte_responsable_flete');
$c->addOrden('eku_param_transporte_responsable_flete.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTransporteResponsableFlete::getEkuParamTransporteResponsableFletes($p, $c);

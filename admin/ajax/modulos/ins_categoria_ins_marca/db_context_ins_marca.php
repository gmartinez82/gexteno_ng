...
$ins_marca = $ins_categoria_ins_marca->getInsMarca();
...
<div class="datos" id="<?php Gral::_echo($ins_marca->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsCategoriaInsMarca::getFiltrosArrGral() ?>&arr=<?php echo $ins_categoria_ins_marca->getFiltrosArrXCampo('InsMarca', 'ins_marca_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsCategoriaInsMarcas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_marca->getDescripcion()) ?></strong>
        </a>
    </div>

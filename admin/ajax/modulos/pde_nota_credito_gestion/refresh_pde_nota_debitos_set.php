...
$o_ids = eval('return $o_padre->getPdeNotaCreditoPdeNotaDebitosId();');


// elementos seleccionados
$c = new Criterio();
$c->add('pde_nota_credito_pde_nota_debito.pde_nota_credito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_nota_debito');
$c->addRealJoin('pde_nota_credito_pde_nota_debito', 'pde_nota_credito_pde_nota_debito.pde_nota_debito_id', 'pde_nota_debito.id', 'LEFT JOIN');

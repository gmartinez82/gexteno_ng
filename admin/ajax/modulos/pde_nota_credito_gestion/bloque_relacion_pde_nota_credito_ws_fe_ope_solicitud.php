	...
	<div class='relacion ws_fe_ope_solicitud' clase='ws_fe_ope_solicitud' padre='pde_nota_credito' padre_clase='PdeNotaCredito' relacion='PdeNotaCreditoWsFeOpeSolicitud'>

	<div class='titulo'>
            <?php Lang::_lang('WsFeOpeSolicituds') ?>
            <?php 
            $cantidad_ws_fe_ope_solicituds = count($pde_nota_credito->getWsFeOpeSolicitudsXPdeNotaCreditoWsFeOpeSolicitud());

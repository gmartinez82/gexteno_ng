...
if(in_array($pde_factura_pde_tributo->getId(), $o_ids)){
	...
	$pde_nota_credito_pde_factura_pde_tributo = PdeNotaCreditoPdeFacturaPdeTributo::getOxArray($arr_cri);
...
<div class='list <?php echo $css_sel ?>' title='<?php echo $pde_factura_pde_tributo->getObservacion() ?>'>
    ...
    <input type='checkbox' id='chk_pde_factura_pde_tributo_id_<?php echo $pde_factura_pde_tributo->getId() ?>' name='chk_pde_factura_pde_tributo[<?php echo $pde_factura_pde_tributo->getId() ?>]' <?php echo $sel ?> value='1' identificador='<?php echo $pde_factura_pde_tributo->getId() ?>' relacion_id='<?php echo $pde_nota_credito_pde_factura_pde_tributo_id ?>' />
    <?php } ?>

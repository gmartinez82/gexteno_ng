...
$pde_tipo_nota_credito_id = Gral::getVars(Gral::VARS_POST, "cmb_pde_tipo_nota_credito_id", 0, Gral::TIPO_INTEGER);
...
$gral_fp_forma_pago_id = Gral::getVars(Gral::VARS_POST, "cmb_gral_fp_forma_pago_id", null);
...
if ($pde_tipo_nota_credito_id == 0) {
    $arr["cmb_pde_tipo_nota_credito_id"] = Lang::_lang("Debe seleccionar un Tipo de Nota de Credito", true);
    $arr["error"] = true;
}
...
$pde_comprobante_existente = PdeNotaCredito::getPdeNotaCreditoXProveedorYNumero($prv_proveedor_id, $txt_nro_punto_venta . '-' . $txt_nro_comprobante);
...
if (!$arr["error"]) {
    ...
    $pde_nota_credito = PdeNotaCredito::setInicializarPdeNotaCreditoItem($pde_tipo_nota_credito_id, $gral_actividad_id, $gral_escenario_id, $gral_fp_forma_pago_id, $gral_empresa_id, $pde_centro_pedido_id, $prv_proveedor_id, $txt_fecha, $cmb_gral_mes_id, $cmb_anio, $txt_nro_timbrado, $txt_nro_punto_venta, $txt_nro_comprobante, $txt_cantidads, $txt_descripcions, $txt_importe_unitarios, $cmb_gral_tipo_iva_ids, $cmb_pde_nota_credito_concepto_ids, $txa_observacion, $txt_comprobante_tributos);
}

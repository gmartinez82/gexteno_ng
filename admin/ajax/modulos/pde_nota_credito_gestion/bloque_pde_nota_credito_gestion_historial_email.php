<table border="0" class="tabla-modal-ficha-emails">
    ...
    <?php
    $pde_nota_credito_enviados = $pde_nota_credito->getPdeNotaCreditoEnviados();
    $cont = 0;
    foreach ($pde_nota_credito_enviados as $pde_nota_credito_enviado) {
        $cont++;
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($pde_nota_credito_enviado->getCreado())); ?>
                </div>
            </td>	

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="asunto">
                    <?php Gral::_echo($pde_nota_credito_enviado->getAsunto()); ?>
                </div>
                <div class="destinatario">
                    <?php Gral::_echo($pde_nota_credito_enviado->getDestinatario()); ?>
                </div>
                <div class="observacion">
                    <?php Gral::_echo($pde_nota_credito_enviado->getObservacion()); ?>
                </div>                 
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="estado">
                    <img src="imgs/btn_estado_<?php echo $pde_nota_credito_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="codigo_envio">
                    <?php Gral::_echo($pde_nota_credito_enviado->getCodigoEnvio()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por-descripcion">
                    <?php Gral::_echo($pde_nota_credito_enviado->getCreadoPorDescripcion()); ?>
                </div>
            </td>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                <ul class="adm_botones_acciones_modal_ficha">
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_NOTA_CREDITO_GESTION_ACCION_COMPROBANTE')) { ?>
                        <li class='adm_botones_accion pde-nota-credito-comprobante' pde_nota_credito_enviado_id='<?php echo $pde_nota_credito_enviado->getId() ?>'>
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_NOTA_CREDITO_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                        <li class='adm_botones_accion pde-nota-credito-ver-cuerpo-correo' pde_nota_credito_enviado_id='<?php echo $pde_nota_credito_enviado->getId() ?>'>

...
if (count($txt_descripcions) > 0) {
    ?>
    <table border='0' align='center' class='listado_pde_nota_credito_items' id='listado_pde_nota_credito_items_confirmacion' multiseleccion = "<?php echo $control_presupuesto ?>">
        <tr>
        ...
        foreach ($txt_descripcions as $key => $txt_descripcion) {
            ...
            ?>
            <tr id="tr_pde_nota_credito_uno_<?php Gral::_echo($key) ?>" class="uno">
                <?php //include "bloque_modal_pde_nota_credito_listado_uno.php"  ?>

                <td align="center">
                    <div class="pde_nota_credito_concepto" id="cmb_pde_nota_credito_concepto_id[<?php echo $key ?>]" name="cmb_pde_nota_credito_concepto_id[<?php echo $key ?>]">

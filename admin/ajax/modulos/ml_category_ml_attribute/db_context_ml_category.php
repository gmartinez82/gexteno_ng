...
$ml_category_ml_attribute_id = Gral::getVars(2, 'ml_category_ml_attribute_id');
$ml_category_ml_attribute = MlCategoryMlAttribute::getOxId($ml_category_ml_attribute_id);
$ml_category = $ml_category_ml_attribute->getMlCategory();
...
<div class="datos" id="<?php Gral::_echo($ml_category->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo MlCategoryMlAttribute::getFiltrosArrGral() ?>&arr=<?php echo $ml_category_ml_attribute->getFiltrosArrXCampo('MlCategory', 'ml_category_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('MlCategoryMlAttributes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ml_category->getDescripcion()) ?></strong>
        </a>
    </div>

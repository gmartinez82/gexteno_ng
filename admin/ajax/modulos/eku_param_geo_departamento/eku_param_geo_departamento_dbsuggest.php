...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_departamento.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_geo_departamento.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_departamento.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_geo_departamento.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_geo_departamento');
$c->addOrden('eku_param_geo_departamento.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamGeoDepartamento::getEkuParamGeoDepartamentos($p, $c);

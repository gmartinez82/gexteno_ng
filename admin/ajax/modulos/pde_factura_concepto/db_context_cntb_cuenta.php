...
$cntb_cuenta = $pde_factura_concepto->getCntbCuenta();
...
<div class="datos" id="<?php Gral::_echo($cntb_cuenta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaConcepto::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_concepto->getFiltrosArrXCampo('CntbCuenta', 'cntb_cuenta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaConceptos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_cuenta->getDescripcion()) ?></strong>
        </a>
    </div>

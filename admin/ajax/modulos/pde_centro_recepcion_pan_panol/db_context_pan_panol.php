...
$pan_panol = $pde_centro_recepcion_pan_panol->getPanPanol();
...
<div class="datos" id="<?php Gral::_echo($pan_panol->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeCentroRecepcionPanPanol::getFiltrosArrGral() ?>&arr=<?php echo $pde_centro_recepcion_pan_panol->getFiltrosArrXCampo('PanPanol', 'pan_panol_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeCentroRecepcionPanPanols') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pan_panol->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pde_centro_recepcion_pan_panol_id = Gral::getVars(2, 'pde_centro_recepcion_pan_panol_id');
$pde_centro_recepcion_pan_panol = PdeCentroRecepcionPanPanol::getOxId($pde_centro_recepcion_pan_panol_id);
$pde_centro_recepcion = $pde_centro_recepcion_pan_panol->getPdeCentroRecepcion();
...
<div class="datos" id="<?php Gral::_echo($pde_centro_recepcion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeCentroRecepcionPanPanol::getFiltrosArrGral() ?>&arr=<?php echo $pde_centro_recepcion_pan_panol->getFiltrosArrXCampo('PdeCentroRecepcion', 'pde_centro_recepcion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeCentroRecepcionPanPanols') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_centro_recepcion->getDescripcion()) ?></strong>
        </a>
    </div>

...
<table border='0' align='center' class='listado' id='listado_adm_afip_citi_prc'>
  ...
  <tr id="tr_afip_citi_prc_uno_<?php Gral::_echo($afip_citi_prc->getId()) ?>" class="uno" identificador="<?php Gral::_echo($afip_citi_prc->getId()) ?>">
  	<?php include "afip_citi_prc_uno.php" ?>
  </tr>
...
?>
  <tr id='tr_mi_<?php Gral::_echo($afip_citi_prc->getId()) ?>' <?php Gral::_echo($mi_display) ?>>
	...
	<div class="masinfo">
		<?php 
		if(trim($id) == $afip_citi_prc->getId()){ 
			include "afip_citi_prc_adm_masinfo.php";
		}
		?>
	</div>

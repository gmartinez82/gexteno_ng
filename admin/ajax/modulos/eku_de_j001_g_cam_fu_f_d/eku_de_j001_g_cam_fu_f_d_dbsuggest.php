...
if($buscar != '...'){
    ...
    $c->add('eku_de_j001_g_cam_fu_f_d.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_j001_g_cam_fu_f_d.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_j001_g_cam_fu_f_d.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_j001_g_cam_fu_f_d.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_j001_g_cam_fu_f_d');
$c->addOrden('eku_de_j001_g_cam_fu_f_d.orden', 'asc');
$c->setCriterios();

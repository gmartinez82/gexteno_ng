...
$proximo_numero_comprobante = $vta_nota_credito->getProximoNumeroComprobante();
...
<form id='form_reasignar_numero_comprobante' name='form_reasignar_numero_comprobante' method='post' action='' >
    <div class="datos remito" >       
        ...
        <div class="par">
            ...
            <div class="dato">
                <?php echo $vta_nota_credito->getNumeroSucursal() ?>-<?php echo $vta_nota_credito->getNumeroPuntoVenta() ?>
        ...
        <div class="par">
            ...
            <div class="dato">
                <textarea name='txa_nota_interna' rows='2' cols='60' id='txa_nota_interna' class='textbox'><?php echo $vta_nota_credito->getNotaInterna();?></textarea>
                <div class="label-error" id="txa_nota_interna_error"></div>
            </div>
        </div>

        <div class="botonera">
            <button class="boton gen-modal-btn-confirmar" id='btn_registrar' name='btn_registrar' type='button' gen-modal-file-post="ajax/modulos/vta_nota_credito_gestion/set_modal_reasignar_numero_comprobante.php?vta_nota_credito_id=<?php echo $vta_nota_credito_id; ?>" gen-modal-content=".div_modal" gen-modal-callback="setInitVtaNotaCreditoGestion(); refreshAdmAll('vta_nota_credito_gestion', 1);"><?php Lang::_lang('Reasignar Numero de Comprobante') ?></button>
        </div>
    </div>
</form>
<script>

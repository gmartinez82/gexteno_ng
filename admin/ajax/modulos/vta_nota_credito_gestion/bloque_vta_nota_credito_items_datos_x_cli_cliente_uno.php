...
<tr class="tr-item" key = "<?php echo $key ?>">
    ...
    <td>
        <div class="vta_nota_credito_concepto">
            <?php
            $vta_nota_credito_concepto_id = $cmb_vta_nota_credito_concepto_ids[$key];
            Html::html_dib_select(1, "cmb_vta_nota_credito_concepto_id[" . $key . "]", Gral::getCmbFiltro(VtaNotaCreditoConcepto::getVtaNotaCreditoConceptosCmb(), '...'), $vta_nota_credito_concepto_id, 'textbox vta_nota_credito_concepto_id' . $error_input_css);
            ?>
        </div>

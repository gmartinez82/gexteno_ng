...
$vta_nota_credito_id = $param["vta_nota_credito_id"];
...
<table cellpadding="3" class="listado" id="listado_adm_vta_nota_credito_gestion" border="0" align="center">
    ...
    <tbody>
        ...
        foreach ( $eku_de_e700_g_dtip_d_e_g_cam_items as $i => $eku_de_e700_g_dtip_d_e_g_cam_item )
        {
            ...
            //$ins_insumo = $vta_nota_credito_vta_orden_venta->getInsInsumo();
            //$importe_unitario = $vta_nota_credito_vta_orden_venta->getImporteUnitarioParaComprobante();
            //$importe_total = $vta_nota_credito_vta_orden_venta->getImporteTotalParaComprobante();
            ...
            ?>
            <tr <?php echo($cont == 23) ? 'pagebreak="true"' : '' ?> id="tr_vta_nota_credito_vta_orden_venta_gestion_uno_<?php echo $eku_de_e700_g_dtip_d_e_g_cam_item->getId() ?>" class="uno" identificador="<?php echo $eku_de_e700_g_dtip_d_e_g_cam_item->getId() ?>">

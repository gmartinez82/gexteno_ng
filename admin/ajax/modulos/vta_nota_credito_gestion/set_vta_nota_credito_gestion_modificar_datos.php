...
if ($vta_tipo_nota_credito_id == 0) {
    $arr["cmb_vta_tipo_nota_credito_id"] = Lang::_lang("Debe seleccionar un Tipo de NC", true);
    $arr["error"] = true;
}
if ($cli_cliente_id == 0) {
...
if (!$arr["error"]) {
    ...
    $vta_nota_credito->setModificarDatosComprobante($vta_tipo_nota_credito_id, $cli_cliente_id, $txt_fecha, $cmb_gral_mes_id, $cmb_anio, $txt_nro_timbrado, $txt_nro_punto_venta, $txt_nro_comprobante, $txt_fecha_vencimiento, $txa_observacion);
}

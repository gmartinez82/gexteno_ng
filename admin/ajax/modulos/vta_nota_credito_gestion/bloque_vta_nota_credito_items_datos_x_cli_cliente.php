...
?>
<form id='form_generar_nota_credito' name='form_generar_nota_credito' method='POST' action='' cli_cliente_id="<?php echo $dbsug_cli_cliente_id ?>">

    <?php include "bloque_generar_comprobantes_vinculados.php" ?>

    <div class="label-error" id='error_general_error'></div>
    
    <table class="listado_vta_nota_credito_items" id="listado_vta_nota_credito_items">
        <tr>
...
<div class="botonera">
    <button id='btn_set_ws_fe_nota_credito_afip' name='btn_set_ws_fe_nota_credito_afip' type='button' class='boton btn_set_ws_fe_nota_credito_afip' cli_cliente_id="<?php echo $dbsug_cli_cliente_id ?>"><?php Lang::_lang('Siguiente') ?></button>
</div>
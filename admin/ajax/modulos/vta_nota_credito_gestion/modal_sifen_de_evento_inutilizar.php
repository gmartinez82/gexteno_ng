...
if($vta_nota_credito->getCae() != ''){
    echo 'El comprobante se encuentra autorizado, no se puede inutilizar.';
    exit;
}

$txa_observacion = 'Se inutiliza el numero de comprobante por ...';

echo 'Funcionalidad no operativa hasta el momento. Se debe definir como vincular con el comprobante';
exit;

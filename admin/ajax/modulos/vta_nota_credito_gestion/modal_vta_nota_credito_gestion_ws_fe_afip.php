...
if ($cli_cliente) {
    $vta_nota_credito->setCliClienteId($cli_cliente_id);
    ...
    if ($vta_punto_venta) {
        ...
        $vta_nota_credito->setVtaPuntoVentaId($vta_punto_venta->getId());
    }
}

$gral_condicion_iva = VtaNotaCredito::getDeterminacionGralCondicionIva($cli_cliente_id);
if ($gral_condicion_iva) {
    $vta_nota_credito->setGralCondicionIvaId($gral_condicion_iva->getId());
}

$vta_nota_credito->setNumeroTimbrado(ConfVariable::NUMERO_TIMBRADO_EKUATIA)
...
<div class="datos generar-ws-fe-afip" tipo="item">
    ...
    <?php include "bloque_vta_nota_credito_listado_items_x_cli_cliente_modal.php"; ?>
    ...
    <form id='form_generar_ws_fe_afip' name='form_generar_ws_fe_afip' method='POST' action='' >
        ...
        <div class="col col1">
            ...
            <div class="par">
                ...
                <div class="dato"><?php Gral::_echo(VtaNotaCredito::getDeterminacionTipoNotaCredito($cli_cliente_id)->getDescripcion()) ?></div>
            </div>
        ...
        <div class="col col2" id="bloque_vta_nota_credito_listado_items_tabla_totales">
            <?php include "bloque_vta_nota_credito_listado_items_tabla_totales.php"; ?>
        </div>

        <div class="label-error" id="generar_nota_credito_online_afip_error"></div>
        <div class="botonera">
            <button class="boton" cli_cliente_id="<?php echo $cli_cliente_id ?>" id='btn_generar_nota_credito_online' name='btn_generar_nota_credito_online' type='button' class='btn_generar_nota_credito_online'><?php Lang::_lang('Generar Nota de Credito') ?></button>
        </div>

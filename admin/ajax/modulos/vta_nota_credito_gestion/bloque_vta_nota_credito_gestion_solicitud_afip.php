<table border="0" class="tabla-modal">
    <tr>
        ...
        <td class="adm_tbl_encabezado" width="100" align='center'><?php Lang::_lang("Num Compr"); ?></td>
    ...
    <?php
    $ws_fe_ope_solicituds = $vta_nota_credito->getWsFeOpeSolicitudsXVtaNotaCreditoWsFeOpeSolicitud();

...
$o_ids = eval('return $o_padre->getVtaNotaCreditoVtaNotaDebitosId();');


// elementos seleccionados
$c = new Criterio();
$c->add('vta_nota_credito_vta_nota_debito.vta_nota_credito_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_nota_debito');
$c->addRealJoin('vta_nota_credito_vta_nota_debito', 'vta_nota_credito_vta_nota_debito.vta_nota_debito_id', 'vta_nota_debito.id', 'LEFT JOIN');

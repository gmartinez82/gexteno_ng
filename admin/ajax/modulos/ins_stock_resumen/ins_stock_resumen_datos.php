...
<table border='0' align='center' class='listado' id='listado_adm_ins_stock_resumen'>
  ...
  <tr id="tr_ins_stock_resumen_uno_<?php Gral::_echo($ins_stock_resumen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($ins_stock_resumen->getId()) ?>">
  	<?php include "ins_stock_resumen_uno.php" ?>
  </tr>
  
  
  <tr id='tr_eliminar_<?php Gral::_echo($ins_stock_resumen->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($ins_stock_resumen->getId()) ?>" >
	<td colspan='12' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($ins_stock_resumen->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />
	  <div><input name='btn_elim_aceptar' type='button' id='btn_elim_aceptar' value='<?php Lang::_lang('Aceptar') ?>'  class='btn_mensaje_aceptar' />
		<input name='btn_elim_cancelar' type='button' id='btn_elim_cancelar' value='<?php Lang::_lang('Cancelar') ?>'  class='btn_mensaje_cancelar' onclick='eliminar_conf(<?php Gral::_echo($ins_stock_resumen->getId()) ?>,0)'/>
	  </div>
	</div>		</td>
	<td align='center'></td>
  </tr>
...
if(trim($id) == $ins_stock_resumen->getId()){ 
	$mi_display = '';
	$mi_hash = "location.hash = 'mi_".$id."';"; 
}
?>
  <tr id='tr_mi_<?php Gral::_echo($ins_stock_resumen->getId()) ?>' <?php Gral::_echo($mi_display) ?>>
	...
	<div class="masinfo">
		<?php 
		if(trim($id) == $ins_stock_resumen->getId()){ 
			include "ins_stock_resumen_adm_masinfo.php";
		}
		?>
	</div>

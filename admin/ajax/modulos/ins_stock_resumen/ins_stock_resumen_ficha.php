...
<div class='ficha'>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($ins_stock_resumen->getInsStockResumenTipoEstado()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo($ins_stock_resumen->getCantidadReal()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('Cantidad Comprometida') ?></div>
        <div class='dato'><?php Gral::_echo($ins_stock_resumen->getCantidadComprometida()) ?></div>
    </div>

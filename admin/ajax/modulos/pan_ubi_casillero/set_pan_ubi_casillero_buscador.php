...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pan_ubi_casillero.id', Gral::getVars(1, 'buscador_pan_ubi_casillero_id'), Gral::getVars(1, 'buscador_pan_ubi_casillero_id_comparador'));
	$criterio->add('pan_ubi_casillero.descripcion', Gral::getVars(1, 'buscador_pan_ubi_casillero_descripcion'), Gral::getVars(1, 'buscador_pan_ubi_casillero_descripcion_comparador'));
	$criterio->add('pan_ubi_casillero.codigo', Gral::getVars(1, 'buscador_pan_ubi_casillero_codigo'), Gral::getVars(1, 'buscador_pan_ubi_casillero_codigo_comparador'));
	$criterio->add('pan_ubi_casillero.observacion', Gral::getVars(1, 'buscador_pan_ubi_casillero_observacion'), Gral::getVars(1, 'buscador_pan_ubi_casillero_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('ins_insumo_pan_panol', 'ins_insumo_pan_panol.pan_ubi_casillero_id', 'pan_ubi_casillero.id', 'LEFT JOIN');

...
$criterio->add('eku_param_condicion_credito_gral_fp_medio_pago.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->addRealJoin('eku_param_condicion_credito', 'eku_param_condicion_credito.id', 'eku_param_condicion_credito_gral_fp_medio_pago.eku_param_condicion_credito_id', 'LEFT JOIN');

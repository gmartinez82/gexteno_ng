...
if($buscar != '...'){
    ...
    $c->add('eku_param_condicion_credito_gral_fp_medio_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_condicion_credito_gral_fp_medio_pago');
$c->addOrden('eku_param_condicion_credito_gral_fp_medio_pago.orden', 'asc');
$c->setCriterios();

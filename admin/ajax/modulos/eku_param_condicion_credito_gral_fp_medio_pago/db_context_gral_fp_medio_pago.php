...
$gral_fp_medio_pago = $eku_param_condicion_credito_gral_fp_medio_pago->getGralFpMedioPago();
...
<div class="datos" id="<?php Gral::_echo($gral_fp_medio_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamCondicionCreditoGralFpMedioPago::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_condicion_credito_gral_fp_medio_pago->getFiltrosArrXCampo('GralFpMedioPago', 'gral_fp_medio_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamCondicionCreditoGralFpMedioPagos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_fp_medio_pago->getDescripcion()) ?></strong>
        </a>
    </div>

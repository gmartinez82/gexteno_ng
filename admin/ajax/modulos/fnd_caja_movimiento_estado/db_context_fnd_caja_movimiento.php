...
$fnd_caja_movimiento = $fnd_caja_movimiento_estado->getFndCajaMovimiento();
...
<div class="datos" id="<?php Gral::_echo($fnd_caja_movimiento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo FndCajaMovimientoEstado::getFiltrosArrGral() ?>&arr=<?php echo $fnd_caja_movimiento_estado->getFiltrosArrXCampo('FndCajaMovimiento', 'fnd_caja_movimiento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('FndCajaMovimientoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($fnd_caja_movimiento->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('gral_tipo_documento.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_tipo_documento.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_documento.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_tipo_documento.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralTipoDocumento::getGralTipoDocumentos($p, $c);

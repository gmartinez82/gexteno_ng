...
$pde_orden_pago_enviado_id = Gral::getVars(2, 'pde_orden_pago_enviado_id');
...
<div class="datos" id="<?php Gral::_echo($pde_orden_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOrdenPagoEnviado::getFiltrosArrGral() ?>&arr=<?php echo $pde_orden_pago_enviado->getFiltrosArrXCampo('PdeOrdenPago', 'pde_orden_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOrdenPagoEnviados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_orden_pago->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_comision = $vta_comision_gral_fp_forma_pago_cheque->getVtaComision();
...
<div class="datos" id="<?php Gral::_echo($vta_comision->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaComisionGralFpFormaPagoCheque::getFiltrosArrGral() ?>&arr=<?php echo $vta_comision_gral_fp_forma_pago_cheque->getFiltrosArrXCampo('VtaComision', 'vta_comision_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaComisionGralFpFormaPagoCheques') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_comision->getDescripcion()) ?></strong>
        </a>
    </div>

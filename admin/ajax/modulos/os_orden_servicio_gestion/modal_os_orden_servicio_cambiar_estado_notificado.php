...
if(Gral::esPost())
{
    ...
    if($estado)
    {
        $tipo_estado_codigo = OsTipoEstado::TIPO_NOTIFICADO;
...
<form id="form_div_modal" name="form_div_modal" method="post" action='<?php echo Gral::getPath("path_http")."admin/ajax/modulos/os_orden_servicio_gestion/modal_os_orden_servicio_cambiar_estado_notificado.php" ?>' >
    
    <div class="datos orden_servicio notificado" >

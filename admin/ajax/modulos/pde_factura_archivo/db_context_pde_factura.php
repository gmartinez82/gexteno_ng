...
$pde_factura_archivo_id = Gral::getVars(2, 'pde_factura_archivo_id');
$pde_factura_archivo = PdeFacturaArchivo::getOxId($pde_factura_archivo_id);
$pde_factura = $pde_factura_archivo->getPdeFactura();
...
<div class="datos" id="<?php Gral::_echo($pde_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaArchivo::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_archivo->getFiltrosArrXCampo('PdeFactura', 'pde_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaArchivos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_factura->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_vta_nota_credito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_vta_nota_credito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_nota_credito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_nota_credito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_vta_nota_credito');
$c->addOrden('eku_de_vta_nota_credito.orden', 'asc');
$c->setCriterios();

...
$identificador = $sld_tipo_imagen->getId();

?>
<div id="container_<?php echo $identificador ?>" class="masivo-bloque">
    <div id="filelist_<?php echo $identificador ?>"></div>
    <div class="comentario">
    <strong>Subida Masiva:</strong> Elija los archivos que desea subir presionando "Seleccionar Imagenes", y a continuacion presione "Subir Imagenes" para levantar los archivos al servidor</div>
    <br />
    ...
    <a id="refresh_<?php echo $identificador ?>" class="masivo-botones" href="?id=<?php echo $sld_slider->getId() ?>">Actualizar Pagina</a>
</div>
...
var uploader_<?php echo $identificador ?> = new plupload.Uploader({
    ...
    max_file_size : '10mb',
        ...
        url : 'ajax/imagenes/upload_masivo_agrupado.php?padre=<?php echo $sld_slider->getId() ?>&clase=SldSlider&agrupacion_clase=SldTipoImagen&agrupacion_tabla=sld_tipo_imagen&agrupacion_id=<?php echo $identificador ?>',

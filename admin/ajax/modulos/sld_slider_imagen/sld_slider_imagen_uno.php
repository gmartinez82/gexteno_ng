...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/sld_slider_imagen/sld_slider_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/sld_slider_imagen/sld_slider_imagen_uno_masinfo.php"; 
}
?>

...
if($buscar != '...'){
    ...
    $c->add('prd_param_tipo_operacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_param_tipo_operacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_param_tipo_operacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_param_tipo_operacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_param_tipo_operacion');
$c->addOrden('prd_param_tipo_operacion.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = PrdParamTipoOperacion::getPrdParamTipoOperacions($p, $c);

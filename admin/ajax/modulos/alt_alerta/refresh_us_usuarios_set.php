...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('alt_alerta_us_usuario.alt_alerta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('alt_alerta_us_usuario', 'alt_alerta_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

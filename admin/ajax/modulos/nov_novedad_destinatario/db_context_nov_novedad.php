...
$nov_novedad = $nov_novedad_destinatario->getNovNovedad();
...
<div class="datos" id="<?php Gral::_echo($nov_novedad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo NovNovedadDestinatario::getFiltrosArrGral() ?>&arr=<?php echo $nov_novedad_destinatario->getFiltrosArrXCampo('NovNovedad', 'nov_novedad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('NovNovedadDestinatarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($nov_novedad->getDescripcion()) ?></strong>
        </a>
    </div>

...
EkuDe::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('eku_de.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de');
$c->addOrden('eku_de.orden', 'asc');
$c->setCriterios();

...
$per_persona = $per_mov_planificacion->getPerPersona();
...
<div class="datos" id="<?php Gral::_echo($per_persona->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PerMovPlanificacion::getFiltrosArrGral() ?>&arr=<?php echo $per_mov_planificacion->getFiltrosArrXCampo('PerPersona', 'per_persona_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PerMovPlanificacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($per_persona->getDescripcion()) ?></strong>
        </a>
    </div>

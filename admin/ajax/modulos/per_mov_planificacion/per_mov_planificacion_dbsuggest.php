...
if($buscar != '...'){
    ...
    $c->add('per_mov_planificacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('per_mov_planificacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_mov_planificacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('per_mov_planificacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('per_mov_planificacion');
$c->addOrden('per_mov_planificacion.orden', 'asc');
$c->setCriterios();

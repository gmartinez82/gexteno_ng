...
if($buscar != '...'){
    ...
    $c->add('ope_operario_us_usuario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ope_operario_us_usuario.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ope_operario_us_usuario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ope_operario_us_usuario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('ope_operario_us_usuario');
$c->addOrden('ope_operario_us_usuario.orden', 'asc');
$c->setCriterios();

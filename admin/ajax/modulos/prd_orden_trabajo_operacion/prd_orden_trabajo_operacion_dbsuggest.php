...
if($buscar != '...'){
    ...
    $c->add('prd_orden_trabajo_operacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_orden_trabajo_operacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_operacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_operacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_orden_trabajo_operacion');
$c->addOrden('prd_orden_trabajo_operacion.orden', 'asc');
$c->setCriterios();

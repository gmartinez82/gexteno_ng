...
if($buscar != '...'){
    ...
    $c->add('eku_param_unidad_medida_ins_unidad_medida.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_unidad_medida_ins_unidad_medida');
$c->addOrden('eku_param_unidad_medida_ins_unidad_medida.orden', 'asc');
$c->setCriterios();

...
$ins_unidad_medida = $eku_param_unidad_medida_ins_unidad_medida->getInsUnidadMedida();
...
<div class="datos" id="<?php Gral::_echo($ins_unidad_medida->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamUnidadMedidaInsUnidadMedida::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_unidad_medida_ins_unidad_medida->getFiltrosArrXCampo('InsUnidadMedida', 'ins_unidad_medida_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamUnidadMedidaInsUnidadMedidas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_unidad_medida->getDescripcion()) ?></strong>
        </a>
    </div>

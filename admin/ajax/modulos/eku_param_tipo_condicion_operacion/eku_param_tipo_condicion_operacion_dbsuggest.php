...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_condicion_operacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_condicion_operacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_condicion_operacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_condicion_operacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamTipoCondicionOperacion::getEkuParamTipoCondicionOperacions($p, $c);

...
$c->add('eku_param_tipo_condicion_operacion_gral_fp_forma_pago.eku_param_tipo_condicion_operacion_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_fp_forma_pago');
$c->addRealJoin('eku_param_tipo_condicion_operacion_gral_fp_forma_pago', 'eku_param_tipo_condicion_operacion_gral_fp_forma_pago.gral_fp_forma_pago_id', 'gral_fp_forma_pago.id', 'LEFT JOIN');

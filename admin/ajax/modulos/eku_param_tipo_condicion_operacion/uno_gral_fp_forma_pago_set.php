...
if(in_array($gral_fp_forma_pago_relacionado->getId(), $o_ids)){
    ...
    $array = array(
        array('campo' => 'eku_param_tipo_condicion_operacion_id', 'valor' => $o_padre->getId()),
...
<div class='list <?php echo $css_sel ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('EKU_PARAM_TIPO_CONDICION_OPERACION_ALTA_RELACION_GRAL_FP_FORMA_PAGO_ACCIONES_SELECCION')){ ?>	

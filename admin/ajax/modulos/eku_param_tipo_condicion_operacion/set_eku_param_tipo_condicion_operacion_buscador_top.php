...
$criterio->add('eku_param_tipo_condicion_operacion.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('eku_param_tipo_condicion_operacion.codigo_eku', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_tipo_condicion_operacion.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('eku_param_tipo_condicion_operacion.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

...
$cntb_periodo = $cntb_diario_asiento_vta_nota_debito->getCntbPeriodo();
...
<div class="datos" id="<?php Gral::_echo($cntb_periodo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo CntbDiarioAsientoVtaNotaDebito::getFiltrosArrGral() ?>&arr=<?php echo $cntb_diario_asiento_vta_nota_debito->getFiltrosArrXCampo('CntbPeriodo', 'cntb_periodo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('CntbDiarioAsientoVtaNotaDebitos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_periodo->getDescripcion()) ?></strong>
        </a>
    </div>

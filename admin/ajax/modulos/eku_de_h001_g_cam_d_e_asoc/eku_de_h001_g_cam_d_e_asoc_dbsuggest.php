...
if($buscar != '...'){
    ...
    $c->add('eku_de_h001_g_cam_d_e_asoc.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_h001_g_cam_d_e_asoc.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_h001_g_cam_d_e_asoc.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_h001_g_cam_d_e_asoc.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_h001_g_cam_d_e_asoc');
$c->addOrden('eku_de_h001_g_cam_d_e_asoc.orden', 'asc');
$c->setCriterios();

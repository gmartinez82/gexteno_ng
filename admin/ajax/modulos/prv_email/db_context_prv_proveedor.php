...
$prv_email_id = Gral::getVars(2, 'prv_email_id');
$prv_email = PrvEmail::getOxId($prv_email_id);
$prv_proveedor = $prv_email->getPrvProveedor();
...
<div class="datos" id="<?php Gral::_echo($prv_proveedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvEmail::getFiltrosArrGral() ?>&arr=<?php echo $prv_email->getFiltrosArrXCampo('PrvProveedor', 'prv_proveedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvEmails') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_proveedor->getDescripcion()) ?></strong>
        </a>
    </div>

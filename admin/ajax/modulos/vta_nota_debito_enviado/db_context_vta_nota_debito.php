...
$vta_nota_debito_enviado_id = Gral::getVars(2, 'vta_nota_debito_enviado_id');
...
<div class="datos" id="<?php Gral::_echo($vta_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaDebitoEnviado::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_debito_enviado->getFiltrosArrXCampo('VtaNotaDebito', 'vta_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaDebitoEnviados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

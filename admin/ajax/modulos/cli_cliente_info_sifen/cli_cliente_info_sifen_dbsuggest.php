...
CliClienteInfoSifen::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('cli_cliente_info_sifen.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('cli_cliente_info_sifen.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_cliente_info_sifen.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_cliente_info_sifen.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('cli_cliente_info_sifen');
$c->addOrden('cli_cliente_info_sifen.orden', 'asc');
$c->setCriterios();

...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_naturaleza_transportista.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_naturaleza_transportista.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_transportista.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_transportista.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_naturaleza_transportista');
$c->addOrden('eku_param_tipo_naturaleza_transportista.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoNaturalezaTransportista::getEkuParamTipoNaturalezaTransportistas($p, $c);

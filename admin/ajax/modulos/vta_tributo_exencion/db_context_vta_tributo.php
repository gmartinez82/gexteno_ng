...
$vta_tributo = $vta_tributo_exencion->getVtaTributo();
...
<div class="datos" id="<?php Gral::_echo($vta_tributo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaTributoExencion::getFiltrosArrGral() ?>&arr=<?php echo $vta_tributo_exencion->getFiltrosArrXCampo('VtaTributo', 'vta_tributo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaTributoExencions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_tributo->getDescripcion()) ?></strong>
        </a>
    </div>

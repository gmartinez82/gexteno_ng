...
?>
<div class="datos etiqueta-recepcion" pde_recepcion_id="<?php Gral::_echo($pde_recepcion->getId()) ?>">
    
    <div class="par">
        <div class="label"><?php Lang::_lang('Recepcion') ?></div>
    ...
    <div class="par">
        ...
        <div class="dato epl"><?php Gral::_echo($pde_recepcion->getEtiquetaRecepcionEPL($pde_recepcion->getCantidad())) ?></div>
    </div>
    
    <div class="par">
        <div class="label"><?php Lang::_lang('Cant Etiquetas') ?></div>
        <div class="dato"><input type="text" class="textbox spinner" id="txt_cantidad" name="txt_cantidad" value="<?php echo $pde_recepcion->getCantidad() ?>" size="5" /></div>
    </div>

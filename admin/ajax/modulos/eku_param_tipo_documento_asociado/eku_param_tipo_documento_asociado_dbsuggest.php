...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_documento_asociado.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_documento_asociado.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_documento_asociado.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_documento_asociado.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_documento_asociado');
$c->addOrden('eku_param_tipo_documento_asociado.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoDocumentoAsociado::getEkuParamTipoDocumentoAsociados($p, $c);

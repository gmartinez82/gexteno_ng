...
$criterio->add('ml_attribute_type.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('ml_attribute_type.codigo_ml', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

...
$fnd_cajero = $fnd_cajero_gral_caja->getFndCajero();
...
<div class="datos" id="<?php Gral::_echo($fnd_cajero->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo FndCajeroGralCaja::getFiltrosArrGral() ?>&arr=<?php echo $fnd_cajero_gral_caja->getFiltrosArrXCampo('FndCajero', 'fnd_cajero_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('FndCajeroGralCajas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($fnd_cajero->getDescripcion()) ?></strong>
        </a>
    </div>

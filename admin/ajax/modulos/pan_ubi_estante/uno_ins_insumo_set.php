...
<div class='list <?php echo $css_sel ?>' title='<?php echo $ins_insumo_relacionado->getObservacion() ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('PAN_UBI_ESTANTE_ALTA_RELACION_INS_INSUMO_ACCIONES_SELECCION')){ ?>	

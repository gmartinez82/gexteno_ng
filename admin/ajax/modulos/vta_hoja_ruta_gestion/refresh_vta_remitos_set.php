...
$o_ids = eval('return $o_padre->getVtaHojaRutaVtaRemitosId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_hoja_ruta_vta_remito.vta_hoja_ruta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_remito');
$c->addRealJoin('vta_hoja_ruta_vta_remito', 'vta_hoja_ruta_vta_remito.vta_remito_id', 'vta_remito.id', 'LEFT JOIN');

...
if ($txt_filtro_desde != "") {
    $criterio->add('vta_hoja_ruta.fecha', Gral::getFechaToDB($txt_filtro_desde), Criterio::MAYORIGUAL);
}

if ($txt_filtro_hasta != "") {
    $criterio->add('vta_hoja_ruta.fecha', Gral::getFechaToDB($txt_filtro_hasta), Criterio::MENORIGUAL);
}

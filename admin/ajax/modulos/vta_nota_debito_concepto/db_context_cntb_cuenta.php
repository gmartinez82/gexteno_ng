...
$vta_nota_debito_concepto_id = Gral::getVars(2, 'vta_nota_debito_concepto_id');
$vta_nota_debito_concepto = VtaNotaDebitoConcepto::getOxId($vta_nota_debito_concepto_id);
$cntb_cuenta = $vta_nota_debito_concepto->getCntbCuenta();
...
<div class="datos" id="<?php Gral::_echo($cntb_cuenta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaDebitoConcepto::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_debito_concepto->getFiltrosArrXCampo('CntbCuenta', 'cntb_cuenta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaDebitoConceptos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_cuenta->getDescripcion()) ?></strong>
        </a>
    </div>

...
<div class="bloque-comprobantes-vinculados bloque-vta-factura-comprobantes-vinculados">
    ...
    <table border="0" class="tabla-modal">
        ...
        <?php
        foreach ($vta_factura_vta_nota_creditos_desvinculados as $vta_factura_vta_nota_credito) {
            ...
            <tr>
                ...
                <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                    <div class="usuario">
                        <?php Gral::_echo($vta_factura_vta_nota_credito->getModificadoPorDescripcion()) ?>
                    </div>
                    <div class="fecha">
                        <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_factura_vta_nota_credito->getModificado())) ?>
                    </div>
                </td>
        ...
        foreach ($vta_factura_vta_recibos_desvinculados as $vta_factura_vta_recibo) {
            $estado = (false) ? 'habilitado' : 'deshabilitado';
            
            $vta_recibo = $vta_factura_vta_recibo->getVtaRecibo();
...
//        $gral_tipo_personeria = $vta_recibo->getGralTipoPersoneria();
            $gral_empresa_facturadora = $vta_recibo->getGralEmpresa();
            $gral_empresa_facturadora_descripcion = $gral_empresa_facturadora->getDescripcion();
            ...
            <tr>
                ...
                <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                    <div class="usuario">
                        <?php Gral::_echo($vta_factura_vta_recibo->getModificadoPorDescripcion()) ?>
                    </div>
                    <div class="fecha">
                        <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_factura_vta_recibo->getModificado())) ?>
                    </div>
                </td>

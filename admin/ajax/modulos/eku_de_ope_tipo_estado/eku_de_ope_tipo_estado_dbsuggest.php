...
EkuDeOpeTipoEstado::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('eku_de_ope_tipo_estado.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_ope_tipo_estado.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_ope_tipo_estado.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_ope_tipo_estado.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_ope_tipo_estado');
$c->addOrden('eku_de_ope_tipo_estado.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeOpeTipoEstado::getEkuDeOpeTipoEstados($p, $c);

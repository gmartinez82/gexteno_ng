...
if($buscar != '...'){
    ...
    $c->add('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc');
$c->addOrden('eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE750GDtipDEGCamItemGRasMerc::getEkuDeE750GDtipDEGCamItemGRasMercs($p, $c);

...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_DE_E750_G_DTIP_D_E_G_CAM_ITEM_G_RAS_MERC_ADM_ACCION_ELIMINAR')){
    ...
    if($eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc){
        if($eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc->getHash() == $hash){
            $eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc->deleteAll();
        }
    }
}    
?>

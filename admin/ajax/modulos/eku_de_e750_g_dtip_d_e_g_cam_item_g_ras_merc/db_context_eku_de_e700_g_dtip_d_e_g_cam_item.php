...
$eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc_id = Gral::getVars(2, 'eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc_id');
...
$eku_de_e700_g_dtip_d_e_g_cam_item = $eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc->getEkuDeE700GDtipDEGCamItem();
...
<div class="datos" id="<?php Gral::_echo($eku_de_e700_g_dtip_d_e_g_cam_item->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE750GDtipDEGCamItemGRasMerc::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e750_g_dtip_d_e_g_cam_item_g_ras_merc->getFiltrosArrXCampo('EkuDeE700GDtipDEGCamItem', 'eku_de_e700_g_dtip_d_e_g_cam_item_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE750GDtipDEGCamItemGRasMercs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de_e700_g_dtip_d_e_g_cam_item->getDescripcion()) ?></strong>
        </a>
    </div>

...
$cmb_vta_ajuste_haber_concepto_id = Gral::getVars(Gral::VARS_POST, "cmb_vta_ajuste_haber_concepto_id", 0);
$key = Gral::getVars(Gral::VARS_POST, "key", 0);

$arr["error"] = false;

if ($cmb_vta_ajuste_haber_concepto_id == 0) {
    $arr["cmb_vta_ajuste_haber_concepto_id_" . $key] = Lang::_lang("Debe seleccionar un concepto valido", true);
    $arr["error"] = true;
}

...
$arr_vta_ajuste_haber_retencion_infos = Gral::getSes($var_sesion_modulo);
...
if (!is_null($arr_vta_ajuste_haber_retencion_infos[$key])) {
    ...
    //Gral::prr($arr_vta_ajuste_haber_retencion_infos[$key]);
}

//Gral::prr($arr_vta_ajuste_haber_retencion_infos);
//Gral::prr($arr_vta_ajuste_haber_retencion_infos[$key]);
?>

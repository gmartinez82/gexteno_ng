...
foreach ($_SESSION as $key => $value) {
    ...
    //if (strpos($key, 'vta_ajuste_haber_cheque_info') === 0)
    //    unset($_SESSION[$key]);

    // se limpia la variable de info de cheque
    //if (strpos($key, 'vta_ajuste_haber_retencion_info') === 0)
    //    unset($_SESSION[$key]);
}
?>

<div class='datos generar-ajuste_haber' var_sesion_random='<?php echo $var_sesion_random; ?>'>
    ...
    <div class="div_datos_generar_ajuste_habers">
        <?php //include "bloque_modal_vta_ajuste_haber_listado_datos.php" ?>
    </div>
</div>

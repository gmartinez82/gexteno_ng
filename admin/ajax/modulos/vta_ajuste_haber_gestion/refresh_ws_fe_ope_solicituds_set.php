...
$o_ids = eval('return $o_padre->getVtaAjusteHaberWsFeOpeSolicitudsId();');


// elementos seleccionados
$c = new Criterio();
$c->add('vta_ajuste_haber_ws_fe_ope_solicitud.vta_ajuste_haber_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ws_fe_ope_solicitud');
$c->addRealJoin('vta_ajuste_haber_ws_fe_ope_solicitud', 'vta_ajuste_haber_ws_fe_ope_solicitud.ws_fe_ope_solicitud_id', 'ws_fe_ope_solicitud.id', 'LEFT JOIN');

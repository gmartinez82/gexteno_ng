<table border="0" class="tabla-modal-ficha-emails">
    ...
    <?php
    $vta_ajuste_haber_enviados = $vta_ajuste_haber->getVtaAjusteHaberEnviados();
    $cont = 0;
    foreach ($vta_ajuste_haber_enviados as $vta_ajuste_haber_enviado) {
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_ajuste_haber_enviado->getCreado())); ?>
                </div>
            </td>	

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="asunto">
                    <?php Gral::_echo($vta_ajuste_haber_enviado->getAsunto()); ?>
                </div>
                <div class="destinatario">
                    <?php Gral::_echo($vta_ajuste_haber_enviado->getDestinatario()); ?>
                </div>
                <div class="observacion">
                    <?php Gral::_echo($vta_ajuste_haber_enviado->getObservacion()); ?>
                </div>                 
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="estado">
                    <img src="imgs/btn_estado_<?php echo $vta_ajuste_haber_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="codigo_envio">
                    <?php Gral::_echo($vta_ajuste_haber_enviado->getCodigoEnvio()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por-descripcion">
                    <?php Gral::_echo($vta_ajuste_haber_enviado->getCreadoPorDescripcion()); ?>
                </div>
            </td>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                <ul class="adm_botones_acciones_modal_ficha">
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_AJUSTE_HABER_GESTION_ACCION_COMPROBANTE')) { ?>
                        <li class='adm_botones_accion vta-ajuste-debe-comprobante' vta_ajuste_haber_enviado_id='<?php echo $vta_ajuste_haber_enviado->getId() ?>'>
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_AJUSTE_HABER_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                        <li class='adm_botones_accion vta-ajuste-debe-ver-cuerpo-correo' vta_ajuste_haber_enviado_id='<?php echo $vta_ajuste_haber_enviado->getId() ?>'>

...
$vta_orden_venta_tipo_estado = $vta_orden_venta_estado->getVtaOrdenVentaTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($vta_orden_venta_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaOrdenVentaEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta_estado->getFiltrosArrXCampo('VtaOrdenVentaTipoEstado', 'vta_orden_venta_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaOrdenVentaEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_orden_venta_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

...
$ins_tipo_lista_precio = $vta_politica_descuento_rango->getInsTipoListaPrecio();
...
<div class="datos" id="<?php Gral::_echo($ins_tipo_lista_precio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPoliticaDescuentoRango::getFiltrosArrGral() ?>&arr=<?php echo $vta_politica_descuento_rango->getFiltrosArrXCampo('InsTipoListaPrecio', 'ins_tipo_lista_precio_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPoliticaDescuentoRangos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_tipo_lista_precio->getDescripcion()) ?></strong>
        </a>
    </div>

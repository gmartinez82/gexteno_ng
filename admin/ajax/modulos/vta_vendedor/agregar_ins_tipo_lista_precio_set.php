...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('VTA_VENDEDOR_ALTA_RELACION_INS_TIPO_LISTA_PRECIO_ACCIONES_SELECCION')){
    ...
    if($checked == 'checked' or $checked == 'true'){
        ...
        $o = VtaVendedorInsTipoListaPrecio::getOxId($relacion_id);
        $o->delete();
    }
}
?>

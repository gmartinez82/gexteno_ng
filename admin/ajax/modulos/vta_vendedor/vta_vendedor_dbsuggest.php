...
if($buscar != '...'){
    ...
    $c->add('id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_vendedor.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_vendedor.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

...
$c->add('gral_centro_costo_vta_vendedor.vta_vendedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_centro_costo');
$c->addRealJoin('gral_centro_costo_vta_vendedor', 'gral_centro_costo_vta_vendedor.gral_centro_costo_id', 'gral_centro_costo.id', 'LEFT JOIN');

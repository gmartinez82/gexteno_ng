...
$o_ids = eval('return $o_padre->getVtaVendedorInsTipoListaPreciosId();');
...
$c->add('vta_vendedor_ins_tipo_lista_precio.vta_vendedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_tipo_lista_precio');
$c->addRealJoin('vta_vendedor_ins_tipo_lista_precio', 'vta_vendedor_ins_tipo_lista_precio.ins_tipo_lista_precio_id', 'ins_tipo_lista_precio.id', 'LEFT JOIN');

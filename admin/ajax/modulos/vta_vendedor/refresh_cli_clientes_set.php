...
$c->add('cli_cliente_vta_vendedor.vta_vendedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_vta_vendedor', 'cli_cliente_vta_vendedor.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

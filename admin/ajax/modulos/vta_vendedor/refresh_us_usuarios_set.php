...
$c->add('vta_vendedor_us_usuario.vta_vendedor_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('vta_vendedor_us_usuario', 'vta_vendedor_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

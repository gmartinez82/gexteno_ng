...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('ins_insumo_veh_modelo.veh_modelo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_insumo');
$c->addRealJoin('ins_insumo_veh_modelo', 'ins_insumo_veh_modelo.ins_insumo_id', 'ins_insumo.id', 'LEFT JOIN');

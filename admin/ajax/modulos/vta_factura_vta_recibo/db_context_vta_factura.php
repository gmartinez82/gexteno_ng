...
$vta_factura_vta_recibo_id = Gral::getVars(2, 'vta_factura_vta_recibo_id');
$vta_factura_vta_recibo = VtaFacturaVtaRecibo::getOxId($vta_factura_vta_recibo_id);
$vta_factura = $vta_factura_vta_recibo->getVtaFactura();
...
<div class="datos" id="<?php Gral::_echo($vta_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaFacturaVtaRecibo::getFiltrosArrGral() ?>&arr=<?php echo $vta_factura_vta_recibo->getFiltrosArrXCampo('VtaFactura', 'vta_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaFacturaVtaRecibos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_factura->getDescripcion()) ?></strong>
        </a>
    </div>

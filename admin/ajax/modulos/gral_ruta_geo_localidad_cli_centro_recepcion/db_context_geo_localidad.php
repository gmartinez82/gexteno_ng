...
$geo_localidad = $gral_ruta_geo_localidad_cli_centro_recepcion->getGeoLocalidad();
...
<div class="datos" id="<?php Gral::_echo($geo_localidad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralRutaGeoLocalidadCliCentroRecepcion::getFiltrosArrGral() ?>&arr=<?php echo $gral_ruta_geo_localidad_cli_centro_recepcion->getFiltrosArrXCampo('GeoLocalidad', 'geo_localidad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralRutaGeoLocalidadCliCentroRecepcions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($geo_localidad->getDescripcion()) ?></strong>
        </a>
    </div>

...
if (Gral::esPost()) {
    ...
    $ins_insumo_pan_panol->setInsStockTipoConfiguracionId(Gral::getVars(1, "ins_insumo_pan_panol_cmb_ins_stock_tipo_configuracion_id", null));
    ...
    $resumen_id = Gral::getVars(2, 'id', 0);
...
?>
<body>
    <form id='formu' name='formu' method='post' action='ajax/modulos/ins_stock_resumen_gestion/modal_puntos_panol_central.php' >
        ...
        <table border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_modal_ins_insumo_pan_panol'>
            ...
            <tr>
                <td width='150' class='adm_carga_datos_titulos'>
                    ...
                    <?php Lang::_lang('Tipo Configuracion') ?>

                </td>
                <td width='450' class='adm_carga_datos_datos' id="dato_ins_insumo_pan_panol_cmb_ins_stock_tipo_configuracion_id">

                    <?php $error_input_css = ($error->getErrorXIndice('ins_stock_tipo_configuracion_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>

                    <?php Html::html_dib_select(1, 'ins_insumo_pan_panol_cmb_ins_stock_tipo_configuracion_id', Gral::getCmbFiltro(InsStockTipoConfiguracion::getInsStockTipoConfiguracionsCmb(), '...'), $ins_insumo_pan_panol->getInsStockTipoConfiguracionId(), 'textbox ' . $error_input_css) ?>

                    <div class="error-mensaje-input-texto"><?php Gral::_echo($error->getErrorXIndice('ins_stock_tipo_configuracion_id')->getMensaje()) ?></div>

...
$vta_recibo_concepto_id = Gral::getVars(2, 'vta_recibo_concepto_id');
$vta_recibo_concepto = VtaReciboConcepto::getOxId($vta_recibo_concepto_id);
$cntb_cuenta = $vta_recibo_concepto->getCntbCuenta();
...
<div class="datos" id="<?php Gral::_echo($cntb_cuenta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaReciboConcepto::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_concepto->getFiltrosArrXCampo('CntbCuenta', 'cntb_cuenta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaReciboConceptos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_cuenta->getDescripcion()) ?></strong>
        </a>
    </div>

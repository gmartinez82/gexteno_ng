...
<div id="container_<?php echo $identificador ?>" class="masivo-bloque">
    ...
    <a id="refresh_<?php echo $identificador ?>" class="masivo-botones" href="?id=<?php echo $not_noticia->getId() ?>">Actualizar Pagina</a>
</div>
...
var uploader_<?php echo $identificador ?> = new plupload.Uploader({
    ...
    max_file_size : '10mb',
        ...
        url : 'ajax/imagenes/upload_masivo.php?padre=<?php echo $not_noticia->getId() ?>&clase=NotNoticia',

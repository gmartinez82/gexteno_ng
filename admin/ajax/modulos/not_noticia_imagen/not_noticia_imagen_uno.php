...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/not_noticia_imagen/not_noticia_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/not_noticia_imagen/not_noticia_imagen_uno_masinfo.php"; 
}
?>

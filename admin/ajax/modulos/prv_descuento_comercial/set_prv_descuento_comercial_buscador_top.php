...
$criterio->add('prv_descuento_comercial.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('prv_descuento_comercial.porcentaje_descuento', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
...
$criterio->addRealJoin('prv_proveedor', 'prv_proveedor.id', 'prv_descuento_comercial.prv_proveedor_id', 'LEFT JOIN');

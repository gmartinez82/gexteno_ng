...
$prv_descuento_comercial_id = Gral::getVars(2, 'prv_descuento_comercial_id');
$prv_descuento_comercial = PrvDescuentoComercial::getOxId($prv_descuento_comercial_id);
$prv_proveedor = $prv_descuento_comercial->getPrvProveedor();
...
<div class="datos" id="<?php Gral::_echo($prv_proveedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvDescuentoComercial::getFiltrosArrGral() ?>&arr=<?php echo $prv_descuento_comercial->getFiltrosArrXCampo('PrvProveedor', 'prv_proveedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvDescuentoComercials') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_proveedor->getDescripcion()) ?></strong>
        </a>
    </div>

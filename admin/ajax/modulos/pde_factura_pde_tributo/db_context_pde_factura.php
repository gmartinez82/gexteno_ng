...
$pde_factura_pde_tributo_id = Gral::getVars(2, 'pde_factura_pde_tributo_id');
$pde_factura_pde_tributo = PdeFacturaPdeTributo::getOxId($pde_factura_pde_tributo_id);
$pde_factura = $pde_factura_pde_tributo->getPdeFactura();
...
<div class="datos" id="<?php Gral::_echo($pde_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaPdeTributo::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_pde_tributo->getFiltrosArrXCampo('PdeFactura', 'pde_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaPdeTributos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_factura->getDescripcion()) ?></strong>
        </a>
    </div>

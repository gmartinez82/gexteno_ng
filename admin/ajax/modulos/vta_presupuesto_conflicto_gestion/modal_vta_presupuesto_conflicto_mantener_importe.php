...
<div class="datos mantener-importe" vta_presupuesto_conflicto_id="<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>">
    <form id='form_mantener_importe' name='form_mantener_importe' method='post' action='' >
        ...
        <div class="par">
            ...
            <div class="dato" style="background-color: #84c642; font-size: 14px;"><?php Gral::_echoImp($vta_presupuesto_conflicto->getImporteInicial()) ?></div>
        </div>
        
        <div class="par">
            <div class="label"><?php Lang::_lang('Imp Actualizado') ?></div>
            <div class="dato"><?php Gral::_echoImp($vta_presupuesto_conflicto->getImporteActualizado()) ?></div>
        </div>

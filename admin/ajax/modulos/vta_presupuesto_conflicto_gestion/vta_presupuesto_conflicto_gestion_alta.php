...
if (Gral::esPost()) {
    ...
    $vta_presupuesto_conflicto = new VtaPresupuestoConflicto();
    if (trim($hdn_id) != '')
        $vta_presupuesto_conflicto->setId($hdn_id, false);
...
<?php //include 'parciales/error.php'; ?>
        ...
        <table border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_modal_vta_presupuesto_conflicto'>
...
<?php Html::html_dib_select(1, 'vta_presupuesto_conflicto_cmb_vta_presupuesto_ins_insumo_id', Gral::getCmbFiltro(VtaPresupuestoInsInsumo::getVtaPresupuestoInsInsumosCmb(), Lang::_lang('Seleccione VtaPresupuestoInsInsumo', true)), $vta_presupuesto_conflicto->getVtaPresupuestoInsInsumoId(), 'textbox ' . $error_input_css) ?>

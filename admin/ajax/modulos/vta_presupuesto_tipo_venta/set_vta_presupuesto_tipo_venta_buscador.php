...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('vta_presupuesto_tipo_venta.id', Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_id'), Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_id_comparador'));
	$criterio->add('vta_presupuesto_tipo_venta.descripcion', Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_descripcion'), Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_descripcion_comparador'));
	$criterio->add('vta_presupuesto_tipo_venta.codigo', Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_codigo'), Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_codigo_comparador'));
	$criterio->add('vta_presupuesto_tipo_venta.observacion', Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_observacion'), Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_observacion_comparador'));
	$criterio->add('vta_presupuesto_tipo_venta.estado', Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_estado'), Gral::getVars(1, 'buscador_vta_presupuesto_tipo_venta_estado_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('vta_presupuesto', 'vta_presupuesto.vta_presupuesto_tipo_venta_id', 'vta_presupuesto_tipo_venta.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('vta_punto_venta_vta_presupuesto_tipo_venta', 'vta_punto_venta_vta_presupuesto_tipo_venta.vta_presupuesto_tipo_venta_id', 'vta_presupuesto_tipo_venta.id', 'LEFT JOIN');

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_punto_venta_vta_presupuesto_tipo_venta.vta_presupuesto_tipo_venta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_punto_venta');
$c->addRealJoin('vta_punto_venta_vta_presupuesto_tipo_venta', 'vta_punto_venta_vta_presupuesto_tipo_venta.vta_punto_venta_id', 'vta_punto_venta.id', 'LEFT JOIN');

...
$pde_nota_debito_concepto_id = Gral::getVars(2, 'pde_nota_debito_concepto_id');
$pde_nota_debito_concepto = PdeNotaDebitoConcepto::getOxId($pde_nota_debito_concepto_id);
$cntb_cuenta = $pde_nota_debito_concepto->getCntbCuenta();
...
<div class="datos" id="<?php Gral::_echo($cntb_cuenta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaDebitoConcepto::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito_concepto->getFiltrosArrXCampo('CntbCuenta', 'cntb_cuenta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaDebitoConceptos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cntb_cuenta->getDescripcion()) ?></strong>
        </a>
    </div>

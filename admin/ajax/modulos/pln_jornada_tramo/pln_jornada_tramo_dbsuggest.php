...
if($buscar != '...'){
    ...
    $c->add('pln_jornada_tramo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('pln_jornada_tramo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_jornada_tramo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('pln_jornada_tramo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('pln_jornada_tramo');
$c->addOrden('pln_jornada_tramo.orden', 'asc');
$c->setCriterios();

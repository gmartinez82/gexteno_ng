...
$vta_orden_venta_vta_recibo_id = Gral::getVars(2, 'vta_orden_venta_vta_recibo_id');
$vta_orden_venta_vta_recibo = VtaOrdenVentaVtaRecibo::getOxId($vta_orden_venta_vta_recibo_id);
$vta_orden_venta = $vta_orden_venta_vta_recibo->getVtaOrdenVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_orden_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaOrdenVentaVtaRecibo::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta_vta_recibo->getFiltrosArrXCampo('VtaOrdenVenta', 'vta_orden_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaOrdenVentaVtaRecibos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_orden_venta->getDescripcion()) ?></strong>
        </a>
    </div>

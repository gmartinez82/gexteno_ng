...
$cmb_filtro_ins_tipo_lista_precio_id = Gral::getVars(1, 'cmb_filtro_ins_tipo_lista_precio_id', '');
$cmb_filtro_ordenar_por = Gral::getVars(1, 'cmb_filtro_ordenar_por', '');

$cmb_filtro_venta_web = Gral::getVars(1, 'cmb_filtro_venta_web', -1);
$cmb_filtro_venta_mayorista = Gral::getVars(1, 'cmb_filtro_venta_mayorista', -1);
$cmb_filtro_venta_web_destacado = Gral::getVars(1, 'cmb_filtro_venta_web_destacado', -1);
...
if ($cmb_filtro_venta_mayorista != -1) {
    $criterio->add('ins_insumo.venta_mayorista', $cmb_filtro_venta_mayorista, Criterio::IGUAL);
}
if ($cmb_filtro_venta_web_destacado != -1) {
    $criterio->add('ins_venta_web_info.destacado', $cmb_filtro_venta_web_destacado, Criterio::IGUAL);
}

...
$pde_nota_credito_imagen_id = Gral::getVars(2, 'pde_nota_credito_imagen_id');
$pde_nota_credito_imagen = PdeNotaCreditoImagen::getOxId($pde_nota_credito_imagen_id);
$pde_nota_credito = $pde_nota_credito_imagen->getPdeNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaCreditoImagen::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_credito_imagen->getFiltrosArrXCampo('PdeNotaCredito', 'pde_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaCreditoImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

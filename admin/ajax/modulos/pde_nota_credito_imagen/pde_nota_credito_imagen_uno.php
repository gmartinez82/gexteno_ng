...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/pde_nota_credito_imagen/pde_nota_credito_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/pde_nota_credito_imagen/pde_nota_credito_imagen_uno_masinfo.php"; 
}
?>

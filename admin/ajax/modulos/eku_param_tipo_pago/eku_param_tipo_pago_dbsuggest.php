...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_pago.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_pago.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_pago.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamTipoPago::getEkuParamTipoPagos($p, $c);

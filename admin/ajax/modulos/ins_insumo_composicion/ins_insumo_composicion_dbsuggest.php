...
if($buscar != '...'){
    ...
    $c->add('ins_insumo_composicion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ins_insumo_composicion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_insumo_composicion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_insumo_composicion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('ins_insumo_composicion');
$c->addOrden('ins_insumo_composicion.orden', 'asc');
$c->setCriterios();

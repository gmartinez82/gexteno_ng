...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('EKU_PARAM_TIPO_CONDICION_OPERACION_GRAL_FP_FORMA_PAGO_ADM_ACCION_ELIMINAR')){
    ...
    if($eku_param_tipo_condicion_operacion_gral_fp_forma_pago){
        if($eku_param_tipo_condicion_operacion_gral_fp_forma_pago->getHash() == $hash){
            $eku_param_tipo_condicion_operacion_gral_fp_forma_pago->deleteAll();
        }
    }
}    
?>

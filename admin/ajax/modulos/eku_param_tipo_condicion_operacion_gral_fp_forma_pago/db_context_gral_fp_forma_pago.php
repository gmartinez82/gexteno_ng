...
$gral_fp_forma_pago = $eku_param_tipo_condicion_operacion_gral_fp_forma_pago->getGralFpFormaPago();
...
<div class="datos" id="<?php Gral::_echo($gral_fp_forma_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamTipoCondicionOperacionGralFpFormaPago::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_tipo_condicion_operacion_gral_fp_forma_pago->getFiltrosArrXCampo('GralFpFormaPago', 'gral_fp_forma_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamTipoCondicionOperacionGralFpFormaPagos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_fp_forma_pago->getDescripcion()) ?></strong>
        </a>
    </div>

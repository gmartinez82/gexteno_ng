...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_condicion_operacion_gral_fp_forma_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_condicion_operacion_gral_fp_forma_pago');
$c->addOrden('eku_param_tipo_condicion_operacion_gral_fp_forma_pago.orden', 'asc');
$c->setCriterios();

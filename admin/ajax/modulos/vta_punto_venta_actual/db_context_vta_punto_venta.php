...
$vta_punto_venta = $vta_punto_venta_actual->getVtaPuntoVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_punto_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPuntoVentaActual::getFiltrosArrGral() ?>&arr=<?php echo $vta_punto_venta_actual->getFiltrosArrXCampo('VtaPuntoVenta', 'vta_punto_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPuntoVentaActuals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_punto_venta->getDescripcion()) ?></strong>
        </a>
    </div>

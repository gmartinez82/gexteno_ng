...
VtaPuntoVentaActual::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('vta_punto_venta_actual.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('vta_punto_venta_actual.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('vta_punto_venta_actual.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('vta_punto_venta_actual');
$c->addOrden('vta_punto_venta_actual.orden', 'asc');
$c->setCriterios();

            ...
            <div class="alta full datos">
				...
				<tr>
				  <td  id="label_cntb_periodo_cmb_cntb_ejercicio_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_cntb_ejercicio_id' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_cntb_ejercicio_id', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_cntb_ejercicio_id', false, false) ?>" />
                                        <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cntb_periodo_txt_anio" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_anio' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_anio', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_anio', false, false) ?>" />
                                        <?php } ?>
				...
				<tr>
				  <td  id="label_cntb_periodo_cmb_gral_mes_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_gral_mes_id' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_gral_mes_id', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_gral_mes_id', false, false) ?>" />
                                        <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cntb_periodo_txt_fecha_inicio" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_fecha_inicio' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_fecha_inicio', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_fecha_inicio', false, false) ?>" />
                                        <?php } ?>
				...
				<tr>
				  <td  id="label_cntb_periodo_txt_fecha_fin" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_fecha_fin' ?>" >
                                        ...
                                        <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_fecha_fin', true, false) != ''){ ?>
                                        <img class="help" src="imgs/icn_help.png" width="15" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_fecha_fin', false, false) ?>" />
                                        <?php } ?>

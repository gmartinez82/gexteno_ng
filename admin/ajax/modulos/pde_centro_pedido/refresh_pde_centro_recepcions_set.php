...
$o_ids = eval('return $o_padre->getPdeCentroPedidoPdeCentroRecepcionsId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_centro_pedido_pde_centro_recepcion.pde_centro_pedido_id', $padre_id, Criterio::IGUAL);
$c->addTabla('pde_centro_recepcion');
$c->addRealJoin('pde_centro_pedido_pde_centro_recepcion', 'pde_centro_pedido_pde_centro_recepcion.pde_centro_recepcion_id', 'pde_centro_recepcion.id', 'LEFT JOIN');

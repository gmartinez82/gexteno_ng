...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('pde_centro_pedido_prv_proveedor.pde_centro_pedido_id', $padre_id, Criterio::IGUAL);
$c->addTabla('prv_proveedor');
$c->addRealJoin('pde_centro_pedido_prv_proveedor', 'pde_centro_pedido_prv_proveedor.prv_proveedor_id', 'prv_proveedor.id', 'LEFT JOIN');

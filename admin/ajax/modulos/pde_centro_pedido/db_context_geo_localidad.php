...
$pde_centro_pedido_id = Gral::getVars(2, 'pde_centro_pedido_id');
$pde_centro_pedido = PdeCentroPedido::getOxId($pde_centro_pedido_id);
$geo_localidad = $pde_centro_pedido->getGeoLocalidad();
...
<div class="datos" id="<?php Gral::_echo($geo_localidad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeCentroPedido::getFiltrosArrGral() ?>&arr=<?php echo $pde_centro_pedido->getFiltrosArrXCampo('GeoLocalidad', 'geo_localidad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeCentroPedidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($geo_localidad->getDescripcion()) ?></strong>
        </a>
    </div>

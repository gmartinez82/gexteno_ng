<table border="0" class="tabla-modal-ficha-emails">
    ...
    <?php
    $vta_remito_enviados = $vta_remito->getVtaRemitoEnviados();
    $cont = 0;
    foreach ($vta_remito_enviados as $vta_remito_enviado) {
        ...
        <tr>
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_remito_enviado->getCreado())); ?>
                </div>
            </td>	
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="estado">
                    <img src="imgs/btn_estado_<?php echo $vta_remito_enviado->getEstado(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por-descripcion">
                    <?php Gral::_echo($vta_remito_enviado->getCreadoPorDescripcion()); ?>
                </div>
            </td>
            ...
            <td align='center' class='adm_tbl_lineas <?php echo $strong ?>' align="center">
                <ul class="adm_botones_acciones_modal_ficha">
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_REMITO_GESTION_ACCION_COMPROBANTE')) { ?>
                        <li class='adm_botones_accion vta-remito-comprobante' vta_remito_enviado_id='<?php echo $vta_remito_enviado->getId() ?>'>
                    ...
                    <?php if (UsCredencial::getEsAcreditado('VTA_PRESUPUESTO_GESTION_ACCION_ENVIAR_POR_CORREO')) { ?>
                        <li class='adm_botones_accion vta-remito-ver-cuerpo-correo' vta_remito_enviado_id='<?php echo $vta_remito_enviado->getId() ?>'>

<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/vta_remito_gestion/set_vta_remito_gestion_buscador_top.php">
    ...
    <div class="col">
        ...
        <input id="txt_cantidad_paginas" name="txt_cantidad_paginas" type="text" class="textboxx" size="2" value="<?php echo VtaRemito::getSesPagCantidad() ?>" title="<?php Lang::_lang('Actualmente se visualizan') ?> <?php echo VtaRemito::getSesPagCantidad() ?> <?php Lang::_lang('VtaRemito') ?> <?php Lang::_lang('por Pagina') ?>" />
    </div>

    <div class="col">

        <?php if (UsCredencial::getEsAcreditado('VTA_REMITO_GENERAR')) { ?>    
            <label class="boton generar_remito" title="<?php Lang::_lang('Generar Remito') ?>" modulo='vta_remito_gestion'><img src="imgs/btn_add.gif" width="25"></label>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='vta_remito_gestion'><img src="imgs/btn_lupa.png" width="25"></label>

        <?php if (UsCredencial::getEsAcreditado("VTA_REMITO_GESTION_REGISTRAR_REMITO_AJUSTE")) { ?>
            <label class="boton" title="<?php Lang::_lang('Registrar Remito Ajuste') ?>">
                <a href="vta_remito_ajuste_gestion.php">
    ...
    <div id="div_listado_buscador_extendido" class="div_listado_buscador_extendido">
        ...
        <div class="col vta_remito_tipo_estado">
            <div class="label"><?php Lang::_lang('Tipo Remito') ?></div>
            <div class="dato">
                <?php Html::html_dib_select(1, 'cmb_filtro_vta_tipo_remito_id', Gral::getCmbFiltro(VtaTipoRemito::getVtaTipoRemitosCmb(true), '...'), $cmb_filtro_vta_tipo_remito_id, 'textbox') ?>
            </div>
        </div>
        ...
        <div class="col gral_ruta">
            <div class="label"><?php Lang::_lang('Ruta Asignada') ?></div>
            <div class="dato">

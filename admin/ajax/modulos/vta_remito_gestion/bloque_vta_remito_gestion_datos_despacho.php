<?php if ($vta_remito_tipo_despacho) { ?>
    <?php if ($vta_remito_tipo_despacho->getCodigo() == VtaRemitoTipoDespacho::TIPO_ENVIO_DOMICILIO) { ?>
        <?php if ($cli_cliente->getId() != '') { ?>
            ...
            <?php } ?>
        <?php } ?>
    <?php }elseif ($vta_remito_tipo_despacho->getCodigo() == VtaRemitoTipoDespacho::TIPO_RETIRO_SUCURSAL){ ?>
        <div class="par">

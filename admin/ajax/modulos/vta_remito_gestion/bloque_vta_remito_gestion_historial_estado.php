<table border="0" class="tabla-modal">
    ...
    <?php
    $vta_remito_estados = $vta_remito->getVtaRemitoEstados();
    $cont = 0;
    foreach ($vta_remito_estados as $vta_remito_estado) {
        $cont++;
        $strong = ($cont == 1) ? 'strong' : '';
        $cantidas_bultos = ($vta_remito_estado->getCantidadBultos() == 0) ? '' : $vta_remito_estado->getCantidadBultos();
        $peso = ($vta_remito_estado->getPeso() == 0) ? '' : $vta_remito_estado->getPeso();
        $costo_envio = ($vta_remito_estado->getCostoEnvio() == 0) ? '' : $vta_remito_estado->getCostoEnvio();
        ?>
        <tr>
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center" title="<?php Gral::_echo(Gral::getFechaHoraToWEB($vta_remito_estado->getCreado(), true)); ?>">
                <div class="fecha">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($vta_remito_estado->getCreado())); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="left">
                <div class="tipo-estado">
                    <img src="imgs/vta_remito_tipo_estado/<?php Gral::_echo($vta_remito_estado->getVtaRemitoTipoEstado()->getCodigo()) ?>.png" alt="tipo-estado" width="15" />
            ...
            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="creado-por">
                    <?php Gral::_echo($vta_remito_estado->getCreadoPorDescripcion()); ?>
                </div>
            </td>

            <td class="adm_tbl_lineas <?php echo $strong ?>" align="center">
                <div class="actual">
                    <img src="imgs/btn_estado_<?php echo $vta_remito_estado->getActual(); ?>.gif" width="15" alt="hab" />
                </div>
            </td>
        </tr>
    <?php } ?>

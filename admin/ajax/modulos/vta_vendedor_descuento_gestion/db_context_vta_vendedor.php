...
$vta_vendedor = $vta_vendedor_descuento->getVtaVendedor();
...
<div class="datos" id="<?php Gral::_echo($vta_vendedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaVendedorDescuento::getFiltrosArrGral() ?>&arr=<?php echo $vta_vendedor_descuento->getFiltrosArrXCampo('VtaVendedor', 'vta_vendedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaVendedorDescuentos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_vendedor->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_param_transporte_tipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_transporte_tipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_tipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_tipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_transporte_tipo');
$c->addOrden('eku_param_transporte_tipo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTransporteTipo::getEkuParamTransporteTipos($p, $c);

...
EkuDeArsch01RespMensaje::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('eku_de_arsch01_resp_mensaje.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_arsch01_resp_mensaje.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_arsch01_resp_mensaje.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_arsch01_resp_mensaje.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_arsch01_resp_mensaje');
$c->addOrden('eku_de_arsch01_resp_mensaje.orden', 'asc');
$c->setCriterios();

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('fnd_cajero_us_usuario.fnd_cajero_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('fnd_cajero_us_usuario', 'fnd_cajero_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

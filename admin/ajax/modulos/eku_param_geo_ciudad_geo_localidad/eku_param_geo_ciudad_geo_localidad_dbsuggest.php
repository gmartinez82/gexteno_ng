...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_ciudad_geo_localidad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_geo_ciudad_geo_localidad');
$c->addOrden('eku_param_geo_ciudad_geo_localidad.orden', 'asc');
$c->setCriterios();

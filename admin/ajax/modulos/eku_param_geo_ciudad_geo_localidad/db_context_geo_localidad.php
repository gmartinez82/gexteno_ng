...
$geo_localidad = $eku_param_geo_ciudad_geo_localidad->getGeoLocalidad();
...
<div class="datos" id="<?php Gral::_echo($geo_localidad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamGeoCiudadGeoLocalidad::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_geo_ciudad_geo_localidad->getFiltrosArrXCampo('GeoLocalidad', 'geo_localidad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamGeoCiudadGeoLocalidads') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($geo_localidad->getDescripcion()) ?></strong>
        </a>
    </div>

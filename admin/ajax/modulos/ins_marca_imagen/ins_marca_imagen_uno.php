...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/ins_marca_imagen/ins_marca_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/ins_marca_imagen/ins_marca_imagen_uno_masinfo.php"; 
}
?>

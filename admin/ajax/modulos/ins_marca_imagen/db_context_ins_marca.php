...
$ins_marca_imagen_id = Gral::getVars(2, 'ins_marca_imagen_id');
$ins_marca_imagen = InsMarcaImagen::getOxId($ins_marca_imagen_id);
$ins_marca = $ins_marca_imagen->getInsMarca();
...
<div class="datos" id="<?php Gral::_echo($ins_marca->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsMarcaImagen::getFiltrosArrGral() ?>&arr=<?php echo $ins_marca_imagen->getFiltrosArrXCampo('InsMarca', 'ins_marca_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsMarcaImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_marca->getDescripcion()) ?></strong>
        </a>
    </div>

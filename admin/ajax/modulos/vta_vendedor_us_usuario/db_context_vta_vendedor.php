...
$vta_vendedor_us_usuario_id = Gral::getVars(2, 'vta_vendedor_us_usuario_id');
$vta_vendedor_us_usuario = VtaVendedorUsUsuario::getOxId($vta_vendedor_us_usuario_id);
$vta_vendedor = $vta_vendedor_us_usuario->getVtaVendedor();
...
<div class="datos" id="<?php Gral::_echo($vta_vendedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaVendedorUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $vta_vendedor_us_usuario->getFiltrosArrXCampo('VtaVendedor', 'vta_vendedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaVendedorUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_vendedor->getDescripcion()) ?></strong>
        </a>
    </div>

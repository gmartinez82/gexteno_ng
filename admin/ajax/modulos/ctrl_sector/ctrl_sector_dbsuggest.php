...
if($buscar != '...'){
    ...
    $c->add('ctrl_sector.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ctrl_sector.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ctrl_sector.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ctrl_sector.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

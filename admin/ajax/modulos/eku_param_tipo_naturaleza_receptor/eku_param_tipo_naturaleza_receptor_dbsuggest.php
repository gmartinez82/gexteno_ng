...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_naturaleza_receptor.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_naturaleza_receptor.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_receptor.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_receptor.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamTipoNaturalezaReceptor::getEkuParamTipoNaturalezaReceptors($p, $c);

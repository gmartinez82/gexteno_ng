...
$c->add('cli_cliente_cli_rubro.cli_rubro_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_cliente');
$c->addRealJoin('cli_cliente_cli_rubro', 'cli_cliente_cli_rubro.cli_cliente_id', 'cli_cliente.id', 'LEFT JOIN');

...
if($buscar != '...'){
    ...
    $c->add('ins_insumo_bulto.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('ins_insumo_bulto.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_insumo_bulto.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('ins_insumo_bulto.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

...
$us_agrupado_id = Gral::getVars(2, 'us_agrupado_id');
$us_agrupado = UsAgrupado::getOxId($us_agrupado_id);
$us_usuario = $us_agrupado->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo UsAgrupado::getFiltrosArrGral() ?>&arr=<?php echo $us_agrupado->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('UsAgrupados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

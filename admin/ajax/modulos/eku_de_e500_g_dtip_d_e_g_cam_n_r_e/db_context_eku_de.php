...
$eku_de_e500_g_dtip_d_e_g_cam_n_r_e_id = Gral::getVars(2, 'eku_de_e500_g_dtip_d_e_g_cam_n_r_e_id');
$eku_de_e500_g_dtip_d_e_g_cam_n_r_e = EkuDeE500GDtipDEGCamNRE::getOxId($eku_de_e500_g_dtip_d_e_g_cam_n_r_e_id);
$eku_de = $eku_de_e500_g_dtip_d_e_g_cam_n_r_e->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE500GDtipDEGCamNRE::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e500_g_dtip_d_e_g_cam_n_r_e->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE500GDtipDEGCamNREs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

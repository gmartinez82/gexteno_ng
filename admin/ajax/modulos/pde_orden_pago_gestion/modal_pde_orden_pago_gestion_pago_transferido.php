...
?>
<form id='form_datos_transferir_orden_pago' name='form_datos_preparar_orden_pago' method='post' >
    <div class='datos transferir-orden-pago' pde_orden_pago_id="<?php echo $pde_orden_pago_id ?>">
        ...
        <div class="botonera">
            <input id="btn_registrar" name='btn_registrar' type='button' class='boton' value='<?php Lang::_lang('Autorizar') ?>' />
        </div>

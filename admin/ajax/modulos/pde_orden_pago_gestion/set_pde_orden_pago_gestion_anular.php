...
if (!$arr["error"]) {
    ...
    //$pde_orden_pago_estado = $pde_orden_pago->setPdeOrdenPagoEstado(PdeOrdenPagoTipoEstado::TIPO_ANULADO, $txa_observacion);
    $pde_orden_pago_estado = $pde_orden_pago->setPdeOrdenPagoAnular($txa_observacion);
}

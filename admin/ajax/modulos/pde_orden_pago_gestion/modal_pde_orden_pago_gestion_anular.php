...
?>
<form id='form_datos_anular_orden_pago' name='form_datos_anular_orden_pago' method='post' >
    <div class='datos anular-orden-pago' pde_orden_pago_id="<?php echo $pde_orden_pago_id ?>">
        ...
        <div class="botonera">
            <input id="btn_registrar" name='btn_registrar' type='button' class='boton' value='<?php Lang::_lang('Anular') ?>' />
        </div>

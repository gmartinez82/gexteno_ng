...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_afectacion_tributaria.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_afectacion_tributaria.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_afectacion_tributaria.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_afectacion_tributaria.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = EkuParamTipoAfectacionTributaria::getEkuParamTipoAfectacionTributarias($p, $c);

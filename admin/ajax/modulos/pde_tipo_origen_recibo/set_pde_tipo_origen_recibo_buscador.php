...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pde_tipo_origen_recibo.id', Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_id'), Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_id_comparador'));
	$criterio->add('pde_tipo_origen_recibo.descripcion', Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_descripcion'), Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_descripcion_comparador'));
	$criterio->add('pde_tipo_origen_recibo.codigo', Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_codigo'), Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_codigo_comparador'));
	$criterio->add('pde_tipo_origen_recibo.observacion', Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_observacion'), Gral::getVars(1, 'buscador_pde_tipo_origen_recibo_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('pde_recibo', 'pde_recibo.pde_tipo_origen_recibo_id', 'pde_tipo_origen_recibo.id', 'LEFT JOIN');

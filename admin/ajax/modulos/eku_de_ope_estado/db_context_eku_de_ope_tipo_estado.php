...
$eku_de_ope_estado_id = Gral::getVars(2, 'eku_de_ope_estado_id');
$eku_de_ope_estado = EkuDeOpeEstado::getOxId($eku_de_ope_estado_id);
$eku_de_ope_tipo_estado = $eku_de_ope_estado->getEkuDeOpeTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($eku_de_ope_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeOpeEstado::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_ope_estado->getFiltrosArrXCampo('EkuDeOpeTipoEstado', 'eku_de_ope_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeOpeEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de_ope_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

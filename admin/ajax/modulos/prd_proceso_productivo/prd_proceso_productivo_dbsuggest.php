...
if($buscar != '...'){
    ...
    $c->add('prd_proceso_productivo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_proceso_productivo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_proceso_productivo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_proceso_productivo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_proceso_productivo');
$c->addOrden('prd_proceso_productivo.orden', 'asc');
$c->setCriterios();

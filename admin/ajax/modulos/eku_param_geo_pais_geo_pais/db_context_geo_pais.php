...
$geo_pais = $eku_param_geo_pais_geo_pais->getGeoPais();
...
<div class="datos" id="<?php Gral::_echo($geo_pais->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamGeoPaisGeoPais::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_geo_pais_geo_pais->getFiltrosArrXCampo('GeoPais', 'geo_pais_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamGeoPaisGeoPaiss') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($geo_pais->getDescripcion()) ?></strong>
        </a>
    </div>

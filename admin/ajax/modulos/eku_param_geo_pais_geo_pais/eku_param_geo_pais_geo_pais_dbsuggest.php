...
if($buscar != '...'){
    ...
    $c->add('eku_param_geo_pais_geo_pais.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_geo_pais_geo_pais');
$c->addOrden('eku_param_geo_pais_geo_pais.orden', 'asc');
$c->setCriterios();

...
if($buscar != '...'){
    ...
    $c->add('os_tipo_resolucion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_tipo_resolucion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_tipo_resolucion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_tipo_resolucion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_tipo_resolucion');
$c->addOrden('os_tipo_resolucion.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = OsTipoResolucion::getOsTipoResolucions($p, $c);

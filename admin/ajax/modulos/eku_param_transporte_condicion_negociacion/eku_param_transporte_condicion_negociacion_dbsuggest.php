...
if($buscar != '...'){
    ...
    $c->add('eku_param_transporte_condicion_negociacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_transporte_condicion_negociacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_condicion_negociacion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_transporte_condicion_negociacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_transporte_condicion_negociacion');
$c->addOrden('eku_param_transporte_condicion_negociacion.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTransporteCondicionNegociacion::getEkuParamTransporteCondicionNegociacions($p, $c);

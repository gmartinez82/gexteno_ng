...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('alt_control_us_usuario.alt_control_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('alt_control_us_usuario', 'alt_control_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

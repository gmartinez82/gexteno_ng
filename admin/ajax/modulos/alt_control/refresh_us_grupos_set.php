...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('alt_control_us_grupo.alt_control_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_grupo');
$c->addRealJoin('alt_control_us_grupo', 'alt_control_us_grupo.us_grupo_id', 'us_grupo.id', 'LEFT JOIN');

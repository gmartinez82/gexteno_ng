...
$pde_oc_reclamo = $pde_oc_reclamo_envio_email->getPdeOcReclamo();
...
<div class="datos" id="<?php Gral::_echo($pde_oc_reclamo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcReclamoEnvioEmail::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_reclamo_envio_email->getFiltrosArrXCampo('PdeOcReclamo', 'pde_oc_reclamo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcReclamoEnvioEmails') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc_reclamo->getDescripcion()) ?></strong>
        </a>
    </div>

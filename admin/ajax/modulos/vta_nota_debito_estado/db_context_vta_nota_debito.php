...
$vta_nota_debito = $vta_nota_debito_estado->getVtaNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaDebitoEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_debito_estado->getFiltrosArrXCampo('VtaNotaDebito', 'vta_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaDebitoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

...
$eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d_id = Gral::getVars(2, 'eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d_id');
...
$eku_de = $eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE620GDtipDEGCamCondGPagTarCD::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE620GDtipDEGCamCondGPagTarCDs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d');
$c->addOrden('eku_de_e620_g_dtip_d_e_g_cam_cond_g_pag_tar_c_d.orden', 'asc');
$c->setCriterios();

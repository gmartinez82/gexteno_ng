...
$ins_stock_transformacion = $ins_insumo_costo->getInsStockTransformacion();
...
<div class="datos" id="<?php Gral::_echo($ins_stock_transformacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsInsumoCosto::getFiltrosArrGral() ?>&arr=<?php echo $ins_insumo_costo->getFiltrosArrXCampo('InsStockTransformacion', 'ins_stock_transformacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsInsumoCostos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_stock_transformacion->getDescripcion()) ?></strong>
        </a>
    </div>

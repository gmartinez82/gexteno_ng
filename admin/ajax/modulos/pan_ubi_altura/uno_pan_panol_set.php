...
if(in_array($pan_panol_relacionado->getId(), $o_ids)){
    ...
    $array = array(
        array('campo' => 'pan_ubi_altura_id', 'valor' => $o_padre->getId()),
...
<div class='list <?php echo $css_sel ?>' title='<?php echo $pan_panol_relacionado->getObservacion() ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('PAN_UBI_ALTURA_ALTA_RELACION_PAN_PANOL_ACCIONES_SELECCION')){ ?>	

...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pan_ubi_altura.id', Gral::getVars(1, 'buscador_pan_ubi_altura_id'), Gral::getVars(1, 'buscador_pan_ubi_altura_id_comparador'));
	$criterio->add('pan_ubi_altura.descripcion', Gral::getVars(1, 'buscador_pan_ubi_altura_descripcion'), Gral::getVars(1, 'buscador_pan_ubi_altura_descripcion_comparador'));
	$criterio->add('pan_ubi_altura.codigo', Gral::getVars(1, 'buscador_pan_ubi_altura_codigo'), Gral::getVars(1, 'buscador_pan_ubi_altura_codigo_comparador'));
	$criterio->add('pan_ubi_altura.observacion', Gral::getVars(1, 'buscador_pan_ubi_altura_observacion'), Gral::getVars(1, 'buscador_pan_ubi_altura_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('ins_insumo_pan_panol', 'ins_insumo_pan_panol.pan_ubi_altura_id', 'pan_ubi_altura.id', 'LEFT JOIN');

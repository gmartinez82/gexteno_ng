...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/veh_marca_imagen/veh_marca_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/veh_marca_imagen/veh_marca_imagen_uno_masinfo.php"; 
}
?>

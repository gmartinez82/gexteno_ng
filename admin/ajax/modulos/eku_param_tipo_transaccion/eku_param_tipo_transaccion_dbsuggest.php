...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_transaccion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_transaccion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_transaccion.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_transaccion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_transaccion');
$c->addOrden('eku_param_tipo_transaccion.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoTransaccion::getEkuParamTipoTransaccions($p, $c);

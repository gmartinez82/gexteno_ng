...
if($buscar != '...'){
    ...
    $c->add('eku_de_e820_g_cam_esp_g_grup_adi.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e820_g_cam_esp_g_grup_adi.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e820_g_cam_esp_g_grup_adi.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e820_g_cam_esp_g_grup_adi.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e820_g_cam_esp_g_grup_adi');
$c->addOrden('eku_de_e820_g_cam_esp_g_grup_adi.orden', 'asc');
$c->setCriterios();

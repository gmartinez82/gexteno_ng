...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_factura_vta_tributo.vta_factura_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_tributo');
$c->addRealJoin('vta_factura_vta_tributo', 'vta_factura_vta_tributo.vta_tributo_id', 'vta_tributo.id', 'LEFT JOIN');

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_factura_ws_fe_ope_solicitud.vta_factura_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ws_fe_ope_solicitud');
$c->addRealJoin('vta_factura_ws_fe_ope_solicitud', 'vta_factura_ws_fe_ope_solicitud.ws_fe_ope_solicitud_id', 'ws_fe_ope_solicitud.id', 'LEFT JOIN');

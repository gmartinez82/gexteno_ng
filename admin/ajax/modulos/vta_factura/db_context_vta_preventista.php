...
$vta_preventista = $vta_factura->getVtaPreventista();
...
<div class="datos" id="<?php Gral::_echo($vta_preventista->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaFactura::getFiltrosArrGral() ?>&arr=<?php echo $vta_factura->getFiltrosArrXCampo('VtaPreventista', 'vta_preventista_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaFacturas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_preventista->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('gral_caja.id', Gral::getVars(1, 'buscador_gral_caja_id'), Gral::getVars(1, 'buscador_gral_caja_id_comparador'));
	$criterio->add('gral_caja.descripcion', Gral::getVars(1, 'buscador_gral_caja_descripcion'), Gral::getVars(1, 'buscador_gral_caja_descripcion_comparador'));
	$criterio->add('gral_caja.gral_caja_tipo_id', Gral::getVars(1, 'buscador_gral_caja_gral_caja_tipo_id'), Gral::getVars(1, 'buscador_gral_caja_gral_caja_tipo_id_comparador'));
	$criterio->add('gral_caja.numero', Gral::getVars(1, 'buscador_gral_caja_numero'), Gral::getVars(1, 'buscador_gral_caja_numero_comparador'));
	$criterio->add('gral_caja.codigo', Gral::getVars(1, 'buscador_gral_caja_codigo'), Gral::getVars(1, 'buscador_gral_caja_codigo_comparador'));
	$criterio->add('gral_caja.observacion', Gral::getVars(1, 'buscador_gral_caja_observacion'), Gral::getVars(1, 'buscador_gral_caja_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('gral_sucursal_gral_caja', 'gral_sucursal_gral_caja.gral_caja_id', 'gral_caja.id', 'LEFT JOIN');
	$criterio->addRealJoin('gral_sucursal', 'gral_sucursal.id', 'gral_sucursal_gral_caja.gral_sucursal_id', 'LEFT JOIN');
	$criterio->addRealJoin('fnd_caja', 'fnd_caja.gral_caja_id', 'gral_caja.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('fnd_cajero_gral_caja', 'fnd_cajero_gral_caja.gral_caja_id', 'gral_caja.id', 'LEFT JOIN');
	$criterio->addRealJoin('fnd_chq_estado', 'fnd_chq_estado.gral_caja_id', 'gral_caja.id', 'LEFT JOIN');

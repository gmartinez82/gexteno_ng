...
if($buscar != '...'){
    ...
    $c->add('prd_orden_trabajo_ciclo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_orden_trabajo_ciclo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_ciclo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_orden_trabajo_ciclo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_orden_trabajo_ciclo');
$c->addOrden('prd_orden_trabajo_ciclo.orden', 'asc');
$c->setCriterios();

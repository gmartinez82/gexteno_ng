...
if($buscar != '...'){
    ...
    $c->add('eku_de_e300_g_dtip_d_e_g_cam_a_e.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e300_g_dtip_d_e_g_cam_a_e.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e300_g_dtip_d_e_g_cam_a_e.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e300_g_dtip_d_e_g_cam_a_e.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e300_g_dtip_d_e_g_cam_a_e');
$c->addOrden('eku_de_e300_g_dtip_d_e_g_cam_a_e.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuDeE300GDtipDEGCamAE::getEkuDeE300GDtipDEGCamAEs($p, $c);

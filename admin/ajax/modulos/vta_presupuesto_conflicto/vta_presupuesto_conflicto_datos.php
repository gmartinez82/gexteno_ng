...
<table border='0' align='center' class='listado' id='listado_adm_vta_presupuesto_conflicto'>
  ...
  <tr>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=importe_actualizado&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Imp Actualizado') ?>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=fecha_conflicto&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Fecha de Conflicto') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='fecha_conflicto'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=fecha_resolucion&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Fecha de Resolucion') ?>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=us_usuario_resolucion&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('UsUsuario Resolucion') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='us_usuario_resolucion'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=resuelto&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Resuelto') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='resuelto'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id="tr_vta_presupuesto_conflicto_uno_<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>" class="uno" identificador="<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>">
  	<?php include "vta_presupuesto_conflicto_uno.php" ?>
  </tr>
  ...
  <tr id='tr_eliminar_<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>" >
	<td colspan='14' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />
...
?>
  <tr id='tr_mi_<?php Gral::_echo($vta_presupuesto_conflicto->getId()) ?>' <?php Gral::_echo($mi_display) ?>>
	...
	<div class="masinfo">
		<?php 
		if(trim($id) == $vta_presupuesto_conflicto->getId()){ 
			include "vta_presupuesto_conflicto_adm_masinfo.php";
		}
		?>
	</div>

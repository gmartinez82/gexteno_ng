<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/vta_presupuesto_conflicto/set_vta_presupuesto_conflicto_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='vta_presupuesto_conflicto_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('VtaPresupuestoConflicto') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='vta_presupuesto_conflicto'><img src="imgs/btn_lupa.png" width="25"></label>

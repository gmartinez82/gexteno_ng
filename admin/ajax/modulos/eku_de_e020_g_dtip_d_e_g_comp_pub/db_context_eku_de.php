...
$eku_de_e020_g_dtip_d_e_g_comp_pub_id = Gral::getVars(2, 'eku_de_e020_g_dtip_d_e_g_comp_pub_id');
$eku_de_e020_g_dtip_d_e_g_comp_pub = EkuDeE020GDtipDEGCompPub::getOxId($eku_de_e020_g_dtip_d_e_g_comp_pub_id);
$eku_de = $eku_de_e020_g_dtip_d_e_g_comp_pub->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE020GDtipDEGCompPub::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e020_g_dtip_d_e_g_comp_pub->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE020GDtipDEGCompPubs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

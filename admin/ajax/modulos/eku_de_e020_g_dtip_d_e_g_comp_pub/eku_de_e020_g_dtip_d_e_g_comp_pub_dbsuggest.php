...
if($buscar != '...'){
    ...
    $c->add('eku_de_e020_g_dtip_d_e_g_comp_pub.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e020_g_dtip_d_e_g_comp_pub.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e020_g_dtip_d_e_g_comp_pub.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e020_g_dtip_d_e_g_comp_pub.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e020_g_dtip_d_e_g_comp_pub');
$c->addOrden('eku_de_e020_g_dtip_d_e_g_comp_pub.orden', 'asc');
$c->setCriterios();

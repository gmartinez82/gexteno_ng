...
$afip_citi_prc = $afip_citi_ventas_alicuotas->getAfipCitiPrc();
...
<div class="datos" id="<?php Gral::_echo($afip_citi_prc->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiVentasAlicuotas::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_ventas_alicuotas->getFiltrosArrXCampo('AfipCitiPrc', 'afip_citi_prc_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiVentasAlicuotass') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($afip_citi_prc->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_impuesto.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_impuesto.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_impuesto.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_impuesto.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_impuesto');
$c->addOrden('eku_param_tipo_impuesto.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoImpuesto::getEkuParamTipoImpuestos($p, $c);

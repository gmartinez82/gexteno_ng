...
if($buscar != '...'){
    ...
    $c->add('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal');
$c->addOrden('eku_de_e920_g_dtip_d_e_g_transp_g_cam_sal.orden', 'asc');
$c->setCriterios();

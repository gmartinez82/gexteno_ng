...
$us_usuario = $nov_novedad_leido->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo NovNovedadLeido::getFiltrosArrGral() ?>&arr=<?php echo $nov_novedad_leido->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('NovNovedadLeidos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

...
$pde_factura = $pde_factura_pde_oc->getPdeFactura();
...
<div class="datos" id="<?php Gral::_echo($pde_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaPdeOc::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_pde_oc->getFiltrosArrXCampo('PdeFactura', 'pde_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaPdeOcs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_factura->getDescripcion()) ?></strong>
        </a>
    </div>

...
$ins_insumo_costo = $pde_factura_pde_oc->getInsInsumoCosto();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo_costo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeFacturaPdeOc::getFiltrosArrGral() ?>&arr=<?php echo $pde_factura_pde_oc->getFiltrosArrXCampo('InsInsumoCosto', 'ins_insumo_costo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeFacturaPdeOcs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo_costo->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('prd_param_operacion_ope_operario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_param_operacion_ope_operario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_param_operacion_ope_operario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_param_operacion_ope_operario');
$c->addOrden('prd_param_operacion_ope_operario.orden', 'asc');
$c->setCriterios();

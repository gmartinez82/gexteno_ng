...
$prd_param_operacion = $prd_param_operacion_ope_operario->getPrdParamOperacion();
...
<div class="datos" id="<?php Gral::_echo($prd_param_operacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrdParamOperacionOpeOperario::getFiltrosArrGral() ?>&arr=<?php echo $prd_param_operacion_ope_operario->getFiltrosArrXCampo('PrdParamOperacion', 'prd_param_operacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrdParamOperacionOpeOperarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prd_param_operacion->getDescripcion()) ?></strong>
        </a>
    </div>

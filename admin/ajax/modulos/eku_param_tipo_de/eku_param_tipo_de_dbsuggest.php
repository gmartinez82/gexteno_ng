...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_de.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_de.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_de.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_de.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_de');
$c->addOrden('eku_param_tipo_de.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoDe::getEkuParamTipoDes($p, $c);

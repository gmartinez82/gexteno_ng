...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <div class="trigger wopenModal boton" archivo="ajax/modulos/cli_cliente_vta_punto_venta/cli_cliente_vta_punto_venta_alta.php?id=<?php Gral::_echo($cli_cliente_vta_punto_venta_id) ?>" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="refreshSetUno(<?php Gral::_echo($vta_punto_venta_relacionado->getId()) ?>, 'vta_punto_venta', 'cli_cliente', <?php Gral::_echo($o_padre->getId()) ?>, 'CliCliente', 'CliClienteVtaPuntoVenta')" title="Editar CliClienteVtaPuntoVenta"><?php Lang::_lang('Editar') ?></div>
        <?php } ?>
        <?php } ?>

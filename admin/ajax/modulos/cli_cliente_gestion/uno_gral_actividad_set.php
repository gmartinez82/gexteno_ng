...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <a class='boton' href='gral_actividad_alta.php?id=<?php echo $gral_actividad_relacionado->getId() ?>' title="<?php Lang::_lang('Ver/Editar') ?>: '<?php Gral::_echo($gral_actividad_relacionado->getDescripcion()) ?>' "><?php Lang::_lang('Ver') ?></a>
        <?php } ?>
    </label>

...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <a class='boton' href='gral_fp_cuota_alta.php?id=<?php echo $gral_fp_cuota_relacionado->getId() ?>' title="<?php Lang::_lang('Ver/Editar') ?>: '<?php Gral::_echo($gral_fp_cuota_relacionado->getDescripcion()) ?>' "><?php Lang::_lang('Ver') ?></a>
        <?php } ?>
    </label>

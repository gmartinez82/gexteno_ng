...
$o_ids = eval('return $o_padre->getGralSucursalCliClientesId();');

// -----------------------------------------------------------------------------
// elementos seleccionados
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('gral_sucursal_cli_cliente.cli_cliente_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_sucursal');
$c->addRealJoin('gral_sucursal_cli_cliente', 'gral_sucursal_cli_cliente.gral_sucursal_id', 'gral_sucursal.id', 'LEFT JOIN');

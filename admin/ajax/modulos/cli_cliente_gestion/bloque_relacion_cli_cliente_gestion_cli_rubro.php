	...
	<div class='buscador'>
            ...
            <div class="trigger wopenModal boton" archivo="ajax/modulos/cli_rubro/cli_rubro_alta.php" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="buscarSetResultados(1, '', 'cli_rubro', 'cli_cliente', <?php Gral::_echo($cli_cliente->getId()) ?>, 'CliCliente', 'CliClienteCliRubro')" title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('cli_rubro') ?>'>

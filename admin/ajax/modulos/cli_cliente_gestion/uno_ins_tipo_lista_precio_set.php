...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <div class="trigger wopenModal boton" archivo="ajax/modulos/cli_cliente_ins_tipo_lista_precio/cli_cliente_ins_tipo_lista_precio_alta.php?id=<?php Gral::_echo($cli_cliente_ins_tipo_lista_precio_id) ?>" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="refreshSetUno(<?php Gral::_echo($ins_tipo_lista_precio_relacionado->getId()) ?>, 'ins_tipo_lista_precio', 'cli_cliente', <?php Gral::_echo($o_padre->getId()) ?>, 'CliCliente', 'CliClienteInsTipoListaPrecio')" title="Editar CliClienteInsTipoListaPrecio"><?php Lang::_lang('Editar') ?></div>
        <?php } ?>
        <?php } ?>

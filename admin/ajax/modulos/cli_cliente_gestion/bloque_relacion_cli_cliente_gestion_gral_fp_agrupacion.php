	...
	<div class='buscador'>
            ...
            <div class="trigger wopenModal boton" archivo="ajax/modulos/gral_fp_agrupacion/gral_fp_agrupacion_alta.php" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="buscarSetResultados(1, '', 'gral_fp_agrupacion', 'cli_cliente', <?php Gral::_echo($cli_cliente->getId()) ?>, 'CliCliente', 'CliClienteGralFpAgrupacion')" title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('gral_fp_agrupacion') ?>'>

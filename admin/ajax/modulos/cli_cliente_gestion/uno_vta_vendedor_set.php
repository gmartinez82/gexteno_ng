...
<div class='list <?php echo $css_sel ?>'>
    ...
    <label class='link'>
        ...
        <div class="trigger wopenModal boton" archivo="ajax/modulos/cli_cliente_vta_vendedor/cli_cliente_vta_vendedor_alta.php?id=<?php Gral::_echo($cli_cliente_vta_vendedor_id) ?>" contenedor="div_modal" ancho="750" alto="600" tipo="formulario" post="refreshSetUno(<?php Gral::_echo($vta_vendedor_relacionado->getId()) ?>, 'vta_vendedor', 'cli_cliente', <?php Gral::_echo($o_padre->getId()) ?>, 'CliCliente', 'CliClienteVtaVendedor')" title="Editar CliClienteVtaVendedor"><?php Lang::_lang('Editar') ?></div>
        <?php } ?>
        <?php } ?>

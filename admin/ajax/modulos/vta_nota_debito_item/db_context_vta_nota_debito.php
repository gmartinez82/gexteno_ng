...
$vta_nota_debito = $vta_nota_debito_item->getVtaNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaDebitoItem::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_debito_item->getFiltrosArrXCampo('VtaNotaDebito', 'vta_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaDebitoItems') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

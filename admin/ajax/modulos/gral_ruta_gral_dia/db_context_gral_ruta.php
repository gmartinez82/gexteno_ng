...
$gral_ruta = $gral_ruta_gral_dia->getGralRuta();
...
<div class="datos" id="<?php Gral::_echo($gral_ruta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralRutaGralDia::getFiltrosArrGral() ?>&arr=<?php echo $gral_ruta_gral_dia->getFiltrosArrXCampo('GralRuta', 'gral_ruta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralRutaGralDias') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_ruta->getDescripcion()) ?></strong>
        </a>
    </div>

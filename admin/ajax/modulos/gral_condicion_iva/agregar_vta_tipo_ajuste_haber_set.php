...
// -----------------------------------------------------------------------------
if(UsCredencial::getEsAcreditado('GRAL_CONDICION_IVA_ALTA_RELACION_VTA_TIPO_AJUSTE_HABER_ACCIONES_SELECCION')){
    ...
    if($checked == 'checked' or $checked == 'true'){
        ...
        $o = GralCondicionIvaVtaTipoAjusteHaber::getOxId($relacion_id);
        $o->delete();
    }
}
?>

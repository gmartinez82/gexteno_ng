...
if($buscar != '...'){
    ...
    $c->add('gral_condicion_iva.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_condicion_iva.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_condicion_iva.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_condicion_iva.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralCondicionIva::getGralCondicionIvas($p, $c);

...
$vta_vendedor = $gral_centro_costo_vta_vendedor->getVtaVendedor();
...
<div class="datos" id="<?php Gral::_echo($vta_vendedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralCentroCostoVtaVendedor::getFiltrosArrGral() ?>&arr=<?php echo $gral_centro_costo_vta_vendedor->getFiltrosArrXCampo('VtaVendedor', 'vta_vendedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralCentroCostoVtaVendedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_vendedor->getDescripcion()) ?></strong>
        </a>
    </div>

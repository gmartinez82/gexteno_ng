...
if($buscar != '...'){
    ...
    $c->add('eku_de_d200_g_dat_gral_ope_g_dat_rec.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_d200_g_dat_gral_ope_g_dat_rec.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d200_g_dat_gral_ope_g_dat_rec.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d200_g_dat_gral_ope_g_dat_rec.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_d200_g_dat_gral_ope_g_dat_rec');
$c->addOrden('eku_de_d200_g_dat_gral_ope_g_dat_rec.orden', 'asc');
$c->setCriterios();

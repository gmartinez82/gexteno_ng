...
<div class="datos" id="<?php Gral::_echo($ins_unidad_medida->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaCreditoVtaFacturaVtaOrdenVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_credito_vta_factura_vta_orden_venta->getFiltrosArrXCampo('InsUnidadMedida', 'ins_unidad_medida_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaCreditoVtaFacturaVtaOrdenVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_unidad_medida->getDescripcion()) ?></strong>
        </a>
    </div>

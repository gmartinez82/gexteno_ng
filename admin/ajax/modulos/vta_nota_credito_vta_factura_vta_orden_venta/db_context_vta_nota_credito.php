...
$vta_nota_credito = $vta_nota_credito_vta_factura_vta_orden_venta->getVtaNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaNotaCreditoVtaFacturaVtaOrdenVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_nota_credito_vta_factura_vta_orden_venta->getFiltrosArrXCampo('VtaNotaCredito', 'vta_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaNotaCreditoVtaFacturaVtaOrdenVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

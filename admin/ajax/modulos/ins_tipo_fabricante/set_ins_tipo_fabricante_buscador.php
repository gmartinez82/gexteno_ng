...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('ins_tipo_fabricante.id', Gral::getVars(1, 'buscador_ins_tipo_fabricante_id'), Gral::getVars(1, 'buscador_ins_tipo_fabricante_id_comparador'));
	$criterio->add('ins_tipo_fabricante.descripcion', Gral::getVars(1, 'buscador_ins_tipo_fabricante_descripcion'), Gral::getVars(1, 'buscador_ins_tipo_fabricante_descripcion_comparador'));
	$criterio->add('ins_tipo_fabricante.codigo', Gral::getVars(1, 'buscador_ins_tipo_fabricante_codigo'), Gral::getVars(1, 'buscador_ins_tipo_fabricante_codigo_comparador'));
	$criterio->add('ins_tipo_fabricante.observacion', Gral::getVars(1, 'buscador_ins_tipo_fabricante_observacion'), Gral::getVars(1, 'buscador_ins_tipo_fabricante_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('ins_insumo', 'ins_insumo.ins_tipo_fabricante_id', 'ins_tipo_fabricante.id', 'LEFT JOIN');

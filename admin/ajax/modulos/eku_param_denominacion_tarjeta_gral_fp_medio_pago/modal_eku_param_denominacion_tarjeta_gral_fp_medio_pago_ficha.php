...
//Gral::prr($eku_param_denominacion_tarjeta_gral_fp_medio_pago);
?>

<div class="tabs ficha-eku_param_denominacion_tarjeta_gral_fp_medio_pago" identificador="<?php echo $eku_param_denominacion_tarjeta_gral_fp_medio_pago->getId() ?>">
    ...
    <div id="tab_general" class="datos">
        ...
        <div class="par eku_param_denominacion_tarjeta_gral_fp_medio_pago id">
        ...
        <div class="par eku_param_denominacion_tarjeta_gral_fp_medio_pago eku_param_denominacion_tarjeta_id">
        ...
        <div class="par eku_param_denominacion_tarjeta_gral_fp_medio_pago gral_fp_medio_pago_id">

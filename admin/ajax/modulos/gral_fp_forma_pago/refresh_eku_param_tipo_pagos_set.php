...
$c->add('eku_param_tipo_pago_gral_fp_forma_pago.gral_fp_forma_pago_id', $padre_id, Criterio::IGUAL);
$c->addTabla('eku_param_tipo_pago');
$c->addRealJoin('eku_param_tipo_pago_gral_fp_forma_pago', 'eku_param_tipo_pago_gral_fp_forma_pago.eku_param_tipo_pago_id', 'eku_param_tipo_pago.id', 'LEFT JOIN');

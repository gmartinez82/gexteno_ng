...
if($buscar != '...'){
    ...
    $c->add('gral_fp_forma_pago.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_fp_forma_pago.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_fp_forma_pago.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_fp_forma_pago.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralFpFormaPago::getGralFpFormaPagos($p, $c);

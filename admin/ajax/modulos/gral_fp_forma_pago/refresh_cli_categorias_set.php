...
$c->add('cli_categoria_gral_fp_forma_pago.gral_fp_forma_pago_id', $padre_id, Criterio::IGUAL);
$c->addTabla('cli_categoria');
$c->addRealJoin('cli_categoria_gral_fp_forma_pago', 'cli_categoria_gral_fp_forma_pago.cli_categoria_id', 'cli_categoria.id', 'LEFT JOIN');

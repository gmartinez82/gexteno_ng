...
$o_ids = eval('return $o_padre->getPanPanolUsUsuariosId();');
...
$c->add('pan_panol_us_usuario.pan_panol_id', $padre_id, Criterio::IGUAL);
$c->addTabla('us_usuario');
$c->addRealJoin('pan_panol_us_usuario', 'pan_panol_us_usuario.us_usuario_id', 'us_usuario.id', 'LEFT JOIN');

...
$c->add('gral_sucursal_pan_panol.pan_panol_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_sucursal');
$c->addRealJoin('gral_sucursal_pan_panol', 'gral_sucursal_pan_panol.gral_sucursal_id', 'gral_sucursal.id', 'LEFT JOIN');

...
$prv_proveedor_us_usuario_id = Gral::getVars(2, 'prv_proveedor_us_usuario_id');
$prv_proveedor_us_usuario = PrvProveedorUsUsuario::getOxId($prv_proveedor_us_usuario_id);
$prv_proveedor = $prv_proveedor_us_usuario->getPrvProveedor();
...
<div class="datos" id="<?php Gral::_echo($prv_proveedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvProveedorUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $prv_proveedor_us_usuario->getFiltrosArrXCampo('PrvProveedor', 'prv_proveedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvProveedorUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_proveedor->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('gral_escenario.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_escenario.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_escenario.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_escenario.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = GralEscenario::getGralEscenarios($p, $c);

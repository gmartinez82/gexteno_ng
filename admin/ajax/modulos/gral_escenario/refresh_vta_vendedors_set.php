...
$c->add('vta_vendedor_gral_escenario.gral_escenario_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_vendedor');
$c->addRealJoin('vta_vendedor_gral_escenario', 'vta_vendedor_gral_escenario.vta_vendedor_id', 'vta_vendedor.id', 'LEFT JOIN');

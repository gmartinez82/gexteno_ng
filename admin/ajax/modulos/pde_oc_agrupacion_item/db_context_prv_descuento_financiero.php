...
$prv_descuento_financiero = $pde_oc_agrupacion_item->getPrvDescuentoFinanciero();
...
<div class="datos" id="<?php Gral::_echo($prv_descuento_financiero->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcAgrupacionItem::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_agrupacion_item->getFiltrosArrXCampo('PrvDescuentoFinanciero', 'prv_descuento_financiero_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcAgrupacionItems') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_descuento_financiero->getDescripcion()) ?></strong>
        </a>
    </div>

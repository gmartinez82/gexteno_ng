...
$pde_oc_agrupacion = $pde_oc_agrupacion_item->getPdeOcAgrupacion();
...
<div class="datos" id="<?php Gral::_echo($pde_oc_agrupacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOcAgrupacionItem::getFiltrosArrGral() ?>&arr=<?php echo $pde_oc_agrupacion_item->getFiltrosArrXCampo('PdeOcAgrupacion', 'pde_oc_agrupacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOcAgrupacionItems') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_oc_agrupacion->getDescripcion()) ?></strong>
        </a>
    </div>

...
$gen_api_proyecto = $gen_prca_ejecucion->getGenApiProyecto();
...
<div class="datos" id="<?php Gral::_echo($gen_api_proyecto->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GenPrcaEjecucion::getFiltrosArrGral() ?>&arr=<?php echo $gen_prca_ejecucion->getFiltrosArrXCampo('GenApiProyecto', 'gen_api_proyecto_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GenPrcaEjecucions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gen_api_proyecto->getDescripcion()) ?></strong>
        </a>
    </div>

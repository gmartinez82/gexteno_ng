...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.id', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_id'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_id_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.descripcion', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_descripcion'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_descripcion_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.pde_orden_pago_id', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_pde_orden_pago_id'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_pde_orden_pago_id_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.gral_fp_forma_pago_id', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_gral_fp_forma_pago_id'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_gral_fp_forma_pago_id_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.importe_afectado', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_importe_afectado'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_importe_afectado_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.codigo', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_codigo'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_codigo_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.observacion', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_observacion'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_observacion_comparador'));
	$criterio->add('pde_orden_pago_gral_fp_forma_pago.estado', Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_estado'), Gral::getVars(1, 'buscador_pde_orden_pago_gral_fp_forma_pago_estado_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('pde_orden_pago_gral_fp_forma_pago_cheque', 'pde_orden_pago_gral_fp_forma_pago_cheque.pde_orden_pago_gral_fp_forma_pago_id', 'pde_orden_pago_gral_fp_forma_pago.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('fnd_chq_cheque', 'fnd_chq_cheque.pde_orden_pago_gral_fp_forma_pago_id', 'pde_orden_pago_gral_fp_forma_pago.id', 'LEFT JOIN');

...
$vta_nota_debito = $afip_citi_ventas_cbte->getVtaNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($vta_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiVentasCbte::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_ventas_cbte->getFiltrosArrXCampo('VtaNotaDebito', 'vta_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiVentasCbtes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

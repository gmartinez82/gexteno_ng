...
$cli_cliente = $gral_sucursal_valoracion_agrupacion->getCliCliente();
...
<div class="datos" id="<?php Gral::_echo($cli_cliente->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalValoracionAgrupacion::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_valoracion_agrupacion->getFiltrosArrXCampo('CliCliente', 'cli_cliente_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalValoracionAgrupacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($cli_cliente->getDescripcion()) ?></strong>
        </a>
    </div>

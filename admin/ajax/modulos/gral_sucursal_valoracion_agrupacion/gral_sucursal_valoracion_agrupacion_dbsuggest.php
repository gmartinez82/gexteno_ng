...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_valoracion_agrupacion.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_valoracion_agrupacion.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_agrupacion.apellido', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_agrupacion.nombre', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_valoracion_agrupacion.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_valoracion_agrupacion');
$c->addOrden('gral_sucursal_valoracion_agrupacion.orden', 'asc');
$c->setCriterios();

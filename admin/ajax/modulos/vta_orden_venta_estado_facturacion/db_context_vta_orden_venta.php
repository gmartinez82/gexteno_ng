...
$vta_orden_venta = $vta_orden_venta_estado_facturacion->getVtaOrdenVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_orden_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaOrdenVentaEstadoFacturacion::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta_estado_facturacion->getFiltrosArrXCampo('VtaOrdenVenta', 'vta_orden_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaOrdenVentaEstadoFacturacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_orden_venta->getDescripcion()) ?></strong>
        </a>
    </div>

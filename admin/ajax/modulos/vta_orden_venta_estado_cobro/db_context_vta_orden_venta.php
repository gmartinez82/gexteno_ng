...
$vta_orden_venta = $vta_orden_venta_estado_cobro->getVtaOrdenVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_orden_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaOrdenVentaEstadoCobro::getFiltrosArrGral() ?>&arr=<?php echo $vta_orden_venta_estado_cobro->getFiltrosArrXCampo('VtaOrdenVenta', 'vta_orden_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaOrdenVentaEstadoCobros') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_orden_venta->getDescripcion()) ?></strong>
        </a>
    </div>

...
$gral_sucursal_us_usuario_id = Gral::getVars(2, 'gral_sucursal_us_usuario_id');
$gral_sucursal_us_usuario = GralSucursalUsUsuario::getOxId($gral_sucursal_us_usuario_id);
$gral_sucursal = $gral_sucursal_us_usuario->getGralSucursal();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralSucursalUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal_us_usuario->getFiltrosArrXCampo('GralSucursal', 'gral_sucursal_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralSucursalUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal->getDescripcion()) ?></strong>
        </a>
    </div>

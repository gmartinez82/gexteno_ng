...
$prv_importacion = $prv_importacion_estado->getPrvImportacion();
...
<div class="datos" id="<?php Gral::_echo($prv_importacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvImportacionEstado::getFiltrosArrGral() ?>&arr=<?php echo $prv_importacion_estado->getFiltrosArrXCampo('PrvImportacion', 'prv_importacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvImportacionEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_importacion->getDescripcion()) ?></strong>
        </a>
    </div>

...
$vta_politica_descuento_ins_insumo_id = Gral::getVars(2, 'vta_politica_descuento_ins_insumo_id');
$vta_politica_descuento_ins_insumo = VtaPoliticaDescuentoInsInsumo::getOxId($vta_politica_descuento_ins_insumo_id);
$vta_politica_descuento = $vta_politica_descuento_ins_insumo->getVtaPoliticaDescuento();
...
<div class="datos" id="<?php Gral::_echo($vta_politica_descuento->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPoliticaDescuentoInsInsumo::getFiltrosArrGral() ?>&arr=<?php echo $vta_politica_descuento_ins_insumo->getFiltrosArrXCampo('VtaPoliticaDescuento', 'vta_politica_descuento_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPoliticaDescuentoInsInsumos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_politica_descuento->getDescripcion()) ?></strong>
        </a>
    </div>

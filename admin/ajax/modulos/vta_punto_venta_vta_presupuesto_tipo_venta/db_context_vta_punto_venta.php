...
$vta_punto_venta = $vta_punto_venta_vta_presupuesto_tipo_venta->getVtaPuntoVenta();
...
<div class="datos" id="<?php Gral::_echo($vta_punto_venta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaPuntoVentaVtaPresupuestoTipoVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_punto_venta_vta_presupuesto_tipo_venta->getFiltrosArrXCampo('VtaPuntoVenta', 'vta_punto_venta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaPuntoVentaVtaPresupuestoTipoVentas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_punto_venta->getDescripcion()) ?></strong>
        </a>
    </div>

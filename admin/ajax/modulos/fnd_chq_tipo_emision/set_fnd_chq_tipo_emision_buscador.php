...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('fnd_chq_tipo_emision.id', Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_id'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_id_comparador'));
	$criterio->add('fnd_chq_tipo_emision.descripcion', Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_descripcion'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_descripcion_comparador'));
	$criterio->add('fnd_chq_tipo_emision.codigo', Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_codigo'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_codigo_comparador'));
	$criterio->add('fnd_chq_tipo_emision.observacion', Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_observacion'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emision_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('fnd_chq_cheque', 'fnd_chq_cheque.fnd_chq_tipo_emision_id', 'fnd_chq_tipo_emision.id', 'LEFT JOIN');

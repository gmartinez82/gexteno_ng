...
$pde_recepcion_tipo_estado_facturacion = $pde_recepcion_estado_facturacion->getPdeRecepcionTipoEstadoFacturacion();
...
<div class="datos" id="<?php Gral::_echo($pde_recepcion_tipo_estado_facturacion->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeRecepcionEstadoFacturacion::getFiltrosArrGral() ?>&arr=<?php echo $pde_recepcion_estado_facturacion->getFiltrosArrXCampo('PdeRecepcionTipoEstadoFacturacion', 'pde_recepcion_tipo_estado_facturacion_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeRecepcionEstadoFacturacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_recepcion_tipo_estado_facturacion->getDescripcion()) ?></strong>
        </a>
    </div>

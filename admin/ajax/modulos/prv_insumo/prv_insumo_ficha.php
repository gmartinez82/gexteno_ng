...
<div class='ficha'>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_insumo->getFechaActualizacion())) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('Referencial') ?></div>
        <div class='dato'><?php Gral::_echo(GralSiNo::getOxId($prv_insumo->getReferencial())->getDescripcion()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('Claves') ?></div>
        <div class='dato'><?php Gral::_echo($prv_insumo->getClaves()) ?></div>
    </div>

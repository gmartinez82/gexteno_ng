...
<table border='0' align='center' class='listado' id='listado_adm_prv_insumo'>
  ...
  <tr>
	...
	<td width='70' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=referencial&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('Referencial') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='referencial'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id='tr_eliminar_<?php Gral::_echo($prv_insumo->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($prv_insumo->getId()) ?>" >
	<td colspan='13' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($prv_insumo->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />

...
$gral_condicion_iva = $eku_param_tipo_naturaleza_receptor_gral_condicion_iva->getGralCondicionIva();
...
<div class="datos" id="<?php Gral::_echo($gral_condicion_iva->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuParamTipoNaturalezaReceptorGralCondicionIva::getFiltrosArrGral() ?>&arr=<?php echo $eku_param_tipo_naturaleza_receptor_gral_condicion_iva->getFiltrosArrXCampo('GralCondicionIva', 'gral_condicion_iva_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuParamTipoNaturalezaReceptorGralCondicionIvas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_condicion_iva->getDescripcion()) ?></strong>
        </a>
    </div>

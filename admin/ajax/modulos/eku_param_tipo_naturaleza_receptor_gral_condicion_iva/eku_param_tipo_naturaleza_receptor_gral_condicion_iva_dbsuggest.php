...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_naturaleza_receptor_gral_condicion_iva.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_naturaleza_receptor_gral_condicion_iva');
$c->addOrden('eku_param_tipo_naturaleza_receptor_gral_condicion_iva.orden', 'asc');
$c->setCriterios();

...
if($buscar != '...'){
    ...
    $c->add('geo_pais.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('geo_pais.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_pais.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('geo_pais.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

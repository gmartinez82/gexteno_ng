...
//$arr_vta_recibo_retencion_infos = Gral::getSes('vta_recibo_descuento_financiero_retencion_info');
...
<form id='form_set_retencion_info' name='form_set_retencion_info' method='post' action='' key="<?php echo $key ?>">

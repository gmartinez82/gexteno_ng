...
foreach ($vta_factura_vta_nota_creditos as $vta_factura_vta_nota_credito) {
    ...
    $vta_nota_credito_vta_factura_vta_orden_ventas = $vta_nota_credito->getVtaNotaCreditoVtaFacturaVtaOrdenVentas();
    ...
    <?php if (count($vta_nota_credito_vta_factura_vta_orden_ventas) > 0) { ?>
        <table border="0" class="tabla-modal">
            ...
            foreach ($vta_nota_credito_vta_factura_vta_orden_ventas as $vta_nota_credito_vta_factura_vta_orden_venta) {
                ...
                $ins_insumo = $vta_nota_credito_vta_factura_vta_orden_venta->getInsInsumo();
                $ins_unidad_medida = $vta_nota_credito_vta_factura_vta_orden_venta->getInsUnidadMedida();
                ?>
                <tr>
                    ...
                    <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                        <div class="cantidad">
                            <?php $cantidad = $vta_nota_credito_vta_factura_vta_orden_venta->getCantidad(); ?>
                    ...
                    <td align='right' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                        <div class="importe-unitario">
                            <?php $importe_unitario = $vta_nota_credito_vta_factura_vta_orden_venta->getImporteUnitario(); ?>

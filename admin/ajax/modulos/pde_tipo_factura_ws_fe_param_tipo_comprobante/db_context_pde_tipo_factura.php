...
$pde_tipo_factura = $pde_tipo_factura_ws_fe_param_tipo_comprobante->getPdeTipoFactura();
...
<div class="datos" id="<?php Gral::_echo($pde_tipo_factura->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeTipoFacturaWsFeParamTipoComprobante::getFiltrosArrGral() ?>&arr=<?php echo $pde_tipo_factura_ws_fe_param_tipo_comprobante->getFiltrosArrXCampo('PdeTipoFactura', 'pde_tipo_factura_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeTipoFacturaWsFeParamTipoComprobantes') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_tipo_factura->getDescripcion()) ?></strong>
        </a>
    </div>

...
$alt_control_us_usuario_id = Gral::getVars(2, 'alt_control_us_usuario_id');
$alt_control_us_usuario = AltControlUsUsuario::getOxId($alt_control_us_usuario_id);
$alt_control = $alt_control_us_usuario->getAltControl();
...
<div class="datos" id="<?php Gral::_echo($alt_control->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AltControlUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $alt_control_us_usuario->getFiltrosArrXCampo('AltControl', 'alt_control_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AltControlUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($alt_control->getDescripcion()) ?></strong>
        </a>
    </div>

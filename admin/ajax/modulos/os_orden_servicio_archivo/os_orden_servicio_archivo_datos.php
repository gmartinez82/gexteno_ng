...
<?php //include Gral::getPathAbs().'admin/parciales/buscadores/activos/os_orden_servicio_archivo.php' ?>

<?php if(count($os_orden_servicio_archivos) > 0){ ?>

<table border='0' align='center' class='listado' id='listado_adm_os_orden_servicio_archivo'>
    <thead>
    <tr>
  ...
  ?>
    ...
    <tr id="tr_os_orden_servicio_archivo_uno_<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>" class="uno tr_datos" identificador="<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>" hash="<?php Gral::_echo($os_orden_servicio_archivo->getHash()) ?>" >
  	<?php include "os_orden_servicio_archivo_uno.php" ?>
    </tr>
  
  
    <tr id='tr_eliminar_<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>" hash="<?php Gral::_echo($os_orden_servicio_archivo->getHash()) ?>" >
	<td colspan='9' align='center' class='adm_tbl_lineas'>
            
            <div id='div_eliminar_<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>'  class='div_eliminar warning'>
                ...
                <div class="eliminar-mensaje">
                    <?php Lang::_lang('Esta a punto de eliminar') ?> "<strong><?php Gral::_echo($os_orden_servicio_archivo->getDescripcion()) ?></strong>".<br />
                ...
                <div class="eliminar-botonera">
                      ...
                      <input name='btn_elim_cancelar' type='button' id='btn_elim_cancelar' value='<?php Lang::_lang('Cancelar') ?>'  class='btn_mensaje_cancelar' onclick='eliminar_conf(<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>,0)'/>
                </div>
            </div>
...
if(trim($id) == $os_orden_servicio_archivo->getId()){ 
	$mi_display = '';
	$mi_hash = "location.hash = 'mi_".$id."';"; 
}
?>
    <tr id='tr_mi_<?php Gral::_echo($os_orden_servicio_archivo->getId()) ?>' <?php Gral::_echo($mi_display) ?>>
	<td colspan='9' align='center' class='adm_tbl_lineas'>
	...
	<div class="masinfo">
		<?php 
		if(trim($id) == $os_orden_servicio_archivo->getId()){ 
			include "os_orden_servicio_archivo_adm_masinfo.php";
		}
		?>
	</div>

...
if($buscar != '...'){
    ...
    $c->add('os_orden_servicio_archivo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_orden_servicio_archivo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio_archivo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_orden_servicio_archivo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_orden_servicio_archivo');
$c->addOrden('os_orden_servicio_archivo.orden', 'asc');
$c->setCriterios();

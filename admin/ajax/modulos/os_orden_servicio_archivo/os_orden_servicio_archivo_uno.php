...
<div class="descripcion"><a href="<?php echo Gral::getPath('path_http') ?>archivos/archivos/os_orden_servicio_archivo/<?php Gral::_echo($archivo->getArchivo()) ?>" target="_blank"><?php Gral::_echo($archivo->getDescripcion()) ?></a></div>
<?php }else{ ?>
<div class="sin-valor"><?php Lang::_lang('Agregue una descripcion al archivo') ?></div>
<?php } ?>

<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/os_orden_servicio_archivo/os_orden_servicio_archivo_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/os_orden_servicio_archivo/os_orden_servicio_archivo_uno_masinfo.php"; 
}
?>
...
<div class="acciones">
    ...
    <div class="accion boton ver" title="Ver Archivo">
        <a href="<?php echo Gral::getPath('path_http') ?>archivos/archivos/os_orden_servicio_archivo/<?php Gral::_echo($archivo->getArchivo()) ?>" target="_blank">

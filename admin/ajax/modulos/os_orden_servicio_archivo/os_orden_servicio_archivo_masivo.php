<div id="container" class="masivo-bloque">
    ...
    <a id="refresh" class="masivo-botones" href="?id=<?php echo $os_orden_servicio->getId() ?>">Actualizar Pagina</a>
</div>
...
var uploader = new plupload.Uploader({
    ...
    container: 'container',
    max_file_size : '10mb',
    url : 'ajax/archivos/upload_masivo.php?padre=<?php echo $os_orden_servicio->getId() ?>&clase=OsOrdenServicio',

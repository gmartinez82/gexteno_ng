...
$pde_pedido_destinatario_id = Gral::getVars(2, 'pde_pedido_destinatario_id');
$pde_pedido_destinatario = PdePedidoDestinatario::getOxId($pde_pedido_destinatario_id);
$us_usuario = $pde_pedido_destinatario->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdePedidoDestinatario::getFiltrosArrGral() ?>&arr=<?php echo $pde_pedido_destinatario->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdePedidoDestinatarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

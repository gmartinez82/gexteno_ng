...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?> <?php echo $destacado ?> <?php echo $principal ?>'>
    <div class="vermasinfo" identificador="<?php echo $vta_vendedor_descuento->getId() ?>" modulo="vta_vendedor_descuento">+</div>
</td>
...
<td align='left' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?> <?php echo $destacado ?> <?php echo $principal ?>'>
    ...
    <?php if (count($vta_vendedor_descuento->getArrDescripcionExtendidaParaBackend()) > 0) { ?>
        <div class="descripcion-extendida">
            <?php foreach ($vta_vendedor_descuento->getArrDescripcionExtendidaParaBackend() as $i => $arr_descripcion_extendida) { ?>
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?> <?php echo $destacado ?> <?php echo $principal ?>'>
    ...
    <div class="vta_vendedor_id <?php Gral::_echo($vta_vendedor_descuento->getVtaVendedor()->getCodigo()) ?> ">	
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?> <?php echo $destacado ?> <?php echo $principal ?>'>
    ...
    <div class="ins_etiqueta_id <?php Gral::_echo($vta_vendedor_descuento->getInsEtiqueta()->getCodigo()) ?> ">	
...
<td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?> <?php echo $destacado ?> <?php echo $principal ?>'>
	...
	<?php } ?>
        ...
        <?php if (UsCredencial::getEsAcreditado('VTA_VENDEDOR_DESCUENTO_ADM_ACCION_CONFIG')) { ?>
        <li class='adm_botones_accion db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/modulos/vta_vendedor_descuento/vta_vendedor_descuento_db_context_acciones.php?id=<?php Gral::_echo($vta_vendedor_descuento->getId()) ?>' modulo_metodo_init="setInitVtaVendedorDescuento()">

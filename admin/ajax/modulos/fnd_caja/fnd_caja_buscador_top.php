<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/fnd_caja/set_fnd_caja_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='fnd_caja_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('FndCaja') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

...
<div class='ficha'>
    ...
    <div class='par impar'>
        ...
        <div class='dato'><?php Gral::_echo($fnd_caja->getGralCaja()->getDescripcion()) ?></div>
    </div>
    ...
    <div class='par '>
        ...
        <div class='dato'><?php Gral::_echo($fnd_caja->getImporteSaldoInicialEsperado()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('Importe') ?></div>
        <div class='dato'><?php Gral::_echo($fnd_caja->getImporteSaldoInicialReal()) ?></div>
    </div>
		
    <div class='par '>
        <div class='label'><?php Lang::_lang('Importe') ?></div>
        <div class='dato'><?php Gral::_echo($fnd_caja->getImporteSaldoInicialDiferencia()) ?></div>
    </div>
		
    <div class='par impar'>
        <div class='label'><?php Lang::_lang('Importe') ?></div>
        <div class='dato'><?php Gral::_echo($fnd_caja->getImporteSaldoFinal()) ?></div>
    </div>

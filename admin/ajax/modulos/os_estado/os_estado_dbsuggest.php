...
if($buscar != '...'){
    ...
    $c->add('os_estado.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_estado.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_estado.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_estado.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_estado');
$c->addOrden('os_estado.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = OsEstado::getOsEstados($p, $c);

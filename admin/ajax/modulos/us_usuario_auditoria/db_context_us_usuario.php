...
$us_usuario_auditoria_id = Gral::getVars(2, 'us_usuario_auditoria_id');
$us_usuario_auditoria = UsUsuarioAuditoria::getOxId($us_usuario_auditoria_id);
$us_usuario = $us_usuario_auditoria->getUsUsuario();
...
<div class="datos" id="<?php Gral::_echo($us_usuario->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo UsUsuarioAuditoria::getFiltrosArrGral() ?>&arr=<?php echo $us_usuario_auditoria->getFiltrosArrXCampo('UsUsuario', 'us_usuario_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('UsUsuarioAuditorias') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($us_usuario->getDescripcion()) ?></strong>
        </a>
    </div>

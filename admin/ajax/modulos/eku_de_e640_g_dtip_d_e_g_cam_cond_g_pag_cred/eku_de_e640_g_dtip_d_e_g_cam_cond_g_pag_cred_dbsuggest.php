...
if($buscar != '...'){
    ...
    $c->add('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred');
$c->addOrden('eku_de_e640_g_dtip_d_e_g_cam_cond_g_pag_cred.orden', 'asc');
$c->setCriterios();

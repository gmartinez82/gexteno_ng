...
<div class='list <?php echo $css_sel ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('INS_ATRIBUTO_ALTA_RELACION_INS_INSUMO_ACCIONES_SELECCION')){ ?>	

...
$chk_despachars           = Gral::getVars(Gral::VARS_POST, 'chk_despachar', null);
...
if (!$arr["error"])
{
    ...
    foreach ($chk_despachars as $key => $pdi_pedido_id)
    {
    ...
    $pdi_pedido_agrupacion->addPdiPedidoDespacharAgrupacion($arr_items, $txa_observacion);
}

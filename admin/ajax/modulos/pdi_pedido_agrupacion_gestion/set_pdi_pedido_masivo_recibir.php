...
$chk_recibirs             = Gral::getVars(Gral::VARS_POST, 'chk_recibir', null);
...
if (!$arr["error"])
{
    ...
    foreach ($chk_recibirs as $key => $pdi_pedido_id)
    {
    ...
    $pdi_pedido_agrupacion->addPdiPedidoRecibirAgrupacion($arr_items, $txa_observacion);
}

...
<form id='form_div_modal' name='form_div_modal' method='post' >
    <div class="datos-masivo despachar-masivo" pdi_pedido_agrupacion_id="<?php echo ($pdi_pedido_agrupacion) ? $pdi_pedido_agrupacion->getId() : 0 ?>" >
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width='30' align='center'>
                                <div class="checkbox">
                                    <input type="checkbox" class="textbox chk_despachar_all" id="chk_despachar_all" name="chk_despachar_all" value="1" />
                                </div>
                            </th>
                            ...
                            <tr class="tr-item uno" id="tr_item_<?php echo $key ?>" key = "<?php echo $key ?>" pdi_pedido_id="<?php echo $pdi_pedido_id ?>">
                                ...
                                <td align="center">
                                    <?php if ($txt_cantidad_solicitado > 0) { ?>
                                        <div class="checkbox">
                                            <?php if ($pdi_tipo_estado->getCodigo() == PdiTipoEstado::TIPO_ESTADO_ACEPTADO) { ?>
                                                <input type="checkbox" class="textbox chk_despachar" id="chk_despachar_<?php echo $key ?>" name="chk_despachar[<?php echo $key ?>]" value="<?php echo $arr_pdi_pedidos[$key] ?>" />
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
                                </td>
                                ...
                                <td align="center">
                                    <div class="stock stock-destino">
                                        <?php Gral::_echo(($ins_stock_resumen_destino) ? $ins_stock_resumen_destino->getCantidadReal() : 'N/I') ?>
                                    </div>
                                </td>
        ...
        <div class="botonera">
            ...
            <input id='btn_generar_despacho_masivo' name='btn_generar_despacho_masivo' class="boton" type='button'  value='<?php Lang::_lang('Generar Despacho Masivo'); ?>' />
        </div>
    </div>
</form>
<script>

<form id="form_buscador_top" name="form_buscador_top" method="post" action="ajax/modulos/cntb_diario_asiento/set_cntb_diario_asiento_buscador_top.php">
    ...
    <div class="col">
        ...
        <a class="boton" href='cntb_diario_asiento_alta.php' title='<?php Lang::_lang('Agregar') ?> <?php Lang::_lang('CntbDiarioAsiento') ?>'><img src="imgs/btn_add.gif" width="25"></a>
        <?php } ?>

        <label class="boton ver_buscador" title="<?php Lang::_lang('Busqueda Avanzada') ?>" modulo='cntb_diario_asiento'><img src="imgs/btn_lupa.png" width="25"></label>

...
<table border='0' align='center' class='listado' id='listado_adm_cntb_diario_asiento'>
  ...
  <tr>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=cntb_ejercicio_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('CntbEjercicio') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='cntb_ejercicio_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=cntb_tipo_asiento_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('CntbTipoAsiento') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='cntb_tipo_asiento_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=cntb_tipo_origen_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('CntbTipoOrigen') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='cntb_tipo_origen_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=cntb_tipo_movimiento_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('CntbTipoMovimiento') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='cntb_tipo_movimiento_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id="tr_cntb_diario_asiento_uno_<?php Gral::_echo($cntb_diario_asiento->getId()) ?>" class="uno" identificador="<?php Gral::_echo($cntb_diario_asiento->getId()) ?>">
  	<?php include "cntb_diario_asiento_uno.php" ?>
  </tr>
  ...
  <tr id='tr_eliminar_<?php Gral::_echo($cntb_diario_asiento->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($cntb_diario_asiento->getId()) ?>" >
	<td colspan='12' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($cntb_diario_asiento->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />

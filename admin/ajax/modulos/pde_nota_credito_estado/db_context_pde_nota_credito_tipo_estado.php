...
$pde_nota_credito_estado_id = Gral::getVars(2, 'pde_nota_credito_estado_id');
$pde_nota_credito_estado = PdeNotaCreditoEstado::getOxId($pde_nota_credito_estado_id);
$pde_nota_credito_tipo_estado = $pde_nota_credito_estado->getPdeNotaCreditoTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_credito_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaCreditoEstado::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_credito_estado->getFiltrosArrXCampo('PdeNotaCreditoTipoEstado', 'pde_nota_credito_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaCreditoEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_credito_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

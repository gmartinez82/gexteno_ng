...
<tr class='tr-item' key='<?php echo $key ?>'>
    ...
    <td>
        <label class='boton quitar_fnd_caja_movimiento_item' title='<?php Lang::_lang('Quitar Item al Movimiento'); ?>' key='<?php echo $key ?>'><img src='imgs/btn_cancelar.png' width='15'></label>
    </td>
</tr>
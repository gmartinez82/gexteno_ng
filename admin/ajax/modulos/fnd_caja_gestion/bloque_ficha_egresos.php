<table border="0" class="tabla-modal egresos">
    ...
    foreach ($fnd_caja_egresos as $fnd_caja_egreso) {
        ...
        ?>
        <tr id="tr_pde_orden_pago_pde_comprobante_gestion_uno_<?php echo $fnd_caja_egreso->getId() ?>" class="uno" identificador="<?php echo $fnd_caja_egreso->getId() ?>">
            ...
            <td class="adm_tbl_lineas <?php echo $css_bg ?>" align="center">
                <label class="fecha-emision">
                    <?php Gral::_echo(Gral::getFechaToWEB($fnd_caja_egreso->getCreado())) ?>
                </label>
            </td>   
            ...
            <td class="adm_tbl_lineas <?php echo $css_bg ?>" align="center">
                <label class="creado">
                    <?php Gral::_echo(Gral::getFechaHoraToWEB($fnd_caja_egreso->getCreado())) ?>
                </label>
            </td>   

            <td class="adm_tbl_lineas <?php echo $css_bg ?>" align="center">
                <label class="creado-por">
                    <?php Gral::_echo($fnd_caja_egreso->getCreadoPorDescripcion()) ?>
                </label>
            </td>   

            <td class="adm_tbl_lineas <?php echo $css_bg ?>" align="center">
                <?php if (UsCredencial::getEsAcreditado('FND_CAJA_GESTION_ACCION_FICHA_EGRESOS_MODIFICAR')) { ?>

...
$pde_nota_credito = $afip_citi_compras_alicuotas->getPdeNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AfipCitiComprasAlicuotas::getFiltrosArrGral() ?>&arr=<?php echo $afip_citi_compras_alicuotas->getFiltrosArrXCampo('PdeNotaCredito', 'pde_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AfipCitiComprasAlicuotass') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

...
if(in_array($pan_panol_relacionado->getId(), $o_ids)){
    ...
    $array = array(
        array('campo' => 'ins_clasificacion_id', 'valor' => $o_padre->getId()),
...
<div class='list <?php echo $css_sel ?>' title='<?php echo $pan_panol_relacionado->getObservacion() ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('INS_CLASIFICACION_ALTA_RELACION_PAN_PANOL_ACCIONES_SELECCION')){ ?>	

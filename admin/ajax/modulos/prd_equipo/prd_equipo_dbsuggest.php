...
if($buscar != '...'){
    ...
    $c->add('prd_equipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_equipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_equipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_equipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}
...
$os = PrdEquipo::getPrdEquipos($p, $c);

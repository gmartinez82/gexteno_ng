...
$criterio->add('prd_equipo.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
$criterio->add('prd_equipo.descripcion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('prd_equipo.descripcion_corta', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
...
$criterio->add('prd_equipo.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

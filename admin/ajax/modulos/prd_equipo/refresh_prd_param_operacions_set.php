...
$c->add('prd_param_operacion_prd_equipo.prd_equipo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('prd_param_operacion');
$c->addRealJoin('prd_param_operacion_prd_equipo', 'prd_param_operacion_prd_equipo.prd_param_operacion_id', 'prd_param_operacion.id', 'LEFT JOIN');

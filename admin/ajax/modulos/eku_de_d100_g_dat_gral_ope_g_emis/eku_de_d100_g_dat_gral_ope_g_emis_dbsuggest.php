...
if($buscar != '...'){
    ...
    $c->add('eku_de_d100_g_dat_gral_ope_g_emis.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_d100_g_dat_gral_ope_g_emis.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d100_g_dat_gral_ope_g_emis.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_d100_g_dat_gral_ope_g_emis.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_d100_g_dat_gral_ope_g_emis');
$c->addOrden('eku_de_d100_g_dat_gral_ope_g_emis.orden', 'asc');
$c->setCriterios();

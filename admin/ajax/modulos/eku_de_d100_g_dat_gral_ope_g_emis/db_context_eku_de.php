...
$eku_de_d100_g_dat_gral_ope_g_emis_id = Gral::getVars(2, 'eku_de_d100_g_dat_gral_ope_g_emis_id');
$eku_de_d100_g_dat_gral_ope_g_emis = EkuDeD100GDatGralOpeGEmis::getOxId($eku_de_d100_g_dat_gral_ope_g_emis_id);
$eku_de = $eku_de_d100_g_dat_gral_ope_g_emis->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeD100GDatGralOpeGEmis::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_d100_g_dat_gral_ope_g_emis->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeD100GDatGralOpeGEmiss') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

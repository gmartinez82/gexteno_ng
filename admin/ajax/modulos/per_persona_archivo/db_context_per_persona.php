...
$per_persona = $per_persona_archivo->getPerPersona();
...
<div class="datos" id="<?php Gral::_echo($per_persona->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PerPersonaArchivo::getFiltrosArrGral() ?>&arr=<?php echo $per_persona_archivo->getFiltrosArrXCampo('PerPersona', 'per_persona_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PerPersonaArchivos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($per_persona->getDescripcion()) ?></strong>
        </a>
    </div>

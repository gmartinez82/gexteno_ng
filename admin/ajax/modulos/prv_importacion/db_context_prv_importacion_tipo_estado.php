...
$prv_importacion_tipo_estado = $prv_importacion->getPrvImportacionTipoEstado();
...
<div class="datos" id="<?php Gral::_echo($prv_importacion_tipo_estado->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PrvImportacion::getFiltrosArrGral() ?>&arr=<?php echo $prv_importacion->getFiltrosArrXCampo('PrvImportacionTipoEstado', 'prv_importacion_tipo_estado_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PrvImportacions') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($prv_importacion_tipo_estado->getDescripcion()) ?></strong>
        </a>
    </div>

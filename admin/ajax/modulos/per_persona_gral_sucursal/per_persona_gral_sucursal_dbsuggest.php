...
if($buscar != '...'){
    ...
    $c->add('per_persona_gral_sucursal.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('per_persona_gral_sucursal.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('per_persona_gral_sucursal');
$c->addOrden('per_persona_gral_sucursal.orden', 'asc');
$c->setCriterios();

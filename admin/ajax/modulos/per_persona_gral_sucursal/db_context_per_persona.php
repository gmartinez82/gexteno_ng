...
$per_persona = $per_persona_gral_sucursal->getPerPersona();
...
<div class="datos" id="<?php Gral::_echo($per_persona->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PerPersonaGralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $per_persona_gral_sucursal->getFiltrosArrXCampo('PerPersona', 'per_persona_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PerPersonaGralSucursals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($per_persona->getDescripcion()) ?></strong>
        </a>
    </div>

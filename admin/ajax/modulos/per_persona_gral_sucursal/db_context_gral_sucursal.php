...
$per_persona_gral_sucursal_id = Gral::getVars(2, 'per_persona_gral_sucursal_id');
$per_persona_gral_sucursal = PerPersonaGralSucursal::getOxId($per_persona_gral_sucursal_id);
$gral_sucursal = $per_persona_gral_sucursal->getGralSucursal();
...
<div class="datos" id="<?php Gral::_echo($gral_sucursal->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PerPersonaGralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $per_persona_gral_sucursal->getFiltrosArrXCampo('GralSucursal', 'gral_sucursal_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PerPersonaGralSucursals') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_sucursal->getDescripcion()) ?></strong>
        </a>
    </div>

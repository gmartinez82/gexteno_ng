...
$criterio->add('per_tipo_estado.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('per_tipo_estado.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('per_tipo_estado.activo', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

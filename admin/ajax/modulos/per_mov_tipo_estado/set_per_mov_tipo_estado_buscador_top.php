...
$criterio->add('per_mov_tipo_estado.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('per_mov_tipo_estado.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

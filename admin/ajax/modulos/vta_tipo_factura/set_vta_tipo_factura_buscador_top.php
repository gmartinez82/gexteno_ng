...
$criterio->add('vta_tipo_factura.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('vta_tipo_factura.codigo_min', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('vta_tipo_factura.informa', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);

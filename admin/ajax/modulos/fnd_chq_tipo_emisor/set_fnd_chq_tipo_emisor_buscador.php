...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('fnd_chq_tipo_emisor.id', Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_id'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_id_comparador'));
	$criterio->add('fnd_chq_tipo_emisor.descripcion', Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_descripcion'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_descripcion_comparador'));
	$criterio->add('fnd_chq_tipo_emisor.codigo', Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_codigo'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_codigo_comparador'));
	$criterio->add('fnd_chq_tipo_emisor.observacion', Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_observacion'), Gral::getVars(1, 'buscador_fnd_chq_tipo_emisor_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('fnd_chq_cheque', 'fnd_chq_cheque.fnd_chq_tipo_emisor_id', 'fnd_chq_tipo_emisor.id', 'LEFT JOIN');
	...
	$criterio->addRealJoin('fnd_chq_tipo_emisor_fnd_chq_tipo_estado', 'fnd_chq_tipo_emisor_fnd_chq_tipo_estado.fnd_chq_tipo_emisor_id', 'fnd_chq_tipo_emisor.id', 'LEFT JOIN');

	...
	<div class='relacion geo_localidad' clase='geo_localidad' padre='gral_ruta' padre_clase='GralRuta' relacion='GralRutaGeoLocalidad'>

	<div class='titulo'>
            <label class="titulo-entidad-vinculada"><?php Lang::_lang('GeoLocalidads') ?></label>
            <label class="titulo-entidad-cantidad">            
                <?php 
                $cantidad_geo_localidads = $gral_ruta->getCantidadGeoLocalidadsXGralRutaGeoLocalidad();
                echo ($cantidad_geo_localidads > 0) ? '('.$cantidad_geo_localidads.')' : '' ;
                ?>
            </label>
            <div class="titulo-entidad-comentarios">
                <?php Lang::_lang('comentario_gral_ruta_alta_relacion_gral_ruta_geo_localidad_titulo_comentarios', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?>
            </div>
	</div>

...
$o_ids = eval('return $o_padre->getGralRutaGeoLocalidadsId();');
...
$c->add('gral_ruta_geo_localidad.gral_ruta_id', $padre_id, Criterio::IGUAL);
$c->addTabla('geo_localidad');
$c->addRealJoin('gral_ruta_geo_localidad', 'gral_ruta_geo_localidad.geo_localidad_id', 'geo_localidad.id', 'LEFT JOIN');

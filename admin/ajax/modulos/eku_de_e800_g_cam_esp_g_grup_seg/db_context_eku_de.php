...
$eku_de_e800_g_cam_esp_g_grup_seg_id = Gral::getVars(2, 'eku_de_e800_g_cam_esp_g_grup_seg_id');
$eku_de_e800_g_cam_esp_g_grup_seg = EkuDeE800GCamEspGGrupSeg::getOxId($eku_de_e800_g_cam_esp_g_grup_seg_id);
$eku_de = $eku_de_e800_g_cam_esp_g_grup_seg->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE800GCamEspGGrupSeg::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e800_g_cam_esp_g_grup_seg->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE800GCamEspGGrupSegs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

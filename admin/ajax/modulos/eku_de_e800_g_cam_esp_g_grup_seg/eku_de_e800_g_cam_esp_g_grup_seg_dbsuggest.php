...
if($buscar != '...'){
    ...
    $c->add('eku_de_e800_g_cam_esp_g_grup_seg.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e800_g_cam_esp_g_grup_seg.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e800_g_cam_esp_g_grup_seg.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e800_g_cam_esp_g_grup_seg.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e800_g_cam_esp_g_grup_seg');
$c->addOrden('eku_de_e800_g_cam_esp_g_grup_seg.orden', 'asc');
$c->setCriterios();

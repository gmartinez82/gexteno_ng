...
$nov_novedad_archivo_id = Gral::getVars(2, 'nov_novedad_archivo_id');
$nov_novedad_archivo = NovNovedadArchivo::getOxId($nov_novedad_archivo_id);
$nov_novedad = $nov_novedad_archivo->getNovNovedad();
...
<div class="datos" id="<?php Gral::_echo($nov_novedad->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo NovNovedadArchivo::getFiltrosArrGral() ?>&arr=<?php echo $nov_novedad_archivo->getFiltrosArrXCampo('NovNovedad', 'nov_novedad_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('NovNovedadArchivos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($nov_novedad->getDescripcion()) ?></strong>
        </a>
    </div>

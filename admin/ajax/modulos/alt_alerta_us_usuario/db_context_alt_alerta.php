...
$alt_alerta = $alt_alerta_us_usuario->getAltAlerta();
...
<div class="datos" id="<?php Gral::_echo($alt_alerta->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo AltAlertaUsUsuario::getFiltrosArrGral() ?>&arr=<?php echo $alt_alerta_us_usuario->getFiltrosArrXCampo('AltAlerta', 'alt_alerta_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('AltAlertaUsUsuarios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($alt_alerta->getDescripcion()) ?></strong>
        </a>
    </div>

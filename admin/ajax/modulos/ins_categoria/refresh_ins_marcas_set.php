...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('ins_categoria_ins_marca.ins_categoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_marca');
$c->addRealJoin('ins_categoria_ins_marca', 'ins_categoria_ins_marca.ins_marca_id', 'ins_marca.id', 'LEFT JOIN');

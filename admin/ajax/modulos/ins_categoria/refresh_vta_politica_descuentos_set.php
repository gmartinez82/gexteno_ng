...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_politica_descuento_ins_categoria.ins_categoria_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_politica_descuento');
$c->addRealJoin('vta_politica_descuento_ins_categoria', 'vta_politica_descuento_ins_categoria.vta_politica_descuento_id', 'vta_politica_descuento.id', 'LEFT JOIN');

...
if($presionado == 'btn_buscar'){
	...
	$criterio->add('pde_tipo_origen_nota_credito.id', Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_id'), Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_id_comparador'));
	$criterio->add('pde_tipo_origen_nota_credito.descripcion', Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_descripcion'), Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_descripcion_comparador'));
	$criterio->add('pde_tipo_origen_nota_credito.codigo', Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_codigo'), Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_codigo_comparador'));
	$criterio->add('pde_tipo_origen_nota_credito.observacion', Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_observacion'), Gral::getVars(1, 'buscador_pde_tipo_origen_nota_credito_observacion_comparador'));
	
	// criterios agregados por dependencias
	
	// criterios agregados por relaciones con hijos
	$criterio->addRealJoin('pde_nota_credito', 'pde_nota_credito.pde_tipo_origen_nota_credito_id', 'pde_tipo_origen_nota_credito.id', 'LEFT JOIN');

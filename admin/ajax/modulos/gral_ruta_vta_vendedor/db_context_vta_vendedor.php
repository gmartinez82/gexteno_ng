...
$gral_ruta_vta_vendedor_id = Gral::getVars(2, 'gral_ruta_vta_vendedor_id');
$gral_ruta_vta_vendedor = GralRutaVtaVendedor::getOxId($gral_ruta_vta_vendedor_id);
$vta_vendedor = $gral_ruta_vta_vendedor->getVtaVendedor();
...
<div class="datos" id="<?php Gral::_echo($vta_vendedor->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralRutaVtaVendedor::getFiltrosArrGral() ?>&arr=<?php echo $gral_ruta_vta_vendedor->getFiltrosArrXCampo('VtaVendedor', 'vta_vendedor_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralRutaVtaVendedors') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_vendedor->getDescripcion()) ?></strong>
        </a>
    </div>

...
if($buscar != '...'){
    ...
    $c->add('gral_sucursal_tipo.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_sucursal_tipo.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_tipo.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_sucursal_tipo.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_sucursal_tipo');
$c->addOrden('gral_sucursal_tipo.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralSucursalTipo::getGralSucursalTipos($p, $c);

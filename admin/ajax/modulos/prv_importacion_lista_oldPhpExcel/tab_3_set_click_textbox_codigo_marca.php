...
//    $objWorksheet->setCellValueByColumnAndRow($col_codigo_marca, $row, $codigo);
    $objWorksheet->setCellValueExplicitByColumnAndRow($col_codigo_marca, $row, $codigo, PHPExcel_Cell_DataType::TYPE_STRING);

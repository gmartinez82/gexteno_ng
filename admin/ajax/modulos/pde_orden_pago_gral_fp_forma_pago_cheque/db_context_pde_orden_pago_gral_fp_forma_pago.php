...
$pde_orden_pago_gral_fp_forma_pago = $pde_orden_pago_gral_fp_forma_pago_cheque->getPdeOrdenPagoGralFpFormaPago();
...
<div class="datos" id="<?php Gral::_echo($pde_orden_pago_gral_fp_forma_pago->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOrdenPagoGralFpFormaPagoCheque::getFiltrosArrGral() ?>&arr=<?php echo $pde_orden_pago_gral_fp_forma_pago_cheque->getFiltrosArrXCampo('PdeOrdenPagoGralFpFormaPago', 'pde_orden_pago_gral_fp_forma_pago_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOrdenPagoGralFpFormaPagoCheques') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_orden_pago_gral_fp_forma_pago->getDescripcion()) ?></strong>
        </a>
    </div>

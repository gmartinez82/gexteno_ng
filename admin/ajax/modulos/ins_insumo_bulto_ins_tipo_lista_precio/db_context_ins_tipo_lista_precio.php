...
$ins_tipo_lista_precio = $ins_insumo_bulto_ins_tipo_lista_precio->getInsTipoListaPrecio();
...
<div class="datos" id="<?php Gral::_echo($ins_tipo_lista_precio->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsInsumoBultoInsTipoListaPrecio::getFiltrosArrGral() ?>&arr=<?php echo $ins_insumo_bulto_ins_tipo_lista_precio->getFiltrosArrXCampo('InsTipoListaPrecio', 'ins_tipo_lista_precio_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsInsumoBultoInsTipoListaPrecios') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_tipo_lista_precio->getDescripcion()) ?></strong>
        </a>
    </div>

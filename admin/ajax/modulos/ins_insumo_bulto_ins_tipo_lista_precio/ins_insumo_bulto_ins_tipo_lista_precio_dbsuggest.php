...
if($buscar != '...'){
    ...
    $c->add('ins_insumo_bulto_ins_tipo_lista_precio.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('ins_insumo_bulto_ins_tipo_lista_precio');
$c->addOrden('ins_insumo_bulto_ins_tipo_lista_precio.orden', 'asc');
$c->setCriterios();

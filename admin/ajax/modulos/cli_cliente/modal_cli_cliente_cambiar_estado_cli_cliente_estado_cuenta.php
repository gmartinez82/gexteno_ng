...
<form id='form_datos_adm_modificar_estado' name='form_datos_adm_modificar_estado' method='post' >
    <div class='datos modificar-estado' identificador="<?php echo $cli_cliente->getId() ?>" modulo="cli_cliente" modulo_estado="cli_cliente_estado_cuenta">
        ...
        <div class="par">
            ...
            <div class="dato">
                <?php Html::html_dib_select(1, 'cmb_cli_cliente_tipo_estado_cuenta_id', Gral::getCmbFiltro($cli_cliente->getCliClienteTipoEstadoCuentasPotencialesCmb(), '...'), $cmb_fnd_chq_tipo_estado_id, 'textbox') ?>
                <div class="error label-error" id="cmb_cli_cliente_tipo_estado_cuenta_id_error"><?php Gral::_echo($cli_cliente_tipo_estado_cuenta_id_error) ?></div>
            </div>
        </div>

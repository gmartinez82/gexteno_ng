...
<div class='list <?php echo $css_sel ?>'>
    ...
    <div class='segunda'>
		...
		<label class='light'><?php Lang::_lang('Automatico') ?>:</label> <label class='dato'><?php Gral::_echoConBr(GralSiNo::getOxId($gral_sucursal_cli_cliente->getAutomatico())->getDescripcion()) ?></label>

...
if(Gral::esPost()){
	...
	$cli_cliente->setCliTipoClienteId(Gral::getVars(1, "cli_cliente_cmb_cli_tipo_cliente_id", null));
	...
	$cli_cliente->setNumeroCasa(Gral::getVars(1, "cli_cliente_txt_numero_casa"));
	$cli_cliente->setTelefono(Gral::getVars(1, "cli_cliente_txt_telefono"));
	$cli_cliente->setTelefonoWhatsapp(Gral::getVars(1, "cli_cliente_txt_telefono_whatsapp"));
	...
	$cli_cliente->setGeoZonaId(Gral::getVars(1, "cli_cliente_cmb_geo_zona_id", null));
	...
	$cli_cliente->setGralEmpresaTransportadoraId(Gral::getVars(1, "cli_cliente_cmb_gral_empresa_transportadora_id", null));
	$cli_cliente->setCliCategoriaId(Gral::getVars(1, "cli_cliente_cmb_cli_categoria_id", null));
	$cli_cliente->setCliSubcategoriaId(Gral::getVars(1, "cli_cliente_cmb_cli_subcategoria_id", null));
	...
	$cli_cliente->setCliClienteTipoGestionId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_gestion_id", null));
	$cli_cliente->setCliClientePeriodicidadGestionId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_periodicidad_gestion_id", null));
	$cli_cliente->setCliClienteTipoEstadoId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_estado_id", null));
	$cli_cliente->setCliClienteTipoEstadoVentaId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_estado_venta_id", null));
	$cli_cliente->setCliClienteTipoEstadoCobroId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_estado_cobro_id", null));
	$cli_cliente->setCliClienteTipoEstadoCuentaId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_estado_cuenta_id", null));
	$cli_cliente->setCliClienteTipoEstadoSatisfaccionId(Gral::getVars(1, "cli_cliente_cmb_cli_cliente_tipo_estado_satisfaccion_id", null));
	$cli_cliente->setIvaExceptuado(Gral::getVars(1, "cli_cliente_cmb_iva_exceptuado", 0));
...
?>
<body>
<form id='formu' name='formu' method='post' action='ajax/modulos/cli_cliente/cli_cliente_alta.php' >
      <?php //include 'parciales/confirmacion.php';?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_cli_tipo_cliente_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_cli_tipo_cliente_id' ?>" >
				  
                                        <?php Lang::_lang('CliTipoCliente', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_cli_tipo_cliente_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('cli_tipo_cliente_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_cli_tipo_cliente_id', Gral::getCmbFiltro(CliTipoCliente::getCliTipoClientesCmb(), '...'), $cli_cliente->getCliTipoClienteId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('CLI_CLIENTE_ALTA_CMB_EDIT_CLI_TIPO_CLIENTE')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="cli_cliente_cmb_cli_tipo_cliente_id" clase_id="cli_tipo_cliente" prefijo='cli_cliente_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_cli_tipo_cliente_id" <?php echo ($cli_cliente->getCliTipoClienteId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="cli_cliente_cmb_cli_tipo_cliente_id" clase_id="cli_tipo_cliente" prefijo='cli_cliente_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_cli_cliente_cmb_cli_tipo_cliente_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_cli_tipo_cliente_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_cli_tipo_cliente_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_cli_tipo_cliente_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_cli_tipo_cliente_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cli_cliente_txt_numero_casa" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_numero_casa' ?>" >
				  
                                        <?php Lang::_lang('Nro Casa', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_txt_numero_casa" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('numero_casa')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
				  <input name='cli_cliente_txt_numero_casa' type='text' class='textbox <?php echo $error_input_css ?> ' id='cli_cliente_txt_numero_casa' value='<?php Gral::_echoTxt($cli_cliente->getNumeroCasa(), true) ?>' size='40' />            
                    <?php if(Lang::_lang('help_cli_cliente_alta_numero_casa', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_numero_casa', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_numero_casa', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_numero_casa', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
				...
				<tr>
				  <td  id="label_cli_cliente_txt_telefono_whatsapp" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_telefono_whatsapp' ?>" >
				  
                                        <?php Lang::_lang('Whatsapp', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_txt_telefono_whatsapp" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('telefono_whatsapp')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
				  <input name='cli_cliente_txt_telefono_whatsapp' type='text' class='textbox <?php echo $error_input_css ?> ' id='cli_cliente_txt_telefono_whatsapp' value='<?php Gral::_echoTxt($cli_cliente->getTelefonoWhatsapp(), true) ?>' size='40' />            
                    <?php if(Lang::_lang('help_cli_cliente_alta_telefono_whatsapp', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_telefono_whatsapp', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_telefono_whatsapp', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_telefono_whatsapp', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_geo_zona_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_geo_zona_id' ?>" >
				  
                                        <?php Lang::_lang('GeoZona', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_geo_zona_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('geo_zona_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_geo_zona_id', Gral::getCmbFiltro(GeoZona::getGeoZonasCmb(), '...'), $cli_cliente->getGeoZonaId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('CLI_CLIENTE_ALTA_CMB_EDIT_GEO_ZONA')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="cli_cliente_cmb_geo_zona_id" clase_id="geo_zona" prefijo='cli_cliente_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_geo_zona_id" <?php echo ($cli_cliente->getGeoZonaId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="cli_cliente_cmb_geo_zona_id" clase_id="geo_zona" prefijo='cli_cliente_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_cli_cliente_cmb_geo_zona_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_geo_zona_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_geo_zona_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_geo_zona_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_geo_zona_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_gral_empresa_transportadora_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_gral_empresa_transportadora_id' ?>" >
				  
                                        <?php Lang::_lang('GralEmpresaTransportadora', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_gral_empresa_transportadora_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('gral_empresa_transportadora_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_gral_empresa_transportadora_id', Gral::getCmbFiltro(GralEmpresaTransportadora::getGralEmpresaTransportadorasCmb(), '...'), $cli_cliente->getGralEmpresaTransportadoraId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('CLI_CLIENTE_ALTA_CMB_EDIT_GRAL_EMPRESA_TRANSPORTADORA')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="cli_cliente_cmb_gral_empresa_transportadora_id" clase_id="gral_empresa_transportadora" prefijo='cli_cliente_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_empresa_transportadora_id" <?php echo ($cli_cliente->getGralEmpresaTransportadoraId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="cli_cliente_cmb_gral_empresa_transportadora_id" clase_id="gral_empresa_transportadora" prefijo='cli_cliente_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_cli_cliente_cmb_gral_empresa_transportadora_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_gral_empresa_transportadora_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_gral_empresa_transportadora_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_gral_empresa_transportadora_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_gral_empresa_transportadora_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
		...
		<?php } ?> 
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_cli_cliente_tipo_gestion_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_cli_cliente_tipo_gestion_id' ?>" >
				  
                                        <?php Lang::_lang('CliClienteTipoGestion', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_cli_cliente_tipo_gestion_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('cli_cliente_tipo_gestion_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_cli_cliente_tipo_gestion_id', Gral::getCmbFiltro(CliClienteTipoGestion::getCliClienteTipoGestionsCmb(), '...'), $cli_cliente->getCliClienteTipoGestionId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('CLI_CLIENTE_ALTA_CMB_EDIT_CLI_CLIENTE_TIPO_GESTION')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="cli_cliente_cmb_cli_cliente_tipo_gestion_id" clase_id="cli_cliente_tipo_gestion" prefijo='cli_cliente_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_cli_cliente_tipo_gestion_id" <?php echo ($cli_cliente->getCliClienteTipoGestionId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="cli_cliente_cmb_cli_cliente_tipo_gestion_id" clase_id="cli_cliente_tipo_gestion" prefijo='cli_cliente_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_cli_cliente_cmb_cli_cliente_tipo_gestion_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_cli_cliente_tipo_gestion_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_cli_cliente_tipo_gestion_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_cli_cliente_tipo_gestion_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_cli_cliente_tipo_gestion_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_cli_cliente_periodicidad_gestion_id" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_cli_cliente_periodicidad_gestion_id' ?>" >
				  
                                        <?php Lang::_lang('CliClientePeriodicidadGestion', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_cli_cliente_periodicidad_gestion_id" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('cli_cliente_periodicidad_gestion_id')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_cli_cliente_periodicidad_gestion_id', Gral::getCmbFiltro(CliClientePeriodicidadGestion::getCliClientePeriodicidadGestionsCmb(), '...'), $cli_cliente->getCliClientePeriodicidadGestionId(), 'textbox '.$error_input_css)?>
		
                <?php if(UsCredencial::getEsAcreditado('CLI_CLIENTE_ALTA_CMB_EDIT_CLI_CLIENTE_PERIODICIDAD_GESTION')){ ?>
                    <div class="div_botonera_cmb_alta_editar">
                        <img class="img_btn_editar" elemento_id="cli_cliente_cmb_cli_cliente_periodicidad_gestion_id" clase_id="cli_cliente_periodicidad_gestion" prefijo='cli_cliente_' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_cli_cliente_periodicidad_gestion_id" <?php echo ($cli_cliente->getCliClientePeriodicidadGestionId() == 'null') ? "style='display:none;'" : '' ?> />

                        <img class="img_btn_agregar_nuevo" elemento_id="cli_cliente_cmb_cli_cliente_periodicidad_gestion_id" clase_id="cli_cliente_periodicidad_gestion" prefijo='cli_cliente_' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                        <div class="div_modal_cli_cliente_cmb_cli_cliente_periodicidad_gestion_id"></div>
                    </div>
		<?php } ?> 
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_cli_cliente_periodicidad_gestion_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_cli_cliente_periodicidad_gestion_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_cli_cliente_periodicidad_gestion_id', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_cli_cliente_periodicidad_gestion_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>
				...
				<tr>
				  <td  id="label_cli_cliente_cmb_iva_exceptuado" class='adm_carga_datos_titulos' width='200' help="<?php echo 'help_'.$db_nombre_pagina.'_iva_exceptuado' ?>" >
				  
                                        <?php Lang::_lang('IVA Exceptuado', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
				  
				  </td>
				  <td  id="dato_cli_cliente_cmb_iva_exceptuado" class='adm_carga_datos_datos' width='400'>

					<?php $error_input_css = ($error->getErrorXIndice('iva_exceptuado')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
				  
		<?php Html::html_dib_select(1, 'cli_cliente_cmb_iva_exceptuado', GralSiNo::getGralSiNosCmb(), $cli_cliente->getIvaExceptuado(), 'textbox '.$error_input_css) ?>
		            
                    <?php if(Lang::_lang('help_cli_cliente_alta_iva_exceptuado', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                        <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_cli_cliente_alta_iva_exceptuado', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                    <?php } ?>

                    <?php if(Lang::_lang('comentario_cli_cliente_alta_iva_exceptuado', true, false, XmlLenguajeTipo::TIPO_COMENTARIO) != ''){ ?>
                        <div class="gen-help-comentario"><?php Lang::_lang('comentario_cli_cliente_alta_iva_exceptuado', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                    <?php } ?>

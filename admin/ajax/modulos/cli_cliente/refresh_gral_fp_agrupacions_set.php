...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c = GralFpAgrupacion::setAplicarFiltrosDeAlcance($c);
...
$c->addOrden('gral_fp_agrupacion.orden', 'asc');
$c->addOrden('2');
$c->setCriterios();
...
if($ids_seleccionados != ''){
    ...
    $c->add('gral_fp_agrupacion.id', '('.$ids_seleccionados.')', Criterio::NOTIN);
    $c->addFinSubconsulta();

    $c->addInicioSubconsulta();
    $c->add('gral_fp_agrupacion.id', '%'.$palabra.'%', Criterio::LIKE);

    $c->add('gral_fp_agrupacion.descripcion', '%'.$palabra.'%', Criterio::LIKE, false, Criterio::_OR);
    $c->add('gral_fp_agrupacion.codigo', '%'.$palabra.'%', Criterio::LIKE, false, Criterio::_OR);
    $c->add('gral_fp_agrupacion.observacion', '%'.$palabra.'%', Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}else{
    $c->addInicioSubconsulta();
    $c->add('gral_fp_agrupacion.id', '%'.$palabra.'%', Criterio::LIKE);
...
$c->add('gral_fp_agrupacion.estado', 1, Criterio::IGUAL);

$c->addTabla('gral_fp_agrupacion');

$c->addOrden('gral_fp_agrupacion.orden', $relacion::GEN_FRTN_VINCULO_CRITERIO_ORDEN);

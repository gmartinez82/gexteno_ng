...
CliCliente::setAplicarFiltrosDeAlcance($c);

if($buscar != '...'){
    $c->addInicioSubconsulta();
    $c->add('cli_cliente.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('cli_cliente.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_cliente.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('cli_cliente.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

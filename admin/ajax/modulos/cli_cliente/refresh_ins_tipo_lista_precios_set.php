...
$o_ids = eval('return $o_padre->getCliClienteInsTipoListaPreciosId();');
...
$c->add('cli_cliente_ins_tipo_lista_precio.cli_cliente_id', $padre_id, Criterio::IGUAL);
$c->addTabla('ins_tipo_lista_precio');
$c->addRealJoin('cli_cliente_ins_tipo_lista_precio', 'cli_cliente_ins_tipo_lista_precio.ins_tipo_lista_precio_id', 'ins_tipo_lista_precio.id', 'LEFT JOIN');

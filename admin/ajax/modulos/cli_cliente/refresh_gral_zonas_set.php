...
$o_ids = eval('return $o_padre->getGralZonaCliClientesId();');
...
$c->add('gral_zona_cli_cliente.cli_cliente_id', $padre_id, Criterio::IGUAL);
$c->addTabla('gral_zona');
$c->addRealJoin('gral_zona_cli_cliente', 'gral_zona_cli_cliente.gral_zona_id', 'gral_zona.id', 'LEFT JOIN');

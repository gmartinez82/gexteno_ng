...
$pde_nota_debito = $pde_orden_pago_pde_nota_debito->getPdeNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeOrdenPagoPdeNotaDebito::getFiltrosArrGral() ?>&arr=<?php echo $pde_orden_pago_pde_nota_debito->getFiltrosArrXCampo('PdeNotaDebito', 'pde_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeOrdenPagoPdeNotaDebitos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

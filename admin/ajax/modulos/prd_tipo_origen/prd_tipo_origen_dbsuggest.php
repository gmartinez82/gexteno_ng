...
if($buscar != '...'){
    ...
    $c->add('prd_tipo_origen.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('prd_tipo_origen.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_tipo_origen.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('prd_tipo_origen.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('prd_tipo_origen');
$c->addOrden('prd_tipo_origen.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = PrdTipoOrigen::getPrdTipoOrigens($p, $c);

...
<div class="bloque-comprobantes-vinculados bloque-pde-nota_debito-comprobantes-vinculados">
<table border="0" class="tabla-modal">
    ...
    foreach ($pde_nota_debito_pde_nota_creditos as $pde_nota_debito_pde_nota_credito) {
        ...
        $gral_empresa_nota_debitodora = $pde_nota_credito->getGralEmpresa();
    ...
    foreach ($pde_nota_debito_pde_recibos as $pde_nota_debito_pde_recibo) {
        $pde_recibo = $pde_nota_debito_pde_recibo->getPdeRecibo();
...
//        $gral_tipo_personeria = $pde_recibo->getGralTipoPersoneria();
        $gral_empresa_nota_debitodora = $pde_recibo->getGralEmpresa();
        $gral_empresa_nota_debitodora_descripcion = $gral_empresa_nota_debitodora->getDescripcion();

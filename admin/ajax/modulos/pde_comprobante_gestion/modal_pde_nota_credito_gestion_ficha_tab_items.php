...
<div class="titulo"><?php Lang::_lang('Items de Nota de Credito') ?></div>

<div class="bloque-pde-nota-credito">
        ...
        foreach ($pde_nota_credito_items as $pde_nota_credito_item) {
            ...
            <tr>
                <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                    <div class="descripcion-pde-nota_credito-concepto">	
                ...
                <td align='center' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                    <div class="cantidad">
                        <?php $cantidad = $pde_nota_credito_item->getCantidad(); ?>
                ...
                <td align='right' class='adm_tbl_lineas <?php echo $estado ?> <?php echo $publicado ?>'>
                    <div class="importe-unitario">
                        <?php $importe_unitario = $pde_nota_credito_item->getImporteUnitario(); ?>

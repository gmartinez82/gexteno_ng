...
$xls->getActiveSheet()->getCell('B2')->setValueExplicit("Proveedor", PHPExcel_Cell_DataType::TYPE_STRING);
...
$xls->getActiveSheet()->getCell('C2')->setValueExplicit($prv_proveedor->getDescripcion(), PHPExcel_Cell_DataType::TYPE_STRING);
...
foreach ($pde_comprobantes as $pde_comprobante)
{
    ...
    $fecha                   = Gral::getFechaToWeb($pde_comprobante->getFechaEmision());
    $comprobante_siglas      = $pde_comprobante->getTipoComprobanteSiglas();
    $comprobante_min         = $pde_comprobante->getTipoComprobanteMin();
    $comprobante_completo    = $pde_comprobante->getNumeroComprobanteCompleto();
    $tipo_estado_comprobante = $pde_comprobante->getTipoEstadoComprobante();

...
if($buscar != '...'){
    ...
    $c->add('eku_de_c001_g_timb.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_c001_g_timb.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_c001_g_timb.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_c001_g_timb.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_c001_g_timb');
$c->addOrden('eku_de_c001_g_timb.orden', 'asc');
$c->setCriterios();

...
$eku_de_c001_g_timb_id = Gral::getVars(2, 'eku_de_c001_g_timb_id');
$eku_de_c001_g_timb = EkuDeC001GTimb::getOxId($eku_de_c001_g_timb_id);
$eku_de = $eku_de_c001_g_timb->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeC001GTimb::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_c001_g_timb->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeC001GTimbs') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

...
// -----------------------------------------------------------------------------
$c = new Criterio();
$c->add('vta_recibo_vta_tributo.vta_recibo_id', $padre_id, Criterio::IGUAL);
$c->addTabla('vta_tributo');
$c->addRealJoin('vta_recibo_vta_tributo', 'vta_recibo_vta_tributo.vta_tributo_id', 'vta_tributo.id', 'LEFT JOIN');

	...
	<div class='titulo'>
            ...
            <label class="titulo-entidad-cantidad">            
                <?php 
                $cantidad_ws_fe_ope_solicituds = $vta_recibo->getCantidadWsFeOpeSolicitudsXVtaReciboWsFeOpeSolicitud();
                echo ($cantidad_ws_fe_ope_solicituds > 0) ? '('.$cantidad_ws_fe_ope_solicituds.')' : '' ;
                ?>
            </label>
            <div class="titulo-entidad-comentarios">
                <?php Lang::_lang('comentario_vta_recibo_alta_relacion_vta_recibo_ws_fe_ope_solicitud_titulo_comentarios', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?>
            </div>
	</div>

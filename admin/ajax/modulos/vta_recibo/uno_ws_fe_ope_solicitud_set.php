...
<div class='list <?php echo $css_sel ?>'>
    ...
    <input type='checkbox' id='chk_ws_fe_ope_solicitud_id_<?php echo $ws_fe_ope_solicitud_relacionado->getId() ?>' name='chk_ws_fe_ope_solicitud[<?php echo $ws_fe_ope_solicitud_relacionado->getId() ?>]' <?php echo $sel ?> value='1' identificador='<?php echo $ws_fe_ope_solicitud_relacionado->getId() ?>' relacion_id='<?php echo $vta_recibo_ws_fe_ope_solicitud_id ?>' />
    <?php } ?>

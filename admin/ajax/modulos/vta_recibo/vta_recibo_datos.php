...
<table border='0' align='center' class='listado' id='listado_adm_vta_recibo'>
  ...
  <tr>
	...
	<td width='120' align='center' class='adm_tbl_encabezado'>
            <a class='ordenar' href="?ord=1&c=vta_tipo_origen_recibo_id&t=<?php Gral::_echo(($criterio->getOrdenDato('tipo') == 'asc') ? 'desc' : 'asc'); ?>">
                <?php Lang::_lang('VtaTipoOrigenRecibo') ?>
                    
                <?php if($criterio->getOrdenDato('campo')=='vta_tipo_origen_recibo_id'){ ?>
                <img src="imgs/ord_<?php Gral::_echo($criterio->getOrdenDato('tipo')) ?>.png" border='0'>
                <?php } ?>
            </a>
	</td>
  ...
  <tr id="tr_vta_recibo_uno_<?php Gral::_echo($vta_recibo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($vta_recibo->getId()) ?>">
  	<?php include "vta_recibo_uno.php" ?>
  </tr>
  
  
  <tr id='tr_eliminar_<?php Gral::_echo($vta_recibo->getId()) ?>' class='uno tr_eliminar' identificador="<?php Gral::_echo($vta_recibo->getId()) ?>" >
	<td colspan='28' align='center' class='adm_tbl_lineas'><div id='div_eliminar_<?php Gral::_echo($vta_recibo->getId()) ?>'  class='div_eliminar warning'><?php Lang::_lang('Confirma la Eliminacion') ?> <br />
	  <br />

...
$criterio->add('pde_recepcion_tipo_estado_facturacion.id', $txt_buscador, Criterio::LIKE, false, Criterio::_AND);
...
$criterio->add('pde_recepcion_tipo_estado_facturacion.activo', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('pde_recepcion_tipo_estado_facturacion.terminal', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('pde_recepcion_tipo_estado_facturacion.observacion', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
$criterio->add('pde_recepcion_tipo_estado_facturacion.estado', $txt_buscador, Criterio::LIKE, false, Criterio::_OR);
    $criterio->addFinSubconsulta();
}

...
$vta_recibo = $vta_recibo_estado->getVtaRecibo();
...
<div class="datos" id="<?php Gral::_echo($vta_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaReciboEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_estado->getFiltrosArrXCampo('VtaRecibo', 'vta_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaReciboEstados') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

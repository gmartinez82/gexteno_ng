...
if($buscar != '...'){
    ...
    $c->add('eku_de_vta_remito.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_vta_remito.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_remito.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_vta_remito.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_vta_remito');
$c->addOrden('eku_de_vta_remito.orden', 'asc');
$c->setCriterios();

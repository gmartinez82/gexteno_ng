...
$gral_tipo_personeria = $gral_empresa->getGralTipoPersoneria();
...
<div class="datos" id="<?php Gral::_echo($gral_tipo_personeria->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo GralEmpresa::getFiltrosArrGral() ?>&arr=<?php echo $gral_empresa->getFiltrosArrXCampo('GralTipoPersoneria', 'gral_tipo_personeria_id') ?>">
            <img class="icono" src="imgs/lupa.png" width="18" align="absmiddle" title="" />
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('GralEmpresas') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($gral_tipo_personeria->getDescripcion()) ?></strong>
        </a>
    </div>

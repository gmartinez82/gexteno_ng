...
$vta_recibo_imagen_id = Gral::getVars(2, 'vta_recibo_imagen_id');
$vta_recibo_imagen = VtaReciboImagen::getOxId($vta_recibo_imagen_id);
$vta_recibo = $vta_recibo_imagen->getVtaRecibo();
...
<div class="datos" id="<?php Gral::_echo($vta_recibo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo VtaReciboImagen::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_imagen->getFiltrosArrXCampo('VtaRecibo', 'vta_recibo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('VtaReciboImagens') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($vta_recibo->getDescripcion()) ?></strong>
        </a>
    </div>

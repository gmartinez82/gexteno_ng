...
<?php 
if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_recibo_imagen/vta_recibo_imagen_uno_masinfo.php")){
    include Gral::getPathAbs()."admin/ajax/modulos/vta_recibo_imagen/vta_recibo_imagen_uno_masinfo.php"; 
}
?>

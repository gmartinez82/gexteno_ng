...
$ins_insumo_veh_modelo_id = Gral::getVars(2, 'ins_insumo_veh_modelo_id');
$ins_insumo_veh_modelo = InsInsumoVehModelo::getOxId($ins_insumo_veh_modelo_id);
$ins_insumo = $ins_insumo_veh_modelo->getInsInsumo();
...
<div class="datos" id="<?php Gral::_echo($ins_insumo->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo InsInsumoVehModelo::getFiltrosArrGral() ?>&arr=<?php echo $ins_insumo_veh_modelo->getFiltrosArrXCampo('InsInsumo', 'ins_insumo_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('InsInsumoVehModelos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($ins_insumo->getDescripcion()) ?></strong>
        </a>
    </div>

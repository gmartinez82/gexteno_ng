...
if($buscar != '...'){
    ...
    $c->add('gral_novedad.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('gral_novedad.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('gral_novedad.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('gral_novedad');
$c->addOrden('gral_novedad.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = GralNovedad::getGralNovedads($p, $c);

...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_naturaleza_vendedor.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_tipo_naturaleza_vendedor.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_vendedor.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_tipo_naturaleza_vendedor.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_naturaleza_vendedor');
$c->addOrden('eku_param_tipo_naturaleza_vendedor.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamTipoNaturalezaVendedor::getEkuParamTipoNaturalezaVendedors($p, $c);

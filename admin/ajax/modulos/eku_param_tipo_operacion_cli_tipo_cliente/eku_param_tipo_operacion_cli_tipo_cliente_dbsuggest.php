...
if($buscar != '...'){
    ...
    $c->add('eku_param_tipo_operacion_cli_tipo_cliente.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_tipo_operacion_cli_tipo_cliente');
$c->addOrden('eku_param_tipo_operacion_cli_tipo_cliente.orden', 'asc');
$c->setCriterios();

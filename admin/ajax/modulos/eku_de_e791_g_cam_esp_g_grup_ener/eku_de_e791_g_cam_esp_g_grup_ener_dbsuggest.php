...
if($buscar != '...'){
    ...
    $c->add('eku_de_e791_g_cam_esp_g_grup_ener.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_e791_g_cam_esp_g_grup_ener.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e791_g_cam_esp_g_grup_ener.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_e791_g_cam_esp_g_grup_ener.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_e791_g_cam_esp_g_grup_ener');
$c->addOrden('eku_de_e791_g_cam_esp_g_grup_ener.orden', 'asc');
$c->setCriterios();

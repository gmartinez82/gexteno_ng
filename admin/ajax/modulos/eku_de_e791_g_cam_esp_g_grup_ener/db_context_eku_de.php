...
$eku_de_e791_g_cam_esp_g_grup_ener_id = Gral::getVars(2, 'eku_de_e791_g_cam_esp_g_grup_ener_id');
$eku_de_e791_g_cam_esp_g_grup_ener = EkuDeE791GCamEspGGrupEner::getOxId($eku_de_e791_g_cam_esp_g_grup_ener_id);
$eku_de = $eku_de_e791_g_cam_esp_g_grup_ener->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeE791GCamEspGGrupEner::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_e791_g_cam_esp_g_grup_ener->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeE791GCamEspGGrupEners') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

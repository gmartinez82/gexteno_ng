...
if($buscar != '...'){
    ...
    $c->add('os_tipo_estado.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('os_tipo_estado.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_tipo_estado.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('os_tipo_estado.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('os_tipo_estado');
$c->addOrden('os_tipo_estado.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = OsTipoEstado::getOsTipoEstados($p, $c);

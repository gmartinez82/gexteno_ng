...
$pde_nota_debito = $pde_nota_debito_pde_nota_credito->getPdeNotaDebito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_debito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaDebitoPdeNotaCredito::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito_pde_nota_credito->getFiltrosArrXCampo('PdeNotaDebito', 'pde_nota_debito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaDebitoPdeNotaCreditos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_debito->getDescripcion()) ?></strong>
        </a>
    </div>

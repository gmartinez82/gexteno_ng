...
$pde_nota_debito_pde_nota_credito_id = Gral::getVars(2, 'pde_nota_debito_pde_nota_credito_id');
$pde_nota_debito_pde_nota_credito = PdeNotaDebitoPdeNotaCredito::getOxId($pde_nota_debito_pde_nota_credito_id);
$pde_nota_credito = $pde_nota_debito_pde_nota_credito->getPdeNotaCredito();
...
<div class="datos" id="<?php Gral::_echo($pde_nota_credito->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo PdeNotaDebitoPdeNotaCredito::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito_pde_nota_credito->getFiltrosArrXCampo('PdeNotaCredito', 'pde_nota_credito_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('PdeNotaDebitoPdeNotaCreditos') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($pde_nota_credito->getDescripcion()) ?></strong>
        </a>
    </div>

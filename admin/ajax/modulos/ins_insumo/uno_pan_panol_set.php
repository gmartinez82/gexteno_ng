...
<div class='list <?php echo $css_sel ?>' title='<?php echo $pan_panol_relacionado->getObservacion() ?>'>
    ...
    <?php if(UsCredencial::getEsAcreditado('INS_INSUMO_ALTA_RELACION_PAN_PANOL_ACCIONES_SELECCION')){ ?>	

...
if($buscar != '...'){
    ...
    $c->add('eku_param_sistema.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_param_sistema.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_sistema.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_param_sistema.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_param_sistema');
$c->addOrden('eku_param_sistema.orden', 'asc');
$c->setCriterios();

$p = new Paginador(10, $pag);

$os = EkuParamSistema::getEkuParamSistemas($p, $c);

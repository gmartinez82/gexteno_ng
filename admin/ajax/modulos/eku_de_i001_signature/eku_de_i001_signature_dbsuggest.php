...
if($buscar != '...'){
    ...
    $c->add('eku_de_i001_signature.id', $buscar, Criterio::LIKE, false, Criterio::_AND);

	$c->add('eku_de_i001_signature.descripcion', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_i001_signature.codigo', $buscar, Criterio::LIKE, false, Criterio::_OR);
	$c->add('eku_de_i001_signature.observacion', $buscar, Criterio::LIKE, false, Criterio::_OR);
    $c->addFinSubconsulta();
}

$c->addTabla('eku_de_i001_signature');
$c->addOrden('eku_de_i001_signature.orden', 'asc');
$c->setCriterios();

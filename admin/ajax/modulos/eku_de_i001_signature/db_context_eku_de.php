...
$eku_de_i001_signature_id = Gral::getVars(2, 'eku_de_i001_signature_id');
$eku_de_i001_signature = EkuDeI001Signature::getOxId($eku_de_i001_signature_id);
$eku_de = $eku_de_i001_signature->getEkuDe();
...
<div class="datos" id="<?php Gral::_echo($eku_de->getId()) ?>">
    ...
    <div class="uno filtrar">
        <a href="_init.php?arr_gral=<?php echo EkuDeI001Signature::getFiltrosArrGral() ?>&arr=<?php echo $eku_de_i001_signature->getFiltrosArrXCampo('EkuDe', 'eku_de_id') ?>">
            ...
            <?php Lang::_lang('Ver') ?> <?php Lang::_lang('EkuDeI001Signatures') ?> <?php Lang::_lang('de') ?>: <strong><?php Gral::_echo($eku_de->getDescripcion()) ?></strong>
        </a>
    </div>

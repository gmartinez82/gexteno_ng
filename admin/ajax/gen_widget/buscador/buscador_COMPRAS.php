...
<div class="gen-widget-modulo-buscador">
    ...
    <form id='widget_modulo_<?php echo $codigo ?>_buscador_form' name='widget_modulo_<?php echo $codigo ?>_buscador_form'>
        ...
        <div class='col par'>
            ...
            <div class='dato'>
                <?php Html::html_dib_select(1, 'widget_modulo_' . $codigo . '_cmb_prv_proveedor_id', Gral::getCmbFiltro(PrvProveedor::getPrvProveedorsCmb(true), '...'), $widget_modulo_cmb_prv_proveedor_id, 'textbox' . $error_input_css, $ancho = '', 'filtro="widget_cmb_prv_proveedor_id"'); ?>
            </div>
        </div>

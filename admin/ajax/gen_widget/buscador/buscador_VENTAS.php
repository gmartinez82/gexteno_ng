...
<div class="gen-widget-modulo-buscador">
    ...
    <form id='widget_modulo_<?php echo $codigo ?>_buscador_form' name='widget_modulo_<?php echo $codigo ?>_buscador_form'>
        ...
        <div class='col par'>
            ...
            <div class='dato'>
                <?php Html::html_dib_select(1, 'widget_modulo_' . $codigo . '_cmb_vta_preventista_id', Gral::getCmbFiltro(VtaPreventista::getVtaPreventistasCmb(true), '...'), $widget_modulo_cmb_vta_preventista_id, 'textbox' . $error_input_css, $ancho = '', 'filtro="widget_cmb_vta_preventista_id"'); ?>
            </div>
        </div>

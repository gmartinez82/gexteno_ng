...
if(Gral::esPost()){
    ...
    $vta_vendedor_valoracion = VtaVendedorValoracion::getOxId($hdn_id);
    if(!$vta_vendedor_valoracion){
        ...
        // -----------------------------------------------------------------
        if($vta_vendedor_valoracion){
            if(VtaVendedorValoracion::GEN_CONTROL_ALCANCE){
                if($vta_vendedor_valoracion->getHash() != $hdn_hash){

                    header('Location: us_noautorizado.php?tipo=HASH&clase=VtaVendedorValoracion&id='.$vta_vendedor_valoracion->getId().'&cod='.$hdn_hash);
                    exit;
                }
            }            
        }            
	...
	$vta_vendedor_valoracion->setVtaVendedorValoracionAgrupacionId(Gral::getVars(1, "cmb_vta_vendedor_valoracion_agrupacion_id", null));
	$vta_vendedor_valoracion->setVtaVendedorValoracionTipoItemId(Gral::getVars(1, "cmb_vta_vendedor_valoracion_tipo_item_id", null));
	$vta_vendedor_valoracion->setApellido(Gral::getVars(1, "txt_apellido"));
	$vta_vendedor_valoracion->setNombre(Gral::getVars(1, "txt_nombre"));
	$vta_vendedor_valoracion->setEmail(Gral::getVars(1, "txt_email"));
	$vta_vendedor_valoracion->setTelefono(Gral::getVars(1, "txt_telefono"));
	$vta_vendedor_valoracion->setFecha(Gral::getFechaToDb(Gral::getVars(1, "txt_fecha")));
	$vta_vendedor_valoracion->setVtaVendedorId(Gral::getVars(1, "cmb_vta_vendedor_id", null));
	$vta_vendedor_valoracion->setValoracion(Gral::getVars(1, "txt_valoracion", 0));
	$vta_vendedor_valoracion->setObservacion(Gral::getVars(1, "txa_observacion"));
    }
    if(UsCredencial::getEsAcreditado('VTA_VENDEDOR_VALORACION_ALTA_AVANZADA')){ 
    }
	...
	switch($accion){
            case 'guardar':
                ...
                if(!$error->getExisteError()){
                    ...
                    header('Location: ?cs=1&id='.$vta_vendedor_valoracion->getId().'&hash='.$vta_vendedor_valoracion->getHash());
                    exit;
                }
            break;
            case 'guardarnvo':
	...
	if(trim($hdn_id) != 0){ 
            $vta_vendedor_valoracion->setId($hdn_id);
            ...
            if($vta_vendedor_valoracion){
                if(VtaVendedorValoracion::GEN_CONTROL_ALCANCE){
                    if($vta_vendedor_valoracion->getHash() != $hash){

                        header('Location: us_noautorizado.php?tipo=HASH&clase=VtaVendedorValoracion&id='.$vta_vendedor_valoracion->getId().'&cod='.$hash);
                        exit;
                    }
                }
            }            
...
<div id='cuerpo' >
    <form id='formu' name='formu' method='post' action='' modulo='vta_vendedor_valoracion' >
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaVendedorValoracion::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaVendedorValoracion::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_VENDEDOR_VALORACION_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_vendedor_valoracion'>
        
            <tr>
                <td id="label_cmb_vta_vendedor_valoracion_agrupacion_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_vendedor_valoracion_agrupacion_id' ?>" >

                    <?php Lang::_lang('VtaVendedorValoracionAgrupacion', false, true, XmlLenguajeTipo::TIPO_PALABRA) ?>
                    
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=vta_vendedor_valoracion_agrupacion_id' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_cmb_vta_vendedor_valoracion_agrupacion_id" class="adm_carga_datos_datos" width="">
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_vendedor_valoracion_agrupacion_id" clase_id="vta_vendedor_valoracion_agrupacion" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_vendedor_valoracion_agrupacion_id" <?php echo ($vta_vendedor_valoracion->getVtaVendedorValoracionAgrupacionId() == 'null') ? "style='display:none;'" : '' ?> />

                   <img class="img_btn_agregar_nuevo" elemento_id="cmb_vta_vendedor_valoracion_agrupacion_id" clase_id="vta_vendedor_valoracion_agrupacion" prefijo='' src='imgs/btn_add.png' border='0' width='20' align='absmiddle' />
                   <div class="div_modal_cmb_vta_vendedor_valoracion_agrupacion_id"></div>
                </div>
                <?php } ?>
                
		<?php Html::html_dib_select(1, 'cmb_vta_vendedor_valoracion_agrupacion_id', Gral::getCmbFiltro(VtaVendedorValoracionAgrupacion::getVtaVendedorValoracionAgrupacionsCmb(true), '...'), $vta_vendedor_valoracion->getVtaVendedorValoracionAgrupacionId(), 'textbox  '.$error_input_css) ?>
		

                <?php if(Lang::_lang('help_'.$db_nombre_pagina.'_vta_vendedor_valoracion_agrupacion_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                    <img class="gen-help-icon" src="imgs/btn_ayuda_verde.png" width="25" alt="help" title="<?php Lang::_lang('help_'.$db_nombre_pagina.'_vta_vendedor_valoracion_agrupacion_id', false, false, XmlLenguajeTipo::TIPO_AYUDA) ?>" />
                <?php } ?>

                <?php if(Lang::_lang('comentario_'.$db_nombre_pagina.'_vta_vendedor_valoracion_agrupacion_id', true, false, XmlLenguajeTipo::TIPO_AYUDA) != ''){ ?>
                    <div class="gen-help-comentario"><?php Lang::_lang('comentario_'.$db_nombre_pagina.'_vta_vendedor_valoracion_agrupacion_id', false, false, XmlLenguajeTipo::TIPO_COMENTARIO) ?></div>
                <?php } ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_valoracion_agrupacion_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_valoracion_agrupacion_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_cmb_vta_vendedor_valoracion_tipo_item_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_vendedor_valoracion_tipo_item_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=vta_vendedor_valoracion_tipo_item_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_vta_vendedor_valoracion_tipo_item_id', Gral::getCmbFiltro(VtaVendedorValoracionTipoItem::getVtaVendedorValoracionTipoItemsCmb(true), '...'), $vta_vendedor_valoracion->getVtaVendedorValoracionTipoItemId(), 'textbox  '.$error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_valoracion_tipo_item_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_valoracion_tipo_item_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_apellido" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_apellido' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=apellido' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_apellido" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('apellido')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_apellido' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_apellido' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getApellido()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_apellido_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_apellido_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_nombre" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_nombre' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=nombre' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_nombre" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('nombre')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_nombre' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_nombre' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getNombre()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_nombre_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_nombre_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_email" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_email' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=email' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_email" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('email')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_email' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_email' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getEmail()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_email_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_email_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_telefono" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_telefono' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=telefono' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_telefono" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('telefono')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_telefono' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_telefono' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getTelefono()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_telefono_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_telefono_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_fecha" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_fecha' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=fecha' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_fecha" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('fecha')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_fecha' type='text' class='textbox <?php echo $error_input_css ?> datetime' id='txt_fecha' value='<?php Gral::_echoTxt(Gral::getFechaToWeb($vta_vendedor_valoracion->getFecha())) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_fecha_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_fecha_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_cmb_vta_vendedor_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_vendedor_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=vta_vendedor_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_vendedor_id" clase_id="vta_vendedor" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_vendedor_id" <?php echo ($vta_vendedor_valoracion->getVtaVendedorId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_vendedor_id', Gral::getCmbFiltro(VtaVendedor::getVtaVendedorsCmb(true), '...'), $vta_vendedor_valoracion->getVtaVendedorId(), 'textbox  '.$error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_vta_vendedor_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_valoracion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_valoracion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=valoracion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_valoracion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('valoracion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_valoracion' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_valoracion' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getValoracion()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_valoracion_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_valoracion_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_vendedor_valoracion_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='7' cols='60' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($vta_vendedor_valoracion->getObservacion()) ?></textarea>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_observacion_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/vta_vendedor_valoracion/vta_vendedor_valoracion_alta_campo_observacion_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'>
            <input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getId()) ?>'/>
            <input name='hdn_hash' type='hidden' id='hdn_hash' size='5' value='<?php Gral::_echoTxt($vta_vendedor_valoracion->getHash()) ?>'/>
    ...
    <?php if(trim($vta_vendedor_valoracion->getId()) != ''){ ?>

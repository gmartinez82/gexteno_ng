...
$db_nombre_objeto = "rep_vta_nota_debito";
$db_nombre_pagina = "rep_vta_nota_debito";
...
if (Gral::esPost())
{
    ...
    $cmb_filtro_vta_tipo_nota_debito_id  = Gral::getVars(1, 'cmb_filtro_vta_tipo_nota_debito_id', 0);
    ...
    include "rep_vta_nota_debito_xlsx.php";
}
else
{
    //$txt_desde = '';
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('Vta Nota Debito') ?> </div>
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Lista de VtaNotaDebito') ?></div>
                    <div class="par">
                    ...
                    <div class="par">
                        <div class="label"><?php Lang::_lang('Tipo de Nota de Debito') ?></div>
                        <div class="dato">

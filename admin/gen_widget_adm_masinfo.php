...
$gen_widget_id = Gral::getVars(2, 'id');
...
<div class="masinfo-datos">
	...
	<div class="par inline">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($gen_widget->getCodigo())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gen_widget->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GEN_WIDGET_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gen_widget->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gen_widget->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GEN_WIDGET_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gen_widget->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gen_widget->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('GEN_WIDGET_MASINFO_GEN_WIDGET_GEN_WIDGET_MODULO')){ ?>
	...
	<div id="tab_gen_widget_gen_widget_modulo" class="bloque-relacion gen_widget_gen_widget_modulo">
            ...
            <h4><?php Lang::_lang('GenWidgetGenWidgetModulo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GenWidget') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gen_widget->getGenWidgetGenWidgetModulosParaBloqueMasInfo() as $gen_widget_gen_widget_modulo){ ?>
                    <div class="uno">
                        <div class="id"><?php Gral::_echo($gen_widget_gen_widget_modulo->getId()) ?></div>
                        <div class="descripcion">
                        					
                        <?php Gral::_echo($gen_widget_gen_widget_modulo->getDescripcionVinculante('GenWidget')) ?>					
                        </div>
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GEN_WIDGET_MASINFO_GEN_WIDGET_GEN_WIDGET_MODULO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($gen_widget_gen_widget_modulo){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo GenWidgetGenWidgetModulo::getFiltrosArrGral() ?>&arr=<?php echo $gen_widget_gen_widget_modulo->getFiltrosArrXCampo('GenWidget', 'gen_widget_id') ?>" >
                                <?php Lang::_lang('Ver GenWidgetGenWidgetModulos de ') ?> <strong><?php echo($gen_widget->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$sql = "
        SELECT 
            ...
            coalesce((select sum(importe_total) from view_pde_factura where fecha_emision = CURRENT_DATE + i), 0) as importe_total_compras,
            coalesce((select sum(importe_total) from view_vta_factura where fecha_emision = CURRENT_DATE + i), 0) as importe_total_ventas

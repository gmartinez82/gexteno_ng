...
$db_nombre_pagina = 'prv_insumo_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="prv_insumo">
              <?php include 'ajax/modulos/prv_insumo/prv_insumo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="prv_insumo">
...
<script type='text/javascript'>
    ...
    refreshAdmAll('prv_insumo', <?php echo $pagina_actual ?>);
</script>

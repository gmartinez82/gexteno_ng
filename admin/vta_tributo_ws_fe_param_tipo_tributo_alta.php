...
if(Gral::esPost()){
	...
	$vta_tributo_ws_fe_param_tipo_tributo->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$vta_tributo_ws_fe_param_tipo_tributo->setVtaTributoId(Gral::getVars(1, "cmb_vta_tributo_id", null));
	$vta_tributo_ws_fe_param_tipo_tributo->setWsFeParamTipoTributoId(Gral::getVars(1, "cmb_ws_fe_param_tipo_tributo_id", null));
	$vta_tributo_ws_fe_param_tipo_tributo->setCodigo(Gral::getVars(1, "txt_codigo"));
	$vta_tributo_ws_fe_param_tipo_tributo->setObservacion(Gral::getVars(1, "txa_observacion"));
	$vta_tributo_ws_fe_param_tipo_tributo->setOrden(Gral::getVars(1, "txt_orden", 0));
	$vta_tributo_ws_fe_param_tipo_tributo->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$vta_tributo_ws_fe_param_tipo_tributo->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$vta_tributo_ws_fe_param_tipo_tributo->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$vta_tributo_ws_fe_param_tipo_tributo->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$vta_tributo_ws_fe_param_tipo_tributo->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$vta_tributo_ws_fe_param_tipo_tributo->getId());
			}
		break;
		case 'guardarnvo':
			$error = $vta_tributo_ws_fe_param_tipo_tributo->control();
	...
	if(trim($hdn_id) != ''){ 
		$vta_tributo_ws_fe_param_tipo_tributo->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaTributoWsFeParamTipoTributo::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaTributoWsFeParamTipoTributo::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_TRIBUTO_WS_FE_PARAM_TIPO_TRIBUTO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_tributo_ws_fe_param_tipo_tributo'>
            ...
            <tr>
                <td id="label_cmb_vta_tributo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_tributo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_tributo_ws_fe_param_tipo_tributo_alta&atributo=vta_tributo_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_tributo_id" clase_id="vta_tributo" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_tributo_id" <?php echo ($vta_tributo_ws_fe_param_tipo_tributo->getVtaTributoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_tributo_id', Gral::getCmbFiltro(VtaTributo::getVtaTributosCmb(), '...'), $vta_tributo_ws_fe_param_tipo_tributo->getVtaTributoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_ws_fe_param_tipo_tributo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_ws_fe_param_tipo_tributo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_tributo_ws_fe_param_tipo_tributo_alta&atributo=ws_fe_param_tipo_tributo_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_ws_fe_param_tipo_tributo_id', Gral::getCmbFiltro(WsFeParamTipoTributo::getWsFeParamTipoTributosCmb(), '...'), $vta_tributo_ws_fe_param_tipo_tributo->getWsFeParamTipoTributoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_tributo_ws_fe_param_tipo_tributo_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($vta_tributo_ws_fe_param_tipo_tributo->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_tributo_ws_fe_param_tipo_tributo->getId()) ?>'/>
    ...
    <?php if(trim($vta_tributo_ws_fe_param_tipo_tributo->getId()) != ''){ ?>

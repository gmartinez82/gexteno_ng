...
$prv_grupo_id = Gral::getVars(2, 'id');
$prv_grupo = PrvGrupo::getOxId($prv_grupo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prv_grupo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_GRUPO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_grupo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_grupo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_GRUPO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_grupo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_grupo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRV_GRUPO_MASINFO_PRV_PROVEEDOR')){ ?>
	...
	<div id="tab_prv_proveedor" class="bloque-relacion prv_proveedor">
            ...
            <h4><?php Lang::_lang('PrvProveedor') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrvGrupo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prv_grupo->getPrvProveedorsParaBloqueMasInfo() as $prv_proveedor){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRV_GRUPO_MASINFO_PRV_PROVEEDOR_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($prv_proveedor){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PrvProveedors de ') ?> <strong><?php echo($prv_grupo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$alt_tipo_id = Gral::getVars(2, 'id');
$alt_tipo = AltTipo::getOxId($alt_tipo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($alt_tipo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ALT_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($alt_tipo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($alt_tipo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ALT_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($alt_tipo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($alt_tipo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('ALT_TIPO_MASINFO_ALT_ALERTA')){ ?>
	...
	<div id="tab_alt_alerta" class="bloque-relacion alt_alerta">
            ...
            <h4><?php Lang::_lang('AltAlerta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('AltTipo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($alt_tipo->getAltAlertasParaBloqueMasInfo() as $alt_alerta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('ALT_TIPO_MASINFO_ALT_ALERTA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($alt_alerta){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver AltAlertas de ') ?> <strong><?php echo($alt_tipo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$pagina = $param["pagina"];
$vta_comprobantes_pagina = $param['vta_comprobantes_pagina'];
...
<table cellpadding="0" cellspacing="0" class="tabla" id="listado_adm_vta_presupuesto_gestion" border="0" align="center">
    <tr>
        ...
        <th class="adm_tbl_encabezado_gris" width="170" align="center">
            Cliente
        </th>
    ...
    foreach ($vta_comprobantes_pagina as $i => $vta_comprobante) {
        ...
        ?>
        <tr id="tr_cntb_diario_asiento_cuenta_uno_<?php echo $vta_comprobante->getId() ?>" class="uno" identificador="<?php echo $vta_comprobante->getId() ?>">
            ...
            <td class="adm_tbl_lineas" align="left">
                <?php Gral::_echo($vta_comprobante->getTipoComprobanteSiglas()) ?> - <?php Gral::_echo($vta_comprobante->getTipoComprobanteMin()) ?>
            </td>
            ...
            <td class="adm_tbl_lineas" align="left">
                <?php Gral::_echo(substr($vta_comprobante->getPersonaDescripcion(), 0, 25)) ?>
            </td>

            <td class="adm_tbl_lineas" align="left">
                <?php Gral::_echo($vta_comprobante->getCuit()) ?>
            </td>
            ...
            <td class="adm_tbl_lineas" align="right">
                <?php Gral::_echoImp($importe_iva_importe_21) ?>&nbsp;&nbsp;
            </td>

            <td class="adm_tbl_lineas" align="right">
                <?php Gral::_echoImp($importe_iva_importe_105) ?>&nbsp;&nbsp;
            </td>
    ...
    <tr>
        ...
        <td class="adm_tbl_encabezado_gris" align="right">
            <?php Gral::_echoImp($importe_total_mensual_iva_21_importe) ?>&nbsp;&nbsp;
        </td>

        <td class="adm_tbl_encabezado_gris" align="right">
            <?php Gral::_echoImp($importe_total_mensual_iva_105_importe) ?>&nbsp;&nbsp;
        </td>
    ...
    <tr>
        ...
        <td class="adm_tbl_encabezado_gris" align="right">
            <?php Gral::_echoImp($arr_total_libro_acumulado['importe_total_libro_iva_21_importe']) ?>&nbsp;&nbsp;
        </td>

        <td class="adm_tbl_encabezado_gris" align="right">
            <?php Gral::_echoImp($arr_total_libro_acumulado['importe_total_libro_iva_105_importe']) ?>&nbsp;&nbsp;
        </td>

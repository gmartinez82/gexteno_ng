...
$pagina_actual = PerPersonaImagen::getSesPag();
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="per_persona_imagen">
              <?php include 'ajax/modulos/per_persona_imagen/per_persona_imagen_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="per_persona_imagen">
              <?php //include 'ajax/modulos/per_persona_imagen/per_persona_imagen_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('per_persona_imagen', <?php echo $pagina_actual ?>);
</script>

...
if(Gral::esPost()){
	...
	$vta_politica_descuento_ins_categoria->setVtaPoliticaDescuentoId(Gral::getVars(1, "cmb_vta_politica_descuento_id", null));
	$vta_politica_descuento_ins_categoria->setInsCategoriaId(Gral::getVars(1, "cmb_ins_categoria_id", null));
	$vta_politica_descuento_ins_categoria->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$vta_politica_descuento_ins_categoria->setCreadoPor(Gral::getVars(1, "_creado_por", null));
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$vta_politica_descuento_ins_categoria->getId());
			}
		break;
		case 'guardarnvo':
			$error = $vta_politica_descuento_ins_categoria->control();
	...
	if(trim($hdn_id) != ''){ 
		$vta_politica_descuento_ins_categoria->setId($hdn_id);
	}else{
...
<div id='cuerpo' >
	...
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('VtaPoliticaDescuentoInsCategorias') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaPoliticaDescuentoInsCategoria::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaPoliticaDescuentoInsCategoria::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_POLITICA_DESCUENTO_INS_CATEGORIA_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_politica_descuento_ins_categoria'>
            ...
            <tr>
                <td id="label_cmb_vta_politica_descuento_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_politica_descuento_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_politica_descuento_ins_categoria_alta&atributo=vta_politica_descuento_id' modulo_metodo_init='setInit()'>
		...
		<?php Html::html_dib_select(1, 'cmb_vta_politica_descuento_id', Gral::getCmbFiltro(VtaPoliticaDescuento::getVtaPoliticaDescuentosCmb(), '...'), $vta_politica_descuento_ins_categoria->getVtaPoliticaDescuentoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_ins_categoria_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_ins_categoria_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_politica_descuento_ins_categoria_alta&atributo=ins_categoria_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_ins_categoria_id" clase_id="ins_categoria" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_ins_categoria_id" <?php echo ($vta_politica_descuento_ins_categoria->getInsCategoriaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_ins_categoria_id', Gral::getCmbFiltro(InsCategoria::getInsCategoriasCmb(), '...'), $vta_politica_descuento_ins_categoria->getInsCategoriaId(), 'textbox '.$error_input_css) ?>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_politica_descuento_ins_categoria->getId()) ?>'/>
    ...
    <?php if(trim($vta_politica_descuento_ins_categoria->getId()) != ''){ ?>

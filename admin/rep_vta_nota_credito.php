...
$db_nombre_objeto = "rep_vta_nota_credito";
$db_nombre_pagina = "rep_vta_nota_credito";
...
if (Gral::esPost())
{
    ...
    $cmb_filtro_vta_tipo_nota_credito_id = Gral::getVars(1, 'cmb_filtro_vta_tipo_nota_credito_id', 0);
    ...
    include "rep_vta_nota_credito_xlsx.php";
}
else
{
    //$txt_desde = '';
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('Vta Nota Credito') ?> </div>
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Lista de VtaNotaCredito') ?></div>
                    <div class="par">

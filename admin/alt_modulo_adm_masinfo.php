...
$alt_modulo_id = Gral::getVars(2, 'id');
$alt_modulo = AltModulo::getOxId($alt_modulo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($alt_modulo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ALT_MODULO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($alt_modulo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($alt_modulo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ALT_MODULO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($alt_modulo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($alt_modulo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('ALT_MODULO_MASINFO_ALT_ALERTA')){ ?>
	...
	<div id="tab_alt_alerta" class="bloque-relacion alt_alerta">
            ...
            <h4><?php Lang::_lang('AltAlerta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('AltModulo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($alt_modulo->getAltAlertasParaBloqueMasInfo() as $alt_alerta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('ALT_MODULO_MASINFO_ALT_ALERTA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($alt_alerta){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver AltAlertas de ') ?> <strong><?php echo($alt_modulo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$db_nombre_pagina = 'cntb_periodo_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="cntb_periodo">
              <?php include 'ajax/modulos/cntb_periodo/cntb_periodo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="cntb_periodo">
...
<script type='text/javascript'>
    ...
    refreshAdmAll('cntb_periodo', <?php echo $pagina_actual ?>);
</script>

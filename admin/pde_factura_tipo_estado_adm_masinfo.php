...
$pde_factura_tipo_estado_id = Gral::getVars(2, 'id');
$pde_factura_tipo_estado = PdeFacturaTipoEstado::getOxId($pde_factura_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($pde_factura_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDE_FACTURA_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pde_factura_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pde_factura_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDE_FACTURA_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pde_factura_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pde_factura_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PDE_FACTURA_TIPO_ESTADO_MASINFO_PDE_FACTURA')){ ?>
            <li><a href="#tab_pde_factura"><?php Lang::_lang('PdeFactura') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PDE_FACTURA_TIPO_ESTADO_MASINFO_PDE_FACTURA_ESTADO')){ ?>
	...
	<div id="tab_pde_factura" class="bloque-relacion pde_factura">
            ...
            <h4><?php Lang::_lang('PdeFactura') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdeFacturaTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pde_factura_tipo_estado->getPdeFacturasParaBloqueMasInfo() as $pde_factura){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDE_FACTURA_TIPO_ESTADO_MASINFO_PDE_FACTURA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_factura){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeFacturas de ') ?> <strong><?php echo($pde_factura_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_factura_estado" class="bloque-relacion pde_factura_estado">
            ...
            <h4><?php Lang::_lang('PdeFacturaEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdeFacturaTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pde_factura_tipo_estado->getPdeFacturaEstadosParaBloqueMasInfo() as $pde_factura_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDE_FACTURA_TIPO_ESTADO_MASINFO_PDE_FACTURA_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_factura_estado){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeFacturaEstados de ') ?> <strong><?php echo($pde_factura_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

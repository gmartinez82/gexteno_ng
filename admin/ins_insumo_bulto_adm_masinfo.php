...
$ins_insumo_bulto_id = Gral::getVars(2, 'id');
...
<div class="masinfo-datos">
	...
	<div class="par inline">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($ins_insumo_bulto->getInsInsumo()->getDescripcion())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Codigo') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($ins_insumo_bulto->getCodigo())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($ins_insumo_bulto->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_INSUMO_BULTO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_insumo_bulto->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_insumo_bulto->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_INSUMO_BULTO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_insumo_bulto->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_insumo_bulto->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('INS_INSUMO_BULTO_MASINFO_VTA_PRESUPUESTO_INS_INSUMO')){ ?>
            <li><a href="#tab_vta_presupuesto_ins_insumo"><?php Lang::_lang('VtaPresupuestoInsInsumo') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('INS_INSUMO_BULTO_MASINFO_VTA_ORDEN_VENTA')){ ?>
	...
	<div id="tab_vta_presupuesto_ins_insumo" class="bloque-relacion vta_presupuesto_ins_insumo">
            ...
            <h4><?php Lang::_lang('VtaPresupuestoInsInsumo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('InsInsumoBulto') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($ins_insumo_bulto->getVtaPresupuestoInsInsumosParaBloqueMasInfo() as $vta_presupuesto_ins_insumo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('INS_INSUMO_BULTO_MASINFO_VTA_PRESUPUESTO_INS_INSUMO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_presupuesto_ins_insumo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaPresupuestoInsInsumos de ') ?> <strong><?php echo($ins_insumo_bulto->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_orden_venta" class="bloque-relacion vta_orden_venta">
            ...
            <h4><?php Lang::_lang('VtaOrdenVenta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('InsInsumoBulto') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($ins_insumo_bulto->getVtaOrdenVentasParaBloqueMasInfo() as $vta_orden_venta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('INS_INSUMO_BULTO_MASINFO_VTA_ORDEN_VENTA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_orden_venta){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaOrdenVentas de ') ?> <strong><?php echo($ins_insumo_bulto->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

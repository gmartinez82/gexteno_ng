...
$db_nombre_pagina = 'ins_insumo_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="ins_insumo">
              <?php include 'ajax/modulos/ins_insumo/ins_insumo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="ins_insumo">
              <?php //include 'ajax/modulos/ins_insumo/ins_insumo_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('ins_insumo', <?php echo $pagina_actual ?>);
</script>

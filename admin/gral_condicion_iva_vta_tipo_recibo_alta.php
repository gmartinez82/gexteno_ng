...
if(Gral::esPost()){
	...
	$gral_condicion_iva_vta_tipo_recibo->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$gral_condicion_iva_vta_tipo_recibo->setGralCondicionIvaId(Gral::getVars(1, "cmb_gral_condicion_iva_id", null));
	$gral_condicion_iva_vta_tipo_recibo->setVtaTipoReciboId(Gral::getVars(1, "cmb_vta_tipo_recibo_id", null));
	$gral_condicion_iva_vta_tipo_recibo->setCodigo(Gral::getVars(1, "txt_codigo"));
	$gral_condicion_iva_vta_tipo_recibo->setObservacion(Gral::getVars(1, "txa_observacion"));
	$gral_condicion_iva_vta_tipo_recibo->setOrden(Gral::getVars(1, "txt_orden", 0));
	$gral_condicion_iva_vta_tipo_recibo->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$gral_condicion_iva_vta_tipo_recibo->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$gral_condicion_iva_vta_tipo_recibo->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$gral_condicion_iva_vta_tipo_recibo->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$gral_condicion_iva_vta_tipo_recibo->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$gral_condicion_iva_vta_tipo_recibo->getId());
			}
		break;
		case 'guardarnvo':
			$error = $gral_condicion_iva_vta_tipo_recibo->control();
	...
	if(trim($hdn_id) != ''){ 
		$gral_condicion_iva_vta_tipo_recibo->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(GralCondicionIvaVtaTipoRecibo::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(GralCondicionIvaVtaTipoRecibo::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('GRAL_CONDICION_IVA_VTA_TIPO_RECIBO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_gral_condicion_iva_vta_tipo_recibo'>
            ...
            <tr>
                <td id="label_cmb_gral_condicion_iva_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_condicion_iva_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_condicion_iva_vta_tipo_recibo_alta&atributo=gral_condicion_iva_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_condicion_iva_id" clase_id="gral_condicion_iva" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_condicion_iva_id" <?php echo ($gral_condicion_iva_vta_tipo_recibo->getGralCondicionIvaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_condicion_iva_id', Gral::getCmbFiltro(GralCondicionIva::getGralCondicionIvasCmb(), '...'), $gral_condicion_iva_vta_tipo_recibo->getGralCondicionIvaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_vta_tipo_recibo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_tipo_recibo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_condicion_iva_vta_tipo_recibo_alta&atributo=vta_tipo_recibo_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_tipo_recibo_id" clase_id="vta_tipo_recibo" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_tipo_recibo_id" <?php echo ($gral_condicion_iva_vta_tipo_recibo->getVtaTipoReciboId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_tipo_recibo_id', Gral::getCmbFiltro(VtaTipoRecibo::getVtaTipoRecibosCmb(), '...'), $gral_condicion_iva_vta_tipo_recibo->getVtaTipoReciboId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_condicion_iva_vta_tipo_recibo_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($gral_condicion_iva_vta_tipo_recibo->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($gral_condicion_iva_vta_tipo_recibo->getId()) ?>'/>
    ...
    <?php if(trim($gral_condicion_iva_vta_tipo_recibo->getId()) != ''){ ?>

...
$db_nombre_objeto = 'rep_cntb_retenciones_de_clientes';
$db_nombre_pagina = 'rep_cntb_retenciones_de_clientes';
...
if (Gral::esPost()) {
    ...
    include "rep_cntb_retenciones_de_clientes_xlsx.php";
}
else {
        ...
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    ...
                    <div class="titulo">
                        <?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Retenciones de Clientes') ?>
                    </div>
                    ...
                    <div class="botonera">
                        <input id="btn_enviar" name="btn_enviar" class="boton" type="submit" value="<?php Lang::_lang('Ver Reporte de Retenciones de Clientes') ?>" />
                    </div>

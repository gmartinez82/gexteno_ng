...
if(Gral::esPost()){
	...
	$ws_fe_param_tipo_tributo->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$ws_fe_param_tipo_tributo->setCodigo(Gral::getVars(1, "txt_codigo"));
	$ws_fe_param_tipo_tributo->setCodigoAfip(Gral::getVars(1, "txt_codigo_afip"));
	$ws_fe_param_tipo_tributo->setFechaDesde(Gral::getVars(1, "txt_fecha_desde"));
	$ws_fe_param_tipo_tributo->setFechaHasta(Gral::getVars(1, "txt_fecha_hasta"));
	$ws_fe_param_tipo_tributo->setObservacion(Gral::getVars(1, "txa_observacion"));
	$ws_fe_param_tipo_tributo->setOrden(Gral::getVars(1, "txt_orden", 0));
	$ws_fe_param_tipo_tributo->setEstado(Gral::getVars(1, "_estado", 0));
	$ws_fe_param_tipo_tributo->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$ws_fe_param_tipo_tributo->setCreadoPor(Gral::getVars(1, "_creado_por", null));
	$ws_fe_param_tipo_tributo->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$ws_fe_param_tipo_tributo->setModificadoPor(Gral::getVars(1, "_modificado_por", null));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$ws_fe_param_tipo_tributo->getId());
			}
		break;
		case 'guardarnvo':
			$error = $ws_fe_param_tipo_tributo->control();
	...
	if(trim($hdn_id) != ''){ 
		$ws_fe_param_tipo_tributo->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(WsFeParamTipoTributo::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(WsFeParamTipoTributo::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('WS_FE_PARAM_TIPO_TRIBUTO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_ws_fe_param_tipo_tributo'>
            ...
            <tr>
                <td id="label_txt_descripcion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_descripcion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=descripcion' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_txt_descripcion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('descripcion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_descripcion' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_descripcion' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getDescripcion()) ?>' size='50' />
            ...
            <tr>
                <td id="label_txt_codigo" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_codigo' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=codigo' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_codigo" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('codigo')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_codigo' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_codigo' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getCodigo()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txt_codigo_afip" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_codigo_afip' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=codigo_afip' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_codigo_afip" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('codigo_afip')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_codigo_afip' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_codigo_afip' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getCodigoAfip()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txt_fecha_desde" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_fecha_desde' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=fecha_desde' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_fecha_desde" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('fecha_desde')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_fecha_desde' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_fecha_desde' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getFechaDesde()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txt_fecha_hasta" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_fecha_hasta' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=fecha_hasta' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_fecha_hasta" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('fecha_hasta')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_fecha_hasta' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_fecha_hasta' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getFechaHasta()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=ws_fe_param_tipo_tributo_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($ws_fe_param_tipo_tributo->getId()) ?>'/>
    ...
    <?php if(trim($ws_fe_param_tipo_tributo->getId()) != ''){ ?>
    <div class="alta relaciones">
		
		<?php include Gral::getPathAbs()."admin/ajax/modulos/ws_fe_param_tipo_tributo/bloque_relacion_vta_tributo_ws_fe_param_tipo_tributo.php" ?>
    </div>
	<?php } ?>


	  <?php //include 'ws_fe_param_tipo_tributo_set.php' ?>
	  </div>

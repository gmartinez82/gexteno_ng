...
if(Gral::esPost()){
	...
	$vta_nota_credito_vta_tributo->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$vta_nota_credito_vta_tributo->setVtaNotaCreditoId(Gral::getVars(1, "cmb_vta_nota_credito_id", null));
	$vta_nota_credito_vta_tributo->setVtaTributoId(Gral::getVars(1, "cmb_vta_tributo_id", null));
	$vta_nota_credito_vta_tributo->setImporteImponible(Gral::getImporteDesdePriceFormatToDB(Gral::getVars(1, "txt_importe_imponible", 0)));
	$vta_nota_credito_vta_tributo->setImporteTributo(Gral::getImporteDesdePriceFormatToDB(Gral::getVars(1, "txt_importe_tributo", 0)));
	$vta_nota_credito_vta_tributo->setAlicuotaPorcentual(Gral::getVars(1, "txt_alicuota_porcentual", 0));
	$vta_nota_credito_vta_tributo->setAlicuotaDecimal(Gral::getVars(1, "txt_alicuota_decimal", 0));
	$vta_nota_credito_vta_tributo->setCodigo(Gral::getVars(1, "txt_codigo"));
	$vta_nota_credito_vta_tributo->setObservacion(Gral::getVars(1, "txa_observacion"));
	$vta_nota_credito_vta_tributo->setOrden(Gral::getVars(1, "txt_orden", 0));
	$vta_nota_credito_vta_tributo->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$vta_nota_credito_vta_tributo->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$vta_nota_credito_vta_tributo->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$vta_nota_credito_vta_tributo->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$vta_nota_credito_vta_tributo->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$vta_nota_credito_vta_tributo->getId());
			}
		break;
		case 'guardarnvo':
			$error = $vta_nota_credito_vta_tributo->control();
	...
	if(trim($hdn_id) != ''){ 
		$vta_nota_credito_vta_tributo->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaNotaCreditoVtaTributo::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaNotaCreditoVtaTributo::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_NOTA_CREDITO_VTA_TRIBUTO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_nota_credito_vta_tributo'>
            ...
            <tr>
                <td id="label_cmb_vta_nota_credito_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_nota_credito_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=vta_nota_credito_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_nota_credito_id" clase_id="vta_nota_credito" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_nota_credito_id" <?php echo ($vta_nota_credito_vta_tributo->getVtaNotaCreditoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_nota_credito_id', Gral::getCmbFiltro(VtaNotaCredito::getVtaNotaCreditosCmb(), '...'), $vta_nota_credito_vta_tributo->getVtaNotaCreditoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_vta_tributo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_tributo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=vta_tributo_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_tributo_id" clase_id="vta_tributo" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_tributo_id" <?php echo ($vta_nota_credito_vta_tributo->getVtaTributoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_tributo_id', Gral::getCmbFiltro(VtaTributo::getVtaTributosCmb(), '...'), $vta_nota_credito_vta_tributo->getVtaTributoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txt_importe_imponible" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_importe_imponible' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=importe_imponible' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_importe_imponible" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('importe_imponible')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_importe_imponible' type='text' class='textbox <?php echo $error_input_css ?> moneda' id='txt_importe_imponible' value='<?php Gral::_echoTxt(Gral::getImporteDesdeDbToPriceFormat($vta_nota_credito_vta_tributo->getImporteImponible())) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_importe_tributo" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_importe_tributo' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=importe_tributo' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_importe_tributo" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('importe_tributo')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_importe_tributo' type='text' class='textbox <?php echo $error_input_css ?> moneda' id='txt_importe_tributo' value='<?php Gral::_echoTxt(Gral::getImporteDesdeDbToPriceFormat($vta_nota_credito_vta_tributo->getImporteTributo())) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_alicuota_porcentual" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_alicuota_porcentual' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=alicuota_porcentual' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_alicuota_porcentual" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('alicuota_porcentual')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_alicuota_porcentual' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_alicuota_porcentual' value='<?php Gral::_echoTxt($vta_nota_credito_vta_tributo->getAlicuotaPorcentual()) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_alicuota_decimal" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_alicuota_decimal' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=alicuota_decimal' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_alicuota_decimal" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('alicuota_decimal')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_alicuota_decimal' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_alicuota_decimal' value='<?php Gral::_echoTxt($vta_nota_credito_vta_tributo->getAlicuotaDecimal()) ?>' size='10' />
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_credito_vta_tributo_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($vta_nota_credito_vta_tributo->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_nota_credito_vta_tributo->getId()) ?>'/>
    ...
    <?php if(trim($vta_nota_credito_vta_tributo->getId()) != ''){ ?>

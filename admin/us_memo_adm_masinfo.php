...
<div class="masinfo-datos">
	...
	<div class="par inline">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($us_memo->getUsUsuario()->getDescripcion())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Codigo') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($us_memo->getCodigo())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($us_memo->getObservacion())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Orden') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($us_memo->getOrden())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'US_MEMO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($us_memo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($us_memo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'US_MEMO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($us_memo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($us_memo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('US_MEMO_MASINFO_US_MEMO_ESTADO')){ ?>
	...
	<div id="tab_us_memo_estado" class="bloque-relacion us_memo_estado">
            ...
            <h4><?php Lang::_lang('UsMemoEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('UsMemo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($us_memo->getUsMemoEstadosParaBloqueMasInfo() as $us_memo_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('US_MEMO_MASINFO_US_MEMO_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($us_memo_estado){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver UsMemoEstados de ') ?> <strong><?php echo($us_memo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
if(Gral::esPost()){
	...
	$pde_nota_credito_pde_tributo->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$pde_nota_credito_pde_tributo->setPdeNotaCreditoId(Gral::getVars(1, "cmb_pde_nota_credito_id", null));
	$pde_nota_credito_pde_tributo->setPdeTributoId(Gral::getVars(1, "cmb_pde_tributo_id", null));
	$pde_nota_credito_pde_tributo->setImporteImponible(Gral::getImporteDesdePriceFormatToDB(Gral::getVars(1, "txt_importe_imponible", 0)));
	$pde_nota_credito_pde_tributo->setImporteTributo(Gral::getImporteDesdePriceFormatToDB(Gral::getVars(1, "txt_importe_tributo", 0)));
	$pde_nota_credito_pde_tributo->setAlicuotaPorcentual(Gral::getVars(1, "txt_alicuota_porcentual", 0));
	$pde_nota_credito_pde_tributo->setAlicuotaDecimal(Gral::getVars(1, "txt_alicuota_decimal", 0));
	$pde_nota_credito_pde_tributo->setCodigo(Gral::getVars(1, "txt_codigo"));
	$pde_nota_credito_pde_tributo->setObservacion(Gral::getVars(1, "txa_observacion"));
	$pde_nota_credito_pde_tributo->setOrden(Gral::getVars(1, "txt_orden", 0));
	$pde_nota_credito_pde_tributo->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$pde_nota_credito_pde_tributo->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$pde_nota_credito_pde_tributo->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$pde_nota_credito_pde_tributo->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$pde_nota_credito_pde_tributo->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$pde_nota_credito_pde_tributo->getId());
			}
		break;
		case 'guardarnvo':
			$error = $pde_nota_credito_pde_tributo->control();
	...
	if(trim($hdn_id) != ''){ 
		$pde_nota_credito_pde_tributo->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(PdeNotaCreditoPdeTributo::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(PdeNotaCreditoPdeTributo::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('PDE_NOTA_CREDITO_PDE_TRIBUTO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_pde_nota_credito_pde_tributo'>
            ...
            <tr>
                <td id="label_cmb_pde_nota_credito_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_pde_nota_credito_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=pde_nota_credito_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_pde_nota_credito_id" clase_id="pde_nota_credito" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_pde_nota_credito_id" <?php echo ($pde_nota_credito_pde_tributo->getPdeNotaCreditoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_pde_nota_credito_id', Gral::getCmbFiltro(PdeNotaCredito::getPdeNotaCreditosCmb(), '...'), $pde_nota_credito_pde_tributo->getPdeNotaCreditoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_pde_tributo_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_pde_tributo_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=pde_tributo_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_pde_tributo_id" clase_id="pde_tributo" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_pde_tributo_id" <?php echo ($pde_nota_credito_pde_tributo->getPdeTributoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_pde_tributo_id', Gral::getCmbFiltro(PdeTributo::getPdeTributosCmb(), '...'), $pde_nota_credito_pde_tributo->getPdeTributoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txt_importe_imponible" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_importe_imponible' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=importe_imponible' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_importe_imponible" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('importe_imponible')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_importe_imponible' type='text' class='textbox <?php echo $error_input_css ?> moneda' id='txt_importe_imponible' value='<?php Gral::_echoTxt(Gral::getImporteDesdeDbToPriceFormat($pde_nota_credito_pde_tributo->getImporteImponible())) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_importe_tributo" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_importe_tributo' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=importe_tributo' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_importe_tributo" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('importe_tributo')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_importe_tributo' type='text' class='textbox <?php echo $error_input_css ?> moneda' id='txt_importe_tributo' value='<?php Gral::_echoTxt(Gral::getImporteDesdeDbToPriceFormat($pde_nota_credito_pde_tributo->getImporteTributo())) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_alicuota_porcentual" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_alicuota_porcentual' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=alicuota_porcentual' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_alicuota_porcentual" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('alicuota_porcentual')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_alicuota_porcentual' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_alicuota_porcentual' value='<?php Gral::_echoTxt($pde_nota_credito_pde_tributo->getAlicuotaPorcentual()) ?>' size='10' />
            ...
            <tr>
                <td id="label_txt_alicuota_decimal" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_alicuota_decimal' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=alicuota_decimal' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_alicuota_decimal" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('alicuota_decimal')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_alicuota_decimal' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_alicuota_decimal' value='<?php Gral::_echoTxt($pde_nota_credito_pde_tributo->getAlicuotaDecimal()) ?>' size='10' />
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_nota_credito_pde_tributo_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($pde_nota_credito_pde_tributo->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($pde_nota_credito_pde_tributo->getId()) ?>'/>
    ...
    <?php if(trim($pde_nota_credito_pde_tributo->getId()) != ''){ ?>

...
$cntb_cuenta_plan_id = Gral::getVars(2, 'id');
$cntb_cuenta_plan = CntbCuentaPlan::getOxId($cntb_cuenta_plan_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($cntb_cuenta_plan->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'CNTB_CUENTA_PLAN_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($cntb_cuenta_plan->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($cntb_cuenta_plan->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'CNTB_CUENTA_PLAN_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($cntb_cuenta_plan->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($cntb_cuenta_plan->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('CNTB_CUENTA_PLAN_MASINFO_CNTB_CUENTA')){ ?>
	...
	<div id="tab_cntb_cuenta" class="bloque-relacion cntb_cuenta">
            ...
            <h4><?php Lang::_lang('CntbCuenta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('CntbCuentaPlan') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($cntb_cuenta_plan->getCntbCuentasParaBloqueMasInfo() as $cntb_cuenta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('CNTB_CUENTA_PLAN_MASINFO_CNTB_CUENTA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($cntb_cuenta){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver CntbCuentas de ') ?> <strong><?php echo($cntb_cuenta_plan->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

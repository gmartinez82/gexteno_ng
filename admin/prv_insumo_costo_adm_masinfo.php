...
$prv_insumo_costo_id = Gral::getVars(2, 'id');
...
<div class="masinfo-datos">
	...
	<div class="par ">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($prv_insumo_costo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_INSUMO_COSTO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_insumo_costo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_insumo_costo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_INSUMO_COSTO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_insumo_costo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_insumo_costo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRV_INSUMO_COSTO_MASINFO_PDE_OC_AGRUPACION_ITEM')){ ?>
            <li><a href="#tab_pde_oc_agrupacion_item"><?php Lang::_lang('PdeOcAgrupacionItems') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PRV_INSUMO_COSTO_MASINFO_PDE_OC')){ ?>
	...
	<div id="tab_pde_oc_agrupacion_item" class="bloque-relacion pde_oc_agrupacion_item">
            ...
            <h4><?php Lang::_lang('PdeOcAgrupacionItem') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrvInsumoCosto') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prv_insumo_costo->getPdeOcAgrupacionItemsParaBloqueMasInfo() as $pde_oc_agrupacion_item){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRV_INSUMO_COSTO_MASINFO_PDE_OC_AGRUPACION_ITEM_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_oc_agrupacion_item){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeOcAgrupacionItems de ') ?> <strong><?php echo($prv_insumo_costo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_oc" class="bloque-relacion pde_oc">
            ...
            <h4><?php Lang::_lang('PdeOc') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrvInsumoCosto') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prv_insumo_costo->getPdeOcsParaBloqueMasInfo() as $pde_oc){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRV_INSUMO_COSTO_MASINFO_PDE_OC_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_oc){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeOcs de ') ?> <strong><?php echo($prv_insumo_costo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

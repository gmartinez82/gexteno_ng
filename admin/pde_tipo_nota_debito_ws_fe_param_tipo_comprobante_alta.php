...
if(Gral::esPost()){
	...
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setPdeTipoNotaDebitoId(Gral::getVars(1, "cmb_pde_tipo_nota_debito_id", null));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setWsFeParamTipoComprobanteId(Gral::getVars(1, "cmb_ws_fe_param_tipo_comprobante_id", null));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setCodigo(Gral::getVars(1, "txt_codigo"));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setObservacion(Gral::getVars(1, "txa_observacion"));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setOrden(Gral::getVars(1, "txt_orden", 0));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getId());
			}
		break;
		case 'guardarnvo':
			$error = $pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->control();
	...
	if(trim($hdn_id) != ''){ 
		$pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(PdeTipoNotaDebitoWsFeParamTipoComprobante::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(PdeTipoNotaDebitoWsFeParamTipoComprobante::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('PDE_TIPO_NOTA_DEBITO_WS_FE_PARAM_TIPO_COMPROBANTE_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_pde_tipo_nota_debito_ws_fe_param_tipo_comprobante'>
            ...
            <tr>
                <td id="label_cmb_pde_tipo_nota_debito_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_pde_tipo_nota_debito_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_tipo_nota_debito_ws_fe_param_tipo_comprobante_alta&atributo=pde_tipo_nota_debito_id' modulo_metodo_init='setInit()'>
		...
		<?php Html::html_dib_select(1, 'cmb_pde_tipo_nota_debito_id', Gral::getCmbFiltro(PdeTipoNotaDebito::getPdeTipoNotaDebitosCmb(), '...'), $pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getPdeTipoNotaDebitoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_ws_fe_param_tipo_comprobante_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_ws_fe_param_tipo_comprobante_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_tipo_nota_debito_ws_fe_param_tipo_comprobante_alta&atributo=ws_fe_param_tipo_comprobante_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_ws_fe_param_tipo_comprobante_id', Gral::getCmbFiltro(WsFeParamTipoComprobante::getWsFeParamTipoComprobantesCmb(), '...'), $pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getWsFeParamTipoComprobanteId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=pde_tipo_nota_debito_ws_fe_param_tipo_comprobante_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getId()) ?>'/>
    ...
    <?php if(trim($pde_tipo_nota_debito_ws_fe_param_tipo_comprobante->getId()) != ''){ ?>

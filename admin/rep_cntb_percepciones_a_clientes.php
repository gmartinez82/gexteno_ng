...
$db_nombre_objeto = 'rep_cntb_percepciones_a_clientes';
$db_nombre_pagina = 'rep_cntb_percepciones_a_clientes';

if (Gral::esPost()) {

    $cmb_filtro_vta_tributo_id = Gral::getVars(1, 'cmb_filtro_vta_tributo_id', 0);
    ...
    include "rep_cntb_percepciones_a_clientes_xlsx.php";
}
else {
        ...
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    ...
                    <div class="titulo">
                        <?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Percepciones a Clientes') ?>
                    </div>

                    <div class="par">
                        <div class="label"><?php Lang::_lang('Tributo') ?></div>
                        <div class="dato">
                            <?php Html::html_dib_select(1, 'cmb_filtro_vta_tributo_id', Gral::getCmbFiltro(VtaTributo::getVtaTributosCmb(true), '...'), $cmb_filtro_vta_tributo_id, 'textbox') ?>
                        </div>
                    </div>
                    ...
                    <div class="botonera">
                        <input id="btn_enviar" name="btn_enviar" class="boton" type="submit" value="<?php Lang::_lang('Ver Reporte de Percepciones a Clientes') ?>" />
                    </div>

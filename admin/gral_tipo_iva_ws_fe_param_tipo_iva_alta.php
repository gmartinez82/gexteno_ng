...
if(Gral::esPost()){
	...
	$gral_tipo_iva_ws_fe_param_tipo_iva->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setGralTipoIvaId(Gral::getVars(1, "cmb_gral_tipo_iva_id", null));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setWsFeParamTipoIvaId(Gral::getVars(1, "cmb_ws_fe_param_tipo_iva_id", null));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setCodigo(Gral::getVars(1, "txt_codigo"));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setObservacion(Gral::getVars(1, "txa_observacion"));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setOrden(Gral::getVars(1, "txt_orden", 0));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$gral_tipo_iva_ws_fe_param_tipo_iva->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$gral_tipo_iva_ws_fe_param_tipo_iva->getId());
			}
		break;
		case 'guardarnvo':
			$error = $gral_tipo_iva_ws_fe_param_tipo_iva->control();
	...
	if(trim($hdn_id) != ''){ 
		$gral_tipo_iva_ws_fe_param_tipo_iva->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(GralTipoIvaWsFeParamTipoIva::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(GralTipoIvaWsFeParamTipoIva::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('GRAL_TIPO_IVA_WS_FE_PARAM_TIPO_IVA_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_gral_tipo_iva_ws_fe_param_tipo_iva'>
            ...
            <tr>
                <td id="label_cmb_gral_tipo_iva_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_tipo_iva_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_tipo_iva_ws_fe_param_tipo_iva_alta&atributo=gral_tipo_iva_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_tipo_iva_id" clase_id="gral_tipo_iva" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_tipo_iva_id" <?php echo ($gral_tipo_iva_ws_fe_param_tipo_iva->getGralTipoIvaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_tipo_iva_id', Gral::getCmbFiltro(GralTipoIva::getGralTipoIvasCmb(), '...'), $gral_tipo_iva_ws_fe_param_tipo_iva->getGralTipoIvaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_ws_fe_param_tipo_iva_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_ws_fe_param_tipo_iva_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_tipo_iva_ws_fe_param_tipo_iva_alta&atributo=ws_fe_param_tipo_iva_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_ws_fe_param_tipo_iva_id" clase_id="ws_fe_param_tipo_iva" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_ws_fe_param_tipo_iva_id" <?php echo ($gral_tipo_iva_ws_fe_param_tipo_iva->getWsFeParamTipoIvaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_ws_fe_param_tipo_iva_id', Gral::getCmbFiltro(WsFeParamTipoIva::getWsFeParamTipoIvasCmb(), '...'), $gral_tipo_iva_ws_fe_param_tipo_iva->getWsFeParamTipoIvaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_tipo_iva_ws_fe_param_tipo_iva_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($gral_tipo_iva_ws_fe_param_tipo_iva->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($gral_tipo_iva_ws_fe_param_tipo_iva->getId()) ?>'/>
    ...
    <?php if(trim($gral_tipo_iva_ws_fe_param_tipo_iva->getId()) != ''){ ?>

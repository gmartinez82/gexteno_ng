...
$c = new Criterio();
$c->addTabla('pde_nota_debito_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $pde_nota_debito->getPdeNotaDebitoImagens(null, $c);
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PdeNotaDebitoImagens') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <?php include "ajax/modulos/pde_nota_debito_imagen/pde_nota_debito_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/pde_nota_debito_imagen/pde_nota_debito_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

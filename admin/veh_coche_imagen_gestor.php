...
$c = new Criterio();
$c->addTabla('veh_coche_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $veh_coche->getVehCocheImagens(null, $c);

$clase = "VehCoche";
$tabla = "veh_coche";
$padre = $veh_coche->getId();
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('VehCocheImagens') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="botonera">
                    <div class="boton volver"><a href="<?php Gral::_echo(VehCoche::getInfoBtnVolver('url')) ?>"><?php Lang::_lang(VehCoche::getInfoBtnVolver('label')) ?></a></div>
                    <div class="boton editar"><a href="veh_coche_alta.php?id=<?php Gral::_echo($veh_coche->getId()) ?>"><?php Lang::_lang('Editar') ?> <strong><?php Gral::_echo($veh_coche->getDescripcion()) ?></strong></a></div>
                </div>

                
                <?php include "ajax/modulos/veh_coche_imagen/veh_coche_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/veh_coche_imagen/veh_coche_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

...
$gral_empresa_id = Gral::getVars(2, 'id');
...
<div class="masinfo-datos">
	...
	<div class="par inline">
            ...
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getGralTipoPersoneria()->getDescripcion())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('GralCondicionIva') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getGralCondicionIva()->getDescripcion())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('CUIT') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getCuit())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Domicilio Legal') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getDomicilioLegal())) ?></div>
	</div>

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Fecha Inicio Act') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br(Gral::getFechaToWeb($gral_empresa->getFechaInicioActividad()))) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('AFIP CRT') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getAfipCrt())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('AFIP KEY') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getAfipKey())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($gral_empresa->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GRAL_EMPRESA_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gral_empresa->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gral_empresa->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'GRAL_EMPRESA_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($gral_empresa->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($gral_empresa->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_GRAL_SUCURSAL')){ ?>
            <li><a href="#tab_gral_sucursal"><?php Lang::_lang('GralSucursal') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_NOTA_CREDITO')){ ?>
            <li><a href="#tab_vta_nota_credito"><?php Lang::_lang('VtaNotaCredito') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_NOTA_DEBITO')){ ?>
            <li><a href="#tab_vta_nota_debito"><?php Lang::_lang('VtaNotaDebito') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_RECIBO')){ ?>
            <li><a href="#tab_vta_recibo"><?php Lang::_lang('VtaRecibo') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_PUNTO_VENTA')){ ?>
            <li><a href="#tab_vta_punto_venta"><?php Lang::_lang('VtaPuntoVenta') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_FACTURA')){ ?>
            <li><a href="#tab_vta_factura"><?php Lang::_lang('VtaFactura') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_WS_FE_PARAM_PUNTO_VENTA')){ ?>
            <li><a href="#tab_ws_fe_param_punto_venta"><?php Lang::_lang('WsFeParamPuntoVenta') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_WS_FE_OPE_SOLICITUD')){ ?>
            <li><a href="#tab_ws_fe_ope_solicitud"><?php Lang::_lang('WsFeOpeSolicitud') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_FACTURA')){ ?>
            <li><a href="#tab_pde_factura"><?php Lang::_lang('PdeFactura') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_NOTA_CREDITO')){ ?>
            <li><a href="#tab_pde_nota_credito"><?php Lang::_lang('PdeNotaCredito') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_NOTA_DEBITO')){ ?>
            <li><a href="#tab_pde_nota_debito"><?php Lang::_lang('PdeNotaDebito') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_RECIBO')){ ?>
            <li><a href="#tab_pde_recibo"><?php Lang::_lang('PdeRecibo') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_ORDEN_PAGO')){ ?>
            <li><a href="#tab_pde_orden_pago"><?php Lang::_lang('PdeOrdenPagos') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_CNTB_EJERCICIO')){ ?>
            <li><a href="#tab_cntb_ejercicio"><?php Lang::_lang('CntbEjercicios') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_CNTB_PERIODO')){ ?>
            <li><a href="#tab_cntb_periodo"><?php Lang::_lang('CntbPeriodos') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_AFIP_CITI_PRC')){ ?>
	...
	<div id="tab_gral_sucursal" class="bloque-relacion gral_sucursal">
            ...
            <h4><?php Lang::_lang('GralSucursal') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getGralSucursalsParaBloqueMasInfo() as $gral_sucursal){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_GRAL_SUCURSAL_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($gral_sucursal){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo GralSucursal::getFiltrosArrGral() ?>&arr=<?php echo $gral_sucursal->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver GralSucursals de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_nota_credito" class="bloque-relacion vta_nota_credito">
            ...
            <h4><?php Lang::_lang('VtaNotaCredito') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getVtaNotaCreditosParaBloqueMasInfo() as $vta_nota_credito){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_NOTA_CREDITO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_nota_credito){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaNotaCreditos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_nota_debito" class="bloque-relacion vta_nota_debito">
            ...
            <h4><?php Lang::_lang('VtaNotaDebito') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getVtaNotaDebitosParaBloqueMasInfo() as $vta_nota_debito){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_NOTA_DEBITO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_nota_debito){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaNotaDebitos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_recibo" class="bloque-relacion vta_recibo">
            ...
            <h4><?php Lang::_lang('VtaRecibo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getVtaRecibosParaBloqueMasInfo() as $vta_recibo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_RECIBO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_recibo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaRecibos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_punto_venta" class="bloque-relacion vta_punto_venta">
            ...
            <h4><?php Lang::_lang('VtaPuntoVenta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getVtaPuntoVentasParaBloqueMasInfo() as $vta_punto_venta){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_PUNTO_VENTA_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($vta_punto_venta){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo VtaPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $vta_punto_venta->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver VtaPuntoVentas de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_factura" class="bloque-relacion vta_factura">
            ...
            <h4><?php Lang::_lang('VtaFactura') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getVtaFacturasParaBloqueMasInfo() as $vta_factura){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_VTA_FACTURA_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($vta_factura){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo VtaFactura::getFiltrosArrGral() ?>&arr=<?php echo $vta_factura->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver VtaFacturas de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_WS_FE_PARAM_PUNTO_VENTA')){ ?>
	<div id="tab_ws_fe_param_punto_venta" class="bloque-relacion ws_fe_param_punto_venta">
		
            <h4><?php Lang::_lang('WsFeParamPuntoVenta') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getWsFeParamPuntoVentasParaBloqueMasInfo() as $ws_fe_param_punto_venta){ ?>
                    <div class="uno">
                        <div class="id"><?php Gral::_echo($ws_fe_param_punto_venta->getId()) ?></div>
                        <div class="descripcion">
                        					
                        <?php Gral::_echo($ws_fe_param_punto_venta->getDescripcionBloqueMasInfo()) ?>					
                        </div>

                        <div class="creado">
                            <label class="fecha-creado" title="<?php Lang::_lang('Creado Por') ?>: <?php Gral::_echo($ws_fe_param_punto_venta->getCreadoPorDescripcion()) ?>"><?php Gral::_echo(Gral::getFechaHoraToWeb($ws_fe_param_punto_venta->getCreado())) ?> h</label><br/>
					
                            <label class="fecha-modificado" title="<?php Lang::_lang('Modificado Por') ?>: <?php Gral::_echo($ws_fe_param_punto_venta->getModificadoPorDescripcion()) ?>"><?php Gral::_echo(Gral::getFechaHoraToWeb($ws_fe_param_punto_venta->getModificado())) ?> h</label>					

                        </div>

                        <div class="acciones">

                            <div class="accion trigger wopenModal" contenedor="div_modal" elemento_id="<?php echo $ws_fe_param_punto_venta->getId() ?>" archivo="ajax/modulos/ws_fe_param_punto_venta/ws_fe_param_punto_venta_ficha.php" ancho="600" alto="500" title="<?php Lang::_lang('Ficha de') ?> <?php Lang::_lang('WsFeParamPuntoVenta') ?>"  post="">
                                    <img src="imgs/icn_ver_mas.png" width="20">
                            </div>

                            <?php if(UsCredencial::getEsAcreditado('WS_FE_PARAM_PUNTO_VENTA_ALTA')){ ?>
                            <div class="accion" title="<?php Lang::_lang('Editar') ?> <?php Lang::_lang('WsFeParamPuntoVenta') ?>">
                                <a href="ws_fe_param_punto_venta_alta.php?id=<?php echo $ws_fe_param_punto_venta->getId() ?>"><img src="imgs/btn_modi.gif" width="20"></a>
                            </div>
                            <?php } ?>
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_WS_FE_PARAM_PUNTO_VENTA_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($ws_fe_param_punto_venta){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo WsFeParamPuntoVenta::getFiltrosArrGral() ?>&arr=<?php echo $ws_fe_param_punto_venta->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver WsFeParamPuntoVentas de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
                            <a href="ws_fe_param_punto_venta_alta.php" >
                            <?php Lang::_lang('Agregar WsFeParamPuntoVenta') ?>
                            </a>				
                        </div>
	...
	<div id="tab_ws_fe_ope_solicitud" class="bloque-relacion ws_fe_ope_solicitud">
            ...
            <h4><?php Lang::_lang('WsFeOpeSolicitud') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getWsFeOpeSolicitudsParaBloqueMasInfo() as $ws_fe_ope_solicitud){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_WS_FE_OPE_SOLICITUD_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($ws_fe_ope_solicitud){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo WsFeOpeSolicitud::getFiltrosArrGral() ?>&arr=<?php echo $ws_fe_ope_solicitud->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver WsFeOpeSolicituds de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_factura" class="bloque-relacion pde_factura">
            ...
            <h4><?php Lang::_lang('PdeFactura') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getPdeFacturasParaBloqueMasInfo() as $pde_factura){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_FACTURA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_factura){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeFacturas de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_nota_credito" class="bloque-relacion pde_nota_credito">
            ...
            <h4><?php Lang::_lang('PdeNotaCredito') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getPdeNotaCreditosParaBloqueMasInfo() as $pde_nota_credito){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_NOTA_CREDITO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($pde_nota_credito){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PdeNotaCredito::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_credito->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver PdeNotaCreditos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_nota_debito" class="bloque-relacion pde_nota_debito">
            ...
            <h4><?php Lang::_lang('PdeNotaDebito') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getPdeNotaDebitosParaBloqueMasInfo() as $pde_nota_debito){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_NOTA_DEBITO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($pde_nota_debito){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PdeNotaDebito::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver PdeNotaDebitos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_recibo" class="bloque-relacion pde_recibo">
            ...
            <h4><?php Lang::_lang('PdeRecibo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getPdeRecibosParaBloqueMasInfo() as $pde_recibo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_RECIBO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($pde_recibo){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PdeRecibo::getFiltrosArrGral() ?>&arr=<?php echo $pde_recibo->getFiltrosArrXCampo('GralEmpresa', 'gral_empresa_id') ?>" >
                                <?php Lang::_lang('Ver PdeRecibos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_orden_pago" class="bloque-relacion pde_orden_pago">
            ...
            <h4><?php Lang::_lang('PdeOrdenPago') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getPdeOrdenPagosParaBloqueMasInfo() as $pde_orden_pago){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_PDE_ORDEN_PAGO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_orden_pago){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeOrdenPagos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_CNTB_EJERCICIO')){ ?>
	<div id="tab_cntb_ejercicio" class="bloque-relacion cntb_ejercicio">
		
            <h4><?php Lang::_lang('CntbEjercicio') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getCntbEjerciciosParaBloqueMasInfo() as $cntb_ejercicio){ ?>
                    <div class="uno">
                        <div class="id"><?php Gral::_echo($cntb_ejercicio->getId()) ?></div>
                        <div class="descripcion">
                        					
                        <?php Gral::_echo($cntb_ejercicio->getDescripcionBloqueMasInfo()) ?>					
                        </div>

                        <div class="creado">
                            <label class="fecha-creado" title="<?php Lang::_lang('Creado Por') ?>: <?php Gral::_echo($cntb_ejercicio->getCreadoPorDescripcion()) ?>"><?php Gral::_echo(Gral::getFechaHoraToWeb($cntb_ejercicio->getCreado())) ?> h</label><br/>
					
                            <label class="fecha-modificado" title="<?php Lang::_lang('Modificado Por') ?>: <?php Gral::_echo($cntb_ejercicio->getModificadoPorDescripcion()) ?>"><?php Gral::_echo(Gral::getFechaHoraToWeb($cntb_ejercicio->getModificado())) ?> h</label>					

                        </div>

                        <div class="acciones">

                            <div class="accion trigger wopenModal" contenedor="div_modal" elemento_id="<?php echo $cntb_ejercicio->getId() ?>" archivo="ajax/modulos/cntb_ejercicio/cntb_ejercicio_ficha.php" ancho="600" alto="500" title="<?php Lang::_lang('Ficha de') ?> <?php Lang::_lang('CntbEjercicio') ?>"  post="">
                                    <img src="imgs/icn_ver_mas.png" width="20">
                            </div>

                            <?php if(UsCredencial::getEsAcreditado('CNTB_EJERCICIO_ALTA')){ ?>
                            <div class="accion" title="<?php Lang::_lang('Editar') ?> <?php Lang::_lang('CntbEjercicio') ?>">
                                <a href="cntb_ejercicio_alta.php?id=<?php echo $cntb_ejercicio->getId() ?>"><img src="imgs/btn_modi.gif" width="20"></a>
                            </div>
                            <?php } ?>
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_CNTB_EJERCICIO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($cntb_ejercicio){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver CntbEjercicios de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
                            <a href="cntb_ejercicio_alta.php" >
                            <?php Lang::_lang('Agregar CntbEjercicio') ?>
                            </a>				
                        </div>
	...
	<div id="tab_cntb_periodo" class="bloque-relacion cntb_periodo">
            ...
            <h4><?php Lang::_lang('CntbPeriodo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getCntbPeriodosParaBloqueMasInfo() as $cntb_periodo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_CNTB_PERIODO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($cntb_periodo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver CntbPeriodos de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_afip_citi_prc" class="bloque-relacion afip_citi_prc">
            ...
            <h4><?php Lang::_lang('AfipCitiPrc') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('GralEmpresa') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($gral_empresa->getAfipCitiPrcsParaBloqueMasInfo() as $afip_citi_prc){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('GRAL_EMPRESA_MASINFO_AFIP_CITI_PRC_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($afip_citi_prc){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver AfipCitiPrcs de ') ?> <strong><?php echo($gral_empresa->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

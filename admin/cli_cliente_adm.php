...
$db_nombre_pagina = 'cli_cliente_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="cli_cliente">
              <?php include 'ajax/modulos/cli_cliente/cli_cliente_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="cli_cliente">
              <?php //include 'ajax/modulos/cli_cliente/cli_cliente_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('cli_cliente', <?php echo $pagina_actual ?>);
</script>

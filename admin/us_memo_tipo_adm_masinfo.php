...
$us_memo_tipo_id = Gral::getVars(2, 'id');
$us_memo_tipo = UsMemoTipo::getOxId($us_memo_tipo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($us_memo_tipo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'US_MEMO_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($us_memo_tipo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($us_memo_tipo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'US_MEMO_TIPO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($us_memo_tipo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($us_memo_tipo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('US_MEMO_TIPO_MASINFO_US_MEMO')){ ?>
	...
	<div id="tab_us_memo" class="bloque-relacion us_memo">
            ...
            <h4><?php Lang::_lang('UsMemo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('UsMemoTipo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($us_memo_tipo->getUsMemosParaBloqueMasInfo() as $us_memo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('US_MEMO_TIPO_MASINFO_US_MEMO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($us_memo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver UsMemos de ') ?> <strong><?php echo($us_memo_tipo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

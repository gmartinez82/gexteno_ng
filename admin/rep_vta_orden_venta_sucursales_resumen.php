...
$db_nombre_objeto = "rep_vta_orden_venta_sucursales_resumen";
$db_nombre_pagina = "rep_vta_orden_venta_sucursales_resumen";
...
if (Gral::esPost()) {
    ...
    include "rep_vta_orden_venta_sucursales_resumen_xlsx.php";
} else {
    //$txt_desde = '';
    //$txt_hasta = '';
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('Vta Orden Venta Sucursales Resumen') ?> </div>
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    ...
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Lista de VtaOrdenVentaSucursalesResumen') ?></div>

...
$prd_param_tipo_operacion_id = Gral::getVars(2, 'id');
$prd_param_tipo_operacion = PrdParamTipoOperacion::getOxId($prd_param_tipo_operacion_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prd_param_tipo_operacion->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_PARAM_TIPO_OPERACION_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_param_tipo_operacion->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_param_tipo_operacion->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRD_PARAM_TIPO_OPERACION_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prd_param_tipo_operacion->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prd_param_tipo_operacion->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRD_PARAM_TIPO_OPERACION_MASINFO_PRD_PARAM_OPERACION')){ ?>
	...
	<div id="tab_prd_param_operacion" class="bloque-relacion prd_param_operacion">
            ...
            <h4><?php Lang::_lang('PrdParamOperacion') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrdParamTipoOperacion') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prd_param_tipo_operacion->getPrdParamOperacionsParaBloqueMasInfo() as $prd_param_operacion){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRD_PARAM_TIPO_OPERACION_MASINFO_PRD_PARAM_OPERACION_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($prd_param_operacion){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PrdParamOperacions de ') ?> <strong><?php echo($prd_param_tipo_operacion->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

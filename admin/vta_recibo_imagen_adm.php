...
$pagina_actual = VtaReciboImagen::getSesPag();
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="vta_recibo_imagen">
              <?php include 'ajax/modulos/vta_recibo_imagen/vta_recibo_imagen_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="vta_recibo_imagen">
              <?php //include 'ajax/modulos/vta_recibo_imagen/vta_recibo_imagen_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('vta_recibo_imagen', <?php echo $pagina_actual ?>);
</script>

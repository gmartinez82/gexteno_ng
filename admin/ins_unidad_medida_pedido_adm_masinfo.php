...
$ins_unidad_medida_pedido_id = Gral::getVars(2, 'id');
$ins_unidad_medida_pedido = InsUnidadMedidaPedido::getOxId($ins_unidad_medida_pedido_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($ins_unidad_medida_pedido->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_UNIDAD_MEDIDA_PEDIDO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_unidad_medida_pedido->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_unidad_medida_pedido->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_UNIDAD_MEDIDA_PEDIDO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_unidad_medida_pedido->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_unidad_medida_pedido->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('INS_UNIDAD_MEDIDA_PEDIDO_MASINFO_INS_INSUMO')){ ?>
	...
	<div id="tab_ins_insumo" class="bloque-relacion ins_insumo">
            ...
            <h4><?php Lang::_lang('InsInsumo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('InsUnidadMedidaPedido') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($ins_unidad_medida_pedido->getInsInsumosParaBloqueMasInfo() as $ins_insumo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('INS_UNIDAD_MEDIDA_PEDIDO_MASINFO_INS_INSUMO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($ins_insumo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver InsInsumos de ') ?> <strong><?php echo($ins_unidad_medida_pedido->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

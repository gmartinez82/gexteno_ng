...
$db_nombre_pagina = 'pde_factura_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="pde_factura">
              <?php include 'ajax/modulos/pde_factura/pde_factura_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="pde_factura">
              <?php //include 'ajax/modulos/pde_factura/pde_factura_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('pde_factura', <?php echo $pagina_actual ?>);
</script>

...
$c->setCriterios();
$archivos = $os_orden_servicio->getOsOrdenServicioArchivos(null, $c);
            ...
            <div class="archivos" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="bloque-archivos">
                    ...
                    <div id="div_grupo_archivo_<?php Gral::_echo($archivo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($archivo->getId()) ?>" >
                        <?php
                        include "ajax/modulos/os_orden_servicio_archivo/os_orden_servicio_archivo_uno.php";
                        ?>
                    </div>
                    <?php } ?>
                </div>
                ...
                <?php include "ajax/modulos/os_orden_servicio_archivo/os_orden_servicio_archivo_masivo.php" ?>

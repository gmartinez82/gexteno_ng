...
if (Gral::esPost()) {
    ...
    $txt_creado_desde_to_db = Gral::getFechaToDB($txt_creado_desde);
    $txt_creado_hasta_to_db = Gral::getFechaToDB($txt_creado_hasta);
    ...
    $txt_modificado_desde_to_db = Gral::getFechaToDB($txt_modificado_desde);
    $txt_modificado_hasta_to_db = Gral::getFechaToDB($txt_modificado_hasta);
    //Campos Strings
    ...
    include "rep_cli_cliente_php_excel.php";
} else {
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('CliCliente') ?></div>

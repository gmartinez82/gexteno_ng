...
if(Gral::esPost()){
    ...
    $gral_sucursal_valoracion_agrupacion = GralSucursalValoracionAgrupacion::getOxId($hdn_id);
    if(!$gral_sucursal_valoracion_agrupacion){
        ...
        // -----------------------------------------------------------------
        if($gral_sucursal_valoracion_agrupacion){
            if(GralSucursalValoracionAgrupacion::GEN_CONTROL_ALCANCE){
                if($gral_sucursal_valoracion_agrupacion->getHash() != $hdn_hash){

                    header('Location: us_noautorizado.php?tipo=HASH&clase=GralSucursalValoracionAgrupacion&id='.$gral_sucursal_valoracion_agrupacion->getId().'&cod='.$hdn_hash);
                    exit;
                }
            }            
        }            
	...
	$gral_sucursal_valoracion_agrupacion->setApellido(Gral::getVars(1, "txt_apellido"));
	$gral_sucursal_valoracion_agrupacion->setNombre(Gral::getVars(1, "txt_nombre"));
	$gral_sucursal_valoracion_agrupacion->setEmail(Gral::getVars(1, "txt_email"));
	$gral_sucursal_valoracion_agrupacion->setTelefono(Gral::getVars(1, "txt_telefono"));
	$gral_sucursal_valoracion_agrupacion->setFecha(Gral::getFechaToDb(Gral::getVars(1, "txt_fecha")));
	$gral_sucursal_valoracion_agrupacion->setGralSucursalId(Gral::getVars(1, "cmb_gral_sucursal_id", null));
	$gral_sucursal_valoracion_agrupacion->setValoracion(Gral::getVars(1, "txt_valoracion", 0));
	$gral_sucursal_valoracion_agrupacion->setObservacion(Gral::getVars(1, "txa_observacion"));
    }
    if(UsCredencial::getEsAcreditado('GRAL_SUCURSAL_VALORACION_AGRUPACION_ALTA_AVANZADA')){ 
    }
	...
	switch($accion){
            case 'guardar':
                ...
                if(!$error->getExisteError()){
                    ...
                    header('Location: ?cs=1&id='.$gral_sucursal_valoracion_agrupacion->getId().'&hash='.$gral_sucursal_valoracion_agrupacion->getHash());
                    exit;
                }
            break;
            case 'guardarnvo':
	...
	if(trim($hdn_id) != 0){ 
            $gral_sucursal_valoracion_agrupacion->setId($hdn_id);
            ...
            if($gral_sucursal_valoracion_agrupacion){
                if(GralSucursalValoracionAgrupacion::GEN_CONTROL_ALCANCE){
                    if($gral_sucursal_valoracion_agrupacion->getHash() != $hash){
                        ...
                        header('Location: us_noautorizado.php?tipo=HASH&clase=GralSucursalValoracionAgrupacion&id='.$gral_sucursal_valoracion_agrupacion->getId().'&cod='.$hash);
                        exit;
                    }
                }
            }            
...
<div id='cuerpo' >
    <form id='formu' name='formu' method='post' action='' modulo='gral_sucursal_valoracion_agrupacion' >
    
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('GralSucursalValoracionAgrupacions') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(GralSucursalValoracionAgrupacion::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(GralSucursalValoracionAgrupacion::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('GRAL_SUCURSAL_VALORACION_AGRUPACION_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_gral_sucursal_valoracion_agrupacion'>
            ...
            <tr>
                <td id="label_txt_apellido" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_apellido' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=apellido' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_txt_apellido" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('apellido')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_apellido' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_apellido' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getApellido()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_apellido_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_apellido_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_nombre" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_nombre' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=nombre' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_nombre" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('nombre')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_nombre' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_nombre' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getNombre()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_nombre_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_nombre_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_email" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_email' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=email' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_email" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('email')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_email' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_email' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getEmail()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_email_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_email_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_telefono" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_telefono' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=telefono' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_telefono" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('telefono')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_telefono' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_telefono' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getTelefono()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_telefono_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_telefono_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_fecha" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_fecha' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=fecha' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_fecha" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('fecha')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_fecha' type='text' class='textbox <?php echo $error_input_css ?> datetime' id='txt_fecha' value='<?php Gral::_echoTxt(Gral::getFechaToWeb($gral_sucursal_valoracion_agrupacion->getFecha())) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_fecha_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_fecha_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_cmb_gral_sucursal_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_sucursal_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=gral_sucursal_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_sucursal_id" clase_id="gral_sucursal" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_sucursal_id" <?php echo ($gral_sucursal_valoracion_agrupacion->getGralSucursalId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_sucursal_id', Gral::getCmbFiltro(GralSucursal::getGralSucursalsCmb(true), '...'), $gral_sucursal_valoracion_agrupacion->getGralSucursalId(), 'textbox  '.$error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_gral_sucursal_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_gral_sucursal_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txt_valoracion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_valoracion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=valoracion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_valoracion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('valoracion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_valoracion' type='text' class='textbox <?php echo $error_input_css ?> spinner' id='txt_valoracion' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getValoracion()) ?>' size='40' autocomplete='off' />
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_valoracion_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_valoracion_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_sucursal_valoracion_agrupacion_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='7' cols='60' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getObservacion()) ?></textarea>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_observacion_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/gral_sucursal_valoracion_agrupacion/gral_sucursal_valoracion_agrupacion_alta_campo_observacion_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'>
            <input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getId()) ?>'/>
            <input name='hdn_hash' type='hidden' id='hdn_hash' size='5' value='<?php Gral::_echoTxt($gral_sucursal_valoracion_agrupacion->getHash()) ?>'/>
    ...
    <?php if(trim($gral_sucursal_valoracion_agrupacion->getId()) != ''){ ?>

...
$pdi_urgencia_id = Gral::getVars(2, 'id');
$pdi_urgencia = PdiUrgencia::getOxId($pdi_urgencia_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($pdi_urgencia->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDI_URGENCIA_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pdi_urgencia->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pdi_urgencia->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDI_URGENCIA_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pdi_urgencia->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pdi_urgencia->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PDI_URGENCIA_MASINFO_PDI_PEDIDO')){ ?>
            <li><a href="#tab_pdi_pedido"><?php Lang::_lang('PdiPedidos') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PDI_URGENCIA_MASINFO_PDI_PEDIDO_AGRUPACION')){ ?>
	...
	<div id="tab_pdi_pedido" class="bloque-relacion pdi_pedido">
            ...
            <h4><?php Lang::_lang('PdiPedido') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdiUrgencia') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pdi_urgencia->getPdiPedidosParaBloqueMasInfo() as $pdi_pedido){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDI_URGENCIA_MASINFO_PDI_PEDIDO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($pdi_pedido){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PdiPedido::getFiltrosArrGral() ?>&arr=<?php echo $pdi_pedido->getFiltrosArrXCampo('PdiUrgencia', 'pdi_urgencia_id') ?>" >
                                <?php Lang::_lang('Ver PdiPedidos de ') ?> <strong><?php echo($pdi_urgencia->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pdi_pedido_agrupacion" class="bloque-relacion pdi_pedido_agrupacion">
            ...
            <h4><?php Lang::_lang('PdiPedidoAgrupacion') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdiUrgencia') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pdi_urgencia->getPdiPedidoAgrupacionsParaBloqueMasInfo() as $pdi_pedido_agrupacion){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDI_URGENCIA_MASINFO_PDI_PEDIDO_AGRUPACION_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pdi_pedido_agrupacion){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdiPedidoAgrupacions de ') ?> <strong><?php echo($pdi_urgencia->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$db_nombre_objeto = "rep_pde_factura";
$db_nombre_pagina = "rep_pde_factura";
...
if (Gral::esPost())
{
    ...
    $cmb_filtro_pde_factura_tipo_estado_id = Gral::getVars(1, 'cmb_filtro_pde_factura_tipo_estado_id', 0);
    $cmb_filtro_pde_tipo_factura_id        = Gral::getVars(1, 'cmb_filtro_pde_tipo_factura_id', 0);
    
    include "rep_pde_factura_xlsx.php";
}
else
{
    //$txt_desde = '';
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PDE Factura') ?> </div>
        <div class='contenedor central reportes'>
            <br />	
            <br />	
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Lista de PdeFactura') ?></div>
                    <div class="par">

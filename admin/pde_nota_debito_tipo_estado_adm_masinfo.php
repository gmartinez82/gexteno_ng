...
$pde_nota_debito_tipo_estado_id = Gral::getVars(2, 'id');
$pde_nota_debito_tipo_estado = PdeNotaDebitoTipoEstado::getOxId($pde_nota_debito_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($pde_nota_debito_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDE_NOTA_DEBITO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pde_nota_debito_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pde_nota_debito_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PDE_NOTA_DEBITO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pde_nota_debito_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pde_nota_debito_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PDE_NOTA_DEBITO_TIPO_ESTADO_MASINFO_PDE_NOTA_DEBITO')){ ?>
            <li><a href="#tab_pde_nota_debito"><?php Lang::_lang('PdeNotaDebito') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PDE_NOTA_DEBITO_TIPO_ESTADO_MASINFO_PDE_NOTA_DEBITO_ESTADO')){ ?>
	...
	<div id="tab_pde_nota_debito" class="bloque-relacion pde_nota_debito">
            ...
            <h4><?php Lang::_lang('PdeNotaDebito') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdeNotaDebitoTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pde_nota_debito_tipo_estado->getPdeNotaDebitosParaBloqueMasInfo() as $pde_nota_debito){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDE_NOTA_DEBITO_TIPO_ESTADO_MASINFO_PDE_NOTA_DEBITO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($pde_nota_debito){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo PdeNotaDebito::getFiltrosArrGral() ?>&arr=<?php echo $pde_nota_debito->getFiltrosArrXCampo('PdeNotaDebitoTipoEstado', 'pde_nota_debito_tipo_estado_id') ?>" >
                                <?php Lang::_lang('Ver PdeNotaDebitos de ') ?> <strong><?php echo($pde_nota_debito_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_pde_nota_debito_estado" class="bloque-relacion pde_nota_debito_estado">
            ...
            <h4><?php Lang::_lang('PdeNotaDebitoEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PdeNotaDebitoTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pde_nota_debito_tipo_estado->getPdeNotaDebitoEstadosParaBloqueMasInfo() as $pde_nota_debito_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PDE_NOTA_DEBITO_TIPO_ESTADO_MASINFO_PDE_NOTA_DEBITO_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($pde_nota_debito_estado){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PdeNotaDebitoEstados de ') ?> <strong><?php echo($pde_nota_debito_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

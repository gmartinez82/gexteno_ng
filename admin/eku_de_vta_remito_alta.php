...
if(Gral::esPost()){
    ...
    $eku_de_vta_remito = EkuDeVtaRemito::getOxId($hdn_id);
    if(!$eku_de_vta_remito){
        ...
        // -----------------------------------------------------------------
        if($eku_de_vta_remito){
            if(EkuDeVtaRemito::GEN_CONTROL_ALCANCE){
                if($eku_de_vta_remito->getHash() != $hdn_hash){

                    header('Location: us_noautorizado.php?tipo=HASH&clase=EkuDeVtaRemito&id='.$eku_de_vta_remito->getId().'&cod='.$hdn_hash);
                    exit;
                }
            }            
        }            
	...
	$eku_de_vta_remito->setEkuDeId(Gral::getVars(1, "dbsug_eku_de_id", null));
	$eku_de_vta_remito->setVtaRemitoId(Gral::getVars(1, "dbsug_vta_remito_id", null));
	$eku_de_vta_remito->setInicial(Gral::getVars(1, "cmb_inicial", 0));
	$eku_de_vta_remito->setActual(Gral::getVars(1, "cmb_actual", 0));
	$eku_de_vta_remito->setObservacion(Gral::getVars(1, "txa_observacion"));
    }
    if(UsCredencial::getEsAcreditado('EKU_DE_VTA_REMITO_ALTA_AVANZADA')){ 
    }
	...
	switch($accion){
            case 'guardar':
                ...
                if(!$error->getExisteError()){
                    ...
                    header('Location: ?cs=1&id='.$eku_de_vta_remito->getId().'&hash='.$eku_de_vta_remito->getHash());
                    exit;
                }
            break;
            case 'guardarnvo':
	...
	if(trim($hdn_id) != 0){ 
            $eku_de_vta_remito->setId($hdn_id);
            ...
            if($eku_de_vta_remito){
                if(EkuDeVtaRemito::GEN_CONTROL_ALCANCE){
                    if($eku_de_vta_remito->getHash() != $hash){

                        header('Location: us_noautorizado.php?tipo=HASH&clase=EkuDeVtaRemito&id='.$eku_de_vta_remito->getId().'&cod='.$hash);
                        exit;
                    }
                }
            }            
...
<div id='cuerpo' >
    <form id='formu' name='formu' method='post' action='' modulo='eku_de_vta_remito' >
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(EkuDeVtaRemito::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(EkuDeVtaRemito::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('EKU_DE_VTA_REMITO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_eku_de_vta_remito'>
            ...
            <tr>
                <td id="label_dbsug_eku_de_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_eku_de_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=eku_de_vta_remito_alta&atributo=eku_de_id' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_dbsug_eku_de_id" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('eku_de_id')->getMensaje()) ? 'error-mensaje-dbsug' : ''; ?>
                    <?php echo Html::html_get_dbsuggest(1, 'dbsug_eku_de', 'ajax/modulos/eku_de/eku_de_dbsuggest.php', false, true, '', 'Ingrese ...', $eku_de_vta_remito->getEkuDeId(), $eku_de_vta_remito->getEkuDe()->getDescripcion(), 40, false, $error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_eku_de_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_eku_de_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_dbsug_vta_remito_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_remito_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=eku_de_vta_remito_alta&atributo=vta_remito_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_dbsug_vta_remito_id" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('vta_remito_id')->getMensaje()) ? 'error-mensaje-dbsug' : ''; ?>
                    <?php echo Html::html_get_dbsuggest(1, 'dbsug_vta_remito', 'ajax/modulos/vta_remito/vta_remito_dbsuggest.php', false, true, '', 'Ingrese ...', $eku_de_vta_remito->getVtaRemitoId(), $eku_de_vta_remito->getVtaRemito()->getDescripcion(), 40, false, $error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_vta_remito_id_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_vta_remito_id_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_cmb_inicial" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_inicial' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=eku_de_vta_remito_alta&atributo=inicial' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_inicial', GralSiNo::getGralSiNosCmb(), $eku_de_vta_remito->getInicial(), 'textbox '.$error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_inicial_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_inicial_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_cmb_actual" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_actual' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=eku_de_vta_remito_alta&atributo=actual' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_actual', GralSiNo::getGralSiNosCmb(), $eku_de_vta_remito->getActual(), 'textbox '.$error_input_css) ?>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_actual_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_actual_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=eku_de_vta_remito_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($eku_de_vta_remito->getObservacion()) ?></textarea>
                ...
                <?php 
                if(file_exists(Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_observacion_dato_html_bottom.php")){
                    include Gral::getPathAbs()."admin/ajax/modulos/eku_de_vta_remito/eku_de_vta_remito_alta_campo_observacion_dato_html_bottom.php";
                }
                ?>
            </td>
        </tr>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'>
            <input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($eku_de_vta_remito->getId()) ?>'/>
            <input name='hdn_hash' type='hidden' id='hdn_hash' size='5' value='<?php Gral::_echoTxt($eku_de_vta_remito->getHash()) ?>'/>
    ...
    <?php if(trim($eku_de_vta_remito->getId()) != ''){ ?>

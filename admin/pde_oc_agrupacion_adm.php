...
$db_nombre_pagina = 'pde_oc_agrupacion_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="pde_oc_agrupacion">
              <?php include 'ajax/modulos/pde_oc_agrupacion/pde_oc_agrupacion_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="pde_oc_agrupacion">
              <?php //include 'ajax/modulos/pde_oc_agrupacion/pde_oc_agrupacion_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('pde_oc_agrupacion', <?php echo $pagina_actual ?>);
</script>

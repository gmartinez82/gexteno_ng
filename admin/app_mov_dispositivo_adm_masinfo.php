...
$app_mov_dispositivo_id = Gral::getVars(2, 'id');
$app_mov_dispositivo = AppMovDispositivo::getOxId($app_mov_dispositivo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($app_mov_dispositivo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'APP_MOV_DISPOSITIVO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($app_mov_dispositivo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($app_mov_dispositivo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'APP_MOV_DISPOSITIVO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($app_mov_dispositivo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($app_mov_dispositivo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('APP_MOV_DISPOSITIVO_MASINFO_APP_MOV_INSTALACION')){ ?>
            <li><a href="#tab_app_mov_instalacion"><?php Lang::_lang('AppMovInstalacions') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('APP_MOV_DISPOSITIVO_MASINFO_APP_MOV_ACTIVIDAD')){ ?>
	...
	<div id="tab_app_mov_instalacion" class="bloque-relacion app_mov_instalacion">
            ...
            <h4><?php Lang::_lang('AppMovInstalacion') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('AppMovDispositivo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($app_mov_dispositivo->getAppMovInstalacionsParaBloqueMasInfo() as $app_mov_instalacion){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('APP_MOV_DISPOSITIVO_MASINFO_APP_MOV_INSTALACION_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($app_mov_instalacion){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver AppMovInstalacions de ') ?> <strong><?php echo($app_mov_dispositivo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_app_mov_actividad" class="bloque-relacion app_mov_actividad">
            ...
            <h4><?php Lang::_lang('AppMovActividad') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('AppMovDispositivo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($app_mov_dispositivo->getAppMovActividadsParaBloqueMasInfo() as $app_mov_actividad){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('APP_MOV_DISPOSITIVO_MASINFO_APP_MOV_ACTIVIDAD_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($app_mov_actividad){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo AppMovActividad::getFiltrosArrGral() ?>&arr=<?php echo $app_mov_actividad->getFiltrosArrXCampo('AppMovDispositivo', 'app_mov_dispositivo_id') ?>" >
                                <?php Lang::_lang('Ver AppMovActividads de ') ?> <strong><?php echo($app_mov_dispositivo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

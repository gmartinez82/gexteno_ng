...
$prv_convenio_descuento_id = Gral::getVars(2, 'id');
$prv_convenio_descuento = PrvConvenioDescuento::getOxId($prv_convenio_descuento_id);
?>
<div class="masinfo-datos">

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Codigo') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prv_convenio_descuento->getCodigo())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($prv_convenio_descuento->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_CONVENIO_DESCUENTO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_convenio_descuento->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_convenio_descuento->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PRV_CONVENIO_DESCUENTO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($prv_convenio_descuento->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($prv_convenio_descuento->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PRV_CONVENIO_DESCUENTO_MASINFO_PRV_IMPORTACION')){ ?>
	...
	<div id="tab_prv_importacion" class="bloque-relacion prv_importacion">
            ...
            <h4><?php Lang::_lang('PrvImportacion') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PrvConvenioDescuento') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($prv_convenio_descuento->getPrvImportacionsParaBloqueMasInfo() as $prv_importacion){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PRV_CONVENIO_DESCUENTO_MASINFO_PRV_IMPORTACION_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($prv_importacion){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PrvImportacions de ') ?> <strong><?php echo($prv_convenio_descuento->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

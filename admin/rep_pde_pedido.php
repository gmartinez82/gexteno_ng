...
$db_nombre_objeto = 'rep_pde_pedido';
$db_nombre_pagina = 'rep_pde_pedido';
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central reportes'>
            ...
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Pedidos Realizados') ?></div>
                    ...
                    <div class="par">
                        ...
                        <div class="dato">
<?php Html::html_dib_select(1, 'cmb_prv_proveedor_id', Gral::getCmbFiltro(PrvProveedor::getPrvProveedorsCmbFxCredencial(), '...'), $cmb_prv_proveedor_id, 'textbox') ?>
                        </div>
                    </div>
                    ...
                    <div class="par">
                        ...
                        <div class="dato">
<?php Html::html_dib_select(1, 'cmb_pde_tipo_estado_id', Gral::getCmbFiltro(PdeTipoEstado::getPdeTipoEstadosCmb(), '...'), $cmb_pde_tipo_estado_id, 'textbox') ?>

...
if(Gral::esPost()){
	...
	$vta_nota_debito_estado->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$vta_nota_debito_estado->setVtaNotaDebitoId(Gral::getVars(1, "cmb_vta_nota_debito_id", null));
	$vta_nota_debito_estado->setVtaNotaDebitoTipoEstadoId(Gral::getVars(1, "cmb_vta_nota_debito_tipo_estado_id", null));
	$vta_nota_debito_estado->setInicial(Gral::getVars(1, "cmb_inicial", 0));
	$vta_nota_debito_estado->setActual(Gral::getVars(1, "cmb_actual", 0));
	$vta_nota_debito_estado->setCodigo(Gral::getVars(1, "txt_codigo"));
	$vta_nota_debito_estado->setObservacion(Gral::getVars(1, "txa_observacion"));
	$vta_nota_debito_estado->setOrden(Gral::getVars(1, "txt_orden", 0));
	$vta_nota_debito_estado->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$vta_nota_debito_estado->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$vta_nota_debito_estado->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$vta_nota_debito_estado->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$vta_nota_debito_estado->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$vta_nota_debito_estado->getId());
			}
		break;
		case 'guardarnvo':
			$error = $vta_nota_debito_estado->control();
...
<div id='cuerpo' >
	...
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('VtaNotaDebitoEstado') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaNotaDebitoEstado::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaNotaDebitoEstado::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_NOTA_DEBITO_ESTADO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_nota_debito_estado'>
            ...
            <tr>
                <td id="label_txt_descripcion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_descripcion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_debito_estado_alta&atributo=descripcion' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_txt_descripcion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('descripcion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_descripcion' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_descripcion' value='<?php Gral::_echoTxt($vta_nota_debito_estado->getDescripcion()) ?>' size='50' />
            ...
            <tr>
                <td id="label_cmb_vta_nota_debito_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_nota_debito_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_debito_estado_alta&atributo=vta_nota_debito_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_nota_debito_id" clase_id="vta_nota_debito" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_nota_debito_id" <?php echo ($vta_nota_debito_estado->getVtaNotaDebitoId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_nota_debito_id', Gral::getCmbFiltro(VtaNotaDebito::getVtaNotaDebitosCmb(), '...'), $vta_nota_debito_estado->getVtaNotaDebitoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_vta_nota_debito_tipo_estado_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_nota_debito_tipo_estado_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_debito_estado_alta&atributo=vta_nota_debito_tipo_estado_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_vta_nota_debito_tipo_estado_id', Gral::getCmbFiltro(VtaNotaDebitoTipoEstado::getVtaNotaDebitoTipoEstadosCmb(), '...'), $vta_nota_debito_estado->getVtaNotaDebitoTipoEstadoId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txt_codigo" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_codigo' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_debito_estado_alta&atributo=codigo' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_codigo" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('codigo')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_codigo' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_codigo' value='<?php Gral::_echoTxt($vta_nota_debito_estado->getCodigo()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_nota_debito_estado_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($vta_nota_debito_estado->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_nota_debito_estado->getId()) ?>'/>
    ...
    <?php if(trim($vta_nota_debito_estado->getId()) != ''){ ?>

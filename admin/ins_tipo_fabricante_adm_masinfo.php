...
$ins_tipo_fabricante_id = Gral::getVars(2, 'id');
$ins_tipo_fabricante = InsTipoFabricante::getOxId($ins_tipo_fabricante_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($ins_tipo_fabricante->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_TIPO_FABRICANTE_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_tipo_fabricante->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_tipo_fabricante->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'INS_TIPO_FABRICANTE_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ins_tipo_fabricante->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ins_tipo_fabricante->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('INS_TIPO_FABRICANTE_MASINFO_INS_INSUMO')){ ?>
	...
	<div id="tab_ins_insumo" class="bloque-relacion ins_insumo">
            ...
            <h4><?php Lang::_lang('InsInsumo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('InsTipoFabricante') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($ins_tipo_fabricante->getInsInsumosParaBloqueMasInfo() as $ins_insumo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('INS_TIPO_FABRICANTE_MASINFO_INS_INSUMO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($ins_insumo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver InsInsumos de ') ?> <strong><?php echo($ins_tipo_fabricante->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

...
$vta_recibo_tipo_estado_id = Gral::getVars(2, 'id');
$vta_recibo_tipo_estado = VtaReciboTipoEstado::getOxId($vta_recibo_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par inline">
            <div class="label"><?php Lang::_lang('Descripcion') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($vta_recibo_tipo_estado->getDescripcionPublica())) ?></div>
	</div>

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($vta_recibo_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_RECIBO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_recibo_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_recibo_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'VTA_RECIBO_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($vta_recibo_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($vta_recibo_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('VTA_RECIBO_TIPO_ESTADO_MASINFO_VTA_RECIBO')){ ?>
            <li><a href="#tab_vta_recibo"><?php Lang::_lang('VtaRecibo') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('VTA_RECIBO_TIPO_ESTADO_MASINFO_VTA_RECIBO_ESTADO')){ ?>
	...
	<div id="tab_vta_recibo" class="bloque-relacion vta_recibo">
            ...
            <h4><?php Lang::_lang('VtaRecibo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('VtaReciboTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($vta_recibo_tipo_estado->getVtaRecibosParaBloqueMasInfo() as $vta_recibo){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('VTA_RECIBO_TIPO_ESTADO_MASINFO_VTA_RECIBO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($vta_recibo){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver VtaRecibos de ') ?> <strong><?php echo($vta_recibo_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_vta_recibo_estado" class="bloque-relacion vta_recibo_estado">
            ...
            <h4><?php Lang::_lang('VtaReciboEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('VtaReciboTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($vta_recibo_tipo_estado->getVtaReciboEstadosParaBloqueMasInfo() as $vta_recibo_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('VTA_RECIBO_TIPO_ESTADO_MASINFO_VTA_RECIBO_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                            
                        <?php if($vta_recibo_estado){ ?>
                            <div class="boton">
                                <a href="_init.php?arr_gral=<?php echo VtaReciboEstado::getFiltrosArrGral() ?>&arr=<?php echo $vta_recibo_estado->getFiltrosArrXCampo('VtaReciboTipoEstado', 'vta_recibo_tipo_estado_id') ?>" >
                                <?php Lang::_lang('Ver VtaReciboEstados de ') ?> <strong><?php echo($vta_recibo_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

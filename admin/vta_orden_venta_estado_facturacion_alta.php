...
if(Gral::esPost()){
	...
	$vta_orden_venta_estado_facturacion->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$vta_orden_venta_estado_facturacion->setVtaOrdenVentaId(Gral::getVars(1, "cmb_vta_orden_venta_id", null));
	$vta_orden_venta_estado_facturacion->setVtaOrdenVentaTipoEstadoFacturacionId(Gral::getVars(1, "cmb_vta_orden_venta_tipo_estado_facturacion_id", null));
	$vta_orden_venta_estado_facturacion->setInicial(Gral::getVars(1, "cmb_inicial", 0));
	$vta_orden_venta_estado_facturacion->setActual(Gral::getVars(1, "cmb_actual", 0));
	$vta_orden_venta_estado_facturacion->setCodigo(Gral::getVars(1, "txt_codigo"));
	$vta_orden_venta_estado_facturacion->setObservacion(Gral::getVars(1, "txa_observacion"));
	$vta_orden_venta_estado_facturacion->setOrden(Gral::getVars(1, "txt_orden", 0));
	$vta_orden_venta_estado_facturacion->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$vta_orden_venta_estado_facturacion->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$vta_orden_venta_estado_facturacion->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$vta_orden_venta_estado_facturacion->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$vta_orden_venta_estado_facturacion->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$vta_orden_venta_estado_facturacion->getId());
			}
		break;
		case 'guardarnvo':
			$error = $vta_orden_venta_estado_facturacion->control();
	...
	if(trim($hdn_id) != ''){ 
		$vta_orden_venta_estado_facturacion->setId($hdn_id);
	}else{
...
<div id='cuerpo' >
	...
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('VtaOrdenVentaEstadoFacturacion') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(VtaOrdenVentaEstadoFacturacion::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(VtaOrdenVentaEstadoFacturacion::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('VTA_ORDEN_VENTA_ESTADO_FACTURACION_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_vta_orden_venta_estado_facturacion'>
            ...
            <tr>
                <td id="label_txt_descripcion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_descripcion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_orden_venta_estado_facturacion_alta&atributo=descripcion' modulo_metodo_init='setInit()'>
                ...
                <td id="dato_txt_descripcion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('descripcion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_descripcion' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_descripcion' value='<?php Gral::_echoTxt($vta_orden_venta_estado_facturacion->getDescripcion()) ?>' size='50' />
            ...
            <tr>
                <td id="label_cmb_vta_orden_venta_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_orden_venta_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_orden_venta_estado_facturacion_alta&atributo=vta_orden_venta_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_vta_orden_venta_id" clase_id="vta_orden_venta" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_vta_orden_venta_id" <?php echo ($vta_orden_venta_estado_facturacion->getVtaOrdenVentaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_vta_orden_venta_id', Gral::getCmbFiltro(VtaOrdenVenta::getVtaOrdenVentasCmb(), '...'), $vta_orden_venta_estado_facturacion->getVtaOrdenVentaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_vta_orden_venta_tipo_estado_facturacion_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_orden_venta_tipo_estado_facturacion_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_orden_venta_estado_facturacion_alta&atributo=vta_orden_venta_tipo_estado_facturacion_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_vta_orden_venta_tipo_estado_facturacion_id', Gral::getCmbFiltro(VtaOrdenVentaTipoEstadoFacturacion::getVtaOrdenVentaTipoEstadoFacturacionsCmb(), '...'), $vta_orden_venta_estado_facturacion->getVtaOrdenVentaTipoEstadoFacturacionId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_txt_codigo" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_codigo' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_orden_venta_estado_facturacion_alta&atributo=codigo' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txt_codigo" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('codigo')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <input name='txt_codigo' type='text' class='textbox <?php echo $error_input_css ?> ' id='txt_codigo' value='<?php Gral::_echoTxt($vta_orden_venta_estado_facturacion->getCodigo()) ?>' size='40' />
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=vta_orden_venta_estado_facturacion_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($vta_orden_venta_estado_facturacion->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($vta_orden_venta_estado_facturacion->getId()) ?>'/>
    ...
    <?php if(trim($vta_orden_venta_estado_facturacion->getId()) != ''){ ?>

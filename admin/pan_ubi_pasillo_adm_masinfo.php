...
$pan_ubi_pasillo_id = Gral::getVars(2, 'id');
$pan_ubi_pasillo = PanUbiPasillo::getOxId($pan_ubi_pasillo_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($pan_ubi_pasillo->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PAN_UBI_PASILLO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pan_ubi_pasillo->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pan_ubi_pasillo->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PAN_UBI_PASILLO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($pan_ubi_pasillo->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($pan_ubi_pasillo->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PAN_UBI_PASILLO_MASINFO_INS_INSUMO_PAN_PANOL')){ ?>
	...
	<div id="tab_ins_insumo_pan_panol" class="bloque-relacion ins_insumo_pan_panol">
            ...
            <h4><?php Lang::_lang('InsInsumoPanPanol') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PanUbiPasillo') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($pan_ubi_pasillo->getInsInsumoPanPanolsParaBloqueMasInfo() as $ins_insumo_pan_panol){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PAN_UBI_PASILLO_MASINFO_INS_INSUMO_PAN_PANOL_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($ins_insumo_pan_panol){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver InsInsumoPanPanols de ') ?> <strong><?php echo($pan_ubi_pasillo->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

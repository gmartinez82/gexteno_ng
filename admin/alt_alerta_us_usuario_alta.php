...
if(Gral::esPost()){
	...
	$alt_alerta_us_usuario->setAltAlertaId(Gral::getVars(1, "cmb_alt_alerta_id", null));
	$alt_alerta_us_usuario->setUsUsuarioId(Gral::getVars(1, "cmb_us_usuario_id", null));
	$alt_alerta_us_usuario->setObservado(Gral::getVars(1, "cmb_observado", 0));
	$alt_alerta_us_usuario->setLeido(Gral::getVars(1, "cmb_leido", 0));
	$alt_alerta_us_usuario->setDestacado(Gral::getVars(1, "cmb_destacado", 0));
	$alt_alerta_us_usuario->setAvisoEmail(Gral::getVars(1, "cmb_aviso_email", 0));
	$alt_alerta_us_usuario->setAvisoSms(Gral::getVars(1, "cmb_aviso_sms", 0));
	$alt_alerta_us_usuario->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$alt_alerta_us_usuario->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$alt_alerta_us_usuario->getId());
			}
		break;
		case 'guardarnvo':
			$error = $alt_alerta_us_usuario->control();
	...
	if(trim($hdn_id) != ''){ 
		$alt_alerta_us_usuario->setId($hdn_id);
	}else{
...
<div id='cuerpo' >
	...
	<div class='adm_cuerpo_titulo'><?php Lang::_lang('AltAlertaUsUsuario') ?> </div>
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(AltAlertaUsUsuario::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(AltAlertaUsUsuario::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('ALT_ALERTA_US_USUARIO_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_alt_alerta_us_usuario'>
            ...
            <tr>
                <td id="label_cmb_alt_alerta_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_alt_alerta_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=alt_alerta_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_alt_alerta_id" clase_id="alt_alerta" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_alt_alerta_id" <?php echo ($alt_alerta_us_usuario->getAltAlertaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_alt_alerta_id', Gral::getCmbFiltro(AltAlerta::getAltAlertasCmb(), '...'), $alt_alerta_us_usuario->getAltAlertaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_us_usuario_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_us_usuario_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=us_usuario_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_us_usuario_id" clase_id="us_usuario" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_us_usuario_id" <?php echo ($alt_alerta_us_usuario->getUsUsuarioId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_us_usuario_id', Gral::getCmbFiltro(UsUsuario::getUsUsuariosCmb(), '...'), $alt_alerta_us_usuario->getUsUsuarioId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_observado" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observado' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=observado' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_observado', GralSiNo::getGralSiNosCmb(), $alt_alerta_us_usuario->getObservado(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_leido" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_leido' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=leido' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_leido', GralSiNo::getGralSiNosCmb(), $alt_alerta_us_usuario->getLeido(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_destacado" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_destacado' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=destacado' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_destacado', GralSiNo::getGralSiNosCmb(), $alt_alerta_us_usuario->getDestacado(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_aviso_email" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_aviso_email' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=aviso_email' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_aviso_email', GralSiNo::getGralSiNosCmb(), $alt_alerta_us_usuario->getAvisoEmail(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_cmb_aviso_sms" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_aviso_sms' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=alt_alerta_us_usuario_alta&atributo=aviso_sms' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
		...
		<?php Html::html_dib_select(1, 'cmb_aviso_sms', GralSiNo::getGralSiNosCmb(), $alt_alerta_us_usuario->getAvisoSms(), 'textbox '.$error_input_css) ?>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($alt_alerta_us_usuario->getId()) ?>'/>
    ...
    <?php if(trim($alt_alerta_us_usuario->getId()) != ''){ ?>

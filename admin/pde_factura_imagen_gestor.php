...
$c = new Criterio();
$c->addTabla('pde_factura_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $pde_factura->getPdeFacturaImagens(null, $c);
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PdeFacturaImagens') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <?php include "ajax/modulos/pde_factura_imagen/pde_factura_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/pde_factura_imagen/pde_factura_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

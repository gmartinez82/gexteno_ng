...
$c = new Criterio();
$c->addTabla('ins_marca_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $ins_marca->getInsMarcaImagens(null, $c);

$clase = "InsMarca";
$tabla = "ins_marca";
$padre = $ins_marca->getId();
          ...
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="titulo">
                    ...
                    <div class="dato"><?php Gral::_echo($ins_marca->getDescripcion()) ?></div>
                </div>
                <div class="botonera">
                    <div class="boton volver"><a href="<?php Gral::_echo(InsMarca::getInfoBtnVolver('url')) ?>"><?php Lang::_lang(InsMarca::getInfoBtnVolver('label')) ?></a></div>
                    <div class="boton editar"><a href="ins_marca_alta.php?id=<?php Gral::_echo($ins_marca->getId()) ?>"><?php Lang::_lang('Editar') ?> <strong><?php Gral::_echo($ins_marca->getDescripcion()) ?></strong></a></div>
                </div>

                
                <?php include "ajax/modulos/ins_marca_imagen/ins_marca_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/ins_marca_imagen/ins_marca_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

...
$db_nombre_pagina = 'pde_recibo_imagen_adm';
...
$c = new Criterio();
$c->addTabla('pde_recibo_imagen');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$imagenes = $pde_recibo->getPdeReciboImagens(null, $c);

$clase = "PdeRecibo";
$tabla = "pde_recibo";
$padre = $pde_recibo->getId();
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PdeReciboImagens') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="imagenes" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <div class="botonera">
                    <div class="boton volver"><a href="<?php Gral::_echo(PdeRecibo::getInfoBtnVolver('url')) ?>"><?php Lang::_lang(PdeRecibo::getInfoBtnVolver('label')) ?></a></div>
                    <div class="boton editar"><a href="pde_recibo_alta.php?id=<?php Gral::_echo($pde_recibo->getId()) ?>"><?php Lang::_lang('Editar') ?> <strong><?php Gral::_echo($pde_recibo->getDescripcion()) ?></strong></a></div>
                </div>

                
                <?php include "ajax/modulos/pde_recibo_imagen/pde_recibo_imagen_masivo.php" ?>
                ...
                <div class="bloque-imagenes">
                    <?php foreach($imagenes as $imagen){ ?>
                        <div id="div_grupo_imagen_<?php Gral::_echo($imagen->getId()) ?>" class="uno" identificador="<?php Gral::_echo($imagen->getId()) ?>" >
                            <?php
                            include "ajax/modulos/pde_recibo_imagen/pde_recibo_imagen_uno.php";
                            ?>
                        </div>
                    <?php } ?>

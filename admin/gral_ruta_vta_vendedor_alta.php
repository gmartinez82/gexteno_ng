...
if(Gral::esPost()){
	...
	$gral_ruta_vta_vendedor->setDescripcion(Gral::getVars(1, "txt_descripcion"));
	$gral_ruta_vta_vendedor->setGralRutaId(Gral::getVars(1, "cmb_gral_ruta_id", null));
	$gral_ruta_vta_vendedor->setVtaVendedorId(Gral::getVars(1, "dbsug_vta_vendedor_id", null));
	$gral_ruta_vta_vendedor->setCodigo(Gral::getVars(1, "txt_codigo"));
	$gral_ruta_vta_vendedor->setObservacion(Gral::getVars(1, "txa_observacion"));
	$gral_ruta_vta_vendedor->setOrden(Gral::getVars(1, "txt_orden", 0));
	$gral_ruta_vta_vendedor->setEstado(Gral::getVars(1, "cmb_estado", 0));
	$gral_ruta_vta_vendedor->setCreado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_creado")));
	$gral_ruta_vta_vendedor->setCreadoPor(Gral::getVars(1, "_creado_por", 0));
	$gral_ruta_vta_vendedor->setModificado(Gral::getFechaHoraToDb(Gral::getVars(1, "txt_modificado")));
	$gral_ruta_vta_vendedor->setModificadoPor(Gral::getVars(1, "_modificado_por", 0));
	...
	switch($accion){
		case 'guardar':
			...
			if(!$error->getExisteError()){
				...
				header('Location: ?cs=1&id='.$gral_ruta_vta_vendedor->getId());
			}
		break;
		case 'guardarnvo':
			$error = $gral_ruta_vta_vendedor->control();
	...
	if(trim($hdn_id) != ''){ 
		$gral_ruta_vta_vendedor->setId($hdn_id);
	}else{
      ...
      <table width='100%' border='0' align='center'>
        <tr>
          <td align='right' class='adm_carga_datos_botones'>
            <input name='btn_listado' type='button' id='btn_listado' value='<?php Lang::_lang(GralRutaVtaVendedor::getInfoBtnVolver('label')) ?>' onclick='location.href="<?php Gral::_echo(GralRutaVtaVendedor::getInfoBtnVolver('url')) ?>"' />
...
<?php if(UsCredencial::getEsAcreditado('GRAL_RUTA_VTA_VENDEDOR_ALTA')){ ?>
        ...
        <table width='100%' border='0' cellspacing='10' class='adm_carga_datos' align='center' id='alta_gral_ruta_vta_vendedor'>
            ...
            <tr>
                <td id="label_cmb_gral_ruta_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_gral_ruta_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_ruta_vta_vendedor_alta&atributo=gral_ruta_id' modulo_metodo_init='setInit()'>
                ...
                <div class="div_botonera_cmb_alta_editar">
                   <img class="img_btn_editar" elemento_id="cmb_gral_ruta_id" clase_id="gral_ruta" prefijo='' src='imgs/btn_modi.gif' border='0' width='20' align='absmiddle' id="img_btn_editar_cmb_gral_ruta_id" <?php echo ($gral_ruta_vta_vendedor->getGralRutaId() == 'null') ? "style='display:none;'" : '' ?> />
		...
		<?php Html::html_dib_select(1, 'cmb_gral_ruta_id', Gral::getCmbFiltro(GralRuta::getGralRutasCmb(), '...'), $gral_ruta_vta_vendedor->getGralRutaId(), 'textbox '.$error_input_css) ?>
            ...
            <tr>
                <td id="label_dbsug_vta_vendedor_id" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_vta_vendedor_id' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_ruta_vta_vendedor_alta&atributo=vta_vendedor_id' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_dbsug_vta_vendedor_id" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('vta_vendedor_id')->getMensaje()) ? 'error-mensaje-dbsug' : ''; ?>
                    <?php echo Html::html_get_dbsuggest(1, 'dbsug_vta_vendedor', 'ajax/modulos/vta_vendedor/vta_vendedor_dbsuggest.php', false, true, '', 'Ingrese ...', $gral_ruta_vta_vendedor->getVtaVendedorId(), $gral_ruta_vta_vendedor->getVtaVendedor()->getDescripcion(), 40, false, $error_input_css) ?>
            ...
            <tr>
                <td id="label_txa_observacion" class="adm_carga_datos_titulos" width="" help="<?php echo 'help_'.$db_nombre_pagina.'_observacion' ?>" >
                    ...
                    <?php if (UsCredencial::getEsAcreditado('GEN_ATRIBUTO_CONFIG')) { ?>
                        <div class='gen-atributos-config db_context' archivo='<?php Gral::_echo(Gral::getPath('path_http')) ?>admin/ajax/atributos/atributos_db_context_acciones.php?modulo=gral_ruta_vta_vendedor_alta&atributo=observacion' modulo_metodo_init='setInit()'>
                            <img src='imgs/btn_config.png' width='20' align='absmiddle' />
                        </div>
                    <?php } ?>
                ...
                <td id="dato_txa_observacion" class="adm_carga_datos_datos" width="">
                  <?php $error_input_css = ($error->getErrorXIndice('observacion')->getMensaje()) ? 'error-mensaje-input' : ''; ?>
                    <textarea name='txa_observacion' rows='10' cols='50' id='txa_observacion' class='textbox <?php echo $error_input_css ?> '><?php Gral::_echoTxt($gral_ruta_vta_vendedor->getObservacion()) ?></textarea>
...
<?php } ?>
    ...
    <table width='100%' border='0' align='center'>
        <tr>
          <td align='right'  class='adm_carga_datos_botones'><input name='hdn_id' type='hidden' id='hdn_id' size='1' value='<?php Gral::_echoTxt($gral_ruta_vta_vendedor->getId()) ?>'/>
    ...
    <?php if(trim($gral_ruta_vta_vendedor->getId()) != ''){ ?>

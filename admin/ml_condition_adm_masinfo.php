...
$ml_condition_id = Gral::getVars(2, 'id');
$ml_condition = MlCondition::getOxId($ml_condition_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($ml_condition->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ML_CONDITION_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ml_condition->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ml_condition->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'ML_CONDITION_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($ml_condition->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($ml_condition->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('ML_CONDITION_MASINFO_INS_VENTA_ML_INFO')){ ?>
	...
	<div id="tab_ins_venta_ml_info" class="bloque-relacion ins_venta_ml_info">
            ...
            <h4><?php Lang::_lang('InsVentaMlInfo') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('MlCondition') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($ml_condition->getInsVentaMlInfosParaBloqueMasInfo() as $ins_venta_ml_info){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('ML_CONDITION_MASINFO_INS_VENTA_ML_INFO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($ins_venta_ml_info){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver InsVentaMlInfos de ') ?> <strong><?php echo($ml_condition->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">

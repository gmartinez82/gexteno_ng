...
$db_nombre_objeto = 'vta_remito_gestion';
$db_nombre_pagina = 'vta_remito_gestion';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
            ...
            <div class="div_listado_buscador" modulo="vta_remito_gestion">
                <?php include 'ajax/modulos/vta_remito_gestion/vta_remito_gestion_buscador_top.php' ?>
            </div>

            <div class="div_listado_datos" modulo="vta_remito_gestion">
                <?php //include 'ajax/modulos/vta_remito_gestion/vta_remito_gestion_datos.php' ?>
            </div>
...
<?php Gral::_echo($mi_hash) ?>
    refreshAdmAll('vta_remito_gestion', <?php echo $pagina_actual ?>);
</script>

...
$db_nombre_pagina = 'pde_recibo_adm';
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="pde_recibo">
              <?php include 'ajax/modulos/pde_recibo/pde_recibo_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="pde_recibo">
              <?php //include 'ajax/modulos/pde_recibo/pde_recibo_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('pde_recibo', <?php echo $pagina_actual ?>);
</script>

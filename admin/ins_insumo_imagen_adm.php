...
$pagina_actual = InsInsumoImagen::getSesPag();
...
<body class="<?php echo Gral::getConfig('cont_entorno') ?>">
    ...
    <div id='cuerpo'>
        ...
        <div class='contenedor central'>
          ...
          <div class="div_listado_buscador" modulo="ins_insumo_imagen">
              <?php include 'ajax/modulos/ins_insumo_imagen/ins_insumo_imagen_buscador_top.php' ?>
          </div>

          <div class="div_listado_datos" modulo="ins_insumo_imagen">
              <?php //include 'ajax/modulos/ins_insumo_imagen/ins_insumo_imagen_datos.php' ?>
          </div>
...
<script type='text/javascript'>
    ...
    refreshAdmAll('ins_insumo_imagen', <?php echo $pagina_actual ?>);
</script>

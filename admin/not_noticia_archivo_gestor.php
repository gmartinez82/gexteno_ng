...
$c = new Criterio();
$c->addTabla('not_noticia_archivo');
$c->addOrden('orden', 'asc');
$c->setCriterios();
$archivos = $not_noticia->getNotNoticiaArchivos(null, $c);
        ...
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('NotNoticiaArchivo') ?> </div>
          <div class='contenedor central'>
            ...
            <div class="archivos" padre="<?php Gral::_echo($padre) ?>" clase="<?php Gral::_echo($clase) ?>" tabla="<?php Gral::_echo($tabla) ?>">
                ...
                <?php include "ajax/modulos/not_noticia_archivo/not_noticia_archivo_masivo.php" ?>
                ...
                <div class="bloque-archivos">
                    ...
                    <div id="div_grupo_archivo_<?php Gral::_echo($archivo->getId()) ?>" class="uno" identificador="<?php Gral::_echo($archivo->getId()) ?>" >
                        <?php
                        include "ajax/modulos/not_noticia_archivo/not_noticia_archivo_uno.php";
                        ?>
                    </div>
                    <?php } ?>
                </div>

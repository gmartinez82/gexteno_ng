...
$db_nombre_objeto = "rep_pde_nota_credito";
$db_nombre_pagina = "rep_pde_nota_credito";
...
if (Gral::esPost())
{
    ...
    include "rep_pde_nota_credito_xlsx.php";
}
else
{
    //$txt_desde = '';
...
<body>
    ...
    <div id='cuerpo'>
        <div class='adm_cuerpo_titulo'><?php Lang::_lang('PDE Nota Credito') ?> </div>
        <div class='contenedor central reportes'>
            <br />	
            <br />
            <form id="form_buscador" name="form_buscador" method="post" action="" target="_blank">
                <div class="buscador">
                    <div class="titulo"><?php Lang::_lang('Reporte de') ?> <?php Lang::_lang('Lista de PdeNotaCredito') ?></div>
                    <div class="par">

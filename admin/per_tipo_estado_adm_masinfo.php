...
$per_tipo_estado_id = Gral::getVars(2, 'id');
$per_tipo_estado = PerTipoEstado::getOxId($per_tipo_estado_id);
?>
<div class="masinfo-datos">

	<div class="par ">
            <div class="label"><?php Lang::_lang('Observaciones') ?></div>
            <div class="dato"><?php Gral::_echo(nl2br($per_tipo_estado->getObservacion())) ?></div>
	</div>

<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PER_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        <div class="label"><?php Lang::_lang('Creado') ?></div>
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($per_tipo_estado->getCreado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($per_tipo_estado->getCreadoPorDescripcion()) ?></strong></i></div>
    </div>
<?php } ?>
...
<?php if(Login::esAutorizado($user, 'GRAL_ADMIN_AUDITOR') || Login::esAutorizado($user, 'PER_TIPO_ESTADO_AUDITOR')){ ?>
    <div class="par inline">
        ...
        <div class="dato"><?php Gral::_echo(Gral::getFechaHoraToWeb($per_tipo_estado->getModificado())) ?> hs<br /> <i>Por: <strong><?php Gral::_echo($per_tipo_estado->getModificadoPorDescripcion()) ?></strong></i></div>
    </div>		
<?php } ?>
...
<div class="tabs">
	<ul>
            <?php if(UsCredencial::getEsAcreditado('PER_TIPO_ESTADO_MASINFO_PER_PERSONA')){ ?>
            <li><a href="#tab_per_persona"><?php Lang::_lang('PerPersonas') ?></a></li>
            <?php } ?>
            
            <?php if(UsCredencial::getEsAcreditado('PER_TIPO_ESTADO_MASINFO_PER_ESTADO')){ ?>
	...
	<div id="tab_per_persona" class="bloque-relacion per_persona">
            ...
            <h4><?php Lang::_lang('PerPersona') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PerTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($per_tipo_estado->getPerPersonasParaBloqueMasInfo() as $per_persona){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PER_TIPO_ESTADO_MASINFO_PER_PERSONA_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($per_persona){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PerPersonas de ') ?> <strong><?php echo($per_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
	...
	<div id="tab_per_estado" class="bloque-relacion per_estado">
            ...
            <h4><?php Lang::_lang('PerEstado') ?> <?php Lang::_lang('vinculados al') ?> <?php Lang::_lang('PerTipoEstado') ?></h4>
            <div class="bloque-relacion-datos">
                    ...
                    <?php foreach($per_tipo_estado->getPerEstadosParaBloqueMasInfo() as $per_estado){ ?>
                    <div class="uno">
                    ...
                    <?php if(UsCredencial::getEsAcreditado('PER_TIPO_ESTADO_MASINFO_PER_ESTADO_BOTONERA')){ ?>
                    <div class="botonera">
                        ...
                        <?php if($per_estado){ ?>
                            <div class="boton">
                                ...
                                <?php Lang::_lang('Ver PerEstados de ') ?> <strong><?php echo($per_tipo_estado->getDescripcion()) ?></strong>
                                </a>				
                            </div>
                        <?php } ?>
                        <div class="boton">
